...
let rec take_lz_lh__d1 n_5 ls_7 =
  (if (n_5 > 0) then
    ((Lazy.force ls_7) n_5)
  else
    (fun _lh_dummy_1_3 -> 
  ...
  (lazy (match (Lazy.force xs_1) with
    | `LH_C(hx_1, tx_1) -> 
      (match (Lazy.force ys_1) with
        ...
        | `LH_N -> 
          (fun f_5 n_1 _lh_dummy_1 -> 
            0.0))
    | `LH_N -> 
      (fun f_6 n_2 _lh_dummy_2 -> 
        0.0)));;
  ...
  (lazy (match (Lazy.force xs_3) with
    | `LH_C(hx_2, tx_2) -> 
      (match (Lazy.force ys_3) with
        | `LH_C(hy_2, ty_2) -> 
          (`LH_C(((f_8 hx_2) hy_2), (((zipWith_lz_lz_lh__d2 f_8) tx_2) ty_2)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N)));;
...
let rec enumFromFloat_lh__d1 _lh_enumFromFloat_arg1_1 =
  (lazy (let rec tx_6 = (enumFromFloat_lh__d1 (_lh_enumFromFloat_arg1_1 +. 1.0)) in
    (let rec hx_6 = _lh_enumFromFloat_arg1_1 in
      (fun f_1_3 ys_5 -> 
        ((((Lazy.force ys_5) f_1_3) hx_6) tx_6)))));;
    ...
    | `LH_C(h_8, t_8) -> 
      (let rec ty_4 = ((map_lz_lh__d2 f_1_4) t_8) in
        (let rec hy_4 = (f_1_4 h_8) in
          (fun f_1_5 hx_7 tx_7 -> 
            (`LH_C(((f_1_5 hx_7) hy_4), (((zipWith_lz_lz_lh__d4 f_1_5) tx_7) ty_4))))))
    | `LH_N -> 
      (fun f_1_6 hx_8 tx_8 -> 
        (`LH_N))));;
let rec zarks_lh__d1 _lh_zarks_arg1_1 =
  (((zipWith_lz_lz_lh__d4 zark_lh__d1) (ints_lh__d1 0)) ((map_lz_lh__d2 (fun n_4 -> 
...
let rec head_lz_lh__d1 ls_2 =
  (match (Lazy.force ls_2) with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec zipWith_lz_lz_lh__d5 f_9 xs_4 ys_4 =
  (lazy (match (Lazy.force xs_4) with
    | `LH_C(hx_3, tx_3) -> 
      ((((Lazy.force ys_4) f_9) hx_3) tx_3)
    | `LH_N -> 
      (`LH_N)));;
    ...
    | `LH_C(h_5, t_5) -> 
      (let rec ty_3 = ((map_lz_lh__d3 f_1_0) t_5) in
        (let rec hy_3 = (f_1_0 h_5) in
          (fun f_1_1 hx_4 tx_4 -> 
            (`LH_C(((f_1_1 hx_4) hy_3), (((zipWith_lz_lz_lh__d5 f_1_1) tx_4) ty_3))))))
    | `LH_N -> 
      (fun f_1_2 hx_5 tx_5 -> 
        (`LH_N))));;
...
let rec zarks_lh__d2 _lh_zarks_arg1_0 =
  (((zipWith_lz_lz_lh__d5 zark_lh__d2) (ints_lh__d3 0)) ((map_lz_lh__d3 (fun n_3 -> 
    (2.0 *. n_3))) (ints_lh__d4 0)));;
...
let rec etotal_lh__d1 _lh_etotal_arg1_0 =
  (sumFloat_lh__d1 ((take_lz_lh__d1 _lh_etotal_arg1_0) ((map_lz_lh__d1 (fun a_3 -> 
    ...
    (a_4 -. b_1))) (rtotals_lh__d1 0)) (itotals_lh__d1 0)))));;

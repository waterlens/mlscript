  ...
  (match _lh_result_arg1_0 with
    | `LH_P2(_lh_result_LH_P2_0_0, _lh_result_LH_P2_1_0) -> 
      ...
      and superpose_0 = (fun _lh_superpose_arg1_0 _lh_superpose_arg2_0 -> 
        (sift_lh (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_6 -> 
            ...
            | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_6) -> 
              (match _lh_listcomp_fun_ls_h_6 with
                | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                  (`LH_C(((lift_lh (pair_lh _lh_superpose_LH_P2_0_0)) ((unify_lh _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6)))
                | _ -> 
                  (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6))
            | `LH_N -> 
              (`LH_N))) in
          (_lh_listcomp_fun_6 (subterms_lh _lh_superpose_arg2_0)))))
        ...
        (match _lh_delete_arg3_0 with
          ...
          | `LH_C(_lh_delete_LH_C_0_0, _lh_delete_LH_C_1_0) -> 
            (if ((_lh_delete_arg1_0 _lh_delete_arg2_0) _lh_delete_LH_C_0_0) then
              ...
              ((lift_lh (fun x_1_2 -> 
                (`LH_C(_lh_delete_LH_C_0_0, x_1_2)))) (((delete_0 _lh_delete_arg1_0) _lh_delete_arg2_0) _lh_delete_LH_C_1_0)))
          | _ -> 
            (failwith "error")))
                ...
                (let rec add_x_0 = (fun xsys_0 -> 
                  (let rec _lh_matchIdent_1_0 = xsys_0 in
                    (match _lh_matchIdent_1_0 with
                      ...
                      | _ -> 
                        (failwith "error")))) in
                  ((getOrElse_lh ((lift_lh (fun _lh_funcomp_x_7 -> 
                    ((rem_eq_0 _lh_rem_eq_arg1_0) ((pair_lh _lh_rem_eq_LH_C_1_0) _lh_funcomp_x_7)))) (((delete_0 _lh_rem_eq_arg1_0) _lh_rem_eq_LH_C_0_0) _lh_rem_eq_LH_P2_1_0))) (add_x_0 ((rem_eq_0 _lh_rem_eq_arg1_0) (`LH_P2(_lh_rem_eq_LH_C_1_0, _lh_rem_eq_LH_P2_1_0))))))
              | _ -> 
                (failwith "error"))
          | _ -> 
            (failwith "error")))
      ...
      and parse_eqn_0 = (fun _lh_parse_eqn_arg1_0 -> 
        (let rec _lh_matchIdent_1_3 = (fst_lh (the_lh (p_eqn_0 _lh_parse_eqn_arg1_0))) in
      ...
      and addby_0 = (fun _lh_addby_arg1_0 _lh_addby_arg2_0 _lh_addby_arg3_0 -> 
        (let rec insert_0 = (fun x_1_1 ls_8 -> 
          (let rec _lh_matchIdent_5 = ls_8 in
            (match _lh_matchIdent_5 with
              | `LH_N -> 
                (`LH_C(x_1_1, (`LH_N)))
              | `LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0) -> 
                (if ((_lh_addby_arg1_0 x_1_1) <= (_lh_addby_arg1_0 _lh_addby_LH_C_0_0)) then
                  (`LH_C(x_1_1, (`LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0))))
                else
                  (`LH_C(_lh_addby_LH_C_0_0, ((insert_0 x_1_1) _lh_addby_LH_C_1_0))))
              | _ -> 
                (failwith "error")))) in
          ...
          (let rec _lh_matchIdent_6 = xs_4 in
            (match _lh_matchIdent_6 with
              | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                ((lift_lh ((cross_lh (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_1_3 -> 
                  x_1_3))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))
              | _ -> 
                (failwith "error")))) in
          (fun _lh_funcomp_x_5 -> 
            ((fun _lh_funcomp_x_6 -> 
              (squash_lh ((lift_lh g_1) _lh_funcomp_x_6))) (_lh_seq2Lzq_arg2_0 _lh_funcomp_x_5)))))
                                        ...
                                        (fun _lh_rpo_Func_0_7 _lh_rpo_Func_0_8 _lh_rpo_Func_1_7 _lh_rpo_Func_1_8 _lh_rpo_arg2_3 rpo'_3 -> 
                                          ((_lh_rpo_arg2_3 rpo'_3) (let rec _lh_lex_ext_LH_P2_1_0 = (let rec _lh_lex_ext_Func_1_0 = _lh_rpo_Func_1_7 in
                                            (let rec _lh_lex_ext_Func_0_0 = _lh_rpo_Func_0_7 in
                                              (fun _lh_lex_ext_Func_0_1 _lh_lex_ext_Func_1_1 _lh_lex_ext_arg1_1 lexico_1 -> 
                                                (let rec estimate_0 = ((lexico_1 _lh_lex_ext_arg1_1) (`LH_P2(_lh_lex_ext_Func_1_1, _lh_lex_ext_Func_1_0))) in
                                                  (let rec confirm_0 = (fun x_1_4 -> 
                                                    (let rec _lh_matchIdent_9 = x_1_4 in
                                                      (match _lh_matchIdent_9 with
                                                        | `Equal -> 
                                                          true
                                                        | `Greater -> 
                                                          ((((quant_lh all_lh) (ltRewrite_lh _lh_lex_ext_arg1_1)) (`Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1))) _lh_lex_ext_Func_1_0)
                                                        | `Less -> 
                                                          ((((quant_lh all_lh) (ltRewrite_lh _lh_lex_ext_arg1_1)) (`Func(_lh_lex_ext_Func_0_0, _lh_lex_ext_Func_1_0))) _lh_lex_ext_Func_1_1)
                                                        | `Unrelated -> 
                                                          false
                                                        | _ -> 
                                                          (failwith "error")))) in
                                                    (if (confirm_0 estimate_0) then
                                                      ...
                                                      (if ((((quant_lh any_lh) (geRewrite_lh _lh_lex_ext_arg1_1)) (`Func(_lh_lex_ext_Func_0_0, _lh_lex_ext_Func_1_0))) _lh_lex_ext_Func_1_1) then
                                                        (`Greater)
                                                      else
                                                        (if ((((quant_lh any_lh) (geRewrite_lh _lh_lex_ext_arg1_1)) (`Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1))) _lh_lex_ext_Func_1_0) then
                                                          (`Less)
                                                        else
                                                          (`Unrelated))))))))) in
                                            (let rec _lh_lex_ext_LH_P2_0_0 = (let rec _lh_lex_ext_Func_1_2 = _lh_rpo_Func_1_8 in
                                              (let rec _lh_lex_ext_Func_0_2 = _lh_rpo_Func_0_8 in
                                                (fun _lh_lex_ext_LH_P2_1_1 _lh_lex_ext_arg1_2 lexico_2 -> 
                                                  ((((_lh_lex_ext_LH_P2_1_1 _lh_lex_ext_Func_0_2) _lh_lex_ext_Func_1_2) _lh_lex_ext_arg1_2) lexico_2)))) in
                                              (fun _lh_lex_ext_arg1_3 lexico_3 -> 
                                                (((_lh_lex_ext_LH_P2_0_0 _lh_lex_ext_LH_P2_1_0) _lh_lex_ext_arg1_3) lexico_3)))))))))))))))) in
                          ((((((_lh_matchIdent_8 _lh_rpo_Func_0_2) _lh_rpo_Func_0_1) _lh_rpo_Func_1_2) _lh_rpo_Func_1_1) _lh_rpo_arg2_0) rpo'_0))
                      | _ -> 
                        ((failwith "error") (`LH_C('e', (`LH_C('r', (`LH_C('r', (`LH_C('o', (`LH_C('r', (`LH_N)))))))))))))
                  | _ -> 
                    ((failwith "error") (`LH_C('e', (`LH_C('r', (`LH_C('r', (`LH_C('o', (`LH_C('r', (`LH_N)))))))))))))
      ...
      and split_0 = (fun _lh_split_arg1_0 _lh_split_arg2_0 -> 
        (let rec tmp_0 = ((zip_lh ((map_lh _lh_split_arg1_0) _lh_split_arg2_0)) _lh_split_arg2_0) in
          (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
            ...
            (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
              ...
              (fun _lh_process2_arg1_1 _lh_process2_arg2_1 _lh_process2_arg4_1 _lh_process2_arg5_1 _lh_process2_arg6_1 add_agenda_1 add_eqn_1 all_crit_pairs_1 process_1 resolve_1 super_reduce_1 -> 
                (let rec net'_0 = ((add_eqn_1 ((delete_eqns_lh ((map_lh eqno_lh) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_1)) _lh_process2_arg6_1) in
                  (let rec deletions_0 = ((map_lh eqpr_lh) _lh_process2_LH_P2_0_0) in
                    (let rec critical_0 = ((all_crit_pairs_1 _lh_process2_arg6_1) _lh_process2_LH_P2_1_0) in
                      (let rec new_agenda_0 = (sift_lh ((map_lh (resolve_1 (super_reduce_1 net'_0))) ((mappend_lh deletions_0) critical_0))) in
                        (let rec todo'_0 = (((add_agenda_1 (snd_lh _lh_process2_arg1_1)) new_agenda_0) _lh_process2_arg5_1) in
                          (((((process_1 _lh_process2_arg1_1) _lh_process2_arg2_1) ((mappend_lh _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_1, (`LH_N))))) net'_0) todo'_0)))))))))))
      and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_2 -> 
        ((lift_lh ((cross_lh _lh_build_arg1_0) (fun x_6 -> 
          x_6))) (_lh_build_arg2_0 _lh_funcomp_x_2)))
      ...
      and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
        (((orElseMap_lh p_name_0) ((seQ_0 (fun x_7 -> 
          ((atIndex_lh 1) x_7))) (`LH_C((look_for_0 '('), (`LH_C(p_expr_0, (`LH_C((look_for_0 ')'), (`LH_N))))))))) _lh_p_prim_arg1_0))
      ...
      and lex_ext_0 = (fun _lh_lex_ext_arg1_0 _lh_lex_ext_arg2_0 -> 
        ((_lh_lex_ext_arg2_0 _lh_lex_ext_arg1_0) lexico_0))
      ...
      and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
        (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh (((seq2Lzq_0 (fun x_1_5 y_2 -> 
      ...
      and sp_0 = (fun _lh_sp_arg1_0 _lh_funcomp_x_1_1 -> 
        (_lh_sp_arg1_0 ((dropWhile_lh (fun x_1_6 -> 
          (x_1_6 = ' '))) _lh_funcomp_x_1_1)))
      ...
      and process2_0 = (fun _lh_process2_arg1_0 _lh_process2_arg2_0 _lh_process2_arg3_0 _lh_process2_arg4_0 _lh_process2_arg5_0 _lh_process2_arg6_0 -> 
        (let rec _lh_matchIdent_2 = ((split_0 (reducible_0 (reduce1_lh _lh_process2_arg6_0))) _lh_process2_arg3_0) in
          (((((((((((_lh_matchIdent_2 _lh_process2_arg1_0) _lh_process2_arg2_0) _lh_process2_arg4_0) _lh_process2_arg5_0) _lh_process2_arg6_0) add_agenda_0) add_eqn_0) all_crit_pairs_0) process_0) resolve_0) super_reduce_0)))
                    ...
                    ((multi_0 _lh_multi_ext_arg1_0) (let rec _lh_multi_LH_P2_1_0 = _lh_multi_ext_Func_1_1 in
                      (let rec _lh_multi_LH_P2_0_0 = _lh_multi_ext_Func_1_0 in
                        (fun _lh_multi_arg1_0 dominates_1 rem_eq_1 -> 
                          (let rec _lh_matchIdent_3 = ((rem_eq_1 (eqRewrite_lh _lh_multi_arg1_0)) (`LH_P2(_lh_multi_LH_P2_0_0, _lh_multi_LH_P2_1_0))) in
          ...
          (let rec _lh_matchIdent_4 = xs_3 in
            (match _lh_matchIdent_4 with
              | `LH_P2(_lh_seq2_LH_P2_0_0, _lh_seq2_LH_P2_1_0) -> 
                ((lift_lh ((cross_lh (_lh_seq2_arg1_0 _lh_seq2_LH_P2_0_0)) (fun x_1_0 -> 
                  x_1_0))) (_lh_seq2_arg3_0 _lh_seq2_LH_P2_1_0))
              | _ -> 
                (failwith "error")))) in
          (fun _lh_funcomp_x_3 -> 
            ((fun _lh_funcomp_x_4 -> 
              (squash_lh ((lift_lh g_0) _lh_funcomp_x_4))) (_lh_seq2_arg2_0 _lh_funcomp_x_3)))))
        ...
        ((fun _lh_funcomp_x_8 -> 
          ((fun _lh_funcomp_x_9 -> 
            ((fun _lh_funcomp_x_1_0 -> 
              (unExpr_0 (fst_lh _lh_funcomp_x_1_0))) (the_lh _lh_funcomp_x_9))) (p_expr_0 _lh_funcomp_x_8))) _lh_parse_arg1_0))

...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_QueenBuiltInType" (fun () -> ignore (let open Module_original in ((testQueenBuiltInType__d0 11))));
  Bench.Test.create ~name:"lumberhack_QueenBuiltInType" (fun () -> ignore (let open Module_lumberhack in ((testQueenBuiltInType__d0 11))));
  Bench.Test.create ~name:"lumberhack_pop_out_QueenBuiltInType" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testQueenBuiltInType__d0 11))));
])

...
let rec map_lh__d1 f_2_2 ls_7 =
  (ls_7 f_2_2);;
let rec start_lh__d1 ys_6_0 f_1_8 n_4_1 =
...
let rec foldr_lh__d1 f_1_9 i_0 ls_1 =
  ((ls_1 f_1_9) i_0);;
let rec map_lh__d5 f_2_5 ls_8 _lh_popOutId_0_2 _lh_popOutId_1_0 =
  (match ls_8 with
    | `LH_C(h_1_1_3, t_1_1_3) -> 
      (let rec t_1_1_4 = ((map_lh__d5 f_2_5) t_1_1_3) in
        (let rec h_1_1_4 = (f_2_5 h_1_1_3) in
          ((_lh_popOutId_0_2 h_1_1_4) (((foldr_lh__d1 _lh_popOutId_0_2) _lh_popOutId_1_0) t_1_1_4))))
    | `LH_N -> 
      _lh_popOutId_1_0);;
...
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec map_lh__d4 f_3_2 ls_1_0 _lh_popOutId_0_5 =
  (match ls_1_0 with
...
let rec copy_lh__d3 _lh_copy_arg1_3 _lh_copy_arg2_3 _lh_popOutId_0_4 _lh_popOutId_1_1 =
    ...
    | _ -> 
      (let rec t_1_1_7 = ((copy_lh__d3 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
        (let rec h_1_1_7 = _lh_copy_arg2_3 in
          (let rec t_1_1_8 = ((map_lh__d1 _lh_popOutId_0_4) t_1_1_7) in
            (let rec h_1_1_8 = (_lh_popOutId_0_4 h_1_1_7) in
              (`LH_C(h_1_1_8, ((take_lh__d2 (_lh_popOutId_1_1 - 1)) t_1_1_8))))))));;
...
let rec limit_lh__d1 _lh_limit_arg1_0 =
  (let rec _lh_matchIdent_1 = (Lazy.force _lh_limit_arg1_0) in
    (match _lh_matchIdent_1 with
      ...
      | _ -> 
        (failwith "error")));;
let rec copy_lh__d1 _lh_copy_arg1_1 _lh_copy_arg2_1 _lh_popOutId_0_1 =
    ...
    | _ -> 
      (let rec t_1_0_4 = ((copy_lh__d1 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
        (let rec h_1_0_4 = _lh_copy_arg2_1 in
          (`LH_C(h_1_0_4, ((take_lh__d1 (_lh_popOutId_0_1 - 1)) t_1_0_4))))));;
let rec iterate_lh__d1 f_2_8 x_0 =
  (lazy (`LH_C(x_0, ((iterate_lh__d1 f_2_8) (f_2_8 x_0)))));;
let rec copy_lh__d2 _lh_copy_arg1_2 _lh_copy_arg2_2 _lh_popOutId_0_3 =
      ...
      (fun n_4_6 -> 
        (let rec t_1_1_5 = ((copy_lh__d2 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
          (let rec h_1_1_5 = _lh_copy_arg2_2 in
            (let rec t_1_1_6 = ((mappend_lh__d2 t_1_1_5) _lh_popOutId_0_3) in

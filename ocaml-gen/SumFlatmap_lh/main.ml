...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_inlined_SumFlatmap_lh" (fun () -> ignore (let open Module_lumberhack_inlined_______.Module_lumberhack_inlined_______ in ((testSumFlatmap_lh__d1 100000))));
  Bench.Test.create ~name:"lumberhack_flo_out_SumFlatmap_lh" (fun () -> ignore (let open Module_lumberhack_flo_out_______.Module_lumberhack_flo_out_______ in ((testSumFlatmap_lh__d1 100000))));
])

...
let rec mappend_lh__d1_d8 xs_4 ys_1_5 =
  (match xs_4 with
    | `LH_C(h_7, t_9) -> 
      (`LH_C(h_7, ((mappend_lh__d1_d8 t_9) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
    ...
    | `LH_C(h_1_8, t_2_8) -> 
      (let rec t_2_9 = ((mappend_lh__d1_d4 t_2_8) ys_3_0) in
        (let rec h_1_9 = h_1_8 in
          (fun ys_3_1 -> 
            (`LH_C(h_1_9, (t_2_9 ys_3_1))))))
    | `LH_N -> 
      ys_3_0);;
let rec mappend_lh__d2_d0 xs_1_4 ys_3_6 =
  (match xs_1_4 with
    | `LH_C(h_2_2, t_3_2) -> 
      (`LH_C(h_2_2, ((mappend_lh__d2_d0 t_3_2) ys_3_6)))
    | `LH_N -> 
      ys_3_6);;
...
let rec showFourTupleofInt_lh__d2 _lh_showFourTupleofInt_arg1_1 =
  (match _lh_showFourTupleofInt_arg1_1 with
    | `LH_P4(_lh_showFourTupleofInt_LH_P4_0_1, _lh_showFourTupleofInt_LH_P4_1_1, _lh_showFourTupleofInt_LH_P4_2_1, _lh_showFourTupleofInt_LH_P4_3_1) -> 
      ((mappend_lh__d1_d9 ((mappend_lh__d2_d0 ((mappend_lh__d1_d8 (((mappend_lh__d1_d5 (((mappend_lh__d1_d4 ((let rec t_3_6 = (fun ys_4_3 -> 
        ys_4_3) in
        (let rec h_2_6 = '(' in
          (fun ys_4_4 -> 
            (`LH_C(h_2_6, (t_3_6 ys_4_4)))))) (string_of_int _lh_showFourTupleofInt_LH_P4_0_1))) (let rec t_3_7 = (fun ys_4_5 -> 
        ys_4_5) in
        (let rec h_2_7 = ',' in
          (fun ys_4_6 -> 
            (`LH_C(h_2_7, (t_3_7 ys_4_6))))))) (string_of_int _lh_showFourTupleofInt_LH_P4_1_1))) (let rec t_3_8 = (fun ys_4_7 -> 
        ys_4_7) in
        (let rec h_2_8 = ',' in
          (fun ys_4_8 -> 
            (`LH_C(h_2_8, (t_3_8 ys_4_8))))))) (string_of_int _lh_showFourTupleofInt_LH_P4_2_1))) (`LH_C(',', (`LH_N))))) (string_of_int _lh_showFourTupleofInt_LH_P4_3_1))) (let rec t_3_9 = (fun ys_4_9 -> 
        ys_4_9) in
        (let rec h_2_9 = ')' in
          (fun ys_5_0 -> 
            (let rec t_4_0 = (t_3_9 ys_5_0) in
              (fun _lh_dummy_1_2 -> 
                (1 + (t_4_0 99))))))))
    | _ -> 
      (failwith "error"));;
...
let rec showFourTupleofInt_lh__d1 _lh_showFourTupleofInt_arg1_0 =
  (match _lh_showFourTupleofInt_arg1_0 with
    | `LH_P4(_lh_showFourTupleofInt_LH_P4_0_0, _lh_showFourTupleofInt_LH_P4_1_0, _lh_showFourTupleofInt_LH_P4_2_0, _lh_showFourTupleofInt_LH_P4_3_0) -> 
      ((mappend_lh__d8 (((mappend_lh__d1_d0 (((mappend_lh__d5 (((mappend_lh__d6 ((let rec t_3 = (fun ys_4 -> 
        ys_4) in
        (let rec h_2 = '(' in
          (fun ys_5 -> 
            (`LH_C(h_2, (t_3 ys_5)))))) (string_of_int _lh_showFourTupleofInt_LH_P4_0_0))) (let rec t_4 = (fun ys_6 -> 
        ys_6) in
        (let rec h_3 = ',' in
          (fun ys_7 -> 
            (`LH_C(h_3, (t_4 ys_7))))))) (string_of_int _lh_showFourTupleofInt_LH_P4_1_0))) (let rec t_5 = (fun ys_8 -> 
        ys_8) in
        (let rec h_4 = ',' in
          (fun ys_9 -> 
            (`LH_C(h_4, (t_5 ys_9))))))) (string_of_int _lh_showFourTupleofInt_LH_P4_2_0))) (let rec t_6 = (fun ys_1_0 -> 
        ys_1_0) in
        (let rec h_5 = ',' in
          (fun ys_1_1 -> 
            (`LH_C(h_5, (t_6 ys_1_1))))))) (string_of_int _lh_showFourTupleofInt_LH_P4_3_0))) (let rec t_7 = (fun ys_1_2 -> 
        ys_1_2) in
        (let rec h_6 = ')' in
          (fun ys_1_3 -> 
            (let rec t_8 = (t_7 ys_1_3) in
              (fun _lh_dummy_1 -> 
                (1 + (t_8 99))))))))
    | _ -> 
      (failwith "error"));;
        ...
        (match _lh_showl_arg1_0 with
          ...
          | `LH_C(_lh_showl_LH_C_0_0, _lh_showl_LH_C_1_0) -> 
            ((fun _lh_funcomp_x_0 -> 
              ((fun _lh_funcomp_x_1 -> 
                ((fun s_0 -> 
                  ((let rec t_1_6 = (let rec t_1_7 = (fun ys_1_8 -> 
                    ys_1_8) in
                    (let rec h_1_0 = '|' in
                      (fun ys_1_9 -> 
                        (let rec t_1_8 = (t_1_7 ys_1_9) in
                          (fun _lh_dummy_7 -> 
                            (1 + (t_1_8 99))))))) in
                    (let rec h_1_1 = ',' in
                      (fun ys_2_0 -> 
                        (let rec t_1_9 = (t_1_6 ys_2_0) in
                          (fun _lh_dummy_8 -> 
                            (1 + (t_1_9 99))))))) s_0)) ((fun s_1 -> 
                  ((showFourTupleofInt_lh__d2 _lh_showl_LH_C_0_0) s_1)) _lh_funcomp_x_1))) ((showl_0 _lh_showl_LH_C_1_0) _lh_funcomp_x_0))) _lh_showl_arg2_0)
          | _ -> 
            (failwith "error"))) in
        ((fun _lh_funcomp_x_2 -> 
          ((fun _lh_funcomp_x_3 -> 
            ((fun s_2 -> 
              ((let rec t_2_0 = (let rec t_2_1 = (fun ys_2_1 -> 
                ys_2_1) in
                (let rec h_1_2 = '|' in
                  (fun ys_2_2 -> 
                    (let rec t_2_2 = (t_2_1 ys_2_2) in
                      (fun _lh_dummy_9 -> 
                        (1 + (t_2_2 99))))))) in
                (let rec h_1_3 = '[' in
                  (fun ys_2_3 -> 
                    (let rec t_2_3 = (t_2_0 ys_2_3) in
                      (fun _lh_dummy_1_0 -> 
                        (1 + (t_2_3 99))))))) s_2)) ((fun s_3 -> 
              ((showFourTupleofInt_lh__d1 _lh_fmt_LH_C_0_0) s_3)) _lh_funcomp_x_3))) ((showl_0 _lh_fmt_LH_C_1_0) _lh_funcomp_x_2))) (fun _lh_dummy_1_1 -> 
          0)))
    | _ -> 
      (failwith "error"));;
...
let rec rot_lh__d4 _lh_rot_arg1_1 _lh_rot_arg2_1 _lh_rot_arg3_1 _lh_rot_arg4_1 =
  (((_lh_rot_arg1_1 ((vec_add_lh__d4 _lh_rot_arg2_1) _lh_rot_arg3_1)) _lh_rot_arg4_1) ((let rec _lh_vec_sub_LH_P2_1_2 = 0 in
...
let rec rot_lh__d1 _lh_rot_arg1_3 _lh_rot_arg2_3 _lh_rot_arg3_3 _lh_rot_arg4_3 =
  (((_lh_rot_arg1_3 ((vec_add_lh__d1 _lh_rot_arg2_3) _lh_rot_arg3_3)) _lh_rot_arg4_3) ((let rec _lh_vec_sub_LH_P2_1_6 = 0 in
...
let rec rot_lh__d3 _lh_rot_arg1_0 _lh_rot_arg2_0 _lh_rot_arg3_0 _lh_rot_arg4_0 =
  (((_lh_rot_arg1_0 (_lh_rot_arg2_0 _lh_rot_arg3_0)) _lh_rot_arg4_0) ((let rec _lh_vec_sub_LH_P2_1_0 = 0 in
...
let rec rot_lh__d6 _lh_rot_arg1_7 _lh_rot_arg2_7 _lh_rot_arg3_7 _lh_rot_arg4_7 =
  (((_lh_rot_arg1_7 ((vec_add_lh__d6 _lh_rot_arg2_7) _lh_rot_arg3_7)) _lh_rot_arg4_7) ((let rec _lh_vec_sub_LH_P2_1_1_4 = 0 in
...
let rec rot_lh__d2 _lh_rot_arg1_8 _lh_rot_arg2_8 _lh_rot_arg3_8 _lh_rot_arg4_8 =
  (((_lh_rot_arg1_8 (_lh_rot_arg2_8 _lh_rot_arg3_8)) _lh_rot_arg4_8) ((let rec _lh_vec_sub_LH_P2_1_1_6 = 0 in
...
let rec rot_lh__d5 _lh_rot_arg1_9 _lh_rot_arg2_9 _lh_rot_arg3_9 _lh_rot_arg4_9 =
  (((_lh_rot_arg1_9 (_lh_rot_arg2_9 _lh_rot_arg3_9)) _lh_rot_arg4_9) ((let rec _lh_vec_sub_LH_P2_1_1_8 = 0 in
...
let rec rot_lh__d1_d0 _lh_rot_arg1_4 _lh_rot_arg2_4 _lh_rot_arg3_4 _lh_rot_arg4_4 =
  (((_lh_rot_arg1_4 ((vec_add_lh__d7 _lh_rot_arg2_4) _lh_rot_arg3_4)) _lh_rot_arg4_4) ((let rec _lh_vec_sub_LH_P2_1_8 = 0 in
...
let rec tile_to_grid_lh__d1 _lh_tile_to_grid_arg1_0 _lh_grid_arg4_2_4_5 _lh_grid_arg5_2_4_5 _lh_grid_arg6_2_4_5 =
  (let rec _lh_listcomp_fun_2_4_5 = (fun _lh_listcomp_fun_para_1 -> 
    ((((((_lh_listcomp_fun_para_1 16) 16) _lh_grid_arg4_2_4_5) _lh_grid_arg5_2_4_5) _lh_grid_arg6_2_4_5) _lh_listcomp_fun_2_4_5)) in
    (_lh_listcomp_fun_2_4_5 _lh_tile_to_grid_arg1_0));;
...
let rec rot_lh__d7 _lh_rot_arg1_5 _lh_rot_arg2_5 _lh_rot_arg3_5 _lh_rot_arg4_5 =
  (((_lh_rot_arg1_5 ((vec_add_lh__d7 _lh_rot_arg2_5) _lh_rot_arg3_5)) _lh_rot_arg4_5) ((let rec _lh_vec_sub_LH_P2_1_1_0 = 0 in
...
let rec rot_lh__d8 _lh_rot_arg1_6 _lh_rot_arg2_6 _lh_rot_arg3_6 _lh_rot_arg4_6 =
  (((_lh_rot_arg1_6 ((vec_add_lh__d7 _lh_rot_arg2_6) _lh_rot_arg3_6)) _lh_rot_arg4_6) ((let rec _lh_vec_sub_LH_P2_1_1_2 = 0 in
...
let rec rot_lh__d9 _lh_rot_arg1_2 _lh_rot_arg2_2 _lh_rot_arg3_2 _lh_rot_arg4_2 =
  (((_lh_rot_arg1_2 ((vec_add_lh__d7 _lh_rot_arg2_2) _lh_rot_arg3_2)) _lh_rot_arg4_2) ((let rec _lh_vec_sub_LH_P2_1_4 = 0 in
...
let rec map_lh__d1 f_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_2_3, t_3_3) -> 
      (`LH_C((f_0 h_2_3), ((map_lh__d1 f_0) t_3_3)))
    | `LH_N -> 
      (`LH_N));;

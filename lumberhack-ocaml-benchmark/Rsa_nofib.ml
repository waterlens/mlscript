      ...
      (match _lh_collect_arg2_0 with
        | `LH_N -> 
          (fun f_6 f_7 -> 
            (`LH_N))
        | _ -> 
          (let rec h_6 = ((take_d0_d0 _lh_collect_arg1_0) _lh_collect_arg2_0) in
            (let rec t_6 = ((collect_d0_d0 _lh_collect_arg1_0) ((drop_d0_d0 _lh_collect_arg1_0) _lh_collect_arg2_0)) in
              (fun f_8 -> 
                (let rec h_7 = (f_8 h_6) in
                  (let rec t_7 = ((map_d0_d0 f_8) t_6) in
                    (fun f_9 -> 
                      (`LH_C((f_9 h_7), ((map_d1_d0 f_9) t_7)))))))))))
...
let rec foldl_d0_d0_d0 f_1_2 i_4 ls_5 =
  ((ls_5 f_1_2) i_4);;
let rec foldl_d0_d0_d1 f_2_4 i_8 ls_1_0 =
  ((ls_1_0 f_2_4) i_8);;
let rec length_d0_d0_d0 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_6, t_1_6) -> 
      (1 + (length_d0_d0_d0 t_1_6))
    | `LH_N -> 
      0);;
let rec mappend_d0_d0_d0 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C(h_1_3, ((mappend_d0_d0_d0 t_1_3) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec mappend_d0_d1_d0 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_1_9, t_1_9) -> 
      (`LH_C(h_1_9, ((mappend_d0_d1_d0 t_1_9) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec mappend_d1_d0_d0 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_d1_d0_d0 t_1_0) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec map_d0_d0_d0 f_1_9 ls_6 =
  (ls_6 f_1_9);;
let rec map_d0_d0_d1 f_2_6 ls_1_2 =
  (ls_1_2 f_2_6);;
let rec map_d1_d0_d0 f_2_0 ls_7 =
  (ls_7 f_2_0);;
let rec map_d1_d0_d1 f_2_5 ls_1_1 =
  (ls_1_1 f_2_5);;
    ...
    | _ -> 
      (match _lh_collect_arg2_1 with
        | `LH_N -> 
          (`LH_N)
        | _ -> 
          (let rec h_1_1 = ((take_d0_d0_d0 _lh_collect_arg1_1) _lh_collect_arg2_1) in
            (let rec t_1_1 = ((collect_d0_d0_d0 _lh_collect_arg1_1) ((drop_d0_d0_d0 _lh_collect_arg1_1) _lh_collect_arg2_1)) in
              (let rec h_1_2 = (_lh_popOutId_0_3 h_1_1) in
                (let rec t_1_2 = ((map_d0_d0_d0 _lh_popOutId_0_3) t_1_1) in
                  (`LH_C((_lh_popOutId_1_3 h_1_2), ((map_d1_d0_d0 _lh_popOutId_1_3) t_1_2)))))))))
and concat_d0_d0_d0 lss_3 =
  (match lss_3 with
    | `LH_C(h_1_5, t_1_5) -> 
      ((mappend_d0_d1_d0 h_1_5) (concat_d0_d1_d0 t_1_5))
    | `LH_N -> 
      (`LH_N))
...
and take_d0_d0_d0 n_1 ls_9 _lh_popOutId_0_1 _lh_popOutId_1_1 =
  (if (n_1 > 0) then
    (match ls_9 with
      | `LH_C(h_1_7, t_1_7) -> 
        (let rec h_1_8 = h_1_7 in
          (let rec t_1_8 = ((take_d0_d0_d0 (n_1 - 1)) t_1_7) in
            (((foldl_d0_d0_d1 _lh_popOutId_0_1) ((_lh_popOutId_0_1 _lh_popOutId_1_1) h_1_8)) t_1_8)))
      | `LH_N -> 
        _lh_popOutId_1_1)
  else
    _lh_popOutId_1_1)

...
Command_unix.run (Bench.make_command [
  ...
  (_lh_listcomp_fun_0 (let rec _lh_listcomp_fun_ls_t_0 = (fun _lh_listcomp_fun_1 _lh_testParaffins_nofib_arg1_0 -> 
    (`LH_N)) in
    (let rec _lh_listcomp_fun_ls_h_0 = (radical_generator_lh__d1 16) in
      (fun _lh_listcomp_fun_2 _lh_testParaffins_nofib_arg1_1 -> 
        (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_1 -> 
          ((((_lh_listcomp_fun_para_1 _lh_listcomp_fun_ls_h_0) _lh_listcomp_fun_3) _lh_listcomp_fun_ls_t_0) _lh_listcomp_fun_2)) in
          (_lh_listcomp_fun_3 ((enumFromTo_lh__d1 0) _lh_testParaffins_nofib_arg1_1)))))))), (let rec radicals_0 = (radical_generator_lh__d4 (16 / 2)) in
  (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_2 -> 
    ((_lh_listcomp_fun_para_2 _lh_listcomp_fun_4) radicals_0)) in
    (_lh_listcomp_fun_4 ((enumFromTo_lh__d4 1) 16)))), (let rec radicals_1 = (radical_generator_lh__d3 (16 / 2)) in
  (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_3 -> 
    ((_lh_listcomp_fun_para_3 _lh_listcomp_fun_5) radicals_1)) in
    (_lh_listcomp_fun_5 ((enumFromTo_lh__d3 1) 16)))), (let rec radicals_2 = (radical_generator_lh__d2 (16 / 2)) in
  (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_4 -> 
    ((_lh_listcomp_fun_para_4 _lh_listcomp_fun_6) radicals_2)) in
    (_lh_listcomp_fun_6 ((enumFromTo_lh__d2 1) 16)))))))));

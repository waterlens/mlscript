...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_SumSquareTree" (fun () -> ignore (let open Module_lumberhack_________.Module_lumberhack_________ in ((testSumSquareTree__d0 18))));
  Bench.Test.create ~name:"lumberhack_pop_out_SumSquareTree" (fun () -> ignore (let open Module_lumberhack_pop_out_.Module_lumberhack_pop_out_ in ((testSumSquareTree__d0 18))));
])

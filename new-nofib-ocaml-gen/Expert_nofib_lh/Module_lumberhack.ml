    ...
    (let rec _lh_listcomp_fun_ls_t_1_3 = ((enumFromTo_lh (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_1_2 = a_0 in
        (fun _lh_listcomp_fun_1_6 -> 
          (`LH_C((`LH_C('X', (string_of_int _lh_listcomp_fun_ls_h_1_2))), (_lh_listcomp_fun_1_6 _lh_listcomp_fun_ls_t_1_3))))))
  else
...
let rec process_lh _lh_process_arg1_0 _lh_process_arg2_0 =
  let rec info_0 = (fun _lh_info_arg1_0 _lh_info_arg2_0 -> 
    ((enterList_lh newTable_lh) (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_3 -> 
      (match _lh_listcomp_fun_para_3 with
            ...
            | `LH_P2(_lh_info_LH_P2_0_0, _lh_info_LH_P2_1_0) -> 
              (match _lh_info_LH_P2_0_0 with
                | `Question(_lh_info_Question_0_0) -> 
                  (`LH_C((`LH_P2(_lh_info_Question_0_0, _lh_info_LH_P2_1_0)), (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_3)))
                | _ -> 
        ...
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_5 ((zip_lh ((results_0 _lh_info_arg1_0) _lh_info_arg2_0)) (replies_0 _lh_info_arg2_0))))))
  ...
  and newsoln_0 = (`Soln(newTable_lh, (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_4 -> 
    (_lh_listcomp_fun_para_4 _lh_listcomp_fun_6)) in
    (_lh_listcomp_fun_6 ((enumFromTo_lh 0) 1)))))
  and replies_0 = (fun _lh_replies_arg1_0 -> 
    (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_2 -> 
      (match _lh_listcomp_fun_para_2 with
        | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
          (`LH_C(((words_lh _lh_listcomp_fun_ls_h_2) <> (`LH_C((`LH_C('n', (`LH_C('o', (`LH_N))))), (`LH_N)))), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_2)))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_4 (lines_lh _lh_replies_arg1_0))))

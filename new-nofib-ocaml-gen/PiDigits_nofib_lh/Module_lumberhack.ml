...
let rec min__d0 _lh_min_arg1_0 _lh_min_arg2_0 =
  (if (_lh_min_arg1_0 > _lh_min_arg2_0) then
    ...
    _lh_min_arg1_0);;
let rec divmod__d0 _lh_divmod_arg1_0 _lh_divmod_arg2_0 =
...
and replicate__d0 _lh_replicate_arg1_0 _lh_replicate_arg2_0 =
  (if (_lh_replicate_arg1_0 > 0) then
    ...
    (fun _lh_dummy_2 ys_2_6 -> 
      ys_2_6))
and splitAt_lz__d0 _lh_splitAt_lz_arg1_0 _lh_splitAt_lz_arg2_0 =
...
and take_lz__d0 n_1 ls_1 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_1) with
      ...
      | `LH_N -> 
        (fun _lh_dummy_4 ys_2_7 -> 
          ys_2_7))
  else
    (fun _lh_dummy_5 ys_2_8 -> 
      ys_2_8))
and take_lz__d1 n_0 ls_0 =
  (if (n_0 > 0) then
    (match (Lazy.force ls_0) with
      | `LH_C(h_0, t_0) -> 
        (let rec t_1 = ((take_lz__d1 (n_0 - 1)) t_0) in
          (let rec h_1 = h_0 in
            (fun ys_0 -> 
              (let rec t_2 = ((mappend__d1 t_1) ys_0) in
                (let rec h_2 = h_1 in
                  (fun _lh_dummy_0 -> 

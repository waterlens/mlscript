...
(* lumberhack_pop_out *)
let rec abs_d0_d0_d0_d0 _lh_abs_arg1_3 =
  (if (_lh_abs_arg1_3 < 0) then
    (0 - _lh_abs_arg1_3)
  else
    _lh_abs_arg1_3);;
let rec abs_d0_d0_d0_d1 _lh_abs_arg1_1 =
  (if (_lh_abs_arg1_1 < 0) then
    (0 - _lh_abs_arg1_1)
  else
    _lh_abs_arg1_1);;
...
let rec map_d0_d0_d1_d0 f_1_0 ls_4 =
  (ls_4 f_1_0);;
let rec map_d1_d0_d0_d0 f_1_4 ls_6 =
  (ls_6 f_1_4);;
let rec map_d1_d0_d1_d0 f_1_1 ls_5 =
  (ls_5 f_1_1);;
        ...
        (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_d1_d0_d0_d0 (a_3 + 1)) b_3) in
          (let rec h_2 = (let rec _lh_f1_LH_P2_0_1 = _lh_popOutId_0_0 in
            (let rec _lh_f1_LH_P2_1_1 = _lh_listcomp_fun_ls_h_5 in
              (fun _lh_dummy_7 -> 
                (let rec _lh_f2_LH_P3_2_6 = ((gcdE_d0_d0_d0_d0 _lh_f1_LH_P2_0_1) _lh_f1_LH_P2_1_1) in
                  (fun _lh_dummy_8 -> 
                    (_lh_f2_LH_P3_2_6 99)))))) in
            (let rec t_2 = (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_5) in
              (let rec h_3 = (f_1_2 h_2) in
                (let rec t_3 = ((map_d0_d0_d0_d0 f_1_2) t_2) in
                  (`LH_C((f_1_3 h_3), ((map_d1_d0_d0_d0 f_1_3) t_3))))))))))
  else
    (_lh_popOutId_3_0 _lh_popOutId_2_0))
and gcdE_d0_d0_d0_d0 _lh_gcdE_arg1_1 _lh_gcdE_arg2_1 =
  (match _lh_gcdE_arg1_1 with
    | 0 -> 
      (let rec _lh_f2_LH_P3_0_3 = _lh_gcdE_arg2_1 in
        (let rec _lh_f2_LH_P3_1_3 = 0 in
          (let rec _lh_f2_LH_P3_2_4 = 1 in
            (fun _lh_dummy_5 -> 
              (abs_d0_d0_d0_d0 ((_lh_f2_LH_P3_0_3 + _lh_f2_LH_P3_1_3) + _lh_f2_LH_P3_2_4))))))
    | _ -> 
      ((g_d0_d0_d0_d0 (let rec _lh_g_LH_P3_0_8 = 1 in
        (let rec _lh_g_LH_P3_1_8 = 0 in
          (let rec _lh_g_LH_P3_2_7 = _lh_gcdE_arg1_1 in
            (fun _lh_g_arg2_3 -> 
              (((_lh_g_arg2_3 _lh_g_LH_P3_0_8) _lh_g_LH_P3_1_8) _lh_g_LH_P3_2_7)))))) (let rec _lh_g_LH_P3_0_9 = 0 in
        (let rec _lh_g_LH_P3_1_9 = 1 in
          (let rec _lh_g_LH_P3_2_8 = _lh_gcdE_arg2_1 in
            (fun _lh_g_LH_P3_0_1_0 _lh_g_LH_P3_1_1_0 _lh_g_LH_P3_2_9 -> 
              (if (_lh_g_LH_P3_2_8 = 0) then
                (let rec _lh_f2_LH_P3_0_4 = _lh_g_LH_P3_2_9 in
                  (let rec _lh_f2_LH_P3_1_4 = _lh_g_LH_P3_0_1_0 in
                    (let rec _lh_f2_LH_P3_2_5 = _lh_g_LH_P3_1_1_0 in
                      (fun _lh_dummy_6 -> 
                        (abs_d0_d0_d0_d1 ((_lh_f2_LH_P3_0_4 + _lh_f2_LH_P3_1_4) + _lh_f2_LH_P3_2_5))))))
              else
                (let rec _lh_matchIdent_2 = ((quotRem_d0_d0_d0_d0 _lh_g_LH_P3_2_9) _lh_g_LH_P3_2_8) in
                  (((((_lh_matchIdent_2 _lh_g_LH_P3_0_1_0) _lh_g_LH_P3_0_9) _lh_g_LH_P3_1_1_0) _lh_g_LH_P3_1_9) _lh_g_LH_P3_2_8)))))))))
and quotRem_d0_d0_d0_d0 _lh_quotRem_arg1_1 _lh_quotRem_arg2_1 _lh_g_LH_P3_0_1_1 _lh_g_LH_P3_0_1_2 _lh_g_LH_P3_1_1_1 _lh_g_LH_P3_1_1_2 _lh_g_LH_P3_2_1_0 =
  (let rec _lh_g_LH_P2_0_1 = (_lh_quotRem_arg1_1 / _lh_quotRem_arg2_1) in
    (let rec _lh_g_LH_P2_1_1 = (_lh_quotRem_arg1_1 mod _lh_quotRem_arg2_1) in
      ((g_d0_d0_d0_d1 (let rec _lh_g_LH_P3_0_1_3 = _lh_g_LH_P3_0_1_2 in
        (let rec _lh_g_LH_P3_1_1_3 = _lh_g_LH_P3_1_1_2 in
          (let rec _lh_g_LH_P3_2_1_1 = _lh_g_LH_P3_2_1_0 in
            (fun _lh_g_arg2_5 -> 
              (((_lh_g_arg2_5 _lh_g_LH_P3_0_1_3) _lh_g_LH_P3_1_1_3) _lh_g_LH_P3_2_1_1)))))) (let rec _lh_g_LH_P3_0_1_4 = (_lh_g_LH_P3_0_1_1 - (_lh_g_LH_P2_0_1 * _lh_g_LH_P3_0_1_2)) in
        (let rec _lh_g_LH_P3_1_1_4 = (_lh_g_LH_P3_1_1_1 - (_lh_g_LH_P2_0_1 * _lh_g_LH_P3_1_1_2)) in
          (let rec _lh_g_LH_P3_2_1_2 = _lh_g_LH_P2_1_1 in
                ...
                (let rec _lh_f2_LH_P3_0_5 = _lh_g_LH_P3_2_1_3 in
                  (let rec _lh_f2_LH_P3_1_5 = _lh_g_LH_P3_0_1_5 in
                    (let rec _lh_f2_LH_P3_2_7 = _lh_g_LH_P3_1_1_5 in
                      (fun _lh_dummy_9 -> 
                        (abs_d0_d0_d0_d2 ((_lh_f2_LH_P3_0_5 + _lh_f2_LH_P3_1_5) + _lh_f2_LH_P3_2_7))))))
              else

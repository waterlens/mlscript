...
let rec head_lh__d2 ls_0 =
  (match ls_0 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec mappend_lh__d2_d6 xs_2_4 ys_4_8 =
  (match xs_2_4 with
    | `LH_C(h_3_9, t_4_0) -> 
      (`LH_C(h_3_9, ((mappend_lh__d2_d6 t_4_0) ys_4_8)))
    | `LH_N -> 
      ys_4_8);;
...
let rec mappend_lh__d2_d3 xs_1_3 ys_1_8 =
  (match xs_1_3 with
    ...
    | `LH_N -> 
      ys_1_8);;
let rec mappend_lh__d2_d4 xs_2_2 ys_4_6 =
  (xs_2_2 ys_4_6);;
let rec mappend_lh__d2_d5 xs_2_1 ys_4_0 =
  (match xs_2_1 with
    | `LH_C(h_3_2, t_3_3) -> 
      (let rec t_3_4 = ((mappend_lh__d2_d5 t_3_3) ys_4_0) in
        (let rec h_3_3 = h_3_2 in
          (fun ys_4_1 -> 
            (`LH_C(h_3_3, ((mappend_lh__d2_d4 t_3_4) ys_4_1))))))
    | `LH_N -> 
      ys_4_0);;
...
ppn_lh__d1 _lh_ppn_arg1_1 _lh_ppn_arg2_1 =
  (match _lh_ppn_arg2_1 with
    ...
    | `Lam(_lh_ppn_Lam_0_1, _lh_ppn_Lam_1_1) -> 
      (((bracket_lh__d3 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 (`LH_C('@', (`LH_N)))) _lh_ppn_Lam_0_1)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) ((ppn_lh__d1 (0 - 1)) _lh_ppn_Lam_1_1)))
    | `Add(_lh_ppn_Add_0_1, _lh_ppn_Add_1_1) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_1) 1) ((mappend_lh__d2_d4 ((mappend_lh__d2_d5 ((ppn_lh__d1 1) _lh_ppn_Add_0_1)) (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (fun ys_4_2 -> 
        ys_4_2) in
        (let rec h_3_4 = ' ' in
          (fun ys_4_3 -> 
            (`LH_C(h_3_4, ((mappend_lh__d2_d4 t_3_7) ys_4_3)))))) in
        (let rec h_3_5 = '+' in
          (fun ys_4_4 -> 
            (`LH_C(h_3_5, ((mappend_lh__d2_d4 t_3_6) ys_4_4)))))) in
        (let rec h_3_6 = ' ' in
          (fun ys_4_5 -> 
            (`LH_C(h_3_6, ((mappend_lh__d2_d4 t_3_5) ys_4_5)))))))) ((ppn_lh__d1 1) _lh_ppn_Add_1_1)))
    ...
    | `IfZero(_lh_ppn_IfZero_0_1, _lh_ppn_IfZero_1_1, _lh_ppn_IfZero_2_1) -> 
      (((bracket_lh__d3 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d3 ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 (`LH_C('I', (`LH_C('F', (`LH_C(' ', (`LH_N)))))))) ((ppn_lh__d1 0) _lh_ppn_IfZero_0_1))) (`LH_C(' ', (`LH_C('T', (`LH_C('H', (`LH_C('E', (`LH_C('N', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d1 0) _lh_ppn_IfZero_1_1))) (`LH_C(' ', (`LH_C('E', (`LH_C('L', (`LH_C('S', (`LH_C('E', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d1 0) _lh_ppn_IfZero_2_1)))
    | `Thunk(_lh_ppn_Thunk_0_1, _lh_ppn_Thunk_1_1) -> 
      (((bracket_lh__d1 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 ((ppn_lh__d1 3) _lh_ppn_Thunk_0_1)) (`LH_C(':', (`LH_C(':', (`LH_N))))))) (ppenv_lh__d2 _lh_ppn_Thunk_1_1)))
    | _ -> 
      (failwith "error"));;
...
let rec mappend_lh__d1_d9 xs_9 ys_9 =
  (xs_9 ys_9);;
let rec mappend_lh__d2_d0 xs_1_9 ys_3_4 =
  (match xs_1_9 with
    | `LH_C(h_2_7, t_2_8) -> 
      (let rec t_2_9 = ((mappend_lh__d2_d0 t_2_8) ys_3_4) in
        (let rec h_2_8 = h_2_7 in
          (fun ys_3_5 -> 
            (`LH_C(h_2_8, ((mappend_lh__d2_d1 t_2_9) ys_3_5))))))
    | `LH_N -> 
      ys_3_4);;
let rec mappend_lh__d1_d7 xs_2_3 ys_4_7 =
  (match xs_2_3 with
    | `LH_C(h_3_8, t_3_9) -> 
      (`LH_C(h_3_8, ((mappend_lh__d1_d7 t_3_9) ys_4_7)))
    | `LH_N -> 
      ys_4_7);;
let rec ppenv_lh__d1 _lh_ppenv_arg1_0 =
  ((mappend_lh__d1_d7 ((mappend_lh__d1_d9 (let rec t_2_2 = (fun ys_2_5 -> 
    ys_2_5) in
    (let rec h_2_1 = '[' in
      (fun ys_2_6 -> 
        (`LH_C(h_2_1, ((mappend_lh__d1_d9 t_2_2) ys_2_6))))))) ((flatMap_lh__d1 (fun vt_0 -> 
    (let rec _lh_matchIdent_3 = vt_0 in
      (match _lh_matchIdent_3 with
        | `LH_P2(_lh_ppenv_LH_P2_0_0, _lh_ppenv_LH_P2_1_0) -> 
          ((mappend_lh__d1_d8 ((mappend_lh__d2_d1 ((mappend_lh__d2_d0 _lh_ppenv_LH_P2_0_0) (let rec t_2_3 = (fun ys_2_7 -> 
            ys_2_7) in
            (let rec h_2_2 = '=' in
              (fun ys_2_8 -> 
                (`LH_C(h_2_2, ((mappend_lh__d2_d1 t_2_3) ys_2_8)))))))) (pp_lh__d8 _lh_ppenv_LH_P2_1_0))) (`LH_C(',', (`LH_C(' ', (`LH_N))))))
        | _ -> 
...
eval_lh__d1 _lh_eval_arg1_0 =
  (match _lh_eval_arg1_0 with
    ...
    | `Incr -> 
      ((myBind_lh__d1 (incr_lh__d1 99)) (fun _dummy_2 -> 
...
let rec mappend_lh__d6 xs_1_6 ys_3_0 =
  (match xs_1_6 with
    | `LH_C(h_2_4, t_2_5) -> 
      (let rec t_2_6 = ((mappend_lh__d6 t_2_5) ys_3_0) in
        (let rec h_2_5 = h_2_4 in
          (fun ys_3_1 -> 
            (`LH_C(h_2_5, ((mappend_lh__d5 t_2_6) ys_3_1))))))
    | `LH_N -> 
      ys_3_0);;
    ...
    (let rec _lh_matchIdent_5 = envt2_0 in
      (match _lh_matchIdent_5 with
        | `LH_P2(_lh_ev_LH_P2_0_0, _lh_ev_LH_P2_1_0) -> 
          ((mappend_lh__d5 ((mappend_lh__d6 (pp_lh__d3 _lh_ev_LH_P2_1_0)) (let rec t_3_1 = (let rec t_3_2 = (fun ys_3_7 -> 
            ys_3_7) in
            (let rec h_3_0 = ' ' in
              (fun ys_3_8 -> 
                (`LH_C(h_3_0, ((mappend_lh__d5 t_3_2) ys_3_8)))))) in
            (let rec h_3_1 = ' ' in
              (fun ys_3_9 -> 
                (`LH_C(h_3_1, ((mappend_lh__d5 t_3_1) ys_3_9)))))))) (ppenv_lh__d1 _lh_ev_LH_P2_0_0))
        | _ -> 
          (failwith "error"))));;
...
let rec mappend_lh__d3 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d3 t_4) ys_5)))
    | `LH_N -> 
      ys_5);;
...
let rec mappend_lh__d1_d0 xs_1_0 ys_1_5 =
  (match xs_1_0 with
    ...
    | `LH_N -> 
      ys_1_5);;
let rec mappend_lh__d1_d4 xs_1_5 ys_2_9 =
  (match xs_1_5 with
    | `LH_C(h_2_3, t_2_4) -> 
      (`LH_C(h_2_3, ((mappend_lh__d1_d4 t_2_4) ys_2_9)))
    | `LH_N -> 
      ys_2_9);;
let rec mappend_lh__d1_d1 xs_1_7 ys_3_2 =
  (match xs_1_7 with
    | `LH_C(h_2_6, t_2_7) -> 
      (`LH_C(h_2_6, ((mappend_lh__d1_d1 t_2_7) ys_3_2)))
    | `LH_N -> 
      ys_3_2);;
let rec mappend_lh__d1_d3 xs_2_0 ys_3_6 =
  (match xs_2_0 with
    | `LH_C(h_2_9, t_3_0) -> 
      (`LH_C(h_2_9, ((mappend_lh__d1_d3 t_3_0) ys_3_6)))
    | `LH_N -> 
      ys_3_6);;
...
let rec mappend_lh__d1 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d1 t_5) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec mappend_lh__d2_d2 xs_2_5 ys_4_9 =
  (xs_2_5 ys_4_9);;
let rec showTerm_lh__d2 _lh_showTerm_arg1_1 =
  (match _lh_showTerm_arg1_1 with
    | `Con(_lh_showTerm_Con_0_1) -> 
      ((mappend_lh__d2_d2 (let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (fun ys_2_0 -> 
        ys_2_0) in
        (let rec h_1_7 = ' ' in
          (fun ys_2_1 -> 
            (`LH_C(h_1_7, ((mappend_lh__d2_d2 t_2_1) ys_2_1)))))) in
        (let rec h_1_8 = 'n' in
          (fun ys_2_2 -> 
            (`LH_C(h_1_8, ((mappend_lh__d2_d2 t_2_0) ys_2_2)))))) in
        (let rec h_1_9 = 'o' in
          (fun ys_2_3 -> 
            (`LH_C(h_1_9, ((mappend_lh__d2_d2 t_1_9) ys_2_3)))))) in
        (let rec h_2_0 = 'C' in
          (fun ys_2_4 -> 
            (`LH_C(h_2_0, ((mappend_lh__d2_d2 t_1_8) ys_2_4))))))) (string_of_int _lh_showTerm_Con_0_1))
    | _ -> 
      ((failwith "error") (`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;
...
simpleEval_lh__d1 _lh_simpleEval_arg1_0 _lh_simpleEval_arg2_0 =
  (match _lh_simpleEval_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec mappend_lh__d4 xs_1_8 ys_3_3 =
  (xs_1_8 ys_3_3);;
let rec showTerm_lh__d1 _lh_showTerm_arg1_0 =
  (match _lh_showTerm_arg1_0 with
    | `Con(_lh_showTerm_Con_0_0) -> 
      ((mappend_lh__d4 (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (fun ys_1_0 -> 
        ys_1_0) in
        (let rec h_9 = ' ' in
          (fun ys_1_1 -> 
            (`LH_C(h_9, ((mappend_lh__d4 t_1_2) ys_1_1)))))) in
        (let rec h_1_0 = 'n' in
          (fun ys_1_2 -> 
            (`LH_C(h_1_0, ((mappend_lh__d4 t_1_1) ys_1_2)))))) in
        (let rec h_1_1 = 'o' in
          (fun ys_1_3 -> 
            (`LH_C(h_1_1, ((mappend_lh__d4 t_1_0) ys_1_3)))))) in
        (let rec h_1_2 = 'C' in
          (fun ys_1_4 -> 
            (`LH_C(h_1_2, ((mappend_lh__d4 t_9) ys_1_4))))))) (string_of_int _lh_showTerm_Con_0_0))
    | _ -> 
      ((failwith "error") (`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;

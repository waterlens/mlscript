    ...
    (let rec _lh_matchIdent_7 = ((divmod_lh n_2) _lh_chop_arg1_0) in
      (match _lh_matchIdent_7 with
        ...
        | _ -> 
          (failwith "error")))) in
    (chop'_0 (`LH_N)))
and doInput_lh _lh_doInput_arg1_0 _lh_doInput_arg2_0 =
  (match _lh_doInput_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and doLine_lh _lh_doLine_arg1_0 _lh_doLine_arg2_0 _lh_doLine_arg3_0 =
  (let rec n_1 = (int_val_of_string_lh _lh_doLine_arg1_0) in
    (let rec _lh_matchIdent_0 = (((multiTest_lh 100) _lh_doLine_arg3_0) n_1) in
      (match _lh_matchIdent_0 with
        ...
        | _ -> 
          (failwith "error"))))
and findKQ_lh _lh_findKQ_arg1_0 =
...
and int_val_of_string_lh _lh_int_val_of_string_arg1_0 =
...
and lines_lh _lh_lines_arg1_0 =
  (let rec _lh_matchIdent_1_0 = ((break_lh (fun x_6 -> 
    ...
    (match _lh_matchIdent_1_0 with
      ...
      | _ -> 
        (failwith "error")))
and makeNumber_lh _lh_makeNumber_arg1_0 =
  ((foldl_lh (fun a_0 x_4 -> 
    ((a_0 * _lh_makeNumber_arg1_0) + x_4))) 0)
and multiTest_lh _lh_multiTest_arg1_0 _lh_multiTest_arg2_0 _lh_multiTest_arg3_0 =
...
and powerMod_lh _lh_powerMod_arg1_0 _lh_powerMod_arg2_0 _lh_powerMod_arg3_0 =
...
and process_lh _lh_process_arg1_0 =
  ((doInput_lh ((randomInts_lh 111) 47)) _lh_process_arg1_0)
and randomInts_lh _lh_randomInts_arg1_0 _lh_randomInts_arg2_0 =
...
and random_lh _lh_random_arg1_0 _lh_random_arg2_0 =
  (let rec ns_0 = ((chop_lh 65536) _lh_random_arg1_0) in
    (let rec _lh_matchIdent_5 = ((splitAt_lz_lh (length_lh ns_0)) _lh_random_arg2_0) in
      (match _lh_matchIdent_5 with
        ...
        | _ -> 
          (failwith "error"))))
and singleTestX_lh _lh_singleTestX_arg1_0 _lh_singleTestX_arg2_0 _lh_singleTestX_arg3_0 =
  (match _lh_singleTestX_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and singleTest_lh _lh_singleTest_arg1_0 _lh_singleTest_arg2_0 _lh_singleTest_arg3_0 =
  (let rec _lh_matchIdent_6 = ((random_lh (_lh_singleTest_arg1_0 - 2)) _lh_singleTest_arg3_0) in
    (match _lh_matchIdent_6 with
      ...
      | _ -> 
        (failwith "error")))
and splitAt_lz_lh _lh_splitAt_lz_arg1_0 _lh_splitAt_lz_arg2_0 =
  (`LH_P2(((take_lz_lh _lh_splitAt_lz_arg1_0) _lh_splitAt_lz_arg2_0), ((drop_lz_lh _lh_splitAt_lz_arg1_0) _lh_splitAt_lz_arg2_0)))
and testPrimetest_nofib_lh _lh_testPrimetest_nofib_arg1_0 =
...
and uniform_lh _lh_uniform_arg1_0 _lh_uniform_arg2_0 =

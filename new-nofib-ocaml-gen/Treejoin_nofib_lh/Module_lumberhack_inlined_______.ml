                ...
                (fun _lh_readTree_LH_P2_0_7 _lh_readTree_LH_P2_0_8 _lh_readTree_arg1_6 _lh_readTree_arg3_6 -> 
                  (let rec e_0 = (`LH_P3(_lh_readTree_LH_P2_0_7, _lh_readTree_LH_P2_0_8, _lh_readTree_LH_P2_0_6)) in
                    (let rec k_0 = (_lh_readTree_arg1_6 e_0) in
                      (match _lh_readTree_LH_P2_1_4 with
                        | `LH_N -> 
                          (((insertT_lh__d1 k_0) e_0) _lh_readTree_arg3_6)
                        | _ -> 
                          (let rec _lh_matchIdent_1_1 = (readInt_lh__d3 _lh_readTree_LH_P2_1_4) in
                            ((_lh_matchIdent_1_1 _lh_readTree_arg1_6) (((insertT_lh__d1 k_0) e_0) _lh_readTree_arg3_6)))))))))))
      | _ -> 
              ...
              (fun _lh_readTree_LH_P2_0_1_0 _lh_readTree_LH_P2_0_1_1 _lh_readTree_arg1_7 _lh_readTree_arg3_7 -> 
                (let rec e_1 = (`LH_P3(_lh_readTree_LH_P2_0_1_0, _lh_readTree_LH_P2_0_1_1, _lh_readTree_LH_P2_0_9)) in
                  (let rec k_1 = (_lh_readTree_arg1_7 e_1) in
                    (match _lh_readTree_LH_P2_1_5 with
                      | `LH_N -> 
                        (((insertT_lh__d1 k_1) e_1) _lh_readTree_arg3_7)
                      | _ -> 
                        (let rec _lh_matchIdent_1_2 = (readInt_lh__d3 _lh_readTree_LH_P2_1_5) in
                          ((_lh_matchIdent_1_2 _lh_readTree_arg1_7) (((insertT_lh__d1 k_1) e_1) _lh_readTree_arg3_7)))))))))))) in
            ...
            (let rec _lh_readTree_LH_P2_1_6 = s'_6 in
              (let rec _lh_readTree_LH_P2_0_1_2 = _lh_readInt'_arg1_3 in
                (fun _lh_readTree_arg1_8 _lh_readTree_arg3_8 -> 
                  (let rec _lh_matchIdent_1_3 = (readInt_lh__d2 _lh_readTree_LH_P2_1_6) in
                    (((_lh_matchIdent_1_3 _lh_readTree_LH_P2_0_1_2) _lh_readTree_arg1_8) _lh_readTree_arg3_8)))))))
      | _ -> 
          ...
          (let rec _lh_readTree_LH_P2_1_7 = s'_7 in
            (let rec _lh_readTree_LH_P2_0_1_3 = _lh_readInt'_arg1_3 in
              (fun _lh_readTree_arg1_9 _lh_readTree_arg3_9 -> 
                (let rec _lh_matchIdent_1_4 = (readInt_lh__d2 _lh_readTree_LH_P2_1_7) in
                  (((_lh_matchIdent_1_4 _lh_readTree_LH_P2_0_1_3) _lh_readTree_arg1_9) _lh_readTree_arg3_9)))))))) in
            ...
            (let rec _lh_readTree_LH_P2_1_2 = s'_2 in
              (let rec _lh_readTree_LH_P2_0_4 = _lh_readInt'_arg1_1 in
                (fun _lh_readTree_arg1_3 _lh_readTree_arg3_3 -> 
                  (let rec _lh_matchIdent_7 = (readInt_lh__d5 _lh_readTree_LH_P2_1_2) in
                    (((_lh_matchIdent_7 _lh_readTree_LH_P2_0_4) _lh_readTree_arg1_3) _lh_readTree_arg3_3)))))))
      | _ -> 
          ...
          (let rec _lh_readTree_LH_P2_1_3 = s'_3 in
            (let rec _lh_readTree_LH_P2_0_5 = _lh_readInt'_arg1_1 in
              (fun _lh_readTree_arg1_4 _lh_readTree_arg3_4 -> 
                (let rec _lh_matchIdent_8 = (readInt_lh__d5 _lh_readTree_LH_P2_1_3) in
                  (((_lh_matchIdent_8 _lh_readTree_LH_P2_0_5) _lh_readTree_arg1_4) _lh_readTree_arg3_4)))))))) in
            ...
            (let rec _lh_readTree_LH_P2_1_8 = s'_8 in
              (let rec _lh_readTree_LH_P2_0_1_4 = _lh_readInt'_arg1_4 in
                (fun _lh_readTree_LH_P2_0_1_5 _lh_readTree_arg1_1_0 _lh_readTree_arg3_1_0 -> 
                  (let rec _lh_matchIdent_1_5 = (readInt_lh__d6 _lh_readTree_LH_P2_1_8) in
                    ((((_lh_matchIdent_1_5 _lh_readTree_LH_P2_0_1_4) _lh_readTree_LH_P2_0_1_5) _lh_readTree_arg1_1_0) _lh_readTree_arg3_1_0)))))))
      | _ -> 
          ...
          (let rec _lh_readTree_LH_P2_1_9 = s'_9 in
            (let rec _lh_readTree_LH_P2_0_1_6 = _lh_readInt'_arg1_4 in
              (fun _lh_readTree_LH_P2_0_1_7 _lh_readTree_arg1_1_1 _lh_readTree_arg3_1_1 -> 
                (let rec _lh_matchIdent_1_6 = (readInt_lh__d6 _lh_readTree_LH_P2_1_9) in
                  ((((_lh_matchIdent_1_6 _lh_readTree_LH_P2_0_1_6) _lh_readTree_LH_P2_0_1_7) _lh_readTree_arg1_1_1) _lh_readTree_arg3_1_1)))))))) in
                ...
                (fun _lh_readTree_LH_P2_0_1_9 _lh_readTree_LH_P2_0_2_0 _lh_readTree_arg1_1_2 _lh_readTree_arg3_1_2 -> 
                  (let rec e_2 = (`LH_P3(_lh_readTree_LH_P2_0_2_0, _lh_readTree_LH_P2_0_1_9, _lh_readTree_LH_P2_0_1_8)) in
                    (let rec k_2 = (_lh_readTree_arg1_1_2 e_2) in
                      (match _lh_readTree_LH_P2_1_1_0 with
                        | `LH_N -> 
                          (((insertT_lh__d2 k_2) e_2) _lh_readTree_arg3_1_2)
                        | _ -> 
                          (let rec _lh_matchIdent_1_7 = (readInt_lh__d4 _lh_readTree_LH_P2_1_1_0) in
                            ((_lh_matchIdent_1_7 _lh_readTree_arg1_1_2) (((insertT_lh__d2 k_2) e_2) _lh_readTree_arg3_1_2)))))))))))
      | _ -> 
              ...
              (fun _lh_readTree_LH_P2_0_2_2 _lh_readTree_LH_P2_0_2_3 _lh_readTree_arg1_1_3 _lh_readTree_arg3_1_3 -> 
                (let rec e_3 = (`LH_P3(_lh_readTree_LH_P2_0_2_3, _lh_readTree_LH_P2_0_2_2, _lh_readTree_LH_P2_0_2_1)) in
                  (let rec k_3 = (_lh_readTree_arg1_1_3 e_3) in
                    (match _lh_readTree_LH_P2_1_1_1 with
                      | `LH_N -> 
                        (((insertT_lh__d2 k_3) e_3) _lh_readTree_arg3_1_3)
                      | _ -> 
                        (let rec _lh_matchIdent_1_8 = (readInt_lh__d4 _lh_readTree_LH_P2_1_1_1) in
                          ((_lh_matchIdent_1_8 _lh_readTree_arg1_1_3) (((insertT_lh__d2 k_3) e_3) _lh_readTree_arg3_1_3)))))))))))) in
            ...
            | `Leaf(_lh_join_Leaf_0_0, _lh_join_Leaf_1_0) -> 
              (match _lh_join_Leaf_1_0 with
                | `LH_P3(_lh_join_LH_P3_0_4, _lh_join_LH_P3_1_4, _lh_join_LH_P3_2_4) -> 
                  (let rec _lh_matchIdent_1_0 = ((lookupT_lh__d1 _lh_join_LH_P3_2_4) _lh_join_arg2_0) in
                    ((((_lh_matchIdent_1_0 _lh_join_arg3_3) _lh_join_LH_P3_0_4) _lh_join_LH_P3_1_4) _lh_join_LH_P3_2_4))
                | _ -> 
                  (match _lh_join_arg1_0 with
...
let rec testTreejoin_nofib_lh__d1 _lh_testTreejoin_nofib_arg1_0 =
  (let rec c1_0 = lh_large_str_0 in
    (let rec c2_0 = lh_large_str_1 in
      (let rec a_0 = (match c1_0 with
        | `LH_N -> 
          (`Empty)
        | _ -> 
          (let rec _lh_matchIdent_2 = (readInt_lh__d3 c1_0) in
            ((_lh_matchIdent_2 (fun x___0 -> 
              (let rec _lh_matchIdent_3 = x___0 in
        ...
        (let rec b_0 = (match c2_0 with
          | `LH_N -> 
            (`Empty)
          | _ -> 
            (let rec _lh_matchIdent_4 = (readInt_lh__d4 c2_0) in
              ((_lh_matchIdent_4 (fun x___1 -> 
                (let rec _lh_matchIdent_5 = x___1 in

(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./Mapmap.ml -o "./Mapmap.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./Mapmap.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;
  ...
  (match ls_3 with
    | `C(h_1, t_1) -> 
      (let rec h_2 = (lazy (f_1 h_1)) in
        (let rec t_2 = (lazy ((map_d1 f_1) t_1)) in
          (fun f_2 -> 
            (`C((f_2 (Lazy.force h_2)), ((map_d0 f_2) (Lazy.force t_2)))))))
    | `N -> 
      (fun f_3 -> 
        (`N)))
...
(* lumberhack_pop_out *)
let rec enumFromTo_d0_d0 a_2 b_2 =
  (if (a_2 <= b_2) then
    (`C(a_2, ((enumFromTo_d0_d0 (a_2 + 1)) b_2)))
  else
    (`N));;
let rec enumFromTo_d1_d0 a_3 b_3 =
  (if (a_3 <= b_3) then
    ...
    (`N));;
let rec map_d0_d0 f_8 ls_7 =
  (ls_7 f_8);;
let rec map_d0_d1 f_7 ls_6 =
  (ls_6 f_7);;
let rec map_d1_d0 f_4 ls_5 _lh_popOutId_0_0 =
  (match ls_5 with
    | `C(h_3, t_3) -> 
      (let rec h_4 = (lazy (f_4 h_3)) in
        (let rec t_4 = (lazy ((map_d1_d0 f_4) t_3)) in
          (`C((_lh_popOutId_0_0 (Lazy.force h_4)), ((map_d0_d1 _lh_popOutId_0_0) (Lazy.force t_4))))))
    | `N -> 
      (`N))
and testMapmap_d0_d0 ls_1_0 =
  ((map_d0_d0 (fun x_6 -> 

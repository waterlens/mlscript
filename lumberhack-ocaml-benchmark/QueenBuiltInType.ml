...
let rec length_d0_d0_d0 ls_1 =
  (match ls_1 with
    ...
    | `LH_N -> 
      0);;
let rec safe_d0_d0_d0 _lh_safe_arg1_4 _lh_safe_arg2_4 _lh_safe_arg3_1 =
          ...
          (`LH_C((Obj.magic (let rec _lh_safe_LH_C_0_1 = _lh_listcomp_fun_ls_h_4 in
            (let rec _lh_safe_LH_C_1_1 = _lh_popOutId_0_0 in
              (fun _lh_safe_arg1_3 _lh_safe_arg2_3 -> 
                ((((_lh_safe_arg1_3 != _lh_safe_LH_C_0_1) && (_lh_safe_arg1_3 != (_lh_safe_LH_C_0_1 + _lh_safe_arg2_3))) && (_lh_safe_arg1_3 != (_lh_safe_LH_C_0_1 - _lh_safe_arg2_3))) && (((safe_d0_d0_d1 _lh_safe_arg1_3) (_lh_safe_arg2_3 + 1)) _lh_safe_LH_C_1_1)))))), (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_4)))
        else
...
and gen_d0_d0_d0 _lh_gen_arg1_1 _lh_gen_arg2_1 =
  (match _lh_gen_arg1_1 with
    | 0 -> 
      (`LH_C((Obj.magic (fun _lh_safe_arg1_6 _lh_safe_arg2_6 -> 
        true)), (`LH_N)))
    | _ -> 

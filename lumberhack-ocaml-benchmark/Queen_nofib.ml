...
let rec enumFromTo__d0__d0 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo__d0__d0 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_0 in
        (fun _lh_listcomp_fun_ls_h_2 _lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2 _lh_listcomp_fun_3 -> 
          (if (((safe__d0__d0 _lh_listcomp_fun_ls_h_1) 1) _lh_listcomp_fun_ls_h_2) then
        ...
        (match _lh_listcomp_fun_para_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
            (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
              ...
              (_lh_listcomp_fun_1 ((enumFromTo__d0__d0 1) _lh_gen_arg2_0)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_0 ((gen__d0__d0 (_lh_gen_arg1_0 - 1)) _lh_gen_arg2_0))))
and nsoln__d0__d0 _lh_nsoln_arg1_0 =
  (length__d0__d0 ((gen__d0__d0 _lh_nsoln_arg1_0) _lh_nsoln_arg1_0))
and testQueen_nofib__d0__d0 _lh_testQueen_nofib_arg1_0 =
  (nsoln__d0__d0 _lh_testQueen_nofib_arg1_0);;
...
let rec safe__d0__d0__d0 _lh_safe_arg1_1 _lh_safe_arg2_1 _lh_safe_arg3_1 =
  (match _lh_safe_arg3_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec enumFromTo__d0__d0__d0 a_1 b_1 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo__d0__d0__d0 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_4 = a_1 in
        (if (((safe__d0__d0__d0 _lh_listcomp_fun_ls_h_4) 1) _lh_popOutId_0_0) then
          (`LH_C((`LH_C(_lh_listcomp_fun_ls_h_4, _lh_popOutId_0_0)), (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_4)))
        else
        ...
        (match _lh_listcomp_fun_para_2 with
          | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
            (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_3 -> 
              ...
              (_lh_listcomp_fun_1_1 ((enumFromTo__d0__d0__d0 1) _lh_gen_arg2_1)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0 ((gen__d0__d0__d0 (_lh_gen_arg1_1 - 1)) _lh_gen_arg2_1))))
and nsoln__d0__d0__d0 _lh_nsoln_arg1_1 =
  (length__d0__d0__d0 ((gen__d0__d0__d0 _lh_nsoln_arg1_1) _lh_nsoln_arg1_1))
and testQueen_nofib__d0__d0__d0 _lh_testQueen_nofib_arg1_1 =
  (nsoln__d0__d0__d0 _lh_testQueen_nofib_arg1_1);;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Queen_nofib" (fun () -> ignore ((testQueen_nofib__d0 11)));
  Bench.Test.create ~name:"lumberhack_Queen_nofib" (fun () -> ignore ((testQueen_nofib__d0__d0 11)));
  Bench.Test.create ~name:"lumberhack_pop_out_Queen_nofib" (fun () -> ignore ((testQueen_nofib__d0__d0__d0 11)));
])

...
and enumFromTo_d0_d0 a_1 b_1 =
  (if (a_1 <= b_1) then
    (let rec hx_1 = (lazy a_1) in
      (let rec tx_1 = (lazy ((enumFromTo_d0_d0 (a_1 + 1)) b_1)) in
        (fun ys_4 -> 
          (match (Lazy.force ys_4) with
            | `LH_C(hy_1, ty_1) -> 
              (let rec _lh_listcomp_fun_ls_h_0 = (lazy (let rec _lh_bernoulli_LH_P2_0_0 = (lazy (Lazy.force hx_1)) in
                (let rec _lh_bernoulli_LH_P2_1_0 = (lazy hy_1) in
                  (fun _lh_listcomp_fun_ls_t_0 _lh_listcomp_fun_0 powers_0 -> 
                    (let rec h_1 = (lazy (((sum_d1_d0 (((zipWith_lz_nl_d0_d0 (fun a_2 b_2 -> 
                      (a_2 * b_2))) powers_0) (tail_d0_d0 (tail_d1_d0 (Lazy.force _lh_bernoulli_LH_P2_1_0))))) - (Lazy.force _lh_bernoulli_LH_P2_0_0)) / ((Lazy.force _lh_bernoulli_LH_P2_0_0) + 1))) in
                      (let rec t_1 = (lazy (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)) in
                        ((Lazy.force h_1) + (sum_d0_d0 (Lazy.force t_1))))))))) in
                (let rec _lh_listcomp_fun_ls_t_1 = (lazy ((zip_nl_lz_d0_d0 (Lazy.force tx_1)) ty_1)) in
                  (fun _lh_listcomp_fun_1 powers_1 -> 
                    ((((Lazy.force _lh_listcomp_fun_ls_h_0) (Lazy.force _lh_listcomp_fun_ls_t_1)) _lh_listcomp_fun_1) powers_1))))
            | `LH_N -> 
              (fun _lh_listcomp_fun_2 powers_2 -> 
                0)))))
  else
    (fun ys_5 _lh_listcomp_fun_3 powers_3 -> 
      0))
and iterate_d0_d0 f_1_0 x_1 =
  (lazy (let rec hx_4 = (lazy x_1) in
    (let rec tx_4 = (lazy ((iterate_d0_d0 f_1_0) (f_1_0 x_1))) in
      (fun f_1_1 ys_1_1 -> 
        (match (Lazy.force ys_1_1) with
          | `LH_C(hy_5, ty_5) -> 
            (let rec hx_5 = (lazy ((f_1_1 (Lazy.force hx_4)) hy_5)) in
              (let rec tx_5 = (lazy (((zipWith_lz_lz_d1_d0 f_1_1) (Lazy.force tx_4)) ty_5)) in
                (fun f_1_2 hy_6 ty_6 -> 
                  (let rec h_9 = (lazy ((f_1_2 (Lazy.force hx_5)) hy_6)) in
                    (let rec t_9 = (lazy (((zipWith_lz_nl_d0_d0 f_1_2) (Lazy.force tx_5)) ty_6)) in
                      ((Lazy.force h_9) + (sum_d1_d0 (Lazy.force t_9))))))))
          | `LH_N -> 
            (fun f_1_3 hy_7 ty_7 -> 
              0))))))
and map_lz_d0_d0 f_3 ls_1 =
  (lazy (match (Lazy.force ls_1) with
    | `LH_C(h_2, t_2) -> 
      (let rec h_3 = (lazy (f_3 h_2)) in
        (let rec t_3 = (lazy ((map_lz_d0_d0 f_3) t_2)) in
          (fun n_0 -> 
            (if (n_0 = 0) then
              (Lazy.force h_3)
            else
              ((atIndex_lz_d0_d0 (n_0 - 1)) (Lazy.force t_3))))))
    | `LH_N -> 
      (fun n_1 -> 
        (failwith "error"))))
and mappend_d0_d0 xs_5 ys_9 =
  (match xs_5 with
    | `LH_C(h_8, t_8) -> 
      (let rec hx_3 = (lazy h_8) in
        (let rec tx_3 = (lazy ((mappend_d0_d0 t_8) ys_9)) in
          (fun f_9 ys_1_0 -> 
            (match ys_1_0 with
              | `LH_C(hy_4, ty_4) -> 
                (`LH_C(((f_9 (Lazy.force hx_3)) hy_4), (((zipWith_d0_d0 f_9) (Lazy.force tx_3)) ty_4)))
              | `LH_N -> 
                (`LH_N)))))
    | `LH_N -> 
      ys_9)
...
and pascal_d0_d0 =
  (lazy (`LH_C((`LH_C(1, (`LH_C(2, (`LH_C(1, (`LH_N))))))), ((map_lz_d2_d0 (fun line_0 -> 
    (((zipWith_d0_d0 (fun a_0 b_0 -> 
      (a_0 + b_0))) ((mappend_d0_d0 line_0) (let rec hx_0 = (lazy 0) in
      (let rec tx_0 = (lazy (fun f_1 ys_2 -> 
        (`LH_N))) in
        (fun f_2 ys_3 -> 
          (match ys_3 with
            | `LH_C(hy_0, ty_0) -> 
              (`LH_C(((f_2 (Lazy.force hx_0)) hy_0), (((zipWith_d0_d0 f_2) (Lazy.force tx_0)) ty_0)))
            | `LH_N -> 
...
(* lumberhack_pop_out *)
let rec atIndex_lz_d0_d0_d0 n_5 ls_1_4 =
  (if (n_5 < 0) then
    (failwith "error")
  else
    ((Lazy.force ls_1_4) n_5));;
let rec atIndex_lz_d0_d0_d1 n_8 ls_1_8 =
  (if (n_8 < 0) then
    (failwith "error")
  else
    ((Lazy.force ls_1_8) n_8));;
let rec enumFrom_d0_d0_d0 a_9 =
  (lazy (`LH_C(a_9, (enumFrom_d0_d0_d0 (a_9 + 1)))));;
let rec head_lz_d0_d0_d0 ls_1_3 =
  (match (Lazy.force ls_1_3) with
    | `LH_C(h_1_5, t_1_5) -> 
      h_1_5
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_d1_d0_d0 f_2_1 ls_1_1 =
  (lazy (match (Lazy.force ls_1_1) with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C((f_2_1 h_1_3), ((map_lz_d1_d0_d0 f_2_1) t_1_3)))
    | `LH_N -> 
      (`LH_N)));;
let rec map_lz_d2_d0_d0 f_2_0 ls_1_0 =
  (lazy (match (Lazy.force ls_1_0) with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C((f_2_0 h_1_2), ((map_lz_d2_d0_d0 f_2_0) t_1_2)))
    | `LH_N -> 
      (`LH_N)));;
let rec sum_d0_d0_d0 ls_2_0 =
  ls_2_0;;
let rec sum_d0_d0_d1 ls_9 =
  ls_9;;
let rec sum_d1_d0_d0 ls_1_7 =
  ls_1_7;;
let rec sum_d1_d0_d1 ls_1_5 =
  ls_1_5;;
let rec tail_d0_d0_d0 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_1_4, t_1_4) -> 
      t_1_4
    | `LH_N -> 
...
let rec tail_d1_d0_d0 ls_1_9 =
  (match ls_1_9 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec zipWith_lz_lz_d0_d0_d0 f_1_9 xs_8 ys_1_7 =
  (lazy (match (Lazy.force xs_8) with
    | `LH_C(hx_9, tx_9) -> 
      (match (Lazy.force ys_1_7) with
        | `LH_C(hy_1_2, ty_1_2) -> 
          (`LH_C(((f_1_9 hx_9) hy_1_2), (((zipWith_lz_lz_d0_d0_d0 f_1_9) tx_9) ty_1_2)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N)));;
let rec zipWith_lz_lz_d1_d0_d0 f_2_7 xs_1_3 ys_2_4 =
  (lazy (((Lazy.force xs_1_3) f_2_7) ys_2_4));;
let rec zipWith_lz_lz_d1_d0_d1 f_2_2 xs_1_0 ys_1_9 =
  (lazy (((Lazy.force xs_1_0) f_2_2) ys_1_9));;
let rec zipWith_lz_nl_d0_d0_d0 f_2_5 xs_1_1 ys_2_2 =
  (match ys_2_2 with
    | `LH_C(hy_1_4, ty_1_4) -> 
      ((((Lazy.force xs_1_1) f_2_5) hy_1_4) ty_1_4)
    | `LH_N -> 
      0);;
let rec zipWith_lz_nl_d0_d0_d1 f_3_0 xs_1_5 ys_2_7 =
  (match ys_2_7 with
    | `LH_C(hy_1_6, ty_1_6) -> 
      ((((Lazy.force xs_1_5) f_3_0) hy_1_6) ty_1_6)
    | `LH_N -> 
      0);;
let rec zipWith_d0_d0_d0 f_3_1 xs_1_6 ys_2_8 =
  ((xs_1_6 f_3_1) ys_2_8);;
let rec zipWith_d0_d0_d1 f_1_4 xs_7 ys_1_3 =
  ((xs_7 f_1_4) ys_1_3);;
let rec zipWith_d0_d0_d2 f_2_6 xs_1_2 ys_2_3 =
  ((xs_1_2 f_2_6) ys_2_3);;
let rec zip_nl_lz_d0_d0_d0 xs_9 ys_1_8 =
  (xs_9 ys_1_8);;
let rec zip_nl_lz_d0_d0_d1 xs_6 ys_1_2 =
  (xs_6 ys_1_2);;
...
and enumFromTo_d0_d0_d0 a_5 b_4 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_0 =
  (if (a_5 <= b_4) then
    (let rec hx_8 = (lazy a_5) in
      (let rec tx_8 = (lazy ((enumFromTo_d0_d0_d0 (a_5 + 1)) b_4)) in
        (match (Lazy.force _lh_popOutId_0_1) with
          | `LH_C(hy_1_1, ty_1_1) -> 
            (let rec _lh_listcomp_fun_ls_h_1 = (lazy (let rec _lh_bernoulli_LH_P2_0_1 = (lazy (Lazy.force hx_8)) in
              (let rec _lh_bernoulli_LH_P2_1_1 = (lazy hy_1_1) in
                (fun _lh_listcomp_fun_ls_t_2 _lh_listcomp_fun_6 powers_6 -> 
                  (let rec h_1_1 = (lazy (((sum_d1_d0_d0 (((zipWith_lz_nl_d0_d0_d0 (fun a_6 b_5 -> 
                    (a_6 * b_5))) powers_6) (tail_d0_d0_d0 (tail_d1_d0_d0 (Lazy.force _lh_bernoulli_LH_P2_1_1))))) - (Lazy.force _lh_bernoulli_LH_P2_0_1)) / ((Lazy.force _lh_bernoulli_LH_P2_0_1) + 1))) in
                    (let rec t_1_1 = (lazy (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_2)) in
                      ((Lazy.force h_1_1) + (sum_d0_d0_d0 (Lazy.force t_1_1))))))))) in
              (let rec _lh_listcomp_fun_ls_t_3 = (lazy ((zip_nl_lz_d0_d0_d0 (Lazy.force tx_8)) ty_1_1)) in
                ((((Lazy.force _lh_listcomp_fun_ls_h_1) (Lazy.force _lh_listcomp_fun_ls_t_3)) _lh_popOutId_1_1) _lh_popOutId_2_0)))
          | `LH_N -> 
            0)))
  else
    0)
and iterate_d0_d0_d0 f_1_5 x_2 =
  (lazy (let rec hx_6 = (lazy x_2) in
    (let rec tx_6 = (lazy ((iterate_d0_d0_d0 f_1_5) (f_1_5 x_2))) in
      (fun f_1_6 ys_1_4 -> 
        (match (Lazy.force ys_1_4) with
          | `LH_C(hy_8, ty_8) -> 
            (let rec hx_7 = (lazy ((f_1_6 (Lazy.force hx_6)) hy_8)) in
              (let rec tx_7 = (lazy (((zipWith_lz_lz_d1_d0_d0 f_1_6) (Lazy.force tx_6)) ty_8)) in
                (fun f_1_7 hy_9 ty_9 -> 
                  (let rec h_1_0 = (lazy ((f_1_7 (Lazy.force hx_7)) hy_9)) in
                    (let rec t_1_0 = (lazy (((zipWith_lz_nl_d0_d0_d1 f_1_7) (Lazy.force tx_7)) ty_9)) in
                      ((Lazy.force h_1_0) + (sum_d1_d0_d1 (Lazy.force t_1_0))))))))
          | `LH_N -> 
            (fun f_1_8 hy_1_0 ty_1_0 -> 
              0))))))
and map_lz_d0_d0_d0 f_2_8 ls_1_6 =
  (lazy (match (Lazy.force ls_1_6) with
    | `LH_C(h_1_6, t_1_6) -> 
      (let rec h_1_7 = (lazy (f_2_8 h_1_6)) in
        (let rec t_1_7 = (lazy ((map_lz_d0_d0_d0 f_2_8) t_1_6)) in
          (fun n_6 -> 
            (if (n_6 = 0) then
              (Lazy.force h_1_7)
            else
              ((atIndex_lz_d0_d0_d1 (n_6 - 1)) (Lazy.force t_1_7))))))
    | `LH_N -> 
      (fun n_7 -> 
        (failwith "error"))))
and mappend_d0_d0_d0 xs_1_4 ys_2_5 =
  (match xs_1_4 with
    | `LH_C(h_1_8, t_1_8) -> 
      (let rec hx_1_1 = (lazy h_1_8) in
        (let rec tx_1_1 = (lazy ((mappend_d0_d0_d0 t_1_8) ys_2_5)) in
          (fun f_2_9 ys_2_6 -> 
            (match ys_2_6 with
              | `LH_C(hy_1_5, ty_1_5) -> 
                (`LH_C(((f_2_9 (Lazy.force hx_1_1)) hy_1_5), (((zipWith_d0_d0_d0 f_2_9) (Lazy.force tx_1_1)) ty_1_5)))
              | `LH_N -> 
                (`LH_N)))))
    | `LH_N -> 
      ys_2_5)
and neg_powers_d0_d0_d0 =
  (lazy ((map_lz_d0_d0_d0 ((zipWith_lz_lz_d1_d0_d1 (fun n_4 x_3 -> 
    (if n_4 then
      x_3
    else
      (0 - x_3)))) ((iterate_d0_d0_d0 not) true))) powers_d0_d0_d0))
and pascal_d0_d0_d0 =
  (lazy (`LH_C((`LH_C(1, (`LH_C(2, (`LH_C(1, (`LH_N))))))), ((map_lz_d2_d0_d0 (fun line_1 -> 
    (((zipWith_d0_d0_d1 (fun a_7 b_6 -> 
      (a_7 + b_6))) ((mappend_d0_d0_d0 line_1) (let rec hx_1_0 = (lazy 0) in
      (let rec tx_1_0 = (lazy (fun f_2_3 ys_2_0 -> 
        (`LH_N))) in
        (fun f_2_4 ys_2_1 -> 
          (match ys_2_1 with
            | `LH_C(hy_1_3, ty_1_3) -> 
              (`LH_C(((f_2_4 (Lazy.force hx_1_0)) hy_1_3), (((zipWith_d0_d0_d2 f_2_4) (Lazy.force tx_1_0)) ty_1_3)))
            | `LH_N -> 
              (`LH_N))))))) (`LH_C(0, line_1))))) pascal_d0_d0_d0))))
and powers_d0_d0_d0 =
  (lazy (`LH_C((enumFrom_d0_d0_d0 2), ((map_lz_d1_d0_d0 (fun p_1 -> 
    (((zipWith_lz_lz_d0_d0_d0 (fun a_8 b_7 -> 
      (a_8 * b_7))) (head_lz_d0_d0_d0 powers_d0_d0_d0)) p_1))) powers_d0_d0_d0))))

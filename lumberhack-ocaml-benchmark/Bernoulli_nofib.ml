...
let rec tail_d1 ls_2_4 =
  (match ls_2_4 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec zipWith_lz_lz_d0 f_1_6 xs_1_2 ys_1_2 =
  (lazy (match (Lazy.force xs_1_2) with
    ...
    | `LH_N -> 
      (`LH_N)));;
let rec zipWith_lz_lz_d1 f_1_5 xs_1_0 ys_1_0 =
  (lazy (match (Lazy.force xs_1_0) with
    ...
    | `LH_N -> 
      (`LH_N)));;
let rec zipWith_lz_nl_d0 f_1_3 xs_9 ys_9 =
  (match ys_9 with
    | `LH_C(hy_8, ty_8) -> 
    ...
    | `LH_N -> 
      (`LH_N));;
let rec zipWith_d0 f_1_7 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(hx_1_1, tx_1_1) -> 
      (match ys_1_3 with
        | `LH_C(hy_1_1, ty_1_1) -> 
    ...
    | `LH_N -> 
      (`LH_N));;
let rec zip_nl_lz_d0 xs_1_4 ys_1_4 =
  (match xs_1_4 with
    | `LH_C(hx_1_2, tx_1_2) -> 
...
let rec atIndex_lz_d0_d0_d1 n_4 ls_1_0 =
  (if (n_4 < 0) then
    (failwith "error")
  else
    ((Lazy.force ls_1_0) n_4));;
let rec enumFrom_d0_d0_d0 a_1_1 =
  (lazy (`LH_C(a_1_1, (enumFrom_d0_d0_d0 (a_1_1 + 1)))));;
let rec map_lz_d1_d0_d0 f_1_6 ls_1_1 =
  (lazy (match (Lazy.force ls_1_1) with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_1_6 h_9), ((map_lz_d1_d0_d0 f_1_6) t_9)))
    | `LH_N -> 
      (`LH_N)));;
let rec map_lz_d2_d0_d0 f_2_4 ls_1_5 =
  (lazy (match (Lazy.force ls_1_5) with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C((f_2_4 h_1_2), ((map_lz_d2_d0_d0 f_2_4) t_1_2)))
    | `LH_N -> 
      (`LH_N)));;
let rec sum_d0_d0_d0 ls_1_4 =
  ls_1_4;;
let rec sum_d0_d0_d1 ls_1_3 =
  ls_1_3;;
let rec sum_d1_d0_d0 ls_8 =
  ls_8;;
let rec sum_d1_d0_d1 ls_9 =
  ls_9;;
...
let rec tail_d1_d0_d0 ls_1_8 =
  (match ls_1_8 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec zipWith_lz_lz_d0_d0_d0 f_2_7 xs_1_5 ys_2_8 =
  (lazy (((Lazy.force xs_1_5) ys_2_8) f_2_7));;
let rec zipWith_lz_lz_d0_d0_d1 f_2_0 xs_1_2 ys_2_1 =
  (lazy (((Lazy.force xs_1_2) ys_2_1) f_2_0));;
let rec zipWith_lz_lz_d1_d0_d0 f_1_7 xs_9 ys_1_6 =
  (lazy (((Lazy.force xs_9) ys_1_6) f_1_7));;
let rec zipWith_lz_lz_d1_d0_d1 f_1_8 xs_1_0 ys_1_7 =
  (lazy (((Lazy.force xs_1_0) ys_1_7) f_1_8));;
let rec zipWith_lz_nl_d0_d0_d0 f_1_9 xs_1_1 ys_2_0 =
  (match ys_2_0 with
    | `LH_C(hy_9, ty_9) -> 
      ((((Lazy.force xs_1_1) hy_9) ty_9) f_1_9)
    | `LH_N -> 
      0);;
let rec zipWith_lz_nl_d0_d0_d1 f_3_0 xs_1_7 ys_3_0 =
  (match ys_3_0 with
    | `LH_C(hy_1_3, ty_1_3) -> 
      ((((Lazy.force xs_1_7) hy_1_3) ty_1_3) f_3_0)
    | `LH_N -> 
      0);;
let rec zipWith_d0_d0_d0 f_2_6 xs_1_4 ys_2_7 =
  ((xs_1_4 ys_2_7) f_2_6);;
let rec zipWith_d0_d0_d1 f_1_5 xs_6 ys_1_3 =
  ((xs_6 ys_1_3) f_1_5);;
let rec zipWith_d0_d0_d2 f_2_8 xs_1_6 ys_2_9 =
  ((xs_1_6 ys_2_9) f_2_8);;
let rec zip_nl_lz_d0_d0_d0 xs_8 ys_1_5 =
  (xs_8 ys_1_5);;
let rec zip_nl_lz_d0_d0_d1 xs_7 ys_1_4 =
  (xs_7 ys_1_4);;
...
and enumFromTo_d0_d0_d0 a_6 b_4 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_0 =
  (if (a_6 <= b_4) then
    (let rec hx_6 = a_6 in
      (let rec tx_6 = ((enumFromTo_d0_d0_d0 (a_6 + 1)) b_4) in
            ...
            (let rec _lh_listcomp_fun_ls_h_1 = (let rec _lh_bernoulli_LH_P2_0_1 = hx_6 in
              (let rec _lh_bernoulli_LH_P2_1_1 = hy_8 in
                (fun powers_6 _lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_2 -> 
                  (let rec h_1_0 = (((sum_d1_d0_d0 (((zipWith_lz_nl_d0_d0_d0 (fun a_7 b_5 -> 
                    (a_7 * b_5))) powers_6) (tail_d0_d0_d0 (tail_d1_d0_d0 _lh_bernoulli_LH_P2_1_1)))) - _lh_bernoulli_LH_P2_0_1) / (_lh_bernoulli_LH_P2_0_1 + 1)) in
                    (let rec t_1_0 = (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_2) in
                      (h_1_0 + (sum_d0_d0_d0 t_1_0))))))) in
    ...
    0)
and enumFrom_d1_d0_d0 a_1_0 =
  (lazy (let rec hx_9 = a_1_0 in
    (let rec tx_9 = (enumFrom_d1_d0_d0 (a_1_0 + 1)) in
      (fun ys_2_6 f_2_5 -> 
        (match (Lazy.force ys_2_6) with
          | `LH_C(hy_1_2, ty_1_2) -> 
            (`LH_C(((f_2_5 hx_9) hy_1_2), (((zipWith_lz_lz_d0_d0_d0 f_2_5) tx_9) ty_1_2)))
          | `LH_N -> 
            (`LH_N))))))
and iterate_d0_d0_d0 f_3_1 x_3 =
  (lazy (let rec hx_1_0 = x_3 in
    (let rec tx_1_0 = ((iterate_d0_d0_d0 f_3_1) (f_3_1 x_3)) in
      (fun ys_3_1 f_3_2 -> 
        (match (Lazy.force ys_3_1) with
          | `LH_C(hy_1_4, ty_1_4) -> 
            (let rec hx_1_1 = ((f_3_2 hx_1_0) hy_1_4) in
              (let rec tx_1_1 = (((zipWith_lz_lz_d1_d0_d0 f_3_2) tx_1_0) ty_1_4) in
                (fun hy_1_5 ty_1_5 f_3_3 -> 
                  (let rec h_1_7 = ((f_3_3 hx_1_1) hy_1_5) in
                    (let rec t_1_7 = (((zipWith_lz_nl_d0_d0_d1 f_3_3) tx_1_1) ty_1_5) in
                      (h_1_7 + (sum_d1_d0_d1 t_1_7)))))))
          | `LH_N -> 
            (fun hy_1_6 ty_1_6 f_3_4 -> 
              0))))))
and map_lz_d0_d0_d0 f_2_9 ls_1_7 =
  (lazy (match (Lazy.force ls_1_7) with
    | `LH_C(h_1_4, t_1_4) -> 
      (let rec h_1_5 = (f_2_9 h_1_4) in
        (let rec t_1_5 = ((map_lz_d0_d0_d0 f_2_9) t_1_4) in
          (fun n_7 -> 
            (if (n_7 = 0) then
              h_1_5
            else
              ((atIndex_lz_d0_d0_d1 (n_7 - 1)) t_1_5)))))
    | `LH_N -> 
      (fun n_8 -> 
        (failwith "error"))))
and mappend_d0_d0_d0 xs_1_3 ys_2_4 =
  (match xs_1_3 with
    | `LH_C(h_1_1, t_1_1) -> 
      (let rec hx_8 = h_1_1 in
        (let rec tx_8 = ((mappend_d0_d0_d0 t_1_1) ys_2_4) in
          (fun ys_2_5 f_2_3 -> 
            (match ys_2_5 with
              | `LH_C(hy_1_1, ty_1_1) -> 
                (`LH_C(((f_2_3 hx_8) hy_1_1), (((zipWith_d0_d0_d0 f_2_3) tx_8) ty_1_1)))
              | `LH_N -> 
                (`LH_N)))))
    | `LH_N -> 
      ys_2_4)
...
and pascal_d0_d0_d0 =
  (lazy (`LH_C((`LH_C(1, (`LH_C(2, (`LH_C(1, (`LH_N))))))), ((map_lz_d2_d0_d0 (fun line_1 -> 
    (((zipWith_d0_d0_d1 (fun a_8 b_6 -> 
      (a_8 + b_6))) ((mappend_d0_d0_d0 line_1) (let rec hx_7 = 0 in
      (let rec tx_7 = (fun ys_2_2 f_2_1 -> 
        (`LH_N)) in
        (fun ys_2_3 f_2_2 -> 
          (match ys_2_3 with
            | `LH_C(hy_1_0, ty_1_0) -> 
              (`LH_C(((f_2_2 hx_7) hy_1_0), (((zipWith_d0_d0_d2 f_2_2) tx_7) ty_1_0)))
            | `LH_N -> 
              (`LH_N))))))) (`LH_C(0, line_1))))) pascal_d0_d0_d0))))
and powers_d0_d0_d0 =
  (lazy (`LH_C((enumFrom_d0_d0_d0 2), ((map_lz_d1_d0_d0 ((zipWith_lz_lz_d0_d0_d1 (fun a_9 b_7 -> 
    (a_9 * b_7))) (enumFrom_d1_d0_d0 2))) powers_d0_d0_d0))))

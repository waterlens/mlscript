...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_DigitsOfE2_nofib" (fun () -> ignore (let open Module_original in ((testDigitsOfE2_nofib__d0 500))));
  Bench.Test.create ~name:"lumberhack_DigitsOfE2_nofib" (fun () -> ignore (let open Module_lumberhack in ((testDigitsOfE2_nofib__d0 500))));
  Bench.Test.create ~name:"lumberhack_pop_out_DigitsOfE2_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testDigitsOfE2_nofib__d0 500))));
])

    ...
    (let rec h_1_8_3 = win8_lh__d1 in
      (fun f_2_0 -> 
        (let rec _lh_interpret_LH_C_1_1 = (t_1_9_0 f_2_0) in
          (let rec _lh_interpret_LH_C_0_1 = (f_2_0 h_1_8_3) in
    ...
    (let rec h_1_8_4 = win7_lh__d1 in
      (fun f_2_1 -> 
        (let rec _lh_interpret_LH_C_1_2 = (t_1_8_9 f_2_1) in
          (let rec _lh_interpret_LH_C_0_2 = (f_2_1 h_1_8_4) in
    ...
    (let rec h_1_8_5 = win6_lh__d1 in
      (fun f_2_2 -> 
        (let rec _lh_interpret_LH_C_1_3 = (t_1_8_8 f_2_2) in
          (let rec _lh_interpret_LH_C_0_3 = (f_2_2 h_1_8_5) in
    ...
    (let rec h_1_8_6 = win5_lh__d1 in
      (fun f_2_3 -> 
        (let rec _lh_interpret_LH_C_1_4 = (t_1_8_7 f_2_3) in
          (let rec _lh_interpret_LH_C_0_4 = (f_2_3 h_1_8_6) in
    ...
    (let rec h_1_8_7 = win4_lh__d1 in
      (fun f_2_4 -> 
        (let rec _lh_interpret_LH_C_1_5 = (t_1_8_6 f_2_4) in
          (let rec _lh_interpret_LH_C_0_5 = (f_2_4 h_1_8_7) in
    ...
    (let rec h_1_8_8 = win3_lh__d1 in
      (fun f_2_5 -> 
        (let rec _lh_interpret_LH_C_1_6 = (t_1_8_5 f_2_5) in
          (let rec _lh_interpret_LH_C_0_6 = (f_2_5 h_1_8_8) in
    ...
    (let rec h_1_8_9 = win2_lh__d1 in
      (fun f_2_6 -> 
        (let rec _lh_interpret_LH_C_1_7 = (t_1_8_4 f_2_6) in
          (let rec _lh_interpret_LH_C_0_7 = (f_2_6 h_1_8_9) in
    ...
    (let rec h_1_9_0 = win1_lh__d1 in
      (fun f_2_7 -> 
        (let rec _lh_interpret_LH_C_1_8 = (t_1_8_3 f_2_7) in
          (let rec _lh_interpret_LH_C_0_8 = (f_2_7 h_1_9_0) in

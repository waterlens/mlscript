...
let rec filter_lh__d0 f_0 ls_0 =
  (match ls_0 with
    | `LH_C(h_0, t_0) -> 
      (if (f_0 h_0) then
        (`LH_C(h_0, ((filter_lh__d0 f_0) t_0)))
      else
        ((filter_lh__d0 f_0) t_0))
    | `LH_N -> 
      (`LH_N));;
let rec permutations_lh__d1 _lh_permutations_arg1_1 =
  (_lh_permutations_arg1_1 99);;
let rec take_lh__d0 n_2 ls_2 =
  (if (n_2 > 0) then
    (ls_2 n_2)
  else
    (fun _lh_dummy_2 -> 
      (`LH_C((`LH_N), (`LH_N)))));;
let rec addj_lh__d0 _lh_addj_arg1_0 _lh_addj_arg2_0 =
    ...
    | `LH_C(_lh_addj_LH_C_0_0, _lh_addj_LH_C_1_0) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_0, (`LH_C(_lh_addj_LH_C_0_0, _lh_addj_LH_C_1_0)))), (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
        (match _lh_listcomp_fun_para_2 with
          ...
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_2 ((addj_lh__d0 _lh_addj_arg1_0) _lh_addj_LH_C_1_0)))))
    | _ -> 
      (failwith "error"));;
let rec enumFromTo_lh__d0 a_0 b_0 _lh_popOutId_0_0 _lh_popOutId_1_0 =
  (if (a_0 <= b_0) then
    (let rec t_1 = ((enumFromTo_lh__d0 (a_0 + 1)) b_0) in
      (let rec h_1 = a_0 in
        (let rec _lh_permutations_LH_C_1_0 = ((take_lh__d0 (_lh_popOutId_0_0 - 1)) t_1) in
          (let rec _lh_permutations_LH_C_0_0 = h_1 in
              ...
              (match _lh_listcomp_fun_para_0 with
                | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
                  (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                    ...
                    (_lh_listcomp_fun_1 ((addj_lh__d0 _lh_permutations_LH_C_0_0) _lh_listcomp_fun_ls_h_0)))
                | `LH_N -> 
                  (`LH_N))) in
...
let rec enumFromTo_lh__d1 a_1 b_1 _lh_popOutId_0_1 =
  (if (a_1 <= b_1) then
    (let rec t_2 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec h_2 = a_1 in
        (`LH_C((_lh_popOutId_0_1 h_2), ((map_lh__d0 _lh_popOutId_0_1) t_2)))))
  else
    (`LH_N));;
                                      ...
                                      (match _lh_condition_LH_C_1_8 with
                                        | `LH_C(_lh_condition_LH_C_0_9, _lh_condition_LH_C_1_9) -> 
                                          (match _lh_condition_LH_C_1_9 with
                                            | `LH_N -> 
                                              ((((((((expand_lh__d1 _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_1) _lh_condition_LH_C_0_2) _lh_condition_LH_C_0_3) _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_4) + (5 * ((((((expand_lh__d2 _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_5) _lh_condition_LH_C_0_6) _lh_condition_LH_C_0_7) _lh_condition_LH_C_0_8) _lh_condition_LH_C_0_6))) = ((((((expand_lh__d0 _lh_condition_LH_C_0_9) _lh_condition_LH_C_0_2) _lh_condition_LH_C_0_9) _lh_condition_LH_C_0_6) _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_4))
                                            | _ -> 
                                              (failwith "error"))
                                        | _ -> 
                                          (failwith "error"))
...
let rec testCryptarithm_nofib_lh__d0 _lh_testCryptarithm_nofib_arg1_0 =
  ((map_lh__d0 (fun i_0 -> 
    (let rec p0_0 = ((take_lh__d0 10) ((enumFromTo_lh__d0 0) (9 + i_0))) in
      ((filter_lh__d0 condition_lh__d0) (permutations_lh__d0 p0_0))))) ((enumFromTo_lh__d1 1) _lh_testCryptarithm_nofib_arg1_0));;
end;;

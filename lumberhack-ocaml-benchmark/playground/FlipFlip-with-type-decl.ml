(*
ocamlfind ocamlopt -rectypes -thread -O3 ./FlipFlip-with-type-decl.ml -o "./FlipFlip-with-type-decl.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./FlipFlip-with-type-decl.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

...
let rec writeSolutions__d0 _lh_writeSolutions_arg1_0 _lh_writeSolutions_arg2_5 =
  (_lh_writeSolutions_arg1_0 _lh_writeSolutions_arg2_5);;
let rec itemFromTo__d0 _lh_itemFromTo_arg1_2 _lh_itemFromTo_arg2_2 _lh_popOutId_0_2 _lh_popOutId_1_2 _lh_popOutId_2_2 _lh_popOutId_3_2 _lh_popOutId_4_2 _lh_popOutId_5_2 _lh_popOutId_6_2 _lh_popOutId_7_2 =
  (if (_lh_itemFromTo_arg1_2 = _lh_itemFromTo_arg2_2) then
    (let rec _lh_listcomp_fun_ls_t_7 = (fun _lh_listcomp_fun_1_3 _lh_transfer_arg1_7 _lh_transfer_arg2_7 _lh_transfer_arg3_7 _lh_transfer_arg4_7 _lh_transfer_arg5_7 newHistory_7 newLocation_7 _lh_dummy_3 ys_4_0_6 -> 
      ys_4_0_6) in
      (let rec _lh_listcomp_fun_ls_h_7 = _lh_itemFromTo_arg1_2 in
        (if (((position__d0 _lh_listcomp_fun_ls_h_7) _lh_popOutId_2_2) = _lh_popOutId_3_2) then
          (let rec newDest_2 = (((updateState__d0 _lh_popOutId_2_2) _lh_listcomp_fun_ls_h_7) _lh_popOutId_7_2) in
            (if ((notSeen__d0 newDest_2) _lh_popOutId_5_2) then
              (let rec newTime_2 = (_lh_popOutId_4_2 + (u2times__d0 _lh_listcomp_fun_ls_h_7)) in
                (let rec t_3_7_0 = (_lh_popOutId_0_2 _lh_listcomp_fun_ls_t_7) in
                  (let rec h_3_7_0 = (((((transfer__d0 _lh_popOutId_1_2) newDest_2) _lh_popOutId_7_2) newTime_2) _lh_popOutId_6_2) in
                    (fun _lh_dummy_4 -> 
                      ((mappend__d0 h_3_7_0) (concat__d0 t_3_7_0))))))
            else
    ...
    (let rec _lh_listcomp_fun_ls_t_8 = ((itemFromTo__d0 (succItem__d0 _lh_itemFromTo_arg1_2)) _lh_itemFromTo_arg2_2) in
      (let rec _lh_listcomp_fun_ls_h_8 = _lh_itemFromTo_arg1_2 in
        (if (((position__d0 _lh_listcomp_fun_ls_h_8) _lh_popOutId_2_2) = _lh_popOutId_3_2) then
          (let rec newDest_3 = (((updateState__d0 _lh_popOutId_2_2) _lh_listcomp_fun_ls_h_8) _lh_popOutId_7_2) in
            (if ((notSeen__d0 newDest_3) _lh_popOutId_5_2) then
              (let rec newTime_3 = (_lh_popOutId_4_2 + (u2times__d0 _lh_listcomp_fun_ls_h_8)) in
                (let rec t_3_7_1 = (_lh_popOutId_0_2 _lh_listcomp_fun_ls_t_8) in
                  (let rec h_3_7_1 = (((((transfer__d0 _lh_popOutId_1_2) newDest_3) _lh_popOutId_7_2) newTime_3) _lh_popOutId_6_2) in
                    (fun _lh_dummy_5 -> 
                      ((mappend__d0 h_3_7_1) (concat__d0 t_3_7_1))))))
            else
          ...
          (_lh_popOutId_0_2 _lh_listcomp_fun_ls_t_8)))))
and itemFromTo__d1 _lh_itemFromTo_arg1_1 _lh_itemFromTo_arg2_1 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 _lh_popOutId_3_1 _lh_popOutId_4_1 _lh_popOutId_5_1 _lh_popOutId_6_1 _lh_popOutId_7_1 =
  (if (_lh_itemFromTo_arg1_1 = _lh_itemFromTo_arg2_1) then
    (let rec _lh_listcomp_fun_ls_t_5 = (fun _lh_listcomp_fun_8 _lh_transfer_arg1_4 _lh_transfer_arg2_4 _lh_transfer_arg3_4 _lh_transfer_arg4_4 _lh_transfer_arg5_4 newHistory_4 newLocation_4 _lh_dummy_2 -> 
      (`LH_N)) in
      (let rec _lh_listcomp_fun_ls_h_5 = _lh_itemFromTo_arg1_1 in
    ...
    (let rec _lh_listcomp_fun_ls_t_6 = ((itemFromTo__d1 (succItem__d1 _lh_itemFromTo_arg1_1)) _lh_itemFromTo_arg2_1) in
      (let rec _lh_listcomp_fun_ls_h_6 = _lh_itemFromTo_arg1_1 in
        (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_3 -> 
          ...
          (_lh_listcomp_fun_1_2 ((itemFromTo__d2 (succItem__d3 _lh_listcomp_fun_ls_h_6)) (`Adam)))))))
and itemFromTo__d2 _lh_itemFromTo_arg1_0 _lh_itemFromTo_arg2_0 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 _lh_popOutId_4_0 _lh_popOutId_5_0 _lh_popOutId_6_0 _lh_popOutId_7_0 _lh_popOutId_8_0 _lh_popOutId_9_0 _lh_popOutId_10_0 =
  (if (_lh_itemFromTo_arg1_0 = _lh_itemFromTo_arg2_0) then
    (let rec _lh_listcomp_fun_ls_t_0 = (fun _lh_listcomp_fun_ls_h_0 _lh_listcomp_fun_0 _lh_transfer_arg1_0 _lh_transfer_arg2_0 _lh_transfer_arg3_0 _lh_transfer_arg4_0 _lh_transfer_arg5_0 newHistory_0 newLocation_0 _lh_listcomp_fun_ls_t_1 _lh_listcomp_fun_1 -> 
      (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1)) in
      (let rec _lh_listcomp_fun_ls_h_1 = _lh_itemFromTo_arg1_0 in
        (if ((((position__d1 _lh_popOutId_0_0) _lh_popOutId_3_0) = _lh_popOutId_4_0) && (((position__d2 _lh_listcomp_fun_ls_h_1) _lh_popOutId_3_0) = _lh_popOutId_4_0)) then
          (let rec newDest_0 = (((updateState__d1 (((updateState__d2 _lh_popOutId_3_0) _lh_popOutId_0_0) _lh_popOutId_8_0)) _lh_listcomp_fun_ls_h_1) _lh_popOutId_8_0) in
            (if ((notSeen__d1 newDest_0) _lh_popOutId_6_0) then
              (let rec newTime_0 = (_lh_popOutId_5_0 + (u2times__d1 _lh_popOutId_0_0)) in
                (let rec t_2 = (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_0) in
                  (let rec h_2 = (((((transfer__d0 _lh_popOutId_2_0) newDest_0) _lh_popOutId_8_0) newTime_0) _lh_popOutId_7_0) in
                    (fun _lh_dummy_0 -> 
                      ((mappend__d1 h_2) (concat__d1 t_2))))))
            else
    ...
    (let rec _lh_listcomp_fun_ls_t_3 = ((itemFromTo__d2 (succItem__d2 _lh_itemFromTo_arg1_0)) _lh_itemFromTo_arg2_0) in
      (let rec _lh_listcomp_fun_ls_h_3 = _lh_itemFromTo_arg1_0 in
        (if ((((position__d1 _lh_popOutId_0_0) _lh_popOutId_3_0) = _lh_popOutId_4_0) && (((position__d2 _lh_listcomp_fun_ls_h_3) _lh_popOutId_3_0) = _lh_popOutId_4_0)) then
          (let rec newDest_1 = (((updateState__d1 (((updateState__d2 _lh_popOutId_3_0) _lh_popOutId_0_0) _lh_popOutId_8_0)) _lh_listcomp_fun_ls_h_3) _lh_popOutId_8_0) in
            (if ((notSeen__d1 newDest_1) _lh_popOutId_6_0) then
              (let rec newTime_1 = (_lh_popOutId_5_0 + (u2times__d1 _lh_popOutId_0_0)) in
                (let rec t_3 = (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_3) in
                  (let rec h_3 = (((((transfer__d0 _lh_popOutId_2_0) newDest_1) _lh_popOutId_8_0) newTime_1) _lh_popOutId_7_0) in
                    (fun _lh_dummy_1 -> 
                      ((mappend__d1 h_3) (concat__d1 t_3))))))
            else
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Puzzle_nofib" (fun () -> ignore (let open Module_original in ((testPuzzle_nofib__d0 (`LH_C(2, (`LH_N)))))));
  Bench.Test.create ~name:"lumberhack_Puzzle_nofib" (fun () -> ignore (let open Module_lumberhack in ((testPuzzle_nofib__d0 (`LH_C(2, (`LH_N)))))));
  Bench.Test.create ~name:"lumberhack_pop_out_Puzzle_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testPuzzle_nofib__d0 (`LH_C(2, (`LH_N)))))));
])

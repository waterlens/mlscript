...
let rec foldr_lh__d1 f_7 i_1 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_2_5, t_2_5) -> 
      ((f_7 h_2_5) (((foldr_lh__d1 f_7) i_1) t_2_5))
    | `LH_N -> 
      i_1);;
  ...
  (match _lh_break_arg2_1 with
    ...
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_1) then
        ...
        (let rec _lh_matchIdent_1_1 = ((break_lh__d1 _lh_break_arg1_1) _lh_break_LH_C_1_1) in
...
let rec words_lh__d1 _lh_words_arg1_1 =
  (let rec _lh_matchIdent_1_3 = ((dropWhile_lh__d1 isSpace_lh__d2) _lh_words_arg1_1) in
    (match _lh_matchIdent_1_3 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1) -> 
        (let rec _lh_matchIdent_1_4 = ((break_lh__d1 isSpace_lh__d1) (`LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1))) in
...
let rec length_lh__d1 ls_1_5 =
  (match ls_1_5 with
    ...
    | `LH_N -> 
      0);;
let rec filter_lh__d1 f_1_0 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_3_0, t_3_0) -> 
      (if (f_1_0 h_3_0) then
        (`LH_C(h_3_0, ((filter_lh__d1 f_1_0) t_3_0)))
      else
        ((filter_lh__d1 f_1_0) t_3_0))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d3 xs_1_1 ys_1_0 =
  (match xs_1_1 with
    | `LH_C(h_2_1, t_2_1) -> 
      (`LH_C(h_2_1, ((mappend_lh__d3 t_2_1) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec mappend_lh__d8 xs_6 ys_5 =
  (match xs_6 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C(h_1_6, ((mappend_lh__d8 t_1_6) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec mappend_lh__d7 xs_7 ys_6 =
  (match xs_7 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C(h_1_7, ((mappend_lh__d7 t_1_7) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec mappend_lh__d5 xs_9 ys_8 =
  (match xs_9 with
    | `LH_C(h_1_9, t_1_9) -> 
      (`LH_C(h_1_9, ((mappend_lh__d5 t_1_9) ys_8)))
    | `LH_N -> 
      ys_8);;
let rec mappend_lh__d6 xs_8 ys_7 =
  (match xs_8 with
    | `LH_C(h_1_8, t_1_8) -> 
      (`LH_C(h_1_8, ((mappend_lh__d6 t_1_8) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec mappend_lh__d4 xs_1_0 ys_9 =
  (match xs_1_0 with
    | `LH_C(h_2_0, t_2_0) -> 
      (`LH_C(h_2_0, ((mappend_lh__d4 t_2_0) ys_9)))
    | `LH_N -> 
      ys_9);;
  ...
  (match _lh_makeResponse_arg1_0 with
    | `LH_C(_lh_makeResponse_LH_C_0_0, _lh_makeResponse_LH_C_1_0) -> 
      (match _lh_makeResponse_LH_C_0_0 with
        | '?' -> 
          ((mappend_lh__d3 ((mappend_lh__d8 ((mappend_lh__d7 _lh_makeResponse_LH_C_1_0) (`LH_C(' ', (`LH_N))))) _lh_makeResponse_arg2_0)) (`LH_C('?', (`LH_N))))
        | '.' -> 
          ((mappend_lh__d4 ((mappend_lh__d6 ((mappend_lh__d5 _lh_makeResponse_LH_C_1_0) (`LH_C(' ', (`LH_N))))) _lh_makeResponse_arg2_0)) (`LH_C('.', (`LH_N))))
        | _ -> 
...
let rec lz_map_lh__d1 _lh_lz_map_arg1_0 _lh_lz_map_arg2_0 =
  (let rec _lh_matchIdent_5 = _lh_lz_map_arg2_0 in
...
let rec prefix_lh__d1 _lh_prefix_arg1_0 _lh_prefix_arg2_0 =
  (let rec _lh_matchIdent_3 = _lh_prefix_arg1_0 in
    (match _lh_matchIdent_3 with
      | `LH_N -> 
        true
      | `LH_C(_lh_prefix_LH_C_0_0, _lh_prefix_LH_C_1_0) -> 
        (let rec _lh_matchIdent_4 = (Lazy.force _lh_prefix_arg2_0) in
...
let rec toUpper_lh__d1 _lh_toUpper_arg1_1 =
  (let rec _lh_matchIdent_2 = _lh_toUpper_arg1_1 in
...
let rec map_lh__d4 f_4 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C((f_4 h_1_2), ((map_lh__d4 f_4) t_1_2)))
    | `LH_N -> 
      (`LH_N));;
...
let rec foldr_lh__d2 f_3 i_0 ls_5 =
  (match ls_5 with
    | `LH_C(h_1_1, t_1_1) -> 
      ((f_3 h_1_1) (((foldr_lh__d2 f_3) i_0) t_1_1))
    | `LH_N -> 
      i_0);;
...
let rec map_lh__d7 f_0 ls_0 =
  (match ls_0 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C((f_0 h_1), ((map_lh__d7 f_0) t_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d5 f_2 ls_4 =
  (match ls_4 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_2 h_9), ((map_lh__d5 f_2) t_9)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d1_d3 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_0, t_0) -> 
      (`LH_C(h_0, ((mappend_lh__d1_d3 t_0) ys_0)))
    | `LH_N -> 
      ys_0);;
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_3, t_3) -> 
      ((mappend_lh__d1_d3 h_3) (concat_lh__d1 t_3))
    | `LH_N -> 
      (`LH_N));;
...
let rec conjug_lh__d1 _lh_conjug_arg1_0 _lh_conjug_arg2_0 =
  ...
  and trailingI_0 = (fun _lh_trailingI_arg1_0 -> 
    (let rec cons_0 = (fun x_0 xs_5 -> 
      (if ((x_0 = (`LH_C('I', (`LH_N)))) && (null_lh__d4 xs_5)) then
...
let rec filter_lh__d2 f_6 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_5, t_1_5) -> 
      (if (f_6 h_1_5) then
        (`LH_C(h_1_5, ((filter_lh__d2 f_6) t_1_5)))
      else
        ((filter_lh__d2 f_6) t_1_5))
    | `LH_N -> 
      (`LH_N));;
  ...
  ((fun _lh_funcomp_x_3 -> 
    ((fun _lh_funcomp_x_4 -> 
      ((map_lh__d3 (fun _lh_funcomp_x_5 -> 
        ((conjug_lh__d1 _lh_replies_arg2_0) ((drop_lh__d1 (length_lh__d2 _lh_replies_arg1_0)) _lh_funcomp_x_5)))) ((filter_lh__d2 (fun ls_1_0 -> 
        ((prefix_lh__d1 _lh_replies_arg1_0) ((lz_map_lh__d1 ucase_lh__d1) ls_1_0)))) _lh_funcomp_x_4))) (tails_lh__d1 _lh_funcomp_x_3))) _lh_replies_arg2_0);;
  ...
  and ans_0 = (fun _lh_ans_arg1_0 _lh_ans_arg2_0 -> 
    (match _lh_ans_arg1_0 with
      | `LH_C(_lh_ans_LH_C_0_0, _lh_ans_LH_C_1_0) -> 
        (let rec _lh_matchIdent_9 = _lh_ans_LH_C_0_0 in
      ...
      | _ -> 
        (failwith "error")))
  in (let rec _lh_matchIdent_1_0 = ((ans_0 (keyTabOf_lh__d1 _lh_answer_arg1_0)) _lh_answer_arg2_0) in
...
let rec mappend_lh__d2 xs_1_2 ys_1_1 =
  (match xs_1_2 with
    | `LH_C(h_2_3, t_2_3) -> 
      (`LH_C(h_2_3, ((mappend_lh__d2 t_2_3) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
...
let rec session_lh__d1 _lh_session_arg1_0 _lh_session_arg2_0 _lh_session_arg3_0 =
  (match _lh_session_arg3_0 with
    ...
    | `LH_C(_lh_session_LH_C_0_0, _lh_session_LH_C_1_0) -> 
      (let rec _lh_matchIdent_1_2 = (if (_lh_session_arg2_0 = _lh_session_LH_C_0_0) then
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_6 = ((break_lh__d2 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
...
let rec words_lh__d2 _lh_words_arg1_0 =
  (let rec _lh_matchIdent_7 = ((dropWhile_lh__d3 isSpace_lh__d3) _lh_words_arg1_0) in
    (match _lh_matchIdent_7 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0) -> 
        (let rec _lh_matchIdent_8 = ((break_lh__d2 isSpace_lh__d4) (`LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0))) in
...
let rec take_lh__d1 n_0 ls_1_6 =
  (if (n_0 > 0) then
    (match ls_1_6 with
      | `LH_C(h_2_9, t_2_9) -> 
        (`LH_C(h_2_9, ((take_lh__d1 (n_0 - 1)) t_2_9)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
let rec map_lh__d2 f_8 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_2_6, t_2_6) -> 
      (`LH_C((f_8 h_2_6), ((map_lh__d2 f_8) t_2_6)))
    | `LH_N -> 
      (`LH_N));;

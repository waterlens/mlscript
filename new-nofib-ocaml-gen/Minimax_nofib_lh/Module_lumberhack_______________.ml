              ...
              (fun f_1 -> 
                (let rec t_3_7 = ((map_lh__d5 f_1) t_3_6) in
                  (let rec h_3_6 = (f_1 h_3_5) in
                    (fun _lh_dummy_1 -> 
                      ((mappend_lh__d2_d1 h_3_6) (concat_lh__d3 t_3_7)))))))))))
  else
...
let rec enumFromTo_lh__d1 a_1 b_1 =
  (if (a_1 <= b_1) then
    ...
    (fun _lh_listcomp_fun_7 f_6 _lh_dummy_1_8 -> 
      (`LH_N)));;
    ...
    (let rec h_1_5_5 = win8_lh__d1 in
      (fun f_1_4 -> 
        (let rec _lh_interpret_LH_C_1_1 = ((map_lh__d4 f_1_4) t_1_9_0) in
          (let rec _lh_interpret_LH_C_0_1 = (f_1_4 h_1_5_5) in
    ...
    (let rec h_1_5_6 = win7_lh__d1 in
      (fun f_1_5 -> 
        (let rec _lh_interpret_LH_C_1_2 = ((map_lh__d4 f_1_5) t_1_8_9) in
          (let rec _lh_interpret_LH_C_0_2 = (f_1_5 h_1_5_6) in
    ...
    (let rec h_1_5_7 = win6_lh__d1 in
      (fun f_1_6 -> 
        (let rec _lh_interpret_LH_C_1_3 = ((map_lh__d4 f_1_6) t_1_8_8) in
          (let rec _lh_interpret_LH_C_0_3 = (f_1_6 h_1_5_7) in
    ...
    (let rec h_1_5_8 = win5_lh__d1 in
      (fun f_1_7 -> 
        (let rec _lh_interpret_LH_C_1_4 = ((map_lh__d4 f_1_7) t_1_8_7) in
          (let rec _lh_interpret_LH_C_0_4 = (f_1_7 h_1_5_8) in
    ...
    (let rec h_1_5_9 = win4_lh__d1 in
      (fun f_1_8 -> 
        (let rec _lh_interpret_LH_C_1_5 = ((map_lh__d4 f_1_8) t_1_8_6) in
          (let rec _lh_interpret_LH_C_0_5 = (f_1_8 h_1_5_9) in
    ...
    (let rec h_1_6_0 = win3_lh__d1 in
      (fun f_1_9 -> 
        (let rec _lh_interpret_LH_C_1_6 = ((map_lh__d4 f_1_9) t_1_8_5) in
          (let rec _lh_interpret_LH_C_0_6 = (f_1_9 h_1_6_0) in
    ...
    (let rec h_1_6_1 = win2_lh__d1 in
      (fun f_2_0 -> 
        (let rec _lh_interpret_LH_C_1_7 = ((map_lh__d4 f_2_0) t_1_8_4) in
          (let rec _lh_interpret_LH_C_0_7 = (f_2_0 h_1_6_1) in
    ...
    (let rec h_1_6_2 = win1_lh__d1 in
      (fun f_2_1 -> 
        (let rec _lh_interpret_LH_C_1_8 = ((map_lh__d4 f_2_1) t_1_8_3) in
          (let rec _lh_interpret_LH_C_0_8 = (f_2_1 h_1_6_2) in
  ...
  (match _lh_showEvaluation_arg1_0 with
    ...
    | `Score(_lh_showEvaluation_Score_0_0) -> 
      ((mappend_lh__d1_d1 (let rec t_4_9 = (let rec t_5_0 = (let rec t_5_1 = (let rec t_5_2 = (let rec t_5_3 = (fun ys_6_1 -> 
        ...
        (let rec h_4_6 = 'e' in
          (fun ys_6_2 -> 
            (`LH_C(h_4_6, ((mappend_lh__d1_d1 t_5_3) ys_6_2)))))) in
        (let rec h_4_7 = 'r' in
          (fun ys_6_3 -> 
            (`LH_C(h_4_7, ((mappend_lh__d1_d1 t_5_2) ys_6_3)))))) in
        (let rec h_4_8 = 'o' in
          (fun ys_6_4 -> 
            (`LH_C(h_4_8, ((mappend_lh__d1_d1 t_5_1) ys_6_4)))))) in
        (let rec h_4_9 = 'c' in
          (fun ys_6_5 -> 
            (`LH_C(h_4_9, ((mappend_lh__d1_d1 t_5_0) ys_6_5)))))) in
        (let rec h_5_0 = 'S' in
          (fun ys_6_6 -> 
            (`LH_C(h_5_0, ((mappend_lh__d1_d1 t_4_9) ys_6_6))))))) (string_of_int _lh_showEvaluation_Score_0_0))
    | _ -> 
      (failwith "error"));;
                                  ...
                                  (fun ys_1_6_1 -> 
                                    (let rec t_1_5_5 = ((mappend_lh__d9 t_1_5_4) ys_1_6_1) in
                                      (let rec h_1_3_1 = h_1_3_0 in
                                        (fun ys_1_6_2 -> 
                                          (`LH_C(h_1_3_1, ((mappend_lh__d7 t_1_5_5) ys_1_6_2)))))))))))))))))))))
    | `O -> 
                                  ...
                                  (fun ys_1_6_8 -> 
                                    (let rec t_1_6_1 = ((mappend_lh__d9 t_1_6_0) ys_1_6_8) in
                                      (let rec h_1_3_7 = h_1_3_6 in
                                        (fun ys_1_6_9 -> 
                                          (`LH_C(h_1_3_7, ((mappend_lh__d7 t_1_6_1) ys_1_6_9)))))))))))))))))))))
    | `Empty -> 
                                  ...
                                  (fun ys_1_7_5 -> 
                                    (let rec t_1_6_7 = ((mappend_lh__d9 t_1_6_6) ys_1_7_5) in
                                      (let rec h_1_4_3 = h_1_4_2 in
                                        (fun ys_1_7_6 -> 
                                          (`LH_C(h_1_4_3, ((mappend_lh__d7 t_1_6_7) ys_1_7_6)))))))))))))))))))))
    | _ -> 
      (failwith "error"));;
              ...
              (match _lh_showBoard_LH_C_1_2 with
                | `LH_N -> 
                  ((mappend_lh__d6 ((mappend_lh__d1_d0 ((mappend_lh__d8 ((mappend_lh__d7 ((mappend_lh__d9 (showRow_lh__d1 _lh_showBoard_LH_C_0_0)) (let rec t_6_9 = (let rec t_7_0 = (let rec t_7_1 = (let rec t_7_2 = (let rec t_7_3 = (let rec t_7_4 = (let rec t_7_5 = (let rec t_7_6 = (fun ys_8_6 -> 
                    ...
                    (let rec h_6_3 = '|' in
                      (fun ys_8_7 -> 
                        (`LH_C(h_6_3, ((mappend_lh__d7 t_7_6) ys_8_7)))))) in
                    (let rec h_6_4 = '-' in
                      (fun ys_8_8 -> 
                        (`LH_C(h_6_4, ((mappend_lh__d7 t_7_5) ys_8_8)))))) in
                    (let rec h_6_5 = '-' in
                      (fun ys_8_9 -> 
                        (`LH_C(h_6_5, ((mappend_lh__d7 t_7_4) ys_8_9)))))) in
                    (let rec h_6_6 = '-' in
                      (fun ys_9_0 -> 
                        (`LH_C(h_6_6, ((mappend_lh__d7 t_7_3) ys_9_0)))))) in
                    (let rec h_6_7 = '-' in
                      (fun ys_9_1 -> 
                        (`LH_C(h_6_7, ((mappend_lh__d7 t_7_2) ys_9_1)))))) in
                    (let rec h_6_8 = '-' in
                      (fun ys_9_2 -> 
                        (`LH_C(h_6_8, ((mappend_lh__d7 t_7_1) ys_9_2)))))) in
                    (let rec h_6_9 = '-' in
                      (fun ys_9_3 -> 
                        (`LH_C(h_6_9, ((mappend_lh__d7 t_7_0) ys_9_3)))))) in
                    (let rec h_7_0 = '|' in
                      (fun ys_9_4 -> 
                        (`LH_C(h_7_0, ((mappend_lh__d7 t_6_9) ys_9_4)))))))) (showRow_lh__d3 _lh_showBoard_LH_C_0_1))) (let rec t_7_7 = (let rec t_7_8 = (let rec t_7_9 = (let rec t_8_0 = (let rec t_8_1 = (let rec t_8_2 = (let rec t_8_3 = (let rec t_8_4 = (fun ys_9_5 -> 
                    ys_9_5) in
                    (let rec h_7_1 = '|' in
                      (fun ys_9_6 -> 
                                ...
                                (let rec h_1_5_1 = (let rec _lh_showMove_LH_P2_1_0 = _lh_alternate_LH_P2_1_0 in
                                  ...
                                  (fun f_9 -> 
                                    (let rec t_1_8_2 = ((map_lh__d1 f_9) t_1_7_8) in
                                      (let rec h_1_5_4 = (f_9 h_1_5_1) in
                                        (fun _lh_dummy_3_3 -> 
                                          ((mappend_lh__d3 h_1_5_4) (concat_lh__d1 t_1_8_2)))))))))))
                      | _ -> 
                        (failwith "error")))
...
let rec testBoard_lh__d2_d9 =
  (let rec t_3_3 = (let rec t_3_4 = (let rec t_3_5 = (fun ys_4_4 -> 
    ...
    (let rec h_3_2 = (`LH_C((`Empty), (`LH_C((`Empty), (`LH_C((`Empty), (`LH_N))))))) in
      (fun ys_4_5 -> 
        (`LH_C(h_3_2, ((mappend_lh__d1 t_3_5) ys_4_5)))))) in
    (let rec h_3_3 = (`LH_C((`Empty), (`LH_C((`X), (`LH_C((`Empty), (`LH_N))))))) in
      (fun ys_4_6 -> 
        (`LH_C(h_3_3, ((mappend_lh__d1 t_3_4) ys_4_6)))))) in
    (let rec h_3_4 = (`LH_C((`Empty), (`LH_C((`O), (`LH_C((`Empty), (`LH_N))))))) in
      (fun ys_4_7 -> 
        (`LH_C(h_3_4, ((mappend_lh__d1 t_3_3) ys_4_7))))));;

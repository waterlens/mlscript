(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./DigitsOfE2_nofib.ml -o "./DigitsOfE2_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./DigitsOfE2_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;
...
let rec append_lz_d1_d0 _lh_append_lz_arg1_1 _lh_append_lz_arg2_1 =
  (let rec _lh_matchIdent_2 = _lh_append_lz_arg1_1 in
    (match _lh_matchIdent_2 with
      ...
      | _ -> 
        (failwith "error")));;
let rec carryPropagate_d0_d0 _lh_carryPropagate_arg1_0 _lh_carryPropagate_arg2_0 =
...
let rec map_lz_d1_d0 f_1 ls_1 =
  (lazy (match (Lazy.force ls_1) with
    | `LH_C(h_0, t_0) -> 
      (`LH_C((f_1 h_0), ((map_lz_d1_d0 f_1) t_0)))
    | `LH_N -> 
      (`LH_N)));;
...
let rec e_d0_d0 _lh_e_arg1_0 =
  ((take_lz_d0_d0 _lh_e_arg1_0) ((fun b_0 -> 
    ((append_lz_d0_d0 (let rec _lh_append_lz_LH_C_0_1 = (lazy '2') in
      (let rec _lh_append_lz_LH_C_1_1 = (lazy (let rec _lh_append_lz_LH_C_0_2 = (lazy '.') in
        (let rec _lh_append_lz_LH_C_1_2 = (lazy (fun _lh_append_lz_arg2_2 -> 
          _lh_append_lz_arg2_2)) in
          (fun _lh_append_lz_arg2_3 -> 
            (lazy (`LH_C((Lazy.force _lh_append_lz_LH_C_0_2), ((append_lz_d0_d0 (Lazy.force _lh_append_lz_LH_C_1_2)) _lh_append_lz_arg2_3)))))))) in
        (fun _lh_append_lz_arg2_4 -> 
          (lazy (`LH_C((Lazy.force _lh_append_lz_LH_C_0_1), ((append_lz_d0_d0 (Lazy.force _lh_append_lz_LH_C_1_1)) _lh_append_lz_arg2_4)))))))) b_0)) ((fun _lh_funcomp_x_0 -> 
...
and iterate_d0_d0 f_2 x_0 =
  (lazy (let rec h_2 = (lazy x_0) in
    (let rec t_2 = (lazy ((iterate_d0_d0 f_2) (f_2 x_0))) in
      (fun f_3 -> 
        (let rec _lh_concat_lz_LH_C_0_0 = (lazy (f_3 (Lazy.force h_2))) in
          (let rec _lh_concat_lz_LH_C_1_0 = (lazy ((map_lz_d0_d0 f_3) (Lazy.force t_2))) in
            (Lazy.force ((append_lz_d1_d0 (Lazy.force _lh_concat_lz_LH_C_0_0)) (concat_lz_d0_d0 (Lazy.force _lh_concat_lz_LH_C_1_0))))))))))
and testDigitsOfE2_nofib_d0_d0 _lh_testDigitsOfE2_nofib_arg1_0 =
  (e_d0_d0 _lh_testDigitsOfE2_nofib_arg1_0);;

(* lumberhack_pop_out *)
let rec append_lz_d0_d0_d0 _lh_append_lz_arg1_3 _lh_append_lz_arg2_6 =
  (let rec _lh_matchIdent_8 = _lh_append_lz_arg1_3 in
    (_lh_matchIdent_8 _lh_append_lz_arg2_6));;
let rec append_lz_d0_d0_d1 _lh_append_lz_arg1_5 _lh_append_lz_arg2_8 =
  (let rec _lh_matchIdent_1_4 = _lh_append_lz_arg1_5 in
    (_lh_matchIdent_1_4 _lh_append_lz_arg2_8));;
let rec append_lz_d0_d0_d2 _lh_append_lz_arg1_4 _lh_append_lz_arg2_7 =
  (let rec _lh_matchIdent_1_3 = _lh_append_lz_arg1_4 in
    (_lh_matchIdent_1_3 _lh_append_lz_arg2_7));;
let rec append_lz_d1_d0_d0 _lh_append_lz_arg1_2 _lh_append_lz_arg2_5 =
  (let rec _lh_matchIdent_7 = _lh_append_lz_arg1_2 in
    (match _lh_matchIdent_7 with
      | `LH_C(_lh_append_lz_LH_C_0_3, _lh_append_lz_LH_C_1_3) -> 
        (lazy (`LH_C(_lh_append_lz_LH_C_0_3, ((append_lz_d1_d0_d0 _lh_append_lz_LH_C_1_3) _lh_append_lz_arg2_5))))
      | `LH_N -> 
        _lh_append_lz_arg2_5
      | _ -> 
        (failwith "error")));;
let rec carryPropagate_d0_d0_d0 _lh_carryPropagate_arg1_1 _lh_carryPropagate_arg2_1 =
  (lazy (let rec _lh_matchIdent_9 = (Lazy.force _lh_carryPropagate_arg2_1) in
    (match _lh_matchIdent_9 with
      | `LH_C(_lh_carryPropagate_LH_C_0_3, _lh_carryPropagate_LH_C_1_3) -> 
        (let rec carryguess_1 = (_lh_carryPropagate_LH_C_0_3 / _lh_carryPropagate_arg1_1) in
          (let rec remainder_1 = (_lh_carryPropagate_LH_C_0_3 mod _lh_carryPropagate_arg1_1) in
            (let rec recRes_1 = ((carryPropagate_d0_d0_d0 (_lh_carryPropagate_arg1_1 + 1)) _lh_carryPropagate_LH_C_1_3) in
              (if (carryguess_1 = ((_lh_carryPropagate_LH_C_0_3 + 9) / _lh_carryPropagate_arg1_1)) then
                (let rec tail_1 = (lazy (let rec _lh_matchIdent_1_0 = (Lazy.force recRes_1) in
                  (match _lh_matchIdent_1_0 with
                    | `LH_C(_lh_carryPropagate_LH_C_0_4, _lh_carryPropagate_LH_C_1_4) -> 
                      (`LH_C((remainder_1 + _lh_carryPropagate_LH_C_0_4), _lh_carryPropagate_LH_C_1_4))
                    | _ -> 
                ...
                (let rec _lh_matchIdent_1_1 = (Lazy.force recRes_1) in
      ...
      | _ -> 
        (failwith "error"))));;
let rec concat_lz_d0_d0_d0 _lh_concat_lz_arg1_1 =
  (lazy (let rec _lh_matchIdent_6 = (Lazy.force _lh_concat_lz_arg1_1) in
    _lh_matchIdent_6));;
let rec concat_lz_d0_d0_d1 _lh_concat_lz_arg1_2 =
  (lazy (let rec _lh_matchIdent_1_2 = (Lazy.force _lh_concat_lz_arg1_2) in
    _lh_matchIdent_1_2));;
let rec enumFromThen_d0_d0_d0 a_2 t_8 =
  (lazy (`LH_C(a_2, ((enumFromThen_d0_d0_d0 t_8) ((2 * t_8) - a_2)))));;
let rec head_lz_d0_d0_d0 ls_1_0 =
  (match (Lazy.force ls_1_0) with
    | `LH_C(h_1_0, t_1_2) -> 
      h_1_0
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_d0_d0_d0 f_8 ls_1_2 =
  (lazy ((Lazy.force ls_1_2) f_8));;
let rec map_lz_d0_d0_d1 f_4 ls_6 =
  (lazy ((Lazy.force ls_6) f_4));;
let rec map_lz_d1_d0_d0 f_7 ls_1_1 =
  (lazy (match (Lazy.force ls_1_1) with
    | `LH_C(h_1_1, t_1_3) -> 
      (`LH_C((f_7 h_1_1), ((map_lz_d1_d0_d0 f_7) t_1_3)))
    | `LH_N -> 
      (`LH_N)));;
let rec tail_lz_d0_d0_d0 ls_9 =
...
let rec tail_lz_d1_d0_d0 ls_8 =
  (match (Lazy.force ls_8) with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec take_lz_d0_d0_d0 n_1 ls_7 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_7) with
      | `LH_C(h_6, t_7) -> 
        (`LH_C(h_6, ((take_lz_d0_d0_d0 (n_1 - 1)) t_7)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
let rec e_d0_d0_d0 _lh_e_arg1_1 =
  ((take_lz_d0_d0_d0 _lh_e_arg1_1) ((fun b_1 -> 
    ((append_lz_d0_d0_d0 (let rec _lh_append_lz_LH_C_0_4 = (lazy '2') in
      (let rec _lh_append_lz_LH_C_1_4 = (lazy (let rec _lh_append_lz_LH_C_0_5 = (lazy '.') in
        (let rec _lh_append_lz_LH_C_1_5 = (lazy (fun _lh_append_lz_arg2_9 -> 
          _lh_append_lz_arg2_9)) in
          (fun _lh_append_lz_arg2_1_0 -> 
            (lazy (`LH_C((Lazy.force _lh_append_lz_LH_C_0_5), ((append_lz_d0_d0_d1 (Lazy.force _lh_append_lz_LH_C_1_5)) _lh_append_lz_arg2_1_0)))))))) in
        (fun _lh_append_lz_arg2_1_1 -> 
          (lazy (`LH_C((Lazy.force _lh_append_lz_LH_C_0_4), ((append_lz_d0_d0_d2 (Lazy.force _lh_append_lz_LH_C_1_4)) _lh_append_lz_arg2_1_1)))))))) b_1)) ((fun _lh_funcomp_x_4 -> 
...
and iterate_d0_d0_d0 f_5 x_1 =
  (lazy (let rec h_8 = (lazy x_1) in
    (let rec t_1_0 = (lazy ((iterate_d0_d0_d0 f_5) (f_5 x_1))) in
      (fun f_6 -> 
        (let rec _lh_concat_lz_LH_C_0_1 = (lazy (f_6 (Lazy.force h_8))) in
          (let rec _lh_concat_lz_LH_C_1_1 = (lazy ((map_lz_d0_d0_d0 f_6) (Lazy.force t_1_0))) in
            (Lazy.force ((append_lz_d1_d0_d0 (Lazy.force _lh_concat_lz_LH_C_0_1)) (concat_lz_d0_d0_d1 (Lazy.force _lh_concat_lz_LH_C_1_1))))))))))

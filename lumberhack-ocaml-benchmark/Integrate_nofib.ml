...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Integrate_nofib" (fun () -> ignore (let open Module_original in ((testIntegrate_nofib__d0 100))));
  Bench.Test.create ~name:"lumberhack_Integrate_nofib" (fun () -> ignore (let open Module_lumberhack in ((testIntegrate_nofib__d0 100))));
  Bench.Test.create ~name:"lumberhack_pop_out_Integrate_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testIntegrate_nofib__d0 100))));
])

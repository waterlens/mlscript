...
let rec lookup_lh__d0 _lh_lookup_arg1_2 _lh_lookup_arg2_2 =
  (match _lh_lookup_arg2_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec enumFromTo_lh__d0 a_2 b_0 _lh_popOutId_0_0 =
  (if (a_2 <= b_0) then
    (let rec t_3_8 = ((enumFromTo_lh__d0 (a_2 + 1)) b_0) in
      (let rec h_3_7 = a_2 in
        (`LH_C((_lh_popOutId_0_0 h_3_7), ((map_lh__d0 _lh_popOutId_0_0) t_3_8)))))
  else
    (`LH_N));;
...
let rec map_lh__d4 f_6_3 ls_2_7 _lh_popOutId_0_2 =
  (match ls_2_7 with
    | `LH_C(h_8_4, t_8_5) -> 
...
let rec map_lh__d8 f_6_8 ls_3_2 _lh_popOutId_0_3 =
  (match ls_3_2 with
    | `LH_C(h_8_7, t_8_8) -> 
...
let rec map_lh__d1 f_4_7 ls_1_8 _lh_popOutId_0_1 =
  (match ls_1_8 with
    | `LH_C(h_5_7, t_5_8) -> 

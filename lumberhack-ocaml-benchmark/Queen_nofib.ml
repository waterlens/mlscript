(*
ocamlfind ocamlopt -rectypes -thread -O3 ./Queen_nofib.ml -o "./Queen_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./Queen_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

            ...
            (fun _lh_interpret_arg1_3 -> 
              (match _lh_interpret_LH_C_0_1 with
                | `Score(_lh_interpret_Score_0_1) -> 
                  (_lh_interpret_LH_C_1_1 (_lh_interpret_arg1_3 + _lh_interpret_Score_0_1))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
            ...
            (fun _lh_interpret_arg1_4 -> 
              (match _lh_interpret_LH_C_0_2 with
                | `Score(_lh_interpret_Score_0_2) -> 
                  (_lh_interpret_LH_C_1_2 (_lh_interpret_arg1_4 + _lh_interpret_Score_0_2))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
            ...
            (fun _lh_interpret_arg1_5 -> 
              (match _lh_interpret_LH_C_0_3 with
                | `Score(_lh_interpret_Score_0_3) -> 
                  (_lh_interpret_LH_C_1_3 (_lh_interpret_arg1_5 + _lh_interpret_Score_0_3))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
            ...
            (fun _lh_interpret_arg1_6 -> 
              (match _lh_interpret_LH_C_0_4 with
                | `Score(_lh_interpret_Score_0_4) -> 
                  (_lh_interpret_LH_C_1_4 (_lh_interpret_arg1_6 + _lh_interpret_Score_0_4))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
            ...
            (fun _lh_interpret_arg1_7 -> 
              (match _lh_interpret_LH_C_0_5 with
                | `Score(_lh_interpret_Score_0_5) -> 
                  (_lh_interpret_LH_C_1_5 (_lh_interpret_arg1_7 + _lh_interpret_Score_0_5))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
            ...
            (fun _lh_interpret_arg1_8 -> 
              (match _lh_interpret_LH_C_0_6 with
                | `Score(_lh_interpret_Score_0_6) -> 
                  (_lh_interpret_LH_C_1_6 (_lh_interpret_arg1_8 + _lh_interpret_Score_0_6))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
            ...
            (fun _lh_interpret_arg1_9 -> 
              (match _lh_interpret_LH_C_0_7 with
                | `Score(_lh_interpret_Score_0_7) -> 
                  (_lh_interpret_LH_C_1_7 (_lh_interpret_arg1_9 + _lh_interpret_Score_0_7))
                | `XWin -> 
                  (`XWin)
                | `OWin -> 
                  (`OWin)
                          ...
                          (let rec _lh_alternate_LH_P2_0_0 = b_2 in
                            (fun _lh_alternate_arg2_0 _lh_alternate_arg3_0 opposition_1 -> 
                              (let rec t_1_7_8 = (if (fullBoard_lh__d1 _lh_alternate_LH_P2_0_0) then
                                (fun f_1_2 _lh_dummy_3_5 _lh_dummy_3_6 -> 
                                  0)
                              else
                                (if ((static_lh__d2 _lh_alternate_LH_P2_0_0) = (`XWin)) then
                                  (fun f_1_3 _lh_dummy_3_7 _lh_dummy_3_8 -> 
                                    0)
                                else
                                  (if ((static_lh__d1 _lh_alternate_LH_P2_0_0) = (`OWin)) then
                                    (fun f_1_4 _lh_dummy_3_9 _lh_dummy_4_0 -> 
                                      0)
                                  else

...
let rec map_lh__d1 f_0 ls_0 =
  (ls_0 f_0);;
let rec concat_lh__d2 lss_2 =
  (lss_2 99);;
let rec negin_lh__d0 _lh_negin_arg1_0 =
  (match _lh_negin_arg1_0 with
    | `Not(_lh_negin_Not_0_0) -> 
      (match _lh_negin_Not_0_0 with
        | `Not(_lh_negin_Not_0_1) -> 
          (negin_lh__d0 _lh_negin_Not_0_1)
        | `Con(_lh_negin_Con_0_0, _lh_negin_Con_1_0) -> 
          (`Dis((negin_lh__d0 (`Not(_lh_negin_Con_0_0))), (negin_lh__d0 (`Not(_lh_negin_Con_1_0)))))
        | `Dis(_lh_negin_Dis_0_0, _lh_negin_Dis_1_0) -> 
          (`Con((negin_lh__d0 (`Not(_lh_negin_Dis_0_0))), (negin_lh__d0 (`Not(_lh_negin_Dis_1_0)))))
        | _ -> 
          _lh_negin_arg1_0)
    | `Dis(_lh_negin_Dis_0_1, _lh_negin_Dis_1_1) -> 
      (`Dis((negin_lh__d0 _lh_negin_Dis_0_1), (negin_lh__d0 _lh_negin_Dis_1_1)))
    | `Con(_lh_negin_Con_0_1, _lh_negin_Con_1_1) -> 
      (`Con((negin_lh__d0 _lh_negin_Con_0_1), (negin_lh__d0 _lh_negin_Con_1_1)))
    | _ -> 
      _lh_negin_arg1_0);;
let rec opri_lh__d3 _lh_opri_arg1_1 =
  (match _lh_opri_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec spri_lh__d2 _lh_spri_arg1_0 =
  (match _lh_spri_arg1_0 with
    ...
    | _ -> 
      0);;
let rec opri_lh__d1 _lh_opri_arg1_2 =
  (match _lh_opri_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec spri_lh__d0 _lh_spri_arg1_2 =
  (match _lh_spri_arg1_2 with
    ...
    | _ -> 
      0);;
let rec while_lh__d0 _lh_while_arg1_1 _lh_while_arg2_1 _lh_while_arg3_1 =
  (if (_lh_while_arg1_1 _lh_while_arg3_1) then
    (((while_lh__d0 _lh_while_arg1_1) _lh_while_arg2_1) (_lh_while_arg2_1 _lh_while_arg3_1))
  else
    _lh_while_arg3_1);;
let rec red_lh__d1 _lh_red_arg1_0 =
  (match _lh_red_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec redstar_lh__d0 _lh_redstar_arg1_0 =
  (((while_lh__d0 (fun _lh_funcomp_x_0 -> 
    (0 <> (spri_lh__d0 _lh_funcomp_x_0)))) red_lh__d1) _lh_redstar_arg1_0);;
...
let rec opri_lh__d2 _lh_opri_arg1_3 =
  (match _lh_opri_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec spri_lh__d1 _lh_spri_arg1_1 =
  (match _lh_spri_arg1_1 with
    ...
    | _ -> 
      0);;
let rec red_lh__d2 _lh_red_arg1_2 =
...
let rec redstar_lh__d1 _lh_redstar_arg1_1 =
  (((while_lh__d1 (fun _lh_funcomp_x_1 -> 
    (0 <> (spri_lh__d1 _lh_funcomp_x_1)))) red_lh__d2) _lh_redstar_arg1_1);;
let rec opri_lh__d0 _lh_opri_arg1_0 =
  (match _lh_opri_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec red_lh__d0 _lh_red_arg1_1 =
  (match _lh_red_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec parseHelper_lh__d0 _lh_parseHelper_arg1_0 _lh_parseHelper_arg2_0 =
  (match _lh_parseHelper_arg1_0 with
    ...
    | `LH_C(_lh_parseHelper_LH_C_0_0, _lh_parseHelper_LH_C_1_0) -> 
      (match _lh_parseHelper_LH_C_0_0 with
        | ' ' -> 
          ((parseHelper_lh__d0 _lh_parseHelper_LH_C_1_0) _lh_parseHelper_arg2_0)
        | '(' -> 
          ((parseHelper_lh__d0 _lh_parseHelper_LH_C_1_0) (`LH_C((`Lex('(')), _lh_parseHelper_arg2_0)))
        | ')' -> 
          (let rec _lh_matchIdent_0 = (redstar_lh__d0 _lh_parseHelper_arg2_0) in
                    ...
                    (match _lh_parseHelper_LH_C_0_2 with
                      | `Lex(_lh_parseHelper_Lex_0_0) -> 
                        (match _lh_parseHelper_Lex_0_0 with
                          | '(' -> 
                            ((parseHelper_lh__d0 _lh_parseHelper_LH_C_1_0) (`LH_C(_lh_parseHelper_LH_C_0_1, _lh_parseHelper_LH_C_1_2)))
                          | _ -> 
                            (failwith "error"))
                      | _ -> 
                        (failwith "error"))
        ...
        | _ -> 
          (if (('a' <= _lh_parseHelper_LH_C_0_0) && (_lh_parseHelper_LH_C_0_0 <= 'z')) then
            ((parseHelper_lh__d0 _lh_parseHelper_LH_C_1_0) (`LH_C((`Ast((`Sym(_lh_parseHelper_LH_C_0_0)))), _lh_parseHelper_arg2_0)))
          else
            (if ((spri_lh__d2 _lh_parseHelper_arg2_0) > (opri_lh__d0 _lh_parseHelper_LH_C_0_0)) then
              ((parseHelper_lh__d0 (`LH_C(_lh_parseHelper_LH_C_0_0, _lh_parseHelper_LH_C_1_0))) (red_lh__d0 _lh_parseHelper_arg2_0))
            else
              ((parseHelper_lh__d0 _lh_parseHelper_LH_C_1_0) (`LH_C((`Lex(_lh_parseHelper_LH_C_0_0)), _lh_parseHelper_arg2_0))))))
    | _ -> 
      (failwith "error"));;
let rec parse_lh__d0 _lh_parse_arg1_0 =
  (let rec _lh_matchIdent_1 = ((parseHelper_lh__d0 _lh_parse_arg1_0) (`LH_N)) in
    (match _lh_matchIdent_1 with
      ...
      | _ -> 
        (failwith "error")));;
let rec mappend_lh__d3 xs_1 ys_2_0 =
  (xs_1 ys_2_0);;
let rec mappend_lh__d1 xs_2 ys_2_1 =
  (xs_2 ys_2_1);;
let rec mappend_lh__d0 xs_3 ys_2_2 =
  (xs_3 ys_2_2);;
let rec mappend_lh__d2 xs_0 ys_0 =
  (xs_0 ys_0);;
let rec mappend_lh__d4 xs_4 ys_2_4 =
  (xs_4 ys_2_4);;
let rec interleave_lh__d1 _lh_interleave_arg1_0 _lh_interleave_arg2_0 =
  (match _lh_interleave_arg1_0 with
    | `LH_C(_lh_interleave_LH_C_0_0, _lh_interleave_LH_C_1_0) -> 
      (let rec t_0 = ((interleave_lh__d1 _lh_interleave_arg2_0) _lh_interleave_LH_C_1_0) in
        (let rec h_0 = _lh_interleave_LH_C_0_0 in
          (fun ys_1 -> 
...
let rec length_lh__d0 ls_1 =
  (match ls_1 with
    ...
    | `LH_N -> 
      0);;
let rec interleave_lh__d0 _lh_interleave_arg1_1 _lh_interleave_arg2_1 =
  (match _lh_interleave_arg1_1 with
    | `LH_C(_lh_interleave_LH_C_0_1, _lh_interleave_LH_C_1_1) -> 
      (let rec t_4 = ((interleave_lh__d0 _lh_interleave_arg2_1) _lh_interleave_LH_C_1_1) in
        (let rec h_4 = _lh_interleave_LH_C_0_1 in
          (fun ys_5 -> 
            (let rec t_5 = ((mappend_lh__d1 t_4) ys_5) in
              (let rec h_5 = h_4 in
                (fun ys_6 -> 
                  (let rec t_6 = ((mappend_lh__d0 t_5) ys_6) in
                    (let rec h_6 = h_5 in
                      (fun ys_7 -> 
                        (let rec t_7 = ((mappend_lh__d3 t_6) ys_7) in
                          (let rec h_7 = h_6 in
                            (fun ys_8 -> 
                              (`LH_C(h_7, ((mappend_lh__d4 t_7) ys_8)))))))))))))))
    | `LH_N -> 
      (fun ys_9 -> 
        ys_9)
    | _ -> 
      (failwith "error"));;
let rec copy_lh__d0 _lh_copy_arg1_1 _lh_copy_arg2_1 =
  (if (_lh_copy_arg1_1 > 0) then
    (`LH_C(_lh_copy_arg2_1, ((copy_lh__d0 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1)))
  else
    (`LH_N));;
let rec spaces_lh__d0 _lh_spaces_arg1_1 =
  ((copy_lh__d0 _lh_spaces_arg1_1) ' ');;
let rec copy_lh__d1 _lh_copy_arg1_0 _lh_copy_arg2_0 =
  (if (_lh_copy_arg1_0 > 0) then
    ...
    (`LH_N));;
let rec spaces_lh__d1 _lh_spaces_arg1_0 =
  ((copy_lh__d1 _lh_spaces_arg1_0) ' ');;
let rec disp_lh__d0 _lh_disp_arg1_0 =
  (match _lh_disp_arg1_0 with
    | `LH_P2(_lh_disp_LH_P2_0_0, _lh_disp_LH_P2_1_0) -> 
      ((mappend_lh__d0 ((mappend_lh__d1 ((interleave_lh__d0 _lh_disp_LH_P2_0_0) (spaces_lh__d0 (length_lh__d0 _lh_disp_LH_P2_0_0)))) (let rec t_8 = (let rec t_9 = (fun ys_1_0 -> 
        ys_1_0) in
        (let rec h_8 = '=' in
          (fun ys_1_1 -> 
            (let rec t_1_0 = ((mappend_lh__d0 t_9) ys_1_1) in
              (let rec h_9 = h_8 in
                (fun ys_1_2 -> 
                  (let rec t_1_1 = ((mappend_lh__d3 t_1_0) ys_1_2) in
                    (let rec h_1_0 = h_9 in
                      (fun ys_1_3 -> 
                        (`LH_C(h_1_0, ((mappend_lh__d4 t_1_1) ys_1_3)))))))))))) in
        (let rec h_1_1 = '<' in
          (fun ys_1_4 -> 
            (let rec t_1_2 = ((mappend_lh__d0 t_8) ys_1_4) in
              (let rec h_1_2 = h_1_1 in
                (fun ys_1_5 -> 
                  (let rec t_1_3 = ((mappend_lh__d3 t_1_2) ys_1_5) in
                    (let rec h_1_3 = h_1_2 in
                      (fun ys_1_6 -> 
                        (`LH_C(h_1_3, ((mappend_lh__d4 t_1_3) ys_1_6)))))))))))))) ((mappend_lh__d2 ((interleave_lh__d1 (spaces_lh__d1 (length_lh__d1 _lh_disp_LH_P2_1_0))) _lh_disp_LH_P2_1_0)) (let rec t_1_4 = (fun ys_1_7 -> 
        ys_1_7) in
        (let rec h_1_4 = 'n' in
          (fun ys_1_8 -> 
            (let rec t_1_5 = ((mappend_lh__d3 t_1_4) ys_1_8) in
              (let rec h_1_5 = h_1_4 in
                (fun ys_1_9 -> 
                  (`LH_C(h_1_5, ((mappend_lh__d4 t_1_5) ys_1_9)))))))))))
    | _ -> 
      (failwith "error"));;
let rec elim_lh__d0 _lh_elim_arg1_0 =
  (match _lh_elim_arg1_0 with
    | `Sym(_lh_elim_Sym_0_0) -> 
      (`Sym(_lh_elim_Sym_0_0))
    | `Not(_lh_elim_Not_0_0) -> 
      (`Not((elim_lh__d0 _lh_elim_Not_0_0)))
    | `Dis(_lh_elim_Dis_0_0, _lh_elim_Dis_1_0) -> 
      (`Dis((elim_lh__d0 _lh_elim_Dis_0_0), (elim_lh__d0 _lh_elim_Dis_1_0)))
    | `Con(_lh_elim_Con_0_0, _lh_elim_Con_1_0) -> 
      (`Con((elim_lh__d0 _lh_elim_Con_0_0), (elim_lh__d0 _lh_elim_Con_1_0)))
    | `Imp(_lh_elim_Imp_0_0, _lh_elim_Imp_1_0) -> 
      (`Dis((`Not((elim_lh__d0 _lh_elim_Imp_0_0))), (elim_lh__d0 _lh_elim_Imp_1_0)))
    | `Eqv(_lh_elim_Eqv_0_0, _lh_elim_Eqv_1_0) -> 
      (`Con((elim_lh__d0 (`Imp(_lh_elim_Eqv_0_0, _lh_elim_Eqv_1_0))), (elim_lh__d0 (`Imp(_lh_elim_Eqv_1_0, _lh_elim_Eqv_0_0)))))
    | _ -> 
      (failwith "error"));;
let rec conjunct_lh__d0 _lh_conjunct_arg1_0 =
...
let rec conjunct_lh__d1 _lh_conjunct_arg1_1 =
  (match _lh_conjunct_arg1_1 with
    ...
    | _ -> 
      false);;
let rec disin_lh__d0 _lh_disin_arg1_0 =
    ...
    | `Dis(_lh_disin_Dis_0_0, _lh_disin_Dis_1_0) -> 
      (match _lh_disin_Dis_1_0 with
        | `Con(_lh_disin_Con_0_0, _lh_disin_Con_1_0) -> 
          (`Con((disin_lh__d0 (`Dis(_lh_disin_Dis_0_0, _lh_disin_Con_0_0))), (disin_lh__d0 (`Dis(_lh_disin_Dis_0_0, _lh_disin_Con_1_0)))))
        | _ -> 
          (match _lh_disin_Dis_0_0 with
            | `Con(_lh_disin_Con_0_1, _lh_disin_Con_1_1) -> 
              (`Con((disin_lh__d0 (`Dis(_lh_disin_Con_0_1, _lh_disin_Dis_1_0))), (disin_lh__d0 (`Dis(_lh_disin_Con_1_1, _lh_disin_Dis_1_0)))))
            | _ -> 
              (let rec dp_0 = (disin_lh__d0 _lh_disin_Dis_0_0) in
                (let rec dq_0 = (disin_lh__d0 _lh_disin_Dis_1_0) in
                  (if ((conjunct_lh__d0 dp_0) || (conjunct_lh__d1 dq_0)) then
                    (disin_lh__d0 (`Dis(dp_0, dq_0)))
                  else
                    (`Dis(dp_0, dq_0)))))))
    | `Con(_lh_disin_Con_0_2, _lh_disin_Con_1_2) -> 
      (`Con((disin_lh__d0 _lh_disin_Con_0_2), (disin_lh__d0 _lh_disin_Con_1_2)))
    | _ -> 
      _lh_disin_arg1_0);;
let rec concat_lh__d0 lss_3 =
  (lss_3 99);;
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec map_lh__d0 f_4 ls_4 _lh_popOutId_0_0 =
  (match ls_4 with
    | `LH_C(h_1_7, t_1_7) -> 
      (let rec t_1_8 = ((map_lh__d0 f_4) t_1_7) in
        (let rec h_1_8 = (f_4 h_1_7) in
          ((mappend_lh__d3 h_1_8) (concat_lh__d1 t_1_8))))
    | `LH_N -> 
      (fun ys_2_3 -> 
        ys_2_3));;
let rec foldr_lh__d1 f_2 i_1 ls_3 =
  ((ls_3 f_2) i_1);;
let rec insert_lh__d2 _lh_insert_arg1_1 _lh_insert_arg2_1 =
  (match _lh_insert_arg2_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec insert_lh__d0 _lh_insert_arg1_0 _lh_insert_arg2_0 =
  (match _lh_insert_arg2_0 with
    ...
    | `LH_C(_lh_insert_LH_C_0_0, _lh_insert_LH_C_1_0) -> 
      (if (_lh_insert_arg1_0 < _lh_insert_LH_C_0_0) then
        ...
        (if (_lh_insert_arg1_0 > _lh_insert_LH_C_0_0) then
          (`LH_C(_lh_insert_LH_C_0_0, ((insert_lh__d0 _lh_insert_arg1_0) _lh_insert_LH_C_1_0)))
        else
          (`LH_C(_lh_insert_LH_C_0_0, _lh_insert_LH_C_1_0))))
    | _ -> 
      (failwith "error"));;
let rec insert_lh__d1 _lh_insert_arg1_2 _lh_insert_arg2_2 =
  (match _lh_insert_arg2_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec clauseHelper_lh__d0 _lh_clauseHelper_arg1_0 _lh_clauseHelper_arg2_0 =
  (match _lh_clauseHelper_arg1_0 with
    | `Dis(_lh_clauseHelper_Dis_0_0, _lh_clauseHelper_Dis_1_0) -> 
      ((clauseHelper_lh__d0 _lh_clauseHelper_Dis_0_0) ((clauseHelper_lh__d0 _lh_clauseHelper_Dis_1_0) _lh_clauseHelper_arg2_0))
    | `Sym(_lh_clauseHelper_Sym_0_0) -> 
      (match _lh_clauseHelper_arg2_0 with
        | `LH_P2(_lh_clauseHelper_LH_P2_0_0, _lh_clauseHelper_LH_P2_1_0) -> 
          (`LH_P2(((insert_lh__d0 _lh_clauseHelper_Sym_0_0) _lh_clauseHelper_LH_P2_0_0), _lh_clauseHelper_LH_P2_1_0))
        | _ -> 
          (failwith "error"))
        ...
        | `Sym(_lh_clauseHelper_Sym_0_1) -> 
          (match _lh_clauseHelper_arg2_0 with
            | `LH_P2(_lh_clauseHelper_LH_P2_0_1, _lh_clauseHelper_LH_P2_1_1) -> 
              (`LH_P2(_lh_clauseHelper_LH_P2_0_1, ((insert_lh__d1 _lh_clauseHelper_Sym_0_1) _lh_clauseHelper_LH_P2_1_1)))
            | _ -> 
              (failwith "error"))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
let rec clause_lh__d0 _lh_clause_arg1_0 =
  ((clauseHelper_lh__d0 _lh_clause_arg1_0) (`LH_P2((`LH_N), (`LH_N))));;
let rec contains_lh__d0 _lh_contains_arg1_0 _lh_contains_arg2_0 =
  (match _lh_contains_arg2_0 with
    | `LH_C(_lh_contains_LH_C_0_0, _lh_contains_LH_C_1_0) -> 
      ((_lh_contains_arg1_0 = _lh_contains_LH_C_0_0) || ((contains_lh__d0 _lh_contains_arg1_0) _lh_contains_LH_C_1_0))
    | `LH_N -> 
      false
    | _ -> 
      (failwith "error"));;
let rec tautclause_lh__d0 _lh_tautclause_arg1_0 =
  (match _lh_tautclause_arg1_0 with
      ...
      ((let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
        (match _lh_listcomp_fun_para_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
            (if ((contains_lh__d0 _lh_listcomp_fun_ls_h_0) _lh_tautclause_LH_P2_1_0) then
    ...
    | _ -> 
      (failwith "error"));;
let rec uniclHelper_lh__d0 _lh_uniclHelper_arg1_0 _lh_uniclHelper_arg2_0 =
  (let rec cp_0 = (clause_lh__d0 _lh_uniclHelper_arg1_0) in
    (if (tautclause_lh__d0 cp_0) then
      _lh_uniclHelper_arg2_0
    else
      ((insert_lh__d2 cp_0) _lh_uniclHelper_arg2_0)));;
let rec unicl_lh__d0 _lh_unicl_arg1_0 =
  (((foldr_lh__d1 uniclHelper_lh__d0) (`LH_N)) _lh_unicl_arg1_0);;
let rec foldr_lh__d0 f_1 i_0 ls_2 =
  ((ls_2 f_1) i_0);;
let rec splitHelper_lh__d0 _lh_splitHelper_arg1_0 _lh_splitHelper_arg2_0 =
  (match _lh_splitHelper_arg1_0 with
    | `Con(_lh_splitHelper_Con_0_0, _lh_splitHelper_Con_1_0) -> 
      ((splitHelper_lh__d0 _lh_splitHelper_Con_0_0) ((splitHelper_lh__d0 _lh_splitHelper_Con_1_0) _lh_splitHelper_arg2_0))
    | _ -> 
      (let rec t_1_6 = _lh_splitHelper_arg2_0 in
        (let rec h_1_6 = _lh_splitHelper_arg1_0 in
          (fun f_3 i_2 -> 
            ((f_3 h_1_6) (((foldr_lh__d0 f_3) i_2) t_1_6))))));;
let rec split_lh__d0 _lh_split_arg1_0 =
  ((splitHelper_lh__d0 _lh_split_arg1_0) (fun f_5 i_3 -> 
    i_3));;
let rec clauses_lh__d0 _lh_clauses_arg1_0 =
  ((fun _lh_funcomp_x_2 -> 
    ((fun _lh_funcomp_x_3 -> 
      ((fun _lh_funcomp_x_4 -> 
        ((fun _lh_funcomp_x_5 -> 
          ((fun _lh_funcomp_x_6 -> 
            ((fun _lh_funcomp_x_7 -> 
              ((fun _lh_funcomp_x_8 -> 
                (concat_lh__d0 ((map_lh__d0 disp_lh__d0) _lh_funcomp_x_8))) (unicl_lh__d0 _lh_funcomp_x_7))) (split_lh__d0 _lh_funcomp_x_6))) (disin_lh__d0 _lh_funcomp_x_5))) (negin_lh__d0 _lh_funcomp_x_4))) (elim_lh__d0 _lh_funcomp_x_3))) (parse_lh__d0 _lh_funcomp_x_2))) _lh_clauses_arg1_0);;
let rec concat_lh__d3 lss_1 =
  (lss_1 99);;
let rec copy_lh__d2 _lh_copy_arg1_2 _lh_copy_arg2_2 _lh_popOutId_0_1 _lh_popOutId_1_0 =
  (if (_lh_copy_arg1_2 > 0) then
    (let rec t_2_0 = ((copy_lh__d2 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec h_2_0 = _lh_copy_arg2_2 in
        (let rec t_2_1 = ((map_lh__d1 _lh_popOutId_0_1) t_2_0) in
          (let rec h_2_1 = (_lh_popOutId_0_1 h_2_0) in
            ((mappend_lh__d4 h_2_1) (concat_lh__d3 t_2_1))))))
  else
    (`LH_N));;
let rec testClausify_nofib_lh__d0 _lh_testClausify_nofib_arg1_0 =
  (let rec xs_5 = ((copy_lh__d2 _lh_testClausify_nofib_arg1_0) (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(')', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(')', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(')', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
    (concat_lh__d2 ((map_lh__d1 clauses_lh__d0) xs_5)));;
end;;

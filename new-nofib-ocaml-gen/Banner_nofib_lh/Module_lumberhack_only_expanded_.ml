...
let rec mappend_lh__d3 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d3 t_1_1) ys_3)))
    | `LH_N -> 
      ys_3);;
...
let rec mappend_lh__d2 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C(h_1_2, ((mappend_lh__d2 t_1_2) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec join_lh__d1 _lh_join_arg1_0 =
  ((foldr1_lh__d1 (fun xs_5 ys_5 -> 
    ((mappend_lh__d3 ((mappend_lh__d2 xs_5) (`LH_C(' ', (`LH_C(' ', (`LH_N))))))) ys_5))) _lh_join_arg1_0);;
    ...
    | `LH_C(_lh_transpose_LH_C_0_0, _lh_transpose_LH_C_1_0) -> 
      (match _lh_transpose_LH_C_0_0 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_1, _lh_transpose_LH_C_1_1) -> 
          (let rec _lh_matchIdent_2 = (unzip_lh__d1 (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
...
let rec map_lh__d3 f_1 ls_7 =
  (match ls_7 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_1 h_9), ((map_lh__d3 f_1) t_9)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d4 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d4 t_1_0) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec concat_lh__d2 lss_0 =
  (match lss_0 with
    | `LH_C(h_8, t_8) -> 
      ((mappend_lh__d6 h_8) (concat_lh__d2 t_8))
    | `LH_N -> 
      (`LH_N));;
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d2 ((map_lh__d3 (fun l_0 -> 
    ((mappend_lh__d4 l_0) (`LH_C('n', (`LH_N)))))) _lh_unlines_arg1_0));;
...
let rec mappend_lh__d5 xs_1 ys_1 =
  (match xs_1 with
    ...
    | `LH_N -> 
      ys_1);;
let rec slant_lh__d1 _lh_slant_arg1_1 =
...
let rec atIndex_lh__d1 n_6 ls_6 =
  (if (n_6 < 0) then
    (failwith "error")
  else
    (match ls_6 with
...
let rec atIndex_lh__d3 n_2 ls_3 =
  (if (n_2 < 0) then
    (failwith "error")
  else
    (match ls_3 with
      | `LH_C(h_4, t_4) -> 
        (if (n_2 = 0) then
          ...
          ((atIndex_lh__d3 (n_2 - 1)) t_4))
      | `LH_N -> 
        (failwith "error")));;
let rec slant_lh__d2 _lh_slant_arg1_0 =
  (`LH_C((`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_N))))))))), (`LH_C((`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_N))))))), (`LH_C((`LH_C(' ', (`LH_C(' ', (`LH_N))))), (`LH_C((`LH_C(' ', (`LH_N))), (`LH_C((`LH_N), (`LH_N)))))))))));;
let rec atIndex_lh__d2 n_4 ls_5 =
  (if (n_4 < 0) then
    (failwith "error")
  else
    (match ls_5 with
      | `LH_C(h_5, t_5) -> 
        (if (n_4 = 0) then
          ...
          ((atIndex_lh__d2 (n_4 - 1)) t_5))
      | `LH_N -> 
        (failwith "error")));;
let rec picChar_lh__d1 _lh_picChar_arg1_0 =
  (if (isUpper_lh__d1 _lh_picChar_arg1_0) then
    ((atIndex_lh__d2 ((int_of_char _lh_picChar_arg1_0) - (int_of_char 'A'))) (alphas_lh__d1 0))
  else
    (if (isLower_lh__d1 _lh_picChar_arg1_0) then
      ((atIndex_lh__d3 ((int_of_char _lh_picChar_arg1_0) - (int_of_char 'a'))) (alphas_lh__d2 0))
    else
      (if (isSpace_lh__d1 _lh_picChar_arg1_0) then
        (blank_lh__d1 0)
      else
        (if (isDigit_lh__d1 _lh_picChar_arg1_0) then
          ((atIndex_lh__d1 ((int_of_char _lh_picChar_arg1_0) - (int_of_char '0'))) (digits_lh__d1 0))
        else
          (if (_lh_picChar_arg1_0 = '/') then
            ...
            (if (_lh_picChar_arg1_0 = '=') then
              ...
              (head_lh__d1 ((mappend_lh__d5 (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                (match _lh_listcomp_fun_para_0 with
                  ...
                  | `LH_N -> 
                    (`LH_N))) in
                (_lh_listcomp_fun_0 (punct_lh__d1 0)))) (`LH_C((`LH_C((`LH_N), (`LH_N))), (`LH_N)))))))))));;

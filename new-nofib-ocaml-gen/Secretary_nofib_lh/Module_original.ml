...
let rec take_lh n_0 ls_3 =
  (if (n_0 > 0) then
    ...
    (`LH_N));;
let rec take_lz_lh n_1 ls_4 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_4) with
      | `LH_C(h_4, t_4) -> 
        (`LH_C(h_4, ((take_lz_lh (n_1 - 1)) t_4)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
and simulate_lh _lh_simulate_arg1_0 _lh_simulate_arg2_0 _lh_simulate_arg3_0 =
...
and testSecretary_nofib_lh _lh_testSecretary_nofib_arg1_0 =

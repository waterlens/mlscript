...
let rec foldr_lh__d1 f_1_8 i_0 ls_2 =
  ((ls_2 f_1_8) i_0);;
let rec map_lh__d3 f_3_1 ls_8 _lh_popOutId_0_4 _lh_popOutId_1_2 =
  (match ls_8 with
    | `LH_C(h_9_2, t_9_2) -> 
      (let rec t_9_3 = ((map_lh__d3 f_3_1) t_9_2) in
        (let rec h_9_3 = (f_3_1 h_9_2) in
          ((_lh_popOutId_0_4 h_9_3) (((foldr_lh__d1 _lh_popOutId_0_4) _lh_popOutId_1_2) t_9_3))))
    | `LH_N -> 
      _lh_popOutId_1_2);;
...
let rec map_lh__d2 f_2_4 ls_4 _lh_popOutId_0_1 =
  (match ls_4 with
    | `LH_C(h_8_2, t_8_2) -> 

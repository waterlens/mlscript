...
let rec b__d5 =
  (`Node((`LH_C('b', (`LH_N))), (`LH_N)));;
let rec bind__d0 _lh_bind_arg1_3 _lh_bind_arg2_3 s_1_0 =
  (let rec _lh_matchIdent_1_3 = (_lh_bind_arg1_3 s_1_0) in
    (match _lh_matchIdent_1_3 with
      | `LH_P2(_lh_bind_LH_P2_0_3, _lh_bind_LH_P2_1_3) -> 
        ((_lh_bind_arg2_3 _lh_bind_LH_P2_1_3) _lh_bind_LH_P2_0_3)
      | _ -> 
        (failwith "error")));;
let rec bind__d1 _lh_bind_arg1_2 _lh_bind_arg2_2 s_9 =
  (let rec _lh_matchIdent_1_2 = (_lh_bind_arg1_2 s_9) in
...
let rec bind__d2 _lh_bind_arg1_1 _lh_bind_arg2_1 s_8 =
  (let rec _lh_matchIdent_1_0 = (_lh_bind_arg1_1 s_8) in
    (match _lh_matchIdent_1_0 with
      | `LH_P2(_lh_bind_LH_P2_0_1, _lh_bind_LH_P2_1_1) -> 
        ((_lh_bind_arg2_1 _lh_bind_LH_P2_1_1) _lh_bind_LH_P2_0_1)
      | _ -> 
        (failwith "error")));;
let rec bind__d3 _lh_bind_arg1_4 _lh_bind_arg2_4 s_1_3 =
  (let rec _lh_matchIdent_1_6 = (_lh_bind_arg1_4 s_1_3) in
...
let rec enumFromTo__d0 a_6 b_5 =
  (if (a_6 <= b_5) then
    ...
    (`LH_N));;
let rec foldr__d0 f_1_5 i_4 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_2_5, t_2_7) -> 
      ((f_1_5 h_2_5) (((foldr__d0 f_1_5) i_4) t_2_7))
    | `LH_N -> 
      i_4);;
...
let rec map__d0 f_1_4 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_2_3, t_2_5) -> 
      (`LH_C((f_1_4 h_2_3), ((map__d0 f_1_4) t_2_5)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d1 f_1_2 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_1, t_2_3) -> 
...
let rec map__d2 f_1_3 ls_2_1 =
  (match ls_2_1 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec map__d3 f_1_6 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_2_6, t_2_8) -> 
      (`LH_C((f_1_6 h_2_6), ((map__d3 f_1_6) t_2_8)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d4 f_1_7 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_2_8, t_3_0) -> 
      (`LH_C((f_1_7 h_2_8), ((map__d4 f_1_7) t_3_0)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend__d0 xs_9 ys_1_0 =
  (match xs_9 with
    | `LH_C(h_2_7, t_2_9) -> 
      (`LH_C(h_2_7, ((mappend__d0 t_2_9) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec mappend__d1 xs_1_0 ys_1_1 =
  (match xs_1_0 with
    | `LH_C(h_3_0, t_3_2) -> 
      (`LH_C(h_3_0, ((mappend__d1 t_3_2) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec mult___d0 _lh_mult__arg1_3 _lh_mult__arg2_3 =
  (`Node((`LH_C('*', (`LH_N))), (`LH_C(_lh_mult__arg1_3, (`LH_C(_lh_mult__arg2_3, (`LH_N)))))));;
let rec mult___d1 _lh_mult__arg1_1 _lh_mult__arg2_1 =
...
let rec plus___d1 _lh_plus__arg1_3 _lh_plus__arg2_3 =
  (`Node((`LH_C('+', (`LH_N))), (`LH_C(_lh_plus__arg1_3, (`LH_C(_lh_plus__arg2_3, (`LH_N)))))));;
let rec plus___d2 _lh_plus__arg1_2 _lh_plus__arg2_2 =
...
let rec plus___d4 _lh_plus__arg1_4 _lh_plus__arg2_4 =
  (`Node((`LH_C('+', (`LH_N))), (`LH_C(_lh_plus__arg1_4, (`LH_C(_lh_plus__arg2_4, (`LH_N)))))));;
let rec plus___d5 _lh_plus__arg1_1 _lh_plus__arg2_1 =
  (`Node((`LH_C('+', (`LH_N))), (`LH_C(_lh_plus__arg1_1, (`LH_C(_lh_plus__arg2_1, (`LH_N)))))));;
let rec plus___d6 _lh_plus__arg1_5 _lh_plus__arg2_5 =
...
let rec retURN__d0 _lh_retURN_arg1_2 s_1_2 =
  (`LH_P2(s_1_2, _lh_retURN_arg1_2));;
let rec retURN__d1 _lh_retURN_arg1_3 s_1_5 =
  (`LH_P2(s_1_5, _lh_retURN_arg1_3));;
let rec retURN__d2 _lh_retURN_arg1_1 s_1_1 =
  (`LH_P2(s_1_1, _lh_retURN_arg1_1));;
let rec scanl__d0 _lh_scanl_arg1_1 _lh_scanl_arg2_1 _lh_scanl_arg3_1 =
  (`LH_C(_lh_scanl_arg2_1, (let rec _lh_matchIdent_1_1 = _lh_scanl_arg3_1 in
...
let rec scanr__d0 _lh_scanr_arg1_1 _lh_scanr_arg2_1 _lh_scanr_arg3_1 =
  (match _lh_scanr_arg3_1 with
    ...
    | `LH_C(_lh_scanr_LH_C_0_2, _lh_scanr_LH_C_1_2) -> 
      (let rec _lh_matchIdent_1_4 = (((scanr__d0 _lh_scanr_arg1_1) _lh_scanr_arg2_1) _lh_scanr_LH_C_1_2) in
...
let rec startingWith__d0 _lh_startingWith_arg1_1 _lh_startingWith_arg2_1 =
  (let rec _lh_matchIdent_9 = (_lh_startingWith_arg1_1 _lh_startingWith_arg2_1) in
    (match _lh_matchIdent_9 with
      | `LH_P2(_lh_startingWith_LH_P2_0_1, _lh_startingWith_LH_P2_1_1) -> 
        _lh_startingWith_LH_P2_1_1
      | _ -> 
        (failwith "error")));;
let rec take__d0 n_5 ls_2_3 =
  (if (n_5 > 0) then
    (match ls_2_3 with
      | `LH_C(h_2_4, t_2_6) -> 
        (`LH_C(h_2_4, ((take__d0 (n_5 - 1)) t_2_6)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
let rec update__d0 _lh_update_arg1_1 s_1_4 =
  (`LH_P2((_lh_update_arg1_1 s_1_4), s_1_4));;
...
let rec concat__d0 lss_1 =
  (match lss_1 with
    | `LH_C(h_2_9, t_3_1) -> 
      ((mappend__d1 h_2_9) (concat__d0 t_3_1))
    | `LH_N -> 
      (`LH_N))
      ...
      | `Node(_lh_label_Node_0_1, _lh_label_Node_1_1) -> 
        ((bind__d0 (incr__d0 0)) (fun n_6 -> 
          ((bind__d1 ((mmapl__d0 label_1) _lh_label_Node_1_1)) (fun ts_2 -> 
            (retURN__d2 (`Node((`LH_P2(n_6, _lh_label_Node_0_1)), ts_2)))))))
      | _ -> 
        (failwith "error"))) in

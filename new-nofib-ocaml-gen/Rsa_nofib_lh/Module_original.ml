...
and collect_lh _lh_collect_arg1_0 _lh_collect_arg2_0 =
...
and concat_lh lss_0 =
  (match lss_0 with
    ...
    | `LH_N -> 
      (`LH_N))
and encrypt_lh _lh_encrypt_arg1_0 _lh_encrypt_arg2_0 _lh_funcomp_x_0 =
  ((fun _lh_funcomp_x_1 -> 
...
and power_lh _lh_power_arg1_0 _lh_power_arg2_0 _lh_power_arg3_0 =
...
and size_lh _lh_size_arg1_0 =
  (((length_lh (string_of_int _lh_size_arg1_0)) * 47) / 100)
and testRsa_nofib_lh _lh_testRsa_nofib_arg1_0 =

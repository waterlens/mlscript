...
let rec emptyBoard__d0 =
  (`Board((`LH_N), (`LH_N)));;
let rec enumFromTo__d1 a_0 b_5 _lh_popOutId_0_1 _lh_popOutId_1_0 =
  (if (a_0 <= b_5) then
    (let rec tx_2 = ((enumFromTo__d1 (a_0 + 1)) b_5) in
      (let rec hx_2 = a_0 in
        (((_lh_popOutId_1_0 _lh_popOutId_0_1) hx_2) tx_2)))
  else
    (fun _lh_dummy_5 ys_4_6_6 -> 
      ys_4_6_6));;
...
and drop__d0 _lh_drop_arg1_0 _lh_drop_arg2_0 =
  (match _lh_drop_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and enumFromTo__d0 a_3 b_9 _lh_popOutId_0_2 =
  (if (a_3 <= b_9) then
    (let rec t_6_3_6 = ((enumFromTo__d0 (a_3 + 1)) b_9) in
      (let rec h_6_3_6 = a_3 in
        ((reverse_helper__d0 t_6_3_6) (let rec tx_3 = _lh_popOutId_0_2 in
          (let rec hx_3 = h_6_3_6 in
            (fun f_8_1 ys_7_8_5 -> 
              (((ys_7_8_5 f_8_1) hx_3) tx_3)))))))
  else
    _lh_popOutId_0_2)
and enumFromTo__d2 a_1_2 b_1_4 _lh_popOutId_0_6 _lh_popOutId_1_1 =
  (if (a_1_2 <= b_1_4) then
    (let rec t_8_9_3 = ((enumFromTo__d2 (a_1_2 + 1)) b_1_4) in
      (let rec h_8_9_3 = a_1_2 in
        ((_lh_popOutId_0_6 h_8_9_3) (((foldr__d1 _lh_popOutId_0_6) _lh_popOutId_1_1) t_8_9_3))))
  else
    _lh_popOutId_1_1)
and enumFromTo__d3 a_7 b_1_1 _lh_popOutId_0_4 =
  (if (a_7 <= b_1_1) then
    (let rec t_6_8_1 = ((enumFromTo__d3 (a_7 + 1)) b_1_1) in
      (let rec h_6_8_1 = a_7 in
        ((reverse_helper__d1 t_6_8_1) (let rec t_6_8_2 = _lh_popOutId_0_4 in
...
and parseSquare__d0 _lh_parseSquare_arg1_0 _lh_parseSquare_arg2_0 _lh_parseSquare_arg3_0 _lh_popOutId_0_9 =
  (match _lh_parseSquare_arg3_0 with
    | '-' -> 
      _lh_popOutId_0_9
    | _ -> 
      (fun ys_1_4_5_7 f_1_2_7 i_9_5 -> 
          ...
          (let rec kin_0 = (let rec _lh_matchIdent_2_7_8 = (toLower__d0 _lh_parseSquare_arg3_0) in
            ...
            (let rec t_1_1_9_4 = (fun ys_1_4_5_5 -> 
              ...
              (let rec h_1_1_9_4 = (let rec _lh_parseBoard_LH_P2_1_0 = (`LH_P2(_lh_parseSquare_arg2_0, _lh_parseSquare_arg1_0)) in
                ...
                (let rec t_1_1_9_5 = ((mappend__d8 t_1_1_9_4) _lh_popOutId_0_9) in
...
and splitAt__d0 _lh_splitAt_arg1_0 _lh_splitAt_arg2_0 _lh_dummy_3_0 _lh_dummy_3_1 =
...
and tab__d0 _lh_tab_arg1_2 _lh_popOutId_0_5 =
  (if (_lh_tab_arg1_2 <= 0) then
    ...
    (fun ys_8_7_3 -> 
      (let rec t_7_1_3 = (tab__d0 (_lh_tab_arg1_2 - 1)) in
        (let rec h_7_1_3 = ' ' in
          (let rec t_7_1_4 = ((mappend__d5_d9 t_7_1_3) _lh_popOutId_0_5) in
            (let rec h_7_1_4 = h_7_1_3 in
              (`LH_C(h_7_1_4, ((mappend__d5_d8 t_7_1_4) ys_8_7_3)))))))))
and tab__d1 _lh_tab_arg1_1 _lh_popOutId_0_3 =
  (if (_lh_tab_arg1_1 <= 0) then
    ...
    (fun ys_7_8_8 -> 
      (let rec t_6_3_7 = (tab__d1 (_lh_tab_arg1_1 - 1)) in
        (let rec h_6_3_7 = ' ' in
          (let rec t_6_3_8 = ((mappend__d1_d3_d2 t_6_3_7) _lh_popOutId_0_3) in
            (let rec h_6_3_8 = h_6_3_7 in
              (`LH_C(h_6_3_8, ((mappend__d1_d3_d1 t_6_3_8) ys_7_8_8)))))))))
and tab__d2 _lh_tab_arg1_0 _lh_popOutId_0_0 =
  (if (_lh_tab_arg1_0 <= 0) then
    ...
    (fun ys_6_4 -> 
      (let rec t_6_3 = (tab__d2 (_lh_tab_arg1_0 - 1)) in
        (let rec h_6_3 = ' ' in
          (let rec t_6_4 = ((mappend__d2_d0_d5 t_6_3) _lh_popOutId_0_0) in
            (let rec h_6_4 = h_6_3 in
              (`LH_C(h_6_4, ((mappend__d2_d0_d4 t_6_4) ys_6_4)))))))))
and take__d1 n_2_6_3 ls_9_2 _lh_popOutId_0_8 _lh_popOutId_1_3 _lh_popOutId_2_1 _lh_popOutId_3_1 =
  (if (n_2_6_3 > 0) then
    (match ls_9_2 with
      | `LH_C(h_1_0_2_4, t_1_0_2_4) -> 
        (let rec ty_1 = ((take__d1 (n_2_6_3 - 1)) t_1_0_2_4) in
          (let rec hy_1 = h_1_0_2_4 in
            (let rec t_1_0_2_5 = (((zipWith__d1 _lh_popOutId_0_8) _lh_popOutId_2_1) ty_1) in
              (let rec h_1_0_2_5 = ((_lh_popOutId_0_8 _lh_popOutId_1_3) hy_1) in

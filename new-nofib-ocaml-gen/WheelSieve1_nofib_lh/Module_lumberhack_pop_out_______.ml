...
let rec zipWith_lz_lz_lh__d1 f_1 xs_0 ys_0 =
  (lazy (match (Lazy.force xs_0) with
    ...
    | `LH_N -> 
      (`LH_N)));;
let rec enumFromThenTo_lh__d2 a_1 t_4 b_1 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 =
  (if (a_1 <= b_1) then
...
let rec append_lz_lh__d1 _lh_append_lz_arg1_0 _lh_append_lz_arg2_0 =
  (let rec _lh_matchIdent_3 = _lh_append_lz_arg1_0 in
    (match _lh_matchIdent_3 with
      ...
      | _ -> 
        (failwith "error")));;
let rec enumFromThenTo_lh__d1 a_0 t_3 b_0 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 _lh_popOutId_4_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_5 = (((enumFromThenTo_lh__d1 t_3) ((2 * t_3) - a_0)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_0 in
        (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_3 -> 
          (match _lh_listcomp_fun_para_3 with
            | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_6) -> 
              (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_4 -> 
                ((((((_lh_listcomp_fun_para_4 _lh_listcomp_fun_1_0) _lh_popOutId_1_0) _lh_popOutId_3_0) _lh_popOutId_4_0) _lh_listcomp_fun_ls_t_6) _lh_listcomp_fun_9)) in
          ...
          (_lh_listcomp_fun_9 _lh_popOutId_2_0))))
  else
    (`LH_N));;

...
let rec specularsurf_lh__d1 _lh_specularsurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
...
let rec specpowsurf_lh__d1 _lh_specpowsurf_arg1_0 =
  (head_lh__d6 ((let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
...
let rec bodysurf_lh__d1 _lh_bodysurf_arg1_0 =
  (head_lh__d6 ((let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_6 -> 
...
let rec trace_lh__d2 _lh_trace_arg1_1 _lh_trace_arg2_1 _lh_trace_arg3_1 =
  (let rec f_1_5 = (fun d1s1_1 d2s2_1 -> 
    ...
    (let rec sphmap_1 = (fun xss_1 -> 
      (let rec _lh_matchIdent_3_0 = xss_1 in
        (match _lh_matchIdent_3_0 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_1, _lh_trace_LH_C_1_1) -> 
            (let rec _lh_matchIdent_3_1 = (((sphereintersect_lh__d1 _lh_trace_arg2_1) _lh_trace_arg3_1) _lh_trace_LH_C_0_1) in
      ...
      (let rec dists_1 = (sphmap_1 _lh_trace_arg1_1) in
        (if (null_lh__d1 dists_1) then
          ...
          (let rec _lh_matchIdent_3_2 = (((foldr_lh__d3 f_1_5) (head_lh__d6 dists_1)) (tail_lh__d1 dists_1)) in
...
let rec diffusesurf_lh__d1 _lh_diffusesurf_arg1_0 =
  (head_lh__d6 ((let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
...
let rec reflectsurf_lh__d1 _lh_reflectsurf_arg1_0 =
  (head_lh__d6 ((let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
...
let rec refractsurf_lh__d1 _lh_refractsurf_arg1_0 =
  (head_lh__d4 ((let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_8 -> 
...
let rec vecscale_lh__d1_d1 _lh_vecscale_arg1_1_1 _lh_vecscale_arg2_1_1 =
  (match _lh_vecscale_arg1_1_1 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_1, _lh_vecscale_LH_P3_1_1_1, _lh_vecscale_LH_P3_2_1_1) -> 
      (let rec _lh_vecadd_LH_P3_2_3_2 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_2_1_1) in
        (let rec _lh_vecadd_LH_P3_1_3_2 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_1_1_1) in
          (let rec _lh_vecadd_LH_P3_0_3_2 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_0_1_1) in
            (fun _lh_vecadd_LH_P3_0_3_3 _lh_vecadd_LH_P3_1_3_3 _lh_vecadd_LH_P3_2_3_3 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_3_3 +. _lh_vecadd_LH_P3_0_3_2), (_lh_vecadd_LH_P3_1_3_3 +. _lh_vecadd_LH_P3_1_3_2), (_lh_vecadd_LH_P3_2_3_3 +. _lh_vecadd_LH_P3_2_3_2)))))))
    | _ -> 
      (failwith "error"));;
...
let rec ambientsurf_lh__d1 _lh_ambientsurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_5 -> 
...
let rec vecscale_lh__d9 _lh_vecscale_arg1_7 _lh_vecscale_arg2_7 =
  (match _lh_vecscale_arg1_7 with
    | `LH_P3(_lh_vecscale_LH_P3_0_7, _lh_vecscale_LH_P3_1_7, _lh_vecscale_LH_P3_2_7) -> 
      (let rec _lh_vecadd_LH_P3_2_1_8 = (_lh_vecscale_arg2_7 *. _lh_vecscale_LH_P3_2_7) in
        (let rec _lh_vecadd_LH_P3_1_1_8 = (_lh_vecscale_arg2_7 *. _lh_vecscale_LH_P3_1_7) in
          (let rec _lh_vecadd_LH_P3_0_1_8 = (_lh_vecscale_arg2_7 *. _lh_vecscale_LH_P3_0_7) in
...
let rec vecscale_lh__d1_d0 _lh_vecscale_arg1_8 _lh_vecscale_arg2_8 =
  (match _lh_vecscale_arg1_8 with
    | `LH_P3(_lh_vecscale_LH_P3_0_8, _lh_vecscale_LH_P3_1_8, _lh_vecscale_LH_P3_2_8) -> 
      (let rec _lh_vecadd_LH_P3_2_2_3 = (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_2_8) in
        (let rec _lh_vecadd_LH_P3_1_2_3 = (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_1_8) in
          (let rec _lh_vecadd_LH_P3_0_2_3 = (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_0_8) in
...
let rec transmitsurf_lh__d1 _lh_transmitsurf_arg1_0 =
  (head_lh__d6 ((let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_9 -> 
...
let rec reflectray_lh__d1 _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
  (let rec newcontrib_4 = ((vecmult_lh__d3 _lh_reflectray_arg4_0) _lh_reflectray_arg5_0) in
    (let rec nearpos_4 = ((vecadd_lh__d1_d1 _lh_reflectray_arg1_0) ((vecscale_lh__d1_d2 _lh_reflectray_arg2_0) epsilon_lh__d5)) in
      (let rec _lh_matchIdent_1_4 = (((trace_lh__d2 (testspheres_lh__d2 0)) nearpos_4) _lh_reflectray_arg2_0) in
...
shade_lh__d1 _lh_shade_arg1_8 _lh_shade_arg2_0 _lh_shade_arg3_0 _lh_shade_arg4_0 _lh_shade_arg5_0 _lh_shade_arg6_8 =
  (let rec hitpos_8 = (match _lh_shade_arg3_0 with
    | `LH_P3(_lh_vecadd_LH_P3_0_1_4, _lh_vecadd_LH_P3_1_1_4, _lh_vecadd_LH_P3_2_1_4) -> 
      (((((vecscale_lh__d9 _lh_shade_arg4_0) _lh_shade_arg5_0) _lh_vecadd_LH_P3_0_1_4) _lh_vecadd_LH_P3_1_1_4) _lh_vecadd_LH_P3_2_1_4)
    | _ -> 
      (failwith "error")) in
          ...
          (fun _lh_vecmult_arg2_1 -> 
            (match _lh_vecmult_arg2_1 with
              | `LH_P3(_lh_vecmult_LH_P3_0_3, _lh_vecmult_LH_P3_1_3, _lh_vecmult_LH_P3_2_3) -> 
                (let rec _lh_vecadd_LH_P3_2_1_5 = (_lh_vecmult_LH_P3_2_2 *. _lh_vecmult_LH_P3_2_3) in
                  (let rec _lh_vecadd_LH_P3_1_1_5 = (_lh_vecmult_LH_P3_1_2 *. _lh_vecmult_LH_P3_1_3) in
                    (let rec _lh_vecadd_LH_P3_0_1_5 = (_lh_vecmult_LH_P3_0_2 *. _lh_vecmult_LH_P3_0_3) in
                      (fun _lh_vecadd_arg2_7 -> 
                        (match _lh_vecadd_arg2_7 with
                          | `LH_P3(_lh_vecadd_LH_P3_0_1_6, _lh_vecadd_LH_P3_1_1_6, _lh_vecadd_LH_P3_2_1_6) -> 
                            (`LH_P3((_lh_vecadd_LH_P3_0_1_5 +. _lh_vecadd_LH_P3_0_1_6), (_lh_vecadd_LH_P3_1_1_5 +. _lh_vecadd_LH_P3_1_1_6), (_lh_vecadd_LH_P3_2_1_5 +. _lh_vecadd_LH_P3_2_1_6)))
                          | _ -> 
                            (failwith "error"))))))
              | _ -> 
                (failwith "error")))))) in
          ...
          (let rec norm_0 = ((spherenormal_lh__d1 hitpos_8) _lh_shade_arg2_0) in
            (let rec refl_8 = (match _lh_shade_arg4_0 with
              | `LH_P3(_lh_vecadd_LH_P3_0_1_7, _lh_vecadd_LH_P3_1_1_7, _lh_vecadd_LH_P3_2_1_7) -> 
                (((((vecscale_lh__d1_d0 norm_0) ((0.0 -. 2.0) *. ((vecdot_lh__d1 _lh_shade_arg4_0) norm_0))) _lh_vecadd_LH_P3_0_1_7) _lh_vecadd_LH_P3_1_1_7) _lh_vecadd_LH_P3_2_1_7)
              | _ -> 
                (failwith "error")) in
              (let rec diff_2 = (vecsum_lh__d1 (_lh_shade_arg1_8 (fun l_0 -> 
                (let rec _lh_matchIdent_1_5 = ((lightdirection_lh__d1 l_0) hitpos_8) in
                  (match _lh_matchIdent_1_5 with
                    | `LH_P2(_lh_lightray_LH_P2_0_5, _lh_lightray_LH_P2_1_3) -> 
                      (let rec cosangle_3 = ((vecdot_lh__d3 _lh_lightray_LH_P2_0_5) norm_0) in
                        (let rec _lh_matchIdent_1_6 = (((shadowed_lh__d1 hitpos_8) _lh_lightray_LH_P2_0_5) (lightcolour_lh__d1 l_0)) in
                          ((((_lh_matchIdent_1_6 _lh_lightray_LH_P2_0_5) refl_8) surf_8) cosangle_3)))
                    | _ -> 
                      (failwith "error")))))) in
                (let rec transmitted_0 = (transmitsurf_lh__d1 surf_8) in
                  (let rec simple_0 = (amb_0 diff_2) in
                    (let rec trintensity_8 = ((vecscale_lh__d7 (bodysurf_lh__d1 surf_8)) transmitted_0) in
                      (let rec _lh_matchIdent_1_7 = (if (transmitted_0 < epsilon_lh__d1) then
                        ...
                        ((((((_lh_matchIdent_1_7 _lh_shade_arg1_8) _lh_shade_arg6_8) hitpos_8) refl_8) surf_8) trintensity_8))))))))))))
and
transmitray_lh__d1 _lh_transmitray_arg1_4 _lh_transmitray_arg2_4 _lh_transmitray_arg3_4 _lh_transmitray_arg4_0 _lh_transmitray_arg5_0 _lh_transmitray_arg6_4 _lh_transmitray_arg7_0 _lh_transmitray_arg8_0 =
  (let rec newcontrib_5 = ((vecmult_lh__d2 _lh_transmitray_arg6_4) _lh_transmitray_arg7_0) in
    (let rec _lh_matchIdent_2_7 = (((refractray_lh__d1 _lh_transmitray_arg5_0) _lh_transmitray_arg4_0) _lh_transmitray_arg8_0) in
      (((((_lh_matchIdent_2_7 _lh_transmitray_arg1_4) _lh_transmitray_arg2_4) _lh_transmitray_arg3_4) _lh_transmitray_arg6_4) newcontrib_5)));;
...
let rec trace_lh__d1 _lh_trace_arg1_0 _lh_trace_arg2_0 _lh_trace_arg3_0 =
  (let rec f_1_4 = (fun d1s1_0 d2s2_0 -> 
    (let rec _lh_matchIdent_2_1 = d1s1_0 in
      (match _lh_matchIdent_2_1 with
        | `LH_P2(_lh_trace_LH_P2_0_0, _lh_trace_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_2_2 = d2s2_0 in
    ...
    (let rec sphmap_0 = (fun xss_0 -> 
      (let rec _lh_matchIdent_2_3 = xss_0 in
        (match _lh_matchIdent_2_3 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_0, _lh_trace_LH_C_1_0) -> 
            (let rec _lh_matchIdent_2_4 = (((sphereintersect_lh__d1 _lh_trace_arg2_0) _lh_trace_arg3_0) _lh_trace_LH_C_0_0) in
          ...
          (let rec _lh_tracepixel_LH_P3_2_0 = (head_lh__d2 _lh_trace_arg1_0) in
            (let rec _lh_tracepixel_LH_P3_1_0 = infinity_lh__d1 in
              (let rec _lh_tracepixel_LH_P3_0_0 = false in
                (fun _lh_tracepixel_LH_P2_0_1 _lh_tracepixel_arg2_2 pos_3 -> 
                  (if _lh_tracepixel_LH_P3_0_0 then
                    ((((((shade_lh__d1 _lh_tracepixel_arg2_2) _lh_tracepixel_LH_P3_2_0) pos_3) _lh_tracepixel_LH_P2_0_1) _lh_tracepixel_LH_P3_1_0) (`LH_P3(1.0, 1.0, 1.0)))
                  else
                    background_lh__d1)))))
        else
          (let rec _lh_matchIdent_2_5 = (((foldr_lh__d2 f_1_4) (head_lh__d1 dists_0)) (tail_lh__d1 dists_0)) in
                ...
                (let rec _lh_tracepixel_LH_P3_2_1 = _lh_trace_LH_P2_1_3 in
                  (let rec _lh_tracepixel_LH_P3_1_1 = _lh_trace_LH_P2_0_3 in
                    (let rec _lh_tracepixel_LH_P3_0_1 = true in
                      (fun _lh_tracepixel_LH_P2_0_2 _lh_tracepixel_arg2_3 pos_4 -> 
                        (if _lh_tracepixel_LH_P3_0_1 then
                          ((((((shade_lh__d1 _lh_tracepixel_arg2_3) _lh_tracepixel_LH_P3_2_1) pos_4) _lh_tracepixel_LH_P2_0_2) _lh_tracepixel_LH_P3_1_1) (`LH_P3(1.0, 1.0, 1.0)))
                        else
                          background_lh__d1)))))
              | _ -> 
                (failwith "error")))))));;
        ...
        (let rec _lh_vecadd_LH_P3_1_1_0 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_1_3) in
          (let rec _lh_vecadd_LH_P3_0_1_0 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_0_3) in
            (fun _lh_vecadd_LH_P3_0_1_1 _lh_vecadd_LH_P3_1_1_1 _lh_vecadd_LH_P3_2_1_1 -> 
              (let rec _lh_vecsub_LH_P3_2_1 = (_lh_vecadd_LH_P3_2_1_1 +. _lh_vecadd_LH_P3_2_1_0) in
                (let rec _lh_vecsub_LH_P3_1_1 = (_lh_vecadd_LH_P3_1_1_1 +. _lh_vecadd_LH_P3_1_1_0) in
                  (let rec _lh_vecsub_LH_P3_0_1 = (_lh_vecadd_LH_P3_0_1_1 +. _lh_vecadd_LH_P3_0_1_0) in
                    (fun _lh_vecsub_LH_P3_0_2 _lh_vecsub_LH_P3_1_2 _lh_vecsub_LH_P3_2_2 -> 
                      (let rec _lh_vecadd_LH_P3_2_1_2 = (_lh_vecsub_LH_P3_2_2 -. _lh_vecsub_LH_P3_2_1) in
                        (let rec _lh_vecadd_LH_P3_1_1_2 = (_lh_vecsub_LH_P3_1_2 -. _lh_vecsub_LH_P3_1_1) in
                          (let rec _lh_vecadd_LH_P3_0_1_2 = (_lh_vecsub_LH_P3_0_2 -. _lh_vecsub_LH_P3_0_1) in
                            (fun _lh_vecadd_arg2_3 -> 
                              (((_lh_vecadd_arg2_3 _lh_vecadd_LH_P3_0_1_2) _lh_vecadd_LH_P3_1_1_2) _lh_vecadd_LH_P3_2_1_2)))))))))))))
    | _ -> 
      (failwith "error"));;
...
let rec vecscale_lh__d1 _lh_vecscale_arg1_9 _lh_vecscale_arg2_9 =
  (match _lh_vecscale_arg1_9 with
    | `LH_P3(_lh_vecscale_LH_P3_0_9, _lh_vecscale_LH_P3_1_9, _lh_vecscale_LH_P3_2_9) -> 
      (let rec _lh_vecadd_LH_P3_2_2_7 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_2_9) in
        (let rec _lh_vecadd_LH_P3_1_2_7 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_1_9) in
          (let rec _lh_vecadd_LH_P3_0_2_7 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_0_9) in
            (fun _lh_vecadd_LH_P3_0_2_8 _lh_vecadd_LH_P3_1_2_8 _lh_vecadd_LH_P3_2_2_8 -> 
              (let rec _lh_vecadd_LH_P3_2_2_9 = (_lh_vecadd_LH_P3_2_2_8 +. _lh_vecadd_LH_P3_2_2_7) in
                (let rec _lh_vecadd_LH_P3_1_2_9 = (_lh_vecadd_LH_P3_1_2_8 +. _lh_vecadd_LH_P3_1_2_7) in
                  (let rec _lh_vecadd_LH_P3_0_2_9 = (_lh_vecadd_LH_P3_0_2_8 +. _lh_vecadd_LH_P3_0_2_7) in
                    (fun _lh_vecadd_arg2_1_3 -> 
                      (((_lh_vecadd_arg2_1_3 _lh_vecadd_LH_P3_0_2_9) _lh_vecadd_LH_P3_1_2_9) _lh_vecadd_LH_P3_2_2_9)))))))))
    | _ -> 
      (failwith "error"));;
...
let rec vecscale_lh__d5 _lh_vecscale_arg1_2 _lh_vecscale_arg2_2 =
  (match _lh_vecscale_arg1_2 with
    | `LH_P3(_lh_vecscale_LH_P3_0_2, _lh_vecscale_LH_P3_1_2, _lh_vecscale_LH_P3_2_2) -> 
      (let rec _lh_vecadd_LH_P3_2_9 = (_lh_vecscale_arg2_2 *. _lh_vecscale_LH_P3_2_2) in
        (let rec _lh_vecadd_LH_P3_1_9 = (_lh_vecscale_arg2_2 *. _lh_vecscale_LH_P3_1_2) in
          (let rec _lh_vecadd_LH_P3_0_9 = (_lh_vecscale_arg2_2 *. _lh_vecscale_LH_P3_0_2) in
            (fun _lh_vecadd_arg2_2 -> 
              (((_lh_vecadd_arg2_2 _lh_vecadd_LH_P3_0_9) _lh_vecadd_LH_P3_1_9) _lh_vecadd_LH_P3_2_9)))))
    | _ -> 
      (failwith "error"));;
...
let rec lookat_lh__d1 _lh_lookat_arg1_0 _lh_vecsub_arg2_3 =
  (let rec _lh_vecsub_LH_P3_2_6 = 0.0 in
    (let rec _lh_vecsub_LH_P3_1_6 = 0.0 in
      (let rec _lh_vecsub_LH_P3_0_6 = 0.0 in
        (((_lh_vecsub_arg2_3 _lh_vecsub_LH_P3_0_6) _lh_vecsub_LH_P3_1_6) _lh_vecsub_LH_P3_2_6))));;
let rec lookfrom_lh__d1 =
  (let rec _lh_vecsub_LH_P3_2_7 = 1.7 in
    (let rec _lh_vecsub_LH_P3_1_7 = 1.3 in
      (let rec _lh_vecsub_LH_P3_0_7 = 2.1 in
        (fun _lh_vecsub_LH_P3_0_8 _lh_vecsub_LH_P3_1_8 _lh_vecsub_LH_P3_2_8 -> 
          (`LH_P3((_lh_vecsub_LH_P3_0_8 -. _lh_vecsub_LH_P3_0_7), (_lh_vecsub_LH_P3_1_8 -. _lh_vecsub_LH_P3_1_7), (_lh_vecsub_LH_P3_2_8 -. _lh_vecsub_LH_P3_2_7)))))));;
...
let rec hash_lh__d1 _lh_hash_arg1_0 =
  (let rec u8_0 = (fun x_0 -> 
    ...
    ((_lh_hash_arg1_0 (fun rgb_0 acc_0 -> 
      (let rec _lh_matchIdent_2_6 = rgb_0 in
...
let rec run_lh__d1 _lh_run_arg1_0 =
  (hash_lh__d1 ((let rec lights_1 = (testlights_lh__d1 0) in
    (let rec _lh_matchIdent_9 = (let rec initfirstray_1 = ((lookat_lh__d1 0) lookfrom_lh__d1) in
      (let rec _lh_matchIdent_1_0 = (vecnorm_lh__d3 initfirstray_1) in
        ((((_lh_matchIdent_1_0 (vup_lh__d1 0)) fov_lh__d1) (float_of_int _lh_run_arg1_0)) initfirstray_1))) in
      ((_lh_matchIdent_9 _lh_run_arg1_0) lights_1))) snd_lh__d1));;

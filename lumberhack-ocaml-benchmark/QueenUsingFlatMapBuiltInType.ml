...
let rec enumFromTo_d0_d0 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_flatMap_LH_C_0_0 = (lazy a_0) in
      (let rec _lh_flatMap_LH_C_1_0 = (lazy ((enumFromTo_d0_d0 (a_0 + 1)) b_0)) in
        (fun _lh_flatMap_arg1_0 -> 
          ((append_d1_d0 (_lh_flatMap_arg1_0 (Lazy.force _lh_flatMap_LH_C_0_0))) ((flatMap_d1_d0 _lh_flatMap_arg1_0) (Lazy.force _lh_flatMap_LH_C_1_0))))))
  else
      ...
      ((flatMap_d0_d0 (fun b_1 -> 
        ((flatMap_d1_d0 (fun q_0 -> 
          (if (((safe_d0_d0 q_0) 1) b_1) then
            (let rec _lh_append_LH_C_0_0 = (lazy (let rec _lh_safe_LH_C_0_0 = (lazy q_0) in
              (let rec _lh_safe_LH_C_1_0 = (lazy b_1) in
                (fun _lh_safe_arg1_2 _lh_safe_arg2_2 -> 
                  ((((_lh_safe_arg1_2 != (Lazy.force _lh_safe_LH_C_0_0)) && (_lh_safe_arg1_2 != ((Lazy.force _lh_safe_LH_C_0_0) + _lh_safe_arg2_2))) && (_lh_safe_arg1_2 != ((Lazy.force _lh_safe_LH_C_0_0) - _lh_safe_arg2_2))) && (((safe_d0_d0 _lh_safe_arg1_2) (_lh_safe_arg2_2 + 1)) (Lazy.force _lh_safe_LH_C_1_0))))))) in
              (let rec _lh_append_LH_C_1_0 = (lazy (fun _lh_append_arg2_3 -> 
                _lh_append_arg2_3)) in
                (fun _lh_append_arg2_4 -> 
                  (let rec _lh_append_LH_C_0_1 = (lazy (Lazy.force _lh_append_LH_C_0_0)) in
                    (let rec _lh_append_LH_C_1_1 = (lazy ((append_d1_d0 (Lazy.force _lh_append_LH_C_1_0)) _lh_append_arg2_4)) in
                      (fun _lh_append_arg2_5 -> 
                        (`LH_C((Lazy.force _lh_append_LH_C_0_1), ((append_d0_d0 (Lazy.force _lh_append_LH_C_1_1)) _lh_append_arg2_5)))))))))
          else
...
(* lumberhack_pop_out *)
let rec append_d0_d0_d0 _lh_append_arg1_4 _lh_append_arg2_1_0 =
  (_lh_append_arg1_4 _lh_append_arg2_1_0);;
let rec append_d0_d0_d1 _lh_append_arg1_3 _lh_append_arg2_9 =
  (_lh_append_arg1_3 _lh_append_arg2_9);;
let rec append_d1_d0_d0 _lh_append_arg1_5 _lh_append_arg2_1_1 =
  (_lh_append_arg1_5 _lh_append_arg2_1_1);;
let rec append_d1_d0_d1 _lh_append_arg1_2 _lh_append_arg2_8 =
  (_lh_append_arg1_2 _lh_append_arg2_8);;
let rec flatMap_d1_d0_d0 _lh_flatMap_arg1_7 _lh_flatMap_arg2_3 =
...
let rec enumFromTo_d0_d0_d0 a_1 b_2 _lh_popOutId_0_0 =
  (if (a_1 <= b_2) then
    (let rec _lh_flatMap_LH_C_0_2 = (lazy a_1) in
      (let rec _lh_flatMap_LH_C_1_2 = (lazy ((enumFromTo_d0_d0_d0 (a_1 + 1)) b_2)) in
        ((append_d1_d0_d1 (_lh_popOutId_0_0 (Lazy.force _lh_flatMap_LH_C_0_2))) ((flatMap_d1_d0_d0 _lh_popOutId_0_0) (Lazy.force _lh_flatMap_LH_C_1_2)))))
  else
    (fun _lh_append_arg2_7 -> 
      _lh_append_arg2_7))
and flatMap_d0_d0_d0 _lh_flatMap_arg1_8 _lh_flatMap_arg2_4 =
  (match _lh_flatMap_arg2_4 with
    | `LH_N -> 
      (`LH_N)
    | `LH_C(_lh_flatMap_LH_C_0_3, _lh_flatMap_LH_C_1_3) -> 
      ((append_d0_d0_d1 (_lh_flatMap_arg1_8 _lh_flatMap_LH_C_0_3)) ((flatMap_d0_d0_d0 _lh_flatMap_arg1_8) _lh_flatMap_LH_C_1_3))
    | _ -> 
      (failwith "error"))
  ...
  (match _lh_gen_arg1_1 with
    | 0 -> 
      (`LH_C((fun _lh_safe_arg1_4 _lh_safe_arg2_4 -> 
        true), (`LH_N)))
    | _ -> 
      ((flatMap_d0_d0_d0 (fun b_3 -> 
        ((flatMap_d1_d0_d1 (fun q_1 -> 
          (if (((safe_d0_d0_d1 q_1) 1) b_3) then
            (let rec _lh_append_LH_C_0_2 = (lazy (let rec _lh_safe_LH_C_0_1 = (lazy q_1) in
              (let rec _lh_safe_LH_C_1_1 = (lazy b_3) in
                (fun _lh_safe_arg1_5 _lh_safe_arg2_5 -> 
                  ((((_lh_safe_arg1_5 != (Lazy.force _lh_safe_LH_C_0_1)) && (_lh_safe_arg1_5 != ((Lazy.force _lh_safe_LH_C_0_1) + _lh_safe_arg2_5))) && (_lh_safe_arg1_5 != ((Lazy.force _lh_safe_LH_C_0_1) - _lh_safe_arg2_5))) && (((safe_d0_d0_d0 _lh_safe_arg1_5) (_lh_safe_arg2_5 + 1)) (Lazy.force _lh_safe_LH_C_1_1))))))) in
              (let rec _lh_append_LH_C_1_2 = (lazy (fun _lh_append_arg2_1_2 -> 
                _lh_append_arg2_1_2)) in
                (fun _lh_append_arg2_1_3 -> 
                  (let rec _lh_append_LH_C_0_3 = (lazy (Lazy.force _lh_append_LH_C_0_2)) in
                    (let rec _lh_append_LH_C_1_3 = (lazy ((append_d1_d0_d0 (Lazy.force _lh_append_LH_C_1_2)) _lh_append_arg2_1_3)) in
                      (fun _lh_append_arg2_1_4 -> 
                        (`LH_C((Lazy.force _lh_append_LH_C_0_3), ((append_d0_d0_d0 (Lazy.force _lh_append_LH_C_1_3)) _lh_append_arg2_1_4)))))))))
          else
            (fun _lh_append_arg2_1_5 -> 
              _lh_append_arg2_1_5)))) ((enumFromTo_d0_d0_d0 1) _lh_gen_arg2_1)))) ((gen_d0_d0_d0 (_lh_gen_arg1_1 - 1)) _lh_gen_arg2_1)))

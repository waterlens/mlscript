...
let rec addIntInt__d0 _lh_addIntInt_arg1_2 _lh_addIntInt_arg2_2 =
  (match _lh_addIntInt_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec addIntInt__d1 _lh_addIntInt_arg1_1 _lh_addIntInt_arg2_1 =
...
let rec compareIntInt__d0 _lh_compareIntInt_arg1_7 _lh_compareIntInt_arg2_7 =
...
let rec compareIntInt__d1 _lh_compareIntInt_arg1_8 _lh_compareIntInt_arg2_8 =
  (match _lh_compareIntInt_arg1_8 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareIntInt__d2 _lh_compareIntInt_arg1_4 _lh_compareIntInt_arg2_4 =
  (match _lh_compareIntInt_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareIntInt__d3 _lh_compareIntInt_arg1_3 _lh_compareIntInt_arg2_3 =
...
let rec compareIntInt__d5 _lh_compareIntInt_arg1_2 _lh_compareIntInt_arg2_2 =
  (match _lh_compareIntInt_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareIntInt__d6 _lh_compareIntInt_arg1_5 _lh_compareIntInt_arg2_5 =
  (match _lh_compareIntInt_arg1_5 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareIntInt__d7 _lh_compareIntInt_arg1_6 _lh_compareIntInt_arg2_6 =
...
let rec flip__d0 _lh_flip_arg1_3 =
  (match _lh_flip_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec flip__d1 _lh_flip_arg1_2 =
  (match _lh_flip_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec flip__d2 _lh_flip_arg1_1 =
  (match _lh_flip_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec foldr__d0 f_1_5 i_3 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_2_6, t_2_8) -> 
...
let rec foldr__d1 f_1_6 i_4 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_2_7, t_2_9) -> 
      ((f_1_6 h_2_7) (((foldr__d1 f_1_6) i_4) t_2_9))
    | `LH_N -> 
      i_4);;
...
let rec mapMaybe__d0 _lh_mapMaybe_arg1_1 _lh_mapMaybe_arg2_1 =
  (match _lh_mapMaybe_arg2_1 with
    ...
    | `LH_C(_lh_mapMaybe_LH_C_0_1, _lh_mapMaybe_LH_C_1_1) -> 
      (let rec _lh_matchIdent_5_0 = (_lh_mapMaybe_arg1_1 _lh_mapMaybe_LH_C_0_1) in
    ...
    | _ -> 
      (failwith "error"));;
let rec map__d0 f_1_4 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_2_4, t_2_6) -> 
      (`LH_C((f_1_4 h_2_4), ((map__d0 f_1_4) t_2_6)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend__d1 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_2_5, t_2_7) -> 
      (`LH_C(h_2_5, ((mappend__d1 t_2_7) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec maxCol__d0 =
  8;;
...
let rec next__d0 _lh_next_arg1_2 =
  ...
  (let rec go_1 = (fun _lh_go_arg1_1 _lh_go_arg2_1 -> 
    (match _lh_go_arg2_1 with
      ...
      | `LH_C(_lh_go_LH_C_0_1, _lh_go_LH_C_1_1) -> 
        (`LH_C((`LH_P2(_lh_go_LH_C_0_1, (_lh_go_arg1_1 _lh_go_LH_C_1_1))), ((go_1 (fun _lh_funcomp_x_5 -> 
          ((fun p_2_6 -> 
            (`LH_C(_lh_go_LH_C_0_1, p_2_6))) (_lh_go_arg1_1 _lh_funcomp_x_5)))) _lh_go_LH_C_1_1)))
      | _ -> 
        (failwith "error"))) in
    ((go_1 (fun x_1_7 -> 
      x_1_7)) _lh_pickOne_arg1_1));;
...
let rec snd__d1 _lh_snd_arg1_1 =
  (match _lh_snd_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec snd__d2 _lh_snd_arg1_4 =
  (match _lh_snd_arg1_4 with
    | `LH_P2(_lh_snd_LH_P2_0_4, _lh_snd_LH_P2_1_4) -> 
      _lh_snd_LH_P2_1_4
    | _ -> 
      (failwith "error"));;
let rec snd__d3 _lh_snd_arg1_3 =
  (match _lh_snd_arg1_3 with
    | `LH_P2(_lh_snd_LH_P2_0_3, _lh_snd_LH_P2_1_3) -> 
      _lh_snd_LH_P2_1_3
    | _ -> 
      (failwith "error"));;
let rec check__d0 _lh_check_arg1_4 _lh_check_arg2_4 =
  ((mapLookup__d0 _lh_check_arg2_4) _lh_check_arg1_4)
and check__d1 _lh_check_arg1_1 _lh_check_arg2_1 =
  ((mapLookup__d1 _lh_check_arg2_1) _lh_check_arg1_1)
  ...
  (match _lh_extend_maybe_arg2_1 with
    | `LH_P2(_lh_extend_maybe_LH_P2_0_1, _lh_extend_maybe_LH_P2_1_1) -> 
      (if (((_lh_extend_maybe_LH_P2_0_1 > maxRow__d0) || (_lh_extend_maybe_LH_P2_1_1 < 1)) || (_lh_extend_maybe_LH_P2_1_1 > maxCol__d0)) then
        ...
        (let rec _lh_matchIdent_4_8 = ((check__d1 _lh_extend_maybe_arg1_1) (`LH_P2(_lh_extend_maybe_LH_P2_0_1, _lh_extend_maybe_LH_P2_1_1))) in
  ...
  (match _lh_extend_maybe_arg2_2 with
    | `LH_P2(_lh_extend_maybe_LH_P2_0_2, _lh_extend_maybe_LH_P2_1_2) -> 
      (if (((_lh_extend_maybe_LH_P2_0_2 > maxRow__d2) || (_lh_extend_maybe_LH_P2_1_2 < 1)) || (_lh_extend_maybe_LH_P2_1_2 > maxCol__d3)) then
        ...
        (let rec _lh_matchIdent_7_7 = ((check__d3 _lh_extend_maybe_arg1_2) (`LH_P2(_lh_extend_maybe_LH_P2_0_2, _lh_extend_maybe_LH_P2_1_2))) in
...
and extend__d1 _lh_extend_arg1_2 _lh_extend_arg2_2 _lh_extend_arg3_2 =
  (((insert__d1 _lh_extend_arg2_2) _lh_extend_arg3_2) _lh_extend_arg1_2)
and extend__d2 _lh_extend_arg1_1 _lh_extend_arg2_1 _lh_extend_arg3_1 =
  (((insert__d2 _lh_extend_arg2_1) _lh_extend_arg3_1) _lh_extend_arg1_1)
and extend__d3 _lh_extend_arg1_4 _lh_extend_arg2_4 _lh_extend_arg3_4 =
  (((insert__d3 _lh_extend_arg2_4) _lh_extend_arg3_4) _lh_extend_arg1_4)
and fit__d0 _lh_fit_arg1_2 _lh_fit_arg2_2 _lh_fit_arg3_2 _lh_fit_arg4_2 =
  (match _lh_fit_arg4_2 with
    ...
    | `LH_C(_lh_fit_LH_C_0_2, _lh_fit_LH_C_1_2) -> 
      (let rec _lh_matchIdent_7_6 = (((extend_maybe__d0 _lh_fit_arg1_2) ((addIntInt__d0 _lh_fit_arg2_2) _lh_fit_LH_C_0_2)) _lh_fit_arg3_2) in
...
and fit__d1 _lh_fit_arg1_1 _lh_fit_arg2_1 _lh_fit_arg3_1 _lh_fit_arg4_1 =
  (match _lh_fit_arg4_1 with
    ...
    | `LH_C(_lh_fit_LH_C_0_1, _lh_fit_LH_C_1_1) -> 
      (let rec _lh_matchIdent_3_9 = (((extend_maybe__d1 _lh_fit_arg1_1) ((addIntInt__d1 _lh_fit_arg2_1) _lh_fit_LH_C_0_1)) _lh_fit_arg3_1) in
...
and insert__d0 _lh_insert_arg1_4 _lh_insert_arg2_4 _lh_insert_arg3_4 =
  (match _lh_insert_arg3_4 with
    ...
    | `Bin(_lh_insert_Bin_0_4, _lh_insert_Bin_1_4, _lh_insert_Bin_2_4, _lh_insert_Bin_3_4, _lh_insert_Bin_4_4) -> 
        ...
        (match _lh_rotateR_arg3_4 with
          | `Bin(_lh_rotateR_Bin_0_8, _lh_rotateR_Bin_1_8, _lh_rotateR_Bin_2_8, _lh_rotateR_Bin_3_8, _lh_rotateR_Bin_4_8) -> 
            (let rec size_2_9 = (fun p_3_9 -> 
              (let rec _lh_matchIdent_8_2 = p_3_9 in
            ...
            (match _lh_doubleL_Bin_3_1_2 with
              | `Bin(_lh_doubleL_Bin_0_1_3, _lh_doubleL_Bin_1_1_3, _lh_doubleL_Bin_2_1_3, _lh_doubleL_Bin_3_1_3, _lh_doubleL_Bin_4_1_3) -> 
                (let rec size_3_0 = (fun p_4_0 -> 
                  (let rec _lh_matchIdent_8_3 = p_4_0 in
        ...
        (match _lh_singleL_arg4_4 with
          | `Bin(_lh_singleL_Bin_0_8, _lh_singleL_Bin_1_8, _lh_singleL_Bin_2_8, _lh_singleL_Bin_3_8, _lh_singleL_Bin_4_8) -> 
            (let rec size_3_3 = (fun p_4_3 -> 
              (let rec _lh_matchIdent_8_6 = p_4_3 in
        ...
        (match _lh_rotateL_arg4_4 with
          | `Bin(_lh_rotateL_Bin_0_8, _lh_rotateL_Bin_1_8, _lh_rotateL_Bin_2_8, _lh_rotateL_Bin_3_8, _lh_rotateL_Bin_4_8) -> 
            (let rec size_3_4 = (fun p_4_4 -> 
              (let rec _lh_matchIdent_8_7 = p_4_4 in
      ...
      and balance_4 = (fun _lh_balance_arg1_4 _lh_balance_arg2_4 _lh_balance_arg3_4 _lh_balance_arg4_4 -> 
        (let rec size_2_8 = (fun p_3_8 -> 
          (let rec _lh_matchIdent_8_1 = p_3_8 in
        ...
        (match _lh_singleR_arg3_4 with
          | `Bin(_lh_singleR_Bin_0_8, _lh_singleR_Bin_1_8, _lh_singleR_Bin_2_8, _lh_singleR_Bin_3_8, _lh_singleR_Bin_4_8) -> 
            (let rec size_3_1 = (fun p_4_1 -> 
              (let rec _lh_matchIdent_8_4 = p_4_1 in
            ...
            (match _lh_doubleR_Bin_4_1_2 with
              | `Bin(_lh_doubleR_Bin_0_1_3, _lh_doubleR_Bin_1_1_3, _lh_doubleR_Bin_2_1_3, _lh_doubleR_Bin_3_1_3, _lh_doubleR_Bin_4_1_3) -> 
                (let rec size_3_2 = (fun p_4_2 -> 
                  (let rec _lh_matchIdent_8_5 = p_4_2 in
      ...
      in (let rec _lh_matchIdent_8_8 = ((compareIntInt__d1 _lh_insert_arg1_4) _lh_insert_Bin_1_4) in
        (match _lh_matchIdent_8_8 with
          | `LT -> 
            ((((balance_4 _lh_insert_Bin_1_4) _lh_insert_Bin_2_4) (((insert__d0 _lh_insert_arg1_4) _lh_insert_arg2_4) _lh_insert_Bin_3_4)) _lh_insert_Bin_4_4)
          | `GT -> 
            ((((balance_4 _lh_insert_Bin_1_4) _lh_insert_Bin_2_4) _lh_insert_Bin_3_4) (((insert__d0 _lh_insert_arg1_4) _lh_insert_arg2_4) _lh_insert_Bin_4_4))
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and insert__d1 _lh_insert_arg1_1 _lh_insert_arg2_1 _lh_insert_arg3_1 =
  (match _lh_insert_arg3_1 with
    ...
    | `Bin(_lh_insert_Bin_0_1, _lh_insert_Bin_1_1, _lh_insert_Bin_2_1, _lh_insert_Bin_3_1, _lh_insert_Bin_4_1) -> 
      ...
      and rotateR_1 = (fun _lh_rotateR_arg1_1 _lh_rotateR_arg2_1 _lh_rotateR_arg3_1 _lh_rotateR_arg4_1 -> 
        (match _lh_rotateR_arg3_1 with
          ...
          | _ -> 
            (failwith "error")))
      in (let rec _lh_matchIdent_3_7 = ((compareIntInt__d3 _lh_insert_arg1_1) _lh_insert_Bin_1_1) in
        (match _lh_matchIdent_3_7 with
          | `LT -> 
            ((((balance_1 _lh_insert_Bin_1_1) _lh_insert_Bin_2_1) (((insert__d1 _lh_insert_arg1_1) _lh_insert_arg2_1) _lh_insert_Bin_3_1)) _lh_insert_Bin_4_1)
          | `GT -> 
            ((((balance_1 _lh_insert_Bin_1_1) _lh_insert_Bin_2_1) _lh_insert_Bin_3_1) (((insert__d1 _lh_insert_arg1_1) _lh_insert_arg2_1) _lh_insert_Bin_4_1))
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and insert__d2 _lh_insert_arg1_2 _lh_insert_arg2_2 _lh_insert_arg3_2 =
  (match _lh_insert_arg3_2 with
    ...
    | `Bin(_lh_insert_Bin_0_2, _lh_insert_Bin_1_2, _lh_insert_Bin_2_2, _lh_insert_Bin_3_2, _lh_insert_Bin_4_2) -> 
          ...
          | `Bin(_lh_doubleR_Bin_0_6, _lh_doubleR_Bin_1_6, _lh_doubleR_Bin_2_6, _lh_doubleR_Bin_3_6, _lh_doubleR_Bin_4_6) -> 
            (match _lh_doubleR_Bin_4_6 with
              | `Bin(_lh_doubleR_Bin_0_7, _lh_doubleR_Bin_1_7, _lh_doubleR_Bin_2_7, _lh_doubleR_Bin_3_7, _lh_doubleR_Bin_4_7) -> 
                (let rec size_1_8 = (fun p_2_3 -> 
                  (let rec _lh_matchIdent_4_4 = p_2_3 in
                    (match _lh_matchIdent_4_4 with
                      ...
                      | _ -> 
                        (failwith "error")))) in
                  (let rec bin_1_0 = (fun k_1_4 x_1_5 l_1_0 r_1_1 -> 
                    (`Bin((((size_1_8 l_1_0) + (size_1_8 r_1_1)) + 1), k_1_4, x_1_5, l_1_0, r_1_1))) in
      ...
      and balance_2 = (fun _lh_balance_arg1_2 _lh_balance_arg2_2 _lh_balance_arg3_2 _lh_balance_arg4_2 -> 
        (let rec size_1_4 = (fun p_1_9 -> 
          (let rec _lh_matchIdent_4_0 = p_1_9 in
      ...
      and singleL_2 = (fun _lh_singleL_arg1_2 _lh_singleL_arg2_2 _lh_singleL_arg3_2 _lh_singleL_arg4_2 -> 
        (match _lh_singleL_arg4_2 with
          | `Bin(_lh_singleL_Bin_0_4, _lh_singleL_Bin_1_4, _lh_singleL_Bin_2_4, _lh_singleL_Bin_3_4, _lh_singleL_Bin_4_4) -> 
            (let rec size_1_9 = (fun p_2_4 -> 
              (let rec _lh_matchIdent_4_5 = p_2_4 in
                (match _lh_matchIdent_4_5 with
                  ...
                  | _ -> 
                    (failwith "error")))) in
              (let rec bin_1_1 = (fun k_1_5 x_1_6 l_1_1 r_1_2 -> 
                (`Bin((((size_1_9 l_1_1) + (size_1_9 r_1_2)) + 1), k_1_5, x_1_6, l_1_1, r_1_2))) in
      ...
      and singleR_2 = (fun _lh_singleR_arg1_2 _lh_singleR_arg2_2 _lh_singleR_arg3_2 _lh_singleR_arg4_2 -> 
        (match _lh_singleR_arg3_2 with
          | `Bin(_lh_singleR_Bin_0_4, _lh_singleR_Bin_1_4, _lh_singleR_Bin_2_4, _lh_singleR_Bin_3_4, _lh_singleR_Bin_4_4) -> 
            (let rec size_1_7 = (fun p_2_2 -> 
              (let rec _lh_matchIdent_4_3 = p_2_2 in
                (match _lh_matchIdent_4_3 with
                  ...
                  | _ -> 
                    (failwith "error")))) in
              (let rec bin_9 = (fun k_1_3 x_1_4 l_9 r_1_0 -> 
                (`Bin((((size_1_7 l_9) + (size_1_7 r_1_0)) + 1), k_1_3, x_1_4, l_9, r_1_0))) in
                ...
                (let rec size_1_6 = (fun p_2_1 -> 
                  (let rec _lh_matchIdent_4_2 = p_2_1 in
                    (match _lh_matchIdent_4_2 with
                      ...
                      | _ -> 
                        (failwith "error")))) in
                  (let rec bin_8 = (fun k_1_2 x_1_3 l_8 r_9 -> 
                    (`Bin((((size_1_6 l_8) + (size_1_6 r_9)) + 1), k_1_2, x_1_3, l_8, r_9))) in
      ...
      and rotateR_2 = (fun _lh_rotateR_arg1_2 _lh_rotateR_arg2_2 _lh_rotateR_arg3_2 _lh_rotateR_arg4_2 -> 
        (match _lh_rotateR_arg3_2 with
          | `Bin(_lh_rotateR_Bin_0_4, _lh_rotateR_Bin_1_4, _lh_rotateR_Bin_2_4, _lh_rotateR_Bin_3_4, _lh_rotateR_Bin_4_4) -> 
            (let rec size_1_5 = (fun p_2_0 -> 
              (let rec _lh_matchIdent_4_1 = p_2_0 in
      ...
      and rotateL_2 = (fun _lh_rotateL_arg1_2 _lh_rotateL_arg2_2 _lh_rotateL_arg3_2 _lh_rotateL_arg4_2 -> 
        (match _lh_rotateL_arg4_2 with
          | `Bin(_lh_rotateL_Bin_0_4, _lh_rotateL_Bin_1_4, _lh_rotateL_Bin_2_4, _lh_rotateL_Bin_3_4, _lh_rotateL_Bin_4_4) -> 
            (let rec size_2_0 = (fun p_2_5 -> 
              (let rec _lh_matchIdent_4_6 = p_2_5 in
          ...
          | _ -> 
            (failwith "error")))
      in (let rec _lh_matchIdent_4_7 = ((compareIntInt__d5 _lh_insert_arg1_2) _lh_insert_Bin_1_2) in
        (match _lh_matchIdent_4_7 with
          | `LT -> 
            ((((balance_2 _lh_insert_Bin_1_2) _lh_insert_Bin_2_2) (((insert__d2 _lh_insert_arg1_2) _lh_insert_arg2_2) _lh_insert_Bin_3_2)) _lh_insert_Bin_4_2)
          | `GT -> 
            ((((balance_2 _lh_insert_Bin_1_2) _lh_insert_Bin_2_2) _lh_insert_Bin_3_2) (((insert__d2 _lh_insert_arg1_2) _lh_insert_arg2_2) _lh_insert_Bin_4_2))
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and insert__d3 _lh_insert_arg1_3 _lh_insert_arg2_3 _lh_insert_arg3_3 =
  (match _lh_insert_arg3_3 with
    ...
    | `Bin(_lh_insert_Bin_0_3, _lh_insert_Bin_1_3, _lh_insert_Bin_2_3, _lh_insert_Bin_3_3, _lh_insert_Bin_4_3) -> 
          ...
          | `Bin(_lh_doubleL_Bin_0_9, _lh_doubleL_Bin_1_9, _lh_doubleL_Bin_2_9, _lh_doubleL_Bin_3_9, _lh_doubleL_Bin_4_9) -> 
            (match _lh_doubleL_Bin_3_9 with
              | `Bin(_lh_doubleL_Bin_0_1_0, _lh_doubleL_Bin_1_1_0, _lh_doubleL_Bin_2_1_0, _lh_doubleL_Bin_3_1_0, _lh_doubleL_Bin_4_1_0) -> 
                (let rec size_2_3 = (fun p_2_9 -> 
                  (let rec _lh_matchIdent_5_3 = p_2_9 in
                    (match _lh_matchIdent_5_3 with
                      ...
                      | _ -> 
                        (failwith "error")))) in
                  (let rec bin_1_2 = (fun k_1_6 x_1_8 l_1_2 r_1_3 -> 
                    (`Bin((((size_2_3 l_1_2) + (size_2_3 r_1_3)) + 1), k_1_6, x_1_8, l_1_2, r_1_3))) in
      ...
      and balance_3 = (fun _lh_balance_arg1_3 _lh_balance_arg2_3 _lh_balance_arg3_3 _lh_balance_arg4_3 -> 
        (let rec size_2_1 = (fun p_2_7 -> 
          (let rec _lh_matchIdent_5_1 = p_2_7 in
      ...
      and rotateR_3 = (fun _lh_rotateR_arg1_3 _lh_rotateR_arg2_3 _lh_rotateR_arg3_3 _lh_rotateR_arg4_3 -> 
        (match _lh_rotateR_arg3_3 with
          | `Bin(_lh_rotateR_Bin_0_6, _lh_rotateR_Bin_1_6, _lh_rotateR_Bin_2_6, _lh_rotateR_Bin_3_6, _lh_rotateR_Bin_4_6) -> 
            (let rec size_2_2 = (fun p_2_8 -> 
              (let rec _lh_matchIdent_5_2 = p_2_8 in
      ...
      and singleL_3 = (fun _lh_singleL_arg1_3 _lh_singleL_arg2_3 _lh_singleL_arg3_3 _lh_singleL_arg4_3 -> 
        (match _lh_singleL_arg4_3 with
          | `Bin(_lh_singleL_Bin_0_6, _lh_singleL_Bin_1_6, _lh_singleL_Bin_2_6, _lh_singleL_Bin_3_6, _lh_singleL_Bin_4_6) -> 
            (let rec size_2_6 = (fun p_3_2 -> 
              (let rec _lh_matchIdent_5_6 = p_3_2 in
                (match _lh_matchIdent_5_6 with
                  ...
                  | _ -> 
                    (failwith "error")))) in
              (let rec bin_1_5 = (fun k_1_9 x_2_1 l_1_5 r_1_6 -> 
                (`Bin((((size_2_6 l_1_5) + (size_2_6 r_1_6)) + 1), k_1_9, x_2_1, l_1_5, r_1_6))) in
      ...
      and rotateL_3 = (fun _lh_rotateL_arg1_3 _lh_rotateL_arg2_3 _lh_rotateL_arg3_3 _lh_rotateL_arg4_3 -> 
        (match _lh_rotateL_arg4_3 with
          | `Bin(_lh_rotateL_Bin_0_6, _lh_rotateL_Bin_1_6, _lh_rotateL_Bin_2_6, _lh_rotateL_Bin_3_6, _lh_rotateL_Bin_4_6) -> 
            (let rec size_2_7 = (fun p_3_3 -> 
              (let rec _lh_matchIdent_5_7 = p_3_3 in
          ...
          | `Bin(_lh_doubleR_Bin_0_9, _lh_doubleR_Bin_1_9, _lh_doubleR_Bin_2_9, _lh_doubleR_Bin_3_9, _lh_doubleR_Bin_4_9) -> 
            (match _lh_doubleR_Bin_4_9 with
              | `Bin(_lh_doubleR_Bin_0_1_0, _lh_doubleR_Bin_1_1_0, _lh_doubleR_Bin_2_1_0, _lh_doubleR_Bin_3_1_0, _lh_doubleR_Bin_4_1_0) -> 
                (let rec size_2_5 = (fun p_3_1 -> 
                  (let rec _lh_matchIdent_5_5 = p_3_1 in
                    (match _lh_matchIdent_5_5 with
                      ...
                      | _ -> 
                        (failwith "error")))) in
                  (let rec bin_1_4 = (fun k_1_8 x_2_0 l_1_4 r_1_5 -> 
                    (`Bin((((size_2_5 l_1_4) + (size_2_5 r_1_5)) + 1), k_1_8, x_2_0, l_1_4, r_1_5))) in
      ...
      and singleR_3 = (fun _lh_singleR_arg1_3 _lh_singleR_arg2_3 _lh_singleR_arg3_3 _lh_singleR_arg4_3 -> 
        (match _lh_singleR_arg3_3 with
          | `Bin(_lh_singleR_Bin_0_6, _lh_singleR_Bin_1_6, _lh_singleR_Bin_2_6, _lh_singleR_Bin_3_6, _lh_singleR_Bin_4_6) -> 
            (let rec size_2_4 = (fun p_3_0 -> 
              (let rec _lh_matchIdent_5_4 = p_3_0 in
                (match _lh_matchIdent_5_4 with
                  ...
                  | _ -> 
                    (failwith "error")))) in
              (let rec bin_1_3 = (fun k_1_7 x_1_9 l_1_3 r_1_4 -> 
                (`Bin((((size_2_4 l_1_3) + (size_2_4 r_1_4)) + 1), k_1_7, x_1_9, l_1_3, r_1_4))) in
          ...
          | _ -> 
            (failwith "error")))
      in (let rec _lh_matchIdent_5_8 = ((compareIntInt__d7 _lh_insert_arg1_3) _lh_insert_Bin_1_3) in
        (match _lh_matchIdent_5_8 with
          | `LT -> 
            ((((balance_3 _lh_insert_Bin_1_3) _lh_insert_Bin_2_3) (((insert__d3 _lh_insert_arg1_3) _lh_insert_arg2_3) _lh_insert_Bin_3_3)) _lh_insert_Bin_4_3)
          | `GT -> 
            ((((balance_3 _lh_insert_Bin_1_3) _lh_insert_Bin_2_3) _lh_insert_Bin_3_3) (((insert__d3 _lh_insert_arg1_3) _lh_insert_arg2_3) _lh_insert_Bin_4_3))
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and mapLookup__d0 _lh_mapLookup_arg1_2 _lh_mapLookup_arg2_2 =
  (match _lh_mapLookup_arg2_2 with
    ...
    | `Bin(_lh_mapLookup_Bin_0_2, _lh_mapLookup_Bin_1_2, _lh_mapLookup_Bin_2_2, _lh_mapLookup_Bin_3_2, _lh_mapLookup_Bin_4_2) -> 
      (let rec _lh_matchIdent_7_4 = ((compareIntInt__d0 _lh_mapLookup_arg1_2) _lh_mapLookup_Bin_1_2) in
        (match _lh_matchIdent_7_4 with
          | `LT -> 
            ((mapLookup__d0 _lh_mapLookup_arg1_2) _lh_mapLookup_Bin_3_2)
          | `GT -> 
            ((mapLookup__d0 _lh_mapLookup_arg1_2) _lh_mapLookup_Bin_4_2)
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and mapLookup__d1 _lh_mapLookup_arg1_3 _lh_mapLookup_arg2_3 =
  (match _lh_mapLookup_arg2_3 with
    ...
    | `Bin(_lh_mapLookup_Bin_0_3, _lh_mapLookup_Bin_1_3, _lh_mapLookup_Bin_2_3, _lh_mapLookup_Bin_3_3, _lh_mapLookup_Bin_4_3) -> 
      (let rec _lh_matchIdent_7_5 = ((compareIntInt__d2 _lh_mapLookup_arg1_3) _lh_mapLookup_Bin_1_3) in
        (match _lh_matchIdent_7_5 with
          | `LT -> 
            ((mapLookup__d1 _lh_mapLookup_arg1_3) _lh_mapLookup_Bin_3_3)
          | `GT -> 
            ((mapLookup__d1 _lh_mapLookup_arg1_3) _lh_mapLookup_Bin_4_3)
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and mapLookup__d2 _lh_mapLookup_arg1_4 _lh_mapLookup_arg2_4 =
  (match _lh_mapLookup_arg2_4 with
    ...
    | `Bin(_lh_mapLookup_Bin_0_4, _lh_mapLookup_Bin_1_4, _lh_mapLookup_Bin_2_4, _lh_mapLookup_Bin_3_4, _lh_mapLookup_Bin_4_4) -> 
      (let rec _lh_matchIdent_8_0 = ((compareIntInt__d4 _lh_mapLookup_arg1_4) _lh_mapLookup_Bin_1_4) in
        (match _lh_matchIdent_8_0 with
          | `LT -> 
            ((mapLookup__d2 _lh_mapLookup_arg1_4) _lh_mapLookup_Bin_3_4)
          | `GT -> 
            ((mapLookup__d2 _lh_mapLookup_arg1_4) _lh_mapLookup_Bin_4_4)
          | `EQ -> 
    ...
    | _ -> 
      (failwith "error"))
and mapLookup__d3 _lh_mapLookup_arg1_1 _lh_mapLookup_arg2_1 =
  (match _lh_mapLookup_arg2_1 with
    ...
    | `Bin(_lh_mapLookup_Bin_0_1, _lh_mapLookup_Bin_1_1, _lh_mapLookup_Bin_2_1, _lh_mapLookup_Bin_3_1, _lh_mapLookup_Bin_4_1) -> 
      (let rec _lh_matchIdent_3_8 = ((compareIntInt__d6 _lh_mapLookup_arg1_1) _lh_mapLookup_Bin_1_1) in
        (match _lh_matchIdent_3_8 with
          | `LT -> 
            ((mapLookup__d3 _lh_mapLookup_arg1_1) _lh_mapLookup_Bin_3_1)
          | `GT -> 
          ...
          (if (_lh_search_LH_P2_1_2 = (maxCol__d2 + 1)) then
            ...
            (if (isJust__d0 ((check__d2 _lh_search_arg3_1) (`LH_P2(_lh_search_LH_P2_0_2, _lh_search_LH_P2_1_2)))) then
              ...
              (let rec choices_1 = (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                        ...
                        (match _lh_search_LH_P2_0_3 with
                          | `P(_lh_search_P_0_1, _lh_search_P_1_1, _lh_search_P_2_1) -> 
                            (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
                              ...
                              (_lh_listcomp_fun_3 (let rec _lh_matchIdent_7_8 = _lh_search_arg2_1 in
                ...
                (let rec _lh_matchIdent_7_9 = ((mapMaybe__d0 (((try__d0 (`LH_P2(_lh_search_LH_P2_0_2, _lh_search_LH_P2_1_2))) _lh_search_arg2_1) _lh_search_arg3_1)) choices_1) in
                  (match _lh_matchIdent_7_9 with
                    | `LH_N -> 
                      (`Fail(_lh_search_arg3_1, (`LH_P2(_lh_search_LH_P2_0_2, _lh_search_LH_P2_1_2))))
                    | _ -> 
                      (`Choose(_lh_matchIdent_7_9))))))))
    | _ -> 
      (failwith "error"))
and testLastPiece_nofib__d0 _lh_testLastPiece_nofib_arg1_1 =
  ...
  and easyDisplay_1 = (fun _lh_easyDisplay_arg1_1 _lh_easyDisplay_arg2_1 _lh_easyDisplay_arg3_1 _lh_easyDisplay_arg4_1 -> 
    (let rec lay_2 = (fun x_2_3 -> 
      (let rec _lh_matchIdent_6_4 = x_2_3 in
  ...
  and fullRender_1 = (fun _lh_fullRender_arg1_1 _lh_fullRender_arg2_1 _lh_fullRender_arg3_1 _lh_fullRender_arg4_1 -> 
    (let rec annTxt_1 = (fun p_3_6 -> 
      (let rec _lh_matchIdent_6_3 = p_3_6 in
  ...
  and hcat_1 = (fun _lh_hcat_arg1_1 -> 
    ((fun _lh_funcomp_x_8 -> 
      ((fun _lh_funcomp_x_9 -> 
        (snd__d1 (reduceHoriz_1 _lh_funcomp_x_9))) (((foldr__d0 (fun p_3_5 q_3 -> 
        (`Beside(p_3_5, false, q_3)))) (`Empty)) _lh_funcomp_x_8))) _lh_hcat_arg1_1))
  and spaceText_1 = (`NoAnnot((`Chr(' ')), 1))
  and printDoc_1 = (fun _lh_printDoc_arg1_1 -> 
    (let rec put_1 = (fun k_2_3 next_2 -> 
      (let rec _lh_matchIdent_7_1 = k_2_3 in
  ...
  and eliminateEmpty_1 = (fun _lh_eliminateEmpty_arg1_1 _lh_eliminateEmpty_arg2_1 _lh_eliminateEmpty_arg3_1 _lh_eliminateEmpty_arg4_1 -> 
    (match _lh_eliminateEmpty_arg2_1 with
      ...
      | _ -> 
        (`LH_P2((`NotEmpty), (let rec _lh_matchIdent_6_2 = _lh_eliminateEmpty_arg4_1 in
  ...
  and displayDoc_1 = (fun _lh_displayDoc_arg1_1 _lh_displayDoc_arg2_1 _lh_displayDoc_arg3_1 _lh_displayDoc_arg4_1 _lh_displayDoc_arg5_1 _lh_displayDoc_arg6_1 -> 
    (let rec _lh_matchIdent_6_5 = (_lh_displayDoc_arg2_1 - _lh_displayDoc_arg3_1) in
      (let rec _lh_matchIdent_6_6 = (_lh_matchIdent_6_5 / 2) in
        (let rec lay_3 = (let rec lay2_1 = (fun k_2_0 param_1 -> 
          (let rec _lh_matchIdent_6_7 = param_1 in
            (match _lh_matchIdent_6_7 with
              | `NilAbove(_lh_displayDoc_NilAbove_0_2) -> 
                ((_lh_displayDoc_arg4_1 nlText_1) ((lay_3 k_2_0) _lh_displayDoc_NilAbove_0_2))
              | `TextBeside(_lh_displayDoc_TextBeside_0_2, _lh_displayDoc_TextBeside_1_2) -> 
                ((_lh_displayDoc_arg4_1 _lh_displayDoc_TextBeside_0_2) ((lay2_1 (k_2_0 + (annotSize_1 _lh_displayDoc_TextBeside_0_2))) _lh_displayDoc_TextBeside_1_2))
              | `Nest(_lh_displayDoc_Nest_0_2, _lh_displayDoc_Nest_1_2) -> 
                ((lay2_1 k_2_0) _lh_displayDoc_Nest_1_2)
              | `Empty -> 
              ...
              | _ -> 
                (failwith "error")))) in
          (let rec lay1_1 = (fun k_2_1 s_1 p_3_7 -> 
            (let rec r_1_7 = (k_2_1 + (annotSize_1 s_1)) in
              ((_lh_displayDoc_arg4_1 (`NoAnnot((`Str((indent__d1 k_2_1))), k_2_1))) ((_lh_displayDoc_arg4_1 s_1) ((lay2_1 r_1_7) p_3_7))))) in
            (fun k_2_2 docc_1 -> 
              (let rec _lh_matchIdent_6_8 = docc_1 in
                (match _lh_matchIdent_6_8 with
                  | `Nest(_lh_displayDoc_Nest_0_3, _lh_displayDoc_Nest_1_3) -> 
                    ((lay_3 (k_2_2 + _lh_displayDoc_Nest_0_3)) _lh_displayDoc_Nest_1_3)
                  | `Empty -> 
                    _lh_displayDoc_arg5_1
                  | `NilAbove(_lh_displayDoc_NilAbove_0_3) -> 
                    ((_lh_displayDoc_arg4_1 nlText_1) ((lay_3 k_2_2) _lh_displayDoc_NilAbove_0_3))
                  | `TextBeside(_lh_displayDoc_TextBeside_0_3, _lh_displayDoc_TextBeside_1_3) -> 
                    (let rec _lh_matchIdent_6_9 = _lh_displayDoc_arg1_1 in
                      (match _lh_matchIdent_6_9 with
                        | `ZigZagMode -> 
                          (if (k_2_2 >= _lh_matchIdent_6_5) then
                            ((_lh_displayDoc_arg4_1 nlText_1) ((_lh_displayDoc_arg4_1 (`NoAnnot((`Str(((copy__d0 _lh_matchIdent_6_6) '/'))), _lh_matchIdent_6_6))) ((_lh_displayDoc_arg4_1 nlText_1) (((lay1_1 (k_2_2 - _lh_matchIdent_6_6)) _lh_displayDoc_TextBeside_0_3) _lh_displayDoc_TextBeside_1_3))))
                          else
                            (if (k_2_2 < 0) then
                              ((_lh_displayDoc_arg4_1 nlText_1) ((_lh_displayDoc_arg4_1 (`NoAnnot((`Str(((copy__d1 _lh_matchIdent_6_6) '|'))), _lh_matchIdent_6_6))) ((_lh_displayDoc_arg4_1 nlText_1) (((lay1_1 (k_2_2 + _lh_matchIdent_6_6)) _lh_displayDoc_TextBeside_0_3) _lh_displayDoc_TextBeside_1_3))))
                            else
                              (((lay1_1 k_2_2) _lh_displayDoc_TextBeside_0_3) _lh_displayDoc_TextBeside_1_3)))
                        | _ -> 
                          (((lay1_1 k_2_2) _lh_displayDoc_TextBeside_0_3) _lh_displayDoc_TextBeside_1_3)))
  ...
  and displayBoard_1 = (fun _lh_displayBoard_arg1_1 -> 
    (let rec sq_1 = (fun n_6 col_1 -> 
      (let rec _lh_matchIdent_6_0 = ((check__d0 _lh_displayBoard_arg1_1) (`LH_P2(n_6, col_1))) in
  ...
  and vcat_1 = (fun _lh_vcat_arg1_1 -> 
    ((fun _lh_funcomp_x_6 -> 
      ((fun _lh_funcomp_x_7 -> 
        (snd__d3 (reduceVert_1 _lh_funcomp_x_7))) (((foldr__d1 (fun p_3_4 q_2 -> 
        (`Above(p_3_4, false, q_2)))) (`Empty)) _lh_funcomp_x_6))) _lh_vcat_arg1_1))
  ...
  and fits_1 = (fun _lh_fits_arg1_1 _lh_fits_arg2_1 -> 
    (if (_lh_fits_arg1_1 < 0) then
      ...
      (let rec _lh_matchIdent_7_3 = _lh_fits_arg2_1 in
  ...
  and text_1 = (fun _lh_text_arg1_1 -> 
    (let rec _lh_matchIdent_7_0 = (length__d0 _lh_text_arg1_1) in
      (`TextBeside((`NoAnnot((`Str(_lh_text_arg1_1)), _lh_matchIdent_7_0)), (`Empty)))))
  ...
  and beside_1 = (fun _lh_beside_arg1_1 _lh_beside_arg2_1 _lh_beside_arg3_1 -> 
    (match _lh_beside_arg1_1 with
      ...
      | `TextBeside(_lh_beside_TextBeside_0_1, _lh_beside_TextBeside_1_1) -> 
        (let rec rest_2 = (let rec _lh_matchIdent_6_1 = _lh_beside_TextBeside_1_1 in
    ...
    (match _lh_fullRenderAnn_arg1_1 with
      ...
      | _ -> 
        (let rec ribbonLen_1 = (int_of_float (ceil ((float_of_int _lh_fullRenderAnn_arg2_1) /. _lh_fullRenderAnn_arg3_1))) in
          (let rec bestLineLen_1 = (let rec _lh_matchIdent_5_9 = _lh_fullRenderAnn_arg1_1 in
    ...
    (match _lh_aboveNest_arg1_1 with
      ...
      | `TextBeside(_lh_aboveNest_TextBeside_0_1, _lh_aboveNest_TextBeside_1_1) -> 
        (let rec k1_1 = (_lh_aboveNest_arg3_1 - (annotSize_1 _lh_aboveNest_TextBeside_0_1)) in
          (let rec rest_3 = (let rec _lh_matchIdent_7_2 = _lh_aboveNest_TextBeside_1_1 in
...
and try__d0 _lh_try_arg1_1 _lh_try_arg2_1 _lh_try_arg3_1 _lh_try_arg4_1 =
  (match _lh_try_arg4_1 with
    | `LH_P3(_lh_try_LH_P3_0_1, _lh_try_LH_P3_1_1, _lh_try_LH_P3_2_1) -> 
      (let rec _lh_matchIdent_4_9 = ((((fit__d1 _lh_try_arg3_1) _lh_try_arg1_1) _lh_try_LH_P3_0_1) _lh_try_LH_P3_1_1) in

  ...
  (if (a_3 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo_lh__d3 (a_3 + 1)) b_1) in
      (fun _lh_listcomp_fun_2 -> 
        (let rec t_1 = (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2) in
          (let rec h_1 = '0' in
            (fun ys_0 -> 
              (`LH_C(h_1, ((mappend_lh__d2 t_1) ys_0))))))))
  else
    (fun _lh_listcomp_fun_3 ys_1 -> 
      ys_1));;
...
constantRule_lh__d1 _lh_constantRule_arg1_1 =
  (match _lh_constantRule_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and
enumFromThenTo_lh__d0 a_5 t_6 b_2 =
  (if (a_5 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_4 = (((enumFromThenTo_lh__d0 t_6) ((2 * t_6) - a_5)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_5 in
        (fun _lh_listcomp_fun_7 _lh_numericRule_LH_C_1_3 width_1 -> 
          (let rec _lh_listcomp_fun_8 = (fun _lh_listcomp_fun_para_4 -> 
            (match _lh_listcomp_fun_para_4 with
              | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_5) -> 
                (`LH_C(((mappend_lh__d1 ((pad_lh__d0 (string_of_int _lh_listcomp_fun_ls_h_3)) width_1)) _lh_listcomp_fun_ls_h_4), (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_5)))
              | `LH_N -> 
                (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_4))) in
            (_lh_listcomp_fun_8 (expand_lh__d0 _lh_numericRule_LH_C_1_3))))))
  else
    (fun _lh_listcomp_fun_9 _lh_numericRule_LH_C_1_4 width_2 -> 
      (`LH_N)))
and
enumFromTo_lh__d0 a_7 b_4 =
  (if (a_7 <= b_4) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d0 (a_7 + 1)) b_4) in
      (let rec _lh_listcomp_fun_ls_h_7 = a_7 in
        (fun _lh_alphabeticRule_LH_C_1_5 _lh_listcomp_fun_1_5 -> 
          (let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_8 -> 
            ...
            (_lh_listcomp_fun_1_6 (expand_lh__d0 _lh_alphabeticRule_LH_C_1_5))))))
  else
    (fun _lh_alphabeticRule_LH_C_1_6 _lh_listcomp_fun_1_7 -> 
      (`LH_N)))
and
enumFromTo_lh__d1 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec t_0 = ((enumFromTo_lh__d1 (a_0 + 1)) b_0) in
      (let rec h_0 = a_0 in
        (fun a_1 -> 
          ((reverse_helper_lh__d0 t_0) (let rec _lh_listcomp_fun_ls_t_0 = a_1 in
    ...
    (fun a_2 -> 
      a_2))
and
enumFromTo_lh__d2 a_6 b_3 =
  (if (a_6 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_6 = ((enumFromTo_lh__d2 (a_6 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_6 in
        (fun _lh_listcomp_fun_1_2 _lh_numericRule_LH_C_1_5 width_3 -> 
          (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_7 -> 
            (match _lh_listcomp_fun_para_7 with
              | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_7) -> 
                (`LH_C(((mappend_lh__d1 ((pad_lh__d0 (string_of_int _lh_listcomp_fun_ls_h_5)) width_3)) _lh_listcomp_fun_ls_h_6), (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_7)))
              | `LH_N -> 
                (_lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_6))) in
            (_lh_listcomp_fun_1_3 (expand_lh__d0 _lh_numericRule_LH_C_1_5))))))
  else
    (fun _lh_listcomp_fun_1_4 _lh_numericRule_LH_C_1_6 width_4 -> 
      (`LH_N)))
and

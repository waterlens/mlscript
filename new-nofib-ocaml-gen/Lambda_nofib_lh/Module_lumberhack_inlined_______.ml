...
ppn_lh__d1 _lh_ppn_arg1_1 _lh_ppn_arg2_1 =
  (match _lh_ppn_arg2_1 with
    ...
    | `Add(_lh_ppn_Add_0_1, _lh_ppn_Add_1_1) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_1) 1) (((mappend_lh__d2_d5 ((ppn_lh__d1 1) _lh_ppn_Add_0_1)) (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (fun ys_4_2 -> 
        ys_4_2) in
        (let rec h_3_4 = ' ' in
          (fun ys_4_3 -> 
            (`LH_C(h_3_4, (t_3_7 ys_4_3)))))) in
        (let rec h_3_5 = '+' in
          (fun ys_4_4 -> 
            (`LH_C(h_3_5, (t_3_6 ys_4_4)))))) in
        (let rec h_3_6 = ' ' in
          (fun ys_4_5 -> 
            (`LH_C(h_3_6, (t_3_5 ys_4_5))))))) ((ppn_lh__d1 1) _lh_ppn_Add_1_1)))
...
let rec ppenv_lh__d1 _lh_ppenv_arg1_0 =
  ((mappend_lh__d1_d7 ((let rec t_2_2 = (fun ys_2_5 -> 
    ys_2_5) in
    (let rec h_2_1 = '[' in
      (fun ys_2_6 -> 
        (`LH_C(h_2_1, (t_2_2 ys_2_6)))))) ((flatMap_lh__d1 (fun vt_0 -> 
    (let rec _lh_matchIdent_3 = vt_0 in
      (match _lh_matchIdent_3 with
        | `LH_P2(_lh_ppenv_LH_P2_0_0, _lh_ppenv_LH_P2_1_0) -> 
          ((mappend_lh__d1_d8 (((mappend_lh__d2_d0 _lh_ppenv_LH_P2_0_0) (let rec t_2_3 = (fun ys_2_7 -> 
            ys_2_7) in
            (let rec h_2_2 = '=' in
              (fun ys_2_8 -> 
                (`LH_C(h_2_2, (t_2_3 ys_2_8))))))) (pp_lh__d8 _lh_ppenv_LH_P2_1_0))) (`LH_C(',', (`LH_C(' ', (`LH_N))))))
        | _ -> 
...
let rec myBind_lh__d1 _lh_myBind_arg1_0 _lh_myBind_arg2_0 =
  (let rec _lh_myRunState_MyState_0_1 = (fun s_1 -> 
    (let rec _lh_matchIdent_6 = (_lh_myBind_arg1_0 s_1) in
      (match _lh_matchIdent_6 with
        | `LH_P2(_lh_myBind_LH_P2_0_0, _lh_myBind_LH_P2_1_0) -> 
          ((_lh_myBind_arg2_0 _lh_myBind_LH_P2_1_0) _lh_myBind_LH_P2_0_0)
        | _ -> 
          (failwith "error")))) in
...
let rec lookupVar_lh__d1 _lh_lookupVar_arg1_0 =
  (let rec lookup2_0 = (fun env_0 -> 
    ((((lookup_lh__d1 _lh_lookupVar_arg1_0) env_0) (fun _dummy_0 -> 
...
let rec myEvalState_lh__d1 _lh_myEvalState_arg1_0 _lh_myEvalState_arg2_0 =
  (let rec _lh_matchIdent_1 = (_lh_myEvalState_arg1_0 _lh_myEvalState_arg2_0) in
    ...
    | `LH_C(h_2_4, t_2_5) -> 
      (let rec t_2_6 = ((mappend_lh__d6 t_2_5) ys_3_0) in
        (let rec h_2_5 = h_2_4 in
          (fun ys_3_1 -> 
            (`LH_C(h_2_5, (t_2_6 ys_3_1))))))
    | `LH_N -> 
      ys_3_0);;
let rec ev_lh__d1 _lh_ev_arg1_0 =
  (let rec envt2_0 = ((traverseTerm_lh__d1 _lh_ev_arg1_0) (`LH_N)) in
    (let rec _lh_matchIdent_5 = envt2_0 in
      (match _lh_matchIdent_5 with
        | `LH_P2(_lh_ev_LH_P2_0_0, _lh_ev_LH_P2_1_0) -> 
          (((mappend_lh__d6 (pp_lh__d3 _lh_ev_LH_P2_1_0)) (let rec t_3_1 = (let rec t_3_2 = (fun ys_3_7 -> 
            ys_3_7) in
            (let rec h_3_0 = ' ' in
              (fun ys_3_8 -> 
                (`LH_C(h_3_0, (t_3_2 ys_3_8)))))) in
            (let rec h_3_1 = ' ' in
              (fun ys_3_9 -> 
                (`LH_C(h_3_1, (t_3_1 ys_3_9))))))) (ppenv_lh__d1 _lh_ev_LH_P2_0_0))
        | _ -> 
          (failwith "error"))));;
...
let rec showTerm_lh__d2 _lh_showTerm_arg1_1 =
  (match _lh_showTerm_arg1_1 with
    | `Con(_lh_showTerm_Con_0_1) -> 
      ((let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (fun ys_2_0 -> 
        ys_2_0) in
        (let rec h_1_7 = ' ' in
          (fun ys_2_1 -> 
        ...
        (let rec h_1_8 = 'n' in
          (fun ys_2_2 -> 
            (`LH_C(h_1_8, (t_2_0 ys_2_2)))))) in
        (let rec h_1_9 = 'o' in
          (fun ys_2_3 -> 
            (`LH_C(h_1_9, (t_1_9 ys_2_3)))))) in
        (let rec h_2_0 = 'C' in
          (fun ys_2_4 -> 
            (`LH_C(h_2_0, (t_1_8 ys_2_4)))))) (string_of_int _lh_showTerm_Con_0_1))
    | _ -> 
      ((failwith "error") (`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;
...
simpleEval_lh__d1 _lh_simpleEval_arg1_0 _lh_simpleEval_arg2_0 =
  (match _lh_simpleEval_arg2_0 with
    | `Var(_lh_simpleEval_Var_0_0) -> 
      ((simpleEval_lh__d1 _lh_simpleEval_arg1_0) ((((lookup_lh__d1 _lh_simpleEval_Var_0_0) _lh_simpleEval_arg1_0) (fun _dummy_1 -> 
...
let rec showTerm_lh__d1 _lh_showTerm_arg1_0 =
  (match _lh_showTerm_arg1_0 with
    | `Con(_lh_showTerm_Con_0_0) -> 
      ((let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (fun ys_1_0 -> 
        ys_1_0) in
        (let rec h_9 = ' ' in
          (fun ys_1_1 -> 
            (`LH_C(h_9, (t_1_2 ys_1_1)))))) in
        (let rec h_1_0 = 'n' in
          (fun ys_1_2 -> 
            (`LH_C(h_1_0, (t_1_1 ys_1_2)))))) in
        (let rec h_1_1 = 'o' in
          (fun ys_1_3 -> 
            (`LH_C(h_1_1, (t_1_0 ys_1_3)))))) in
        (let rec h_1_2 = 'C' in
          (fun ys_1_4 -> 
            (`LH_C(h_1_2, (t_9 ys_1_4)))))) (string_of_int _lh_showTerm_Con_0_0))
    | _ -> 
      ((failwith "error") (`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;
let rec lfxx_lh__d2 =
  (`Lam((`LH_C('x', (`LH_N))), (`App((`Var((`LH_C('F', (`LH_N))))), (`App((`Var((`LH_C('x', (`LH_N))))), (`Var((`LH_C('x', (`LH_N)))))))))));;

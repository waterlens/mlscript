...
let rec copy_lz_lh__d1 _lh_copy_lz_arg1_1 _lh_copy_lz_arg2_1 =
  (if (_lh_copy_lz_arg1_1 > 0) then
    ...
    (lazy (`LH_N)));;
let rec take_lz_lh__d1 n_2 ls_2_8 =
  (if (n_2 > 0) then
    (match (Lazy.force ls_2_8) with
      | `LH_C(h_2_9, t_2_9) -> 
        (`LH_C(h_2_9, ((take_lz_lh__d1 (n_2 - 1)) t_2_9)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec append__lz_lh__d1 _lh_append__lz_arg1_1 _lh_append__lz_arg2_1 =
  (let rec _lh_matchIdent_2_1 = _lh_append__lz_arg1_1 in
...
let rec map_lh__d3 f_2_5 ls_2_7 =
  (match ls_2_7 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec inports_lh__d1 _lh_inports_arg1_4 =
      ...
      and get_output_0 = (fun _lh_get_output_arg1_0 _lh_get_output_arg2_0 -> 
        (match _lh_get_output_arg2_0 with
          | `LH_P2(_lh_get_output_LH_P2_0_0, _lh_get_output_LH_P2_1_0) -> 
            (third_0 (head_lh__d1 (let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_1_4 -> 
              (match _lh_listcomp_fun_para_1_4 with
                | `LH_C(_lh_listcomp_fun_ls_h_1_4, _lh_listcomp_fun_ls_t_1_4) -> 
                  (if (_lh_get_output_LH_P2_1_0 = (pid_lh__d1 _lh_listcomp_fun_ls_h_1_4)) then
                    (`LH_C((head_lh__d2 (inports_lh__d1 _lh_listcomp_fun_ls_h_1_4)), (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_4)))
                  else
                    (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_4))
                | `LH_N -> 
                  (`LH_N))) in
              (_lh_listcomp_fun_1_4 _lh_get_output_arg1_0))))
          | _ -> 
            (failwith "error")))
...
let rec inports_lh__d3 _lh_inports_arg1_2 =
  (match _lh_inports_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compType_lh__d3 _lh_compType_arg1_1 =
...
let rec pathDepth_lh__d4 _lh_pathDepth_arg1_4 =
  (match _lh_pathDepth_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compType_lh__d4 _lh_compType_arg1_0 =
...
let rec outports_lh__d9 _lh_outports_arg1_0 =
  (match _lh_outports_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec inports_lh__d5 _lh_inports_arg1_0 =
  (match _lh_inports_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec pathDepth_lh__d8 _lh_pathDepth_arg1_0 =
...
let rec update_outports_lh__d3 _lh_update_outports_arg1_0 _lh_update_outports_arg2_0 =
  ((updateOutports_lh__d5 _lh_update_outports_arg1_0) (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_6 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_6) -> 
        (match _lh_listcomp_fun_ls_h_6 with
          | `LH_P6(_lh_update_outports_LH_P6_0_0, _lh_update_outports_LH_P6_1_0, _lh_update_outports_LH_P6_2_0, _lh_update_outports_LH_P6_3_0, _lh_update_outports_LH_P6_4_0, _lh_update_outports_LH_P6_5_0) -> 
            (`LH_C((`LH_P6(_lh_update_outports_LH_P6_0_0, _lh_update_outports_arg2_0, _lh_update_outports_LH_P6_2_0, _lh_update_outports_LH_P6_3_0, _lh_update_outports_LH_P6_4_0, _lh_update_outports_LH_P6_5_0)), (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6)))
          | _ -> 
            (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_6 (outports_lh__d9 _lh_update_outports_arg1_0))));;
let rec inports_lh__d4 _lh_inports_arg1_1 =
...
let rec simulate_component_lh__d1 _lh_simulate_component_arg1_0 _lh_simulate_component_arg2_0 =
  (let rec out_signals_0 = (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_1_1 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_1_1, _lh_listcomp_fun_ls_t_1_1) -> 
        (match _lh_listcomp_fun_ls_h_1_1 with
          | `LH_P3(_lh_simulate_component_LH_P3_0_0, _lh_simulate_component_LH_P3_1_0, _lh_simulate_component_LH_P3_2_0) -> 
            (`LH_C(_lh_simulate_component_LH_P3_2_0, (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_1_1)))
          | _ -> 
            (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_1_1))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_1 (inports_lh__d4 _lh_simulate_component_arg2_0))) in
    (let rec new_value_0 = ((apply_component_lh__d1 (compType_lh__d4 _lh_simulate_component_arg2_0)) out_signals_0) in
      (if ((_lh_simulate_component_arg1_0 = (pathDepth_lh__d4 _lh_simulate_component_arg2_0)) && (not (new_value_0 = (`Nothing)))) then
        (let rec _lh_matchIdent_1_9 = new_value_0 in
...
let rec map_lh__d7 f_1_8 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_1_9, t_1_9) -> 
      (`LH_C((f_1_8 h_1_9), ((map_lh__d7 f_1_8) t_1_9)))
    | `LH_N -> 
      (`LH_N));;
...
let rec foldr_lh__d1 f_1 i_0 ls_1 =
  (match ls_1 with
    ...
    | `LH_N -> 
      i_0);;
let rec unzip_lh__d3 _lh_unzip_arg1_0 =
...
let rec combine_lh__d3 _lh_combine_arg1_0 _lh_combine_arg2_0 _lh_combine_arg3_0 _lh_combine_arg4_0 =
  (`LH_C((`LH_C(_lh_combine_arg1_0, _lh_combine_arg2_0)), (transpose_lh__d3 (`LH_C(_lh_combine_arg3_0, _lh_combine_arg4_0)))))
and
transpose_lh__d3 _lh_transpose_arg1_1 =
    ...
    | `LH_C(_lh_transpose_LH_C_0_3, _lh_transpose_LH_C_1_3) -> 
      (match _lh_transpose_LH_C_0_3 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_4, _lh_transpose_LH_C_1_4) -> 
          (let rec _lh_matchIdent_1_6 = (unzip_lh__d3 (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
...
let rec transpose_lh__d4 _lh_transpose_arg1_0 =
  (match _lh_transpose_arg1_0 with
    ...
    | `LH_C(_lh_transpose_LH_C_0_0, _lh_transpose_LH_C_1_0) -> 
      (match _lh_transpose_LH_C_0_0 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_1, _lh_transpose_LH_C_1_1) -> 
          (let rec _lh_matchIdent_1_5 = (unzip_lh__d3 (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1_d8 f_6 ls_7 =
  (match ls_7 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C((f_6 h_7), ((map_lh__d1_d8 f_6) t_7)))
    | `LH_N -> 
      (`LH_N));;
let rec update_requests_lh__d3 _lh_update_requests_arg1_0 _lh_update_requests_arg2_0 =
...
let rec check_depth_lh__d4 _lh_check_depth_arg1_0 _lh_check_depth_arg2_0 =
  (if ((pathDepth_lh__d8 _lh_check_depth_arg2_0) = _lh_check_depth_arg1_0) then
    _lh_check_depth_arg2_0
  else
    ((update_requests_lh__d3 false) _lh_check_depth_arg2_0));;
let rec map_lh__d1_d7 f_7 ls_8 =
  (match ls_8 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C((f_7 h_8), ((map_lh__d1_d7 f_7) t_8)))
    | `LH_N -> 
      (`LH_N));;
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
        (match _lh_listcomp_fun_ls_h_4 with
          | `LH_P6(_lh_make_packet_LH_P6_0_0, _lh_make_packet_LH_P6_1_0, _lh_make_packet_LH_P6_2_0, _lh_make_packet_LH_P6_3_0, _lh_make_packet_LH_P6_4_0, _lh_make_packet_LH_P6_5_0) -> 
            (`LH_C((`LH_P8((pid_lh__d4 _lh_make_packet_arg1_0), _lh_make_packet_LH_P6_0_0, _lh_make_packet_LH_P6_1_0, _lh_make_packet_LH_P6_2_0, _lh_make_packet_LH_P6_3_0, _lh_make_packet_LH_P6_4_0, _lh_make_packet_LH_P6_5_0, 1)), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4)))
          | _ -> 
            (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_4 (outports_lh__d9 _lh_make_packet_arg1_0)));;
...
let rec compare_and_update_lh__d1 _lh_compare_and_update_arg1_0 _lh_compare_and_update_arg2_0 =
  (match _lh_compare_and_update_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d2_d1 f_2 ls_4 =
  (match ls_4 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C((f_2 h_4), ((map_lh__d2_d1 f_2) t_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec update_o_lh__d1 _lh_update_o_arg1_0 _lh_update_o_arg2_0 =
  (match _lh_update_o_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec zipWith_lh__d5 f_0 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(hx_0, tx_0) -> 
      (match ys_0 with
        | `LH_C(hy_0, ty_0) -> 
          (`LH_C(((f_0 hx_0) hy_0), (((zipWith_lh__d5 f_0) tx_0) ty_0)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d1_d9 f_5 ls_6 =
  (match ls_6 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C((f_5 h_6), ((map_lh__d1_d9 f_5) t_6)))
    | `LH_N -> 
      (`LH_N));;
let rec zipWith_lh__d4 f_4 xs_2 ys_1 =
  (match xs_2 with
    | `LH_C(hx_1, tx_1) -> 
      (match ys_1 with
        | `LH_C(hy_1, ty_1) -> 
          (`LH_C(((f_4 hx_1) hy_1), (((zipWith_lh__d4 f_4) tx_1) ty_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec length_lh__d1 ls_3 =
  (match ls_3 with
    ...
    | `LH_N -> 
      0);;
let rec take_lz_lh__d2 n_1 ls_2 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_2) with
      | `LH_C(h_2, t_2) -> 
        (`LH_C(h_2, ((take_lz_lh__d2 (n_1 - 1)) t_2)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec pad_packets_lh__d2 _lh_pad_packets_arg1_0 =
  (let rec pad_0 = (fun xs_1 -> 
    (let rec max_ps_0 = (maximum_lh__d2 ((map_lh__d2_d1 length_lh__d1) _lh_pad_packets_arg1_0)) in
      ((take_lz_lh__d2 max_ps_0) ((append__lz_lh__d2 xs_1) ((copy_lz_lh__d2 max_ps_0) emptyPacket_lh__d3))))) in
...
let rec scanlr_lh__d1 _lh_scanlr_arg1_0 _lh_scanlr_arg2_0 _lh_scanlr_arg3_0 _lh_scanlr_arg4_0 _lh_scanlr_arg5_0 =
  ...
  in (let rec xs'_0 = ((map_lh__d2_d1 (fun x_0 -> 
    ...
    (let rec _lh_matchIdent_1_4 = ((((sweep_ud_lh__d1 ((up_0 _lh_scanlr_arg1_0) _lh_scanlr_arg2_0)) ((down_0 _lh_scanlr_arg1_0) _lh_scanlr_arg2_0)) (`LH_P2(_lh_scanlr_arg3_0, _lh_scanlr_arg4_0))) (put_lh__d1 xs'_0)) in
...
let rec do_send_lh__d2 _lh_do_send_arg1_0 _lh_do_send_arg2_0 =
  (let rec states1_0 = ((map_lh__d1_d7 (check_depth_lh__d4 _lh_do_send_arg1_0)) _lh_do_send_arg2_0) in
    (let rec send_results_0 = ((map_lh__d1_d9 (fun _lh_funcomp_x_0 -> 
      (snd_lh__d2 (send_lh__d2 _lh_funcomp_x_0)))) ((fun _lh_funcomp_x_1 -> 
      (transpose_lh__d3 (pad_packets_lh__d2 _lh_funcomp_x_1))) ((map_lh__d1_d8 make_packet_lh__d2) states1_0))) in
...
let rec map_lh__d1_d5 f_9 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C((f_9 h_1_0), ((map_lh__d1_d5 f_9) t_1_0)))
    | `LH_N -> 
      (`LH_N));;
...
let rec or_lh__d4 _lh_or_arg1_0 =
  (match _lh_or_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1_d4 f_1_0 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C((f_1_0 h_1_1), ((map_lh__d1_d4 f_1_0) t_1_1)))
    | `LH_N -> 
      (`LH_N));;
let rec check_depth_lh__d3 _lh_check_depth_arg1_1 _lh_check_depth_arg2_1 =
  (if ((pathDepth_lh__d8 _lh_check_depth_arg2_1) = _lh_check_depth_arg1_1) then
    ...
    ((update_requests_lh__d3 false) _lh_check_depth_arg2_1));;
let rec map_lh__d1_d6 f_8 ls_9 =
  (match ls_9 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_8 h_9), ((map_lh__d1_d6 f_8) t_9)))
    | `LH_N -> 
      (`LH_N));;
let rec acknowledge_lh__d2 _lh_acknowledge_arg1_0 _lh_acknowledge_arg2_0 =
  ...
  and check_requests_0 = (fun _lh_check_requests_arg1_0 -> 
    (or_lh__d4 ((map_lh__d1_d6 check_lr_requests_0) _lh_check_requests_arg1_0)))
  in (let rec states1_1 = ((map_lh__d1_d5 (check_depth_lh__d3 _lh_acknowledge_arg1_0)) _lh_acknowledge_arg2_0) in
    (not (or_lh__d3 ((map_lh__d1_d4 (fun _lh_funcomp_x_2 -> 
      (check_requests_0 (outports_lh__d5 _lh_funcomp_x_2)))) states1_1))));;
...
let rec or_lh__d2 _lh_or_arg1_2 =
  (match _lh_or_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1_d0 f_1_5 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_1_5, t_1_5) -> 
      (`LH_C((f_1_5 h_1_5), ((map_lh__d1_d0 f_1_5) t_1_5)))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d8 f_1_7 ls_1_7 =
  (match ls_1_7 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d9 f_1_6 ls_1_6 =
  (match ls_1_6 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C((f_1_6 h_1_6), ((map_lh__d9 f_1_6) t_1_6)))
    | `LH_N -> 
      (`LH_N));;
let rec pathDepth_lh__d5 _lh_pathDepth_arg1_3 =
...
let rec update_requests_lh__d1 _lh_update_requests_arg1_2 _lh_update_requests_arg2_2 =
  ((updateOutports_lh__d5 _lh_update_requests_arg2_2) (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
        (match _lh_listcomp_fun_ls_h_2 with
          | `LH_P6(_lh_update_requests_LH_P6_0_2, _lh_update_requests_LH_P6_1_2, _lh_update_requests_LH_P6_2_2, _lh_update_requests_LH_P6_3_2, _lh_update_requests_LH_P6_4_2, _lh_update_requests_LH_P6_5_2) -> 
            (`LH_C((`LH_P6(_lh_update_requests_LH_P6_0_2, _lh_update_requests_LH_P6_1_2, _lh_update_requests_arg1_2, _lh_update_requests_LH_P6_3_2, _lh_update_requests_arg1_2, _lh_update_requests_LH_P6_5_2)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
          | _ -> 
            (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_2 (outports_lh__d9 _lh_update_requests_arg2_2))));;
let rec check_depth_lh__d1 _lh_check_depth_arg1_3 _lh_check_depth_arg2_3 =
  (if ((pathDepth_lh__d5 _lh_check_depth_arg2_3) = _lh_check_depth_arg1_3) then
...
let rec acknowledge_lh__d1 _lh_acknowledge_arg1_1 _lh_acknowledge_arg2_1 =
  let rec check_requests_1 = (fun _lh_check_requests_arg1_1 -> 
    (or_lh__d2 ((map_lh__d8 check_lr_requests_1) _lh_check_requests_arg1_1)))
  and check_lr_requests_1 = (fun _lh_check_lr_requests_arg1_1 -> 
    (match _lh_check_lr_requests_arg1_1 with
      ...
      | _ -> 
        (failwith "error")))
  in (let rec states1_3 = ((map_lh__d1_d0 (check_depth_lh__d1 _lh_acknowledge_arg1_1)) _lh_acknowledge_arg2_1) in
    (not (or_lh__d1 ((map_lh__d9 (fun _lh_funcomp_x_5 -> 
      (check_requests_1 (outports_lh__d4 _lh_funcomp_x_5)))) states1_3))));;
let rec map_lh__d1_d1 f_1_4 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_1_4, t_1_4) -> 
      (`LH_C((f_1_4 h_1_4), ((map_lh__d1_d1 f_1_4) t_1_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec updateOutports_lh__d4 _lh_updateOutports_arg1_1 _lh_updateOutports_arg2_1 =
  (`PS((pid_lh__d4 _lh_updateOutports_arg1_1), (compType_lh__d4 _lh_updateOutports_arg1_1), (pathDepth_lh__d8 _lh_updateOutports_arg1_1), (inports_lh__d5 _lh_updateOutports_arg1_1), _lh_updateOutports_arg2_1));;
let rec outports_lh__d8 _lh_outports_arg1_1 =
  (match _lh_outports_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec pathDepth_lh__d6 _lh_pathDepth_arg1_2 =
...
let rec pathDepth_lh__d7 _lh_pathDepth_arg1_1 =
  (match _lh_pathDepth_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec update_requests_lh__d2 _lh_update_requests_arg1_1 _lh_update_requests_arg2_1 =
  ((updateOutports_lh__d5 _lh_update_requests_arg2_1) (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
    (match _lh_listcomp_fun_para_1 with
      ...
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1 (outports_lh__d9 _lh_update_requests_arg2_1))));;
...
let rec map_lh__d1_d2 f_1_3 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C((f_1_3 h_1_3), ((map_lh__d1_d2 f_1_3) t_1_3)))
    | `LH_N -> 
      (`LH_N));;
let rec zipWith_lh__d3 f_1_2 xs_3 ys_2 =
  (match xs_3 with
    | `LH_C(hx_2, tx_2) -> 
      (match ys_2 with
        | `LH_C(hy_2, ty_2) -> 
          (`LH_C(((f_1_2 hx_2) hy_2), (((zipWith_lh__d3 f_1_2) tx_2) ty_2)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec unzip_lh__d2 _lh_unzip_arg1_1 =
  (((foldr_lh__d1 (fun ab_1 asbs_1 -> 
    (let rec _lh_matchIdent_9 = ab_1 in
      (match _lh_matchIdent_9 with
        | `LH_P2(_lh_unzip_LH_P2_0_2, _lh_unzip_LH_P2_1_2) -> 
          (let rec _lh_matchIdent_1_0 = asbs_1 in
...
let rec combine_lh__d2 _lh_combine_arg1_1 _lh_combine_arg2_1 _lh_combine_arg3_1 _lh_combine_arg4_1 =
  (`LH_C((`LH_C(_lh_combine_arg1_1, _lh_combine_arg2_1)), (transpose_lh__d2 (`LH_C(_lh_combine_arg3_1, _lh_combine_arg4_1)))))
and
transpose_lh__d2 _lh_transpose_arg1_2 =
  (match _lh_transpose_arg1_2 with
    ...
    | `LH_C(_lh_transpose_LH_C_0_6, _lh_transpose_LH_C_1_6) -> 
      (match _lh_transpose_LH_C_0_6 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_7, _lh_transpose_LH_C_1_7) -> 
          (let rec _lh_matchIdent_1_7 = (unzip_lh__d2 (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_7 -> 
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
                (match _lh_listcomp_fun_ls_h_7 with
                  | `LH_C(_lh_transpose_LH_C_0_8, _lh_transpose_LH_C_1_8) -> 
                    (`LH_C((`LH_P2(_lh_transpose_LH_C_0_8, _lh_transpose_LH_C_1_8)), (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_7)))
                  | _ -> 
                    (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_7))
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_7 _lh_transpose_LH_C_1_6))) in
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d2_d0 f_3 ls_5 =
  (match ls_5 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C((f_3 h_5), ((map_lh__d2_d0 f_3) t_5)))
    | `LH_N -> 
      (`LH_N));;
let rec pad_packets_lh__d1 _lh_pad_packets_arg1_1 =
  (let rec pad_1 = (fun xs_4 -> 
    (let rec max_ps_1 = (maximum_lh__d2 ((map_lh__d2_d1 length_lh__d1) _lh_pad_packets_arg1_1)) in
      ((take_lz_lh__d2 max_ps_1) ((append__lz_lh__d2 xs_4) ((copy_lz_lh__d2 max_ps_1) emptyPacket_lh__d3))))) in
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_8, _lh_listcomp_fun_ls_t_8) -> 
        (match _lh_listcomp_fun_ls_h_8 with
          | `LH_P6(_lh_make_packet_LH_P6_0_1, _lh_make_packet_LH_P6_1_1, _lh_make_packet_LH_P6_2_1, _lh_make_packet_LH_P6_3_1, _lh_make_packet_LH_P6_4_1, _lh_make_packet_LH_P6_5_1) -> 
            (`LH_C((`LH_P8((pid_lh__d4 _lh_make_packet_arg1_1), _lh_make_packet_LH_P6_0_1, _lh_make_packet_LH_P6_1_1, _lh_make_packet_LH_P6_2_1, _lh_make_packet_LH_P6_3_1, _lh_make_packet_LH_P6_4_1, _lh_make_packet_LH_P6_5_1, 1)), (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_8)))
          | _ -> 
            (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_8))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_8 (outports_lh__d7 _lh_make_packet_arg1_1)));;
let rec unzip_lh__d1 _lh_unzip_arg1_2 =
  (((foldr_lh__d1 (fun ab_2 asbs_2 -> 
    (let rec _lh_matchIdent_1_2 = ab_2 in
      (match _lh_matchIdent_1_2 with
        | `LH_P2(_lh_unzip_LH_P2_0_4, _lh_unzip_LH_P2_1_4) -> 
          (let rec _lh_matchIdent_1_3 = asbs_2 in
...
let rec combine_lh__d1 _lh_combine_arg1_2 _lh_combine_arg2_2 _lh_combine_arg3_2 _lh_combine_arg4_2 =
  (`LH_C((`LH_C(_lh_combine_arg1_2, _lh_combine_arg2_2)), (transpose_lh__d1 (`LH_C(_lh_combine_arg3_2, _lh_combine_arg4_2)))))
and
    ...
    | `LH_C(_lh_transpose_LH_C_0_9, _lh_transpose_LH_C_1_9) -> 
      (match _lh_transpose_LH_C_0_9 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_1_0, _lh_transpose_LH_C_1_1_0) -> 
          (let rec _lh_matchIdent_1_8 = (unzip_lh__d1 (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_9 -> 
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_9, _lh_listcomp_fun_ls_t_9) -> 
                (match _lh_listcomp_fun_ls_h_9 with
                  | `LH_C(_lh_transpose_LH_C_0_1_1, _lh_transpose_LH_C_1_1_1) -> 
                    (`LH_C((`LH_P2(_lh_transpose_LH_C_0_1_1, _lh_transpose_LH_C_1_1_1)), (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9)))
                  | _ -> 
                    (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9))
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_9 _lh_transpose_LH_C_1_9))) in
...
let rec do_send_lh__d1 _lh_do_send_arg1_1 _lh_do_send_arg2_1 =
  (let rec states1_2 = ((map_lh__d1_d1 (check_depth_lh__d2 _lh_do_send_arg1_1)) _lh_do_send_arg2_1) in
    (let rec send_results_1 = ((map_lh__d1_d2 (fun _lh_funcomp_x_3 -> 
      (snd_lh__d1 (send_lh__d1 _lh_funcomp_x_3)))) ((fun _lh_funcomp_x_4 -> 
      (transpose_lh__d1 (pad_packets_lh__d1 _lh_funcomp_x_4))) ((map_lh__d1_d3 make_packet_lh__d1) states1_2))) in
...
let rec map_lh__d6 f_2_2 ls_2_1 =
  (match ls_2_1 with
    | `LH_C(h_2_1, t_2_1) -> 
      (`LH_C((f_2_2 h_2_1), ((map_lh__d6 f_2_2) t_2_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec update_outports_lh__d2 _lh_update_outports_arg1_1 _lh_update_outports_arg2_1 =
  ((updateOutports_lh__d3 _lh_update_outports_arg1_1) (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_1_0 -> 
    (match _lh_listcomp_fun_para_1_0 with
      ...
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_0 (outports_lh__d6 _lh_update_outports_arg1_1))));;
  ...
  (match _lh_store_inputs_arg2_0 with
    | `PS(_lh_store_inputs_PS_0_0, _lh_store_inputs_PS_1_0, _lh_store_inputs_PS_2_0, _lh_store_inputs_PS_3_0, _lh_store_inputs_PS_4_0) -> 
      (match _lh_store_inputs_PS_1_0 with
        | `Inp -> 
          (head_lh__d3 (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_1_2 -> 
            (match _lh_listcomp_fun_para_1_2 with
                    ...
                    (match _lh_store_inputs_LH_P2_0_0 with
                      | `LH_P2(_lh_store_inputs_LH_P2_0_1, _lh_store_inputs_LH_P2_1_1) -> 
                        (if (_lh_store_inputs_PS_0_0 = _lh_store_inputs_LH_P2_1_1) then
                          (`LH_C(((update_outports_lh__d2 (`PS(_lh_store_inputs_PS_0_0, (`Inp), _lh_store_inputs_PS_2_0, _lh_store_inputs_PS_3_0, _lh_store_inputs_PS_4_0))) _lh_store_inputs_LH_P2_1_0), (_lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_1_2)))
                        else
              ...
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_1_2 _lh_store_inputs_arg1_0)))
        | _ -> 
          _lh_store_inputs_arg2_0)
    | _ -> 
      _lh_store_inputs_arg2_0);;
let rec foldl_lh__d1 f_2_1 i_1 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_0, t_2_0) -> 
      (((foldl_lh__d1 f_2_1) ((f_2_1 i_1) h_2_0)) t_2_0)
    | `LH_N -> 
      i_1);;
  ...
  (match _lh_do_cycle_arg2_0 with
    | `LH_P4(_lh_do_cycle_LH_P4_0_0, _lh_do_cycle_LH_P4_1_0, _lh_do_cycle_LH_P4_2_0, _lh_do_cycle_LH_P4_3_0) -> 
      (let rec sim_then_send_0 = (fun _lh_sim_then_send_arg1_0 _lh_sim_then_send_arg2_0 -> 
        ...
        (let rec states1_4 = ((map_lh__d6 (store_inputs_lh__d1 ((zip_lh__d1 _lh_do_cycle_LH_P4_1_0) _lh_do_cycle_arg3_0))) _lh_do_cycle_LH_P4_3_0) in
...
let rec pathDepth_lh__d2 _lh_pathDepth_arg1_6 =
  (match _lh_pathDepth_arg1_6 with
    ...
    | _ -> 
      (failwith "error"));;
let rec inports_lh__d2 _lh_inports_arg1_3 =
  (match _lh_inports_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compType_lh__d2 _lh_compType_arg1_2 =
...
let rec update_outports_lh__d1 _lh_update_outports_arg1_2 _lh_update_outports_arg2_2 =
  ((updateOutports_lh__d1 _lh_update_outports_arg1_2) (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_1_3 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_1_3, _lh_listcomp_fun_ls_t_1_3) -> 
        (match _lh_listcomp_fun_ls_h_1_3 with
          | `LH_P6(_lh_update_outports_LH_P6_0_2, _lh_update_outports_LH_P6_1_2, _lh_update_outports_LH_P6_2_2, _lh_update_outports_LH_P6_3_2, _lh_update_outports_LH_P6_4_2, _lh_update_outports_LH_P6_5_2) -> 
            (`LH_C((`LH_P6(_lh_update_outports_LH_P6_0_2, _lh_update_outports_arg2_2, _lh_update_outports_LH_P6_2_2, _lh_update_outports_LH_P6_3_2, _lh_update_outports_LH_P6_4_2, _lh_update_outports_LH_P6_5_2)), (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_1_3)))
          | _ -> 
            (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_1_3))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_3 (outports_lh__d1 _lh_update_outports_arg1_2))));;
let rec compType_lh__d1 _lh_compType_arg1_3 =
...
let rec tail_lh__d1 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_2_3, t_2_3) -> 
      t_2_3
    | `LH_N -> 
      (failwith "error"));;
let rec map_lh__d4 f_2_4 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C((f_2_4 h_2_4), ((map_lh__d4 f_2_4) t_2_4)))
    | `LH_N -> 
      (`LH_N));;
let rec scanl_lh__d1 _lh_scanl_arg1_0 _lh_scanl_arg2_0 _lh_scanl_arg3_0 =
  (`LH_C(_lh_scanl_arg2_0, (let rec _lh_matchIdent_2_0 = _lh_scanl_arg3_0 in
    (match _lh_matchIdent_2_0 with
      ...
      | _ -> 
        (failwith "error")))));;
let rec map_lh__d5 f_2_3 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_2_2, t_2_2) -> 
      (`LH_C((f_2_3 h_2_2), ((map_lh__d5 f_2_3) t_2_2)))
    | `LH_N -> 
      (`LH_N));;
let rec maximum_lh__d1 _lh_maximum_arg1_1 =
  (match _lh_maximum_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec pathDepth_lh__d1 _lh_pathDepth_arg1_7 =
...
let rec critical_path_depth_lh__d1 _lh_critical_path_depth_arg1_0 =
  (match _lh_critical_path_depth_arg1_0 with
    | `LH_P4(_lh_critical_path_depth_LH_P4_0_0, _lh_critical_path_depth_LH_P4_1_0, _lh_critical_path_depth_LH_P4_2_0, _lh_critical_path_depth_LH_P4_3_0) -> 
      (maximum_lh__d1 ((map_lh__d5 pathDepth_lh__d1) _lh_critical_path_depth_LH_P4_3_0))
    | _ -> 
      (failwith "error"));;
let rec simulate_lh__d1 _lh_simulate_arg1_0 _lh_simulate_arg2_0 =
  (match _lh_simulate_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d2 f_2_6 ls_2_9 =
  (match ls_2_9 with
    | `LH_C(h_3_0, t_3_0) -> 
      (`LH_C((f_2_6 h_3_0), ((map_lh__d2 f_2_6) t_3_0)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d1 xs_1_1 ys_9 =
  (match xs_1_1 with
    | `LH_C(h_3_3, t_3_3) -> 
      (`LH_C(h_3_3, ((mappend_lh__d1 t_3_3) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec enumFromTo_lh__d2 a_5 b_2 =
  (if (a_5 <= b_2) then
    (`LH_C(a_5, ((enumFromTo_lh__d2 (a_5 + 1)) b_2)))
  else
    (`LH_N));;
let rec mappend_lh__d2 xs_1_0 ys_8 =
  (match xs_1_0 with
    | `LH_C(h_3_1, t_3_1) -> 
      (`LH_C(h_3_1, ((mappend_lh__d2 t_3_1) ys_8)))
    | `LH_N -> 
      ys_8);;
let rec enumFrom_lh__d2 a_4 =
  (lazy (`LH_C(a_4, (enumFrom_lh__d2 (a_4 + 1)))));;
let rec map_lh__d1 f_2_9 ls_3_0 =
  (match ls_3_0 with
    | `LH_C(h_3_4, t_3_4) -> 
      (`LH_C((f_2_9 h_3_4), ((map_lh__d1 f_2_9) t_3_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec enumFrom_lh__d1 a_6 =
  (lazy (`LH_C(a_6, (enumFrom_lh__d1 (a_6 + 1)))));;
let rec zipWith_lz_nl_lh__d2 f_2_7 xs_9 ys_7 =
  (match ys_7 with
    | `LH_C(hy_6, ty_6) -> 
...
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_3_2, t_3_2) -> 
      ((mappend_lh__d3 h_3_2) (concat_lh__d1 t_3_2))
    | `LH_N -> 
      (`LH_N));;
...
let rec zipWith_lz_nl_lh__d1 f_2_8 xs_1_2 ys_1_0 =
  (match ys_1_0 with
    | `LH_C(hy_7, ty_7) -> 
...
let rec regs_lh__d1 _lh_regs_arg1_0 =
  ...
  in (let rec is_0 = (`LH_C((`LH_P2((`LH_C('s', (`LH_C('t', (`LH_C('o', (`LH_N))))))), 0)), (((zipWith_lz_nl_lh__d1 ilabel_0) (enumFrom_lh__d2 0)) (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_1_5 -> 
    ...
    (let rec os_0 = (((zipWith_lz_nl_lh__d2 olabel_0) (enumFrom_lh__d1 0)) (let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_1_6 -> 
      (match _lh_listcomp_fun_para_1_6 with
        | `LH_C(_lh_listcomp_fun_ls_h_1_6, _lh_listcomp_fun_ls_t_1_6) -> 
          (`LH_C(((7 * _lh_listcomp_fun_ls_h_1_6) + 7), (_lh_listcomp_fun_1_6 _lh_listcomp_fun_ls_t_1_6)))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_1_6 ((enumFromTo_lh__d2 0) (_lh_regs_arg1_0 - 1))))) in
      (let rec sto_0 = (`PS(0, (`Inp), 0, (`LH_N), (`LH_C((`LH_P6(0, (`F), false, 0, true, ((8 * (_lh_regs_arg1_0 - 1)) + 5))), (`LH_N))))) in
        (let rec states_0 = (`LH_C(sto_0, (concat_lh__d1 ((map_lh__d1 (reg_lh__d1 0)) (let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_1_7 -> 
          (match _lh_listcomp_fun_para_1_7 with
            | `LH_C(_lh_listcomp_fun_ls_h_1_7, _lh_listcomp_fun_ls_t_1_7) -> 
              (`LH_C(((7 * _lh_listcomp_fun_ls_h_1_7) + 1), (_lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_1_7)))
            | `LH_N -> 
              (`LH_N))) in
          (_lh_listcomp_fun_1_7 ((enumFromTo_lh__d3 0) (_lh_regs_arg1_0 - 1)))))))) in

(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./Queen_nofib.ml -o "./Queen_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./Queen_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;
...
and testQueen_nofib_d0 _lh_testQueen_nofib_arg1_1 =
  (nsoln_d0 _lh_testQueen_nofib_arg1_1);;
...
and testQueen_nofib_d0_d0 _lh_testQueen_nofib_arg1_0 =
  (nsoln_d0_d0 _lh_testQueen_nofib_arg1_0);;
...
and testQueen_nofib_d0_d0_d0 _lh_testQueen_nofib_arg1_1 =
  (nsoln_d0_d0_d0 _lh_testQueen_nofib_arg1_1);;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Queen_nofib" (fun () -> ignore ((testQueen_nofib_d0 11)));
  Bench.Test.create ~name:"lumberhack_Queen_nofib" (fun () -> ignore ((testQueen_nofib_d0_d0 11)));
  Bench.Test.create ~name:"lumberhack_pop_out_Queen_nofib" (fun () -> ignore ((testQueen_nofib_d0_d0_d0 11)));
])

(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./Tak_nofib.ml -o "./Tak_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./Tak_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_inlined_SumMapEnumBuiltInType_lh" (fun () -> ignore (let open Module_lumberhack_inlined_______.Module_lumberhack_inlined_______ in ((testSumMapEnumBuiltInType_lh__d1 300000))));
  Bench.Test.create ~name:"lumberhack_flo_out_SumMapEnumBuiltInType_lh" (fun () -> ignore (let open Module_lumberhack_flo_out_______.Module_lumberhack_flo_out_______ in ((testSumMapEnumBuiltInType_lh__d1 300000))));
])

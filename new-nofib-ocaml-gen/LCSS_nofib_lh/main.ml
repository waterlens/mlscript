...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_LCSS_nofib_lh" (fun () -> ignore (let open Module_lumberhack_______________.Module_lumberhack_______________ in ((testLCSS_nofib_lh__d1__d0 0))));
  Bench.Test.create ~name:"lumberhack_pop_out_LCSS_nofib_lh" (fun () -> ignore (let open Module_lumberhack_pop_out_______.Module_lumberhack_pop_out_______ in ((testLCSS_nofib_lh__d1__d0 0))));
])

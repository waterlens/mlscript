...
(* lumberhack *)
let rec comp_magnitude__d0__d0 _lh_comp_magnitude_arg1_0 =
  (match _lh_comp_magnitude_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec comp_plus__d0__d0 _lh_comp_plus_arg1_0 _lh_comp_plus_arg2_0 =
  (_lh_comp_plus_arg1_0 _lh_comp_plus_arg2_0);;
let rec comp_times__d0__d0 _lh_comp_times_arg1_0 _lh_comp_times_arg2_0 =
  (match _lh_comp_times_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec createPixmap__d0__d0 _lh_createPixmap_arg1_0 _lh_createPixmap_arg2_0 _lh_createPixmap_arg3_0 _lh_createPixmap_arg4_0 =
  (`Pixmap(_lh_createPixmap_arg1_0, _lh_createPixmap_arg2_0, _lh_createPixmap_arg3_0, _lh_createPixmap_arg4_0));;
let rec map_lz__d0__d0 f_2 ls_3 =
  (lazy (match (Lazy.force ls_3) with
    | `LH_C(h_1, t_1) -> 
      (`LH_C((f_2 h_1), ((map_lz__d0__d0 f_2) t_1)))
    | `LH_N -> 
      (`LH_N)));;
...
let rec map__d1__d0 f_0 ls_1 =
  (ls_1 f_0);;
let rec myMax__d0__d0 _lh_myMax_arg1_0 _lh_myMax_arg2_0 =
  (if (_lh_myMax_arg1_0 > _lh_myMax_arg2_0) then
    _lh_myMax_arg1_0
  else
    _lh_myMax_arg2_0);;
let rec diverge__d0__d0 _lh_diverge_arg1_0 _lh_diverge_arg2_0 =
  ((comp_magnitude__d0__d0 _lh_diverge_arg1_0) > _lh_diverge_arg2_0)
      ...
      (let rec _lh_listcomp_fun_ls_h_3 = a_1 in
        (fun _lh_listcomp_fun_4 _lh_mandelset_arg5_0 windowToViewport_2 -> 
          (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_0 -> 
            ...
            (_lh_listcomp_fun_5 ((enumFromTo__d1__d0 1) _lh_mandelset_arg5_0))))))
  else
    ...
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo__d1__d0 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (fun _lh_listcomp_fun_ls_h_1 _lh_listcomp_fun_0 windowToViewport_0 _lh_listcomp_fun_ls_t_1 _lh_listcomp_fun_1 -> 
          (let rec t_2 = (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0) in
            (let rec h_2 = ((windowToViewport_0 _lh_listcomp_fun_ls_h_0) _lh_listcomp_fun_ls_h_1) in
              (fun f_3 -> 
                (let rec t_3 = ((map__d1__d0 f_3) t_2) in
                  (let rec h_3 = (f_3 h_2) in
                    (fun f_4 -> 
                      (`LH_C((f_4 h_3), ((map__d0__d0 f_4) t_3))))))))))))
  else
...
and mandel__d0__d0 _lh_mandel_arg1_0 =
  (let rec infiniteMandel_0 = (lazy (`LH_C(_lh_mandel_arg1_0, ((map_lz__d0__d0 (fun z_0 -> 
    ((comp_plus__d0__d0 ((comp_times__d0__d0 z_0) z_0)) _lh_mandel_arg1_0))) infiniteMandel_0)))) in
    infiniteMandel_0)
and mandelset__d0__d0 _lh_mandelset_arg1_0 _lh_mandelset_arg2_0 _lh_mandelset_arg3_0 _lh_mandelset_arg4_0 _lh_mandelset_arg5_2 _lh_mandelset_arg6_0 _lh_mandelset_arg7_0 =
  (let rec prettyRGB_0 = (fun s_0 -> 
    ...
    (let rec windowToViewport_4 = (fun s_1 t_5 -> 
      ...
      (let rec result_0 = (((parallelMandel__d0__d0 (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_1 -> 
        (((_lh_listcomp_fun_para_1 _lh_listcomp_fun_7) _lh_mandelset_arg5_2) windowToViewport_4)) in
        (_lh_listcomp_fun_7 ((enumFromTo__d0__d0 1) _lh_mandelset_arg6_0)))) _lh_mandelset_arg7_0) (((myMax__d0__d0 (_lh_mandelset_arg3_0 -. _lh_mandelset_arg1_0)) (_lh_mandelset_arg4_0 -. _lh_mandelset_arg2_0)) /. 2.0)) in
        ((((createPixmap__d0__d0 _lh_mandelset_arg5_2) _lh_mandelset_arg6_0) _lh_mandelset_arg7_0) ((map__d0__d0 prettyRGB_0) result_0)))))
and parallelMandel__d0__d0 _lh_parallelMandel_arg1_0 _lh_parallelMandel_arg2_0 _lh_parallelMandel_arg3_0 =
  ((map__d1__d0 ((whenDiverge__d0__d0 _lh_parallelMandel_arg2_0) _lh_parallelMandel_arg3_0)) _lh_parallelMandel_arg1_0)
and take_lz__d0__d0 n_0 ls_0 =
  (if (n_0 > 0) then
    (match (Lazy.force ls_0) with
      | `LH_C(h_0, t_0) -> 
        (let rec _lh_whenDiverge_LH_C_1_0 = ((take_lz__d0__d0 (n_0 - 1)) t_0) in
          (let rec _lh_whenDiverge_LH_C_0_0 = h_0 in
            (fun _lh_whenDiverge_arg2_0 walkIt_0 -> 
              (if ((diverge__d0__d0 _lh_whenDiverge_LH_C_0_0) _lh_whenDiverge_arg2_0) then
                0
              else
    ...
    (fun _lh_whenDiverge_arg2_2 walkIt_2 -> 
      0))
and testMandel_nofib__d0__d0 _lh_testMandel_nofib_arg1_0 =
          ...
          (let rec screenX_0 = 80 in
            (let rec screenY_0 = 80 in
              (let rec limit_0 = 75 in
                (((((((mandelset__d0__d0 minx_0) miny_0) maxx_0) maxy_0) screenX_0) screenY_0) limit_0))))))))
and whenDiverge__d0__d0 _lh_whenDiverge_arg1_0 _lh_whenDiverge_arg2_3 _lh_whenDiverge_arg3_0 =
  (let rec walkIt_3 = (fun ls_4 -> 
    (let rec _lh_matchIdent_0 = ls_4 in
      ((_lh_matchIdent_0 _lh_whenDiverge_arg2_3) walkIt_3))) in
    (walkIt_3 ((take_lz__d0__d0 _lh_whenDiverge_arg1_0) (mandel__d0__d0 _lh_whenDiverge_arg3_0))));;

(* lumberhack_pop_out *)
let rec comp_magnitude__d0__d0__d0 _lh_comp_magnitude_arg1_1 =
  (match _lh_comp_magnitude_arg1_1 with
    | `Complex(_lh_comp_magnitude_Complex_0_1, _lh_comp_magnitude_Complex_1_1) -> 
      ((_lh_comp_magnitude_Complex_0_1 *. _lh_comp_magnitude_Complex_0_1) +. (_lh_comp_magnitude_Complex_1_1 *. _lh_comp_magnitude_Complex_1_1))
    | _ -> 
      (failwith "error"));;
let rec comp_plus__d0__d0__d0 _lh_comp_plus_arg1_1 _lh_comp_plus_arg2_3 =
  (_lh_comp_plus_arg1_1 _lh_comp_plus_arg2_3);;
let rec comp_times__d0__d0__d0 _lh_comp_times_arg1_1 _lh_comp_times_arg2_1 =
  (match _lh_comp_times_arg1_1 with
    | `Complex(_lh_comp_times_Complex_0_2, _lh_comp_times_Complex_1_2) -> 
      (match _lh_comp_times_arg2_1 with
        | `Complex(_lh_comp_times_Complex_0_3, _lh_comp_times_Complex_1_3) -> 
          (let rec _lh_comp_plus_Complex_1_2 = ((_lh_comp_times_Complex_0_2 *. _lh_comp_times_Complex_1_3) +. (_lh_comp_times_Complex_1_2 *. _lh_comp_times_Complex_0_3)) in
            (let rec _lh_comp_plus_Complex_0_2 = ((_lh_comp_times_Complex_0_2 *. _lh_comp_times_Complex_0_3) -. (_lh_comp_times_Complex_1_2 *. _lh_comp_times_Complex_1_3)) in
              (fun _lh_comp_plus_arg2_2 -> 
                (match _lh_comp_plus_arg2_2 with
                  | `Complex(_lh_comp_plus_Complex_0_3, _lh_comp_plus_Complex_1_3) -> 
                    (`Complex((_lh_comp_plus_Complex_0_2 +. _lh_comp_plus_Complex_0_3), (_lh_comp_plus_Complex_1_2 +. _lh_comp_plus_Complex_1_3)))
                  | _ -> 
                    (failwith "error")))))
    ...
    | _ -> 
      (failwith "error"));;
let rec createPixmap__d0__d0__d0 _lh_createPixmap_arg1_1 _lh_createPixmap_arg2_1 _lh_createPixmap_arg3_1 _lh_createPixmap_arg4_1 =
  (`Pixmap(_lh_createPixmap_arg1_1, _lh_createPixmap_arg2_1, _lh_createPixmap_arg3_1, _lh_createPixmap_arg4_1));;
let rec map_lz__d0__d0__d0 f_1_0 ls_8 =
  (lazy (match (Lazy.force ls_8) with
    | `LH_C(h_5, t_9) -> 
      (`LH_C((f_1_0 h_5), ((map_lz__d0__d0__d0 f_1_0) t_9)))
    | `LH_N -> 
      (`LH_N)));;
let rec map__d0__d0__d0 f_1_4 ls_1_0 =
  (ls_1_0 f_1_4);;
let rec map__d0__d0__d1 f_7 ls_5 =
  (ls_5 f_7);;
let rec map__d1__d0__d0 f_1_5 ls_1_1 =
  (ls_1_1 f_1_5);;
let rec map__d1__d0__d1 f_1_3 ls_9 =
  (ls_9 f_1_3);;
let rec myMax__d0__d0__d0 _lh_myMax_arg1_1 _lh_myMax_arg2_1 =
  (if (_lh_myMax_arg1_1 > _lh_myMax_arg2_1) then
    _lh_myMax_arg1_1
  else
    _lh_myMax_arg2_1);;
let rec diverge__d0__d0__d0 _lh_diverge_arg1_1 _lh_diverge_arg2_1 =
  ((comp_magnitude__d0__d0__d0 _lh_diverge_arg1_1) > _lh_diverge_arg2_1)
and enumFromTo__d0__d0__d0 a_2 b_2 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 =
  (if (a_2 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo__d0__d0__d0 (a_2 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_4 = a_2 in
        (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_2 -> 
          (((((_lh_listcomp_fun_para_2 _lh_listcomp_fun_ls_h_4) _lh_listcomp_fun_9) _lh_popOutId_2_1) _lh_listcomp_fun_ls_t_4) _lh_popOutId_0_1)) in
          (_lh_listcomp_fun_9 ((enumFromTo__d1__d0__d0 1) _lh_popOutId_1_1)))))
  else
    (fun f_8 f_9 -> 
      (`LH_N)))
and enumFromTo__d1__d0__d0 a_3 b_3 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 _lh_popOutId_4_0 =
  (if (a_3 <= b_3) then
    (fun f_1_1 f_1_2 -> 
      (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo__d1__d0__d0 (a_3 + 1)) b_3) in
        (let rec _lh_listcomp_fun_ls_h_5 = a_3 in
          (let rec t_1_0 = (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_5) in
            (let rec h_6 = ((_lh_popOutId_2_0 _lh_listcomp_fun_ls_h_5) _lh_popOutId_0_0) in
              (let rec t_1_1 = ((map__d1__d0__d0 f_1_1) t_1_0) in
                (let rec h_7 = (f_1_1 h_6) in
                  (`LH_C((f_1_2 h_7), ((map__d0__d0__d0 f_1_2) t_1_1))))))))))
  else
    (_lh_popOutId_4_0 _lh_popOutId_3_0))
and mandel__d0__d0__d0 _lh_mandel_arg1_1 =
  (let rec infiniteMandel_1 = (lazy (`LH_C(_lh_mandel_arg1_1, ((map_lz__d0__d0__d0 (fun z_1 -> 
    ((comp_plus__d0__d0__d0 ((comp_times__d0__d0__d0 z_1) z_1)) _lh_mandel_arg1_1))) infiniteMandel_1)))) in
    infiniteMandel_1)
and mandelset__d0__d0__d0 _lh_mandelset_arg1_1 _lh_mandelset_arg2_1 _lh_mandelset_arg3_1 _lh_mandelset_arg4_1 _lh_mandelset_arg5_5 _lh_mandelset_arg6_1 _lh_mandelset_arg7_1 =
  (let rec prettyRGB_1 = (fun s_2 -> 
    (let rec t_7 = (_lh_mandelset_arg7_1 - s_2) in
      (`LH_P3(s_2, t_7, t_7)))) in
    (let rec windowToViewport_7 = (fun s_3 t_8 -> 
      (`Complex((_lh_mandelset_arg1_1 +. (((float_of_int s_3) *. (_lh_mandelset_arg3_1 -. _lh_mandelset_arg1_1)) /. (float_of_int _lh_mandelset_arg5_5))), (_lh_mandelset_arg2_1 +. (((float_of_int t_8) *. (_lh_mandelset_arg4_1 -. _lh_mandelset_arg2_1)) /. (float_of_int _lh_mandelset_arg6_1)))))) in
      (let rec result_1 = (((parallelMandel__d0__d0__d0 (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_3 -> 
        (((_lh_listcomp_fun_para_3 _lh_listcomp_fun_1_1) _lh_mandelset_arg5_5) windowToViewport_7)) in
        (_lh_listcomp_fun_1_1 ((enumFromTo__d0__d0__d0 1) _lh_mandelset_arg6_1)))) _lh_mandelset_arg7_1) (((myMax__d0__d0__d0 (_lh_mandelset_arg3_1 -. _lh_mandelset_arg1_1)) (_lh_mandelset_arg4_1 -. _lh_mandelset_arg2_1)) /. 2.0)) in
        ((((createPixmap__d0__d0__d0 _lh_mandelset_arg5_5) _lh_mandelset_arg6_1) _lh_mandelset_arg7_1) ((map__d0__d0__d1 prettyRGB_1) result_1)))))
and parallelMandel__d0__d0__d0 _lh_parallelMandel_arg1_1 _lh_parallelMandel_arg2_1 _lh_parallelMandel_arg3_1 =
  ((map__d1__d0__d1 ((whenDiverge__d0__d0__d0 _lh_parallelMandel_arg2_1) _lh_parallelMandel_arg3_1)) _lh_parallelMandel_arg1_1)
and take_lz__d0__d0__d0 n_1 ls_6 _lh_popOutId_0_3 _lh_popOutId_1_3 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_6) with
      | `LH_C(h_4, t_6) -> 
        (let rec _lh_whenDiverge_LH_C_1_1 = ((take_lz__d0__d0__d0 (n_1 - 1)) t_6) in
          (let rec _lh_whenDiverge_LH_C_0_1 = h_4 in
            (if ((diverge__d0__d0__d0 _lh_whenDiverge_LH_C_0_1) _lh_popOutId_0_3) then
              0
            else
              (1 + (_lh_popOutId_1_3 _lh_whenDiverge_LH_C_1_1)))))
      | `LH_N -> 
        0)
  else
    0)
and testMandel_nofib__d0__d0__d0 _lh_testMandel_nofib_arg1_1 =
  (let rec minx_1 = (0.0 -. 2.0) in
    (let rec miny_1 = (0.0 -. 2.0) in
      (let rec maxx_1 = 2.0 in
        (let rec maxy_1 = 2.0 in
          (let rec screenX_1 = 80 in
            (let rec screenY_1 = 80 in
              (let rec limit_1 = 75 in
                (((((((mandelset__d0__d0__d0 minx_1) miny_1) maxx_1) maxy_1) screenX_1) screenY_1) limit_1))))))))
and whenDiverge__d0__d0__d0 _lh_whenDiverge_arg1_1 _lh_whenDiverge_arg2_7 _lh_whenDiverge_arg3_1 =
  (let rec walkIt_7 = (fun ls_7 -> 
    (let rec _lh_matchIdent_1 = ls_7 in
      ((_lh_matchIdent_1 _lh_whenDiverge_arg2_7) walkIt_7))) in
    (walkIt_7 ((take_lz__d0__d0__d0 _lh_whenDiverge_arg1_1) (mandel__d0__d0__d0 _lh_whenDiverge_arg3_1))));;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Mandel_nofib" (fun () -> ignore ((testMandel_nofib__d0 0)));
  Bench.Test.create ~name:"lumberhack_Mandel_nofib" (fun () -> ignore ((testMandel_nofib__d0__d0 0)));
  Bench.Test.create ~name:"lumberhack_pop_out_Mandel_nofib" (fun () -> ignore ((testMandel_nofib__d0__d0__d0 0)));
])

      ...
      | `LH_C(h_5_8, t_5_8) -> 
        (let rec ty_0 = ((take_lh__d1 (n_2 - 1)) t_5_8) in
          (let rec hy_0 = h_5_8 in
            (fun f_1_6 hx_1 tx_1 -> 
              (let rec t_5_9 = (((zipWith_lh__d1 f_1_6) tx_1) ty_0) in
                (let rec h_5_9 = ((f_1_6 hx_1) hy_0) in
                  (fun _lh_dummy_2 -> 
                    ((mappend_lh__d2_d0 h_5_9) (concat_lh__d2 t_5_9))))))))
      | `LH_N -> 
        (fun f_1_7 hx_2 tx_2 _lh_dummy_3 f_1_8 i_9 -> 
          i_9))
  else
    (fun f_1_9 hx_3 tx_3 _lh_dummy_4 f_2_0 i_1_0 -> 
      i_1_0));;
...
let rec foldr_lh__d1 f_9 i_5 ls_7 =
  ((ls_7 f_9) i_5);;
let rec enumFromTo_lh__d1 a_9 b_8 =
  (if (a_9 <= b_8) then
    (let rec t_7_8 = ((enumFromTo_lh__d1 (a_9 + 1)) b_8) in
      (let rec h_7_8 = a_9 in
        (fun f_3_0 i_1_3 -> 
          ((f_3_0 h_7_8) (((foldr_lh__d1 f_3_0) i_1_3) t_7_8)))))
  else
    (fun f_3_1 i_1_4 -> 
      i_1_4));;
  ...
  (if (a_4 <= b_3) then
    (let rec t_2_8 = ((enumFromTo_lh__d2 (a_4 + 1)) b_3) in
      (let rec h_2_8 = a_4 in
        (fun a_5 -> 
          ((reverse_helper_lh__d1 t_2_8) (let rec t_2_9 = a_5 in
...
let rec tab_lh__d1 _lh_tab_arg1_1 =
  (if (_lh_tab_arg1_1 <= 0) then
    ...
    (let rec t_1_3_5 = (tab_lh__d1 (_lh_tab_arg1_1 - 1)) in
      (let rec h_1_3_5 = ' ' in
        (fun ys_1_4_2 -> 
          (let rec t_1_3_6 = ((mappend_lh__d2_d1 t_1_3_5) ys_1_4_2) in
...
let rec reverse_helper_lh__d2 ls_5 a_1 =
  (ls_5 a_1);;
let rec enumFromTo_lh__d3 a_1_0 b_9 =
  (if (a_1_0 <= b_9) then
    (let rec t_8_1 = ((enumFromTo_lh__d3 (a_1_0 + 1)) b_9) in
      (let rec h_8_1 = a_1_0 in
        (fun a_1_1 -> 
          ((reverse_helper_lh__d2 t_8_1) (let rec tx_4 = a_1_1 in

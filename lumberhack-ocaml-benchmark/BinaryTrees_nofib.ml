...
and make_d0_d0 _lh_make_arg1_0 _lh_make_arg2_0 =
  (match _lh_make_arg2_0 with
    | 0 -> 
      (let rec _lh_check'_Node_0_0 = (lazy _lh_make_arg1_0) in
        (let rec _lh_check'_Node_1_0 = (lazy (fun _lh_check'_arg2_1 _lh_check'_arg1_1 -> 
          _lh_check'_arg2_1)) in
          (let rec _lh_check'_Node_2_0 = (lazy (fun _lh_check'_arg2_2 _lh_check'_arg1_2 -> 
            ...
            (fun _lh_check'_arg2_3 _lh_check'_arg1_3 -> 
              (((check'_d0_d0 (not _lh_check'_arg1_3)) (((check'_d0_d0 _lh_check'_arg1_3) (if _lh_check'_arg1_3 then
                (_lh_check'_arg2_3 + (Lazy.force _lh_check'_Node_0_0))
              else
                (_lh_check'_arg2_3 - (Lazy.force _lh_check'_Node_0_0)))) (Lazy.force _lh_check'_Node_1_0))) (Lazy.force _lh_check'_Node_2_0))))))
    | _ -> 
      (let rec i2_0 = (2 * _lh_make_arg1_0) in
        (let rec d2_0 = (_lh_make_arg2_0 - 1) in
          (let rec _lh_check'_Node_0_1 = (lazy _lh_make_arg1_0) in
            (let rec _lh_check'_Node_1_1 = (lazy ((make_d0_d0 (i2_0 - 1)) d2_0)) in
              (let rec _lh_check'_Node_2_1 = (lazy ((make_d0_d0 i2_0) d2_0)) in
                (fun _lh_check'_arg2_4 _lh_check'_arg1_4 -> 
                  (((check'_d0_d0 (not _lh_check'_arg1_4)) (((check'_d0_d0 _lh_check'_arg1_4) (if _lh_check'_arg1_4 then
                    (_lh_check'_arg2_4 + (Lazy.force _lh_check'_Node_0_1))
                  else
                    (_lh_check'_arg2_4 - (Lazy.force _lh_check'_Node_0_1)))) (Lazy.force _lh_check'_Node_1_1))) (Lazy.force _lh_check'_Node_2_1)))))))))
...
(* lumberhack_pop_out *)
let rec check'_d0_d0_d0 _lh_check'_arg1_9 _lh_check'_arg2_9 _lh_check'_arg3_1 =
  ((_lh_check'_arg3_1 _lh_check'_arg2_9) _lh_check'_arg1_9);;
let rec check'_d0_d0_d1 _lh_check'_arg1_1_0 _lh_check'_arg2_1_0 _lh_check'_arg3_2 =
...
let rec check'_d0_d0_d3 _lh_check'_arg1_1_2 _lh_check'_arg2_1_2 _lh_check'_arg3_4 =
...
and make_d0_d0_d0 _lh_make_arg1_1 _lh_make_arg2_1 _lh_popOutId_0_0 _lh_popOutId_1_0 =
  (match _lh_make_arg2_1 with
    | 0 -> 
      (let rec _lh_check'_Node_0_2 = (lazy _lh_make_arg1_1) in
        (let rec _lh_check'_Node_1_2 = (lazy (fun _lh_check'_arg2_5 _lh_check'_arg1_5 -> 
          _lh_check'_arg2_5)) in
          (let rec _lh_check'_Node_2_2 = (lazy (fun _lh_check'_arg2_6 _lh_check'_arg1_6 -> 
            _lh_check'_arg2_6)) in
            (((check'_d0_d0_d3 (not _lh_popOutId_1_0)) (((check'_d0_d0_d4 _lh_popOutId_1_0) (if _lh_popOutId_1_0 then
              (_lh_popOutId_0_0 + (Lazy.force _lh_check'_Node_0_2))
            else
              (_lh_popOutId_0_0 - (Lazy.force _lh_check'_Node_0_2)))) (Lazy.force _lh_check'_Node_1_2))) (Lazy.force _lh_check'_Node_2_2)))))
    | _ -> 
      (let rec i2_1 = (2 * _lh_make_arg1_1) in
        (let rec d2_1 = (_lh_make_arg2_1 - 1) in
          (let rec _lh_check'_Node_0_3 = (lazy _lh_make_arg1_1) in
            (let rec _lh_check'_Node_1_3 = (lazy ((make_d0_d0_d0 (i2_1 - 1)) d2_1)) in
              (let rec _lh_check'_Node_2_3 = (lazy ((make_d0_d0_d0 i2_1) d2_1)) in
                (((check'_d0_d0_d1 (not _lh_popOutId_1_0)) (((check'_d0_d0_d2 _lh_popOutId_1_0) (if _lh_popOutId_1_0 then
                  (_lh_popOutId_0_0 + (Lazy.force _lh_check'_Node_0_3))
                else
                  (_lh_popOutId_0_0 - (Lazy.force _lh_check'_Node_0_3)))) (Lazy.force _lh_check'_Node_1_3))) (Lazy.force _lh_check'_Node_2_3))))))))

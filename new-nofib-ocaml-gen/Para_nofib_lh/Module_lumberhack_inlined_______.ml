...
let rec mappend_lh__d1_d4 xs_1_2 ys_1_8 =
  (match xs_1_2 with
    | `LH_C(h_2_0, t_2_0) -> 
      (`LH_C(h_2_0, ((mappend_lh__d1_d4 t_2_0) ys_1_8)))
    | `LH_N -> 
      ys_1_8);;
let rec mappend_lh__d1_d1 xs_1_4 ys_2_0 =
  (match xs_1_4 with
    | `LH_C(h_2_2, t_2_2) -> 
      (`LH_C(h_2_2, ((mappend_lh__d1_d1 t_2_2) ys_2_0)))
    | `LH_N -> 
      ys_2_0);;
let rec mappend_lh__d1_d3 xs_1_9 ys_2_9 =
  (match xs_1_9 with
    | `LH_C(h_3_0, t_3_0) -> 
      (`LH_C(h_3_0, ((mappend_lh__d1_d3 t_3_0) ys_2_9)))
    | `LH_N -> 
      ys_2_9);;
let rec mappend_lh__d1_d5 xs_2_1 ys_3_1 =
  (match xs_2_1 with
    | `LH_C(h_3_3, t_3_3) -> 
      (`LH_C(h_3_3, ((mappend_lh__d1_d5 t_3_3) ys_3_1)))
    | `LH_N -> 
      ys_3_1);;
let rec mappend_lh__d1_d7 xs_2_3 ys_3_4 =
  (match xs_2_3 with
    | `LH_C(h_4_7, t_4_7) -> 
      (`LH_C(h_4_7, ((mappend_lh__d1_d7 t_4_7) ys_3_4)))
    | `LH_N -> 
      ys_3_4);;
let rec mappend_lh__d1_d2 xs_2_4 ys_3_5 =
  (match xs_2_4 with
    | `LH_C(h_4_9, t_4_9) -> 
      (`LH_C(h_4_9, ((mappend_lh__d1_d2 t_4_9) ys_3_5)))
    | `LH_N -> 
      ys_3_5);;
...
let rec mappend_lh__d6 xs_1_3 ys_1_9 =
  (match xs_1_3 with
    | `LH_C(h_2_1, t_2_1) -> 
      (`LH_C(h_2_1, ((mappend_lh__d6 t_2_1) ys_1_9)))
    | `LH_N -> 
      ys_1_9);;
let rec mappend_lh__d4 xs_1_5 ys_2_1 =
  (match xs_1_5 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d4 t_2_4) ys_2_1)))
    | `LH_N -> 
      ys_2_1);;
let rec mappend_lh__d9 xs_2_0 ys_3_0 =
  (match xs_2_0 with
    | `LH_C(h_3_2, t_3_2) -> 
      (`LH_C(h_3_2, ((mappend_lh__d9 t_3_2) ys_3_0)))
    | `LH_N -> 
      ys_3_0);;
...
let rec map_lh__d3 f_8 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_3_7, t_3_7) -> 
      (let rec t_3_8 = ((map_lh__d3 f_8) t_3_7) in
        (let rec h_3_8 = (f_8 h_3_7) in
          (fun f_9 -> 
            (let rec t_3_9 = (t_3_8 f_9) in
              (let rec h_3_9 = (f_9 h_3_8) in
                (fun _lh_dummy_4 -> 
                  (h_3_9 (t_3_9 99))))))))
    | `LH_N -> 
      (fun f_1_0 _lh_dummy_5 -> 
        (`LH_N)));;
let rec mappend_lh__d2_d4 xs_2_2 ys_3_2 =
  (match xs_2_2 with
    | `LH_C(h_4_3, t_4_3) -> 
      (let rec t_4_4 = ((mappend_lh__d2_d4 t_4_3) ys_3_2) in
        (let rec h_4_4 = h_4_3 in
          (fun ys_3_3 -> 
            (`LH_C(h_4_4, (t_4_4 ys_3_3))))))
    | `LH_N -> 
      ys_3_2);;
...
let rec unformat_lh__d1 _lh_unformat_arg1_0 =
  ((fold1_lh__d3 (fun xs_1_7 ys_2_5 -> 
    (((mappend_lh__d2_d4 xs_1_7) (let rec t_2_8 = (fun ys_2_6 -> 
      ys_2_6) in
      (let rec h_2_8 = _lh_unformat_arg1_0 in
        (fun ys_2_7 -> 
          (`LH_C(h_2_8, (t_2_8 ys_2_7))))))) ys_2_5))) (fun x_3 -> 
    x_3));;
...
let rec mappend_lh__d2_d0 xs_1_6 ys_2_2 =
  (match xs_1_6 with
    | `LH_C(h_2_5, t_2_5) -> 
      (let rec t_2_6 = ((mappend_lh__d2_d0 t_2_5) ys_2_2) in
        (let rec h_2_6 = h_2_5 in
          (fun ys_2_3 -> 
            (let rec t_2_7 = (t_2_6 ys_2_3) in
              (let rec h_2_7 = h_2_6 in
                (fun ys_2_4 -> 
                  (`LH_C(h_2_7, (t_2_7 ys_2_4)))))))))
    | `LH_N -> 
      ys_2_2);;
...
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  ((_lh_unlines_arg1_0 (fun l_1 -> 
    (l_1 (let rec t_5_0 = (fun ys_3_7 -> 
      ys_3_7) in
      (let rec h_5_0 = '|' in
        (fun ys_3_8 -> 
          (`LH_C(h_5_0, (t_5_0 ys_3_8))))))))) 99);;
      ...
      (if (_lh_break_arg1_2 _lh_break_LH_C_0_1) then
        (`LH_P2((`LH_N), (let rec _lh_lines_LH_C_1_0 = _lh_break_LH_C_1_1 in
          (let rec _lh_lines_LH_C_0_0 = _lh_break_LH_C_0_1 in
            (fun _lh_dummy_3 -> 
              (let rec _lh_matchIdent_1_1 = ((break_lh__d1 (fun x_5 -> 
                (x_5 = '|'))) _lh_lines_LH_C_1_0) in
                (match _lh_matchIdent_1_1 with
                  | `LH_P2(_lh_lines_LH_P2_0_2, _lh_lines_LH_P2_1_2) -> 
                    (let rec t_3_5 = (let rec _lh_matchIdent_1_2 = _lh_lines_LH_P2_1_2 in
                      (_lh_matchIdent_1_2 99)) in
                      (let rec h_3_5 = _lh_lines_LH_P2_0_2 in
                        (fun f_7 -> 
                          (`LH_C((f_7 h_3_5), (t_3_5 f_7))))))
                  | _ -> 
                    (failwith "error"))))))))
      else
        (let rec _lh_matchIdent_1_3 = ((break_lh__d1 _lh_break_arg1_2) _lh_break_LH_C_1_1) in
...
let rec filter_lh__d1 f_1_1 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_4_0, t_4_0) -> 
      (if (f_1_1 h_4_0) then
        (let rec t_4_1 = ((filter_lh__d1 f_1_1) t_4_0) in
          (let rec h_4_1 = h_4_0 in
            (fun f_1_2 -> 
              (`LH_C((f_1_2 h_4_1), (t_4_1 f_1_2))))))
      else
        ((filter_lh__d1 f_1_1) t_4_0))
    | `LH_N -> 
      (fun f_1_3 -> 
        (`LH_N)));;
      ...
      (if (_lh_dropWhile_arg1_0 _lh_dropWhile_LH_C_0_0) then
        ...
        (let rec _lh_words_LH_C_1_0 = _lh_dropWhile_LH_C_1_0 in
          (let rec _lh_words_LH_C_0_0 = _lh_dropWhile_LH_C_0_0 in
            (fun _lh_dummy_1 -> 
              (let rec _lh_matchIdent_8 = ((break_lh__d2 isSpace_lh__d2) (`LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0))) in
                (match _lh_matchIdent_8 with
                  | `LH_P2(_lh_words_LH_P2_0_0, _lh_words_LH_P2_1_0) -> 
                    (`LH_C(_lh_words_LH_P2_0_0, (let rec _lh_matchIdent_9 = ((dropWhile_lh__d1 isSpace_lh__d1) _lh_words_LH_P2_1_0) in
                      (_lh_matchIdent_9 99))))
                  | _ -> 
                    (failwith "error")))))))
    | _ -> 
...
let rec parse_lh__d1 _lh_parse_arg1_0 =
  ((fun _lh_funcomp_x_6 -> 
    ((fun _lh_funcomp_x_7 -> 
      (paras_lh__d1 (_lh_funcomp_x_7 words_lh__d1))) (let rec _lh_matchIdent_6 = ((break_lh__d1 (fun x_2 -> 
      (x_2 = '|'))) _lh_funcomp_x_6) in
      (match _lh_matchIdent_6 with
        | `LH_P2(_lh_lines_LH_P2_0_1, _lh_lines_LH_P2_1_1) -> 
          (let rec t_1_8 = (let rec _lh_matchIdent_7 = _lh_lines_LH_P2_1_1 in
            (_lh_matchIdent_7 99)) in
            (let rec h_1_8 = _lh_lines_LH_P2_0_1 in
              (fun f_1 -> 
                (`LH_C((f_1 h_1_8), (t_1_8 f_1))))))
        | _ -> 
          (failwith "error"))))) _lh_parse_arg1_0);;
...
let rec concat_lh__d1 lss_1 =
  (match lss_1 with
    | `LH_C(h_4_8, t_4_8) -> 
      ((mappend_lh__d1_d9 h_4_8) (concat_lh__d1 t_4_8))
    | `LH_N -> 
      (`LH_N));;
...
let rec startr_lh__d1 _lh_startr_arg1_0 =
  (if (_lh_startr_arg1_0 <= maxw_lh__d3) then
    (`LH_P3((nil'_lh__d1 (`LH_P3(0, 0, 0))), _lh_startr_arg1_0, 1))
  else
...
let rec take_lh__d1 n_0 ls_7 =
  (if (n_0 > 0) then
    (match ls_7 with
      | `LH_C(h_3_1, t_3_1) -> 
        (`LH_C(h_3_1, ((take_lh__d1 (n_0 - 1)) t_3_1)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
    ...
    | `LH_P2(_lh_init'_LH_P2_0_2, _lh_init'_LH_P2_1_2) -> 
      (if (null_lh__d2 _lh_init'_LH_P2_1_2) then
        ...
        (if (single_lh__d1 _lh_init'_LH_P2_1_2) then
          (let rec _lh_matchIdent_1_0 = ((splitAt_lh__d1 ((length_lh__d1 _lh_init'_LH_P2_0_2) / 2)) _lh_init'_LH_P2_0_2) in
    ...
    | `LH_P2(_lh_tail'_LH_P2_0_0, _lh_tail'_LH_P2_1_0) -> 
      (if (null_lh__d2 _lh_tail'_LH_P2_0_0) then
        ...
        (if (single_lh__d1 _lh_tail'_LH_P2_0_0) then
          (let rec _lh_matchIdent_1_4 = ((splitAt_lh__d1 ((length_lh__d1 _lh_tail'_LH_P2_1_0) / 2)) _lh_tail'_LH_P2_1_0) in
                ...
                (let rec old_width_hd_0 = (fun p_3 -> 
                  ...
                  (let rec new_0 = (fun p_4 -> 
                    (if (single_0 p_4) then
                      ...
                      (`LH_P3(_lh_stepr_LH_P3_1_0, ((cost_tl_lh__d2 p_4) + (let rec x_4 = (optw_lh__d2 - (old_width_hd_0 p_4)) in
                        (x_4 * x_4))), _lh_stepr_LH_P3_2_0)))) in
...
let rec map_lh__d4 f_1_4 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_4_5, t_4_5) -> 
      (`LH_C((f_1_4 h_4_5), ((map_lh__d4 f_1_4) t_4_5)))
    | `LH_N -> 
      (`LH_N));;
...
let rec tile_lh__d1 _lh_tile_arg1_0 _lh_tile_arg2_0 =
  (match _lh_tile_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d5 f_5 ls_9 =
  (match ls_9 with
    | `LH_C(h_3_4, t_3_4) -> 
      (`LH_C((f_5 h_3_4), ((map_lh__d5 f_5) t_3_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec fmt_lh__d1 _lh_fmt_arg1_0 =
  ((fun _lh_funcomp_x_3 -> 
    ((fun _lh_funcomp_x_4 -> 
      (unparse_lh__d1 (_lh_funcomp_x_4 (fun _lh_funcomp_x_5 -> 
        (par3_lh__d1 (concat_lh__d1 _lh_funcomp_x_5)))))) (parse_lh__d1 _lh_funcomp_x_3))) _lh_fmt_arg1_0);;

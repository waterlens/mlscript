    ...
    | `LH_C(_lh_interleave_LH_C_0_1, _lh_interleave_LH_C_1_1) -> 
      (let rec t_6 = ((interleave_lh__d2 _lh_interleave_arg2_1) _lh_interleave_LH_C_1_1) in
        (let rec h_6 = _lh_interleave_LH_C_0_1 in
          (fun ys_6 -> 
            (let rec t_7 = (t_6 ys_6) in
              (let rec h_7 = h_6 in
                (fun ys_7 -> 
                  (let rec t_8 = (t_7 ys_7) in
                    (let rec h_8 = h_7 in
                      (fun ys_8 -> 
                        (let rec t_9 = (t_8 ys_8) in
                          (let rec h_9 = h_8 in
                            (fun ys_9 -> 
                              (`LH_C(h_9, (t_9 ys_9)))))))))))))))
    | `LH_N -> 
    ...
    | `LH_C(_lh_interleave_LH_C_0_0, _lh_interleave_LH_C_1_0) -> 
      (let rec t_2 = ((interleave_lh__d1 _lh_interleave_arg2_0) _lh_interleave_LH_C_1_0) in
        (let rec h_2 = _lh_interleave_LH_C_0_0 in
          (fun ys_1 -> 
            (let rec t_3 = (t_2 ys_1) in
              (let rec h_3 = h_2 in
                (fun ys_2 -> 
                  (let rec t_4 = (t_3 ys_2) in
                    (let rec h_4 = h_3 in
                      (fun ys_3 -> 
                        (`LH_C(h_4, (t_4 ys_3))))))))))))
    | `LH_N -> 
...
let rec disp_lh__d1 _lh_disp_arg1_0 =
  (match _lh_disp_arg1_0 with
    | `LH_P2(_lh_disp_LH_P2_0_0, _lh_disp_LH_P2_1_0) -> 
      ((((interleave_lh__d2 _lh_disp_LH_P2_0_0) (spaces_lh__d1 (length_lh__d1 _lh_disp_LH_P2_0_0))) (let rec t_1_3 = (let rec t_1_4 = (fun ys_1_5 -> 
        ys_1_5) in
        (let rec h_1_3 = '=' in
          (fun ys_1_6 -> 
            (let rec t_1_5 = (t_1_4 ys_1_6) in
              (let rec h_1_4 = h_1_3 in
                (fun ys_1_7 -> 
                  (let rec t_1_6 = (t_1_5 ys_1_7) in
                    (let rec h_1_5 = h_1_4 in
                      (fun ys_1_8 -> 
                        (`LH_C(h_1_5, (t_1_6 ys_1_8)))))))))))) in
        (let rec h_1_6 = '<' in
          (fun ys_1_9 -> 
            (let rec t_1_7 = (t_1_3 ys_1_9) in
              (let rec h_1_7 = h_1_6 in
                (fun ys_2_0 -> 
                  (let rec t_1_8 = (t_1_7 ys_2_0) in
                    (let rec h_1_8 = h_1_7 in
                      (fun ys_2_1 -> 
                        (`LH_C(h_1_8, (t_1_8 ys_2_1))))))))))))) (((interleave_lh__d1 (spaces_lh__d2 (length_lh__d2 _lh_disp_LH_P2_1_0))) _lh_disp_LH_P2_1_0) (let rec t_1_9 = (fun ys_2_2 -> 
        ys_2_2) in
        (let rec h_1_9 = 'n' in
          (fun ys_2_3 -> 

(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./SumMapEnum.ml -o "./SumMapEnum.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./SumMapEnum.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

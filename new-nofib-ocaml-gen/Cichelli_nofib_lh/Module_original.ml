...
and blocked'_lh _lh_blocked'_arg1_0 _lh_blocked'_arg2_0 =
  (match _lh_blocked'_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and blocked_lh _lh_blocked_arg1_0 =
  ((blocked'_lh (`LH_N)) _lh_blocked_arg1_0)
and cichelli_lh _lh_cichelli_arg1_0 =
...
and hash_lh _lh_hash_arg1_0 _lh_hash_arg2_0 =
  (match _lh_hash_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and hinsert_lh _lh_hinsert_arg1_0 _lh_hinsert_arg2_0 =
...
and maxm_lh _lh_maxm_arg1_0 _lh_maxm_arg2_0 =
  (match _lh_maxm_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and minm_lh _lh_minm_arg1_0 _lh_minm_arg2_0 =

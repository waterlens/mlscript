...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Life_nofib_lh" (fun () -> ignore (let open Module_lumberhack_______________.Module_lumberhack_______________ in ((testLife_nofib_lh__d1__d0__d0 15))));
  Bench.Test.create ~name:"lumberhack_pop_out_Life_nofib_lh" (fun () -> ignore (let open Module_lumberhack_pop_out_______.Module_lumberhack_pop_out_______ in ((testLife_nofib_lh__d1__d0__d0 15))));
])

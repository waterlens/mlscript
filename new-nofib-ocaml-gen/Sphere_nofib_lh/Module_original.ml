...
and bodysurf_lh _lh_bodysurf_arg1_0 =
...
and camparams_lh _lh_camparams_arg1_0 _lh_camparams_arg2_0 _lh_camparams_arg3_0 _lh_camparams_arg4_0 _lh_camparams_arg5_0 =
  (let rec initfirstray_0 = ((vecsub_lh _lh_camparams_arg2_0) _lh_camparams_arg1_0) in
    (let rec _lh_matchIdent_1_0 = (vecnorm_lh initfirstray_0) in
      (match _lh_matchIdent_1_0 with
        ...
        | _ -> 
          (failwith "error"))))
and diffusesurf_lh _lh_diffusesurf_arg1_0 =
...
and is_zerovector_lh _lh_is_zerovector_arg1_0 =
  (match _lh_is_zerovector_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and lightdirection_lh _lh_lightdirection_arg1_0 _lh_lightdirection_arg2_0 =
  (match _lh_lightdirection_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and lightray_lh _lh_lightray_arg1_0 _lh_lightray_arg2_0 _lh_lightray_arg3_0 _lh_lightray_arg4_0 _lh_lightray_arg5_0 =
  ...
  (let rec lights_0 = (testlights_lh 0) in
    (let rec _lh_matchIdent_1_3 = (((((camparams_lh lookfrom_lh) (lookat_lh 0)) (vup_lh 0)) fov_lh) (float_of_int _lh_ray_arg1_0)) in
      (match _lh_matchIdent_1_3 with
        ...
        | _ -> 
          (failwith "error"))))
and reflectray_lh _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
    ...
    (let rec nearpos_0 = ((vecadd_lh _lh_reflectray_arg1_0) ((vecscale_lh _lh_reflectray_arg2_0) epsilon_lh)) in
      (let rec _lh_matchIdent_0 = (((trace_lh (testspheres_lh 0)) nearpos_0) _lh_reflectray_arg2_0) in
        (match _lh_matchIdent_0 with
          ...
          | _ -> 
            (failwith "error")))))
and reflectsurf_lh _lh_reflectsurf_arg1_0 =
...
and refractray_lh _lh_refractray_arg1_0 _lh_refractray_arg2_0 _lh_refractray_arg3_0 =
  (let rec dotp_0 = (0.0 -. ((vecdot_lh _lh_refractray_arg2_0) _lh_refractray_arg3_0)) in
    (let rec _lh_matchIdent_1_7 = (if (dotp_0 < 0.0) then
      ...
      (match _lh_matchIdent_1_7 with
        ...
        | _ -> 
          (failwith "error"))))
and refractsurf_lh _lh_refractsurf_arg1_0 =
...
and run_lh _lh_run_arg1_0 =
  (hash_lh ((map_lh snd_lh) (ray_lh _lh_run_arg1_0)))
and shade_lh _lh_shade_arg1_0 _lh_shade_arg2_0 _lh_shade_arg3_0 _lh_shade_arg4_0 _lh_shade_arg5_0 _lh_shade_arg6_0 =
                    ...
                    (let rec trintensity_0 = ((vecscale_lh (bodysurf_lh surf_0)) transmitted_0) in
                      (let rec _lh_matchIdent_1 = (if (transmitted_0 < epsilon_lh) then
                        ...
                        (match _lh_matchIdent_1 with
                          ...
                          | _ -> 
                            (failwith "error")))))))))))))
and shadowed_lh _lh_shadowed_arg1_0 _lh_shadowed_arg2_0 _lh_shadowed_arg3_0 =
  (let rec _lh_matchIdent_1_4 = (((trace_lh (testspheres_lh 0)) ((vecadd_lh _lh_shadowed_arg1_0) ((vecscale_lh _lh_shadowed_arg2_0) epsilon_lh))) _lh_shadowed_arg2_0) in
    (match _lh_matchIdent_1_4 with
      ...
      | _ -> 
        (failwith "error")))
and specpowsurf_lh _lh_specpowsurf_arg1_0 =
...
and specularsurf_lh _lh_specularsurf_arg1_0 =
...
and sphereintersect_lh _lh_sphereintersect_arg1_0 _lh_sphereintersect_arg2_0 _lh_sphereintersect_arg3_0 =
  (match _lh_sphereintersect_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and spherenormal_lh _lh_spherenormal_arg1_0 _lh_spherenormal_arg2_0 =
  (match _lh_spherenormal_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and testSphere_nofib_lh _lh_testSphere_nofib_arg1_0 =
  (run_lh _lh_testSphere_nofib_arg1_0)
and testspheres_lh _lh_testspheres_arg1_0 =
...
and trace_lh _lh_trace_arg1_0 _lh_trace_arg2_0 _lh_trace_arg3_0 =
        ...
        (if (null_lh dists_0) then
          ...
          (let rec _lh_matchIdent_7 = (((foldr_lh f_2) (head_lh dists_0)) (tail_lh dists_0)) in
            (match _lh_matchIdent_7 with
              ...
              | _ -> 
                (failwith "error")))))))
and tracepixel_lh _lh_tracepixel_arg1_0 _lh_tracepixel_arg2_0 _lh_tracepixel_arg3_0 _lh_tracepixel_arg4_0 _lh_tracepixel_arg5_0 _lh_tracepixel_arg6_0 _lh_tracepixel_arg7_0 =
  (let rec pos_0 = lookfrom_lh in
    (let rec _lh_matchIdent_1_8 = (vecnorm_lh ((vecadd_lh ((vecadd_lh _lh_tracepixel_arg5_0) ((vecscale_lh _lh_tracepixel_arg6_0) _lh_tracepixel_arg3_0))) ((vecscale_lh _lh_tracepixel_arg7_0) _lh_tracepixel_arg4_0))) in
      (match _lh_matchIdent_1_8 with
        ...
        | _ -> 
          (failwith "error"))))
and transmitray_lh _lh_transmitray_arg1_0 _lh_transmitray_arg2_0 _lh_transmitray_arg3_0 _lh_transmitray_arg4_0 _lh_transmitray_arg5_0 _lh_transmitray_arg6_0 _lh_transmitray_arg7_0 _lh_transmitray_arg8_0 =
  (let rec newcontrib_1 = ((vecmult_lh _lh_transmitray_arg6_0) _lh_transmitray_arg7_0) in
    (let rec _lh_matchIdent_8 = (((refractray_lh _lh_transmitray_arg5_0) _lh_transmitray_arg4_0) _lh_transmitray_arg8_0) in
      (match _lh_matchIdent_8 with
        ...
        | _ -> 
          (failwith "error"))))
and transmitsurf_lh _lh_transmitsurf_arg1_0 =
...
and vecsum_lh _lh_vecsum_arg1_0 =

              ...
              (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                (match _lh_listcomp_fun_para_2 with
                  | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
                    (`LH_C((`LH_P3(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_h_2)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
                  | `LH_N -> 
                    (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1))) in
                (_lh_listcomp_fun_2 (`LH_C((_lh_three_partitions_arg1_0 - (_lh_listcomp_fun_ls_h_0 + _lh_listcomp_fun_ls_h_1)), (`LH_N)))))
            | `LH_N -> 
              (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0))) in
          (_lh_listcomp_fun_1 ((enumFromTo_lh__d5 _lh_listcomp_fun_ls_h_0) ((_lh_three_partitions_arg1_0 - _lh_listcomp_fun_ls_h_0) / 2))))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_0 ((enumFromTo_lh__d5 0) (_lh_three_partitions_arg1_0 / 3))));;
let rec rads_of_size_n_lh__d1 _lh_rads_of_size_n_arg1_0 _lh_rads_of_size_n_arg2_0 =
  (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_7 -> 
    (match _lh_listcomp_fun_para_7 with
                                ...
                                (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_1_0 -> 
                                  (match _lh_listcomp_fun_para_1_0 with
                                    | `LH_C(_lh_listcomp_fun_ls_h_1_0, _lh_listcomp_fun_ls_t_1_0) -> 
                                      (`LH_C((`C(_lh_rads_of_size_n_LH_C_0_0, _lh_rads_of_size_n_LH_C_0_1, _lh_listcomp_fun_ls_h_1_0)), (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_1_0)))
                                    | `LH_N -> 
      ...
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_7 (three_partitions_lh__d1 (_lh_rads_of_size_n_arg2_0 - 1))));;
let rec radical_generator_lh__d4 _lh_radical_generator_arg1_0 =
  (let rec radicals_0 = (lazy (`LH_C((`LH_C((`H), (`LH_N))), (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_1_1 -> 
    (match _lh_listcomp_fun_para_1_1 with
      | `LH_C(_lh_listcomp_fun_ls_h_1_1, _lh_listcomp_fun_ls_t_1_1) -> 
        (lazy (`LH_C(((rads_of_size_n_lh__d1 radicals_0) _lh_listcomp_fun_ls_h_1_1), (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_1_1))))
      | `LH_N -> 
        (lazy (`LH_N)))) in
    (_lh_listcomp_fun_1_1 ((enumFromTo_lh__d5 1) _lh_radical_generator_arg1_0)))))) in
    radicals_0);;
              ...
              (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_1_3 -> 
                (match _lh_listcomp_fun_para_1_3 with
                  | `LH_C(_lh_listcomp_fun_ls_h_1_3, _lh_listcomp_fun_ls_t_1_3) -> 
                    (`LH_C((`BCP(_lh_bcp_generator_LH_C_0_0, _lh_listcomp_fun_ls_h_1_3)), (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_1_3)))
                  | `LH_N -> 
                    (_lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_1_2))) in
                (_lh_listcomp_fun_1_3 (`LH_C(_lh_bcp_generator_LH_C_0_0, _lh_bcp_generator_LH_C_1_0))))
            | _ -> 
              (_lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_1_2))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_1_2 (remainders_lh__d3 ((atIndex_lz_lh__d6 (_lh_bcp_generator_arg2_0 / 2)) _lh_bcp_generator_arg1_0)))));;
...
let rec bcp_until_lh__d1 _lh_bcp_until_arg1_0 =
  (let rec radicals_4 = (radical_generator_lh__d4 (_lh_bcp_until_arg1_0 / 2)) in
    (let rec _lh_listcomp_fun_2_9 = (fun _lh_listcomp_fun_para_2_9 -> 
      (match _lh_listcomp_fun_para_2_9 with
        | `LH_C(_lh_listcomp_fun_ls_h_2_9, _lh_listcomp_fun_ls_t_2_9) -> 
          (`LH_C((length_lh__d5 ((bcp_generator_lh__d2 radicals_4) _lh_listcomp_fun_ls_h_2_9)), (_lh_listcomp_fun_2_9 _lh_listcomp_fun_ls_t_2_9)))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_2_9 ((enumFromTo_lh__d4 1) _lh_bcp_until_arg1_0))));;
...
let rec radical_generator_lh__d2 _lh_radical_generator_arg1_2 =
  (let rec radicals_2 = (lazy (`LH_C((`LH_C((`H), (`LH_N))), (let rec _lh_listcomp_fun_2_0 = (fun _lh_listcomp_fun_para_2_0 -> 
    (match _lh_listcomp_fun_para_2_0 with
      | `LH_C(_lh_listcomp_fun_ls_h_2_0, _lh_listcomp_fun_ls_t_2_0) -> 
        (lazy (`LH_C(((rads_of_size_n_lh__d1 radicals_2) _lh_listcomp_fun_ls_h_2_0), (_lh_listcomp_fun_2_0 _lh_listcomp_fun_ls_t_2_0))))
      | `LH_N -> 
        (lazy (`LH_N)))) in
    (_lh_listcomp_fun_2_0 ((enumFromTo_lh__d5 1) _lh_radical_generator_arg1_2)))))) in
    radicals_2);;
                    ...
                    (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_6 -> 
                      (match _lh_listcomp_fun_para_6 with
                        | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_6) -> 
                          (`LH_C((`LH_P4(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_h_5, _lh_listcomp_fun_ls_h_6)), (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6)))
                        | `LH_N -> 
                          (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_5))) in
                      (_lh_listcomp_fun_6 (`LH_C((_lh_four_partitions_arg1_0 - ((_lh_listcomp_fun_ls_h_3 + _lh_listcomp_fun_ls_h_4) + _lh_listcomp_fun_ls_h_5)), (`LH_N)))))
                  | `LH_N -> 
                    (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4))) in
                (_lh_listcomp_fun_5 ((enumFromTo_lh__d5 ((max_lh__d1 _lh_listcomp_fun_ls_h_4) (((int_of_float (ceil ((float_of_int _lh_four_partitions_arg1_0) /. (float_of_int 2)))) - _lh_listcomp_fun_ls_h_3) - _lh_listcomp_fun_ls_h_4))) (((_lh_four_partitions_arg1_0 - _lh_listcomp_fun_ls_h_3) - _lh_listcomp_fun_ls_h_4) / 2))))
            | `LH_N -> 
              (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_3))) in
          (_lh_listcomp_fun_4 ((enumFromTo_lh__d5 _lh_listcomp_fun_ls_h_3) ((_lh_four_partitions_arg1_0 - _lh_listcomp_fun_ls_h_3) / 3))))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_3 ((enumFromTo_lh__d5 0) (_lh_four_partitions_arg1_0 / 4))));;
                                          ...
                                          (let rec _lh_listcomp_fun_2_7 = (fun _lh_listcomp_fun_para_2_7 -> 
                                            (match _lh_listcomp_fun_para_2_7 with
                                              | `LH_C(_lh_listcomp_fun_ls_h_2_7, _lh_listcomp_fun_ls_t_2_7) -> 
                                                (`LH_C((`CCP(_lh_ccp_generator_LH_C_0_3, _lh_ccp_generator_LH_C_0_4, _lh_ccp_generator_LH_C_0_5, _lh_listcomp_fun_ls_h_2_7)), (_lh_listcomp_fun_2_7 _lh_listcomp_fun_ls_t_2_7)))
                                              | `LH_N -> 
                                                (_lh_listcomp_fun_2_6 _lh_listcomp_fun_ls_t_2_6))) in
                                            (_lh_listcomp_fun_2_7 (if (_lh_ccp_generator_LH_P4_2_1 = _lh_ccp_generator_LH_P4_3_1) then
                                              (`LH_C(_lh_ccp_generator_LH_C_0_5, _lh_ccp_generator_LH_C_1_5))
                                            else
                                              ((atIndex_lz_lh__d5 _lh_ccp_generator_LH_P4_3_1) _lh_ccp_generator_arg1_1))))
                                        | _ -> 
                                          (_lh_listcomp_fun_2_6 _lh_listcomp_fun_ls_t_2_6))
                                    | `LH_N -> 
                                      (_lh_listcomp_fun_2_5 _lh_listcomp_fun_ls_t_2_5))) in
                                  (_lh_listcomp_fun_2_6 (remainders_lh__d2 (if (_lh_ccp_generator_LH_P4_1_1 = _lh_ccp_generator_LH_P4_2_1) then
                                    (`LH_C(_lh_ccp_generator_LH_C_0_4, _lh_ccp_generator_LH_C_1_4))
                                  else
                                    ((atIndex_lz_lh__d4 _lh_ccp_generator_LH_P4_2_1) _lh_ccp_generator_arg1_1)))))
                              | _ -> 
                                (_lh_listcomp_fun_2_5 _lh_listcomp_fun_ls_t_2_5))
                          | `LH_N -> 
                            (_lh_listcomp_fun_2_4 _lh_listcomp_fun_ls_t_2_4))) in
                        (_lh_listcomp_fun_2_5 (remainders_lh__d1 (if (_lh_ccp_generator_LH_P4_0_1 = _lh_ccp_generator_LH_P4_1_1) then
                          (`LH_C(_lh_ccp_generator_LH_C_0_3, _lh_ccp_generator_LH_C_1_3))
                        else
                          ((atIndex_lz_lh__d2 _lh_ccp_generator_LH_P4_1_1) _lh_ccp_generator_arg1_1)))))
                    | _ -> 
                      (_lh_listcomp_fun_2_4 _lh_listcomp_fun_ls_t_2_4))
                | `LH_N -> 
                  (_lh_listcomp_fun_2_3 _lh_listcomp_fun_ls_t_2_3))) in
              (_lh_listcomp_fun_2_4 (remainders_lh__d3 ((atIndex_lz_lh__d3 _lh_ccp_generator_LH_P4_0_1) _lh_ccp_generator_arg1_1))))
          | _ -> 
            (_lh_listcomp_fun_2_3 _lh_listcomp_fun_ls_t_2_3))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_2_3 (four_partitions_lh__d1 (_lh_ccp_generator_arg2_1 - 1))));;
              ...
              (let rec _lh_listcomp_fun_2_2 = (fun _lh_listcomp_fun_para_2_2 -> 
                (match _lh_listcomp_fun_para_2_2 with
                  | `LH_C(_lh_listcomp_fun_ls_h_2_2, _lh_listcomp_fun_ls_t_2_2) -> 
                    (`LH_C((`BCP(_lh_bcp_generator_LH_C_0_1, _lh_listcomp_fun_ls_h_2_2)), (_lh_listcomp_fun_2_2 _lh_listcomp_fun_ls_t_2_2)))
                  | `LH_N -> 
                    (_lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_2_1))) in
                (_lh_listcomp_fun_2_2 (`LH_C(_lh_bcp_generator_LH_C_0_1, _lh_bcp_generator_LH_C_1_1))))
            | _ -> 
              (_lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_2_1))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_2_1 (remainders_lh__d3 ((atIndex_lz_lh__d6 (_lh_bcp_generator_arg2_1 / 2)) _lh_bcp_generator_arg1_1)))));;
...
let rec paraffins_until_lh__d1 _lh_paraffins_until_arg1_0 =
  (let rec radicals_6 = (radical_generator_lh__d2 (_lh_paraffins_until_arg1_0 / 2)) in
    (let rec _lh_listcomp_fun_3_1 = (fun _lh_listcomp_fun_para_3_1 -> 
      (match _lh_listcomp_fun_para_3_1 with
        | `LH_C(_lh_listcomp_fun_ls_h_3_1, _lh_listcomp_fun_ls_t_3_1) -> 
          (`LH_C(((length_lh__d2 ((bcp_generator_lh__d1 radicals_6) _lh_listcomp_fun_ls_h_3_1)) + (length_lh__d3 ((ccp_generator_lh__d1 radicals_6) _lh_listcomp_fun_ls_h_3_1))), (_lh_listcomp_fun_3_1 _lh_listcomp_fun_ls_t_3_1)))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_3_1 ((enumFromTo_lh__d2 1) _lh_paraffins_until_arg1_0))));;
let rec atIndex_lz_lh__d1 n_5 ls_1_0 =
  (if (n_5 < 0) then
    (failwith "error")
  else
        ...
        (match _lh_listcomp_fun_ls_h_1_4 with
          | `LH_P4(_lh_ccp_generator_LH_P4_0_0, _lh_ccp_generator_LH_P4_1_0, _lh_ccp_generator_LH_P4_2_0, _lh_ccp_generator_LH_P4_3_0) -> 
            (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_1_5 -> 
                  ...
                  (match _lh_listcomp_fun_ls_h_1_5 with
                    | `LH_C(_lh_ccp_generator_LH_C_0_0, _lh_ccp_generator_LH_C_1_0) -> 
                      (let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_1_6 -> 
                            ...
                            (match _lh_listcomp_fun_ls_h_1_6 with
                              | `LH_C(_lh_ccp_generator_LH_C_0_1, _lh_ccp_generator_LH_C_1_1) -> 
                                (let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_1_7 -> 
                                          ...
                                          (let rec _lh_listcomp_fun_1_8 = (fun _lh_listcomp_fun_para_1_8 -> 
                                            (match _lh_listcomp_fun_para_1_8 with
                                              | `LH_C(_lh_listcomp_fun_ls_h_1_8, _lh_listcomp_fun_ls_t_1_8) -> 
                                                (`LH_C((`CCP(_lh_ccp_generator_LH_C_0_0, _lh_ccp_generator_LH_C_0_1, _lh_ccp_generator_LH_C_0_2, _lh_listcomp_fun_ls_h_1_8)), (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_1_8)))
                                              | `LH_N -> 
                                                (_lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_1_7))) in
                                            (_lh_listcomp_fun_1_8 (if (_lh_ccp_generator_LH_P4_2_0 = _lh_ccp_generator_LH_P4_3_0) then
                                              (`LH_C(_lh_ccp_generator_LH_C_0_2, _lh_ccp_generator_LH_C_1_2))
                                            else
                                  ...
                                  (_lh_listcomp_fun_1_7 (remainders_lh__d3 (if (_lh_ccp_generator_LH_P4_1_0 = _lh_ccp_generator_LH_P4_2_0) then
                                    (`LH_C(_lh_ccp_generator_LH_C_0_1, _lh_ccp_generator_LH_C_1_1))
                                  else
                        ...
                        (_lh_listcomp_fun_1_6 (remainders_lh__d3 (if (_lh_ccp_generator_LH_P4_0_0 = _lh_ccp_generator_LH_P4_1_0) then
                          (`LH_C(_lh_ccp_generator_LH_C_0_0, _lh_ccp_generator_LH_C_1_0))
                        else
              ...
              (_lh_listcomp_fun_1_5 (remainders_lh__d3 ((atIndex_lz_lh__d6 _lh_ccp_generator_LH_P4_0_0) _lh_ccp_generator_arg1_0))))
          | _ -> 
            (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_4))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_4 (four_partitions_lh__d1 (_lh_ccp_generator_arg2_0 - 1))));;
let rec radical_generator_lh__d3 _lh_radical_generator_arg1_1 =
  (let rec radicals_1 = (lazy (`LH_C((`LH_C((`H), (`LH_N))), (let rec _lh_listcomp_fun_1_9 = (fun _lh_listcomp_fun_para_1_9 -> 
    (match _lh_listcomp_fun_para_1_9 with
      | `LH_C(_lh_listcomp_fun_ls_h_1_9, _lh_listcomp_fun_ls_t_1_9) -> 
        (lazy (`LH_C(((rads_of_size_n_lh__d1 radicals_1) _lh_listcomp_fun_ls_h_1_9), (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_1_9))))
      | `LH_N -> 
        (lazy (`LH_N)))) in
    (_lh_listcomp_fun_1_9 ((enumFromTo_lh__d5 1) _lh_radical_generator_arg1_1)))))) in
    radicals_1);;
    ...
    (let rec _lh_listcomp_fun_3_0 = (fun _lh_listcomp_fun_para_3_0 -> 
      (match _lh_listcomp_fun_para_3_0 with
        | `LH_C(_lh_listcomp_fun_ls_h_3_0, _lh_listcomp_fun_ls_t_3_0) -> 
          (`LH_C((length_lh__d4 ((ccp_generator_lh__d2 radicals_5) _lh_listcomp_fun_ls_h_3_0)), (_lh_listcomp_fun_3_0 _lh_listcomp_fun_ls_t_3_0)))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_3_0 ((enumFromTo_lh__d3 1) _lh_ccp_until_arg1_0))));;
...
let rec radical_generator_lh__d1 _lh_radical_generator_arg1_3 =
  (let rec radicals_3 = (lazy (`LH_C((`LH_C((`H), (`LH_N))), (let rec _lh_listcomp_fun_2_8 = (fun _lh_listcomp_fun_para_2_8 -> 
    (match _lh_listcomp_fun_para_2_8 with
      | `LH_C(_lh_listcomp_fun_ls_h_2_8, _lh_listcomp_fun_ls_t_2_8) -> 
        (lazy (`LH_C(((rads_of_size_n_lh__d1 radicals_3) _lh_listcomp_fun_ls_h_2_8), (_lh_listcomp_fun_2_8 _lh_listcomp_fun_ls_t_2_8))))
      | `LH_N -> 
        (lazy (`LH_N)))) in
    (_lh_listcomp_fun_2_8 ((enumFromTo_lh__d5 1) _lh_radical_generator_arg1_3)))))) in
    radicals_3);;
let rec testParaffins_nofib_lh__d1 _lh_testParaffins_nofib_arg1_0 =
  (`LH_P4((let rec _lh_listcomp_fun_3_2 = (fun _lh_listcomp_fun_para_3_2 -> 
        ...
        (let rec _lh_listcomp_fun_3_3 = (fun _lh_listcomp_fun_para_3_3 -> 
          (match _lh_listcomp_fun_para_3_3 with
            | `LH_C(_lh_listcomp_fun_ls_h_3_3, _lh_listcomp_fun_ls_t_3_3) -> 
              (`LH_C((length_lh__d1 ((atIndex_lz_lh__d1 _lh_listcomp_fun_ls_h_3_3) _lh_listcomp_fun_ls_h_3_2)), (_lh_listcomp_fun_3_3 _lh_listcomp_fun_ls_t_3_3)))
            | `LH_N -> 
              (_lh_listcomp_fun_3_2 _lh_listcomp_fun_ls_t_3_2))) in
          (_lh_listcomp_fun_3_3 ((enumFromTo_lh__d1 0) _lh_testParaffins_nofib_arg1_0)))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_3_2 (`LH_C((radical_generator_lh__d1 _lh_testParaffins_nofib_arg1_0), (`LH_N))))), (bcp_until_lh__d1 _lh_testParaffins_nofib_arg1_0), (ccp_until_lh__d1 _lh_testParaffins_nofib_arg1_0), (paraffins_until_lh__d1 _lh_testParaffins_nofib_arg1_0)));;
end;;

...
let rec map_lh__d6 f_1 ls_4 =
  (ls_4 f_1);;
let rec map_lh__d3 f_6 ls_1_1 _lh_popOutId_0_0 _lh_popOutId_1_0 =
  (match ls_1_1 with
    | `LH_C(h_3_5, t_3_5) -> 
      (let rec t_3_6 = ((map_lh__d3 f_6) t_3_5) in
        (let rec h_3_6 = (f_6 h_3_5) in
          (let rec t_3_7 = ((map_lh__d6 _lh_popOutId_0_0) t_3_6) in
            (let rec h_3_7 = (_lh_popOutId_0_0 h_3_6) in

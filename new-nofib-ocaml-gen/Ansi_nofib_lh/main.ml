...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_only_expanded_Ansi_nofib_lh" (fun () -> ignore (let open Module_lumberhack_only_expanded.Module_lumberhack_only_expanded in ((testAnsi_nofib__d0 8))));

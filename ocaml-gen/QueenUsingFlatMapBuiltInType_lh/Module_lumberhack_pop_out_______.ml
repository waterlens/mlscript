...
let rec append_lh__d1 _lh_append_arg1_1 _lh_append_arg2_5 =
  (_lh_append_arg1_1 _lh_append_arg2_5);;
  ...
  (if (a_0 <= b_1) then
    (let rec _lh_flatMap_LH_C_1_0 = ((enumFromTo_lh__d1 (a_0 + 1)) b_1) in
      (let rec _lh_flatMap_LH_C_0_0 = a_0 in
        ((append_lh__d1 (_lh_popOutId_0_0 _lh_flatMap_LH_C_0_0)) ((flatMap_lh__d1 _lh_popOutId_0_0) _lh_flatMap_LH_C_1_0))))
  else
...
let rec flatMap_lh__d2 _lh_flatMap_arg1_3 _lh_flatMap_arg2_1 =
  (match _lh_flatMap_arg2_1 with
    ...
    | `LH_C(_lh_flatMap_LH_C_0_1, _lh_flatMap_LH_C_1_1) -> 
      ((append_lh__d2 (_lh_flatMap_arg1_3 _lh_flatMap_LH_C_0_1)) ((flatMap_lh__d2 _lh_flatMap_arg1_3) _lh_flatMap_LH_C_1_1))
    | _ -> 
      (failwith "error"));;
            ...
            (let rec _lh_append_LH_C_1_0 = (fun _lh_append_arg2_1 -> 
              ...
              (let rec _lh_append_LH_C_0_0 = (`LH_C(q_0, b_0)) in
                (fun _lh_append_arg2_2 -> 
                  (let rec _lh_append_LH_C_1_1 = ((append_lh__d1 _lh_append_LH_C_1_0) _lh_append_arg2_2) in
                    (let rec _lh_append_LH_C_0_1 = _lh_append_LH_C_0_0 in
                      (fun _lh_append_arg2_3 -> 
                        (`LH_C(_lh_append_LH_C_0_1, ((append_lh__d2 _lh_append_LH_C_1_1) _lh_append_arg2_3)))))))))
          else
            (fun _lh_append_arg2_4 -> 
              _lh_append_arg2_4)))) ((enumFromTo_lh__d1 1) _lh_gen_arg2_0)))) ((gen_lh__d1 (_lh_gen_arg1_0 - 1)) _lh_gen_arg2_0)));;

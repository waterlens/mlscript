...
let rec mappend_lh__d1 xs_3 ys_6 =
  (match xs_3 with
    | `LH_C(h_5, t_5) -> 
      (let rec tx_2 = ((mappend_lh__d1 t_5) ys_6) in
        (let rec hx_2 = h_5 in
          (fun f_5 ys_7 -> 
            (match ys_7 with
              | `LH_C(hy_3, ty_3) -> 
                (`LH_C(((f_5 hx_2) hy_3), ((tx_2 f_5) ty_3)))
              | `LH_N -> 
                (`LH_N)))))
    | `LH_N -> 
      ys_6);;
...
let rec pascal_lh__d1 =
  (lazy (`LH_C((`LH_C(1, (`LH_C(2, (`LH_C(1, (`LH_N))))))), ((map_lz_lh__d1 (fun line_0 -> 
    ((((mappend_lh__d1 line_0) (let rec tx_3 = (fun f_7 ys_9 -> 
      (`LH_N)) in
      (let rec hx_3 = 0 in
        (fun f_8 ys_1_0 -> 
          (match ys_1_0 with
            | `LH_C(hy_5, ty_5) -> 
              (`LH_C(((f_8 hx_3) hy_5), ((tx_3 f_8) ty_5)))
            | `LH_N -> 
              (`LH_N)))))) (fun a_3 b_3 -> 
      (a_3 + b_3))) (`LH_C(0, line_0))))) pascal_lh__d1))));;
    ...
    (let rec hx_4 = x_1 in
      (fun f_1_1 ys_1_2 -> 
        (match (Lazy.force ys_1_2) with
          | `LH_C(hy_6, ty_6) -> 
            (let rec tx_5 = (lazy (((Lazy.force tx_4) f_1_1) ty_6)) in
              (let rec hx_5 = ((f_1_1 hx_4) hy_6) in
                (fun f_1_2 hy_7 ty_7 -> 
                  (let rec t_9 = (match ty_7 with
                    | `LH_C(hy_8, ty_8) -> 
                      ((((Lazy.force tx_5) f_1_2) hy_8) ty_8)
                    | `LH_N -> 
                      (fun _lh_dummy_5 -> 
                        0)) in
                    (let rec h_9 = ((f_1_2 hx_5) hy_7) in
                      (fun _lh_dummy_6 -> 
                        (h_9 + (t_9 99))))))))
          | `LH_N -> 
            (fun f_1_3 hy_9 ty_9 _lh_dummy_7 -> 
              0))))));;
          ...
          (fun n_2 -> 
            (if (n_2 = 0) then
              ...
              (if ((n_2 - 1) < 0) then
                ...
                ((Lazy.force t_3) (n_2 - 1)))))))
    | `LH_N -> 
      (fun n_3 -> 
        (failwith "error"))));;
let rec neg_powers_lh__d1 =
  (lazy ((map_lz_lh__d2 (fun ys_1 -> 
    (lazy (((Lazy.force ((iterate_lh__d1 not) true)) (fun n_1 x_0 -> 
      (if n_1 then
        x_0
      else
        (0 - x_0)))) ys_1)))) powers_lh__d1));;
      ...
      (let rec hx_1 = a_1 in
        (fun ys_2 -> 
          (match (Lazy.force ys_2) with
            | `LH_C(hy_1, ty_1) -> 
              (let rec _lh_listcomp_fun_ls_t_0 = (tx_1 ty_1) in
                  ...
                  (let rec _lh_bernoulli_LH_P2_0_0 = hx_1 in
                    (fun _lh_listcomp_fun_ls_t_1 _lh_listcomp_fun_0 powers_0 -> 
                      (let rec t_1 = (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_1) in
                        (let rec h_1 = ((((match (tail_lh__d2 (tail_lh__d1 _lh_bernoulli_LH_P2_1_0)) with
                          | `LH_C(hy_2, ty_2) -> 
                            ((((Lazy.force powers_0) (fun a_2 b_2 -> 
                              (a_2 * b_2))) hy_2) ty_2)
                          | `LH_N -> 
                            (fun _lh_dummy_0 -> 
                              0)) 99) - _lh_bernoulli_LH_P2_0_0) / (_lh_bernoulli_LH_P2_0_0 + 1)) in
                          (fun _lh_dummy_1 -> 
                            (h_1 + (t_1 99)))))))) in
                  (fun _lh_listcomp_fun_1 powers_1 -> 
                    (((_lh_listcomp_fun_ls_h_0 _lh_listcomp_fun_ls_t_0) _lh_listcomp_fun_1) powers_1))))
            | `LH_N -> 
              (fun _lh_listcomp_fun_2 powers_2 _lh_dummy_2 -> 
                0)))))
  else
    (fun ys_3 _lh_listcomp_fun_3 powers_3 _lh_dummy_3 -> 
      0));;
let rec testBernoulli_nofib_lh__d1 _lh_testBernoulli_nofib_arg1_0 =
  (match _lh_testBernoulli_nofib_arg1_0 with
    | 0 -> 
      1
    | 1 -> 
      (0 - (1 / 2))
    | _ -> 
      (if ((_lh_testBernoulli_nofib_arg1_0 mod 2) = 1) then
        0
      else
        (let rec powers_4 = (if ((_lh_testBernoulli_nofib_arg1_0 - 1) < 0) then
          (failwith "error")
        else
          ((Lazy.force (Lazy.force neg_powers_lh__d1)) (_lh_testBernoulli_nofib_arg1_0 - 1))) in
          (((0 - 1) / 2) + ((let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_0 -> 
            ((_lh_listcomp_fun_para_0 _lh_listcomp_fun_4) powers_4)) in
            (_lh_listcomp_fun_4 (((enumFromTo_lh__d1 2) _lh_testBernoulli_nofib_arg1_0) pascal_lh__d1))) 99)))));;
end;;

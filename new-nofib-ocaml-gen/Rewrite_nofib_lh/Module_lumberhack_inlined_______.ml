      ...
      (let rec _lh_all_LH_C_0_1 = _lh_copy_arg2_0 in
        (fun _lh_all_arg1_2 -> 
          (if (_lh_all_arg1_2 _lh_all_LH_C_0_1) then
            (_lh_all_LH_C_1_1 _lh_all_arg1_2)
          else
            false)))));;
      ...
      (fun _lh_dummy_0 -> 
        ...
        and preorder_0 = (fun _lh_preorder_arg1_0 -> 
          (if ((eqListExpr_lh__d1 _lh_preorder_arg1_0) (`LH_N)) then
            ...
            ((let rec t_2_3 = (fun ys_5 -> 
              ys_5) in
              (let rec h_1_8 = (g_first_0 _lh_preorder_arg1_0) in
                (fun ys_6 -> 
                  (`LH_C(h_1_8, (t_2_3 ys_6)))))) (preorder_0 (g_rest_0 _lh_preorder_arg1_0)))))

    ...
    (let rec tx_0 = ((enumFromTo_d1_d0 (a_1 + 1)) b_1) in
      (let rec hx_0 = a_1 in
        (fun ys_1 -> 
          (match ys_1 with
            | `LH_C(hy_0, ty_0) -> 
              (let rec _lh_listcomp_fun_ls_t_4 = ((zip_d0_d0 tx_0) ty_0) in
                (let rec _lh_listcomp_fun_ls_h_4 = (let rec _lh_safe_LH_P2_1_0 = hy_0 in
                  (let rec _lh_safe_LH_P2_0_0 = hx_0 in
                    (fun _lh_listcomp_fun_ls_t_5 _lh_listcomp_fun_7 _lh_safe_arg2_1 m_1 -> 
                      (let rec _lh_and_LH_C_1_0 = (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_5) in
                  ...
                  (fun _lh_listcomp_fun_8 _lh_safe_arg2_2 m_2 -> 
                    ((((_lh_listcomp_fun_ls_h_4 _lh_listcomp_fun_ls_t_4) _lh_listcomp_fun_8) _lh_safe_arg2_2) m_2))))
            | `LH_N -> 
        ...
        (match _lh_popOutId_0_2 with
          | `LH_C(hy_1, ty_1) -> 
            (let rec _lh_listcomp_fun_ls_t_7 = ((zip_d0_d0_d0 tx_1) ty_1) in
              (let rec _lh_listcomp_fun_ls_h_6 = (let rec _lh_safe_LH_P2_1_1 = hy_1 in
                (let rec _lh_safe_LH_P2_0_1 = hx_1 in
                  (fun _lh_listcomp_fun_ls_t_8 _lh_listcomp_fun_1_3 _lh_safe_arg2_5 m_5 -> 
                    (let rec _lh_and_LH_C_1_1 = (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_8) in
                      (let rec _lh_and_LH_C_0_1 = (((_lh_safe_LH_P2_1_1 <> _lh_safe_arg2_5) && ((_lh_safe_LH_P2_0_1 + _lh_safe_LH_P2_1_1) <> (m_5 + _lh_safe_arg2_5))) && ((_lh_safe_LH_P2_0_1 - _lh_safe_LH_P2_1_1) <> (m_5 - _lh_safe_arg2_5))) in
                        (fun _lh_dummy_3 -> 
                          (if _lh_and_LH_C_0_1 then
                            ...
                            false))))))) in
                ((((_lh_listcomp_fun_ls_h_6 _lh_listcomp_fun_ls_t_7) _lh_popOutId_1_2) _lh_popOutId_2_2) _lh_popOutId_3_1)))
          | `LH_N -> 
            (fun _lh_dummy_4 -> 
              true))))
  else
...
and safe_d0_d0_d0 _lh_safe_arg1_1 _lh_safe_arg2_9 =
  (let rec m_9 = ((length_d1_d0_d0 _lh_safe_arg1_1) + 1) in
    (and_d0_d0_d0 (let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_5 -> 
      (((_lh_listcomp_fun_para_5 _lh_listcomp_fun_1_7) _lh_safe_arg2_9) m_9)) in

...
let rec enumFromTo_lh__d1 a_1 b_1 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (fun _lh_listcomp_fun_3 _lh_simulate_arg2_0 _lh_simulate_arg3_0 -> 
        (let rec t_4 = (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_1) in
          (let rec h_4 = (_lh_simulate_arg3_0 (infRand_lh__d0 _lh_simulate_arg2_0)) in
            (fun f_5 -> 
              (if (f_5 h_4) then
                (let rec t_5 = ((filter_lh__d1 f_5) t_4) in
                  (fun _lh_dummy_0 -> 
                    (1 + (length_lh__d1 t_5))))
              else
                ((filter_lh__d2 f_5) t_4)))))))
  else
    (fun _lh_listcomp_fun_4 _lh_simulate_arg2_1 _lh_simulate_arg3_1 f_6 _lh_dummy_1 -> 
      0));;
    ...
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo_lh__d0 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (fun _lh_listcomp_fun_0 -> 
          (`LH_C((sim_lh__d0 _lh_listcomp_fun_ls_h_0), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0))))))
  else

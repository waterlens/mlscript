...
let rec filter_lh__d1 f_1_4 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_2_6, t_2_6) -> 
      (if (f_1_4 h_2_6) then
        (`LH_C(h_2_6, ((filter_lh__d1 f_1_4) t_2_6)))
      else
    ...
    | `LH_C(h_1_4, t_1_4) -> 
      (let rec t_1_5 = ((map_lh__d6 f_8) t_1_4) in
        (let rec h_1_5 = (f_8 h_1_4) in
          ((mappend_lh__d8 h_1_5) (concat_lh__d5 t_1_5))))
    | `LH_N -> 
      (`LH_N));;
...
let rec foldl_lh__d1 f_3 i_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_4, t_4) -> 
      (((foldl_lh__d1 f_3) ((f_3 i_0) h_4)) t_4)
    | `LH_N -> 
      i_0);;
    ...
    | true -> 
      (let rec _lh_runStateT_StateT_0_2 = (fun s_1_0 -> 
        (let rec t_9 = (fun f_5 _lh_dummy_6 -> 
          (`LH_N)) in
          (let rec h_9 = (let rec _lh_bind_LH_P2_1_2 = s_1_0 in
            ...
            (fun f_6 -> 
              (let rec t_1_0 = ((map_lh__d5 f_6) t_9) in
                (let rec h_1_0 = (f_6 h_9) in
                  (fun _lh_dummy_7 -> 
                    ((mappend_lh__d8 h_1_0) (concat_lh__d4 t_1_0))))))))) in
...
let rec foldr_lh__d1 f_4 i_1 ls_4 =
  (match ls_4 with
    | `LH_C(h_8, t_8) -> 
      ((f_4 h_8) (((foldr_lh__d1 f_4) i_1) t_8))
    | `LH_N -> 
      i_1);;
    ...
    | `LH_C(h_2, t_2) -> 
      (let rec t_3 = ((map_lh__d3 f_2) t_2) in
        (let rec h_3 = (f_2 h_2) in
          ((mappend_lh__d7 h_3) (concat_lh__d2 t_3))))
    | `LH_N -> 
      (`LH_N));;
        ...
        | `LH_P2(_lh_execStateT_LH_P2_0_0, _lh_execStateT_LH_P2_1_0) -> 
          (let rec t_2_5 = (fun ys_1_7 -> 
            ...
            (let rec h_2_5 = _lh_execStateT_LH_P2_1_0 in
              (fun ys_1_8 -> 
                (`LH_C(h_2_5, ((mappend_lh__d7 t_2_5) ys_1_8))))))
        | _ -> 
...
let rec map_lh__d2 f_9 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C((f_9 h_1_6), ((map_lh__d2 f_9) t_1_6)))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `LH_C(h_1_1, t_1_1) -> 
      (let rec t_1_2 = ((mappend_lh__d5 t_1_1) ys_5) in
        (let rec h_1_2 = h_1_1 in
          (fun ys_6 -> 
            (`LH_C(h_1_2, ((mappend_lh__d4 t_1_2) ys_6))))))
    | `LH_N -> 
      ys_5);;
                          ...
                          (match _lh_listcomp_fun_ls_h_1 with
                            | `LH_P2(_lh_puzzle_LH_P2_0_0, _lh_puzzle_LH_P2_1_0) -> 
                              (let rec t_1_7 = (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1) in
                                (let rec h_1_7 = ((mappend_lh__d3 ((mappend_lh__d2 (let rec t_1_8 = (fun ys_9 -> 
                                  ys_9) in
                                    ...
                                    (fun ys_1_0 -> 
                                      (let rec t_1_9 = ((mappend_lh__d2 t_1_8) ys_1_0) in
                                        (let rec h_1_9 = h_1_8 in
                                          (fun ys_1_1 -> 
                                            (`LH_C(h_1_9, ((mappend_lh__d3 t_1_9) ys_1_1)))))))))) (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (fun ys_1_2 -> 
                                  ys_1_2) in
                                  (let rec h_2_0 = ' ' in
                                    (fun ys_1_3 -> 
                                      (`LH_C(h_2_0, ((mappend_lh__d3 t_2_3) ys_1_3)))))) in
                                  (let rec h_2_1 = '>' in
                                    (fun ys_1_4 -> 
                                      (`LH_C(h_2_1, ((mappend_lh__d3 t_2_2) ys_1_4)))))) in
                                  (let rec h_2_2 = '=' in
                                    (fun ys_1_5 -> 
                                      (`LH_C(h_2_2, ((mappend_lh__d3 t_2_1) ys_1_5)))))) in
                                  (let rec h_2_3 = ' ' in
                                    (fun ys_1_6 -> 
                                      (`LH_C(h_2_3, ((mappend_lh__d3 t_2_0) ys_1_6)))))))) (string_of_int _lh_puzzle_LH_P2_1_0)) in
                                  (fun f_1_0 -> 
                                    (let rec t_2_4 = ((map_lh__d4 f_1_0) t_1_7) in
                                      (let rec h_2_4 = (f_1_0 h_1_7) in
                                        (fun _lh_dummy_1_3 -> 
                                          ((mappend_lh__d8 h_2_4) (concat_lh__d3 t_2_4))))))))
                            | _ -> 
...
let rec enumFromTo_lh__d1 a_0 b_0 _lh_popOutId_0_0 =
  (if (a_0 <= b_0) then
    (let rec t_1 = ((enumFromTo_lh__d1 (a_0 + 1)) b_0) in
      (let rec h_1 = a_0 in
        (`LH_C((_lh_popOutId_0_0 h_1), ((map_lh__d1 _lh_popOutId_0_0) t_1)))))
  else
    (`LH_N));;
let rec testCryptarithm2_nofib_lh__d1 _lh_testCryptarithm2_nofib_arg1_0 =
  ((map_lh__d1 (fun i_2 -> 
    (let rec args_0 = (`LH_C((`LH_C('T', (`LH_C('H', (`LH_C('I', (`LH_C('R', (`LH_C('T', (`LH_C('Y', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C(((mappend_lh__d1 (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (fun ys_1_9 -> 
      ...
      (let rec h_2_7 = 'E' in
        (fun ys_2_0 -> 
          (`LH_C(h_2_7, ((mappend_lh__d1 t_3_2) ys_2_0)))))) in
      (let rec h_2_8 = 'V' in
        (fun ys_2_1 -> 
          (`LH_C(h_2_8, ((mappend_lh__d1 t_3_1) ys_2_1)))))) in
      (let rec h_2_9 = 'L' in
        (fun ys_2_2 -> 
          (`LH_C(h_2_9, ((mappend_lh__d1 t_3_0) ys_2_2)))))) in
      (let rec h_3_0 = 'E' in
        (fun ys_2_3 -> 
          (`LH_C(h_3_0, ((mappend_lh__d1 t_2_9) ys_2_3)))))) in
      (let rec h_3_1 = 'W' in
        (fun ys_2_4 -> 
          (`LH_C(h_3_1, ((mappend_lh__d1 t_2_8) ys_2_4)))))) in
      (let rec h_3_2 = 'T' in
        (fun ys_2_5 -> 
          (`LH_C(h_3_2, ((mappend_lh__d1 t_2_7) ys_2_5))))))) (if (i_2 > 999999) then
      (`LH_C('1', (`LH_N)))
    else
      (`LH_N))), (`LH_N))))))))))))) in

(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./Lumherhack_Common.ml ./Lumberhack_LargeStr.ml ./Module_original___________.ml ./Module_lumberhack_________.ml ./Module_lumberhack_pop_out_.ml ./mainRev.ml -o SumSquareTreeRev.out -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./SumSquareTreeRev.out +time
*)
open Core_bench;;

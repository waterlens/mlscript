...
let rec zip_lh xs_7 ys_2 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 _lh_popOutId_3_1 _lh_popOutId_4_1 =
  (match xs_7 with
    | `LH_C(hx_2, tx_2) -> 
      (match ys_2 with
        | `LH_C(hy_4, ty_4) -> 
          (let rec _lh_listcomp_fun_ls_t_6 = ((zip_lh tx_2) ty_4) in
            (let rec _lh_listcomp_fun_ls_h_6 = (let rec _lh_store_inputs_LH_P2_1_0 = hy_4 in
              ...
              ((((((_lh_listcomp_fun_ls_h_6 _lh_listcomp_fun_ls_t_6) _lh_popOutId_0_1) _lh_popOutId_1_1) _lh_popOutId_2_1) _lh_popOutId_3_1) _lh_popOutId_4_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec do_cycle_lh _lh_do_cycle_arg1_0 _lh_do_cycle_arg2_0 _lh_do_cycle_arg3_0 =
  (match _lh_do_cycle_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec regs_lh _lh_regs_arg1_0 _lh_dummy_0 _lh_simulate_arg1_0 =

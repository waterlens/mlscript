    ...
    | `LH_C(h_8_5, t_8_5) -> 
      (let rec t_8_6 = ((mappend_lh__d2 t_8_5) ys_2_9) in
        (let rec h_8_6 = h_8_5 in
          (fun ys_3_0 -> 
            (let rec t_8_7 = ((mappend_lh__d1 t_8_6) ys_3_0) in
    ...
    | `LH_C(h_8_3, t_8_3) -> 
      (let rec t_8_4 = ((mappend_lh__d7 t_8_3) ys_2_7) in
        (let rec h_8_4 = h_8_3 in
          (fun ys_2_8 -> 
            (`LH_C(h_8_4, ((mappend_lh__d8 t_8_4) ys_2_8))))))
    | `LH_N -> 
      ys_2_7);;
  ...
  (match _lh_makeResponse_arg1_0 with
    | `LH_C(_lh_makeResponse_LH_C_0_0, _lh_makeResponse_LH_C_1_0) -> 
      (match _lh_makeResponse_LH_C_0_0 with
        | '?' -> 
          ((mappend_lh__d3 ((mappend_lh__d8 ((mappend_lh__d7 _lh_makeResponse_LH_C_1_0) (let rec t_9_5 = (fun ys_3_8 -> 
            ys_3_8) in
            (let rec h_9_5 = ' ' in
              (fun ys_3_9 -> 
                (`LH_C(h_9_5, ((mappend_lh__d8 t_9_5) ys_3_9)))))))) _lh_makeResponse_arg2_0)) (`LH_C('?', (`LH_N))))
        | '.' -> 
          ((mappend_lh__d4 ((mappend_lh__d6 ((mappend_lh__d5 _lh_makeResponse_LH_C_1_0) (let rec t_9_6 = (fun ys_4_0 -> 
            ys_4_0) in
            (let rec h_9_6 = ' ' in
              (fun ys_4_1 -> 
                (`LH_C(h_9_6, ((mappend_lh__d6 t_9_6) ys_4_1)))))))) _lh_makeResponse_arg2_0)) (`LH_C('.', (`LH_N))))
        | _ -> 
...
let rec prefix_lh__d1 _lh_prefix_arg1_0 _lh_prefix_arg2_0 =
  (let rec _lh_matchIdent_2_1 = _lh_prefix_arg1_0 in
    (match _lh_matchIdent_2_1 with
      | `LH_N -> 
        true
      | `LH_C(_lh_prefix_LH_C_0_3, _lh_prefix_LH_C_1_3) -> 
        (let rec _lh_matchIdent_2_2 = (Lazy.force _lh_prefix_arg2_0) in
          ((_lh_matchIdent_2_2 _lh_prefix_LH_C_0_3) _lh_prefix_LH_C_1_3))
      | _ -> 
        (failwith "error")));;
let rec lz_map_lh__d1 _lh_lz_map_arg1_0 _lh_lz_map_arg2_0 =
  (let rec _lh_matchIdent_1_7 = _lh_lz_map_arg2_0 in
    (match _lh_matchIdent_1_7 with
      ...
      | _ -> 
        (failwith "error")));;
let rec map_lh__d4 f_6_1 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_0_1, t_1_0_1) -> 
      (`LH_C((f_6_1 h_1_0_1), ((map_lh__d4 f_6_1) t_1_0_1)))
    | `LH_N -> 
      (`LH_N));;
let rec toUpper_lh__d1 _lh_toUpper_arg1_0 =
  (let rec _lh_matchIdent_2_3 = _lh_toUpper_arg1_0 in
...
let rec tail_lh__d1 ls_9 =
  (match ls_9 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec map_lh__d3 f_3_2 ls_2 =
  (ls_2 f_3_2);;
let rec filter_lh__d2 f_6_2 ls_1_6 =
  (ls_1_6 f_6_2);;
let rec tails_lh__d1 _lh_tails_arg1_0 _lh_popOutId_0_0 =
    ...
    | _ -> 
      (let rec t_9_7 = (tails_lh__d1 (tail_lh__d1 _lh_tails_arg1_0)) in
        (let rec h_9_7 = _lh_tails_arg1_0 in
          (if (_lh_popOutId_0_0 h_9_7) then
            (fun f_5_7 -> 
              (let rec t_9_8 = ((filter_lh__d2 _lh_popOutId_0_0) t_9_7) in
                (let rec h_9_8 = h_9_7 in
                  (`LH_C((f_5_7 h_9_8), ((map_lh__d3 f_5_7) t_9_8))))))
          else
            ((filter_lh__d2 _lh_popOutId_0_0) t_9_7)))));;
...
let rec null_lh__d4 _lh_null_arg1_0 =
  (match _lh_null_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec foldr_lh__d2 f_4_8 i_2 ls_5 =
  ((ls_5 f_4_8) i_2);;
...
let rec null_lh__d5 _lh_null_arg1_3 =
  (match _lh_null_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d5 f_5_8 ls_1_1 _lh_popOutId_0_1 _lh_popOutId_1_0 =
  (match ls_1_1 with
    | `LH_C(h_9_9, t_9_9) -> 
      (let rec t_1_0_0 = ((map_lh__d5 f_5_8) t_9_9) in
        (let rec h_1_0_0 = (f_5_8 h_9_9) in
          ((_lh_popOutId_0_1 h_1_0_0) (((foldr_lh__d2 _lh_popOutId_0_1) _lh_popOutId_1_0) t_1_0_0))))
    | `LH_N -> 
      _lh_popOutId_1_0);;
let rec head_lh__d2 ls_4 =
  (match ls_4 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec map_lh__d7 f_3_0 ls_0 =
  (match ls_0 with
    | `LH_C(h_4_2, t_4_2) -> 
      (`LH_C((f_3_0 h_4_2), ((map_lh__d7 f_3_0) t_4_2)))
    | `LH_N -> 
      (`LH_N));;
let rec toUpper_lh__d2 _lh_toUpper_arg1_1 =
  (let rec _lh_matchIdent_2_5 = _lh_toUpper_arg1_1 in
...
let rec conjugates_lh__d1 =
  (let rec prepare_0 = (fun _lh_prepare_arg1_0 -> 
    ((map_lh__d6 (fun wr_0 -> 
      (let rec _lh_matchIdent_1_4 = wr_0 in
        (_lh_matchIdent_1_4 99)))) _lh_prepare_arg1_0)) in
    (let rec oneways_0 = (let rec t_4_6 = (fun ys_2 -> 
      ...
      (let rec h_4_6 = (let rec _lh_prepare_LH_P2_1_0 = (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_N))))))) in
        ...
        (fun ys_3 -> 
          (let rec t_4_7 = ((mappend_lh__d1_d2 t_4_6) ys_3) in
            (let rec h_4_7 = h_4_6 in
              (fun f_3_4 -> 
                (let rec _lh_listcomp_fun_ls_t_1 = ((map_lh__d6 f_3_4) t_4_7) in
                  (let rec _lh_listcomp_fun_ls_h_0 = (f_3_4 h_4_7) in
      ...
      (let rec bothways_0 = (let rec _lh_listcomp_fun_ls_t_2 = (let rec _lh_listcomp_fun_ls_t_3 = (let rec _lh_listcomp_fun_ls_t_4 = (let rec _lh_listcomp_fun_ls_t_5 = (let rec _lh_listcomp_fun_ls_t_6 = (let rec _lh_listcomp_fun_ls_t_7 = (fun _lh_listcomp_fun_2 _lh_dummy_2 f_3_5 _lh_conj_arg1_2 _lh_listcomp_fun_3 -> 
        (`LH_N)) in
              ...
              (let rec t_4_8 = (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_8) in
                (let rec h_4_8 = (let rec t_4_9 = (let rec t_5_0 = (fun ys_4 -> 
                  ...
                  (let rec h_4_9 = (let rec _lh_prepare_LH_P2_1_1 = _lh_conjugates_LH_P2_0_0 in
                    ...
                    (fun ys_5 -> 
                      (let rec t_5_1 = ((mappend_lh__d1_d3 t_5_0) ys_5) in
                        (let rec h_5_0 = h_4_9 in
                          (fun f_3_6 -> 
                            (let rec _lh_listcomp_fun_ls_t_1_0 = ((map_lh__d6 f_3_6) t_5_1) in
                              (let rec _lh_listcomp_fun_ls_h_2 = (f_3_6 h_5_0) in
                  ...
                  (let rec h_5_1 = (let rec _lh_prepare_LH_P2_1_2 = _lh_conjugates_LH_P2_1_0 in
                    ...
                    (fun ys_6 -> 
                      (let rec t_5_2 = ((mappend_lh__d1_d3 t_4_9) ys_6) in
                        (let rec h_5_2 = h_5_1 in
                          (fun f_3_7 -> 
                            (let rec _lh_listcomp_fun_ls_t_1_2 = ((map_lh__d6 f_3_7) t_5_2) in
                              (let rec _lh_listcomp_fun_ls_h_3 = (f_3_7 h_5_2) in
                  ...
                  (fun _lh_dummy_5 -> 
                    ((mappend_lh__d1_d3 h_4_8) (concat_lh__d1 t_4_8)))))))) in
              ...
              (let rec t_5_3 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_1_3) in
                (let rec h_5_3 = (let rec t_5_4 = (let rec t_5_5 = (fun ys_7 -> 
                  ...
                  (let rec h_5_4 = (let rec _lh_prepare_LH_P2_1_3 = _lh_conjugates_LH_P2_0_1 in
                    ...
                    (fun ys_8 -> 
                      (let rec t_5_6 = ((mappend_lh__d1_d3 t_5_5) ys_8) in
                        (let rec h_5_5 = h_5_4 in
                          (fun f_3_8 -> 
                            (let rec _lh_listcomp_fun_ls_t_1_5 = ((map_lh__d6 f_3_8) t_5_6) in
                              (let rec _lh_listcomp_fun_ls_h_5 = (f_3_8 h_5_5) in
                  ...
                  (let rec h_5_6 = (let rec _lh_prepare_LH_P2_1_4 = _lh_conjugates_LH_P2_1_1 in
                    ...
                    (fun ys_9 -> 
                      (let rec t_5_7 = ((mappend_lh__d1_d3 t_5_4) ys_9) in
                        (let rec h_5_7 = h_5_6 in
                          (fun f_3_9 -> 
                            (let rec _lh_listcomp_fun_ls_t_1_7 = ((map_lh__d6 f_3_9) t_5_7) in
                              (let rec _lh_listcomp_fun_ls_h_6 = (f_3_9 h_5_7) in
                  ...
                  (fun _lh_dummy_8 -> 
                    ((mappend_lh__d1_d3 h_5_3) (concat_lh__d1 t_5_3)))))))) in
              ...
              (let rec t_5_8 = (_lh_listcomp_fun_1_6 _lh_listcomp_fun_ls_t_1_8) in
                (let rec h_5_8 = (let rec t_5_9 = (let rec t_6_0 = (fun ys_1_0 -> 
                  ...
                  (let rec h_5_9 = (let rec _lh_prepare_LH_P2_1_5 = _lh_conjugates_LH_P2_0_2 in
                    ...
                    (fun ys_1_1 -> 
                      (let rec t_6_1 = ((mappend_lh__d1_d3 t_6_0) ys_1_1) in
                        (let rec h_6_0 = h_5_9 in
                          (fun f_4_0 -> 
                            (let rec _lh_listcomp_fun_ls_t_2_0 = ((map_lh__d6 f_4_0) t_6_1) in
                              (let rec _lh_listcomp_fun_ls_h_8 = (f_4_0 h_6_0) in
                  ...
                  (let rec h_6_1 = (let rec _lh_prepare_LH_P2_1_6 = _lh_conjugates_LH_P2_1_2 in
                    ...
                    (fun ys_1_2 -> 
                      (let rec t_6_2 = ((mappend_lh__d1_d3 t_5_9) ys_1_2) in
                        (let rec h_6_2 = h_6_1 in
                          (fun f_4_1 -> 
                            (let rec _lh_listcomp_fun_ls_t_2_2 = ((map_lh__d6 f_4_1) t_6_2) in
                              (let rec _lh_listcomp_fun_ls_h_9 = (f_4_1 h_6_2) in
                  ...
                  (fun _lh_dummy_1_1 -> 
                    ((mappend_lh__d1_d3 h_5_8) (concat_lh__d1 t_5_8)))))))) in
              ...
              (let rec t_6_3 = (_lh_listcomp_fun_2_2 _lh_listcomp_fun_ls_t_2_3) in
                (let rec h_6_3 = (let rec t_6_4 = (let rec t_6_5 = (fun ys_1_3 -> 
                  ...
                  (let rec h_6_4 = (let rec _lh_prepare_LH_P2_1_7 = _lh_conjugates_LH_P2_0_3 in
                    ...
                    (fun ys_1_4 -> 
                      (let rec t_6_6 = ((mappend_lh__d1_d3 t_6_5) ys_1_4) in
                        (let rec h_6_5 = h_6_4 in
                          (fun f_4_2 -> 
                            (let rec _lh_listcomp_fun_ls_t_2_5 = ((map_lh__d6 f_4_2) t_6_6) in
                              (let rec _lh_listcomp_fun_ls_h_1_1 = (f_4_2 h_6_5) in
                  ...
                  (let rec h_6_6 = (let rec _lh_prepare_LH_P2_1_8 = _lh_conjugates_LH_P2_1_3 in
                    ...
                    (fun ys_1_5 -> 
                      (let rec t_6_7 = ((mappend_lh__d1_d3 t_6_4) ys_1_5) in
                        (let rec h_6_7 = h_6_6 in
                          (fun f_4_3 -> 
                            (let rec _lh_listcomp_fun_ls_t_2_7 = ((map_lh__d6 f_4_3) t_6_7) in
                              (let rec _lh_listcomp_fun_ls_h_1_2 = (f_4_3 h_6_7) in
                  ...
                  (fun _lh_dummy_1_4 -> 
                    ((mappend_lh__d1_d3 h_6_3) (concat_lh__d1 t_6_3)))))))) in
              ...
              (let rec t_6_8 = (_lh_listcomp_fun_2_8 _lh_listcomp_fun_ls_t_2_8) in
                (let rec h_6_8 = (let rec t_6_9 = (let rec t_7_0 = (fun ys_1_6 -> 
                  ...
                  (let rec h_6_9 = (let rec _lh_prepare_LH_P2_1_9 = _lh_conjugates_LH_P2_0_4 in
                    ...
                    (fun ys_1_7 -> 
                      (let rec t_7_1 = ((mappend_lh__d1_d3 t_7_0) ys_1_7) in
                        (let rec h_7_0 = h_6_9 in
                          (fun f_4_4 -> 
                            (let rec _lh_listcomp_fun_ls_t_3_0 = ((map_lh__d6 f_4_4) t_7_1) in
                              (let rec _lh_listcomp_fun_ls_h_1_4 = (f_4_4 h_7_0) in
                  ...
                  (let rec h_7_1 = (let rec _lh_prepare_LH_P2_1_1_0 = _lh_conjugates_LH_P2_1_4 in
                    ...
                    (fun ys_1_8 -> 
                      (let rec t_7_2 = ((mappend_lh__d1_d3 t_6_9) ys_1_8) in
                        (let rec h_7_2 = h_7_1 in
                          (fun f_4_5 -> 
                            (let rec _lh_listcomp_fun_ls_t_3_2 = ((map_lh__d6 f_4_5) t_7_2) in
                              (let rec _lh_listcomp_fun_ls_h_1_5 = (f_4_5 h_7_2) in
                  ...
                  (fun _lh_dummy_1_7 -> 
                    ((mappend_lh__d1_d3 h_6_8) (concat_lh__d1 t_6_8)))))))) in
              ...
              (let rec t_7_3 = (_lh_listcomp_fun_3_4 _lh_listcomp_fun_ls_t_3_3) in
                (let rec h_7_3 = (let rec t_7_4 = (let rec t_7_5 = (fun ys_1_9 -> 
                  ...
                  (let rec h_7_4 = (let rec _lh_prepare_LH_P2_1_1_1 = _lh_conjugates_LH_P2_0_5 in
                    ...
                    (fun ys_2_0 -> 
                      (let rec t_7_6 = ((mappend_lh__d1_d3 t_7_5) ys_2_0) in
                        (let rec h_7_5 = h_7_4 in
                          (fun f_4_6 -> 
                            (let rec _lh_listcomp_fun_ls_t_3_5 = ((map_lh__d6 f_4_6) t_7_6) in
                              (let rec _lh_listcomp_fun_ls_h_1_7 = (f_4_6 h_7_5) in
                  ...
                  (let rec h_7_6 = (let rec _lh_prepare_LH_P2_1_1_2 = _lh_conjugates_LH_P2_1_5 in
                    ...
                    (fun ys_2_1 -> 
                      (let rec t_7_7 = ((mappend_lh__d1_d3 t_7_4) ys_2_1) in
                        (let rec h_7_7 = h_7_6 in
                          (fun f_4_7 -> 
                            (let rec _lh_listcomp_fun_ls_t_3_7 = ((map_lh__d6 f_4_7) t_7_7) in
                              (let rec _lh_listcomp_fun_ls_h_1_8 = (f_4_7 h_7_7) in
                  ...
                  (fun _lh_dummy_2_0 -> 
                    ((mappend_lh__d1_d3 h_7_3) (concat_lh__d1 t_7_3)))))))) in
  ...
  in ((fun _lh_funcomp_x_1_0 -> 
    ((fun _lh_funcomp_x_1_1 -> 
      ((fun _lh_funcomp_x_1_2 -> 
        (unwords_lh__d1 (trailingI_0 _lh_funcomp_x_1_2))) ((map_lh__d5 conj_0) _lh_funcomp_x_1_1))) ((maybe_0 _lh_conjug_arg1_0) _lh_funcomp_x_1_0))) _lh_conjug_arg2_0);;
let rec replies_lh__d1 _lh_replies_arg1_0 _lh_replies_arg2_0 =
  ((fun _lh_funcomp_x_7 -> 
    ((fun _lh_funcomp_x_8 -> 
      ((map_lh__d3 (fun _lh_funcomp_x_9 -> 
        ((conjug_lh__d1 _lh_replies_arg2_0) ((drop_lh__d1 (length_lh__d2 _lh_replies_arg1_0)) _lh_funcomp_x_9)))) ((filter_lh__d2 (fun ls_1_4 -> 
        ((prefix_lh__d1 _lh_replies_arg1_0) ((lz_map_lh__d1 ucase_lh__d1) ls_1_4)))) _lh_funcomp_x_8))) (tails_lh__d1 _lh_funcomp_x_7))) _lh_replies_arg2_0);;
  ...
  and ans_0 = (fun _lh_ans_arg1_0 _lh_ans_arg2_0 -> 
    (match _lh_ans_arg1_0 with
      | `LH_C(_lh_ans_LH_C_0_0, _lh_ans_LH_C_1_0) -> 
        (let rec _lh_matchIdent_1_5 = _lh_ans_LH_C_0_0 in
        ...
        (let rec _lh_session_LH_P2_1_0 = ((newKeyTab_lh__d1 _lh_answer_LH_P2_1_0) _lh_answer_arg1_0) in
          (let rec _lh_session_LH_P2_0_0 = _lh_answer_LH_P2_0_0 in
            (fun _lh_session_LH_C_0_1_4 _lh_session_LH_C_1_1_4 -> 
              ((mappend_lh__d1 ((mappend_lh__d2 _lh_session_LH_P2_0_0) (let rec t_7_8 = (let rec t_7_9 = (fun ys_2_2 -> 
                ys_2_2) in
                (let rec h_7_8 = 'n' in
                  (fun ys_2_3 -> 
                    (let rec t_8_0 = ((mappend_lh__d1 t_7_9) ys_2_3) in
                      (let rec h_7_9 = h_7_8 in
                        (fun _lh_dummy_2_1 -> 
                          (1 + (length_lh__d1 t_8_0)))))))) in
                (let rec h_8_0 = 'n' in
                  (fun ys_2_4 -> 
                    (let rec t_8_1 = ((mappend_lh__d1 t_7_8) ys_2_4) in
                      (let rec h_8_1 = h_8_0 in
                        (fun _lh_dummy_2_2 -> 
                          (1 + (length_lh__d1 t_8_1)))))))))) (((session_lh__d1 _lh_session_LH_P2_1_0) _lh_session_LH_C_0_1_4) _lh_session_LH_C_1_1_4)))))
      | _ -> 
        (failwith "error")));;
let rec foldr_lh__d1 f_3_1 i_1 ls_1 =
  (match ls_1 with
    | `LH_C(h_4_3, t_4_3) -> 
      ((f_3_1 h_4_3) (((foldr_lh__d1 f_3_1) i_1) t_4_3))
    | `LH_N -> 
      i_1);;
  ...
  (match _lh_break_arg2_1 with
    ...
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_1) then
        ...
        (let rec _lh_matchIdent_2_6 = ((break_lh__d1 _lh_break_arg1_1) _lh_break_LH_C_1_1) in
      ...
      (if (_lh_dropWhile_arg1_0 _lh_dropWhile_LH_C_0_0) then
        ...
        (let rec _lh_words_LH_C_1_0 = _lh_dropWhile_LH_C_1_0 in
          (let rec _lh_words_LH_C_0_0 = _lh_dropWhile_LH_C_0_0 in
            (fun _lh_dummy_2_5 -> 
              (let rec _lh_matchIdent_2_4 = ((break_lh__d1 isSpace_lh__d1) (`LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0))) in
...
words_lh__d1 _lh_words_arg1_0 =
  (let rec _lh_matchIdent_1_8 = ((dropWhile_lh__d1 isSpace_lh__d2) _lh_words_arg1_0) in
    (_lh_matchIdent_1_8 99));;
let rec map_lh__d1 f_5_3 ls_1_0 =
  (ls_1_0 f_5_3);;
let rec enumFromTo_lh__d1 a_0 b_0 =
  (if (a_0 <= b_0) then
    ...
    (`LH_N));;
let rec filter_lh__d1 f_3_3 ls_3 =
  (ls_3 f_3_3);;
          ...
          (let rec _lh_session_LH_P2_1_1 = (`LH_P2(_lh_repeated_LH_P2_0_0, _lh_repeated_LH_C_1_0)) in
            (let rec _lh_session_LH_P2_0_1 = _lh_repeated_LH_C_0_0 in
              (fun _lh_session_LH_C_0_1_5 _lh_session_LH_C_1_1_5 -> 
                ((mappend_lh__d1 ((mappend_lh__d2 _lh_session_LH_P2_0_1) (let rec t_1_0_3 = (let rec t_1_0_4 = (fun ys_4_2 -> 
                  ys_4_2) in
                  (let rec h_1_0_3 = 'n' in
                    (fun ys_4_3 -> 
                      (let rec t_1_0_5 = ((mappend_lh__d1 t_1_0_4) ys_4_3) in
                        (let rec h_1_0_4 = h_1_0_3 in
                          (fun _lh_dummy_2_7 -> 
                            (1 + (length_lh__d1 t_1_0_5)))))))) in
                  (let rec h_1_0_5 = 'n' in
                    (fun ys_4_4 -> 
                      (let rec t_1_0_6 = ((mappend_lh__d1 t_1_0_3) ys_4_4) in
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_1_9 = ((break_lh__d2 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
      ...
      (if (_lh_dropWhile_arg1_2 _lh_dropWhile_LH_C_0_2) then
        ...
        (let rec _lh_words_LH_C_1_1 = _lh_dropWhile_LH_C_1_2 in
          (let rec _lh_words_LH_C_0_1 = _lh_dropWhile_LH_C_0_2 in
            (fun _lh_dummy_3_0 -> 
              (let rec _lh_matchIdent_2_7 = ((break_lh__d2 isSpace_lh__d4) (`LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1))) in
...
words_lh__d2 _lh_words_arg1_1 =
  (let rec _lh_matchIdent_2_0 = ((dropWhile_lh__d3 isSpace_lh__d3) _lh_words_arg1_1) in
  ...
  (let rec repeatMsgs_0 = (`LH_C((`LH_C('W', (`LH_C('h', (`LH_C('y', (`LH_C(' ', (`LH_C('d', (`LH_C('i', (`LH_C('d', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('p', (`LH_C('e', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C('l', (`LH_C('f', (`LH_C('?', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C((`LH_C('D', (`LH_C('o', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('e', (`LH_C('x', (`LH_C('p', (`LH_C('e', (`LH_C('c', (`LH_C('t', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('d', (`LH_C('i', (`LH_C('f', (`LH_C('f', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('s', (`LH_C('w', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('b', (`LH_C('y', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('p', (`LH_C('e', (`LH_C('a', (`LH_C('t', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C('l', (`LH_C('f', (`LH_C('?', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C((`LH_C('C', (`LH_C('o', (`LH_C('m', (`LH_C('e', (`LH_C(',', (`LH_C(' ', (`LH_C('c', (`LH_C('o', (`LH_C('m', (`LH_C('e', (`LH_C(',', (`LH_C(' ', (`LH_C('e', (`LH_C('l', (`LH_C('u', (`LH_C('c', (`LH_C('i', (`LH_C('d', (`LH_C('a', (`LH_C('t', (`LH_C('e', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C(' ', (`LH_C('t', (`LH_C('h', (`LH_C('o', (`LH_C('u', (`LH_C('g', (`LH_C('h', (`LH_C('t', (`LH_C('s', (`LH_C('.', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C((`LH_C('P', (`LH_C('l', (`LH_C('e', (`LH_C('a', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_C('n', (`LH_C('_', (`LH_C('t', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('p', (`LH_C('e', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C('l', (`LH_C('f', (`LH_C('!', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_N))))))))) in
    (let rec respMsgs_0 = (let rec canYou_0 = (`LH_C((`LH_C('?', (`LH_C('D', (`LH_C('o', (`LH_C('n', (`LH_C('_', (`LH_C('t', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('b', (`LH_C('e', (`LH_C('l', (`LH_C('i', (`LH_C('e', (`LH_C('v', (`LH_C('e', (`LH_C(' ', (`LH_C('t', (`LH_C('h', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('I', (`LH_C(' ', (`LH_C('c', (`LH_C('a', (`LH_C('n', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C((`LH_C('?', (`LH_C('P', (`LH_C('e', (`LH_C('r', (`LH_C('h', (`LH_C('a', (`LH_C('p', (`LH_C('s', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('w', (`LH_C('o', (`LH_C('u', (`LH_C('l', (`LH_C('d', (`LH_C(' ', (`LH_C('l', (`LH_C('i', (`LH_C('k', (`LH_C('e', (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_C(' ', (`LH_C('b', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('b', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C((`LH_C('?', (`LH_C('Y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('w', (`LH_C('a', (`LH_C('n', (`LH_C('t', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_C(' ', (`LH_C('b', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('b', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_N))))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_1_9 = (let rec _lh_initial_LH_P2_1_0 = nokeyMsgs_0 in
                                                                (let rec _lh_initial_LH_P2_0_0 = (`LH_N) in
                                                                  (fun _lh_listcomp_fun_ls_t_7_8 _lh_listcomp_fun_4_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_0), (cycle_lh__d2 _lh_initial_LH_P2_1_0))), (_lh_listcomp_fun_4_3 _lh_listcomp_fun_ls_t_7_8)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_0 = (let rec _lh_initial_LH_P2_1_1 = friend_0 in
                                                                (let rec _lh_initial_LH_P2_0_1 = (`LH_C('F', (`LH_C('R', (`LH_C('I', (`LH_C('E', (`LH_C('N', (`LH_C('D', (`LH_C('S', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_7_9 _lh_listcomp_fun_4_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1), (cycle_lh__d2 _lh_initial_LH_P2_1_1))), (_lh_listcomp_fun_4_5 _lh_listcomp_fun_ls_t_7_9)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_1 = (let rec _lh_initial_LH_P2_1_2 = friend_0 in
                                                                (let rec _lh_initial_LH_P2_0_2 = (`LH_C('F', (`LH_C('R', (`LH_C('I', (`LH_C('E', (`LH_C('N', (`LH_C('D', (`LH_N))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_0 _lh_listcomp_fun_4_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2), (cycle_lh__d2 _lh_initial_LH_P2_1_2))), (_lh_listcomp_fun_4_7 _lh_listcomp_fun_ls_t_8_0)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_2 = (let rec _lh_initial_LH_P2_1_3 = alike_0 in
                                                                (let rec _lh_initial_LH_P2_0_3 = (`LH_C('A', (`LH_C('L', (`LH_C('I', (`LH_C('K', (`LH_C('E', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_1 _lh_listcomp_fun_4_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3), (cycle_lh__d2 _lh_initial_LH_P2_1_3))), (_lh_listcomp_fun_4_9 _lh_listcomp_fun_ls_t_8_1)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_3 = (let rec _lh_initial_LH_P2_1_4 = think_0 in
                                                                (let rec _lh_initial_LH_P2_0_4 = (`LH_C('T', (`LH_C('H', (`LH_C('I', (`LH_C('N', (`LH_C('K', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_2 _lh_listcomp_fun_5_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_4), (cycle_lh__d2 _lh_initial_LH_P2_1_4))), (_lh_listcomp_fun_5_1 _lh_listcomp_fun_ls_t_8_2)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_4 = (let rec _lh_initial_LH_P2_1_5 = always_0 in
                                                                (let rec _lh_initial_LH_P2_0_5 = (`LH_C('A', (`LH_C('L', (`LH_C('W', (`LH_C('A', (`LH_C('Y', (`LH_C('S', (`LH_N))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_3 _lh_listcomp_fun_5_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_5), (cycle_lh__d2 _lh_initial_LH_P2_1_5))), (_lh_listcomp_fun_5_3 _lh_listcomp_fun_ls_t_8_3)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_5 = (let rec _lh_initial_LH_P2_1_6 = your_0 in
                                                                (let rec _lh_initial_LH_P2_0_6 = (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_C('R', (`LH_N))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_4 _lh_listcomp_fun_5_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_6), (cycle_lh__d2 _lh_initial_LH_P2_1_6))), (_lh_listcomp_fun_5_5 _lh_listcomp_fun_ls_t_8_4)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_6 = (let rec _lh_initial_LH_P2_1_7 = maybe_1 in
                                                                (let rec _lh_initial_LH_P2_0_7 = (`LH_C('M', (`LH_C('A', (`LH_C('Y', (`LH_C('B', (`LH_C('E', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_5 _lh_listcomp_fun_5_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_7), (cycle_lh__d2 _lh_initial_LH_P2_1_7))), (_lh_listcomp_fun_5_7 _lh_listcomp_fun_ls_t_8_5)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_7 = (let rec _lh_initial_LH_P2_1_8 = hello_0 in
                                                                (let rec _lh_initial_LH_P2_0_8 = (`LH_C('H', (`LH_C('E', (`LH_C('L', (`LH_C('L', (`LH_C('O', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_6 _lh_listcomp_fun_5_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_8), (cycle_lh__d2 _lh_initial_LH_P2_1_8))), (_lh_listcomp_fun_5_9 _lh_listcomp_fun_ls_t_8_6)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_8 = (let rec _lh_initial_LH_P2_1_9 = hello_0 in
                                                                (let rec _lh_initial_LH_P2_0_9 = (`LH_C('H', (`LH_C('I', (`LH_N))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_7 _lh_listcomp_fun_6_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_9), (cycle_lh__d2 _lh_initial_LH_P2_1_9))), (_lh_listcomp_fun_6_1 _lh_listcomp_fun_ls_t_8_7)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_2_9 = (let rec _lh_initial_LH_P2_1_1_0 = dream_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_0 = (`LH_C('D', (`LH_C('R', (`LH_C('E', (`LH_C('A', (`LH_C('M', (`LH_C('S', (`LH_N))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_8 _lh_listcomp_fun_6_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_0), (cycle_lh__d2 _lh_initial_LH_P2_1_1_0))), (_lh_listcomp_fun_6_3 _lh_listcomp_fun_ls_t_8_8)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_0 = (let rec _lh_initial_LH_P2_1_1_1 = dream_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_1 = (`LH_C('D', (`LH_C('R', (`LH_C('E', (`LH_C('A', (`LH_C('M', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_8_9 _lh_listcomp_fun_6_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_1), (cycle_lh__d2 _lh_initial_LH_P2_1_1_1))), (_lh_listcomp_fun_6_5 _lh_listcomp_fun_ls_t_8_9)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_1 = (let rec _lh_initial_LH_P2_1_1_2 = sorry_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_2 = (`LH_C('S', (`LH_C('O', (`LH_C('R', (`LH_C('R', (`LH_C('Y', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_0 _lh_listcomp_fun_6_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_2), (cycle_lh__d2 _lh_initial_LH_P2_1_1_2))), (_lh_listcomp_fun_6_7 _lh_listcomp_fun_ls_t_9_0)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_2 = (let rec _lh_initial_LH_P2_1_1_3 = because_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_3 = (`LH_C('C', (`LH_C('A', (`LH_C('U', (`LH_C('S', (`LH_C('E', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_1 _lh_listcomp_fun_6_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_3), (cycle_lh__d2 _lh_initial_LH_P2_1_1_3))), (_lh_listcomp_fun_6_9 _lh_listcomp_fun_ls_t_9_1)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_3 = (let rec _lh_initial_LH_P2_1_1_4 = because_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_4 = (`LH_C('B', (`LH_C('E', (`LH_C('C', (`LH_C('A', (`LH_C('U', (`LH_C('S', (`LH_C('E', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_2 _lh_listcomp_fun_7_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_4), (cycle_lh__d2 _lh_initial_LH_P2_1_1_4))), (_lh_listcomp_fun_7_1 _lh_listcomp_fun_ls_t_9_2)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_4 = (let rec _lh_initial_LH_P2_1_1_5 = name_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_5 = (`LH_C('N', (`LH_C('A', (`LH_C('M', (`LH_C('E', (`LH_N))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_3 _lh_listcomp_fun_7_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_5), (cycle_lh__d2 _lh_initial_LH_P2_1_1_5))), (_lh_listcomp_fun_7_3 _lh_listcomp_fun_ls_t_9_3)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_5 = (let rec _lh_initial_LH_P2_1_1_6 = question_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_6 = (`LH_C('W', (`LH_C('H', (`LH_C('Y', (`LH_N))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_4 _lh_listcomp_fun_7_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_6), (cycle_lh__d2 _lh_initial_LH_P2_1_1_6))), (_lh_listcomp_fun_7_5 _lh_listcomp_fun_ls_t_9_4)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_6 = (let rec _lh_initial_LH_P2_1_1_7 = question_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_7 = (`LH_C('W', (`LH_C('H', (`LH_C('E', (`LH_C('N', (`LH_N))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_5 _lh_listcomp_fun_7_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_7), (cycle_lh__d2 _lh_initial_LH_P2_1_1_7))), (_lh_listcomp_fun_7_7 _lh_listcomp_fun_ls_t_9_5)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_7 = (let rec _lh_initial_LH_P2_1_1_8 = question_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_8 = (`LH_C('W', (`LH_C('H', (`LH_C('E', (`LH_C('R', (`LH_C('E', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_6 _lh_listcomp_fun_7_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_8), (cycle_lh__d2 _lh_initial_LH_P2_1_1_8))), (_lh_listcomp_fun_7_9 _lh_listcomp_fun_ls_t_9_6)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_8 = (let rec _lh_initial_LH_P2_1_1_9 = question_0 in
                                                                (let rec _lh_initial_LH_P2_0_1_9 = (`LH_C('W', (`LH_C('H', (`LH_C('O', (`LH_N))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_7 _lh_listcomp_fun_8_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_1_9), (cycle_lh__d2 _lh_initial_LH_P2_1_1_9))), (_lh_listcomp_fun_8_1 _lh_listcomp_fun_ls_t_9_7)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_3_9 = (let rec _lh_initial_LH_P2_1_2_0 = question_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_0 = (`LH_C('H', (`LH_C('O', (`LH_C('W', (`LH_N))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_8 _lh_listcomp_fun_8_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_0), (cycle_lh__d2 _lh_initial_LH_P2_1_2_0))), (_lh_listcomp_fun_8_3 _lh_listcomp_fun_ls_t_9_8)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_0 = (let rec _lh_initial_LH_P2_1_2_1 = question_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_1 = (`LH_C('W', (`LH_C('H', (`LH_C('A', (`LH_C('T', (`LH_N))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_9_9 _lh_listcomp_fun_8_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_1), (cycle_lh__d2 _lh_initial_LH_P2_1_2_1))), (_lh_listcomp_fun_8_5 _lh_listcomp_fun_ls_t_9_9)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_1 = (let rec _lh_initial_LH_P2_1_2_2 = iWant_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_2 = (`LH_C('I', (`LH_C(' ', (`LH_C('W', (`LH_C('A', (`LH_C('N', (`LH_C('T', (`LH_N))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_0 _lh_listcomp_fun_8_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_2), (cycle_lh__d2 _lh_initial_LH_P2_1_2_2))), (_lh_listcomp_fun_8_7 _lh_listcomp_fun_ls_t_1_0_0)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_2 = (let rec _lh_initial_LH_P2_1_2_3 = computer_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_3 = (`LH_C('C', (`LH_C('O', (`LH_C('M', (`LH_C('P', (`LH_C('U', (`LH_C('T', (`LH_C('E', (`LH_C('R', (`LH_C('S', (`LH_N))))))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_1 _lh_listcomp_fun_8_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_3), (cycle_lh__d2 _lh_initial_LH_P2_1_2_3))), (_lh_listcomp_fun_8_9 _lh_listcomp_fun_ls_t_1_0_1)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_3 = (let rec _lh_initial_LH_P2_1_2_4 = computer_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_4 = (`LH_C('C', (`LH_C('O', (`LH_C('M', (`LH_C('P', (`LH_C('U', (`LH_C('T', (`LH_C('E', (`LH_C('R', (`LH_N))))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_2 _lh_listcomp_fun_9_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_4), (cycle_lh__d2 _lh_initial_LH_P2_1_2_4))), (_lh_listcomp_fun_9_1 _lh_listcomp_fun_ls_t_1_0_2)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_4 = (let rec _lh_initial_LH_P2_1_2_5 = no_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_5 = (`LH_C('N', (`LH_C('O', (`LH_N))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_3 _lh_listcomp_fun_9_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_5), (cycle_lh__d2 _lh_initial_LH_P2_1_2_5))), (_lh_listcomp_fun_9_3 _lh_listcomp_fun_ls_t_1_0_3)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_5 = (let rec _lh_initial_LH_P2_1_2_6 = yes_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_6 = (`LH_C('Y', (`LH_C('E', (`LH_C('S', (`LH_N))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_4 _lh_listcomp_fun_9_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_6), (cycle_lh__d2 _lh_initial_LH_P2_1_2_6))), (_lh_listcomp_fun_9_5 _lh_listcomp_fun_ls_t_1_0_4)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_6 = (let rec _lh_initial_LH_P2_1_2_7 = you_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_7 = (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_N))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_5 _lh_listcomp_fun_9_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_7), (cycle_lh__d2 _lh_initial_LH_P2_1_2_7))), (_lh_listcomp_fun_9_7 _lh_listcomp_fun_ls_t_1_0_5)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_7 = (let rec _lh_initial_LH_P2_1_2_8 = iAm_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_8 = (`LH_C('I', (`LH_C('_', (`LH_C('M', (`LH_N))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_6 _lh_listcomp_fun_9_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_8), (cycle_lh__d2 _lh_initial_LH_P2_1_2_8))), (_lh_listcomp_fun_9_9 _lh_listcomp_fun_ls_t_1_0_6)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_8 = (let rec _lh_initial_LH_P2_1_2_9 = iAm_0 in
                                                                (let rec _lh_initial_LH_P2_0_2_9 = (`LH_C('I', (`LH_C(' ', (`LH_C('A', (`LH_C('M', (`LH_N))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_7 _lh_listcomp_fun_1_0_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_2_9), (cycle_lh__d2 _lh_initial_LH_P2_1_2_9))), (_lh_listcomp_fun_1_0_1 _lh_listcomp_fun_ls_t_1_0_7)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_4_9 = (let rec _lh_initial_LH_P2_1_3_0 = iCant_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_0 = (`LH_C('I', (`LH_C(' ', (`LH_C('C', (`LH_C('A', (`LH_C('N', (`LH_C('_', (`LH_C('T', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_8 _lh_listcomp_fun_1_0_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_0), (cycle_lh__d2 _lh_initial_LH_P2_1_3_0))), (_lh_listcomp_fun_1_0_3 _lh_listcomp_fun_ls_t_1_0_8)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_0 = (let rec _lh_initial_LH_P2_1_3_1 = areYou_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_1 = (`LH_C('A', (`LH_C('R', (`LH_C('E', (`LH_C(' ', (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_0_9 _lh_listcomp_fun_1_0_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_1), (cycle_lh__d2 _lh_initial_LH_P2_1_3_1))), (_lh_listcomp_fun_1_0_5 _lh_listcomp_fun_ls_t_1_0_9)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_1 = (let rec _lh_initial_LH_P2_1_3_2 = whyCant_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_2 = (`LH_C('W', (`LH_C('H', (`LH_C('Y', (`LH_C(' ', (`LH_C('C', (`LH_C('A', (`LH_C('N', (`LH_C('_', (`LH_C('T', (`LH_C(' ', (`LH_C('I', (`LH_N))))))))))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_0 _lh_listcomp_fun_1_0_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_2), (cycle_lh__d2 _lh_initial_LH_P2_1_3_2))), (_lh_listcomp_fun_1_0_7 _lh_listcomp_fun_ls_t_1_1_0)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_2 = (let rec _lh_initial_LH_P2_1_3_3 = whyDont_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_3 = (`LH_C('W', (`LH_C('H', (`LH_C('Y', (`LH_C(' ', (`LH_C('D', (`LH_C('O', (`LH_C('N', (`LH_C('_', (`LH_C('T', (`LH_C(' ', (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_N))))))))))))))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_1 _lh_listcomp_fun_1_0_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_3), (cycle_lh__d2 _lh_initial_LH_P2_1_3_3))), (_lh_listcomp_fun_1_0_9 _lh_listcomp_fun_ls_t_1_1_1)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_3 = (let rec _lh_initial_LH_P2_1_3_4 = iFeel_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_4 = (`LH_C('I', (`LH_C(' ', (`LH_C('F', (`LH_C('E', (`LH_C('E', (`LH_C('L', (`LH_N))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_2 _lh_listcomp_fun_1_1_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_4), (cycle_lh__d2 _lh_initial_LH_P2_1_3_4))), (_lh_listcomp_fun_1_1_1 _lh_listcomp_fun_ls_t_1_1_2)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_4 = (let rec _lh_initial_LH_P2_1_3_5 = iDont_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_5 = (`LH_C('I', (`LH_C(' ', (`LH_C('D', (`LH_C('O', (`LH_C('N', (`LH_C('_', (`LH_C('T', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_3 _lh_listcomp_fun_1_1_3 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_5), (cycle_lh__d2 _lh_initial_LH_P2_1_3_5))), (_lh_listcomp_fun_1_1_3 _lh_listcomp_fun_ls_t_1_1_3)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_5 = (let rec _lh_initial_LH_P2_1_3_6 = youAre_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_6 = (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_C('_', (`LH_C('R', (`LH_C('E', (`LH_N))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_4 _lh_listcomp_fun_1_1_5 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_6), (cycle_lh__d2 _lh_initial_LH_P2_1_3_6))), (_lh_listcomp_fun_1_1_5 _lh_listcomp_fun_ls_t_1_1_4)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_6 = (let rec _lh_initial_LH_P2_1_3_7 = youAre_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_7 = (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_C(' ', (`LH_C('A', (`LH_C('R', (`LH_C('E', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_5 _lh_listcomp_fun_1_1_7 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_7), (cycle_lh__d2 _lh_initial_LH_P2_1_3_7))), (_lh_listcomp_fun_1_1_7 _lh_listcomp_fun_ls_t_1_1_5)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_7 = (let rec _lh_initial_LH_P2_1_3_8 = canI_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_8 = (`LH_C('C', (`LH_C('A', (`LH_C('N', (`LH_C(' ', (`LH_C('I', (`LH_N))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_6 _lh_listcomp_fun_1_1_9 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_8), (cycle_lh__d2 _lh_initial_LH_P2_1_3_8))), (_lh_listcomp_fun_1_1_9 _lh_listcomp_fun_ls_t_1_1_6)))))) in
                                                              ...
                                                              (let rec _lh_listcomp_fun_ls_h_5_8 = (let rec _lh_initial_LH_P2_1_3_9 = canYou_0 in
                                                                (let rec _lh_initial_LH_P2_0_3_9 = (`LH_C('C', (`LH_C('A', (`LH_C('N', (`LH_C(' ', (`LH_C('Y', (`LH_C('O', (`LH_C('U', (`LH_N))))))))))))))) in
                                                                  (fun _lh_listcomp_fun_ls_t_1_1_7 _lh_listcomp_fun_1_2_1 -> 
                                                                    (`LH_C((`LH_P2((words_lh__d2 _lh_initial_LH_P2_0_3_9), (cycle_lh__d2 _lh_initial_LH_P2_1_3_9))), (_lh_listcomp_fun_1_2_1 _lh_listcomp_fun_ls_t_1_1_7)))))) in
      ...
      (`LH_P2((let rec _lh_listcomp_fun_1_2_3 = (fun _lh_listcomp_fun_para_2 -> 
        ...
        (_lh_listcomp_fun_1_2_3 respMsgs_0)), (cycle_lh__d1 repeatMsgs_0)))));;
let rec take_lh__d1 n_1_5 ls_7 =
  (if (n_1_5 > 0) then
    (ls_7 n_1_5)
  else
    (fun f_5_0 f_5_1 _lh_session_arg1_1_5 _lh_session_arg2_1_5 _lh_dummy_2_6 -> 
      0));;
let rec map_lh__d2 f_5_2 ls_8 =
  (match ls_8 with
    | `LH_C(h_9_2, t_9_2) -> 
      (`LH_C((f_5_2 h_9_2), ((map_lh__d2 f_5_2) t_9_2)))
    | `LH_N -> 
      (`LH_N));;
let rec testEliza_nofib_lh__d1 _lh_testEliza_nofib_arg1_0 =
  (let rec input_0 = (let rec t_0 = (let rec t_1 = (let rec t_2 = (let rec t_3 = (let rec t_4 = (let rec t_5 = (let rec t_6 = (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (let rec t_1_3 = (fun n_0 f_0 f_1 _lh_session_arg1_0 _lh_session_arg2_0 _lh_dummy_0 -> 
    ...
    (let rec h_0 = (`LH_C('b', (`LH_C('u', (`LH_C('t', (`LH_C(' ', (`LH_C('I', (`LH_C('_', (`LH_C('m', (`LH_C(' ', (`LH_C('n', (`LH_C('o', (`LH_C('t', (`LH_N))))))))))))))))))))))) in
      (fun n_1 -> 
        (let rec t_1_4 = ((take_lh__d1 (n_1 - 1)) t_1_3) in
          (let rec h_1 = h_0 in
            (fun f_2 -> 
              (let rec t_1_5 = ((map_lh__d1 f_2) t_1_4) in
                (let rec h_2 = (f_2 h_1) in
                  (fun f_3 -> 
                    (if (f_3 h_2) then
                      (let rec _lh_session_LH_C_1_0 = ((filter_lh__d1 f_3) t_1_5) in
                      ...
                      ((filter_lh__d1 f_3) t_1_5))))))))))) in
    (let rec h_3 = (`LH_C('y', (`LH_C('e', (`LH_C('s', (`LH_N))))))) in
      (fun n_2 -> 
        (let rec t_1_6 = ((take_lh__d1 (n_2 - 1)) t_1_2) in
          (let rec h_4 = h_3 in
            (fun f_4 -> 
              (let rec t_1_7 = ((map_lh__d1 f_4) t_1_6) in
                (let rec h_5 = (f_4 h_4) in
                  (fun f_5 -> 
                    (if (f_5 h_5) then
                      (let rec _lh_session_LH_C_1_1 = ((filter_lh__d1 f_5) t_1_7) in
                      ...
                      ((filter_lh__d1 f_5) t_1_7))))))))))) in
    (let rec h_6 = (`LH_C('n', (`LH_C('o', (`LH_N))))) in
      (fun n_3 -> 
        (let rec t_1_8 = ((take_lh__d1 (n_3 - 1)) t_1_1) in
          (let rec h_7 = h_6 in
            (fun f_6 -> 
              (let rec t_1_9 = ((map_lh__d1 f_6) t_1_8) in
                (let rec h_8 = (f_6 h_7) in
                  (fun f_7 -> 
                    (if (f_7 h_8) then
                      (let rec _lh_session_LH_C_1_2 = ((filter_lh__d1 f_7) t_1_9) in
    ...
    (let rec h_9 = (`LH_C('I', (`LH_C('_', (`LH_C('m', (`LH_C(' ', (`LH_C('a', (`LH_C('s', (`LH_C('k', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_C(' ', (`LH_C('q', (`LH_C('u', (`LH_C('e', (`LH_C('s', (`LH_C('t', (`LH_C('i', (`LH_C('o', (`LH_C('n', (`LH_C('s', (`LH_C(',', (`LH_C(' ', (`LH_C('n', (`LH_C('o', (`LH_C('t', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_4 -> 
        (let rec t_2_0 = ((take_lh__d1 (n_4 - 1)) t_1_0) in
          (let rec h_1_0 = h_9 in
            (fun f_8 -> 
              (let rec t_2_1 = ((map_lh__d1 f_8) t_2_0) in
                (let rec h_1_1 = (f_8 h_1_0) in
                  (fun f_9 -> 
                    (if (f_9 h_1_1) then
                      (let rec _lh_session_LH_C_1_3 = ((filter_lh__d1 f_9) t_2_1) in
    ...
    (let rec h_1_2 = (`LH_C('N', (`LH_C('o', (`LH_C(',', (`LH_C(' ', (`LH_C('w', (`LH_C('h', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('w', (`LH_C('h', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('w', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('s', (`LH_C('h', (`LH_C('e', (`LH_C(' ', (`LH_C('l', (`LH_C('i', (`LH_C('k', (`LH_C('e', (`LH_C('?', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_5 -> 
        (let rec t_2_2 = ((take_lh__d1 (n_5 - 1)) t_9) in
          (let rec h_1_3 = h_1_2 in
            (fun f_1_0 -> 
              (let rec t_2_3 = ((map_lh__d1 f_1_0) t_2_2) in
                (let rec h_1_4 = (f_1_0 h_1_3) in
                  (fun f_1_1 -> 
                    (if (f_1_1 h_1_4) then
                      (let rec _lh_session_LH_C_1_4 = ((filter_lh__d1 f_1_1) t_2_3) in
    ...
    (let rec h_1_5 = (`LH_C('T', (`LH_C('e', (`LH_C('l', (`LH_C('l', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('b', (`LH_C('o', (`LH_C('u', (`LH_C('t', (`LH_C(' ', (`LH_C('*', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C('*', (`LH_C(' ', (`LH_C('m', (`LH_C('o', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_6 -> 
        (let rec t_2_4 = ((take_lh__d1 (n_6 - 1)) t_8) in
          (let rec h_1_6 = h_1_5 in
            (fun f_1_2 -> 
              (let rec t_2_5 = ((map_lh__d1 f_1_2) t_2_4) in
                (let rec h_1_7 = (f_1_2 h_1_6) in
                  (fun f_1_3 -> 
                    (if (f_1_3 h_1_7) then
                      (let rec _lh_session_LH_C_1_5 = ((filter_lh__d1 f_1_3) t_2_5) in
    ...
    (let rec h_1_8 = (`LH_C('O', (`LH_C('h', (`LH_C(',', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('p', (`LH_C('a', (`LH_C('r', (`LH_C('a', (`LH_C('n', (`LH_C('o', (`LH_C('i', (`LH_C('d', (`LH_C(' ', (`LH_C('c', (`LH_C('o', (`LH_C('m', (`LH_C('p', (`LH_C('u', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C(',', (`LH_C(' ', (`LH_C('e', (`LH_C('h', (`LH_C('h', (`LH_C('?', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_7 -> 
        (let rec t_2_6 = ((take_lh__d1 (n_7 - 1)) t_7) in
          (let rec h_1_9 = h_1_8 in
            (fun f_1_4 -> 
              (let rec t_2_7 = ((map_lh__d1 f_1_4) t_2_6) in
                (let rec h_2_0 = (f_1_4 h_1_9) in
                  (fun f_1_5 -> 
                    (if (f_1_5 h_2_0) then
                      (let rec _lh_session_LH_C_1_6 = ((filter_lh__d1 f_1_5) t_2_7) in
                      ...
                      ((filter_lh__d1 f_1_5) t_2_7))))))))))) in
    (let rec h_2_1 = (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_C('n', (`LH_C('t', (`LH_N))))))))))))))))) in
      (fun n_8 -> 
        (let rec t_2_8 = ((take_lh__d1 (n_8 - 1)) t_6) in
          (let rec h_2_2 = h_2_1 in
            (fun f_1_6 -> 
              (let rec t_2_9 = ((map_lh__d1 f_1_6) t_2_8) in
                (let rec h_2_3 = (f_1_6 h_2_2) in
                  (fun f_1_7 -> 
                    (if (f_1_7 h_2_3) then
                      (let rec _lh_session_LH_C_1_7 = ((filter_lh__d1 f_1_7) t_2_9) in
    ...
    (let rec h_2_4 = (`LH_C('N', (`LH_C('o', (`LH_C('p', (`LH_C(',', (`LH_C(' ', (`LH_C('t', (`LH_C('h', (`LH_C('a', (`LH_C('t', (`LH_C('s', (`LH_C(' ', (`LH_C('b', (`LH_C('e', (`LH_C('c', (`LH_C('a', (`LH_C('u', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('c', (`LH_C('o', (`LH_C('m', (`LH_C('p', (`LH_C('u', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_9 -> 
        (let rec t_3_0 = ((take_lh__d1 (n_9 - 1)) t_5) in
          (let rec h_2_5 = h_2_4 in
            (fun f_1_8 -> 
              (let rec t_3_1 = ((map_lh__d1 f_1_8) t_3_0) in
                (let rec h_2_6 = (f_1_8 h_2_5) in
                  (fun f_1_9 -> 
                    (if (f_1_9 h_2_6) then
                      (let rec _lh_session_LH_C_1_8 = ((filter_lh__d1 f_1_9) t_3_1) in
                      ...
                      ((filter_lh__d1 f_1_9) t_3_1))))))))))) in
    (let rec h_2_7 = (`LH_C('d', (`LH_C('o', (`LH_C(' ', (`LH_C('r', (`LH_C('a', (`LH_C('y', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_N))))))))))))))))))) in
      (fun n_1_0 -> 
        (let rec t_3_2 = ((take_lh__d1 (n_1_0 - 1)) t_4) in
          (let rec h_2_8 = h_2_7 in
            (fun f_2_0 -> 
              (let rec t_3_3 = ((map_lh__d1 f_2_0) t_3_2) in
                (let rec h_2_9 = (f_2_0 h_2_8) in
                  (fun f_2_1 -> 
                    (if (f_2_1 h_2_9) then
                      (let rec _lh_session_LH_C_1_9 = ((filter_lh__d1 f_2_1) t_3_3) in
    ...
    (let rec h_3_0 = (`LH_C('I', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_C('n', (`LH_C('t', (`LH_C(' ', (`LH_C('a', (`LH_C('s', (`LH_C('k', (`LH_C(',', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_N))))))))))))))))))))))))))))))))))))) in
      (fun n_1_1 -> 
        (let rec t_3_4 = ((take_lh__d1 (n_1_1 - 1)) t_3) in
          (let rec h_3_1 = h_3_0 in
            (fun f_2_2 -> 
              (let rec t_3_5 = ((map_lh__d1 f_2_2) t_3_4) in
                (let rec h_3_2 = (f_2_2 h_3_1) in
                  (fun f_2_3 -> 
                    (if (f_2_3 h_3_2) then
                      (let rec _lh_session_LH_C_1_1_0 = ((filter_lh__d1 f_2_3) t_3_5) in
    ...
    (let rec h_3_3 = (`LH_C('B', (`LH_C('u', (`LH_C('t', (`LH_C(' ', (`LH_C('w', (`LH_C('h', (`LH_C('y', (`LH_C(' ', (`LH_C('n', (`LH_C('o', (`LH_C('t', (`LH_C(' ', (`LH_C('t', (`LH_C('a', (`LH_C('l', (`LH_C('k', (`LH_C(' ', (`LH_C('a', (`LH_C('b', (`LH_C('o', (`LH_C('u', (`LH_C('t', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(',', (`LH_C(' ', (`LH_C('i', (`LH_C('t', (`LH_C('s', (`LH_C(' ', (`LH_C('m', (`LH_C('o', (`LH_C('r', (`LH_C('e', (`LH_C(' ', (`LH_C('f', (`LH_C('u', (`LH_C('n', (`LH_C('.', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_1_2 -> 
        (let rec t_3_6 = ((take_lh__d1 (n_1_2 - 1)) t_2) in
          (let rec h_3_4 = h_3_3 in
            (fun f_2_4 -> 
              (let rec t_3_7 = ((map_lh__d1 f_2_4) t_3_6) in
                (let rec h_3_5 = (f_2_4 h_3_4) in
                  (fun f_2_5 -> 
                    (if (f_2_5 h_3_5) then
                      (let rec _lh_session_LH_C_1_1_1 = ((filter_lh__d1 f_2_5) t_3_7) in
    ...
    (let rec h_3_6 = (`LH_C('T', (`LH_C('h', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C(' ', (`LH_C('R', (`LH_C('o', (`LH_C('s', (`LH_C('w', (`LH_C('e', (`LH_C('l', (`LH_C('l', (`LH_C(' ', (`LH_C('e', (`LH_C('v', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C(' ', (`LH_C('w', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C('c', (`LH_C('t', (`LH_C('u', (`LH_C('a', (`LH_C('l', (`LH_C('l', (`LH_C('y', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C(' ', (`LH_C('a', (`LH_C('l', (`LH_C('i', (`LH_C('e', (`LH_C('n', (`LH_C(' ', (`LH_C('e', (`LH_C('n', (`LH_C('c', (`LH_C('o', (`LH_C('u', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C('.', (`LH_C(' ', (`LH_C('D', (`LH_C('o', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('a', (`LH_C('g', (`LH_C('r', (`LH_C('e', (`LH_C('e', (`LH_C('d', (`LH_C('?', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun n_1_3 -> 
        (let rec t_3_8 = ((take_lh__d1 (n_1_3 - 1)) t_1) in
          (let rec h_3_7 = h_3_6 in
            (fun f_2_6 -> 
              (let rec t_3_9 = ((map_lh__d1 f_2_6) t_3_8) in
                (let rec h_3_8 = (f_2_6 h_3_7) in
                  (fun f_2_7 -> 
                    (if (f_2_7 h_3_8) then
                      (let rec _lh_session_LH_C_1_1_2 = ((filter_lh__d1 f_2_7) t_3_9) in
                      ...
                      ((filter_lh__d1 f_2_7) t_3_9))))))))))) in
    (let rec h_3_9 = (`LH_C('A', (`LH_C('r', (`LH_C('e', (`LH_C(' ', (`LH_C('w', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('l', (`LH_C('o', (`LH_C('n', (`LH_C('e', (`LH_C('?', (`LH_N))))))))))))))))))))))))))) in
      (fun n_1_4 -> 
        (let rec t_4_0 = ((take_lh__d1 (n_1_4 - 1)) t_0) in
          (let rec h_4_0 = h_3_9 in
            (fun f_2_8 -> 
              (let rec t_4_1 = ((map_lh__d1 f_2_8) t_4_0) in
                (let rec h_4_1 = (f_2_8 h_4_0) in
                  (fun f_2_9 -> 
                    (if (f_2_9 h_4_1) then
                      (let rec _lh_session_LH_C_1_1_3 = ((filter_lh__d1 f_2_9) t_4_1) in
                      ...
                      ((filter_lh__d1 f_2_9) t_4_1))))))))))) in
    ((map_lh__d2 (fun i_0 -> 
      ((fun _lh_funcomp_x_0 -> 
        ((fun _lh_funcomp_x_1 -> 
          ((fun _lh_funcomp_x_2 -> 
            ((fun _lh_funcomp_x_3 -> 
              (length_lh__d1 (((session_lh__d1 initial_lh__d1) (`LH_N)) _lh_funcomp_x_3))) ((filter_lh__d1 (fun _lh_funcomp_x_4 -> 
              (not (null_lh__d1 _lh_funcomp_x_4)))) _lh_funcomp_x_2))) ((map_lh__d1 (fun _lh_funcomp_x_5 -> 

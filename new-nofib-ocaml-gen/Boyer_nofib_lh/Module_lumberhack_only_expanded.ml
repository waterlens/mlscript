...
let rec find__d0 _lh_find_arg1_2 _lh_find_arg2_2 =
  (match _lh_find_arg2_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec find__d1 _lh_find_arg1_3 _lh_find_arg2_3 =
      ...
      (match _lh_find_LH_C_0_3 with
        | `LH_P2(_lh_find_LH_P2_0_3, _lh_find_LH_P2_1_3) -> 
          (if (_lh_find_arg1_3 = _lh_find_LH_P2_0_3) then
            ...
            ((find__d1 _lh_find_arg1_3) _lh_find_LH_C_1_3))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
let rec find__d2 _lh_find_arg1_1 _lh_find_arg2_1 =
      ...
      (match _lh_find_LH_C_0_1 with
        | `LH_P2(_lh_find_LH_P2_0_1, _lh_find_LH_P2_1_1) -> 
          (if (_lh_find_arg1_1 = _lh_find_LH_P2_0_1) then
            ...
            ((find__d2 _lh_find_arg1_1) _lh_find_LH_C_1_1))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
let rec map__d0 f_1_3 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_2_0, t_2_2) -> 
      (`LH_C((f_1_3 h_2_0), ((map__d0 f_1_3) t_2_2)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d1 f_1_6 ls_2_1 =
  (match ls_2_1 with
    | `LH_C(h_2_2, t_2_4) -> 
      (`LH_C((f_1_6 h_2_2), ((map__d1 f_1_6) t_2_4)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d2 f_1_4 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_1, t_2_3) -> 
      (`LH_C((f_1_4 h_2_1), ((map__d2 f_1_4) t_2_3)))
    | `LH_N -> 
      (`LH_N));;
...
let rec apply_subst__d0 _lh_apply_subst_arg1_1 _lh_apply_subst_arg2_1 =
  (match _lh_apply_subst_arg2_1 with
    | `Var(_lh_apply_subst_Var_0_1) -> 
      (let rec _lh_matchIdent_9 = ((find__d0 _lh_apply_subst_Var_0_1) _lh_apply_subst_arg1_1) in
    ...
    | `Fun(_lh_apply_subst_Fun_0_1, _lh_apply_subst_Fun_1_1, _lh_apply_subst_Fun_2_1) -> 
      (`Fun(_lh_apply_subst_Fun_0_1, ((map__d0 (apply_subst__d0 _lh_apply_subst_arg1_1)) _lh_apply_subst_Fun_1_1), _lh_apply_subst_Fun_2_1))
    | _ -> 
      (failwith "error"))
and apply_subst__d1 _lh_apply_subst_arg1_2 _lh_apply_subst_arg2_2 =
  (match _lh_apply_subst_arg2_2 with
    | `Var(_lh_apply_subst_Var_0_2) -> 
      (let rec _lh_matchIdent_1_2 = ((find__d1 _lh_apply_subst_Var_0_2) _lh_apply_subst_arg1_2) in
    ...
    | `Fun(_lh_apply_subst_Fun_0_2, _lh_apply_subst_Fun_1_2, _lh_apply_subst_Fun_2_2) -> 
      (`Fun(_lh_apply_subst_Fun_0_2, ((map__d2 (apply_subst__d1 _lh_apply_subst_arg1_2)) _lh_apply_subst_Fun_1_2), _lh_apply_subst_Fun_2_2))
    | _ -> 
      (failwith "error"))
and falsep__d0 _lh_falsep_arg1_2 _lh_falsep_arg2_2 =
    ...
    | `Fun(_lh_falsep_Fun_0_2, _lh_falsep_Fun_1_2, _lh_falsep_Fun_2_2) -> 
      (match _lh_falsep_Fun_0_2 with
        | `FALSE -> 
          true
        | _ -> 
          ((termInList__d0 _lh_falsep_arg1_2) _lh_falsep_arg2_2))
    | _ -> 
      ((termInList__d0 _lh_falsep_arg1_2) _lh_falsep_arg2_2))
    ...
    | `LH_C(_lh_one_way_unify1_lst_LH_C_0_2, _lh_one_way_unify1_lst_LH_C_1_2) -> 
      (match _lh_one_way_unify1_lst_arg2_1 with
        | `LH_C(_lh_one_way_unify1_lst_LH_C_0_3, _lh_one_way_unify1_lst_LH_C_1_3) -> 
          (let rec _lh_matchIdent_1_0 = (((one_way_unify1__d0 _lh_one_way_unify1_lst_LH_C_0_2) _lh_one_way_unify1_lst_LH_C_0_3) _lh_one_way_unify1_lst_arg3_1) in
            (match _lh_matchIdent_1_0 with
              | `LH_P2(_lh_one_way_unify1_lst_LH_P2_0_2, _lh_one_way_unify1_lst_LH_P2_1_2) -> 
                (let rec _lh_matchIdent_1_1 = (((one_way_unify1_lst__d0 _lh_one_way_unify1_lst_LH_C_1_2) _lh_one_way_unify1_lst_LH_C_1_3) _lh_one_way_unify1_lst_LH_P2_1_2) in
...
and one_way_unify1__d0 _lh_one_way_unify1_arg1_1 _lh_one_way_unify1_arg2_1 _lh_one_way_unify1_arg3_1 =
  (match _lh_one_way_unify1_arg2_1 with
    | `Var(_lh_one_way_unify1_Var_0_1) -> 
      (let rec _lh_matchIdent_8 = ((find__d2 _lh_one_way_unify1_Var_0_1) _lh_one_way_unify1_arg3_1) in
...
and rewrite_with_lemmas_helper__d0 _lh_rewrite_with_lemmas_helper_arg1_1 _lh_rewrite_with_lemmas_helper_arg2_1 =
  (let rec _lh_matchIdent_1_3 = _lh_rewrite_with_lemmas_helper_arg2_1 in
      ...
      | `LH_C(_lh_rewrite_with_lemmas_helper_LH_C_0_1, _lh_rewrite_with_lemmas_helper_LH_C_1_1) -> 
        (match _lh_rewrite_with_lemmas_helper_LH_C_0_1 with
          | `LH_P2(_lh_rewrite_with_lemmas_helper_LH_P2_0_2, _lh_rewrite_with_lemmas_helper_LH_P2_1_2) -> 
            (let rec _lh_matchIdent_1_4 = ((one_way_unify__d0 _lh_rewrite_with_lemmas_helper_arg1_1) _lh_rewrite_with_lemmas_helper_LH_P2_0_2) in
...
and tautologyp__d0 _lh_tautologyp_arg1_1 _lh_tautologyp_arg2_1 _lh_tautologyp_arg3_1 =
  (if ((truep__d0 _lh_tautologyp_arg1_1) _lh_tautologyp_arg2_1) then
    ...
    (if ((falsep__d0 _lh_tautologyp_arg1_1) _lh_tautologyp_arg3_1) then
      ...
      (let rec _lh_matchIdent_7 = _lh_tautologyp_arg1_1 in
...
and termEq__d4 _lh_termEq_arg1_4 _lh_termEq_arg2_4 =
  (match _lh_termEq_arg1_4 with
    ...
    | _ -> 
      false)
and termInList__d0 _lh_termInList_arg1_1 _lh_termInList_arg2_1 =
  (match _lh_termInList_arg2_1 with
    | `LH_C(_lh_termInList_LH_C_0_1, _lh_termInList_LH_C_1_1) -> 
      (if ((termEq__d1 _lh_termInList_arg1_1) _lh_termInList_LH_C_0_1) then
        true
      else
        ((termInList__d0 _lh_termInList_arg1_1) _lh_termInList_LH_C_1_1))
    | `LH_N -> 
      false
    | _ -> 
      (failwith "error"))
and termInList__d1 _lh_termInList_arg1_3 _lh_termInList_arg2_3 =
  (match _lh_termInList_arg2_3 with
    ...
    | _ -> 
      (failwith "error"))
and termInList__d2 _lh_termInList_arg1_2 _lh_termInList_arg2_2 =
  (match _lh_termInList_arg2_2 with
    | `LH_C(_lh_termInList_LH_C_0_2, _lh_termInList_LH_C_1_2) -> 
      (if ((termEq__d3 _lh_termInList_arg1_2) _lh_termInList_LH_C_0_2) then
        true
      else
        ((termInList__d2 _lh_termInList_arg1_2) _lh_termInList_LH_C_1_2))
    | `LH_N -> 
      false
    | _ -> 
      (failwith "error"))
and termInList__d3 _lh_termInList_arg1_4 _lh_termInList_arg2_4 =
  (match _lh_termInList_arg2_4 with
    | `LH_C(_lh_termInList_LH_C_0_4, _lh_termInList_LH_C_1_4) -> 
      (if ((termEq__d4 _lh_termInList_arg1_4) _lh_termInList_LH_C_0_4) then
        true
      else
        ((termInList__d3 _lh_termInList_arg1_4) _lh_termInList_LH_C_1_4))
    | `LH_N -> 
      false
    | _ -> 
      (failwith "error"))
and termLsEq__d0 _lh_termLsEq_arg1_5 _lh_termLsEq_arg2_5 =
    ...
    | `LH_C(_lh_termLsEq_LH_C_0_1_0, _lh_termLsEq_LH_C_1_1_0) -> 
      (match _lh_termLsEq_arg2_5 with
        | `LH_C(_lh_termLsEq_LH_C_0_1_1, _lh_termLsEq_LH_C_1_1_1) -> 
          (if ((termEq__d0 _lh_termLsEq_LH_C_0_1_0) _lh_termLsEq_LH_C_0_1_1) then
            ((termLsEq__d0 _lh_termLsEq_LH_C_1_1_0) _lh_termLsEq_LH_C_1_1_1)
          else
            false)
        | _ -> 
          (failwith "error"))
...
and termLsEq__d1 _lh_termLsEq_arg1_2 _lh_termLsEq_arg2_2 =
  (match _lh_termLsEq_arg1_2 with
    ...
    | _ -> 
      (failwith "error"))
and termLsEq__d2 _lh_termLsEq_arg1_1 _lh_termLsEq_arg2_1 =
    ...
    | `LH_C(_lh_termLsEq_LH_C_0_2, _lh_termLsEq_LH_C_1_2) -> 
      (match _lh_termLsEq_arg2_1 with
        | `LH_C(_lh_termLsEq_LH_C_0_3, _lh_termLsEq_LH_C_1_3) -> 
          (if ((termEq__d2 _lh_termLsEq_LH_C_0_2) _lh_termLsEq_LH_C_0_3) then
            ((termLsEq__d2 _lh_termLsEq_LH_C_1_2) _lh_termLsEq_LH_C_1_3)
          else
            false)
        | _ -> 
          (failwith "error"))
...
and termLsEq__d3 _lh_termLsEq_arg1_3 _lh_termLsEq_arg2_3 =
  (match _lh_termLsEq_arg1_3 with
    ...
    | _ -> 
      (failwith "error"))
and termLsEq__d4 _lh_termLsEq_arg1_4 _lh_termLsEq_arg2_4 =
    ...
    | `LH_C(_lh_termLsEq_LH_C_0_8, _lh_termLsEq_LH_C_1_8) -> 
      (match _lh_termLsEq_arg2_4 with
        | `LH_C(_lh_termLsEq_LH_C_0_9, _lh_termLsEq_LH_C_1_9) -> 
          (if ((termEq__d4 _lh_termLsEq_LH_C_0_8) _lh_termLsEq_LH_C_0_9) then
            ((termLsEq__d4 _lh_termLsEq_LH_C_1_8) _lh_termLsEq_LH_C_1_9)
          else
            false)
        | _ -> 
          (failwith "error"))
...
and test0__d0 _lh_test0_arg1_1 =
  ...
  and c_1 = (`Var((`C)))
  in (let rec subst0_1 = (`LH_C((`LH_P2((`X), (f_1_5 ((plus_1 ((plus_1 a_6) b_3)) ((plus_1 c_1) zero_1))))), (`LH_C((`LH_P2((`Y), (f_1_5 ((times_1 ((times_1 a_6) b_3)) ((plus_1 c_1) d_1))))), (`LH_C((`LH_P2((`Z), (f_1_5 (reverse__1 ((append_1 ((append_1 a_6) b_3)) nil_1))))), (`LH_C((`LH_P2((`U), ((equal_1 ((plus_1 a_6) b_3)) ((difference_1 x_3) y_1)))), (`LH_C((`LH_P2((`W), ((lessp_1 ((remainder_1 a_6) b_3)) ((member_1 a_6) (length__1 b_3))))), (`LH_N))))))))))) in
...
and truep__d0 _lh_truep_arg1_2 _lh_truep_arg2_2 =
    ...
    | `Fun(_lh_truep_Fun_0_2, _lh_truep_Fun_1_2, _lh_truep_Fun_2_2) -> 
      (match _lh_truep_Fun_0_2 with
        | `TRUE -> 
          true
        | _ -> 
          ((termInList__d2 _lh_truep_arg1_2) _lh_truep_arg2_2))
    | _ -> 
      ((termInList__d2 _lh_truep_arg1_2) _lh_truep_arg2_2))
and truep__d1 _lh_truep_arg1_1 _lh_truep_arg2_1 =
    ...
    | `Fun(_lh_truep_Fun_0_1, _lh_truep_Fun_1_1, _lh_truep_Fun_2_1) -> 
      (match _lh_truep_Fun_0_1 with
        | `TRUE -> 
          true
        | _ -> 
          ((termInList__d3 _lh_truep_arg1_1) _lh_truep_arg2_1))
    | _ -> 
      ((termInList__d3 _lh_truep_arg1_1) _lh_truep_arg2_1));;
end;;

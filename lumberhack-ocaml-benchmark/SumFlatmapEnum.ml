(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./SumFlatmapEnum.ml -o "./SumFlatmapEnum.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./SumFlatmapEnum.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

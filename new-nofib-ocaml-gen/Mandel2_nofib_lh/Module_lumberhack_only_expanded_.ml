...
let rec np_lh__d4 _lh_np_arg1_2 =
  (pmn_lh__d1 +. ((float_of_int _lh_np_arg1_2) *. delta_p_lh__d2));;
    ...
    | `LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_0) -> 
      (match _lh_check_perim_arg2_0 with
        | `LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_1) -> 
          (let rec col1_0 = (point_colour_lh__d2 (`LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_0))) in
            (let rec col2_0 = (point_colour_lh__d5 (`LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_0))) in
              (let rec col3_0 = (point_colour_lh__d3 (`LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_1))) in
                (let rec col4_0 = (point_colour_lh__d1 (`LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_1))) in
                  (let rec corners_diff_0 = (if (col1_0 = col2_0) then
                    ...
                    (let rec check_line_0 = (fun xcyc_0 xdyd_0 -> 
                      ...
                      (let rec check_sides_0 = (if ((check_line_0 (`LH_P2((_lh_check_perim_LH_P2_0_0 + 1), _lh_check_perim_LH_P2_1_0))) right_lh__d1) then
                        ...
                        (0 - 1)) in
                        (if ((equalp_lh__d4 (`LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_0))) (`LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_1))) then
                          (point_colour_lh__d6 (`LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_0)))
                        else

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Power_nofib_lh" (fun () -> ignore (let open Module_lumberhack_______________.Module_lumberhack_______________ in ((testPower_nofib_lh__d1__d0 14))));
  Bench.Test.create ~name:"lumberhack_pop_out_Power_nofib_lh" (fun () -> ignore (let open Module_lumberhack_pop_out_______.Module_lumberhack_pop_out_______ in ((testPower_nofib_lh__d1__d0 14))));
])

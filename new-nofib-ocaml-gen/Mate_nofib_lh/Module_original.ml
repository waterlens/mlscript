...
and insertCompact_lh _lh_insertCompact_arg1_0 _lh_insertCompact_arg2_0 =
  (match _lh_insertCompact_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and kingSquare_lh _lh_kingSquare_arg1_0 _lh_kingSquare_arg2_0 =
  (match _lh_kingSquare_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and kingincheck_lh _lh_kingincheck_arg1_0 _lh_kingincheck_arg2_0 =
...
and kingmoves_lh _lh_kingmoves_arg1_0 _lh_kingmoves_arg2_0 _lh_kingmoves_arg3_0 =
  (match _lh_kingmoves_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and knightmoves_lh _lh_knightmoves_arg1_0 _lh_knightmoves_arg2_0 _lh_knightmoves_arg3_0 =
...
and lines_lh _lh_lines_arg1_0 =
  (let rec _lh_matchIdent_3_4 = ((break_lh (fun x_5 -> 
    ...
    (match _lh_matchIdent_3_4 with
      ...
      | _ -> 
        (failwith "error")))
and moveDetailsFor_lh _lh_moveDetailsFor_arg1_0 _lh_moveDetailsFor_arg2_0 =
...
and moveLine_lh _lh_moveLine_arg1_0 _lh_moveLine_arg2_0 _lh_moveLine_arg3_0 _lh_moveLine_arg4_0 _lh_moveLine_arg5_0 =
...
and parseBoard_lh _lh_parseBoard_arg1_0 =
...
and parseGoal_lh _lh_parseGoal_arg1_0 =
  (match _lh_parseGoal_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and parseProblem_lh _lh_parseProblem_arg1_0 =
  (let rec bdtxt_gltxt_0 = ((splitAt_lh 8) ((filter_lh (fun _lh_funcomp_x_3 -> 
    ...
    (let rec _lh_matchIdent_2_7 = bdtxt_gltxt_0 in
      (match _lh_matchIdent_2_7 with
        ...
        | _ -> 
          (failwith "error"))))
and parseRank_lh _lh_parseRank_arg1_0 _lh_parseRank_arg2_0 =
  ((fun _lh_funcomp_x_0 -> 
    ((fun _lh_funcomp_x_1 -> 
...
and parseSquare_lh _lh_parseSquare_arg1_0 _lh_parseSquare_arg2_0 _lh_parseSquare_arg3_0 =
...
and pawnmoves_lh _lh_pawnmoves_arg1_0 _lh_pawnmoves_arg2_0 _lh_pawnmoves_arg3_0 =
  (match _lh_pawnmoves_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and pieceToChar_lh _lh_pieceToChar_arg1_0 =
  (match _lh_pieceToChar_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and qpart_lh _lh_qpart_arg1_0 _lh_qpart_arg2_0 _lh_qpart_arg3_0 _lh_qpart_arg4_0 _lh_qpart_arg5_0 _lh_qpart_arg6_0 =
  (match _lh_qpart_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and qsort_lh _lh_qsort_arg1_0 _lh_qsort_arg2_0 _lh_qsort_arg3_0 =
  (match _lh_qsort_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and queenmoves_lh _lh_queenmoves_arg1_0 _lh_queenmoves_arg2_0 _lh_queenmoves_arg3_0 =
...
and rawmoves_lh _lh_rawmoves_arg1_0 _lh_rawmoves_arg2_0 _lh_rawmoves_arg3_0 =
  (match _lh_rawmoves_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and readProblem_lh _lh_readProblem_arg1_0 =
  ((fun _lh_funcomp_x_2 -> 
    (parseProblem_lh (lines_lh _lh_funcomp_x_2))) _lh_readProblem_arg1_0)
and replies_lh _lh_replies_arg1_0 _lh_replies_arg2_0 _lh_replies_arg3_0 =
...
and rmPieceAt_lh _lh_rmPieceAt_arg1_0 _lh_rmPieceAt_arg2_0 _lh_rmPieceAt_arg3_0 =
  (match _lh_rmPieceAt_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and rookmoves_lh _lh_rookmoves_arg1_0 _lh_rookmoves_arg2_0 _lh_rookmoves_arg3_0 =
  ((((((moveLine_lh _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_1 -> 
    ...
    x_6))))) (`LH_N))
and rqpart_lh _lh_rqpart_arg1_0 _lh_rqpart_arg2_0 _lh_rqpart_arg3_0 _lh_rqpart_arg4_0 _lh_rqpart_arg5_0 _lh_rqpart_arg6_0 =
  (match _lh_rqpart_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and rqsort_lh _lh_rqsort_arg1_0 _lh_rqsort_arg2_0 _lh_rqsort_arg3_0 =
  (match _lh_rqsort_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and showBoard_lh _lh_showBoard_arg1_0 =
...
and showMoveInFull_lh _lh_showMoveInFull_arg1_0 =
  ((showMove_lh true) _lh_showMoveInFull_arg1_0)
and showMove_lh _lh_showMove_arg1_0 _lh_showMove_arg2_0 =
  (match _lh_showMove_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and showMovesAfter_lh _lh_showMovesAfter_arg1_0 _lh_showMovesAfter_arg2_0 =
  (match _lh_showMovesAfter_arg2_0 with
    ...
    | _ -> 
      (match _lh_showMovesAfter_arg1_0 with
        ...
        | _ -> 
          (failwith "error")))
and showMoves_lh _lh_showMoves_arg1_0 =
  (match _lh_showMoves_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showPiece_lh _lh_showPiece_arg1_0 =
  (match _lh_showPiece_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showReplies_lh _lh_showReplies_arg1_0 _lh_showReplies_arg2_0 =
  (match _lh_showReplies_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showResult_lh _lh_showResult_arg1_0 =
  (match _lh_showResult_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showSoln_lh _lh_showSoln_arg1_0 _lh_showSoln_arg2_0 =
  (match _lh_showSoln_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showSquare_lh _lh_showSquare_arg1_0 _lh_showSquare_arg2_0 =
  (match _lh_showSquare_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and sift_lh _lh_sift_arg1_0 _lh_sift_arg2_0 _lh_sift_arg3_0 _lh_sift_arg4_0 =
  (match _lh_sift_arg4_0 with
    ...
    | _ -> 
      (failwith "error"))
and solution_lh _lh_solution_arg1_0 _lh_solution_arg2_0 _lh_solution_arg3_0 =
...
and testMate_nofib_lh _lh_testMate_nofib_arg1_0 =
    ...
    (let rec bdcn_0 = (readProblem_lh input_0) in
      (let rec _lh_matchIdent_1_4 = bdcn_0 in
        (match _lh_matchIdent_1_4 with
          ...
          | _ -> 
            (failwith "error")))))
and tryMove_lh _lh_tryMove_arg1_0 _lh_tryMove_arg2_0 _lh_tryMove_arg3_0 _lh_tryMove_arg4_0 =

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Gcd_nofib" (fun () -> ignore (let open Module_lumberhack.Module_lumberhack in ((testGcd_nofib__d0__d0 200))));
  Bench.Test.create ~name:"lumberhack_pop_out_Gcd_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out.Module_lumberhack_pop_out in ((testGcd_nofib__d0__d0 200))));
])

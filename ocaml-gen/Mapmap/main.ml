...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Mapmap" (fun () -> ignore (let open Module_lumberhack_________.Module_lumberhack_________ in ((testMapmap__d0 ((enumFromTo__d1 1) 100000)))));
  Bench.Test.create ~name:"lumberhack_pop_out_Mapmap" (fun () -> ignore (let open Module_lumberhack_pop_out_.Module_lumberhack_pop_out_ in ((testMapmap__d0 ((enumFromTo__d1 1) 100000)))));
])

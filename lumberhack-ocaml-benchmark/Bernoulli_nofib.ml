...
(* lumberhack_pop_out *)
let rec atIndex_lz_d0_d0_d0 n_6 ls_1_7 =
  (if (n_6 < 0) then
    (Obj.magic 99)
  else
    ((Lazy.force ls_1_7) n_6));;
let rec atIndex_lz_d0_d0_d1 n_7 ls_1_9 =
  (if (n_7 < 0) then
    (Obj.magic 99)
  else
    ((Lazy.force ls_1_9) n_7));;
...
let rec head_lz_d0_d0_d0 ls_1_4 =
  (match (Lazy.force ls_1_4) with
    ...
    | `LH_N -> 
      (Obj.magic 99));;
let rec map_lz_d1_d0_d0 f_1_9 ls_1_0 =
  (lazy (match (Lazy.force ls_1_0) with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C((f_1_9 h_1_1), ((map_lz_d1_d0_d0 f_1_9) t_1_1)))
    | `LH_N -> 
      (`LH_N)));;
let rec map_lz_d2_d0_d0 f_2_0 ls_1_1 =
...
let rec tail_d0_d0_d0 ls_9 =
  (match ls_9 with
    ...
    | `LH_N -> 
      (Obj.magic 99));;
let rec tail_d1_d0_d0 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_5, t_1_5) -> 
      t_1_5
    | `LH_N -> 
      (Obj.magic 99));;
let rec zipWith_lz_lz_d0_d0_d0 f_2_3 xs_1_2 ys_2_0 =
  (lazy (match (Lazy.force xs_1_2) with
    | `LH_C(hx_7, tx_7) -> 
      (match (Lazy.force ys_2_0) with
        | `LH_C(hy_1_1, ty_1_1) -> 
          (`LH_C(((f_2_3 hx_7) hy_1_1), (((zipWith_lz_lz_d0_d0_d0 f_2_3) tx_7) ty_1_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (Obj.magic 99)));;
let rec zipWith_lz_lz_d1_d0_d0 f_1_6 xs_8 ys_1_4 =
  (lazy (((Lazy.force xs_8) f_1_6) ys_1_4));;
let rec zipWith_lz_lz_d1_d0_d1 f_2_1 xs_1_1 ys_1_9 =
  (lazy (((Lazy.force xs_1_1) f_2_1) ys_1_9));;
let rec zipWith_lz_nl_d0_d0_d0 f_1_4 xs_6 ys_1_2 =
  (match ys_1_2 with
    | `LH_C(hy_8, ty_8) -> 
      ((((Lazy.force xs_6) f_1_4) hy_8) ty_8)
    | `LH_N -> 
      (fun _lh_dummy_6 -> 
        0));;
let rec zipWith_lz_nl_d0_d0_d1 f_1_5 xs_7 ys_1_3 =
  (match ys_1_3 with
    | `LH_C(hy_9, ty_9) -> 
      ((((Lazy.force xs_7) f_1_5) hy_9) ty_9)
    | `LH_N -> 
      (fun _lh_dummy_7 -> 
        0));;
let rec zipWith_d0_d0_d0 f_2_5 xs_1_4 ys_2_2 =
  ((xs_1_4 f_2_5) ys_2_2);;
let rec zipWith_d0_d0_d1 f_2_6 xs_1_5 ys_2_3 =
  ((xs_1_5 f_2_6) ys_2_3);;
let rec zipWith_d0_d0_d2 f_2_4 xs_1_3 ys_2_1 =
  ((xs_1_3 f_2_4) ys_2_1);;
let rec zip_nl_lz_d0_d0_d0 xs_1_0 ys_1_8 =
  (xs_1_0 ys_1_8);;
let rec zip_nl_lz_d0_d0_d1 xs_9 ys_1_5 =
  (xs_9 ys_1_5);;
...
and enumFromTo_d0_d0_d0 a_8 b_6 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_0 =
  (if (a_8 <= b_6) then
    (let rec hx_8 = a_8 in
      (let rec tx_8 = ((enumFromTo_d0_d0_d0 (a_8 + 1)) b_6) in
        (match (Lazy.force _lh_popOutId_0_1) with
          | `LH_C(hy_1_2, ty_1_2) -> 
            (let rec _lh_listcomp_fun_ls_h_1 = (let rec _lh_bernoulli_LH_P2_0_1 = hx_8 in
              (let rec _lh_bernoulli_LH_P2_1_1 = hy_1_2 in
                (fun _lh_listcomp_fun_ls_t_2 _lh_listcomp_fun_6 powers_6 -> 
                  (let rec h_1_7 = (((sum_d1_d0_d0 (((zipWith_lz_nl_d0_d0_d0 (fun a_9 b_7 -> 
                    ...
                    (let rec t_1_7 = (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_2) in
                      (fun _lh_dummy_8 -> 
                        (h_1_7 + (sum_d0_d0_d0 t_1_7)))))))) in
              (let rec _lh_listcomp_fun_ls_t_3 = ((zip_nl_lz_d0_d0_d0 tx_8) ty_1_2) in
    ...
    (fun _lh_dummy_1_0 -> 
      0))
and iterate_d0_d0_d0 f_2_7 x_2 =
  (lazy (let rec hx_9 = x_2 in
    (let rec tx_9 = ((iterate_d0_d0_d0 f_2_7) (f_2_7 x_2)) in
      (fun f_2_8 ys_2_6 -> 
        (match (Lazy.force ys_2_6) with
          | `LH_C(hy_1_3, ty_1_3) -> 
            (let rec hx_1_0 = ((f_2_8 hx_9) hy_1_3) in
              (let rec tx_1_0 = (((zipWith_lz_lz_d1_d0_d0 f_2_8) tx_9) ty_1_3) in
                (fun f_2_9 hy_1_4 ty_1_4 -> 
                  (let rec h_1_8 = ((f_2_9 hx_1_0) hy_1_4) in
                    (let rec t_1_8 = (((zipWith_lz_nl_d0_d0_d1 f_2_9) tx_1_0) ty_1_4) in
                      (fun _lh_dummy_1_1 -> 
                        (h_1_8 + (sum_d1_d0_d1 t_1_8))))))))
          | `LH_N -> 
            (fun f_3_0 hy_1_5 ty_1_5 _lh_dummy_1_2 -> 
              0))))))
and map_lz_d0_d0_d0 f_2_2 ls_1_2 =
  (lazy (match (Lazy.force ls_1_2) with
    | `LH_C(h_1_3, t_1_3) -> 
      (let rec h_1_4 = (f_2_2 h_1_3) in
        (let rec t_1_4 = ((map_lz_d0_d0_d0 f_2_2) t_1_3) in
          (fun n_4 -> 
            (if (n_4 = 0) then
              h_1_4
            else
              ((atIndex_lz_d0_d0_d1 (n_4 - 1)) t_1_4)))))
    | `LH_N -> 
      (fun n_5 -> 
        (Obj.magic 99))))
and mappend_d0_d0_d0 xs_1_6 ys_2_7 =
  (match xs_1_6 with
    | `LH_C(h_1_9, t_1_9) -> 
      (let rec hx_1_1 = h_1_9 in
        (let rec tx_1_1 = ((mappend_d0_d0_d0 t_1_9) ys_2_7) in
          (fun f_3_1 ys_2_8 -> 
            (match ys_2_8 with
              | `LH_C(hy_1_6, ty_1_6) -> 
                (`LH_C(((f_3_1 hx_1_1) hy_1_6), (((zipWith_d0_d0_d0 f_3_1) tx_1_1) ty_1_6)))
              | `LH_N -> 
                (`LH_N)))))
    | `LH_N -> 
      ys_2_7)
and neg_powers_d0_d0_d0 =
  (lazy ((map_lz_d0_d0_d0 ((zipWith_lz_lz_d1_d0_d1 (fun n_8 x_3 -> 
    (if n_8 then
      x_3
    else
...
and pascal_d0_d0_d0 =
  (lazy (`LH_C((`LH_C(1, (`LH_C(2, (`LH_C(1, (`LH_N))))))), ((map_lz_d2_d0_d0 (fun line_1 -> 
    (((zipWith_d0_d0_d1 (fun a_5 b_4 -> 
      ...
      (let rec tx_6 = (fun f_1_7 ys_1_6 -> 
        (`LH_N)) in
        (fun f_1_8 ys_1_7 -> 
          (match ys_1_7 with
            | `LH_C(hy_1_0, ty_1_0) -> 
              (`LH_C(((f_1_8 hx_6) hy_1_0), (((zipWith_d0_d0_d2 f_1_8) tx_6) ty_1_0)))
            | `LH_N -> 

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Cse_nofib" (fun () -> ignore (let open Module_lumberhack.Module_lumberhack in ((testCse_nofib__d0__d0__d0 1000))));
  Bench.Test.create ~name:"lumberhack_pop_out_Cse_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out.Module_lumberhack_pop_out in ((testCse_nofib__d0__d0__d0 1000))));
])

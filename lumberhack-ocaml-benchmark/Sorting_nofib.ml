...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Sorting_nofib" (fun () -> ignore (let open Module_original in ((testSorting_nofib__d0 0))));
  Bench.Test.create ~name:"lumberhack_Sorting_nofib" (fun () -> ignore (let open Module_lumberhack in ((testSorting_nofib__d0 0))));
  Bench.Test.create ~name:"lumberhack_pop_out_Sorting_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testSorting_nofib__d0 0))));
])

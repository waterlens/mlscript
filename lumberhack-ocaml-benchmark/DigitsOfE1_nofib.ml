...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_DigitsOfE1_nofib" (fun () -> ignore (let open Module_original in ((testDigitsOfE1_nofib__d0 300))));
  Bench.Test.create ~name:"lumberhack_DigitsOfE1_nofib" (fun () -> ignore (let open Module_lumberhack in ((testDigitsOfE1_nofib__d0 300))));
  Bench.Test.create ~name:"lumberhack_pop_out_DigitsOfE1_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testDigitsOfE1_nofib__d0 300))));
])

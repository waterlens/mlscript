...
let rec mknum_lh__d1 _lh_mknum_arg1_0 =
  ((_lh_mknum_arg1_0 (fun u_0 c_1 -> 
    ((u_0 * 10) + ((int_of_char c_1) - (int_of_char '0'))))) 0);;
  ...
  (if (a_3 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_lh__d4 (a_3 + 1)) b_2) in
      (fun _lh_listcomp_fun_1_1 -> 
        (let rec t_7 = (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_5) in
          (let rec h_7 = '0' in
            (fun ys_5 -> 
              (`LH_C(h_7, (t_7 ys_5))))))))
  else
    (fun _lh_listcomp_fun_1_2 ys_6 -> 
      ys_6));;
let rec mknum_lh__d2 _lh_mknum_arg1_1 =
  ((_lh_mknum_arg1_1 (fun u_1 c_4 -> 
    ((u_1 * 10) + ((int_of_char c_4) - (int_of_char '0'))))) 0);;
...
let rec reverse_lh__d1 ls_6 =
  (ls_6 (fun _lh_alphabeticRule_LH_C_1_1_1 _lh_listcomp_fun_2_3 -> 
    (`LH_N)));;
let rec constantRule_lh__d1 _lh_constantRule_arg1_0 =
          ...
          | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
            (`LH_C((let rec t_4 = _lh_listcomp_fun_ls_h_4 in
              (let rec h_4 = _lh_constantRule_LH_C_0_0 in
                (fun ys_2 -> 
                  (`LH_C(h_4, (t_4 ys_2)))))), (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_4)))
          | `LH_N -> 
            (`LH_N))) in
      ...
      (let rec _lh_listcomp_fun_2_1 = (fun _lh_listcomp_fun_para_1_2 -> 
        (match _lh_listcomp_fun_para_1_2 with
          | `LH_C(_lh_listcomp_fun_ls_h_9, _lh_listcomp_fun_ls_t_1_0) -> 
            (`LH_C((let rec t_1_3 = _lh_listcomp_fun_ls_h_9 in
              (let rec h_1_2 = _lh_constantRule_LH_C_0_1 in
                (fun ys_1_0 -> 
                  (`LH_C(h_1_2, (t_1_3 ys_1_0)))))), (_lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_1_0)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_2_1 (expand_lh__d1 _lh_constantRule_LH_C_1_1)))
    | _ -> 
      (failwith "error"))
and
  ...
  (if (a_4 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_6 = (((enumFromThenTo_lh__d1 t_8) ((2 * t_8) - a_4)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_4 in
        (fun _lh_listcomp_fun_1_3 _lh_numericRule_LH_C_1_5 width_3 -> 
          (let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_7 -> 
            (match _lh_listcomp_fun_para_7 with
              | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_7) -> 
                (`LH_C(((mappend_lh__d2 ((let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_8 -> 
                  (_lh_listcomp_fun_para_8 _lh_listcomp_fun_1_5)) in
                  (_lh_listcomp_fun_1_5 ((enumFromTo_lh__d4 1) (width_3 - (length_lh__d3 (string_of_int _lh_listcomp_fun_ls_h_5)))))) (string_of_int _lh_listcomp_fun_ls_h_5))) _lh_listcomp_fun_ls_h_6), (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_7)))
              | `LH_N -> 
                (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_6))) in
            (_lh_listcomp_fun_1_4 (expand_lh__d1 _lh_numericRule_LH_C_1_5))))))
  else
    (fun _lh_listcomp_fun_1_6 _lh_numericRule_LH_C_1_6 width_4 -> 
      (`LH_N)))
and
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
                (`LH_C((let rec t_1 = _lh_listcomp_fun_ls_h_1 in
                  (let rec h_1 = (char_of_int _lh_listcomp_fun_ls_h_0) in
                    (fun ys_1 -> 
                      (`LH_C(h_1, (t_1 ys_1)))))), (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1)))
              | `LH_N -> 
...
enumFromTo_lh__d2 a_5 b_4 =
  (if (a_5 <= b_4) then
    (let rec t_9 = ((enumFromTo_lh__d2 (a_5 + 1)) b_4) in
      (let rec h_8 = a_5 in
        (fun a_6 -> 
          (t_9 (let rec _lh_listcomp_fun_ls_t_8 = a_6 in
            (let rec _lh_listcomp_fun_ls_h_7 = h_8 in
              (fun _lh_alphabeticRule_LH_C_1_1_0 _lh_listcomp_fun_1_9 -> 
                (let rec _lh_listcomp_fun_2_0 = (fun _lh_listcomp_fun_para_1_1 -> 
                  (match _lh_listcomp_fun_para_1_1 with
                    | `LH_C(_lh_listcomp_fun_ls_h_8, _lh_listcomp_fun_ls_t_9) -> 
                      (`LH_C((let rec t_1_0 = _lh_listcomp_fun_ls_h_8 in
                        (let rec h_9 = (char_of_int _lh_listcomp_fun_ls_h_7) in
                          (fun ys_7 -> 
                            (`LH_C(h_9, (t_1_0 ys_7)))))), (_lh_listcomp_fun_2_0 _lh_listcomp_fun_ls_t_9)))
                    | `LH_N -> 
                      (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_8))) in
                  (_lh_listcomp_fun_2_0 (expand_lh__d1 _lh_alphabeticRule_LH_C_1_1_0))))))))))
  else
    (fun a_7 -> 
      a_7))
and
          ...
          (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_1 -> 
            (match _lh_listcomp_fun_para_1 with
              | `LH_C(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_t_3) -> 
                (`LH_C(((mappend_lh__d2 ((let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_2 -> 
                  (_lh_listcomp_fun_para_2 _lh_listcomp_fun_5)) in
                  (_lh_listcomp_fun_5 ((enumFromTo_lh__d4 1) (width_0 - (length_lh__d3 (string_of_int _lh_listcomp_fun_ls_h_2)))))) (string_of_int _lh_listcomp_fun_ls_h_2))) _lh_listcomp_fun_ls_h_3), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3)))
              | `LH_N -> 
  ...
  (match _lh_expand_arg1_0 with
    ...
    | `LH_C(_lh_expand_LH_C_0_0, _lh_expand_LH_C_1_0) -> 
      (match _lh_expand_LH_C_0_0 with
        | '<' -> 
          (let rec _lh_matchIdent_3 = ((span_lh__d2 (fun c_3 -> 
            (c_3 <> '-'))) _lh_expand_LH_C_1_0) in
            (match _lh_matchIdent_3 with
              | `LH_P2(_lh_numericRule_LH_P2_0_4, _lh_numericRule_LH_P2_1_2) -> 
                (_lh_numericRule_LH_P2_1_2 _lh_numericRule_LH_P2_0_4)
              | _ -> 
                (failwith "error")))
        | '[' -> 
          (match _lh_expand_LH_C_1_0 with
                                ...
                                | ']' -> 
                                  (if ((int_of_char _lh_alphabeticRule_LH_C_0_0) <= (int_of_char _lh_alphabeticRule_LH_C_0_2)) then
                                    (let rec _lh_listcomp_fun_8 = (fun _lh_listcomp_fun_para_4 -> 
                                      ((_lh_listcomp_fun_para_4 _lh_alphabeticRule_LH_C_1_5) _lh_listcomp_fun_8)) in
                                      (_lh_listcomp_fun_8 ((enumFromTo_lh__d1 (int_of_char _lh_alphabeticRule_LH_C_0_0)) (int_of_char _lh_alphabeticRule_LH_C_0_2))))
                                  else
                                    (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_5 -> 
                                      ((_lh_listcomp_fun_para_5 _lh_alphabeticRule_LH_C_1_5) _lh_listcomp_fun_9)) in
                                      (_lh_listcomp_fun_9 (reverse_lh__d1 ((enumFromTo_lh__d2 (int_of_char _lh_alphabeticRule_LH_C_0_2)) (int_of_char _lh_alphabeticRule_LH_C_0_0))))))
                                | _ -> 
                                  (failwith "error"))
                            | _ -> 
                              (failwith "error"))
      ...
      (if (_lh_span_arg1_1 _lh_span_LH_C_0_1) then
        ...
        (`LH_P2((fun f_6 i_6 -> 
          ...
          (fun _lh_numericRule_LH_P2_0_7 _lh_numericRule_LH_P2_0_8 -> 
            (let rec _lh_matchIdent_5 = (let rec _lh_numericRule_LH_P2_1_3 = (mknum_lh__d2 _lh_numericRule_LH_P2_0_7) in
              (let rec _lh_numericRule_LH_P2_0_9 = (mknum_lh__d1 _lh_numericRule_LH_P2_0_8) in
                (fun _lh_numericRule_LH_C_1_4 -> 
                  (let rec width_2 = ((max_lh__d1 (length_lh__d1 (string_of_int _lh_numericRule_LH_P2_0_9))) (length_lh__d2 (string_of_int _lh_numericRule_LH_P2_1_3))) in
                    (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_6 -> 
                      (((_lh_listcomp_fun_para_6 _lh_listcomp_fun_1_0) _lh_numericRule_LH_C_1_4) width_2)) in
                      (_lh_listcomp_fun_1_0 (if (_lh_numericRule_LH_P2_0_9 < _lh_numericRule_LH_P2_1_3) then
                        ((enumFromTo_lh__d3 _lh_numericRule_LH_P2_0_9) _lh_numericRule_LH_P2_1_3)
                      else
                        (((enumFromThenTo_lh__d1 _lh_numericRule_LH_P2_0_9) (_lh_numericRule_LH_P2_0_9 - 1)) _lh_numericRule_LH_P2_1_3)))))))) in
              (_lh_matchIdent_5 _lh_numericRule_LH_C_1_3)))))))
    | _ -> 
      (failwith "error"))
and
            ...
            | `LH_P2(_lh_span_LH_P2_0_0, _lh_span_LH_P2_1_0) -> 
              (`LH_P2((let rec t_0 = _lh_span_LH_P2_0_0 in
                (let rec h_0 = _lh_span_LH_C_0_0 in
                  (fun f_1 i_1 -> 
                    ((t_0 f_1) ((f_1 i_1) h_0))))), _lh_span_LH_P2_1_0))
            | _ -> 
              (failwith "error")))
      else
        (`LH_P2((fun f_2 i_2 -> 

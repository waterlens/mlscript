...
let rec algb_lh__d1__d0 _lh_algb_arg1_1 _lh_algb_arg2_1 a_5 =
...
let rec algb1_lh__d3__d0 _lh_algb1_arg1_4 _lh_algb1_arg2_7 =
  (match _lh_algb1_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec algb_lh__d3__d0 _lh_algb_arg1_0 _lh_algb_arg2_0 ys_0 =
...
let rec algb_lh__d4__d0 _lh_algb_arg1_2 _lh_algb_arg2_2 a_7 =
...
let rec take_lh__d2__d0 n_2 ls_1_1 =
  (if (n_2 > 0) then
    ...
    (`LH_N));;
let rec map_lh__d1__d3 f_2 ls_1_3 _lh_popOutId_0_5 =
  (match ls_1_3 with
    | `LH_C(h_1_2, t_1_4) -> 
      (let rec t_1_5 = ((map_lh__d1__d3 f_2) t_1_4) in
        (let rec h_1_3 = (f_2 h_1_2) in
          ((reverse_helper_lh__d2__d0 t_1_5) (let rec ty_3 = _lh_popOutId_0_5 in
...
let rec reverse_helper_lh__d6__d0 ls_2_0 a_1_2 =
  (match ls_2_0 with
    ...
    | `LH_N -> 
      a_1_2);;
let rec map_lh__d1__d2 f_0 ls_0 _lh_popOutId_0_0 =
  (match ls_0 with
    | `LH_C(h_0, t_0) -> 
      (let rec t_1 = ((map_lh__d1__d2 f_0) t_0) in
        (let rec h_1 = (f_0 h_0) in
          ((reverse_helper_lh__d4__d0 t_1) (let rec ty_0 = _lh_popOutId_0_0 in
            (let rec hy_0 = h_1 in
              (fun hx_1 tx_1 -> 
...
let rec algb1_lh__d2__d0 _lh_algb1_arg1_1 _lh_algb1_arg2_1 =
  (match _lh_algb1_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec algb_lh__d2__d0 _lh_algb_arg1_3 _lh_algb_arg2_3 ys_5 =
  (let rec tx_9 = ((algb1_lh__d2__d0 _lh_algb_arg1_3) (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_3 -> 
    ...
    (let rec hx_9 = 0 in
      ((ys_5 hx_9) tx_9)));;
let rec algc_lh__d1__d0 _lh_algc_arg1_0 _lh_algc_arg2_0 _lh_algc_arg3_0 _lh_algc_arg4_0 _lh_popOutId_0_4 =
                    ...
                    (let rec l1_0 = ((algb_lh__d2__d0 xs1_0) _lh_algc_arg4_0) in
                      (let rec l2_0 = (reverse_lh__d4__d0 ((algb_lh__d4__d0 (reverse_lh__d6__d0 xs2_0)) (reverse_lh__d1__d0 _lh_algc_arg4_0))) in
                        (let rec k_0 = ((((findk_lh__d2__d0 0) 0) (0 - 1)) ((zip_lh__d2__d1 l1_0) l2_0)) in
                          (((((algc_lh__d1__d0 m2_0) k_0) xs1_0) ((take_lh__d1__d0 k_0) _lh_algc_arg4_0)) (((((algc_lh__d1__d0 (_lh_algc_arg1_0 - m2_0)) (_lh_algc_arg2_0 - k_0)) xs2_0) ((drop_lh__d2__d0 k_0) _lh_algc_arg4_0)) _lh_popOutId_0_4)))))))))
        | _ -> 
                ...
                (let rec l1_1 = ((algb_lh__d3__d0 xs1_1) _lh_algc_arg4_0) in
                  (let rec l2_1 = (reverse_lh__d2__d0 ((algb_lh__d1__d0 (reverse_lh__d5__d0 xs2_1)) (reverse_lh__d3__d0 _lh_algc_arg4_0))) in
                    (let rec k_1 = ((((findk_lh__d1__d0 0) 0) (0 - 1)) ((zip_lh__d1__d1 l1_1) l2_1)) in
                      (((((algc_lh__d1__d0 m2_1) k_1) xs1_1) ((take_lh__d4__d0 k_1) _lh_algc_arg4_0)) (((((algc_lh__d1__d0 (_lh_algc_arg1_0 - m2_1)) (_lh_algc_arg2_0 - k_1)) xs2_1) ((drop_lh__d3__d0 k_1) _lh_algc_arg4_0)) _lh_popOutId_0_4))))))))));;

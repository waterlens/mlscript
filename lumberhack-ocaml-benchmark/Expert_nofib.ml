        ...
        (let rec _lh_matchIdent_1_4 = ((break_d1 _lh_break_arg1_1) _lh_break_LH_C_1_0) in
          (match _lh_matchIdent_1_4 with
            | `LH_P2(_lh_break_LH_P2_0_0, _lh_break_LH_P2_1_0) -> 
              (`LH_P2((`LH_C(_lh_break_LH_C_0_0, _lh_break_LH_P2_0_0)), (Obj.magic 99)))
            | _ -> 
              (Obj.magic 99))))
    | _ -> 
      (Obj.magic 99))
                                      ...
                                      (let rec t_1_3_9 = (let rec h_1_1_4 = 't' in
                                        (let rec t_1_4_0 = (let rec h_1_1_5 = ' ' in
                                          (let rec t_1_4_1 = (fun ys_8_7 -> 
                                            ys_8_7) in
                                            (fun ys_8_8 -> 
                                              (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_4_1) ys_8_8)))))) in
                                          (fun ys_8_9 -> 
                                            (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_4_0) ys_8_9)))))) in
                                        (fun ys_9_0 -> 
                                          (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_9) ys_9_0)))))) in
                                      (fun ys_9_1 -> 
                                        (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_8) ys_9_1)))))) in
                                    (fun ys_9_2 -> 
                                      (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_7) ys_9_2)))))) in
                                  (fun ys_9_3 -> 
                                    (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_6) ys_9_3)))))) in
                                (fun ys_9_4 -> 
                                  (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_5) ys_9_4)))))) in
                              (fun ys_9_5 -> 
                                (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_4) ys_9_5)))))) in
                            (fun ys_9_6 -> 
                              (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_3) ys_9_6)))))) in
                          (fun ys_9_7 -> 
                            (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_2) ys_9_7)))))) in
                        (fun ys_9_8 -> 
                          (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_1) ys_9_8)))))) in
                      (fun ys_9_9 -> 
                        (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_3_0) ys_9_9)))))) in
                    (fun ys_1_0_0 -> 
                      (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_2_9) ys_1_0_0)))))) in
                  (fun ys_1_0_1 -> 
                    (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_2_8) ys_1_0_1)))))) in
                (fun ys_1_0_2 -> 
                  (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_2_7) ys_1_0_2)))))) in
              (fun ys_1_0_3 -> 
                (`LH_C((Obj.magic 99), ((mappend_d1_d2 t_1_2_6) ys_1_0_3))))))) _lh_display_Question_0_0)) (let rec h_1_1_6 = '?' in
                              ...
                              (let rec t_1_5_3 = (let rec h_1_2_6 = ':' in
                                (let rec t_1_5_4 = (let rec h_1_2_7 = ' ' in
                                  (let rec t_1_5_5 = (fun ys_1_0_7 -> 
                                    ys_1_0_7) in
                                    (fun ys_1_0_8 -> 
                                      (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_5_5) ys_1_0_8)))))) in
                                  (fun ys_1_0_9 -> 
                                    (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_5_4) ys_1_0_9)))))) in
                                (fun ys_1_1_0 -> 
                                  (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_5_3) ys_1_1_0)))))) in
                              (fun ys_1_1_1 -> 
                                (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_5_2) ys_1_1_1)))))) in
                            (fun ys_1_1_2 -> 
                              (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_5_1) ys_1_1_2)))))) in
                          (fun ys_1_1_3 -> 
                            (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_5_0) ys_1_1_3)))))) in
                        (fun ys_1_1_4 -> 
                          (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_4_9) ys_1_1_4)))))) in
                      (fun ys_1_1_5 -> 
                        (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_4_8) ys_1_1_5)))))) in
                    (fun ys_1_1_6 -> 
                      (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_4_7) ys_1_1_6)))))) in
                  (fun ys_1_1_7 -> 
                    (`LH_C((Obj.magic 99), ((mappend_d1_d5 t_1_4_6) ys_1_1_7))))))) sol_0)) (let rec h_1_2_8 = '.' in
...
and find_d2 _lh_find_arg1_6 _lh_find_arg2_1_0 =
  (let rec _lh_matchIdent_1_5_3 = _lh_find_arg1_6 in
    (match _lh_matchIdent_1_5_3 with
      | `Empty -> 
        (failure_d2 (Obj.magic 99))
      | `Fork(_lh_find_Fork_0_6, _lh_find_Fork_1_6, _lh_find_Fork_2_6) -> 
        (match _lh_find_Fork_1_6 with
          | `LH_P2(_lh_find_LH_P2_0_6, _lh_find_LH_P2_1_6) -> 
...
and mappend_d1_d7 xs_4_1 ys_1_2_7 =
  (match xs_4_1 with
    | `LH_C(h_1_3_6, t_1_7_3) -> 
      (let rec h_1_3_7 = (Obj.magic 99) in
        (let rec t_1_7_4 = ((mappend_d1_d7 t_1_7_3) ys_1_2_7) in
          (fun ys_1_2_8 -> 
            (`LH_C((Obj.magic 99), ((mappend_d1_d6 t_1_7_4) ys_1_2_8))))))
    | `LH_N -> 
      ys_1_2_7)
and mappend_d1_d9 xs_4_0 ys_8_5 =
  (match xs_4_0 with
    | `LH_C(h_9_7, t_1_0_4) -> 
      (let rec h_9_8 = (Obj.magic 99) in
        (let rec t_1_0_5 = ((mappend_d1_d9 t_1_0_4) ys_8_5) in
          (fun ys_8_6 -> 
            (`LH_C((Obj.magic 99), ((mappend_d1_d8 t_1_0_5) ys_8_6))))))
    | `LH_N -> 
      ys_8_5)
and mappend_d2_d1 xs_1_0 ys_2_6 =
  (match xs_1_0 with
    | `LH_C(h_3_2, t_3_3) -> 
      (let rec h_3_3 = (Obj.magic 99) in
        (let rec t_3_4 = ((mappend_d2_d1 t_3_3) ys_2_6) in
          (fun ys_2_7 -> 
            (`LH_C((Obj.magic 99), ((mappend_d2_d0 t_3_4) ys_2_7))))))
    | `LH_N -> 
      ys_2_6)
and mappend_d2_d3 xs_4_8 ys_1_4_7 =
  (match xs_4_8 with
    | `LH_C(h_1_4_9, t_1_8_7) -> 
      (let rec h_1_5_0 = (Obj.magic 99) in
        (let rec t_1_8_8 = ((mappend_d2_d3 t_1_8_7) ys_1_4_7) in
          (fun ys_1_4_8 -> 
            (`LH_C((Obj.magic 99), ((mappend_d2_d2 t_1_8_8) ys_1_4_8))))))
    | `LH_N -> 
      ys_1_4_7)
...
and mappend_d3_d2 xs_4_3 ys_1_3_9 =
  (match xs_4_3 with
    | `LH_C(h_1_4_5, t_1_8_3) -> 
      (let rec h_1_4_6 = (Obj.magic 99) in
        (let rec t_1_8_4 = ((mappend_d3_d2 t_1_8_3) ys_1_3_9) in
          (fun ys_1_4_0 -> 
            (`LH_C((Obj.magic 99), ((mappend_d3_d1 t_1_8_4) ys_1_4_0))))))
    | `LH_N -> 
      ys_1_3_9)
and mappend_d3_d4 xs_4_9 ys_1_4_9 =
  (match xs_4_9 with
    | `LH_C(h_1_5_1, t_1_8_9) -> 
      (let rec h_1_5_2 = (Obj.magic 99) in
        (let rec t_1_9_0 = ((mappend_d3_d4 t_1_8_9) ys_1_4_9) in
          (fun ys_1_5_0 -> 
            (`LH_C((Obj.magic 99), ((mappend_d3_d3 t_1_9_0) ys_1_5_0))))))
    | `LH_N -> 
      ys_1_4_9)
                ...
                (let rec t_2_1 = (let rec h_2_2 = ':' in
                  (let rec t_2_2 = (let rec h_2_3 = ' ' in
                    (let rec t_2_3 = (fun ys_1_0 -> 
                      ys_1_0) in
                      (fun ys_1_1 -> 
                        (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_2_3) ys_1_1)))))) in
                    (fun ys_1_2 -> 
                      (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_2_2) ys_1_2)))))) in
                  (fun ys_1_3 -> 
                    (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_2_1) ys_1_3)))))) in
                (fun ys_1_4 -> 
                  (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_2_0) ys_1_4)))))) in
              (fun ys_1_5 -> 
                (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_1_9) ys_1_5)))))) in
            (fun ys_1_6 -> 
              (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_1_8) ys_1_6)))))) in
          (fun ys_1_7 -> 
            (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_1_7) ys_1_7)))))) in
        (fun ys_1_8 -> 
          (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_1_6) ys_1_8)))))) in
      (fun ys_1_9 -> 
        (`LH_C((Obj.magic 99), ((mappend_d3_d0 t_1_5) ys_1_9))))))) (showPhrase_d1 (problem_0 _lh_process_arg1_0)))) (let rec h_2_4 = '|' in
                ...
                | `LH_N -> 
                  ((mappend_d3_d1 ((mappend_d3_d2 ((mappend_d3_d3 ((mappend_d3_d4 (showPhrase_d1 _lh_showPhrase_LH_C_0_0)) (let rec h_3_7 = ' ' in
                    (let rec t_3_8 = (fun ys_3_1 -> 
                      ys_3_1) in
                      (fun ys_3_2 -> 
                        (`LH_C((Obj.magic 99), ((mappend_d3_d3 t_3_8) ys_3_2)))))))) _lh_showPhrase_Term_0_0)) (let rec h_3_8 = ' ' in
                    (let rec t_3_9 = (fun ys_3_3 -> 
                      ys_3_3) in
                      (fun ys_3_4 -> 
                        (`LH_C((Obj.magic 99), ((mappend_d3_d1 t_3_9) ys_3_4)))))))) (showPhrase_d1 _lh_showPhrase_LH_C_0_1))
                | _ -> 
                  (Obj.magic 99))
            | _ -> 
              (Obj.magic 99))
    ...
    ((mappend_d1_d6 ((mappend_d1_d7 x_2_0) (let rec h_1_3_8 = ';' in
      (let rec t_1_7_6 = (let rec h_1_3_9 = ' ' in
        (let rec t_1_7_7 = (fun ys_1_3_0 -> 
          ys_1_3_0) in
          (fun ys_1_3_1 -> 
            (`LH_C((Obj.magic 99), ((mappend_d1_d6 t_1_7_7) ys_1_3_1)))))) in
        (fun ys_1_3_2 -> 
          (`LH_C((Obj.magic 99), ((mappend_d1_d6 t_1_7_6) ys_1_3_2)))))))) y_3)) in
        ...
        (let rec t_1_7_8 = (let rec h_1_4_1 = '=' in
          (let rec t_1_7_9 = (let rec h_1_4_2 = ' ' in
            (let rec t_1_8_0 = (fun ys_1_3_3 -> 
              ys_1_3_3) in
              (fun ys_1_3_4 -> 
                (`LH_C((Obj.magic 99), ((mappend_d1_d8 t_1_8_0) ys_1_3_4)))))) in
            (fun ys_1_3_5 -> 
              (`LH_C((Obj.magic 99), ((mappend_d1_d8 t_1_7_9) ys_1_3_5)))))) in
          (fun ys_1_3_6 -> 
            (`LH_C((Obj.magic 99), ((mappend_d1_d8 t_1_7_8) ys_1_3_6)))))))) (showPhrase_d0 ((subst_d0 _lh_showVars_arg1_0) (`Var(v_1)))))) in
            ...
            (match _lh_insertKey_arg2_1 with
              | `LH_C(_lh_insertKey_LH_C_0_1, _lh_insertKey_LH_C_1_1) -> 
                (match _lh_insertKey_LH_C_0_1 with
                  | `LH_P2(_lh_insertKey_LH_P2_0_3, _lh_insertKey_LH_P2_1_3) -> 
                    (if (_lh_insertKey_LH_P2_0_2 <= _lh_insertKey_LH_P2_0_3) then
                      (`LH_C((`LH_C((Obj.magic 99), (Obj.magic 99))), _lh_insertKey_LH_C_1_1))
                    else
                      (`LH_C((`LH_P2(_lh_insertKey_LH_P2_0_3, _lh_insertKey_LH_P2_1_3)), ((insertKey_1 (`LH_P2(_lh_insertKey_LH_P2_0_2, _lh_insertKey_LH_P2_1_2))) _lh_insertKey_LH_C_1_1))))
                  | _ -> 
                    (Obj.magic 99))
                ...
                (match _lh_insertKey_LH_C_0_0 with
                  | `LH_P2(_lh_insertKey_LH_P2_0_1, _lh_insertKey_LH_P2_1_1) -> 
                    (if (_lh_insertKey_LH_P2_0_0 <= _lh_insertKey_LH_P2_0_1) then
                      (`LH_C((`LH_C((Obj.magic 99), (Obj.magic 99))), _lh_insertKey_LH_C_1_0))
                    else
                      ...
                      | `LH_N -> 
                        ((mappend_d2_d0 ((mappend_d2_d1 ((mappend_d2_d2 ((mappend_d2_d3 (showPhrase_d0 _lh_showPhrase_LH_C_0_4)) (let rec h_9_5 = ' ' in
                          (let rec t_1_0_2 = (fun ys_8_1 -> 
                            ys_8_1) in
                            (fun ys_8_2 -> 
                              (`LH_C((Obj.magic 99), ((mappend_d2_d2 t_1_0_2) ys_8_2)))))))) _lh_showPhrase_Term_0_2)) (let rec h_9_6 = ' ' in
                          (let rec t_1_0_3 = (fun ys_8_3 -> 
                            ys_8_3) in
                            (fun ys_8_4 -> 
                              (`LH_C((Obj.magic 99), ((mappend_d2_d0 t_1_0_3) ys_8_4)))))))) (showPhrase_d0 _lh_showPhrase_LH_C_0_5))
                      | _ -> 
                        (Obj.magic 99))
                  | _ -> 
                    (Obj.magic 99))
...
let rec break_d0 _lh_break_arg1_8 _lh_break_arg2_5 =
  (match _lh_break_arg2_5 with
    ...
    | _ -> 
      (Obj.magic 99));;
let rec break_d1 _lh_break_arg1_1 _lh_break_arg2_1 =
  (match _lh_break_arg2_1 with
    | `LH_N -> 
      (`LH_P2((`LH_N), (Obj.magic 99)))
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
...
let rec failure_d0 _lh_failure_arg1_6 =
  (`Reason((Obj.magic 99)));;
let rec failure_d1 _lh_failure_arg1_4 _lh_dummy_2_3 =
  (Obj.magic 99);;
let rec failure_d2 _lh_failure_arg1_0 =
  (`Reason((Obj.magic 99)));;
let rec failure_d3 _lh_failure_arg1_5 =
...
let rec mappend_d4_d1 xs_3_4 ys_7_3 =
  (Obj.magic 99);;
let rec mappend_d4_d2 xs_1_5 ys_3_8 =
  (match xs_1_5 with
    | `LH_C(h_4_3, t_4_4) -> 
      (let rec h_4_4 = (Obj.magic 99) in
        (let rec t_4_5 = ((mappend_d4_d2 t_4_4) ys_3_8) in
...
let rec mappend_d8 xs_3_1 ys_6_9 =
  (Obj.magic 99);;
let rec mappend_d9 xs_1_2 ys_2_9 =
  (match xs_1_2 with
    | `LH_C(h_3_5, t_3_6) -> 
      (let rec h_3_6 = (Obj.magic 99) in
        (let rec t_3_7 = ((mappend_d9 t_3_6) ys_2_9) in
...
let rec success_d0 _lh_success_arg1_1_0 =
  (`Answer(_lh_success_arg1_1_0));;
let rec success_d1 _lh_success_arg1_8 _lh_dummy_4_4 =
  (let rec _lh_answer_Answer_0_5 = _lh_success_arg1_8 in
    _lh_answer_Answer_0_5);;
let rec success_d1_d0 _lh_success_arg1_3 =
  (`Answer(_lh_success_arg1_3));;
...
let rec zip_d2 xs_4_7 ys_1_4_4 _lh_popOutId_0_8 =
  (match xs_4_7 with
    | `LH_C(hx_5, tx_5) -> 
      (match ys_1_4_4 with
        | `LH_C(hy_2, ty_2) -> 
          (let rec _lh_listcomp_fun_ls_h_3_1 = (let rec _lh_info_LH_P2_0_0 = hx_5 in
            (let rec _lh_info_LH_P2_1_0 = hy_2 in
              (fun _lh_listcomp_fun_ls_t_3_2 _lh_listcomp_fun_4_5 -> 
                (match _lh_info_LH_P2_0_0 with
                  | `Question(_lh_info_Question_0_0) -> 
                    (`LH_C((`LH_P2(_lh_info_Question_0_0, _lh_info_LH_P2_1_0)), (_lh_listcomp_fun_4_5 _lh_listcomp_fun_ls_t_3_2)))
                  | _ -> 
                    (_lh_listcomp_fun_4_5 _lh_listcomp_fun_ls_t_3_2))))) in
            (let rec _lh_listcomp_fun_ls_t_3_3 = ((zip_d2 tx_5) ty_2) in
              ((_lh_listcomp_fun_ls_h_3_1 _lh_listcomp_fun_ls_t_3_3) _lh_popOutId_0_8)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
and break_d3 _lh_break_arg1_7 _lh_break_arg2_4 =
  (match _lh_break_arg2_4 with
    ...
    | `LH_C(_lh_break_LH_C_0_4, _lh_break_LH_C_1_4) -> 
      (if (_lh_break_arg1_7 _lh_break_LH_C_0_4) then
        (`LH_P2((`LH_N), (let rec _lh_lines_LH_C_1_1 = _lh_break_LH_C_1_4 in
          (fun _lh_dummy_6_5 -> 
            (lines_d2 _lh_lines_LH_C_1_1)))))
      else
        (let rec _lh_matchIdent_1_4_9 = ((break_d3 _lh_break_arg1_7) _lh_break_LH_C_1_4) in
  ...
  (let rec verb_2 = (fun x_7 -> 
    (let rec _lh_matchIdent_3_2 = x_7 in
      (match _lh_matchIdent_3_2 with
        ...
        | _ -> 
          (Obj.magic 99)))) in
    (let rec rs_0 = (let rec _lh_listcomp_fun_1_8 = (fun _lh_listcomp_fun_para_1_2 -> 
      (match _lh_listcomp_fun_para_1_2 with
        | `LH_C(_lh_listcomp_fun_ls_h_1_1, _lh_listcomp_fun_ls_t_1_1) -> 
          (`LH_C((rule_d0 (words_d0 _lh_listcomp_fun_ls_h_1_1)), (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_1_1)))
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_1_8 _lh_definitions_arg1_0)) in
      (let rec verbs_2 = (nub_d0 (let rec _lh_listcomp_fun_1_9 = (fun _lh_listcomp_fun_para_1_3 -> 
        (match _lh_listcomp_fun_para_1_3 with
          | `LH_C(_lh_listcomp_fun_ls_h_1_2, _lh_listcomp_fun_ls_t_1_2) -> 
            (`LH_C((verb_2 _lh_listcomp_fun_ls_h_1_2), (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_1_2)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_9 rs_0))) in
        (let rec def_2 = (fun v_0 -> 
          (let rec _lh_listcomp_fun_2_0 = (fun _lh_listcomp_fun_para_1_4 -> 
            (match _lh_listcomp_fun_para_1_4 with
              | `LH_C(_lh_listcomp_fun_ls_h_1_3, _lh_listcomp_fun_ls_t_1_3) -> 
                (if ((verb_2 _lh_listcomp_fun_ls_h_1_3) = v_0) then
              ...
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_2_0 rs_0))) in
          ((updateList_d0 newTable_d0) (let rec _lh_listcomp_fun_2_1 = (fun _lh_listcomp_fun_para_1_5 -> 
            ((_lh_listcomp_fun_para_1_5 _lh_listcomp_fun_2_1) def_2)) in
            (_lh_listcomp_fun_2_1 verbs_2)))))))
and display_d0 _lh_display_arg1_0 _lh_display_arg2_0 _lh_display_arg3_0 =
  (match _lh_display_arg1_0 with
    | `LH_N -> 
...
and freshCopy_d0 _lh_freshCopy_arg1_0 _lh_freshCopy_arg2_0 =
  (match _lh_freshCopy_arg1_0 with
    | `Soln(_lh_freshCopy_Soln_0_0, _lh_freshCopy_Soln_1_0) -> 
      (let rec xs_2_6 = (vars_d0 _lh_freshCopy_arg2_0) in
        (let rec n_2 = (length_d2 xs_2_6) in
          (let rec tab_0 = ((updateList_d1 newTable_d3) ((zip_d0 xs_2_6) (let rec _lh_listcomp_fun_3_2 = (fun _lh_listcomp_fun_para_2_5 -> 
            (_lh_listcomp_fun_para_2_5 _lh_listcomp_fun_3_2)) in
            (_lh_listcomp_fun_3_2 ((take_d1 n_2) _lh_freshCopy_Soln_1_0))))) in
            (let rec _lh_lookUp_LH_P2_0_0 = (let rec _lh_try_Soln_0_0 = _lh_freshCopy_Soln_0_0 in
              (let rec _lh_try_Soln_1_0 = ((drop_d1 n_2) _lh_freshCopy_Soln_1_0) in
                (fun _lh_try_arg1_1 _lh_try_arg3_1 _lh_try_arg4_1 -> 
                  (match _lh_try_arg4_1 with
                    ...
                    | _ -> 
                      (Obj.magic 99))))) in
              (let rec _lh_lookUp_LH_P2_1_0 = ((subst_d2 tab_0) _lh_freshCopy_arg2_0) in
                (fun _lh_listcomp_fun_ls_t_2_4 _lh_listcomp_fun_3_3 _lh_lookUp_arg1_0 _lh_lookUp_arg3_0 -> 
                  (let rec h_7_2 = ((((try_d0 _lh_lookUp_arg1_0) _lh_lookUp_LH_P2_0_0) _lh_lookUp_arg3_0) _lh_lookUp_LH_P2_1_0) in
                    (let rec t_7_5 = (_lh_listcomp_fun_3_3 _lh_listcomp_fun_ls_t_2_4) in
                      (fun _lh_dummy_4_5 -> 
                        ((mappend_d4_d0 h_7_2) (concat_d1 t_7_5)))))))))))
    | _ -> 
      (Obj.magic 99))
...
and lines_d1 _lh_lines_arg1_1 =
  (let rec _lh_matchIdent_1_3_2 = ((break_d2 (fun x_8 -> 
    ...
    (match _lh_matchIdent_1_3_2 with
      | `LH_P2(_lh_lines_LH_P2_0_1, _lh_lines_LH_P2_1_1) -> 
        (let rec _lh_listcomp_fun_ls_h_2_3 = _lh_lines_LH_P2_0_1 in
          (let rec _lh_listcomp_fun_ls_t_2_3 = (let rec _lh_matchIdent_1_3_3 = _lh_lines_LH_P2_1_1 in
            (_lh_matchIdent_1_3_3 99)) in
            (fun _lh_listcomp_fun_3_1 -> 
              (`LH_C(((words_d2 _lh_listcomp_fun_ls_h_2_3) != (`LH_C((`LH_C('n', (`LH_C('o', (`LH_N))))), (`LH_N)))), (_lh_listcomp_fun_3_1 _lh_listcomp_fun_ls_t_2_3))))))
      | _ -> 
        (Obj.magic 99)))
and lines_d2 _lh_lines_arg1_0 =
  (let rec _lh_matchIdent_2_1 = ((break_d3 (fun x_0 -> 
    ...
    (match _lh_matchIdent_2_1 with
      ...
      | _ -> 
        (Obj.magic 99)))
and lookUp_d0 _lh_lookUp_arg1_1 _lh_lookUp_arg2_0 _lh_lookUp_arg3_1 _lh_lookUp_arg4_0 =
  (let rec copies_0 = (let rec _lh_listcomp_fun_4_1 = (fun _lh_listcomp_fun_para_3_0 -> 
    (match _lh_listcomp_fun_para_3_0 with
      | `LH_C(_lh_listcomp_fun_ls_h_2_9, _lh_listcomp_fun_ls_t_3_0) -> 
        (let rec _lh_listcomp_fun_ls_h_3_0 = ((freshCopy_d0 _lh_lookUp_arg2_0) _lh_listcomp_fun_ls_h_2_9) in
          (let rec _lh_listcomp_fun_ls_t_3_1 = (_lh_listcomp_fun_4_1 _lh_listcomp_fun_ls_t_3_0) in
            (fun _lh_listcomp_fun_4_2 _lh_lookUp_arg1_2 _lh_lookUp_arg3_2 -> 
              ((((_lh_listcomp_fun_ls_h_3_0 _lh_listcomp_fun_ls_t_3_1) _lh_listcomp_fun_4_2) _lh_lookUp_arg1_2) _lh_lookUp_arg3_2))))
      | `LH_N -> 
        (fun _lh_listcomp_fun_4_3 _lh_lookUp_arg1_3 _lh_lookUp_arg3_3 _lh_dummy_1_0_3 -> 
          (`LH_N)))) in
    (_lh_listcomp_fun_4_1 _lh_lookUp_arg4_0)) in
    (concat_d1 (let rec _lh_listcomp_fun_4_4 = (fun _lh_listcomp_fun_para_3_1 -> 
      (((_lh_listcomp_fun_para_3_1 _lh_listcomp_fun_4_4) _lh_lookUp_arg1_1) _lh_lookUp_arg3_1)) in
      (_lh_listcomp_fun_4_4 copies_0))))
and mappend_d1 xs_2 ys_3 =
  (match xs_2 with
    | `LH_C(h_4, t_4) -> 
      (let rec h_5 = h_4 in
    ...
    (let rec _lh_inList_LH_C_1_2_6 = (let rec _lh_inList_LH_C_0_2_7 = (`LH_C('d', (`LH_C('e', (`LH_C('s', (`LH_C('c', (`LH_C('r', (`LH_C('i', (`LH_C('b', (`LH_C('e', (`LH_C('s', (`LH_N))))))))))))))))))) in
      ...
      (fun _lh_inList_arg1_4_7 -> 
        (if (_lh_inList_arg1_4_7 = _lh_inList_LH_C_0_2_6) then
          ...
          ((inList_d5 _lh_inList_arg1_4_7) _lh_inList_LH_C_1_2_6))))) in
    (let rec verb_3 = (head_d5 (let rec _lh_listcomp_fun_3_8 = (fun _lh_listcomp_fun_para_2_7 -> 
      (match _lh_listcomp_fun_para_2_7 with
        | `LH_C(_lh_listcomp_fun_ls_h_2_6, _lh_listcomp_fun_ls_t_2_7) -> 
          (if ((inList_d5 _lh_listcomp_fun_ls_h_2_6) verbs_3) then
            (let rec h_8_2 = _lh_listcomp_fun_ls_h_2_6 in
              (fun _lh_dummy_5_3 -> 
                h_8_2))
          else
        ...
        | `LH_N -> 
          (fun _lh_dummy_5_4 -> 
            (Obj.magic 99)))) in
      (_lh_listcomp_fun_3_8 _lh_relation_arg1_2))) in
      ((((split_d3 _lh_relation_arg1_2) noun_d2) verb_3) noun_d3)))
and relation_d2 _lh_relation_arg1_1 =
  (let rec verbs_1 = (let rec _lh_inList_LH_C_0_8 = (`LH_C('i', (`LH_C('s', (`LH_N))))) in
    (let rec _lh_inList_LH_C_1_8 = (let rec _lh_inList_LH_C_0_9 = (`LH_C('d', (`LH_C('e', (`LH_C('s', (`LH_C('c', (`LH_C('r', (`LH_C('i', (`LH_C('b', (`LH_C('e', (`LH_C('s', (`LH_N))))))))))))))))))) in
                                                                            ...
                                                                            | `LH_C(_lh_solve_LH_C_0_7, _lh_solve_LH_C_1_7) -> 
                                                                              (match _lh_solve_LH_C_1_7 with
                                                                                | `LH_C(_lh_solve_LH_C_0_8, _lh_solve_LH_C_1_8) -> 
                                                                                  (match _lh_solve_LH_C_1_8 with
                                                                                    | `LH_N -> 
                                                                                      (concat_d0 (let rec _lh_listcomp_fun_2_2 = (fun _lh_listcomp_fun_para_1_6 -> 
                                                                                        (match _lh_listcomp_fun_para_1_6 with
                                                                                          | `LH_C(_lh_listcomp_fun_ls_h_1_4, _lh_listcomp_fun_ls_t_1_4) -> 
                                                                                            (let rec h_6_2 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_1_4) _lh_solve_LH_C_0_8) in
                                                                                              (let rec t_6_5 = (_lh_listcomp_fun_2_2 _lh_listcomp_fun_ls_t_1_4) in
                                                                                                (fun _lh_dummy_2_6 -> 
                                                                                                  ((mappend_d3_d9 h_6_2) (concat_d0 t_6_5)))))
                                                                                          | `LH_N -> 
                                                                                            (fun _lh_dummy_2_7 -> 
                                                                                              (`LH_N)))) in
                                                                                        (_lh_listcomp_fun_2_2 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_7))))
                                                                                    | _ -> 
                                                                                      (let rec _lh_matchIdent_3_3 = _lh_solve_arg1_0 in
                                                                                        (match _lh_matchIdent_3_3 with
                                                                                          | `LH_P2(_lh_solve_LH_P2_0_0, _lh_solve_LH_P2_1_0) -> 
                                                                        ...
                                                                        | `LH_C(_lh_solve_LH_C_0_1_2, _lh_solve_LH_C_1_1_2) -> 
                                                                          (match _lh_solve_LH_C_1_1_2 with
                                                                            | `LH_C(_lh_solve_LH_C_0_1_3, _lh_solve_LH_C_1_1_3) -> 
                                                                              (match _lh_solve_LH_C_1_1_3 with
                                                                                | `LH_N -> 
                                                                                  (concat_d0 (let rec _lh_listcomp_fun_2_3 = (fun _lh_listcomp_fun_para_1_7 -> 
                                                                                    (match _lh_listcomp_fun_para_1_7 with
                                                                                      | `LH_C(_lh_listcomp_fun_ls_h_1_5, _lh_listcomp_fun_ls_t_1_5) -> 
                                                                                        (let rec h_6_3 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_1_5) _lh_solve_LH_C_0_1_3) in
                                                                                          (let rec t_6_6 = (_lh_listcomp_fun_2_3 _lh_listcomp_fun_ls_t_1_5) in
                                                                                            (fun _lh_dummy_2_8 -> 
                                                                                              ((mappend_d3_d9 h_6_3) (concat_d0 t_6_6)))))
                                                                                      | `LH_N -> 
                                                                                        (fun _lh_dummy_2_9 -> 
                                                                                          (`LH_N)))) in
                                                                                    (_lh_listcomp_fun_2_3 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_1_2))))
                                                                                | _ -> 
                                                                                  (let rec _lh_matchIdent_4_4 = _lh_solve_arg1_0 in
                                                                                    (match _lh_matchIdent_4_4 with
                                                                                      | `LH_P2(_lh_solve_LH_P2_0_1_1, _lh_solve_LH_P2_1_1_1) -> 
                                                                    ...
                                                                    | `LH_C(_lh_solve_LH_C_0_1_7, _lh_solve_LH_C_1_1_7) -> 
                                                                      (match _lh_solve_LH_C_1_1_7 with
                                                                        | `LH_C(_lh_solve_LH_C_0_1_8, _lh_solve_LH_C_1_1_8) -> 
                                                                          (match _lh_solve_LH_C_1_1_8 with
                                                                            | `LH_N -> 
                                                                              (concat_d0 (let rec _lh_listcomp_fun_2_4 = (fun _lh_listcomp_fun_para_1_8 -> 
                                                                                (match _lh_listcomp_fun_para_1_8 with
                                                                                  | `LH_C(_lh_listcomp_fun_ls_h_1_6, _lh_listcomp_fun_ls_t_1_6) -> 
                                                                                    (let rec h_6_4 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_1_6) _lh_solve_LH_C_0_1_8) in
                                                                                      (let rec t_6_7 = (_lh_listcomp_fun_2_4 _lh_listcomp_fun_ls_t_1_6) in
                                                                                        (fun _lh_dummy_3_0 -> 
                                                                                          ((mappend_d3_d9 h_6_4) (concat_d0 t_6_7)))))
                                                                                  | `LH_N -> 
                                                                                    (fun _lh_dummy_3_1 -> 
                                                                                      (`LH_N)))) in
                                                                                (_lh_listcomp_fun_2_4 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_1_7))))
                                                                            | _ -> 
                                                                              (let rec _lh_matchIdent_5_5 = _lh_solve_arg1_0 in
                                                                                (match _lh_matchIdent_5_5 with
                                                                                  | `LH_P2(_lh_solve_LH_P2_0_2_2, _lh_solve_LH_P2_1_2_2) -> 
                                                                ...
                                                                | `LH_C(_lh_solve_LH_C_0_2_2, _lh_solve_LH_C_1_2_2) -> 
                                                                  (match _lh_solve_LH_C_1_2_2 with
                                                                    | `LH_C(_lh_solve_LH_C_0_2_3, _lh_solve_LH_C_1_2_3) -> 
                                                                      (match _lh_solve_LH_C_1_2_3 with
                                                                        | `LH_N -> 
                                                                          (concat_d0 (let rec _lh_listcomp_fun_2_5 = (fun _lh_listcomp_fun_para_1_9 -> 
                                                                            (match _lh_listcomp_fun_para_1_9 with
                                                                              | `LH_C(_lh_listcomp_fun_ls_h_1_7, _lh_listcomp_fun_ls_t_1_7) -> 
                                                                                (let rec h_6_5 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_1_7) _lh_solve_LH_C_0_2_3) in
                                                                                  (let rec t_6_8 = (_lh_listcomp_fun_2_5 _lh_listcomp_fun_ls_t_1_7) in
                                                                                    (fun _lh_dummy_3_2 -> 
                                                                                      ((mappend_d3_d9 h_6_5) (concat_d0 t_6_8)))))
                                                                              | `LH_N -> 
                                                                                (fun _lh_dummy_3_3 -> 
                                                                                  (`LH_N)))) in
                                                                            (_lh_listcomp_fun_2_5 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_2_2))))
                                                                        | _ -> 
                                                                          (let rec _lh_matchIdent_6_6 = _lh_solve_arg1_0 in
                                                                            (match _lh_matchIdent_6_6 with
                                                                              | `LH_P2(_lh_solve_LH_P2_0_3_3, _lh_solve_LH_P2_1_3_3) -> 
                                                                  ...
                                                                  (match _lh_solve_LH_C_1_2_8 with
                                                                    | `LH_N -> 
                                                                      (concat_d0 (let rec _lh_listcomp_fun_2_6 = (fun _lh_listcomp_fun_para_2_0 -> 
                                                                        (match _lh_listcomp_fun_para_2_0 with
                                                                          | `LH_C(_lh_listcomp_fun_ls_h_1_8, _lh_listcomp_fun_ls_t_1_8) -> 
                                                                            (let rec h_6_6 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_1_8) _lh_solve_LH_C_0_2_8) in
                                                                              (let rec t_6_9 = (_lh_listcomp_fun_2_6 _lh_listcomp_fun_ls_t_1_8) in
                                                                                (fun _lh_dummy_3_4 -> 
                                                                                  ((mappend_d3_d9 h_6_6) (concat_d0 t_6_9)))))
                                                                          | `LH_N -> 
                                                                            (fun _lh_dummy_3_5 -> 
                                                                              (`LH_N)))) in
                                                                        (_lh_listcomp_fun_2_6 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_2_7))))
                                                                    | _ -> 
                                                                      (let rec _lh_matchIdent_7_7 = _lh_solve_arg1_0 in
                                                                        (match _lh_matchIdent_7_7 with
                                                                          | `LH_P2(_lh_solve_LH_P2_0_4_4, _lh_solve_LH_P2_1_4_4) -> 
                                                              ...
                                                              (match _lh_solve_LH_C_1_3_3 with
                                                                | `LH_N -> 
                                                                  (concat_d0 (let rec _lh_listcomp_fun_2_7 = (fun _lh_listcomp_fun_para_2_1 -> 
                                                                    (match _lh_listcomp_fun_para_2_1 with
                                                                      | `LH_C(_lh_listcomp_fun_ls_h_1_9, _lh_listcomp_fun_ls_t_1_9) -> 
                                                                        (let rec h_6_7 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_1_9) _lh_solve_LH_C_0_3_3) in
                                                                          (let rec t_7_0 = (_lh_listcomp_fun_2_7 _lh_listcomp_fun_ls_t_1_9) in
                                                                            (fun _lh_dummy_3_6 -> 
                                                                              ((mappend_d3_d9 h_6_7) (concat_d0 t_7_0)))))
                                                                      | `LH_N -> 
                                                                        (fun _lh_dummy_3_7 -> 
                                                                          (`LH_N)))) in
                                                                    (_lh_listcomp_fun_2_7 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_3_2))))
                                                                | _ -> 
                                                                  (let rec _lh_matchIdent_8_8 = _lh_solve_arg1_0 in
                                                                    (match _lh_matchIdent_8_8 with
                                                                      | `LH_P2(_lh_solve_LH_P2_0_5_5, _lh_solve_LH_P2_1_5_5) -> 
                                                          ...
                                                          (match _lh_solve_LH_C_1_3_8 with
                                                            | `LH_N -> 
                                                              (concat_d0 (let rec _lh_listcomp_fun_2_8 = (fun _lh_listcomp_fun_para_2_2 -> 
                                                                (match _lh_listcomp_fun_para_2_2 with
                                                                  | `LH_C(_lh_listcomp_fun_ls_h_2_0, _lh_listcomp_fun_ls_t_2_0) -> 
                                                                    (let rec h_6_8 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_2_0) _lh_solve_LH_C_0_3_8) in
                                                                      (let rec t_7_1 = (_lh_listcomp_fun_2_8 _lh_listcomp_fun_ls_t_2_0) in
                                                                        (fun _lh_dummy_3_8 -> 
                                                                          ((mappend_d3_d9 h_6_8) (concat_d0 t_7_1)))))
                                                                  | `LH_N -> 
                                                                    (fun _lh_dummy_3_9 -> 
                                                                      (`LH_N)))) in
                                                                (_lh_listcomp_fun_2_8 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_3_7))))
                                                            | _ -> 
                                                              (let rec _lh_matchIdent_9_9 = _lh_solve_arg1_0 in
                                                                (match _lh_matchIdent_9_9 with
                                                                  | `LH_P2(_lh_solve_LH_P2_0_6_6, _lh_solve_LH_P2_1_6_6) -> 
                                                      ...
                                                      (match _lh_solve_LH_C_1_4_3 with
                                                        | `LH_N -> 
                                                          (concat_d0 (let rec _lh_listcomp_fun_2_9 = (fun _lh_listcomp_fun_para_2_3 -> 
                                                            (match _lh_listcomp_fun_para_2_3 with
                                                              | `LH_C(_lh_listcomp_fun_ls_h_2_1, _lh_listcomp_fun_ls_t_2_1) -> 
                                                                (let rec h_6_9 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_2_1) _lh_solve_LH_C_0_4_3) in
                                                                  (let rec t_7_2 = (_lh_listcomp_fun_2_9 _lh_listcomp_fun_ls_t_2_1) in
                                                                    (fun _lh_dummy_4_0 -> 
                                                                      ((mappend_d3_d9 h_6_9) (concat_d0 t_7_2)))))
                                                              | `LH_N -> 
                                                                (fun _lh_dummy_4_1 -> 
                                                                  (`LH_N)))) in
                                                            (_lh_listcomp_fun_2_9 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_4_2))))
                                                        | _ -> 
                                                          (let rec _lh_matchIdent_1_1_0 = _lh_solve_arg1_0 in
                                                            (match _lh_matchIdent_1_1_0 with
                                                              | `LH_P2(_lh_solve_LH_P2_0_7_7, _lh_solve_LH_P2_1_7_7) -> 
                                                  ...
                                                  (match _lh_solve_LH_C_1_4_8 with
                                                    | `LH_N -> 
                                                      (concat_d0 (let rec _lh_listcomp_fun_3_0 = (fun _lh_listcomp_fun_para_2_4 -> 
                                                        (match _lh_listcomp_fun_para_2_4 with
                                                          | `LH_C(_lh_listcomp_fun_ls_h_2_2, _lh_listcomp_fun_ls_t_2_2) -> 
                                                            (let rec h_7_0 = (((solve_d0 _lh_solve_arg1_0) _lh_listcomp_fun_ls_h_2_2) _lh_solve_LH_C_0_4_8) in
                                                              (let rec t_7_3 = (_lh_listcomp_fun_3_0 _lh_listcomp_fun_ls_t_2_2) in
                                                                (fun _lh_dummy_4_2 -> 
                                                                  ((mappend_d3_d9 h_7_0) (concat_d0 t_7_3)))))
                                                          | `LH_N -> 
                                                            (fun _lh_dummy_4_3 -> 
                                                              (`LH_N)))) in
                                                        (_lh_listcomp_fun_3_0 (((solve_d0 _lh_solve_arg1_0) _lh_solve_arg2_0) _lh_solve_LH_C_0_4_7))))
                                                    | _ -> 
                                                      (let rec _lh_matchIdent_1_2_1 = _lh_solve_arg1_0 in
                                                        (match _lh_matchIdent_1_2_1 with
                                                          | `LH_P2(_lh_solve_LH_P2_0_8_8, _lh_solve_LH_P2_1_8_8) -> 
...
and subst_d0 _lh_subst_arg1_4 _lh_subst_arg2_4 =
  (match _lh_subst_arg2_4 with
    | `Term(_lh_subst_Term_0_4, _lh_subst_Term_1_4) -> 
      (let rec _lh_showPhrase_Term_0_2 = _lh_subst_Term_0_4 in
        (let rec _lh_showPhrase_Term_1_2 = (let rec _lh_listcomp_fun_4_0 = (fun _lh_listcomp_fun_para_2_9 -> 
          (match _lh_listcomp_fun_para_2_9 with
            | `LH_C(_lh_listcomp_fun_ls_h_2_8, _lh_listcomp_fun_ls_t_2_9) -> 
              (`LH_C(((subst_d0 _lh_subst_arg1_4) _lh_listcomp_fun_ls_h_2_8), (_lh_listcomp_fun_4_0 _lh_listcomp_fun_ls_t_2_9)))
            | `LH_N -> 
              (`LH_N))) in
          (_lh_listcomp_fun_4_0 _lh_subst_Term_1_4)) in
          (fun _lh_dummy_6_2 -> 
            (match _lh_showPhrase_Term_1_2 with
              | `LH_N -> 
                _lh_showPhrase_Term_0_2
...
and subst_d2 _lh_subst_arg1_3 _lh_subst_arg2_3 =
  (match _lh_subst_arg2_3 with
    | `Term(_lh_subst_Term_0_3, _lh_subst_Term_1_3) -> 
      (`Term(_lh_subst_Term_0_3, (let rec _lh_listcomp_fun_3_4 = (fun _lh_listcomp_fun_para_2_6 -> 
        (match _lh_listcomp_fun_para_2_6 with
          | `LH_C(_lh_listcomp_fun_ls_h_2_4, _lh_listcomp_fun_ls_t_2_5) -> 
            (`LH_C(((subst_d2 _lh_subst_arg1_3) _lh_listcomp_fun_ls_h_2_4), (_lh_listcomp_fun_3_4 _lh_listcomp_fun_ls_t_2_5)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_3_4 _lh_subst_Term_1_3))))
    | `Var(_lh_subst_Var_0_3) -> 
      (let rec lookup_3 = ((find_d3 _lh_subst_arg1_3) _lh_subst_Var_0_3) in
        (if (fails_d2 lookup_3) then
          (`Var(_lh_subst_Var_0_3))
...
and take_d1 n_3 ls_2_8 _lh_popOutId_0_4 _lh_popOutId_1_1 _lh_popOutId_2_1 _lh_popOutId_3_1 _lh_popOutId_4_1 =
  (if (n_3 > 0) then
    (match ls_2_8 with
      | `LH_C(h_7_7, t_8_2) -> 
        (let rec _lh_listcomp_fun_ls_h_2_5 = h_7_7 in
          (let rec _lh_listcomp_fun_ls_t_2_6 = ((take_d1 (n_3 - 1)) t_8_2) in
            (let rec hy_0 = (`Var(_lh_listcomp_fun_ls_h_2_5)) in
              (let rec ty_0 = (_lh_popOutId_0_4 _lh_listcomp_fun_ls_t_2_6) in
              ...
              (let rec _lh_matchIdent_1_5 = ((break_d2 _lh_popOutId_0_2) _lh_break_LH_C_1_1) in
                (match _lh_matchIdent_1_5 with
                  ...
                  | _ -> 
                    (Obj.magic 99))))))
      | `LH_N -> 
        (`LH_P2((`LH_N), (fun _lh_dummy_8 _lh_listcomp_fun_1_1 -> 
          (`LH_N)))))
  else
    (`LH_P2((`LH_N), (fun _lh_dummy_9 _lh_listcomp_fun_1_2 -> 
      (`LH_N)))))
and testExpert_nofib_d0 _lh_testExpert_nofib_arg1_0 =
  (let rec animals_0 = (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('X', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('z', (`LH_C('e', (`LH_C('b', (`LH_C('r', (`LH_C('a', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('s', (`LH_C('t', (`LH_C('r', (`LH_C('i', (`LH_C('p', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('h', (`LH_C('o', (`LH_C('o', (`LH_C('v', (`LH_C('e', (`LH_C('s', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('t', (`LH_C('i', (`LH_C('g', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('s', (`LH_C('t', (`LH_C('r', (`LH_C('i', (`LH_C('p', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('c', (`LH_C('l', (`LH_C('a', (`LH_C('w', (`LH_C('s', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_C('g', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('m', (`LH_C('a', (`LH_C('m', (`LH_C('m', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('d', (`LH_C('e', (`LH_C('s', (`LH_C('c', (`LH_C('r', (`LH_C('i', (`LH_C('b', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('c', (`LH_C('a', (`LH_C('n', (`LH_C(' ', (`LH_C('b', (`LH_C('a', (`LH_C('r', (`LH_C('k', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('c', (`LH_C('a', (`LH_C('t', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('m', (`LH_C('a', (`LH_C('m', (`LH_C('m', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('d', (`LH_C('e', (`LH_C('s', (`LH_C('c', (`LH_C('r', (`LH_C('i', (`LH_C('b', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('c', (`LH_C('a', (`LH_C('n', (`LH_C(' ', (`LH_C('m', (`LH_C('i', (`LH_C('e', (`LH_C('o', (`LH_C('w', (`LH_C('|', (`LH_C('m', (`LH_C('a', (`LH_C('m', (`LH_C('m', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('d', (`LH_C('e', (`LH_C('s', (`LH_C('c', (`LH_C('r', (`LH_C('i', (`LH_C('b', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('i', (`LH_C('r', (`LH_C(' ', (`LH_C('o', (`LH_C('r', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('m', (`LH_C('i', (`LH_C('l', (`LH_C('k', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C('i', (`LH_C('r', (`LH_C('d', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('f', (`LH_C('e', (`LH_C('a', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C('i', (`LH_C('r', (`LH_C('d', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('c', (`LH_C('a', (`LH_C('n', (`LH_C(' ', (`LH_C('f', (`LH_C('l', (`LH_C('y', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('e', (`LH_C('g', (`LH_C('g', (`LH_C('s', (`LH_C('|', (`LH_C('X', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('f', (`LH_C('i', (`LH_C('s', (`LH_C('h', (`LH_C(' ', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('c', (`LH_C('a', (`LH_C('n', (`LH_C(' ', (`LH_C('s', (`LH_C('w', (`LH_C('i', (`LH_C('m', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('X', (`LH_C(' ', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C(' ', (`LH_C('f', (`LH_C('i', (`LH_C('n', (`LH_C('s', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
    (let rec contents_0 = (`LH_C('N', (`LH_C('o', (`LH_C('|', (`LH_C('N', (`LH_C('o', (`LH_C('|', (`LH_C('Y', (`LH_C('o', (`LH_C('u', (`LH_C(' ', (`LH_C('b', (`LH_C('e', (`LH_C('t', (`LH_C('|', (`LH_C('M', (`LH_C('a', (`LH_C('y', (`LH_C('b', (`LH_C('e', (`LH_C('|', (`LH_C('A', (`LH_C(' ', (`LH_C('t', (`LH_C('i', (`LH_C('g', (`LH_C('e', (`LH_C('r', (`LH_C('?', (`LH_C('|', (`LH_C('U', (`LH_C('n', (`LH_C('h', (`LH_C('u', (`LH_C('h', (`LH_C('|', (`LH_C('Y', (`LH_C('e', (`LH_C('p', (`LH_C('|', (`LH_C('y', (`LH_C('|', (`LH_C('n', (`LH_C('|', (`LH_C('y', (`LH_C('|', (`LH_C('y', (`LH_C('|', (`LH_C('y', (`LH_C('|', (`LH_C('y', (`LH_C('|', (`LH_C('n', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
  ...
  (let rec names_1 = (fun _lh_names_arg1_1 -> 
    (match _lh_names_arg1_1 with
      | `Var(_lh_names_Var_0_1) -> 
        (`LH_C(_lh_names_Var_0_1, (`LH_N)))
      | `Term(_lh_names_Term_0_1, _lh_names_Term_1_1) -> 
        (concat_d2 (let rec _lh_listcomp_fun_3_9 = (fun _lh_listcomp_fun_para_2_8 -> 
          (match _lh_listcomp_fun_para_2_8 with
            | `LH_C(_lh_listcomp_fun_ls_h_2_7, _lh_listcomp_fun_ls_t_2_8) -> 
              (let rec h_9_4 = (names_1 _lh_listcomp_fun_ls_h_2_7) in
                (let rec t_1_0_1 = (_lh_listcomp_fun_3_9 _lh_listcomp_fun_ls_t_2_8) in
                  (fun _lh_dummy_6_0 -> 
                    ((mappend_d4_d3 h_9_4) (concat_d2 t_1_0_1)))))
            | `LH_N -> 
              (fun _lh_dummy_6_1 -> 
                (`LH_N)))) in
          (_lh_listcomp_fun_3_9 _lh_names_Term_1_1)))
      | _ -> 
        (Obj.magic 99))) in
    (nub_d1 (names_1 _lh_vars_arg1_1)))
and vars_d1 _lh_vars_arg1_0 =

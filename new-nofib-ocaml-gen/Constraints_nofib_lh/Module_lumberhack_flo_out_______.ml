...
let rec enumFromTo_lh__d7 a_8 b_6 =
  (if (a_8 <= b_6) then
    ...
    (fun _lh_listcomp_fun_ls_h_9 _lh_listcomp_fun_2_1 f_3_3 hx_1_0 tx_1_0 -> 
      (`LH_N)));;
  ...
  (match ls_2_8 with
    | `LH_C(h_3_2, t_3_2) -> 
      (let rec _lh_combine_LH_C_1_1 = ((map_lh__d8 f_5_6) t_3_2) in
        (let rec _lh_combine_LH_C_0_1 = (f_5_6 h_3_2) in
...
let rec enumFromTo_lh__d5 a_9 b_7 =
  (if (a_9 <= b_7) then
    ...
    (fun _lh_listcomp_fun_ls_h_1_2 _lh_listcomp_fun_2_3 f_3_5 hx_1_3 tx_1_3 -> 
      (`LH_N)));;

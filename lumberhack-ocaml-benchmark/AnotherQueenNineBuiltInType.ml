...
let rec zip__d0 xs_0 ys_0 =
  (xs_0 ys_0);;
let rec enumFromTo__d0 a_1 b_1 _lh_popOutId_0_2 _lh_popOutId_1_2 _lh_popOutId_2_2 _lh_popOutId_3_1 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo__d0 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_1 in
        (if ((safe__d0 _lh_popOutId_0_2) _lh_listcomp_fun_ls_h_1) then
          (`LH_C(((append__d0 _lh_popOutId_0_2) (`LH_C(_lh_listcomp_fun_ls_h_1, (`LH_N)))), (_lh_popOutId_1_2 _lh_listcomp_fun_ls_t_2)))
        else
          (_lh_popOutId_1_2 _lh_listcomp_fun_ls_t_2))))
  else
    (_lh_popOutId_3_1 _lh_popOutId_2_2))
and enumFromTo__d1 a_0 b_0 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 _lh_popOutId_3_0 =
  (if (a_0 <= b_0) then
    (let rec tx_0 = ((enumFromTo__d1 (a_0 + 1)) b_0) in
      (let rec hx_0 = a_0 in
                      ...
                      (let rec _lh_and_LH_C_0_0 = (((_lh_safe_LH_P2_1_0 <> _lh_safe_arg2_0) && ((_lh_safe_LH_P2_0_0 + _lh_safe_LH_P2_1_0) <> (m_0 + _lh_safe_arg2_0))) && ((_lh_safe_LH_P2_0_0 - _lh_safe_LH_P2_1_0) <> (m_0 - _lh_safe_arg2_0))) in
                        (fun _lh_dummy_0 -> 
                          (if _lh_and_LH_C_0_0 then
                            ...
                            false))))))) in
                ((((_lh_listcomp_fun_ls_h_0 _lh_listcomp_fun_ls_t_0) _lh_popOutId_1_1) _lh_popOutId_2_1) _lh_popOutId_3_0)))
          | `LH_N -> 
            (fun _lh_dummy_1 -> 
              true))))
  else
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_AnotherQueenNineBuiltInType" (fun () -> ignore (let open Module_original in ((testAnotherQueenNineBuiltInType__d0 9))));
  Bench.Test.create ~name:"lumberhack_AnotherQueenNineBuiltInType" (fun () -> ignore (let open Module_lumberhack in ((testAnotherQueenNineBuiltInType__d0 9))));
  Bench.Test.create ~name:"lumberhack_pop_out_AnotherQueenNineBuiltInType" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testAnotherQueenNineBuiltInType__d0 9))));
])

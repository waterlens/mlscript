    ...
    | _ -> 
      (let rec t_1_1_2 = ((copy_lh__d1 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
        (let rec h_1_1_2 = _lh_copy_arg2_1 in
          (fun f_2_7 -> 
            (let rec t_1_1_3 = ((map_lh__d4 f_2_7) t_1_1_2) in
              (let rec h_1_1_3 = (f_2_7 h_1_1_2) in
                (fun n_4_3 -> 
                  (`LH_C(h_1_1_3, ((take_lh__d0 (n_4_3 - 1)) t_1_1_3))))))))));;
let rec copy_lh__d0 _lh_copy_arg1_2 _lh_copy_arg2_2 =
    ...
    | _ -> 
      (let rec t_1_2_5 = ((copy_lh__d0 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
        (let rec h_1_2_5 = _lh_copy_arg2_2 in
          (fun n_4_6 -> 
            (`LH_C(h_1_2_5, ((take_lh__d1 (n_4_6 - 1)) t_1_2_5)))))));;
    ...
    | _ -> 
      (let rec t_1_3_9 = ((copy_lh__d2 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
        (let rec h_1_3_9 = _lh_copy_arg2_3 in
          (fun ys_1_0_3 -> 
            (let rec t_1_4_0 = ((mappend_lh__d1_d3 t_1_3_9) ys_1_0_3) in

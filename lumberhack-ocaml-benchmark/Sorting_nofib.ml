...
and mangle_d0_d0 _lh_mangle_arg1_0 =
  (let rec sort_0 = (fun _lh_sort_arg1_0 -> 
    ((((foldr_d0_d0 (fun f_2 g_0 _lh_funcomp_x_0 -> 
      ...
      x_0)) ((intersperse_d0_d0 reverse_d3_d0) (let rec _lh_intersperse_LH_C_1_0 = (let rec _lh_prependToAll_LH_C_1_0 = (let rec _lh_prependToAll_LH_C_1_1 = (let rec _lh_prependToAll_LH_C_1_2 = (let rec _lh_prependToAll_LH_C_1_3 = (let rec _lh_prependToAll_LH_C_1_4 = (let rec _lh_prependToAll_LH_C_1_5 = (let rec _lh_prependToAll_LH_C_1_6 = (fun _lh_prependToAll_arg1_0 f_3 i_1 -> 
      i_1) in
      (let rec _lh_prependToAll_LH_C_0_0 = treeSort2_d0_d0 in
        (fun _lh_prependToAll_arg1_1 -> 
          (let rec t_3 = (let rec t_4 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_1) _lh_prependToAll_LH_C_1_6) in
            (let rec h_3 = _lh_prependToAll_LH_C_0_0 in
              (fun f_4 i_2 -> 
                ((f_4 h_3) (((foldr_d0_d0 f_4) i_2) t_4))))) in
            (let rec h_4 = _lh_prependToAll_arg1_1 in
              (fun f_5 i_3 -> 
                ((f_5 h_4) (((foldr_d0_d0 f_5) i_3) t_3)))))))) in
      (let rec _lh_prependToAll_LH_C_0_1 = treeSort_d0_d0 in
        (fun _lh_prependToAll_arg1_2 -> 
          (let rec t_5 = (let rec t_6 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_2) _lh_prependToAll_LH_C_1_5) in
            (let rec h_5 = _lh_prependToAll_LH_C_0_1 in
              (fun f_6 i_4 -> 
                ((f_6 h_5) (((foldr_d0_d0 f_6) i_4) t_6))))) in
            (let rec h_6 = _lh_prependToAll_arg1_2 in
              (fun f_7 i_5 -> 
                ((f_7 h_6) (((foldr_d0_d0 f_7) i_5) t_5)))))))) in
      (let rec _lh_prependToAll_LH_C_0_2 = quickerSort_d0_d0 in
        (fun _lh_prependToAll_arg1_3 -> 
          (let rec t_7 = (let rec t_8 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_3) _lh_prependToAll_LH_C_1_4) in
            (let rec h_7 = _lh_prependToAll_LH_C_0_2 in
              (fun f_8 i_6 -> 
                ((f_8 h_7) (((foldr_d0_d0 f_8) i_6) t_8))))) in
            (let rec h_8 = _lh_prependToAll_arg1_3 in
              (fun f_9 i_7 -> 
                ((f_9 h_8) (((foldr_d0_d0 f_9) i_7) t_7)))))))) in
      (let rec _lh_prependToAll_LH_C_0_3 = quickSort2_d0_d0 in
        (fun _lh_prependToAll_arg1_4 -> 
          (let rec t_9 = (let rec t_1_0 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_4) _lh_prependToAll_LH_C_1_3) in
            (let rec h_9 = _lh_prependToAll_LH_C_0_3 in
              (fun f_1_0 i_8 -> 
                ((f_1_0 h_9) (((foldr_d0_d0 f_1_0) i_8) t_1_0))))) in
            (let rec h_1_0 = _lh_prependToAll_arg1_4 in
              (fun f_1_1 i_9 -> 
                ((f_1_1 h_1_0) (((foldr_d0_d0 f_1_1) i_9) t_9)))))))) in
      (let rec _lh_prependToAll_LH_C_0_4 = quickSort_d0_d0 in
        (fun _lh_prependToAll_arg1_5 -> 
          (let rec t_1_1 = (let rec t_1_2 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_5) _lh_prependToAll_LH_C_1_2) in
            (let rec h_1_1 = _lh_prependToAll_LH_C_0_4 in
              (fun f_1_2 i_1_0 -> 
                ((f_1_2 h_1_1) (((foldr_d0_d0 f_1_2) i_1_0) t_1_2))))) in
            (let rec h_1_2 = _lh_prependToAll_arg1_5 in
              (fun f_1_3 i_1_1 -> 
                ((f_1_3 h_1_2) (((foldr_d0_d0 f_1_3) i_1_1) t_1_1)))))))) in
      (let rec _lh_prependToAll_LH_C_0_5 = mergeSort_d0_d0 in
        (fun _lh_prependToAll_arg1_6 -> 
          (let rec t_1_3 = (let rec t_1_4 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_6) _lh_prependToAll_LH_C_1_1) in
            (let rec h_1_3 = _lh_prependToAll_LH_C_0_5 in
              (fun f_1_4 i_1_2 -> 
                ((f_1_4 h_1_3) (((foldr_d0_d0 f_1_4) i_1_2) t_1_4))))) in
            (let rec h_1_4 = _lh_prependToAll_arg1_6 in
              (fun f_1_5 i_1_3 -> 
                ((f_1_5 h_1_4) (((foldr_d0_d0 f_1_5) i_1_3) t_1_3)))))))) in
      (let rec _lh_prependToAll_LH_C_0_6 = insertSort_d0_d0 in
        (fun _lh_prependToAll_arg1_7 -> 
          (let rec t_1_5 = (let rec t_1_6 = ((prependToAll_d0_d0 _lh_prependToAll_arg1_7) _lh_prependToAll_LH_C_1_0) in
            (let rec h_1_5 = _lh_prependToAll_LH_C_0_6 in
              (fun f_1_6 i_1_4 -> 
                ((f_1_6 h_1_5) (((foldr_d0_d0 f_1_6) i_1_4) t_1_6))))) in
            (let rec h_1_6 = _lh_prependToAll_arg1_7 in
              (fun f_1_7 i_1_5 -> 
                ((f_1_7 h_1_6) (((foldr_d0_d0 f_1_7) i_1_5) t_1_5)))))))) in
      (let rec _lh_intersperse_LH_C_0_0 = heapSort_d0_d0 in
...
and reverse_helper_d0_d0 ls_1_1 a_3 =
  (match ls_1_1 with
    | `LH_C(h_3_2, t_3_2) -> 
      ((reverse_helper_d0_d0 t_3_2) (let rec t_3_3 = a_3 in
...
and reverse_helper_d0_d1 ls_1_5 a_4 =
  (match ls_1_5 with
    | `LH_C(h_3_5, t_3_5) -> 
      ((reverse_helper_d0_d1 t_3_5) (let rec t_3_6 = a_4 in
...
and reverse_helper_d1_d0 ls_7 a_2 =
  (match ls_7 with
    | `LH_C(h_2_5, t_2_5) -> 
      ((reverse_helper_d1_d0 t_2_5) (let rec t_2_6 = a_2 in
...
and reverse_helper_d1_d1 ls_3 a_1 =
  (match ls_3 with
    | `LH_C(h_1_9, t_1_9) -> 
      ((reverse_helper_d1_d1 t_1_9) (let rec t_2_0 = a_1 in
...
and reverse_helper_d2_d0 ls_0 a_0 =
  (match ls_0 with
    | `LH_C(h_0, t_0) -> 
      ((reverse_helper_d2_d0 t_0) (let rec t_1 = a_0 in
        (let rec h_1 = h_0 in
          (fun ys_0 -> 
...
and unlines_d0_d0 _lh_unlines_arg1_0 =
  (concat_d0_d0 ((map_d0_d0 (fun l_0 -> 
    ((mappend_d9_d0 l_0) (let rec t_3_0 = (fun ys_1_3 -> 
      ys_1_3) in
      (let rec h_3_0 = '|' in
        (fun ys_1_4 -> 
...
(* lumberhack_pop_out *)
let rec compareList_d0_d0_d0 _lh_compareList_arg1_2_8 _lh_compareList_arg2_2_8 =
      ...
      (match _lh_compareList_arg2_2_8 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_8_6, _lh_compareList_LH_C_1_8_6) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_8_5) = (int_of_char _lh_compareList_LH_C_0_8_6)) then
            ((compareList_d0_d0_d0 _lh_compareList_LH_C_1_8_5) _lh_compareList_LH_C_1_8_6)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_8_5) < (int_of_char _lh_compareList_LH_C_0_8_6)) then
              false
            else
...
let rec compareList_d1_d0_d0 _lh_compareList_arg1_4_1 _lh_compareList_arg2_4_1 =
  (match _lh_compareList_arg1_4_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d1_d0_d0_d0 _lh_compareList_arg1_3_5 _lh_compareList_arg2_3_5 =
  (match _lh_compareList_arg1_3_5 with
      ...
      (match _lh_compareList_arg2_3_5 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_0_7, _lh_compareList_LH_C_1_1_0_7) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_0_6) = (int_of_char _lh_compareList_LH_C_0_1_0_7)) then
            ((compareList_d1_d0_d0_d0 _lh_compareList_LH_C_1_1_0_6) _lh_compareList_LH_C_1_1_0_7)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_0_6) < (int_of_char _lh_compareList_LH_C_0_1_0_7)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d1_d1_d0_d0 _lh_compareList_arg1_3_8 _lh_compareList_arg2_3_8 =
  (match _lh_compareList_arg1_3_8 with
      ...
      (match _lh_compareList_arg2_3_8 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_1_6, _lh_compareList_LH_C_1_1_1_6) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_1_5) = (int_of_char _lh_compareList_LH_C_0_1_1_6)) then
            ((compareList_d1_d1_d0_d0 _lh_compareList_LH_C_1_1_1_5) _lh_compareList_LH_C_1_1_1_6)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_1_5) < (int_of_char _lh_compareList_LH_C_0_1_1_6)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d1_d2_d0_d0 _lh_compareList_arg1_3_3 _lh_compareList_arg2_3_3 =
  (match _lh_compareList_arg1_3_3 with
      ...
      (match _lh_compareList_arg2_3_3 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_0_1, _lh_compareList_LH_C_1_1_0_1) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_0_0) = (int_of_char _lh_compareList_LH_C_0_1_0_1)) then
            ((compareList_d1_d2_d0_d0 _lh_compareList_LH_C_1_1_0_0) _lh_compareList_LH_C_1_1_0_1)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_0_0) < (int_of_char _lh_compareList_LH_C_0_1_0_1)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d1_d3_d0_d0 _lh_compareList_arg1_4_0 _lh_compareList_arg2_4_0 =
  (match _lh_compareList_arg1_4_0 with
      ...
      (match _lh_compareList_arg2_4_0 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_2_2, _lh_compareList_LH_C_1_1_2_2) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_2_1) = (int_of_char _lh_compareList_LH_C_0_1_2_2)) then
            ((compareList_d1_d3_d0_d0 _lh_compareList_LH_C_1_1_2_1) _lh_compareList_LH_C_1_1_2_2)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_2_1) < (int_of_char _lh_compareList_LH_C_0_1_2_2)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d1_d4_d0_d0 _lh_compareList_arg1_4_8 _lh_compareList_arg2_4_8 =
  (match _lh_compareList_arg1_4_8 with
      ...
      (match _lh_compareList_arg2_4_8 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_4_6, _lh_compareList_LH_C_1_1_4_6) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_4_5) = (int_of_char _lh_compareList_LH_C_0_1_4_6)) then
            ((compareList_d1_d4_d0_d0 _lh_compareList_LH_C_1_1_4_5) _lh_compareList_LH_C_1_1_4_6)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_4_5) < (int_of_char _lh_compareList_LH_C_0_1_4_6)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d1_d5_d0_d0 _lh_compareList_arg1_4_7 _lh_compareList_arg2_4_7 =
  (match _lh_compareList_arg1_4_7 with
      ...
      (match _lh_compareList_arg2_4_7 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_4_3, _lh_compareList_LH_C_1_1_4_3) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_4_2) = (int_of_char _lh_compareList_LH_C_0_1_4_3)) then
            ((compareList_d1_d5_d0_d0 _lh_compareList_LH_C_1_1_4_2) _lh_compareList_LH_C_1_1_4_3)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_4_2) < (int_of_char _lh_compareList_LH_C_0_1_4_3)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d2_d0_d0 _lh_compareList_arg1_2_7 _lh_compareList_arg2_2_7 =
  (match _lh_compareList_arg1_2_7 with
      ...
      (match _lh_compareList_arg2_2_7 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_8_3, _lh_compareList_LH_C_1_8_3) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_8_2) = (int_of_char _lh_compareList_LH_C_0_8_3)) then
            ((compareList_d2_d0_d0 _lh_compareList_LH_C_1_8_2) _lh_compareList_LH_C_1_8_3)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_8_2) < (int_of_char _lh_compareList_LH_C_0_8_3)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d3_d0_d0 _lh_compareList_arg1_3_4 _lh_compareList_arg2_3_4 =
  (match _lh_compareList_arg1_3_4 with
      ...
      (match _lh_compareList_arg2_3_4 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_0_4, _lh_compareList_LH_C_1_1_0_4) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_0_3) = (int_of_char _lh_compareList_LH_C_0_1_0_4)) then
            ((compareList_d3_d0_d0 _lh_compareList_LH_C_1_1_0_3) _lh_compareList_LH_C_1_1_0_4)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_0_3) < (int_of_char _lh_compareList_LH_C_0_1_0_4)) then
              true
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d3_d1_d0 _lh_compareList_arg1_2_6 _lh_compareList_arg2_2_6 =
  (match _lh_compareList_arg1_2_6 with
      ...
      (match _lh_compareList_arg2_2_6 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_8_0, _lh_compareList_LH_C_1_8_0) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_7_9) = (int_of_char _lh_compareList_LH_C_0_8_0)) then
            ((compareList_d3_d1_d0 _lh_compareList_LH_C_1_7_9) _lh_compareList_LH_C_1_8_0)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_7_9) < (int_of_char _lh_compareList_LH_C_0_8_0)) then
              true
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d4_d0_d0 _lh_compareList_arg1_3_6 _lh_compareList_arg2_3_6 =
  (match _lh_compareList_arg1_3_6 with
      ...
      (match _lh_compareList_arg2_3_6 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_1_0, _lh_compareList_LH_C_1_1_1_0) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_0_9) = (int_of_char _lh_compareList_LH_C_0_1_1_0)) then
            ((compareList_d4_d0_d0 _lh_compareList_LH_C_1_1_0_9) _lh_compareList_LH_C_1_1_1_0)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_0_9) < (int_of_char _lh_compareList_LH_C_0_1_1_0)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d5_d0_d0 _lh_compareList_arg1_5_1 _lh_compareList_arg2_5_1 =
      ...
      (match _lh_compareList_arg2_5_1 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_5_5, _lh_compareList_LH_C_1_1_5_5) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_5_4) = (int_of_char _lh_compareList_LH_C_0_1_5_5)) then
            ((compareList_d5_d0_d0 _lh_compareList_LH_C_1_1_5_4) _lh_compareList_LH_C_1_1_5_5)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_5_4) < (int_of_char _lh_compareList_LH_C_0_1_5_5)) then
              false
            else
...
let rec compareList_d5_d1_d0 _lh_compareList_arg1_3_9 _lh_compareList_arg2_3_9 =
  (match _lh_compareList_arg1_3_9 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d5_d2_d0 _lh_compareList_arg1_4_6 _lh_compareList_arg2_4_6 =
      ...
      (match _lh_compareList_arg2_4_6 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_4_0, _lh_compareList_LH_C_1_1_4_0) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_3_9) = (int_of_char _lh_compareList_LH_C_0_1_4_0)) then
            ((compareList_d5_d2_d0 _lh_compareList_LH_C_1_1_3_9) _lh_compareList_LH_C_1_1_4_0)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_3_9) < (int_of_char _lh_compareList_LH_C_0_1_4_0)) then
              false
            else
...
let rec compareList_d5_d3_d0 _lh_compareList_arg1_3_1 _lh_compareList_arg2_3_1 =
  (match _lh_compareList_arg1_3_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d6_d0_d0 _lh_compareList_arg1_4_4 _lh_compareList_arg2_4_4 =
  (match _lh_compareList_arg1_4_4 with
      ...
      (match _lh_compareList_arg2_4_4 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_3_4, _lh_compareList_LH_C_1_1_3_4) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_3_3) = (int_of_char _lh_compareList_LH_C_0_1_3_4)) then
            ((compareList_d6_d0_d0 _lh_compareList_LH_C_1_1_3_3) _lh_compareList_LH_C_1_1_3_4)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_3_3) < (int_of_char _lh_compareList_LH_C_0_1_3_4)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d6_d1_d0 _lh_compareList_arg1_5_0 _lh_compareList_arg2_5_0 =
  (match _lh_compareList_arg1_5_0 with
      ...
      (match _lh_compareList_arg2_5_0 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_5_2, _lh_compareList_LH_C_1_1_5_2) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_5_1) = (int_of_char _lh_compareList_LH_C_0_1_5_2)) then
            ((compareList_d6_d1_d0 _lh_compareList_LH_C_1_1_5_1) _lh_compareList_LH_C_1_1_5_2)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_5_1) < (int_of_char _lh_compareList_LH_C_0_1_5_2)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d6_d2_d0 _lh_compareList_arg1_4_3 _lh_compareList_arg2_4_3 =
  (match _lh_compareList_arg1_4_3 with
      ...
      (match _lh_compareList_arg2_4_3 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_3_1, _lh_compareList_LH_C_1_1_3_1) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_3_0) = (int_of_char _lh_compareList_LH_C_0_1_3_1)) then
            ((compareList_d6_d2_d0 _lh_compareList_LH_C_1_1_3_0) _lh_compareList_LH_C_1_1_3_1)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_3_0) < (int_of_char _lh_compareList_LH_C_0_1_3_1)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d6_d3_d0 _lh_compareList_arg1_4_2 _lh_compareList_arg2_4_2 =
  (match _lh_compareList_arg1_4_2 with
      ...
      (match _lh_compareList_arg2_4_2 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_2_8, _lh_compareList_LH_C_1_1_2_8) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_2_7) = (int_of_char _lh_compareList_LH_C_0_1_2_8)) then
            ((compareList_d6_d3_d0 _lh_compareList_LH_C_1_1_2_7) _lh_compareList_LH_C_1_1_2_8)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_2_7) < (int_of_char _lh_compareList_LH_C_0_1_2_8)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d7_d0_d0 _lh_compareList_arg1_2_9 _lh_compareList_arg2_2_9 =
  (match _lh_compareList_arg1_2_9 with
      ...
      (match _lh_compareList_arg2_2_9 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_8_9, _lh_compareList_LH_C_1_8_9) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_8_8) = (int_of_char _lh_compareList_LH_C_0_8_9)) then
            ((compareList_d7_d0_d0 _lh_compareList_LH_C_1_8_8) _lh_compareList_LH_C_1_8_9)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_8_8) < (int_of_char _lh_compareList_LH_C_0_8_9)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d7_d1_d0 _lh_compareList_arg1_4_9 _lh_compareList_arg2_4_9 =
  (match _lh_compareList_arg1_4_9 with
      ...
      (match _lh_compareList_arg2_4_9 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_4_9, _lh_compareList_LH_C_1_1_4_9) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_4_8) = (int_of_char _lh_compareList_LH_C_0_1_4_9)) then
            ((compareList_d7_d1_d0 _lh_compareList_LH_C_1_1_4_8) _lh_compareList_LH_C_1_1_4_9)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_4_8) < (int_of_char _lh_compareList_LH_C_0_1_4_9)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d7_d2_d0 _lh_compareList_arg1_3_0 _lh_compareList_arg2_3_0 =
  (match _lh_compareList_arg1_3_0 with
      ...
      (match _lh_compareList_arg2_3_0 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_9_2, _lh_compareList_LH_C_1_9_2) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_9_1) = (int_of_char _lh_compareList_LH_C_0_9_2)) then
            ((compareList_d7_d2_d0 _lh_compareList_LH_C_1_9_1) _lh_compareList_LH_C_1_9_2)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_9_1) < (int_of_char _lh_compareList_LH_C_0_9_2)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d7_d3_d0 _lh_compareList_arg1_3_7 _lh_compareList_arg2_3_7 =
  (match _lh_compareList_arg1_3_7 with
      ...
      (match _lh_compareList_arg2_3_7 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_1_3, _lh_compareList_LH_C_1_1_1_3) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_1_2) = (int_of_char _lh_compareList_LH_C_0_1_1_3)) then
            ((compareList_d7_d3_d0 _lh_compareList_LH_C_1_1_1_2) _lh_compareList_LH_C_1_1_1_3)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_1_2) < (int_of_char _lh_compareList_LH_C_0_1_1_3)) then
              false
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d8_d0_d0 _lh_compareList_arg1_4_5 _lh_compareList_arg2_4_5 =
  (match _lh_compareList_arg1_4_5 with
      ...
      (match _lh_compareList_arg2_4_5 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_3_7, _lh_compareList_LH_C_1_1_3_7) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_3_6) = (int_of_char _lh_compareList_LH_C_0_1_3_7)) then
            ((compareList_d8_d0_d0 _lh_compareList_LH_C_1_1_3_6) _lh_compareList_LH_C_1_1_3_7)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_3_6) < (int_of_char _lh_compareList_LH_C_0_1_3_7)) then
              true
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList_d9_d0_d0 _lh_compareList_arg1_3_2 _lh_compareList_arg2_3_2 =
      ...
      (match _lh_compareList_arg2_3_2 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_9_8, _lh_compareList_LH_C_1_9_8) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_9_7) = (int_of_char _lh_compareList_LH_C_0_9_8)) then
            ((compareList_d9_d0_d0 _lh_compareList_LH_C_1_9_7) _lh_compareList_LH_C_1_9_8)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_9_7) < (int_of_char _lh_compareList_LH_C_0_9_8)) then
              true
            else
...
let rec concat_d0_d0_d1 lss_1 =
  (lss_1 99);;
let rec foldl_d0_d0_d0 f_5_0 i_4_6 ls_2_8 =
  ((ls_2_8 f_5_0) i_4_6);;
let rec foldl_d0_d0_d1 f_4_9 i_4_5 ls_2_7 =
  ((ls_2_7 f_4_9) i_4_5);;
let rec foldl_d0_d0_d2 f_5_8 i_5_3 ls_3_8 =
  ((ls_3_8 f_5_8) i_5_3);;
let rec foldr_d0_d0_d0 f_2_9 i_2_6 ls_2_3 =
  ((ls_2_3 f_2_9) i_2_6);;
let rec foldr_d0_d0_d1 f_2_8 i_2_5 ls_2_0 =
  ((ls_2_0 f_2_8) i_2_5);;
let rec foldr_d0_d0_d1_d0 f_7_0 i_6_4 ls_5_2 =
  ((ls_5_2 f_7_0) i_6_4);;
let rec foldr_d0_d0_d1_d1 f_4_8 i_4_4 ls_2_5 =
  ((ls_2_5 f_4_8) i_4_4);;
let rec foldr_d0_d0_d1_d2 f_2_7 i_2_4 ls_1_9 =
  ((ls_1_9 f_2_7) i_2_4);;
let rec foldr_d0_d0_d1_d3 f_6_1 i_5_6 ls_4_2 =
  ((ls_4_2 f_6_1) i_5_6);;
let rec foldr_d0_d0_d1_d4 f_5_3 i_4_9 ls_3_3 =
  ((ls_3_3 f_5_3) i_4_9);;
let rec foldr_d0_d0_d1_d5 f_5_6 i_5_2 ls_3_7 =
  ((ls_3_7 f_5_6) i_5_2);;
let rec foldr_d0_d0_d2 f_6_9 i_6_3 ls_5_1 =
  ((ls_5_1 f_6_9) i_6_3);;
let rec foldr_d0_d0_d3 f_4_7 i_4_3 ls_2_4 =
  ((ls_2_4 f_4_7) i_4_3);;
let rec foldr_d0_d0_d4 f_5_9 i_5_4 ls_3_9 =
  ((ls_3_9 f_5_9) i_5_4);;
let rec foldr_d0_d0_d5 f_5_5 i_5_1 ls_3_6 =
  ((ls_3_6 f_5_5) i_5_1);;
let rec foldr_d0_d0_d6 f_6_0 i_5_5 ls_4_0 =
  ((ls_4_0 f_6_0) i_5_5);;
let rec foldr_d0_d0_d7 f_6_4 i_5_9 ls_4_8 =
  ((ls_4_8 f_6_4) i_5_9);;
let rec foldr_d0_d0_d8 f_5_2 i_4_8 ls_3_2 =
  ((ls_3_2 f_5_2) i_4_8);;
let rec foldr_d0_d0_d9 f_5_1 i_4_7 ls_3_0 =
  ((ls_3_0 f_5_1) i_4_7);;
let rec foldr_d1_d0_d0 f_5_4 i_5_0 ls_3_4 =
  (match ls_3_4 with
    | `LH_C(h_6_4, t_6_4) -> 
      ((f_5_4 h_6_4) (((foldr_d1_d0_d0 f_5_4) i_5_0) t_6_4))
    | `LH_N -> 
      i_5_0);;
let rec foldr_d2_d0_d0 f_6_2 i_5_7 ls_4_3 =
  (match ls_4_3 with
    | `LH_C(h_6_9, t_6_9) -> 
      ((f_6_2 h_6_9) (((foldr_d2_d0_d0 f_6_2) i_5_7) t_6_9))
    | `LH_N -> 
      i_5_7);;
let rec foldr_d3_d0_d0 f_6_3 i_5_8 ls_4_6 =
  (match ls_4_6 with
    | `LH_C(h_7_3, t_7_3) -> 
      ((f_6_3 h_7_3) (((foldr_d3_d0_d0 f_6_3) i_5_8) t_7_3))
    | `LH_N -> 
      i_5_8);;
let rec intersperse_d0_d0_d0 _lh_intersperse_arg1_3 _lh_intersperse_arg2_1 =
  (_lh_intersperse_arg2_1 _lh_intersperse_arg1_3);;
let rec mappend_d0_d0_d0 xs_1_6 ys_3_3 =
  (xs_1_6 ys_3_3);;
let rec mappend_d0_d0_d1 xs_1_8 ys_3_6 =
  (xs_1_8 ys_3_6);;
let rec mappend_d0_d1_d0 xs_2_7 ys_4_8 =
  (xs_2_7 ys_4_8);;
let rec mappend_d0_d1_d1 xs_2_4 ys_4_3 =
  (xs_2_4 ys_4_3);;
let rec mappend_d1_d0_d0 xs_1_4 ys_3_1 =
  (xs_1_4 ys_3_1);;
let rec mappend_d1_d0_d1 xs_1_5 ys_3_2 =
  (xs_1_5 ys_3_2);;
let rec mappend_d1_d1_d0 xs_3_0 ys_5_6 =
  (xs_3_0 ys_5_6);;
let rec mappend_d1_d1_d1 xs_2_3 ys_4_2 =
  (xs_2_3 ys_4_2);;
let rec mappend_d2_d0_d0 xs_2_9 ys_5_5 =
  (xs_2_9 ys_5_5);;
let rec mappend_d2_d0_d1 xs_2_2 ys_4_0 =
  (xs_2_2 ys_4_0);;
let rec mappend_d3_d0_d0 xs_2_6 ys_4_7 =
  (match xs_2_6 with
    | `LH_C(h_7_4, t_7_4) -> 
      (`LH_C(h_7_4, ((mappend_d3_d0_d0 t_7_4) ys_4_7)))
    | `LH_N -> 
      ys_4_7);;
let rec mappend_d4_d0_d0 xs_1_7 ys_3_5 =
  (match xs_1_7 with
    | `LH_C(h_6_3, t_6_3) -> 
      (`LH_C(h_6_3, ((mappend_d4_d0_d0 t_6_3) ys_3_5)))
    | `LH_N -> 
      ys_3_5);;
let rec mappend_d5_d0_d0 xs_2_0 ys_3_8 =
  (match xs_2_0 with
    | `LH_C(h_6_6, t_6_6) -> 
      (`LH_C(h_6_6, ((mappend_d5_d0_d0 t_6_6) ys_3_8)))
    | `LH_N -> 
      ys_3_8);;
let rec mappend_d6_d0_d0 xs_2_5 ys_4_5 =
  (match xs_2_5 with
    | `LH_C(h_7_0, t_7_0) -> 
      (`LH_C(h_7_0, ((mappend_d6_d0_d0 t_7_0) ys_4_5)))
    | `LH_N -> 
      ys_4_5);;
let rec mappend_d7_d0_d0 xs_1_2 ys_2_5 =
  (match xs_1_2 with
    | `LH_C(h_4_1, t_4_1) -> 
      (`LH_C(h_4_1, ((mappend_d7_d0_d0 t_4_1) ys_2_5)))
    | `LH_N -> 
      ys_2_5);;
let rec mappend_d8_d0_d0 xs_1_3 ys_2_9 =
  (xs_1_3 ys_2_9);;
let rec mappend_d8_d0_d1 xs_2_1 ys_3_9 =
  (xs_2_1 ys_3_9);;
let rec mappend_d8_d0_d2 xs_1_9 ys_3_7 =
  (xs_1_9 ys_3_7);;
let rec odd_d0_d0_d0 _lh_odd_arg1_2 =
  ((_lh_odd_arg1_2 mod 2) = 0);;
let rec odd_d1_d0_d0 _lh_odd_arg1_3 =
  ((_lh_odd_arg1_3 mod 2) = 0);;
let rec prependToAll_d0_d0_d0 _lh_prependToAll_arg1_2_3 _lh_prependToAll_arg2_7 =
  (_lh_prependToAll_arg2_7 _lh_prependToAll_arg1_2_3);;
let rec prependToAll_d0_d0_d1 _lh_prependToAll_arg1_2_0 _lh_prependToAll_arg2_4 =
  (_lh_prependToAll_arg2_4 _lh_prependToAll_arg1_2_0);;
let rec prependToAll_d0_d0_d2 _lh_prependToAll_arg1_2_4 _lh_prependToAll_arg2_8 =
  (_lh_prependToAll_arg2_8 _lh_prependToAll_arg1_2_4);;
let rec prependToAll_d0_d0_d3 _lh_prependToAll_arg1_1_9 _lh_prependToAll_arg2_3 =
...
let rec prependToAll_d0_d0_d5 _lh_prependToAll_arg1_2_2 _lh_prependToAll_arg2_6 =
  (_lh_prependToAll_arg2_6 _lh_prependToAll_arg1_2_2);;
let rec prependToAll_d0_d0_d6 _lh_prependToAll_arg1_9 _lh_prependToAll_arg2_1 =
...
let rec reverse_helper_d3_d0_d0 ls_3_5 a_9 =
  (match ls_3_5 with
    | `LH_C(h_6_5, t_6_5) -> 
      ((reverse_helper_d3_d0_d0 t_6_5) (`LH_C(h_6_5, a_9)))
    | `LH_N -> 
      a_9);;
...
and gtList_d0_d0_d0 _lh_gtList_arg1_4_0 _lh_gtList_arg2_4_0 =
  (let rec _lh_matchIdent_6_3 = ((compareList_d0_d0_d0 _lh_gtList_arg1_4_0) _lh_gtList_arg2_4_0) in
    _lh_matchIdent_6_3)
and gtList_d1_d0_d0 _lh_gtList_arg1_2_6 _lh_gtList_arg2_2_6 =
  (let rec _lh_matchIdent_4_0 = ((compareList_d1_d0_d0 _lh_gtList_arg1_2_6) _lh_gtList_arg2_2_6) in
    _lh_matchIdent_4_0)
and gtList_d1_d0_d0_d0 _lh_gtList_arg1_2_2 _lh_gtList_arg2_2_2 =
  (let rec _lh_matchIdent_3_4 = ((compareList_d1_d4_d0_d0 _lh_gtList_arg1_2_2) _lh_gtList_arg2_2_2) in
    _lh_matchIdent_3_4)
and gtList_d1_d1_d0_d0 _lh_gtList_arg1_2_7 _lh_gtList_arg2_2_7 =
  (let rec _lh_matchIdent_4_2 = ((compareList_d1_d5_d0_d0 _lh_gtList_arg1_2_7) _lh_gtList_arg2_2_7) in
    _lh_matchIdent_4_2)
and gtList_d2_d0_d0 _lh_gtList_arg1_3_4 _lh_gtList_arg2_3_4 =
  (let rec _lh_matchIdent_5_6 = ((compareList_d2_d0_d0 _lh_gtList_arg1_3_4) _lh_gtList_arg2_3_4) in
    _lh_matchIdent_5_6)
and gtList_d3_d0_d0 _lh_gtList_arg1_2_5 _lh_gtList_arg2_2_5 =
  (let rec _lh_matchIdent_3_9 = ((compareList_d5_d0_d0 _lh_gtList_arg1_2_5) _lh_gtList_arg2_2_5) in
    _lh_matchIdent_3_9)
and gtList_d3_d1_d0 _lh_gtList_arg1_4_1 _lh_gtList_arg2_4_1 =
  (let rec _lh_matchIdent_6_4 = ((compareList_d5_d1_d0 _lh_gtList_arg1_4_1) _lh_gtList_arg2_4_1) in
    _lh_matchIdent_6_4)
and gtList_d3_d2_d0 _lh_gtList_arg1_3_8 _lh_gtList_arg2_3_8 =
  (let rec _lh_matchIdent_6_1 = ((compareList_d5_d2_d0 _lh_gtList_arg1_3_8) _lh_gtList_arg2_3_8) in
    _lh_matchIdent_6_1)
and gtList_d3_d3_d0 _lh_gtList_arg1_3_3 _lh_gtList_arg2_3_3 =
  (let rec _lh_matchIdent_5_0 = ((compareList_d5_d3_d0 _lh_gtList_arg1_3_3) _lh_gtList_arg2_3_3) in
    _lh_matchIdent_5_0)
and gtList_d4_d0_d0 _lh_gtList_arg1_2_1 _lh_gtList_arg2_2_1 =
  (let rec _lh_matchIdent_3_3 = ((compareList_d6_d0_d0 _lh_gtList_arg1_2_1) _lh_gtList_arg2_2_1) in
    _lh_matchIdent_3_3)
and gtList_d4_d1_d0 _lh_gtList_arg1_3_1 _lh_gtList_arg2_3_1 =
  (let rec _lh_matchIdent_4_8 = ((compareList_d6_d1_d0 _lh_gtList_arg1_3_1) _lh_gtList_arg2_3_1) in
    _lh_matchIdent_4_8)
and gtList_d4_d2_d0 _lh_gtList_arg1_2_4 _lh_gtList_arg2_2_4 =
  (let rec _lh_matchIdent_3_8 = ((compareList_d6_d2_d0 _lh_gtList_arg1_2_4) _lh_gtList_arg2_2_4) in
    _lh_matchIdent_3_8)
and gtList_d4_d3_d0 _lh_gtList_arg1_3_6 _lh_gtList_arg2_3_6 =
  (let rec _lh_matchIdent_5_8 = ((compareList_d6_d3_d0 _lh_gtList_arg1_3_6) _lh_gtList_arg2_3_6) in
    _lh_matchIdent_5_8)
and gtList_d5_d0_d0 _lh_gtList_arg1_3_5 _lh_gtList_arg2_3_5 =
  (let rec _lh_matchIdent_5_7 = ((compareList_d7_d0_d0 _lh_gtList_arg1_3_5) _lh_gtList_arg2_3_5) in
    _lh_matchIdent_5_7)
and gtList_d5_d1_d0 _lh_gtList_arg1_3_9 _lh_gtList_arg2_3_9 =
  (let rec _lh_matchIdent_6_2 = ((compareList_d7_d1_d0 _lh_gtList_arg1_3_9) _lh_gtList_arg2_3_9) in
    _lh_matchIdent_6_2)
and gtList_d5_d2_d0 _lh_gtList_arg1_2_3 _lh_gtList_arg2_2_3 =
  (let rec _lh_matchIdent_3_7 = ((compareList_d7_d2_d0 _lh_gtList_arg1_2_3) _lh_gtList_arg2_2_3) in
    _lh_matchIdent_3_7)
and gtList_d5_d3_d0 _lh_gtList_arg1_3_7 _lh_gtList_arg2_3_7 =
  (let rec _lh_matchIdent_6_0 = ((compareList_d7_d3_d0 _lh_gtList_arg1_3_7) _lh_gtList_arg2_3_7) in
    _lh_matchIdent_6_0)
and gtList_d6_d0_d0 _lh_gtList_arg1_3_0 _lh_gtList_arg2_3_0 =
  (let rec _lh_matchIdent_4_7 = ((compareList_d1_d0_d0_d0 _lh_gtList_arg1_3_0) _lh_gtList_arg2_3_0) in
    _lh_matchIdent_4_7)
and gtList_d7_d0_d0 _lh_gtList_arg1_2_9 _lh_gtList_arg2_2_9 =
  (let rec _lh_matchIdent_4_6 = ((compareList_d1_d1_d0_d0 _lh_gtList_arg1_2_9) _lh_gtList_arg2_2_9) in
    _lh_matchIdent_4_6)
and gtList_d8_d0_d0 _lh_gtList_arg1_2_8 _lh_gtList_arg2_2_8 =
  (let rec _lh_matchIdent_4_3 = ((compareList_d1_d2_d0_d0 _lh_gtList_arg1_2_8) _lh_gtList_arg2_2_8) in
    _lh_matchIdent_4_3)
and gtList_d9_d0_d0 _lh_gtList_arg1_3_2 _lh_gtList_arg2_3_2 =
  (let rec _lh_matchIdent_4_9 = ((compareList_d1_d3_d0_d0 _lh_gtList_arg1_3_2) _lh_gtList_arg2_3_2) in
    _lh_matchIdent_4_9)
...
and insertSort_d0_d0_d0 _lh_insertSort_arg1_1 =
  (match _lh_insertSort_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and leList_d0_d0_d0 _lh_leList_arg1_2_2 _lh_leList_arg2_2_2 =
  (not ((gtList_d0_d0_d0 _lh_leList_arg1_2_2) _lh_leList_arg2_2_2))
and leList_d1_d0_d0 _lh_leList_arg1_3_1 _lh_leList_arg2_3_1 =
  (not ((gtList_d1_d0_d0 _lh_leList_arg1_3_1) _lh_leList_arg2_3_1))
...
and leList_d3_d1_d0 _lh_leList_arg1_2_8 _lh_leList_arg2_2_8 =
  (not ((gtList_d4_d1_d0 _lh_leList_arg1_2_8) _lh_leList_arg2_2_8))
and leList_d3_d2_d0 _lh_leList_arg1_2_4 _lh_leList_arg2_2_4 =
  (not ((gtList_d4_d2_d0 _lh_leList_arg1_2_4) _lh_leList_arg2_2_4))
and leList_d3_d3_d0 _lh_leList_arg1_3_0 _lh_leList_arg2_3_0 =
  (not ((gtList_d4_d3_d0 _lh_leList_arg1_3_0) _lh_leList_arg2_3_0))
and leList_d4_d0_d0 _lh_leList_arg1_1_6 _lh_leList_arg2_1_6 =
  (not ((gtList_d5_d0_d0 _lh_leList_arg1_1_6) _lh_leList_arg2_1_6))
and leList_d4_d1_d0 _lh_leList_arg1_1_7 _lh_leList_arg2_1_7 =
  (not ((gtList_d5_d1_d0 _lh_leList_arg1_1_7) _lh_leList_arg2_1_7))
and leList_d4_d2_d0 _lh_leList_arg1_2_0 _lh_leList_arg2_2_0 =
  (not ((gtList_d5_d2_d0 _lh_leList_arg1_2_0) _lh_leList_arg2_2_0))
and leList_d4_d3_d0 _lh_leList_arg1_2_7 _lh_leList_arg2_2_7 =
  (not ((gtList_d5_d3_d0 _lh_leList_arg1_2_7) _lh_leList_arg2_2_7))
and leList_d5_d0_d0 _lh_leList_arg1_1_8 _lh_leList_arg2_1_8 =
  (not ((gtList_d7_d0_d0 _lh_leList_arg1_1_8) _lh_leList_arg2_1_8))
and leList_d6_d0_d0 _lh_leList_arg1_2_9 _lh_leList_arg2_2_9 =
  (not ((gtList_d8_d0_d0 _lh_leList_arg1_2_9) _lh_leList_arg2_2_9))
and leList_d7_d0_d0 _lh_leList_arg1_1_9 _lh_leList_arg2_1_9 =
  (not ((gtList_d9_d0_d0 _lh_leList_arg1_1_9) _lh_leList_arg2_1_9))
and leList_d8_d0_d0 _lh_leList_arg1_2_3 _lh_leList_arg2_2_3 =
  (not ((gtList_d1_d0_d0_d0 _lh_leList_arg1_2_3) _lh_leList_arg2_2_3))
and leList_d9_d0_d0 _lh_leList_arg1_2_1 _lh_leList_arg2_2_1 =
  (not ((gtList_d1_d1_d0_d0 _lh_leList_arg1_2_1) _lh_leList_arg2_2_1))
and lines_d0_d0_d0 _lh_lines_arg1_1 =
  (match _lh_lines_arg1_1 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_3_5 = ((break_d0_d0_d0 (fun x_3 -> 
        (x_3 = '|'))) _lh_lines_arg1_1) in
        (match _lh_matchIdent_3_5 with
          | `LH_P2(_lh_lines_LH_P2_0_1, _lh_lines_LH_P2_1_1) -> 
            (`LH_C(_lh_lines_LH_P2_0_1, (let rec _lh_matchIdent_3_6 = _lh_lines_LH_P2_1_1 in
              (_lh_matchIdent_3_6 99))))
          | _ -> 
            (failwith "error"))))
and ltList_d0_d0_d0 _lh_ltList_arg1_5 _lh_ltList_arg2_5 =
  (let rec _lh_matchIdent_4_5 = ((compareList_d3_d0_d0 _lh_ltList_arg1_5) _lh_ltList_arg2_5) in
    _lh_matchIdent_4_5)
and ltList_d0_d1_d0 _lh_ltList_arg1_6 _lh_ltList_arg2_6 =
  (let rec _lh_matchIdent_5_1 = ((compareList_d3_d1_d0 _lh_ltList_arg1_6) _lh_ltList_arg2_6) in
    _lh_matchIdent_5_1)
and ltList_d1_d0_d0 _lh_ltList_arg1_7 _lh_ltList_arg2_7 =
  (let rec _lh_matchIdent_6_5 = ((compareList_d8_d0_d0 _lh_ltList_arg1_7) _lh_ltList_arg2_7) in
    _lh_matchIdent_6_5)
and ltList_d2_d0_d0 _lh_ltList_arg1_4 _lh_ltList_arg2_4 =
  (let rec _lh_matchIdent_4_4 = ((compareList_d9_d0_d0 _lh_ltList_arg1_4) _lh_ltList_arg2_4) in
    _lh_matchIdent_4_4)
and mangle_d0_d0_d0 _lh_mangle_arg1_1 =
  (let rec sort_1 = (fun _lh_sort_arg1_1 -> 
    ((((foldr_d0_d0_d0 (fun f_3_0 g_1 _lh_funcomp_x_7 -> 
      (f_3_0 (g_1 _lh_funcomp_x_7)))) (fun x_4 -> 
      x_4)) ((intersperse_d0_d0_d0 reverse_d3_d0_d0) (let rec _lh_intersperse_LH_C_1_1 = (let rec _lh_prependToAll_LH_C_1_7 = (let rec _lh_prependToAll_LH_C_1_8 = (let rec _lh_prependToAll_LH_C_1_9 = (let rec _lh_prependToAll_LH_C_1_1_0 = (let rec _lh_prependToAll_LH_C_1_1_1 = (let rec _lh_prependToAll_LH_C_1_1_2 = (let rec _lh_prependToAll_LH_C_1_1_3 = (fun _lh_prependToAll_arg1_1_0 f_3_1 i_2_7 -> 
      i_2_7) in
      (let rec _lh_prependToAll_LH_C_0_7 = treeSort2_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_1 -> 
          (let rec t_4_6 = (let rec t_4_7 = ((prependToAll_d0_d0_d0 _lh_prependToAll_arg1_1_1) _lh_prependToAll_LH_C_1_1_3) in
            (let rec h_4_6 = _lh_prependToAll_LH_C_0_7 in
              (fun f_3_2 i_2_8 -> 
                ((f_3_2 h_4_6) (((foldr_d0_d0_d1 f_3_2) i_2_8) t_4_7))))) in
            (let rec h_4_7 = _lh_prependToAll_arg1_1_1 in
              (fun f_3_3 i_2_9 -> 
                ((f_3_3 h_4_7) (((foldr_d0_d0_d2 f_3_3) i_2_9) t_4_6)))))))) in
      (let rec _lh_prependToAll_LH_C_0_8 = treeSort_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_2 -> 
          (let rec t_4_8 = (let rec t_4_9 = ((prependToAll_d0_d0_d1 _lh_prependToAll_arg1_1_2) _lh_prependToAll_LH_C_1_1_2) in
            (let rec h_4_8 = _lh_prependToAll_LH_C_0_8 in
              (fun f_3_4 i_3_0 -> 
                ((f_3_4 h_4_8) (((foldr_d0_d0_d3 f_3_4) i_3_0) t_4_9))))) in
            (let rec h_4_9 = _lh_prependToAll_arg1_1_2 in
              (fun f_3_5 i_3_1 -> 
                ((f_3_5 h_4_9) (((foldr_d0_d0_d4 f_3_5) i_3_1) t_4_8)))))))) in
      (let rec _lh_prependToAll_LH_C_0_9 = quickerSort_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_3 -> 
          (let rec t_5_0 = (let rec t_5_1 = ((prependToAll_d0_d0_d2 _lh_prependToAll_arg1_1_3) _lh_prependToAll_LH_C_1_1_1) in
            (let rec h_5_0 = _lh_prependToAll_LH_C_0_9 in
              (fun f_3_6 i_3_2 -> 
                ((f_3_6 h_5_0) (((foldr_d0_d0_d5 f_3_6) i_3_2) t_5_1))))) in
            (let rec h_5_1 = _lh_prependToAll_arg1_1_3 in
              (fun f_3_7 i_3_3 -> 
                ((f_3_7 h_5_1) (((foldr_d0_d0_d6 f_3_7) i_3_3) t_5_0)))))))) in
      (let rec _lh_prependToAll_LH_C_0_1_0 = quickSort2_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_4 -> 
          (let rec t_5_2 = (let rec t_5_3 = ((prependToAll_d0_d0_d3 _lh_prependToAll_arg1_1_4) _lh_prependToAll_LH_C_1_1_0) in
            (let rec h_5_2 = _lh_prependToAll_LH_C_0_1_0 in
              (fun f_3_8 i_3_4 -> 
                ((f_3_8 h_5_2) (((foldr_d0_d0_d7 f_3_8) i_3_4) t_5_3))))) in
            (let rec h_5_3 = _lh_prependToAll_arg1_1_4 in
              (fun f_3_9 i_3_5 -> 
                ((f_3_9 h_5_3) (((foldr_d0_d0_d8 f_3_9) i_3_5) t_5_2)))))))) in
      (let rec _lh_prependToAll_LH_C_0_1_1 = quickSort_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_5 -> 
          (let rec t_5_4 = (let rec t_5_5 = ((prependToAll_d0_d0_d4 _lh_prependToAll_arg1_1_5) _lh_prependToAll_LH_C_1_9) in
            (let rec h_5_4 = _lh_prependToAll_LH_C_0_1_1 in
              (fun f_4_0 i_3_6 -> 
                ((f_4_0 h_5_4) (((foldr_d0_d0_d9 f_4_0) i_3_6) t_5_5))))) in
            (let rec h_5_5 = _lh_prependToAll_arg1_1_5 in
              (fun f_4_1 i_3_7 -> 
                ((f_4_1 h_5_5) (((foldr_d0_d0_d1_d0 f_4_1) i_3_7) t_5_4)))))))) in
      (let rec _lh_prependToAll_LH_C_0_1_2 = mergeSort_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_6 -> 
          (let rec t_5_6 = (let rec t_5_7 = ((prependToAll_d0_d0_d5 _lh_prependToAll_arg1_1_6) _lh_prependToAll_LH_C_1_8) in
            (let rec h_5_6 = _lh_prependToAll_LH_C_0_1_2 in
              (fun f_4_2 i_3_8 -> 
                ((f_4_2 h_5_6) (((foldr_d0_d0_d1_d1 f_4_2) i_3_8) t_5_7))))) in
            (let rec h_5_7 = _lh_prependToAll_arg1_1_6 in
              (fun f_4_3 i_3_9 -> 
                ((f_4_3 h_5_7) (((foldr_d0_d0_d1_d2 f_4_3) i_3_9) t_5_6)))))))) in
      (let rec _lh_prependToAll_LH_C_0_1_3 = insertSort_d0_d0_d0 in
        (fun _lh_prependToAll_arg1_1_7 -> 
          (let rec t_5_8 = (let rec t_5_9 = ((prependToAll_d0_d0_d6 _lh_prependToAll_arg1_1_7) _lh_prependToAll_LH_C_1_7) in
            (let rec h_5_8 = _lh_prependToAll_LH_C_0_1_3 in
              (fun f_4_4 i_4_0 -> 
                ((f_4_4 h_5_8) (((foldr_d0_d0_d1_d3 f_4_4) i_4_0) t_5_9))))) in
            (let rec h_5_9 = _lh_prependToAll_arg1_1_7 in
              (fun f_4_5 i_4_1 -> 
                ((f_4_5 h_5_9) (((foldr_d0_d0_d1_d4 f_4_5) i_4_1) t_5_8)))))))) in
      (let rec _lh_intersperse_LH_C_0_1 = heapSort_d0_d0_d0 in
        (fun _lh_intersperse_arg1_2 -> 
          (let rec t_6_0 = ((prependToAll_d0_d0_d7 _lh_intersperse_arg1_2) _lh_intersperse_LH_C_1_1) in
            (let rec h_6_0 = _lh_intersperse_LH_C_0_1 in
              (fun f_4_6 i_4_2 -> 
                ((f_4_6 h_6_0) (((foldr_d0_d0_d1_d5 f_4_6) i_4_2) t_6_0)))))))))) _lh_sort_arg1_1)) in
    ((fun _lh_funcomp_x_8 -> 
      ((fun _lh_funcomp_x_9 -> 
        (unlines_d0_d0_d0 (sort_1 _lh_funcomp_x_9))) (lines_d0_d0_d0 _lh_funcomp_x_8))) _lh_mangle_arg1_1))
and mappend_d9_d0_d0 xs_2_8 ys_5_3 =
  (match xs_2_8 with
    | `LH_C(h_7_7, t_7_7) -> 
      (let rec t_7_8 = ((mappend_d9_d0_d0 t_7_7) ys_5_3) in
        (let rec h_7_8 = h_7_7 in
          (fun ys_5_4 -> 
            (let rec t_7_9 = ((mappend_d8_d0_d1 t_7_8) ys_5_4) in
              (let rec h_7_9 = h_7_8 in
                (fun f_6_6 i_6_1 -> 
                  (((foldl_d0_d0_d2 f_6_6) ((f_6_6 i_6_1) h_7_9)) t_7_9)))))))
    | `LH_N -> 
      ys_5_3)
and map_d0_d0_d0 f_6_7 ls_5_0 _lh_popOutId_0_0 =
  (match ls_5_0 with
    | `LH_C(h_8_0, t_8_0) -> 
      (let rec t_8_1 = ((map_d0_d0_d0 f_6_7) t_8_0) in
        (let rec h_8_1 = (f_6_7 h_8_0) in
...
and mergeSort_d0_d0_d0 _lh_mergeSort_arg1_1 =
                      ...
                      | _ -> 
                        (match _lh_runsplit_arg1_1 with
                          | `LH_C(_lh_runsplit_LH_C_0_1_1, _lh_runsplit_LH_C_1_1_1) -> 
                            (match _lh_runsplit_arg2_1 with
                              | `LH_C(_lh_runsplit_LH_C_0_1_2, _lh_runsplit_LH_C_1_1_2) -> 
                                (let rec _lh_matchIdent_5_2 = _lh_runsplit_LH_C_1_1_1 in
                                  (match _lh_matchIdent_5_2 with
                                    ...
                                    | _ -> 
                                      (if ((leList_d3_d0_d0 _lh_runsplit_LH_C_0_1_2) _lh_runsplit_LH_C_0_1_1) then
                                        ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_2, (`LH_C(_lh_runsplit_LH_C_0_1_1, _lh_matchIdent_5_2))))) _lh_runsplit_LH_C_1_1_2)
                                      else
                                        (let rec _lh_merge_lists_LH_C_1_1_2 = ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_2, (`LH_N)))) _lh_runsplit_LH_C_1_1_2) in
                                          (let rec _lh_merge_lists_LH_C_0_1_2 = (`LH_C(_lh_runsplit_LH_C_0_1_1, _lh_matchIdent_5_2)) in
                  ...
                  | _ -> 
                    (match _lh_runsplit_arg1_1 with
                      | `LH_C(_lh_runsplit_LH_C_0_1_3, _lh_runsplit_LH_C_1_1_3) -> 
                        (match _lh_runsplit_arg2_1 with
                          | `LH_C(_lh_runsplit_LH_C_0_1_4, _lh_runsplit_LH_C_1_1_4) -> 
                            (let rec _lh_matchIdent_5_3 = _lh_runsplit_LH_C_1_1_3 in
                              (match _lh_matchIdent_5_3 with
                                ...
                                | _ -> 
                                  (if ((leList_d3_d1_d0 _lh_runsplit_LH_C_0_1_4) _lh_runsplit_LH_C_0_1_3) then
                                    ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_4, (`LH_C(_lh_runsplit_LH_C_0_1_3, _lh_matchIdent_5_3))))) _lh_runsplit_LH_C_1_1_4)
                                  else
                                    (let rec _lh_merge_lists_LH_C_1_1_4 = ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_4, (`LH_N)))) _lh_runsplit_LH_C_1_1_4) in
                                      (let rec _lh_merge_lists_LH_C_0_1_4 = (`LH_C(_lh_runsplit_LH_C_0_1_3, _lh_matchIdent_5_3)) in
                  ...
                  | _ -> 
                    (match _lh_runsplit_arg1_1 with
                      | `LH_C(_lh_runsplit_LH_C_0_1_6, _lh_runsplit_LH_C_1_1_6) -> 
                        (match _lh_runsplit_arg2_1 with
                          | `LH_C(_lh_runsplit_LH_C_0_1_7, _lh_runsplit_LH_C_1_1_7) -> 
                            (let rec _lh_matchIdent_5_4 = _lh_runsplit_LH_C_1_1_6 in
                              (match _lh_matchIdent_5_4 with
                                ...
                                | _ -> 
                                  (if ((leList_d3_d2_d0 _lh_runsplit_LH_C_0_1_7) _lh_runsplit_LH_C_0_1_6) then
                                    ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_7, (`LH_C(_lh_runsplit_LH_C_0_1_6, _lh_matchIdent_5_4))))) _lh_runsplit_LH_C_1_1_7)
                                  else
                                    (let rec _lh_merge_lists_LH_C_1_1_7 = ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_7, (`LH_N)))) _lh_runsplit_LH_C_1_1_7) in
                                      (let rec _lh_merge_lists_LH_C_0_1_7 = (`LH_C(_lh_runsplit_LH_C_0_1_6, _lh_matchIdent_5_4)) in
              ...
              | _ -> 
                (match _lh_runsplit_arg1_1 with
                  | `LH_C(_lh_runsplit_LH_C_0_1_8, _lh_runsplit_LH_C_1_1_8) -> 
                    (match _lh_runsplit_arg2_1 with
                      | `LH_C(_lh_runsplit_LH_C_0_1_9, _lh_runsplit_LH_C_1_1_9) -> 
                        (let rec _lh_matchIdent_5_5 = _lh_runsplit_LH_C_1_1_8 in
                          (match _lh_matchIdent_5_5 with
                            ...
                            | _ -> 
                              (if ((leList_d3_d3_d0 _lh_runsplit_LH_C_0_1_9) _lh_runsplit_LH_C_0_1_8) then
                                ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_9, (`LH_C(_lh_runsplit_LH_C_0_1_8, _lh_matchIdent_5_5))))) _lh_runsplit_LH_C_1_1_9)
                              else
                                (let rec _lh_merge_lists_LH_C_1_1_9 = ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_9, (`LH_N)))) _lh_runsplit_LH_C_1_1_9) in
                                  (let rec _lh_merge_lists_LH_C_0_1_9 = (`LH_C(_lh_runsplit_LH_C_0_1_8, _lh_matchIdent_5_5)) in
  ...
  in ((fun _lh_funcomp_x_1_1 -> 
    (merge_lists_1_4 ((runsplit_1 (`LH_N)) _lh_funcomp_x_1_1))) _lh_mergeSort_arg1_1)
...
and quickSort2_d0_d0_d0 _lh_quickSort2_arg1_1 =
  (match _lh_quickSort2_arg1_1 with
    | `LH_N -> 
      (`LH_N)
    | `LH_C(_lh_quickSort2_LH_C_0_1, _lh_quickSort2_LH_C_1_1) -> 
      (let rec _lh_matchIdent_5_9 = ((partition_d0_d0_d0 ((fun x_5 y_1 -> 
...
and quickerSort_d0_d0_d0 _lh_quickerSort_arg1_1 =
  (match _lh_quickerSort_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and reverse_helper_d0_d0_d0 ls_2_1 a_7 =
  (match ls_2_1 with
    | `LH_C(h_4_4, t_4_4) -> 
      ((reverse_helper_d0_d0_d0 t_4_4) (let rec t_4_5 = a_7 in
        (let rec h_4_5 = h_4_4 in
          (fun ys_2_7 -> 
            (`LH_C(h_4_5, ((mappend_d0_d0_d1 t_4_5) ys_2_7)))))))
    | `LH_N -> 
      a_7)
and reverse_helper_d0_d1_d0 ls_4_1 a_1_0 =
  (match ls_4_1 with
    | `LH_C(h_6_7, t_6_7) -> 
      ((reverse_helper_d0_d1_d0 t_6_7) (let rec t_6_8 = a_1_0 in
        (let rec h_6_8 = h_6_7 in
          (fun ys_4_1 -> 
            (`LH_C(h_6_8, ((mappend_d0_d1_d1 t_6_8) ys_4_1)))))))
    | `LH_N -> 
      a_1_0)
and reverse_helper_d1_d0_d0 ls_2_6 a_8 =
  (match ls_2_6 with
    | `LH_C(h_6_1, t_6_1) -> 
      ((reverse_helper_d1_d0_d0 t_6_1) (let rec t_6_2 = a_8 in
        (let rec h_6_2 = h_6_1 in
          (fun ys_3_0 -> 
            (`LH_C(h_6_2, ((mappend_d1_d0_d1 t_6_2) ys_3_0)))))))
    | `LH_N -> 
      a_8)
and reverse_helper_d1_d1_d0 ls_4_5 a_1_1 =
  (match ls_4_5 with
    | `LH_C(h_7_1, t_7_1) -> 
      ((reverse_helper_d1_d1_d0 t_7_1) (let rec t_7_2 = a_1_1 in
        (let rec h_7_2 = h_7_1 in
          (fun ys_4_6 -> 
            (`LH_C(h_7_2, ((mappend_d1_d1_d1 t_7_2) ys_4_6)))))))
    | `LH_N -> 
      a_1_1)
and reverse_helper_d2_d0_d0 ls_1_8 a_6 =
  (match ls_1_8 with
    | `LH_C(h_4_2, t_4_2) -> 
      ((reverse_helper_d2_d0_d0 t_4_2) (let rec t_4_3 = a_6 in
        (let rec h_4_3 = h_4_2 in
          (fun ys_2_6 -> 
            (`LH_C(h_4_3, ((mappend_d2_d0_d1 t_4_3) ys_2_6)))))))
    | `LH_N -> 
      a_6)
and reverse_d0_d0_d0 ls_4_9 =
  ((reverse_helper_d0_d0_d0 ls_4_9) (fun ys_5_2 -> 
    ys_5_2))
and reverse_d0_d1_d0 ls_4_7 =
  ((reverse_helper_d0_d1_d0 ls_4_7) (fun ys_4_9 -> 
    ys_4_9))
and reverse_d1_d0_d0 ls_2_2 =
  ((reverse_helper_d1_d0_d0 ls_2_2) (fun ys_2_8 -> 
    ys_2_8))
and reverse_d1_d1_d0 ls_4_4 =
  ((reverse_helper_d1_d1_d0 ls_4_4) (fun ys_4_4 -> 
    ys_4_4))
and reverse_d2_d0_d0 ls_3_1 =
  ((reverse_helper_d2_d0_d0 ls_3_1) (fun ys_3_4 -> 
    ys_3_4))
and reverse_d3_d0_d0 ls_2_9 =
  ((reverse_helper_d3_d0_d0 ls_2_9) (`LH_N))
and testSorting_nofib_d0_d0_d0 _lh_testSorting_nofib_arg1_1 =
  (let rec f_5_7 = (`LH_C('m', (`LH_C('o', (`LH_C('d', (`LH_C('u', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('M', (`LH_C('a', (`LH_C('i', (`LH_C('n', (`LH_C(' ', (`LH_C('w', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_C('|', (`LH_C('|', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C('|', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('C', (`LH_C('o', (`LH_C('n', (`LH_C('t', (`LH_C('r', (`LH_C('o', (`LH_C('l', (`LH_C('.', (`LH_C('M', (`LH_C('o', (`LH_C('n', (`LH_C('a', (`LH_C('d', (`LH_C(' ', (`LH_C('(', (`LH_C('r', (`LH_C('e', (`LH_C('p', (`LH_C('l', (`LH_C('i', (`LH_C('c', (`LH_C('a', (`LH_C('t', (`LH_C('e', (`LH_C('M', (`LH_C('_', (`LH_C(')', (`LH_C('|', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('D', (`LH_C('a', (`LH_C('t', (`LH_C('a', (`LH_C('.', (`LH_C('L', (`LH_C('i', (`LH_C('s', (`LH_C('t', (`LH_C(' ', (`LH_C('(', (`LH_C('i', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('p', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C(')', (`LH_C('|', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('S', (`LH_C('y', (`LH_C('s', (`LH_C('t', (`LH_C('e', (`LH_C('m', (`LH_C('.', (`LH_C('E', (`LH_C('n', (`LH_C('v', (`LH_C('i', (`LH_C('r', (`LH_C('o', (`LH_C('n', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C(' ', (`LH_C('(', (`LH_C('g', (`LH_C('e', (`LH_C('t', (`LH_C('A', (`LH_C('r', (`LH_C('g', (`LH_C('s', (`LH_C(')', (`LH_C('|', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('N', (`LH_C('o', (`LH_C('f', (`LH_C('i', (`LH_C('b', (`LH_C('U', (`LH_C('t', (`LH_C('i', (`LH_C('l', (`LH_C('s', (`LH_C(' ', (`LH_C('(', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C('h', (`LH_C(')', (`LH_C('|', (`LH_C('|', (`LH_C('m', (`LH_C('a', (`LH_C('i', (`LH_C('n', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C('(', (`LH_C('n', (`LH_C(':', (`LH_C('_', (`LH_C(')', (`LH_C(' ', (`LH_C('<', (`LH_C('-', (`LH_C(' ', (`LH_C('g', (`LH_C('e', (`LH_C('t', (`LH_C('A', (`LH_C('r', (`LH_C('g', (`LH_C('s', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('p', (`LH_C('l', (`LH_C('i', (`LH_C('c', (`LH_C('a', (`LH_C('t', (`LH_C('e', (`LH_C('M', (`LH_C('_', (`LH_C(' ', (`LH_C('(', (`LH_C('r', (`LH_C('e', (`LH_C('a', (`LH_C('d', (`LH_C(' ', (`LH_C('n', (`LH_C(')', (`LH_C(' ', (`LH_C('$', (`LH_C(' ', (`LH_C('d', (`LH_C('o', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C('(', (`LH_C('_', (`LH_C(':', (`LH_C('s', (`LH_C(':', (`LH_C('_', (`LH_C(')', (`LH_C(' ', (`LH_C('<', (`LH_C('-', (`LH_C(' ', (`LH_C('g', (`LH_C('e', (`LH_C('t', (`LH_C('A', (`LH_C('r', (`LH_C('g', (`LH_C('s', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C('f', (`LH_C(' ', (`LH_C('<', (`LH_C('-', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('a', (`LH_C('d', (`LH_C('F', (`LH_C('i', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('s', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('n', (`LH_C('t', (`LH_C(' ', (`LH_C('(', (`LH_C('h', (`LH_C('a', (`LH_C('s', (`LH_C('h', (`LH_C(' ', (`LH_C('(', (`LH_C('m', (`LH_C('a', (`LH_C('n', (`LH_C('g', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('f', (`LH_C(')', (`LH_C(')', (`LH_C('|', (`LH_C('|', (`LH_C('m', (`LH_C('a', (`LH_C('n', (`LH_C('g', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C(':', (`LH_C(':', (`LH_C(' ', (`LH_C('S', (`LH_C('t', (`LH_C('r', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_C('{', (`LH_C('-', (`LH_C('i', (`LH_C('n', (`LH_C('p', (`LH_C('u', (`LH_C('t', (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_C(' ', (`LH_C('s', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('-', (`LH_C('}', (`LH_C(' ', (`LH_C('-', (`LH_C('>', (`LH_C(' ', (`LH_C('S', (`LH_C('t', (`LH_C('r', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_C('{', (`LH_C('-', (`LH_C('o', (`LH_C('u', (`LH_C('t', (`LH_C('p', (`LH_C('u', (`LH_C('t', (`LH_C('-', (`LH_C('}', (`LH_C('|', (`LH_C('m', (`LH_C('a', (`LH_C('n', (`LH_C('g', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('i', (`LH_C('n', (`LH_C('p', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('(', (`LH_C('u', (`LH_C('n', (`LH_C('l', (`LH_C('i', (`LH_C('n', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('.', (`LH_C(' ', (`LH_C('s', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('.', (`LH_C(' ', (`LH_C('l', (`LH_C('i', (`LH_C('n', (`LH_C('e', (`LH_C('s', (`LH_C(')', (`LH_C(' ', (`LH_C('i', (`LH_C('n', (`LH_C('p', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C('w', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C('s', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('f', (`LH_C('o', (`LH_C('l', (`LH_C('d', (`LH_C('r', (`LH_C(' ', (`LH_C('(', (`LH_C('.', (`LH_C(')', (`LH_C(' ', (`LH_C('i', (`LH_C('d', (`LH_C(' ', (`LH_C('(', (`LH_C('i', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('p', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('v', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('s', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('s', (`LH_C(')', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C('s', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('s', (`LH_C(' ', (`LH_C('=', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C('[', (`LH_C(' ', (`LH_C('h', (`LH_C('e', (`LH_C('a', (`LH_C('p', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('i', (`LH_C('n', (`LH_C('s', (`LH_C('e', (`LH_C('r', (`LH_C('t', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C('r', (`LH_C('g', (`LH_C('e', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('q', (`LH_C('u', (`LH_C('i', (`LH_C('c', (`LH_C('k', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('q', (`LH_C('u', (`LH_C('i', (`LH_C('c', (`LH_C('k', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('2', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('q', (`LH_C('u', (`LH_C('i', (`LH_C('c', (`LH_C('k', (`LH_C('e', (`LH_C('r', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('t', (`LH_C('r', (`LH_C('e', (`LH_C('e', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(',', (`LH_C(' ', (`LH_C('t', (`LH_C('r', (`LH_C('e', (`LH_C('e', (`LH_C('S', (`LH_C('o', (`LH_C('r', (`LH_C('t', (`LH_C('2', (`LH_C('|', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(']', (`LH_C('|', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
    (hash_d0_d0_d0 (mangle_d0_d0_d0 f_5_7)))
...
and unlines_d0_d0_d0 _lh_unlines_arg1_1 =
  (concat_d0_d0_d0 ((map_d0_d0_d0 (fun l_1 -> 
    ((mappend_d9_d0_d0 l_1) (let rec t_7_5 = (fun ys_5_0 -> 
      ys_5_0) in
      (let rec h_7_5 = '|' in
        (fun ys_5_1 -> 
          (let rec t_7_6 = ((mappend_d8_d0_d0 t_7_5) ys_5_1) in
            (let rec h_7_6 = h_7_5 in
              (fun f_6_5 i_6_0 -> 
                (((foldl_d0_d0_d1 f_6_5) ((f_6_5 i_6_0) h_7_6)) t_7_6)))))))))) _lh_unlines_arg1_1));;

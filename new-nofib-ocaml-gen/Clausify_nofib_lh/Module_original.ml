...
let rec clauseHelper_lh _lh_clauseHelper_arg1_0 _lh_clauseHelper_arg2_0 =
  (match _lh_clauseHelper_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and clause_lh _lh_clause_arg1_0 =
  ((clauseHelper_lh _lh_clause_arg1_0) (`LH_P2((`LH_N), (`LH_N))))
and clauses_lh _lh_clauses_arg1_0 =
  ((fun _lh_funcomp_x_1 -> 
    ((fun _lh_funcomp_x_2 -> 
      ((fun _lh_funcomp_x_3 -> 
        ((fun _lh_funcomp_x_4 -> 
...
and disp_lh _lh_disp_arg1_0 =
  (match _lh_disp_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and parseHelper_lh _lh_parseHelper_arg1_0 _lh_parseHelper_arg2_0 =
...
and spri_lh _lh_spri_arg1_0 =
  (match _lh_spri_arg1_0 with
    ...
    | _ -> 
      0)
and tautclause_lh _lh_tautclause_arg1_0 =
  (match _lh_tautclause_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and testClausify_nofib_lh _lh_testClausify_nofib_arg1_0 =
...
and uniclHelper_lh _lh_uniclHelper_arg1_0 _lh_uniclHelper_arg2_0 =

...
let rec map_lh__d2 f_1 ls_0 =
  (ls_0 f_1);;
let rec foldl_lh__d1 f_9 i_0 ls_3 =
  (match ls_3 with
    | `LH_C(h_5, t_5) -> 
      (((foldl_lh__d1 f_9) ((f_9 i_0) h_5)) t_5)
    | `LH_N -> 
      i_0);;
    ...
    | `LH_N -> 
      (((rqsort_lh__d2 _lh_qpart_arg1_0) _lh_qpart_arg4_0) (let rec t_1_8 = (((rqsort_lh__d1 _lh_qpart_arg1_0) _lh_qpart_arg5_0) _lh_qpart_arg6_0) in
        (let rec h_1_8 = _lh_qpart_arg2_0 in
          (fun f_2_1 -> 
            (`LH_C((f_2_1 h_1_8), ((map_lh__d4 f_2_1) t_1_8)))))))
        ...
        | `LH_N -> 
          (let rec t_4 = _lh_qsort_arg3_0 in
            (let rec h_4 = _lh_qsort_LH_C_0_0 in
              (fun f_8 -> 
                (`LH_C((f_8 h_4), ((map_lh__d4 f_8) t_4))))))
        | _ -> 
    ...
    | `LH_N -> 
      (((qsort_lh__d1 _lh_rqpart_arg1_1) _lh_rqpart_arg4_1) (let rec t_1_9 = (((qsort_lh__d1 _lh_rqpart_arg1_1) _lh_rqpart_arg5_1) _lh_rqpart_arg6_1) in
        (let rec h_1_9 = _lh_rqpart_arg2_1 in
          (fun f_2_3 -> 
            (`LH_C((f_2_3 h_1_9), ((map_lh__d4 f_2_3) t_1_9)))))))
    ...
    | `LH_N -> 
      (((qsort_lh__d1 _lh_rqpart_arg1_0) _lh_rqpart_arg4_0) (let rec t_7 = (((qsort_lh__d1 _lh_rqpart_arg1_0) _lh_rqpart_arg5_0) _lh_rqpart_arg6_0) in
        (let rec h_7 = _lh_rqpart_arg2_0 in
          (fun f_1_0 -> 
            (`LH_C((f_1_0 h_7), ((map_lh__d4 f_1_0) t_7)))))))
        ...
        | `LH_N -> 
          (let rec t_1_1 = _lh_rqsort_arg3_0 in
            (let rec h_1_1 = _lh_rqsort_LH_C_0_0 in
              (fun f_1_3 -> 
                (`LH_C((f_1_3 h_1_1), ((map_lh__d4 f_1_3) t_1_1))))))
        | _ -> 
        ...
        | `LH_N -> 
          (let rec t_1_2 = _lh_rqsort_arg3_1 in
            (let rec h_1_2 = _lh_rqsort_LH_C_0_1 in
              (fun f_1_4 -> 
                (`LH_C((f_1_4 h_1_2), ((map_lh__d4 f_1_4) t_1_2))))))
        | _ -> 
...
let rec mappend_lh__d3 xs_1 ys_1 =
  (xs_1 ys_1);;
let rec map_lh__d6 f_1_1 ls_5 _lh_popOutId_0_2 =
  (match ls_5 with
    | `LH_C(h_9, t_9) -> 
...
let rec sum_lh__d1 ls_4 =
  (match ls_4 with
    ...
    | `LH_N -> 
      0);;
let rec filter_lh__d1 f_2_2 ls_8 =
  (ls_8 f_2_2);;
let rec map_lh__d3 f_4 ls_1 _lh_popOutId_0_1 =
  (match ls_1 with
    | `LH_C(h_2, t_2) -> 
      (let rec t_3 = ((map_lh__d3 f_4) t_2) in
        (let rec h_3 = (f_4 h_2) in
          (if (_lh_popOutId_0_1 h_3) then
            (`LH_C(h_3, ((filter_lh__d1 _lh_popOutId_0_1) t_3)))
          else
            ((filter_lh__d1 _lh_popOutId_0_1) t_3))))
    | `LH_N -> 
      (`LH_N));;

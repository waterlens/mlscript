...
let rec mappend_lh__d3 xs_2 ys_6 =
  (match xs_2 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d3 t_4) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec mappend_lh__d1 xs_3 ys_7 =
  (match xs_3 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d1 t_5) ys_7)))
    | `LH_N -> 
      ys_7);;
...
let rec drop_lh__d1 _lh_drop_arg1_0 _lh_drop_arg2_0 =
  (match _lh_drop_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec take_lh__d1 n_0 ls_9 =
  (if (n_0 > 0) then
    (match ls_9 with
      | `LH_C(h_2_6, t_2_6) -> 
        (`LH_C(h_2_6, ((take_lh__d1 (n_0 - 1)) t_2_6)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec last'_lh__d5 _lh_last'_arg1_4 =
  (match _lh_last'_arg1_4 with
    | `LH_P2(_lh_last'_LH_P2_0_4, _lh_last'_LH_P2_1_4) -> 
      (if (not (null_lh__d5 _lh_last'_LH_P2_1_4)) then
        (head_lh__d7 _lh_last'_LH_P2_1_4)
      else
        (head_lh__d7 _lh_last'_LH_P2_0_4))
    | _ -> 
      (failwith "error"));;
                ...
                (let rec old_width_hd_0 = (fun p_3 -> 
                  ...
                  (let rec new_0 = (fun p_4 -> 
                    (if (single_0 p_4) then
                      ...
                      (`LH_P3(_lh_stepr_LH_P3_1_0, ((cost_tl_lh__d2 p_4) + (let rec x_3 = (optw_lh__d1 - (old_width_hd_0 p_4)) in
...
let rec map_lh__d4 f_0 ls_0 =
  (match ls_0 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C((f_0 h_1), ((map_lh__d4 f_0) t_1)))
    | `LH_N -> 
      (`LH_N));;
let rec head_lh__d1 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_3_6, t_3_6) -> 
      h_3_6
    | `LH_N -> 
...
tile_lh__d1 _lh_tile_arg1_0 _lh_tile_arg2_0 =
  (match _lh_tile_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d5 f_7 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_3_1, t_3_1) -> 
      (`LH_C((f_7 h_3_1), ((map_lh__d5 f_7) t_3_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec filter_lh__d1 f_1_0 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_3_3, t_3_3) -> 
      (if (f_1_0 h_3_3) then
        (let rec t_3_4 = ((filter_lh__d1 f_1_0) t_3_3) in
          (let rec h_3_4 = h_3_3 in
            (fun f_1_1 -> 
              (`LH_C((f_1_1 h_3_4), ((map_lh__d1 f_1_1) t_3_4))))))
      else
        ((filter_lh__d1 f_1_0) t_3_3))
    | `LH_N -> 
      (fun f_1_2 -> 
        (`LH_N)));;
...
let rec break_lh__d1 _lh_break_arg1_2 _lh_break_arg2_2 =
  (match _lh_break_arg2_2 with
    | `LH_N -> 
      (`LH_P2((`LH_N), (fun _lh_dummy_4 f_8 -> 
        (`LH_N))))
      ...
      | `LH_P2(_lh_lines_LH_P2_0_0, _lh_lines_LH_P2_1_0) -> 
        (let rec t_1_2 = (let rec _lh_matchIdent_5 = _lh_lines_LH_P2_1_0 in
          ...
          (let rec h_1_2 = _lh_lines_LH_P2_0_0 in
            (fun f_1 -> 
              (`LH_C((f_1 h_1_2), ((map_lh__d3 f_1) t_1_2))))))
      | _ -> 
        (failwith "error")));;
...
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d2 ((map_lh__d6 (fun l_2 -> 
    ((mappend_lh__d1_d1 l_2) (let rec t_4_2 = (fun ys_2_8 -> 
      ys_2_8) in
      (let rec h_4_2 = '|' in
        (fun ys_2_9 -> 
          (`LH_C(h_4_2, ((mappend_lh__d1_d4 t_4_2) ys_2_9))))))))) _lh_unlines_arg1_0));;
let rec mappend_lh__d1_d2 xs_1_6 ys_2_5 =
  (match xs_1_6 with
    | `LH_C(h_3_8, t_3_8) -> 
      (let rec t_3_9 = ((mappend_lh__d1_d2 t_3_8) ys_2_5) in
        (let rec h_3_9 = h_3_8 in
          (fun ys_2_6 -> 
            (let rec t_4_0 = ((mappend_lh__d1_d1 t_3_9) ys_2_6) in
              (let rec h_4_0 = h_3_9 in
                (fun ys_2_7 -> 
                  (`LH_C(h_4_0, ((mappend_lh__d1_d4 t_4_0) ys_2_7)))))))))
    | `LH_N -> 
      ys_2_5);;
let rec mappend_lh__d1_d3 xs_1_3 ys_1_9 =
  (match xs_1_3 with
    | `LH_C(h_2_3, t_2_3) -> 
      (let rec t_2_4 = ((mappend_lh__d1_d3 t_2_3) ys_1_9) in
        (let rec h_2_4 = h_2_3 in
          (fun ys_2_0 -> 
            (let rec t_2_5 = ((mappend_lh__d1_d1 t_2_4) ys_2_0) in
              (let rec h_2_5 = h_2_4 in
                (fun ys_2_1 -> 
                  (`LH_C(h_2_5, ((mappend_lh__d1_d4 t_2_5) ys_2_1)))))))))
    | `LH_N -> 
      ys_1_9);;
      ...
      (let rec go_0 = (fun _lh_go_arg1_0 -> 
        (match _lh_go_arg1_0 with
          ...
          | `LH_C(_lh_go_LH_C_0_0, _lh_go_LH_C_1_0) -> 
            (let rec t_2 = ((mappend_lh__d1_d2 _lh_go_LH_C_0_0) (go_0 _lh_go_LH_C_1_0)) in
              (let rec h_2 = ' ' in
                (fun ys_4 -> 
                  (let rec t_3 = ((mappend_lh__d1_d1 t_2) ys_4) in
                    (let rec h_3 = h_2 in
                      (fun ys_5 -> 
                        (`LH_C(h_3, ((mappend_lh__d1_d4 t_3) ys_5)))))))))
          | _ -> 
            (failwith "error"))) in
...
let rec mappend_lh__d1_d5 xs_1_5 ys_2_3 =
  (match xs_1_5 with
    | `LH_C(h_2_9, t_2_9) -> 
      (let rec t_3_0 = ((mappend_lh__d1_d5 t_2_9) ys_2_3) in
        (let rec h_3_0 = h_2_9 in
          (fun ys_2_4 -> 
            (`LH_C(h_3_0, ((mappend_lh__d1_d6 t_3_0) ys_2_4))))))
    | `LH_N -> 
      ys_2_3);;
let rec unformat_lh__d1 _lh_unformat_arg1_0 =
  ((fold1_lh__d2 (fun xs_1_2 ys_1_6 -> 
    ((mappend_lh__d1_d6 ((mappend_lh__d1_d5 xs_1_2) (let rec t_2_1 = (fun ys_1_7 -> 
      ys_1_7) in
      (let rec h_2_1 = _lh_unformat_arg1_0 in
        (fun ys_1_8 -> 
          (`LH_C(h_2_1, ((mappend_lh__d1_d6 t_2_1) ys_1_8)))))))) ys_1_6))) (fun x_2 -> 
    x_2));;
let rec unparas_lh__d1 _lh_unparas_arg1_0 =
  ((unformat_lh__d1 (`LH_N)) _lh_unparas_arg1_0);;
let rec map_lh__d2 f_3 ls_7 _lh_popOutId_0_0 _lh_popOutId_1_0 =
  (match ls_7 with
    | `LH_C(h_1_8, t_1_8) -> 
      (let rec t_1_9 = ((map_lh__d2 f_3) t_1_8) in
        (let rec h_1_9 = (f_3 h_1_8) in
          (let rec t_2_0 = ((map_lh__d6 _lh_popOutId_0_0) t_1_9) in
            (let rec h_2_0 = (_lh_popOutId_0_0 h_1_9) in
              ((mappend_lh__d1_d4 h_2_0) (concat_lh__d2 t_2_0))))))
    | `LH_N -> 
      (`LH_N));;
...
let rec concat_lh__d1 lss_1 =
  (match lss_1 with
    | `LH_C(h_3_7, t_3_7) -> 
      ((mappend_lh__d1_d0 h_3_7) (concat_lh__d1 t_3_7))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d4 xs_1_1 ys_1_5 =
  (match xs_1_1 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C(h_1_7, ((mappend_lh__d4 t_1_7) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
let rec mappend_lh__d9 xs_1_4 ys_2_2 =
  (match xs_1_4 with
    | `LH_C(h_2_8, t_2_8) -> 
      (`LH_C(h_2_8, ((mappend_lh__d9 t_2_8) ys_2_2)))
    | `LH_N -> 
      ys_2_2);;

...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Lambda_nofib" (fun () -> ignore (let open Module_original in ((testLambda_nofib__d0 80))));
  Bench.Test.create ~name:"lumberhack_Lambda_nofib" (fun () -> ignore (let open Module_lumberhack in ((testLambda_nofib__d0 80))));
  Bench.Test.create ~name:"lumberhack_pop_out_Lambda_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testLambda_nofib__d0 80))));
])

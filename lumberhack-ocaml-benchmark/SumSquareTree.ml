(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./SumSquareTree.ml -o "./SumSquareTree.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./SumSquareTree.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

...
and deleteFirst_lh _lh_deleteFirst_arg1_0 =
  (match _lh_deleteFirst_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and depthSearch_lh _lh_depthSearch_arg1_0 _lh_depthSearch_arg2_0 _lh_depthSearch_arg3_0 =
...
and descAndNo_lh _lh_descAndNo_arg1_0 =
...
and descendents_lh _lh_descendents_arg1_0 =
...
and grow_lh _lh_grow_arg1_0 =
  (match _lh_grow_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and isFinished_lh _lh_isFinished_arg1_0 =
  (match _lh_isFinished_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and isSquareFree_lh _lh_isSquareFree_arg1_0 _lh_isSquareFree_arg2_0 =
  (match _lh_isSquareFree_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and moveKnight_lh _lh_moveKnight_arg1_0 _lh_moveKnight_arg2_0 =
  ((addPiece_lh ((move_lh _lh_moveKnight_arg2_0) (lastPiece_lh _lh_moveKnight_arg1_0))) _lh_moveKnight_arg1_0)
and possibleMoves_lh _lh_possibleMoves_arg1_0 =
...
and printBoard_lh _lh_printBoard_arg1_0 _lh_printBoard_arg2_0 _lh_printBoard_arg3_0 =
  (match _lh_printBoard_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and printTour_lh _lh_printTour_arg1_0 =
  ...
  in (let rec _lh_matchIdent_0 = ((map_lh (strToInt_0 0)) _lh_printTour_arg1_0) in
    (match _lh_matchIdent_0 with
      ...
      | _ -> 
        (failwith "error")))
and quickSortIntChessSet_lh _lh_quickSortIntChessSet_arg1_0 =
  (match _lh_quickSortIntChessSet_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and quickSortIntInt_lh _lh_quickSortIntInt_arg1_0 =
...
and showChessSet_lh _lh_showChessSet_arg1_0 =
  (match _lh_showChessSet_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and singleDescend_lh _lh_singleDescend_arg1_0 =
...
and spaces_lh _lh_spaces_arg1_0 _lh_spaces_arg2_0 =
...
and startTour_lh _lh_startTour_arg1_0 _lh_startTour_arg2_0 =
...
and testKnights_nofib_lh _lh_testKnights_nofib_arg1_0 =
...
and tourFinished_lh _lh_tourFinished_arg1_0 =

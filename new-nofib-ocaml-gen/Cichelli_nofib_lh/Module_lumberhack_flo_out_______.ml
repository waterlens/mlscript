...
let rec attribkeys_lh__d1 _lh_attribkeys_arg1_2 =
  (_lh_attribkeys_arg1_2 (fun k_2 -> 
    (`K(k_2, (head_lh__d1 k_2), (last_lh__d1 k_2), (length_lh__d1 k_2)))));;
let rec keys_lh__d1 =
  (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (let rec t_2_5 = (let rec t_2_6 = (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (let rec t_3_5 = (let rec t_3_6 = (fun n_2 f_1_3 -> 
    (`LH_N)) in
    (let rec h_1_5 = (`LH_C('w', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_N))))))))))) in
      (fun n_3 -> 
        (let rec t_3_7 = (if ((n_3 - 1) > 0) then
          (t_3_6 (n_3 - 1))
        else
          (fun f_1_4 -> 
            (`LH_N))) in
          (let rec h_1_6 = h_1_5 in
            (fun f_1_5 -> 
              (`LH_C((f_1_5 h_1_6), (t_3_7 f_1_5))))))))) in
    (let rec h_1_7 = (`LH_C('t', (`LH_C('y', (`LH_C('p', (`LH_C('e', (`LH_N))))))))) in
      (fun n_4 -> 
        (let rec t_3_8 = (if ((n_4 - 1) > 0) then
          (t_3_5 (n_4 - 1))
        else
          (fun f_1_6 -> 
            (`LH_N))) in
          (let rec h_1_8 = h_1_7 in
            (fun f_1_7 -> 
              (`LH_C((f_1_7 h_1_8), (t_3_8 f_1_7))))))))) in
    (let rec h_1_9 = (`LH_C('t', (`LH_C('o', (`LH_N))))) in
      (fun n_5 -> 
        (let rec t_3_9 = (if ((n_5 - 1) > 0) then
          (t_3_4 (n_5 - 1))
        else
          (fun f_1_8 -> 
            (`LH_N))) in
          (let rec h_2_0 = h_1_9 in
            (fun f_1_9 -> 
              (`LH_C((f_1_9 h_2_0), (t_3_9 f_1_9))))))))) in
    (let rec h_2_1 = (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('n', (`LH_N))))))))) in
      (fun n_6 -> 
        (let rec t_4_0 = (if ((n_6 - 1) > 0) then
          (t_3_3 (n_6 - 1))
        else
          (fun f_2_0 -> 
            (`LH_N))) in
      ...
      (fun n_7 -> 
        (let rec t_4_1 = (if ((n_7 - 1) > 0) then
          ...
          (let rec h_2_4 = h_2_3 in
            (fun f_2_3 -> 
              (`LH_C((f_2_3 h_2_4), (t_4_1 f_2_3))))))))) in
    (let rec h_2_5 = (`LH_C('o', (`LH_C('f', (`LH_N))))) in
      (fun n_8 -> 
        (let rec t_4_2 = (if ((n_8 - 1) > 0) then
          (t_3_1 (n_8 - 1))
        else
          (fun f_2_4 -> 
            (`LH_N))) in
      ...
      (fun n_9 -> 
        (let rec t_4_3 = (if ((n_9 - 1) > 0) then
          ...
          (let rec h_2_8 = h_2_7 in
            (fun f_2_7 -> 
              (`LH_C((f_2_7 h_2_8), (t_4_3 f_2_7))))))))) in
    (let rec h_2_9 = (`LH_C('l', (`LH_C('e', (`LH_C('t', (`LH_N))))))) in
      (fun n_1_0 -> 
        (let rec t_4_4 = (if ((n_1_0 - 1) > 0) then
          (t_2_9 (n_1_0 - 1))
        else
          (fun f_2_8 -> 
            (`LH_N))) in
      ...
      (fun n_1_3 -> 
        (let rec t_4_7 = (if ((n_1_3 - 1) > 0) then
          ...
          (let rec h_3_6 = h_3_5 in
            (fun f_3_5 -> 
              (`LH_C((f_3_5 h_3_6), (t_4_7 f_3_5))))))))) in
    (let rec h_3_7 = (`LH_C('i', (`LH_C('n', (`LH_C('f', (`LH_C('i', (`LH_C('x', (`LH_N))))))))))) in
      (fun n_1_4 -> 
        (let rec t_4_8 = (if ((n_1_4 - 1) > 0) then
          (t_2_5 (n_1_4 - 1))
        else
          (fun f_3_6 -> 
            (`LH_N))) in
          (let rec h_3_8 = h_3_7 in
            (fun f_3_7 -> 
              (`LH_C((f_3_7 h_3_8), (t_4_8 f_3_7))))))))) in
    (let rec h_3_9 = (`LH_C('i', (`LH_C('n', (`LH_N))))) in
      (fun n_1_5 -> 
        (let rec t_4_9 = (if ((n_1_5 - 1) > 0) then
          (t_2_4 (n_1_5 - 1))
        else
          (fun f_3_8 -> 
            (`LH_N))) in
      ...
      (fun n_1_6 -> 
        (let rec t_5_0 = (if ((n_1_6 - 1) > 0) then
          ...
          (let rec h_4_2 = h_4_1 in
            (fun f_4_1 -> 
              (`LH_C((f_4_1 h_4_2), (t_5_0 f_4_1))))))))) in
    (let rec h_4_3 = (`LH_C('i', (`LH_C('f', (`LH_N))))) in
      (fun n_1_7 -> 
        (let rec t_5_1 = (if ((n_1_7 - 1) > 0) then
          (t_2_2 (n_1_7 - 1))
        else
          (fun f_4_2 -> 
            (`LH_N))) in
      ...
      (fun n_1_8 -> 
        (let rec t_5_2 = (if ((n_1_8 - 1) > 0) then
          ...
          (let rec h_4_6 = h_4_5 in
            (fun f_4_5 -> 
              (`LH_C((f_4_5 h_4_6), (t_5_2 f_4_5))))))))) in
    (let rec h_4_7 = (`LH_C('e', (`LH_C('l', (`LH_C('s', (`LH_C('e', (`LH_N))))))))) in
      (fun n_1_9 -> 
        (let rec t_5_3 = (if ((n_1_9 - 1) > 0) then
          (t_2_0 (n_1_9 - 1))
        else
          (fun f_4_6 -> 
            (`LH_N))) in
      ...
      (fun n_2_1 -> 
        (let rec t_5_5 = (if ((n_2_1 - 1) > 0) then
          ...
          (let rec h_5_2 = h_5_1 in
            (fun f_5_1 -> 
              (`LH_C((f_5_1 h_5_2), (t_5_5 f_5_1))))))))) in
    (let rec h_5_3 = (`LH_C('d', (`LH_C('a', (`LH_C('t', (`LH_C('a', (`LH_N))))))))) in
      (fun n_2_2 -> 
        (let rec t_5_6 = (if ((n_2_2 - 1) > 0) then
          (t_1_7 (n_2_2 - 1))
        else
          (fun f_5_2 -> 
            (`LH_N))) in
          (let rec h_5_4 = h_5_3 in
            (fun f_5_3 -> 
              (`LH_C((f_5_3 h_5_4), (t_5_6 f_5_3))))))))) in
    (let rec h_5_5 = (`LH_C('c', (`LH_C('l', (`LH_C('a', (`LH_C('s', (`LH_C('s', (`LH_N))))))))))) in
      (fun n_2_3 -> 
        (let rec t_5_7 = (if ((n_2_3 - 1) > 0) then
          (t_1_6 (n_2_3 - 1))
        else
          (fun f_5_4 -> 
            (`LH_N))) in
          (let rec h_5_6 = h_5_5 in
            (fun f_5_5 -> 
              (`LH_C((f_5_5 h_5_6), (t_5_7 f_5_5))))))))) in
    (let rec h_5_7 = (`LH_C('c', (`LH_C('a', (`LH_C('s', (`LH_C('e', (`LH_N))))))))) in
      (fun n_2_4 -> 
        (let rec t_5_8 = (if ((n_2_4 - 1) > 0) then
          (t_1_5 (n_2_4 - 1))
        else
          (fun f_5_6 -> 
            (`LH_N))) in
...
let rec firstSuccess_lh__d1 _lh_firstSuccess_arg1_0 _lh_firstSuccess_arg2_0 =
  (let rec _lh_matchIdent_2 = (Lazy.force (lazy ((Lazy.force _lh_firstSuccess_arg2_0) _lh_firstSuccess_arg1_0))) in
    (_lh_matchIdent_2 0));;
...
let rec map_lh__d4 f_5_8 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_5_9, t_5_9) -> 
      (`LH_C((f_5_8 h_5_9), ((map_lh__d4 f_5_8) t_5_9)))
    | `LH_N -> 
      (`LH_N));;
                ...
                (let rec _lh_matchIdent_8 = _lh_first_LH_C_0_1 in
                  (match _lh_matchIdent_8 with
                    ...
                    | `NotEver(_lh_first_NotEver_0_1) -> 
                      (let rec _lh_matchIdent_9 = (Lazy.force _lh_first_LH_C_1_1) in
                        (_lh_matchIdent_9 (_lh_first_arg1_4 + _lh_first_NotEver_0_1)))
                    | _ -> 
                      (failwith "error")))))))))
  else
...
let rec firstSuccess_lh__d3 _lh_firstSuccess_arg1_1 _lh_firstSuccess_arg2_1 =
  (let rec _lh_matchIdent_1_0 = (Lazy.force (lazy ((Lazy.force _lh_firstSuccess_arg2_1) _lh_firstSuccess_arg1_1))) in
    (_lh_matchIdent_1_0 0));;
...
let rec ends_lh__d3 _lh_ends_arg1_1 =
  (match _lh_ends_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d2 f_8 ls_7 _lh_popOutId_0_0 =
  (match ls_7 with
    | `LH_C(h_9, t_9) -> 
      (let rec t_1_0 = ((map_lh__d2 f_8) t_9) in
        (let rec h_1_0 = (f_8 h_9) in
          ((mappend_lh__d4 h_1_0) (t_1_0 99))))
    | `LH_N -> 
      (`LH_N));;
...
let rec freqtab_lh__d1 =
  (histo_lh__d1 (((map_lh__d2 ends_lh__d3) (attribkeys_lh__d2 keys_lh__d3)) 99));;
      ...
      (let rec _lh_first_LH_C_1_0 = ((map_lz_lh__d4 f_1) t_4) in
        (let rec _lh_first_LH_C_0_0 = (f_1 h_4) in
          (fun _lh_first_arg1_2 -> 
            (let rec _lh_matchIdent_6 = _lh_first_LH_C_0_0 in
              (match _lh_matchIdent_6 with
                ...
                | `NotEver(_lh_first_NotEver_0_0) -> 
                  (let rec _lh_matchIdent_7 = (Lazy.force _lh_first_LH_C_1_0) in
                    (_lh_matchIdent_7 (_lh_first_arg1_2 + _lh_first_NotEver_0_0)))
                | _ -> 
                  (failwith "error"))))))
    | `LH_N -> 
...
let rec firstSuccess_lh__d4 _lh_firstSuccess_arg1_2 _lh_firstSuccess_arg2_2 =
  (let rec _lh_matchIdent_1_3 = (Lazy.force ((map_lz_lh__d4 _lh_firstSuccess_arg1_2) _lh_firstSuccess_arg2_2)) in
    (_lh_matchIdent_1_3 0));;
  ...
  (lazy (if (_lh_enumFromTo_lz_arg1_4 <= _lh_enumFromTo_lz_arg2_4) then
    (let rec t_1_0_5 = ((enumFromTo_lz_lh__d2 (_lh_enumFromTo_lz_arg1_4 + 1)) _lh_enumFromTo_lz_arg2_4) in
      (let rec h_1_0_5 = _lh_enumFromTo_lz_arg1_4 in
        (fun f_8_2 -> 
          (let rec _lh_first_LH_C_1_3 = (lazy ((Lazy.force t_1_0_5) f_8_2)) in
            (let rec _lh_first_LH_C_0_3 = (f_8_2 h_1_0_5) in
...
let rec map_lh__d3 f_1_2 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_4, t_1_4) -> 
      (`LH_C((f_1_2 h_1_4), ((map_lh__d3 f_1_2) t_1_4)))
    | `LH_N -> 
      (`LH_N));;
  ...
  (lazy (if (_lh_enumFromTo_lz_arg1_3 <= _lh_enumFromTo_lz_arg2_3) then
    (let rec t_1_2 = ((enumFromTo_lz_lh__d3 (_lh_enumFromTo_lz_arg1_3 + 1)) _lh_enumFromTo_lz_arg2_3) in
      (let rec h_1_2 = _lh_enumFromTo_lz_arg1_3 in
        (fun f_1_0 -> 
          (let rec _lh_first_LH_C_1_2 = (lazy ((Lazy.force t_1_2) f_1_0)) in
            (let rec _lh_first_LH_C_0_2 = (f_1_0 h_1_2) in
              (fun _lh_first_arg1_8 -> 
                (let rec _lh_matchIdent_1_4 = _lh_first_LH_C_0_2 in
                  (match _lh_matchIdent_1_4 with
                    ...
                    | `NotEver(_lh_first_NotEver_0_2) -> 
                      (let rec _lh_matchIdent_1_5 = (Lazy.force _lh_first_LH_C_1_2) in
                        (_lh_matchIdent_1_5 (_lh_first_arg1_8 + _lh_first_NotEver_0_2)))
                    | _ -> 
                      (failwith "error")))))))))
  else
    (fun f_1_1 _lh_first_arg1_9 -> 
                      ...
                      | `K(_lh_findhash'_K_0_0, _lh_findhash'_K_1_2, _lh_findhash'_K_2_2, _lh_findhash'_K_3_0) -> 
                        (let rec try_2 = (fun newAssocs_0 -> 
                          (let rec newCharAssocs_0 = ((mappend_lh__d3 newAssocs_0) _lh_findhash'_arg2_0) in
                            (let rec _lh_matchIdent_4 = ((hinsert_lh__d1 ((let rec _lh_hash_K_3_0 = _lh_findhash'_K_3_0 in
                              (let rec _lh_hash_K_2_0 = _lh_findhash'_K_2_2 in
                                (let rec _lh_hash_K_1_0 = _lh_findhash'_K_1_2 in
                                  (let rec _lh_hash_K_0_0 = _lh_findhash'_K_0_0 in
                                    (fun _lh_hash_arg1_0 -> 
                                      ((_lh_hash_K_3_0 + ((assoc_lh__d1 _lh_hash_K_1_0) _lh_hash_arg1_0)) + ((assoc_lh__d2 _lh_hash_K_2_0) _lh_hash_arg1_0))))))) newCharAssocs_0)) _lh_findhash'_arg1_0) in
                              (match _lh_matchIdent_4 with
                                | `Nothing -> 
                                  (`NotEver(1))
                                | `Just(_lh_findhash'_Just_0_3) -> 
                                  ((_lh_findhash'_LH_C_1_0 newCharAssocs_0) _lh_findhash'_Just_0_3)
                                | _ -> 
                                  (failwith "error"))))) in
                          (let rec _lh_matchIdent_5 = (let rec _lh_findhash'_LH_P2_1_3 = ((assocm_lh__d2 _lh_findhash'_K_2_2) _lh_findhash'_arg2_0) in
                            ...
                            (((_lh_matchIdent_5 _lh_findhash'_K_1_2) _lh_findhash'_K_2_2) try_2)))
                      | _ -> 
        ...
        (let rec _lh_matchIdent_1_9 = ((partition'_lh__d1 (fun x_1 -> 
          ...
          (match _lh_matchIdent_1_9 with
            | `LH_P2(_lh_blocked'_LH_P2_0_0, _lh_blocked'_LH_P2_1_0) -> 
              ((let rec t_1_0_6 = _lh_blocked'_LH_P2_0_0 in
                (let rec h_1_0_6 = _lh_blocked'_LH_C_0_0 in
                  (fun ys_2_9 -> 
                    (let rec _lh_findhash'_LH_C_1_1 = (t_1_0_6 ys_2_9) in
                                ...
                                (let rec newCharAssocs_1 = ((mappend_lh__d3 newAssocs_1) _lh_findhash'_arg2_3) in
                                  (let rec _lh_matchIdent_2_0 = ((hinsert_lh__d1 ((let rec _lh_hash_K_3_1 = _lh_findhash'_K_3_1 in
                                    (let rec _lh_hash_K_2_1 = _lh_findhash'_K_2_4 in
                                      (let rec _lh_hash_K_1_1 = _lh_findhash'_K_1_4 in
                                        (let rec _lh_hash_K_0_1 = _lh_findhash'_K_0_1 in
                                          (fun _lh_hash_arg1_2 -> 
                                            ((_lh_hash_K_3_1 + ((assoc_lh__d1 _lh_hash_K_1_1) _lh_hash_arg1_2)) + ((assoc_lh__d2 _lh_hash_K_2_1) _lh_hash_arg1_2))))))) newCharAssocs_1)) _lh_findhash'_arg1_3) in
                                    (match _lh_matchIdent_2_0 with
                                      ...
                                      | _ -> 
                                        (failwith "error"))))) in
                                (let rec _lh_matchIdent_2_1 = (let rec _lh_findhash'_LH_P2_1_4 = ((assocm_lh__d2 _lh_findhash'_K_2_4) _lh_findhash'_arg2_3) in
                                  ...
                                  (((_lh_matchIdent_2_1 _lh_findhash'_K_1_4) _lh_findhash'_K_2_4) try_4)))
                            | _ -> 

...
let rec vecscale_lh__d3 _lh_vecscale_arg1_3 _lh_vecscale_arg2_4 =
  (match _lh_vecscale_arg1_3 with
    | `LH_P3(_lh_vecscale_LH_P3_0_4, _lh_vecscale_LH_P3_1_4, _lh_vecscale_LH_P3_2_4) -> 
      (let rec _lh_vecadd_LH_P3_2_1_5 = (_lh_vecscale_arg2_4 *. _lh_vecscale_LH_P3_2_4) in
        (let rec _lh_vecadd_LH_P3_1_1_5 = (_lh_vecscale_arg2_4 *. _lh_vecscale_LH_P3_1_4) in
          (let rec _lh_vecadd_LH_P3_0_1_5 = (_lh_vecscale_arg2_4 *. _lh_vecscale_LH_P3_0_4) in
            (fun _lh_vecadd_LH_P3_0_1_6 _lh_vecadd_LH_P3_1_1_6 _lh_vecadd_LH_P3_2_1_6 -> 
              (let rec _lh_vecsub_LH_P3_2_1 = (_lh_vecadd_LH_P3_2_1_6 +. _lh_vecadd_LH_P3_2_1_5) in
                (let rec _lh_vecsub_LH_P3_1_1 = (_lh_vecadd_LH_P3_1_1_6 +. _lh_vecadd_LH_P3_1_1_5) in
                  (let rec _lh_vecsub_LH_P3_0_1 = (_lh_vecadd_LH_P3_0_1_6 +. _lh_vecadd_LH_P3_0_1_5) in
                    (fun _lh_vecsub_LH_P3_0_2 _lh_vecsub_LH_P3_1_2 _lh_vecsub_LH_P3_2_2 -> 
                      (let rec _lh_vecadd_LH_P3_2_1_7 = (_lh_vecsub_LH_P3_2_2 -. _lh_vecsub_LH_P3_2_1) in
                        (let rec _lh_vecadd_LH_P3_1_1_7 = (_lh_vecsub_LH_P3_1_2 -. _lh_vecsub_LH_P3_1_1) in
                          (let rec _lh_vecadd_LH_P3_0_1_7 = (_lh_vecsub_LH_P3_0_2 -. _lh_vecsub_LH_P3_0_1) in
                            (fun _lh_vecadd_arg2_2 -> 
                              (((_lh_vecadd_arg2_2 _lh_vecadd_LH_P3_0_1_7) _lh_vecadd_LH_P3_1_1_7) _lh_vecadd_LH_P3_2_1_7)))))))))))))
    | _ -> 
      (failwith "error"));;
let rec pi_lh__d2 =
  3.141592653589793;;
  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_0 in
        (fun _lh_listcomp_fun_ls_h_6 _lh_listcomp_fun_6 f_6 _lh_listcomp_fun_ls_t_6 _lh_listcomp_fun_7 -> 
          (let rec t_9 = (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_5) in
            (let rec h_7 = (let rec _lh_snd_LH_P2_1_0 = ((f_6 _lh_listcomp_fun_ls_h_6) _lh_listcomp_fun_ls_h_5) in
              (let rec _lh_snd_LH_P2_0_0 = (`LH_P2(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_h_5)) in
                _lh_snd_LH_P2_1_0)) in
              (fun f_7 -> 
                (let rec t_1_0 = (t_9 f_7) in
                  (let rec h_8 = (f_7 h_7) in
                    (fun f_8 i_1 -> 
                      ((f_8 h_8) ((t_1_0 f_8) i_1)))))))))))
  else
    (fun _lh_listcomp_fun_ls_h_7 _lh_listcomp_fun_8 f_9 _lh_listcomp_fun_ls_t_7 _lh_listcomp_fun_9 -> 
  ...
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1_0 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_1 in
        (fun _lh_listcomp_fun_1_2 _lh_ray_arg1_2 f_1_6 -> 
          (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_8 -> 
            (((((_lh_listcomp_fun_para_8 _lh_listcomp_fun_ls_h_1_0) _lh_listcomp_fun_1_3) f_1_6) _lh_listcomp_fun_ls_t_1_0) _lh_listcomp_fun_1_2)) in
            (_lh_listcomp_fun_1_3 ((enumFromTo_lh__d2 0) (_lh_ray_arg1_2 - 1)))))))
  else
    (fun _lh_listcomp_fun_1_4 _lh_ray_arg1_3 f_1_7 f_1_8 f_1_9 i_5 -> 
      i_5));;
let rec vecscale_lh__d5 _lh_vecscale_arg1_2 _lh_vecscale_arg2_3 =
  (match _lh_vecscale_arg1_2 with
    | `LH_P3(_lh_vecscale_LH_P3_0_3, _lh_vecscale_LH_P3_1_3, _lh_vecscale_LH_P3_2_3) -> 
      (let rec _lh_vecadd_LH_P3_2_1_3 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_2_3) in
        (let rec _lh_vecadd_LH_P3_1_1_3 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_1_3) in
          (let rec _lh_vecadd_LH_P3_0_1_3 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_0_3) in
            (fun _lh_vecadd_LH_P3_0_1_4 _lh_vecadd_LH_P3_1_1_4 _lh_vecadd_LH_P3_2_1_4 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_1_4 +. _lh_vecadd_LH_P3_0_1_3), (_lh_vecadd_LH_P3_1_1_4 +. _lh_vecadd_LH_P3_1_1_3), (_lh_vecadd_LH_P3_2_1_4 +. _lh_vecadd_LH_P3_2_1_3)))))))
    | _ -> 
      (failwith "error"));;
...
let rec infinity_lh__d1 =
  100000000.0;;
let rec foldr_lh__d2 f_1_1 i_3 ls_3 =
  (match ls_3 with
    | `LH_C(h_1_1, t_1_3) -> 
      ((f_1_1 h_1_1) (((foldr_lh__d2 f_1_1) i_3) t_1_3))
    | `LH_N -> 
      i_3);;
...
let rec specularsurf_lh__d1 _lh_specularsurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
...
let rec bodysurf_lh__d2 _lh_bodysurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
...
let rec specpowsurf_lh__d1 _lh_specpowsurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
            ...
            (fun _lh_vecmult_arg2_6 -> 
              (match _lh_vecmult_arg2_6 with
                | `LH_P3(_lh_vecmult_LH_P3_0_9, _lh_vecmult_LH_P3_1_9, _lh_vecmult_LH_P3_2_9) -> 
                  (let rec _lh_vecadd_LH_P3_2_3_1 = (_lh_vecmult_LH_P3_2_8 *. _lh_vecmult_LH_P3_2_9) in
                    (let rec _lh_vecadd_LH_P3_1_3_1 = (_lh_vecmult_LH_P3_1_8 *. _lh_vecmult_LH_P3_1_9) in
                      (let rec _lh_vecadd_LH_P3_0_3_1 = (_lh_vecmult_LH_P3_0_8 *. _lh_vecmult_LH_P3_0_9) in
                        (fun _lh_vecadd_arg2_9 -> 
                          (((_lh_vecadd_arg2_9 _lh_vecadd_LH_P3_0_3_1) _lh_vecadd_LH_P3_1_3_1) _lh_vecadd_LH_P3_2_3_1)))))
                | _ -> 
                  (failwith "error"))))))
    | _ -> 
      (failwith "error"));;
            ...
            (let rec disc_2 = (((bm_0 *. bm_0) -. m2_0) +. (_lh_sphereintersect_Sphere_1_0 *. _lh_sphereintersect_Sphere_1_0)) in
              (let rec slo_0 = ((0.0 -. bm_0) -. (sqrt disc_2)) in
                (let rec shi_0 = ((0.0 -. bm_0) +. (sqrt disc_2)) in
                  (if (disc_2 < 0.0) then
                    (let rec _lh_trace_LH_P2_1_2_4 = 0.0 in
                      (let rec _lh_trace_LH_P2_0_2_4 = false in
                        (fun _lh_trace_LH_C_0_8 _lh_trace_LH_C_1_8 sphmap_8 -> 
                          (if _lh_trace_LH_P2_0_2_4 then
                            (`LH_C((`LH_P2(_lh_trace_LH_P2_1_2_4, _lh_trace_LH_C_0_8)), (sphmap_8 _lh_trace_LH_C_1_8)))
                          else
                            (sphmap_8 _lh_trace_LH_C_1_8)))))
                  else
                    (if (slo_0 < 0.0) then
                      (if (shi_0 < 0.0) then
                        (let rec _lh_trace_LH_P2_1_2_5 = 0.0 in
                          (let rec _lh_trace_LH_P2_0_2_5 = false in
                            (fun _lh_trace_LH_C_0_9 _lh_trace_LH_C_1_9 sphmap_9 -> 
                              (if _lh_trace_LH_P2_0_2_5 then
                                (`LH_C((`LH_P2(_lh_trace_LH_P2_1_2_5, _lh_trace_LH_C_0_9)), (sphmap_9 _lh_trace_LH_C_1_9)))
                              else
                                (sphmap_9 _lh_trace_LH_C_1_9)))))
                      else
                        (let rec _lh_trace_LH_P2_1_2_6 = shi_0 in
                          (let rec _lh_trace_LH_P2_0_2_6 = true in
                            (fun _lh_trace_LH_C_0_1_0 _lh_trace_LH_C_1_1_0 sphmap_1_0 -> 
                              (if _lh_trace_LH_P2_0_2_6 then
                                (`LH_C((`LH_P2(_lh_trace_LH_P2_1_2_6, _lh_trace_LH_C_0_1_0)), (sphmap_1_0 _lh_trace_LH_C_1_1_0)))
                              else
                                (sphmap_1_0 _lh_trace_LH_C_1_1_0))))))
                    else
                      (let rec _lh_trace_LH_P2_1_2_7 = slo_0 in
                        (let rec _lh_trace_LH_P2_0_2_7 = true in
                          (fun _lh_trace_LH_C_0_1_1 _lh_trace_LH_C_1_1_1 sphmap_1_1 -> 
                            (if _lh_trace_LH_P2_0_2_7 then
                              (`LH_C((`LH_P2(_lh_trace_LH_P2_1_2_7, _lh_trace_LH_C_0_1_1)), (sphmap_1_1 _lh_trace_LH_C_1_1_1)))
                            else
                              (sphmap_1_1 _lh_trace_LH_C_1_1_1)))))))))))))
    | _ -> 
      (failwith "error"));;
let rec specularsurf_lh__d2 _lh_specularsurf_arg1_1 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_1_0 -> 
            ...
            (fun _lh_vecmult_arg2_2 -> 
              (match _lh_vecmult_arg2_2 with
                | `LH_P3(_lh_vecmult_LH_P3_0_3, _lh_vecmult_LH_P3_1_3, _lh_vecmult_LH_P3_2_3) -> 
                  (let rec _lh_vecadd_LH_P3_2_1_8 = (_lh_vecmult_LH_P3_2_2 *. _lh_vecmult_LH_P3_2_3) in
                    (let rec _lh_vecadd_LH_P3_1_1_8 = (_lh_vecmult_LH_P3_1_2 *. _lh_vecmult_LH_P3_1_3) in
                      (let rec _lh_vecadd_LH_P3_0_1_8 = (_lh_vecmult_LH_P3_0_2 *. _lh_vecmult_LH_P3_0_3) in
...
let rec diffusesurf_lh__d1 _lh_diffusesurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
            ...
            (fun _lh_vecmult_arg2_4 -> 
              (match _lh_vecmult_arg2_4 with
                | `LH_P3(_lh_vecmult_LH_P3_0_5, _lh_vecmult_LH_P3_1_5, _lh_vecmult_LH_P3_2_5) -> 
                  (let rec _lh_vecadd_LH_P3_2_2_0 = (_lh_vecmult_LH_P3_2_4 *. _lh_vecmult_LH_P3_2_5) in
                    (let rec _lh_vecadd_LH_P3_1_2_0 = (_lh_vecmult_LH_P3_1_4 *. _lh_vecmult_LH_P3_1_5) in
                      (let rec _lh_vecadd_LH_P3_0_2_0 = (_lh_vecmult_LH_P3_0_4 *. _lh_vecmult_LH_P3_0_5) in
...
let rec shadowed_lh__d1 _lh_shadowed_arg1_0 _lh_shadowed_arg2_0 _lh_shadowed_arg3_0 =
  (let rec _lh_matchIdent_0 = (let rec f_1 = (fun d1s1_0 d2s2_0 -> 
      ...
      (let rec _lh_matchIdent_3 = xss_0 in
        (match _lh_matchIdent_3 with
          ...
          | `LH_C(_lh_trace_LH_C_0_0, _lh_trace_LH_C_1_0) -> 
            (let rec _lh_matchIdent_4 = (((sphereintersect_lh__d1 ((vecadd_lh__d1_d0 _lh_shadowed_arg1_0) ((vecscale_lh__d1_d5 _lh_shadowed_arg2_0) epsilon_lh__d1))) _lh_shadowed_arg2_0) _lh_trace_LH_C_0_0) in
              (((_lh_matchIdent_4 _lh_trace_LH_C_0_0) _lh_trace_LH_C_1_0) sphmap_0))
          | _ -> 
            (failwith "error")))) in
      (let rec dists_0 = (sphmap_0 testspheres_lh__d1) in
        (if (null_lh__d1 dists_0) then
          (`LH_P3(false, infinity_lh__d1, (head_lh__d2 testspheres_lh__d1)))
        else
          (let rec _lh_matchIdent_5 = (((foldr_lh__d2 f_1) (head_lh__d1 dists_0)) (tail_lh__d1 dists_0)) in
                      ...
                      (if (cosangle_0 <= 0.0) then
                          ...
                          (let rec cosalpha_0 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1)) in
                            (let rec diffcont_0 = ((vecmult_lh__d5 ((vecscale_lh__d1_d1 diff_0) (0.0 -. cosangle_0))) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_0 = (if (cosalpha_0 <= 0.0) then
                                ...
                                (((vecscale_lh__d1_d3 bodycol_0) (cosalpha_0 ** spow_0)) _lh_lightray_LH_P2_1_0)) in
                                (match diffcont_0 with
                                  | `LH_P3(_lh_vecadd_LH_P3_0_4, _lh_vecadd_LH_P3_1_4, _lh_vecadd_LH_P3_2_4) -> 
                                    (((speccont_0 _lh_vecadd_LH_P3_0_4) _lh_vecadd_LH_P3_1_4) _lh_vecadd_LH_P3_2_4)
                                  | _ -> 
                                    (failwith "error"))))))
                      else
                        (let rec spec_0 = (specularsurf_lh__d2 _lh_lightray_arg5_0) in
                          (let rec cosalpha_1 = ((vecdot_lh__d2 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1) in
                            (let rec diffcont_1 = (((vecscale_lh__d1_d4 diff_0) cosangle_0) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_1 = (if (cosalpha_1 <= 0.0) then
                                (let rec _lh_vecadd_LH_P3_2_5 = 0.0 in
                                  (let rec _lh_vecadd_LH_P3_1_5 = 0.0 in
                                    (let rec _lh_vecadd_LH_P3_0_5 = 0.0 in
                                      (fun _lh_vecadd_LH_P3_0_6 _lh_vecadd_LH_P3_1_6 _lh_vecadd_LH_P3_2_6 -> 
                                        (`LH_P3((_lh_vecadd_LH_P3_0_6 +. _lh_vecadd_LH_P3_0_5), (_lh_vecadd_LH_P3_1_6 +. _lh_vecadd_LH_P3_1_5), (_lh_vecadd_LH_P3_2_6 +. _lh_vecadd_LH_P3_2_5)))))))
                              else
                                (((vecscale_lh__d1_d2 spec_0) (cosalpha_1 ** spow_0)) _lh_lightray_LH_P2_1_0)) in
                                (diffcont_1 speccont_1))))))))))))
        else
                      ...
                      (if (cosangle_1 <= 0.0) then
                          ...
                          (let rec cosalpha_2 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3)) in
                            (let rec diffcont_2 = ((vecmult_lh__d5 ((vecscale_lh__d1_d1 diff_1) (0.0 -. cosangle_1))) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_2 = (if (cosalpha_2 <= 0.0) then
                                (let rec _lh_vecadd_LH_P3_2_7 = 0.0 in
                                  (let rec _lh_vecadd_LH_P3_1_7 = 0.0 in
                                    (let rec _lh_vecadd_LH_P3_0_7 = 0.0 in
                                ...
                                (((vecscale_lh__d1_d3 bodycol_1) (cosalpha_2 ** spow_1)) _lh_lightray_LH_P2_1_1)) in
                                (match diffcont_2 with
                                  | `LH_P3(_lh_vecadd_LH_P3_0_9, _lh_vecadd_LH_P3_1_9, _lh_vecadd_LH_P3_2_9) -> 
                                    (((speccont_2 _lh_vecadd_LH_P3_0_9) _lh_vecadd_LH_P3_1_9) _lh_vecadd_LH_P3_2_9)
                                  | _ -> 
                                    (failwith "error"))))))
                      else
                        (let rec spec_1 = (specularsurf_lh__d2 _lh_lightray_arg5_1) in
                          (let rec cosalpha_3 = ((vecdot_lh__d2 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3) in
                            (let rec diffcont_3 = (((vecscale_lh__d1_d4 diff_1) cosangle_1) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_3 = (if (cosalpha_3 <= 0.0) then
                                (let rec _lh_vecadd_LH_P3_2_1_0 = 0.0 in
                                  (let rec _lh_vecadd_LH_P3_1_1_0 = 0.0 in
                                    (let rec _lh_vecadd_LH_P3_0_1_0 = 0.0 in
                                      (fun _lh_vecadd_LH_P3_0_1_1 _lh_vecadd_LH_P3_1_1_1 _lh_vecadd_LH_P3_2_1_1 -> 
                                        (`LH_P3((_lh_vecadd_LH_P3_0_1_1 +. _lh_vecadd_LH_P3_0_1_0), (_lh_vecadd_LH_P3_1_1_1 +. _lh_vecadd_LH_P3_1_1_0), (_lh_vecadd_LH_P3_2_1_1 +. _lh_vecadd_LH_P3_2_1_0)))))))
                              else
                                (((vecscale_lh__d1_d2 spec_1) (cosalpha_3 ** spow_1)) _lh_lightray_LH_P2_1_1)) in
                                (diffcont_3 speccont_3)))))))))))))
      | _ -> 
        (failwith "error")));;
...
let rec reflectsurf_lh__d1 _lh_reflectsurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
...
let rec vecscale_lh__d9 _lh_vecscale_arg1_8 _lh_vecscale_arg2_9 =
  (match _lh_vecscale_arg1_8 with
    | `LH_P3(_lh_vecscale_LH_P3_0_8, _lh_vecscale_LH_P3_1_8, _lh_vecscale_LH_P3_2_8) -> 
      (let rec _lh_vecadd_LH_P3_2_2_8 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_2_8) in
        (let rec _lh_vecadd_LH_P3_1_2_8 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_1_8) in
          (let rec _lh_vecadd_LH_P3_0_2_8 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_0_8) in
            (fun _lh_vecadd_LH_P3_0_2_9 _lh_vecadd_LH_P3_1_2_9 _lh_vecadd_LH_P3_2_2_9 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_2_9 +. _lh_vecadd_LH_P3_0_2_8), (_lh_vecadd_LH_P3_1_2_9 +. _lh_vecadd_LH_P3_1_2_8), (_lh_vecadd_LH_P3_2_2_9 +. _lh_vecadd_LH_P3_2_2_8)))))))
    | _ -> 
      (failwith "error"));;
...
let rec refractsurf_lh__d1 _lh_refractsurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_9 -> 
...
let rec ambientsurf_lh__d1 _lh_ambientsurf_arg1_0 =
  (head_lh__d4 ((let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_6 -> 
...
let rec bodysurf_lh__d1 _lh_bodysurf_arg1_1 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_7 -> 
...
let rec vecscale_lh__d1_d0 _lh_vecscale_arg1_1_1 _lh_vecscale_arg2_1_2 =
  (match _lh_vecscale_arg1_1_1 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_1, _lh_vecscale_LH_P3_1_1_1, _lh_vecscale_LH_P3_2_1_1) -> 
      (let rec _lh_vecadd_LH_P3_2_3_3 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_2_1_1) in
        (let rec _lh_vecadd_LH_P3_1_3_3 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_1_1_1) in
          (let rec _lh_vecadd_LH_P3_0_3_3 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_0_1_1) in
...
let rec vecsum_lh__d1 _lh_vecsum_arg1_0 =
  ((_lh_vecsum_arg1_0 vecadd_lh__d1_d0) (`LH_P3(0.0, 0.0, 0.0)));;
let rec transmitsurf_lh__d1 _lh_transmitsurf_arg1_0 =
  (head_lh__d5 ((let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_1_1 -> 
...
let rec reflectray_lh__d1 _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
  (let rec newcontrib_4 = ((vecmult_lh__d5 _lh_reflectray_arg4_0) _lh_reflectray_arg5_0) in
    (let rec nearpos_4 = ((vecadd_lh__d1_d0 _lh_reflectray_arg1_0) ((vecscale_lh__d1_d5 _lh_reflectray_arg2_0) epsilon_lh__d1)) in
      (let rec _lh_matchIdent_3_7 = (let rec f_1_2 = (fun d1s1_5 d2s2_5 -> 
        (let rec _lh_matchIdent_3_8 = d1s1_5 in
          (match _lh_matchIdent_3_8 with
            | `LH_P2(_lh_trace_LH_P2_0_1_5, _lh_trace_LH_P2_1_1_5) -> 
              (let rec _lh_matchIdent_3_9 = d2s2_5 in
                (match _lh_matchIdent_3_9 with
                  | `LH_P2(_lh_trace_LH_P2_0_1_6, _lh_trace_LH_P2_1_1_6) -> 
                    (if (_lh_trace_LH_P2_0_1_5 < _lh_trace_LH_P2_0_1_6) then
                      (`LH_P2(_lh_trace_LH_P2_0_1_5, _lh_trace_LH_P2_1_1_5))
                    else
                      (`LH_P2(_lh_trace_LH_P2_0_1_6, _lh_trace_LH_P2_1_1_6)))
                  | _ -> 
            ...
            | _ -> 
              (failwith "error")))) in
        (let rec sphmap_5 = (fun xss_5 -> 
          (let rec _lh_matchIdent_4_0 = xss_5 in
            (match _lh_matchIdent_4_0 with
              | `LH_N -> 
                (`LH_N)
              | `LH_C(_lh_trace_LH_C_0_5, _lh_trace_LH_C_1_5) -> 
                (let rec _lh_matchIdent_4_1 = (((sphereintersect_lh__d1 nearpos_4) _lh_reflectray_arg2_0) _lh_trace_LH_C_0_5) in
                  (((_lh_matchIdent_4_1 _lh_trace_LH_C_0_5) _lh_trace_LH_C_1_5) sphmap_5))
              | _ -> 
                (failwith "error")))) in
          (let rec dists_5 = (sphmap_5 testspheres_lh__d1) in
            (if (null_lh__d1 dists_5) then
              (`LH_P3(false, infinity_lh__d1, (head_lh__d2 testspheres_lh__d1)))
            else
              (let rec _lh_matchIdent_4_2 = (((foldr_lh__d2 f_1_2) (head_lh__d1 dists_5)) (tail_lh__d1 dists_5)) in
                (match _lh_matchIdent_4_2 with
                  | `LH_P2(_lh_trace_LH_P2_0_1_7, _lh_trace_LH_P2_1_1_7) -> 
                    (`LH_P3(true, _lh_trace_LH_P2_0_1_7, _lh_trace_LH_P2_1_1_7))
                  | _ -> 
                    (failwith "error"))))))) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_0 = true in
                        (fun _lh_transmitray_arg1_0 _lh_transmitray_arg2_0 _lh_transmitray_arg3_0 _lh_transmitray_arg6_0 newcontrib_0 -> 
                          (let rec nearpos_0 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_0) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_0) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_7 = (let rec f_2 = (fun d1s1_1 d2s2_1 -> 
                              (let rec _lh_matchIdent_8 = d1s1_1 in
                                (match _lh_matchIdent_8 with
                                  | `LH_P2(_lh_trace_LH_P2_0_3, _lh_trace_LH_P2_1_3) -> 
                                    (let rec _lh_matchIdent_9 = d2s2_1 in
                                      (match _lh_matchIdent_9 with
                                        | `LH_P2(_lh_trace_LH_P2_0_4, _lh_trace_LH_P2_1_4) -> 
                                          (if (_lh_trace_LH_P2_0_3 < _lh_trace_LH_P2_0_4) then
                                            (`LH_P2(_lh_trace_LH_P2_0_3, _lh_trace_LH_P2_1_3))
                                          else
                                            (`LH_P2(_lh_trace_LH_P2_0_4, _lh_trace_LH_P2_1_4)))
                                        | _ -> 
                              ...
                              (let rec sphmap_1 = (fun xss_1 -> 
                                (let rec _lh_matchIdent_1_0 = xss_1 in
                                  (match _lh_matchIdent_1_0 with
                                    | `LH_N -> 
                                      (`LH_N)
                                    | `LH_C(_lh_trace_LH_C_0_1, _lh_trace_LH_C_1_1) -> 
                                      (let rec _lh_matchIdent_1_1 = (((sphereintersect_lh__d1 nearpos_0) _lh_transmitray_LH_P2_1_0) _lh_trace_LH_C_0_1) in
                                        (((_lh_matchIdent_1_1 _lh_trace_LH_C_0_1) _lh_trace_LH_C_1_1) sphmap_1))
                                    | _ -> 
                                      (failwith "error")))) in
                                (let rec dists_1 = (sphmap_1 testspheres_lh__d1) in
                                  (if (null_lh__d1 dists_1) then
                                    (`LH_P3(false, infinity_lh__d1, (head_lh__d2 testspheres_lh__d1)))
                                  else
                                    (let rec _lh_matchIdent_1_2 = (((foldr_lh__d2 f_2) (head_lh__d1 dists_1)) (tail_lh__d1 dists_1)) in
                                      (match _lh_matchIdent_1_2 with
                                        | `LH_P2(_lh_trace_LH_P2_0_5, _lh_trace_LH_P2_1_5) -> 
                                          (`LH_P3(true, _lh_trace_LH_P2_0_5, _lh_trace_LH_P2_1_5))
                                        | _ -> 
                                          (failwith "error"))))))) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_1 = false in
                        (fun _lh_transmitray_arg1_1 _lh_transmitray_arg2_1 _lh_transmitray_arg3_1 _lh_transmitray_arg6_1 newcontrib_1 -> 
                          (let rec nearpos_1 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_1) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_1) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_1_3 = (let rec f_3 = (fun d1s1_2 d2s2_2 -> 
                              (let rec _lh_matchIdent_1_4 = d1s1_2 in
                                (match _lh_matchIdent_1_4 with
                                  | `LH_P2(_lh_trace_LH_P2_0_6, _lh_trace_LH_P2_1_6) -> 
                                    (let rec _lh_matchIdent_1_5 = d2s2_2 in
                                      (match _lh_matchIdent_1_5 with
                                        | `LH_P2(_lh_trace_LH_P2_0_7, _lh_trace_LH_P2_1_7) -> 
                                          (if (_lh_trace_LH_P2_0_6 < _lh_trace_LH_P2_0_7) then
                                            (`LH_P2(_lh_trace_LH_P2_0_6, _lh_trace_LH_P2_1_6))
                                          else
                                            (`LH_P2(_lh_trace_LH_P2_0_7, _lh_trace_LH_P2_1_7)))
                                        | _ -> 
                              ...
                              (let rec sphmap_2 = (fun xss_2 -> 
                                (let rec _lh_matchIdent_1_6 = xss_2 in
                                  (match _lh_matchIdent_1_6 with
                                    | `LH_N -> 
                                      (`LH_N)
                                    | `LH_C(_lh_trace_LH_C_0_2, _lh_trace_LH_C_1_2) -> 
                                      (let rec _lh_matchIdent_1_7 = (((sphereintersect_lh__d1 nearpos_1) _lh_transmitray_LH_P2_1_1) _lh_trace_LH_C_0_2) in
                                        (((_lh_matchIdent_1_7 _lh_trace_LH_C_0_2) _lh_trace_LH_C_1_2) sphmap_2))
                                    | _ -> 
                                      (failwith "error")))) in
                                (let rec dists_2 = (sphmap_2 testspheres_lh__d1) in
                                  (if (null_lh__d1 dists_2) then
                                    (`LH_P3(false, infinity_lh__d1, (head_lh__d2 testspheres_lh__d1)))
                                  else
                                    (let rec _lh_matchIdent_1_8 = (((foldr_lh__d2 f_3) (head_lh__d1 dists_2)) (tail_lh__d1 dists_2)) in
                                      (match _lh_matchIdent_1_8 with
                                        | `LH_P2(_lh_trace_LH_P2_0_8, _lh_trace_LH_P2_1_8) -> 
                                          (`LH_P3(true, _lh_trace_LH_P2_0_8, _lh_trace_LH_P2_1_8))
                                        | _ -> 
                                          (failwith "error"))))))) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_2 = true in
                        (fun _lh_transmitray_arg1_2 _lh_transmitray_arg2_2 _lh_transmitray_arg3_2 _lh_transmitray_arg6_2 newcontrib_2 -> 
                          (let rec nearpos_2 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_2) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_2) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_1_9 = (let rec f_4 = (fun d1s1_3 d2s2_3 -> 
                              (let rec _lh_matchIdent_2_0 = d1s1_3 in
                                (match _lh_matchIdent_2_0 with
                                  | `LH_P2(_lh_trace_LH_P2_0_9, _lh_trace_LH_P2_1_9) -> 
                                    (let rec _lh_matchIdent_2_1 = d2s2_3 in
                                      (match _lh_matchIdent_2_1 with
                                        | `LH_P2(_lh_trace_LH_P2_0_1_0, _lh_trace_LH_P2_1_1_0) -> 
                                          (if (_lh_trace_LH_P2_0_9 < _lh_trace_LH_P2_0_1_0) then
                                            (`LH_P2(_lh_trace_LH_P2_0_9, _lh_trace_LH_P2_1_9))
                                          else
                                            (`LH_P2(_lh_trace_LH_P2_0_1_0, _lh_trace_LH_P2_1_1_0)))
                                        | _ -> 
                              ...
                              (let rec sphmap_3 = (fun xss_3 -> 
                                (let rec _lh_matchIdent_2_2 = xss_3 in
                                  (match _lh_matchIdent_2_2 with
                                    | `LH_N -> 
                                      (`LH_N)
                                    | `LH_C(_lh_trace_LH_C_0_3, _lh_trace_LH_C_1_3) -> 
                                      (let rec _lh_matchIdent_2_3 = (((sphereintersect_lh__d1 nearpos_2) _lh_transmitray_LH_P2_1_2) _lh_trace_LH_C_0_3) in
                                        (((_lh_matchIdent_2_3 _lh_trace_LH_C_0_3) _lh_trace_LH_C_1_3) sphmap_3))
                                    | _ -> 
                                      (failwith "error")))) in
                                (let rec dists_3 = (sphmap_3 testspheres_lh__d1) in
                                  (if (null_lh__d1 dists_3) then
                                    (`LH_P3(false, infinity_lh__d1, (head_lh__d2 testspheres_lh__d1)))
                                  else
                                    (let rec _lh_matchIdent_2_4 = (((foldr_lh__d2 f_4) (head_lh__d1 dists_3)) (tail_lh__d1 dists_3)) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_3 = false in
                        (fun _lh_transmitray_arg1_3 _lh_transmitray_arg2_3 _lh_transmitray_arg3_3 _lh_transmitray_arg6_3 newcontrib_3 -> 
                          (let rec nearpos_3 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_3) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_3) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_2_5 = (let rec f_5 = (fun d1s1_4 d2s2_4 -> 
                              (let rec _lh_matchIdent_2_6 = d1s1_4 in
                                (match _lh_matchIdent_2_6 with
                                  | `LH_P2(_lh_trace_LH_P2_0_1_2, _lh_trace_LH_P2_1_1_2) -> 
                                    (let rec _lh_matchIdent_2_7 = d2s2_4 in
                              ...
                              (let rec sphmap_4 = (fun xss_4 -> 
                                (let rec _lh_matchIdent_2_8 = xss_4 in
                                  (match _lh_matchIdent_2_8 with
                                    | `LH_N -> 
                                      (`LH_N)
                                    | `LH_C(_lh_trace_LH_C_0_4, _lh_trace_LH_C_1_4) -> 
                                      (let rec _lh_matchIdent_2_9 = (((sphereintersect_lh__d1 nearpos_3) _lh_transmitray_LH_P2_1_3) _lh_trace_LH_C_0_4) in
                                        (((_lh_matchIdent_2_9 _lh_trace_LH_C_0_4) _lh_trace_LH_C_1_4) sphmap_4))
                                    | _ -> 
                                      (failwith "error")))) in
                                (let rec dists_4 = (sphmap_4 testspheres_lh__d1) in
                                  (if (null_lh__d1 dists_4) then
                                    (`LH_P3(false, infinity_lh__d1, (head_lh__d2 testspheres_lh__d1)))
                                  else
                                    (let rec _lh_matchIdent_3_0 = (((foldr_lh__d2 f_5) (head_lh__d1 dists_4)) (tail_lh__d1 dists_4)) in
                                      (match _lh_matchIdent_3_0 with
                                        | `LH_P2(_lh_trace_LH_P2_0_1_4, _lh_trace_LH_P2_1_1_4) -> 
                                          (`LH_P3(true, _lh_trace_LH_P2_0_1_4, _lh_trace_LH_P2_1_1_4))
                                        | _ -> 
                                          (failwith "error"))))))) in
                              (match _lh_matchIdent_2_5 with
                                ...
                                | _ -> 
                                  (failwith "error"))))))))))))))) in
      (_lh_matchIdent_6 _lh_refractray_arg2_0)))
and
shade_lh__d1 _lh_shade_arg1_8 _lh_shade_arg2_0 _lh_shade_arg3_0 _lh_shade_arg4_0 _lh_shade_arg5_0 _lh_shade_arg6_8 =
  (let rec hitpos_8 = (match _lh_shade_arg3_0 with
    | `LH_P3(_lh_vecadd_LH_P3_0_2_4, _lh_vecadd_LH_P3_1_2_4, _lh_vecadd_LH_P3_2_2_4) -> 
      (((((vecscale_lh__d9 _lh_shade_arg4_0) _lh_shade_arg5_0) _lh_vecadd_LH_P3_0_2_4) _lh_vecadd_LH_P3_1_2_4) _lh_vecadd_LH_P3_2_2_4)
    | _ -> 
      (failwith "error")) in
          ...
          (fun _lh_vecmult_arg2_5 -> 
            (match _lh_vecmult_arg2_5 with
              | `LH_P3(_lh_vecmult_LH_P3_0_7, _lh_vecmult_LH_P3_1_7, _lh_vecmult_LH_P3_2_7) -> 
                (let rec _lh_vecadd_LH_P3_2_2_5 = (_lh_vecmult_LH_P3_2_6 *. _lh_vecmult_LH_P3_2_7) in
                  (let rec _lh_vecadd_LH_P3_1_2_5 = (_lh_vecmult_LH_P3_1_6 *. _lh_vecmult_LH_P3_1_7) in
                    (let rec _lh_vecadd_LH_P3_0_2_5 = (_lh_vecmult_LH_P3_0_6 *. _lh_vecmult_LH_P3_0_7) in
                      (fun _lh_vecadd_arg2_6 -> 
                        (match _lh_vecadd_arg2_6 with
                          | `LH_P3(_lh_vecadd_LH_P3_0_2_6, _lh_vecadd_LH_P3_1_2_6, _lh_vecadd_LH_P3_2_2_6) -> 
                            (`LH_P3((_lh_vecadd_LH_P3_0_2_5 +. _lh_vecadd_LH_P3_0_2_6), (_lh_vecadd_LH_P3_1_2_5 +. _lh_vecadd_LH_P3_1_2_6), (_lh_vecadd_LH_P3_2_2_5 +. _lh_vecadd_LH_P3_2_2_6)))
                          | _ -> 
                            (failwith "error"))))))
              | _ -> 
                (failwith "error")))))) in
      (let rec surf_8 = (spheresurf_lh__d1 _lh_shade_arg2_0) in
        (let rec amb_0 = (ambientlight_0 (ambientsurf_lh__d1 surf_8)) in
          (let rec norm_0 = ((spherenormal_lh__d1 hitpos_8) _lh_shade_arg2_0) in
            (let rec refl_8 = (match _lh_shade_arg4_0 with
              | `LH_P3(_lh_vecadd_LH_P3_0_2_7, _lh_vecadd_LH_P3_1_2_7, _lh_vecadd_LH_P3_2_2_7) -> 
                (((((vecscale_lh__d1_d0 norm_0) ((0.0 -. 2.0) *. ((vecdot_lh__d1 _lh_shade_arg4_0) norm_0))) _lh_vecadd_LH_P3_0_2_7) _lh_vecadd_LH_P3_1_2_7) _lh_vecadd_LH_P3_2_2_7)
              | _ -> 
                (failwith "error")) in
              (let rec diff_2 = (vecsum_lh__d1 (_lh_shade_arg1_8 (fun l_0 -> 
                (let rec _lh_matchIdent_4_3 = ((lightdirection_lh__d1 l_0) hitpos_8) in
                  (match _lh_matchIdent_4_3 with
                    | `LH_P2(_lh_lightray_LH_P2_0_5, _lh_lightray_LH_P2_1_3) -> 
                      (let rec cosangle_3 = ((vecdot_lh__d4 _lh_lightray_LH_P2_0_5) norm_0) in
                        (let rec _lh_matchIdent_4_4 = (((shadowed_lh__d1 hitpos_8) _lh_lightray_LH_P2_0_5) (lightcolour_lh__d1 l_0)) in
                          ((((_lh_matchIdent_4_4 _lh_lightray_LH_P2_0_5) refl_8) surf_8) cosangle_3)))
                    | _ -> 
                      (failwith "error")))))) in
                (let rec transmitted_0 = (transmitsurf_lh__d1 surf_8) in
                  (let rec simple_0 = (amb_0 diff_2) in
                    (let rec trintensity_8 = ((vecscale_lh__d8 (bodysurf_lh__d1 surf_8)) transmitted_0) in
                      (let rec _lh_matchIdent_4_5 = (if (transmitted_0 < epsilon_lh__d1) then
                        ...
                        ((((((_lh_matchIdent_4_5 _lh_shade_arg1_8) _lh_shade_arg6_8) hitpos_8) refl_8) surf_8) trintensity_8))))))))))))
and
transmitray_lh__d1 _lh_transmitray_arg1_4 _lh_transmitray_arg2_4 _lh_transmitray_arg3_4 _lh_transmitray_arg4_0 _lh_transmitray_arg5_0 _lh_transmitray_arg6_4 _lh_transmitray_arg7_0 _lh_transmitray_arg8_0 =
  (let rec newcontrib_5 = ((vecmult_lh__d5 _lh_transmitray_arg6_4) _lh_transmitray_arg7_0) in
    (let rec _lh_matchIdent_6_2 = (((refractray_lh__d1 _lh_transmitray_arg5_0) _lh_transmitray_arg4_0) _lh_transmitray_arg8_0) in
      (((((_lh_matchIdent_6_2 _lh_transmitray_arg1_4) _lh_transmitray_arg2_4) _lh_transmitray_arg3_4) _lh_transmitray_arg6_4) newcontrib_5)));;
...
let rec vecscale_lh__d6 _lh_vecscale_arg1_1_3 _lh_vecscale_arg2_1_4 =
  (match _lh_vecscale_arg1_1_3 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_3, _lh_vecscale_LH_P3_1_1_3, _lh_vecscale_LH_P3_2_1_3) -> 
      (let rec _lh_vecadd_LH_P3_2_3_6 = (_lh_vecscale_arg2_1_4 *. _lh_vecscale_LH_P3_2_1_3) in
        (let rec _lh_vecadd_LH_P3_1_3_6 = (_lh_vecscale_arg2_1_4 *. _lh_vecscale_LH_P3_1_1_3) in
          (let rec _lh_vecadd_LH_P3_0_3_6 = (_lh_vecscale_arg2_1_4 *. _lh_vecscale_LH_P3_0_1_3) in
            (fun _lh_vecadd_LH_P3_0_3_7 _lh_vecadd_LH_P3_1_3_7 _lh_vecadd_LH_P3_2_3_7 -> 
              (let rec _lh_vecadd_LH_P3_2_3_8 = (_lh_vecadd_LH_P3_2_3_7 +. _lh_vecadd_LH_P3_2_3_6) in
                (let rec _lh_vecadd_LH_P3_1_3_8 = (_lh_vecadd_LH_P3_1_3_7 +. _lh_vecadd_LH_P3_1_3_6) in
                  (let rec _lh_vecadd_LH_P3_0_3_8 = (_lh_vecadd_LH_P3_0_3_7 +. _lh_vecadd_LH_P3_0_3_6) in
                    (fun _lh_vecadd_arg2_1_4 -> 
                      (((_lh_vecadd_arg2_1_4 _lh_vecadd_LH_P3_0_3_8) _lh_vecadd_LH_P3_1_3_8) _lh_vecadd_LH_P3_2_3_8)))))))))
    | _ -> 
      (failwith "error"));;
let rec tracepixel_lh__d1 _lh_tracepixel_arg1_0 _lh_tracepixel_arg2_0 _lh_tracepixel_arg3_0 _lh_tracepixel_arg4_0 _lh_tracepixel_arg5_0 _lh_tracepixel_arg6_0 _lh_tracepixel_arg7_0 =
  (let rec pos_0 = lookfrom_lh__d2 in
    (let rec _lh_matchIdent_4_9 = (vecnorm_lh__d4 ((_lh_tracepixel_arg5_0 ((vecscale_lh__d6 _lh_tracepixel_arg6_0) _lh_tracepixel_arg3_0)) ((vecscale_lh__d5 _lh_tracepixel_arg7_0) _lh_tracepixel_arg4_0))) in
      (match _lh_matchIdent_4_9 with
        | `LH_P2(_lh_tracepixel_LH_P2_0_0, _lh_tracepixel_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_5_0 = (let rec f_2_0 = (fun d1s1_6 d2s2_6 -> 
            (let rec _lh_matchIdent_5_1 = d1s1_6 in
              (match _lh_matchIdent_5_1 with
                | `LH_P2(_lh_trace_LH_P2_0_1_8, _lh_trace_LH_P2_1_1_8) -> 
                  (let rec _lh_matchIdent_5_2 = d2s2_6 in
                    (match _lh_matchIdent_5_2 with
                      | `LH_P2(_lh_trace_LH_P2_0_1_9, _lh_trace_LH_P2_1_1_9) -> 
                        (if (_lh_trace_LH_P2_0_1_8 < _lh_trace_LH_P2_0_1_9) then
                          (`LH_P2(_lh_trace_LH_P2_0_1_8, _lh_trace_LH_P2_1_1_8))
                        else
                          (`LH_P2(_lh_trace_LH_P2_0_1_9, _lh_trace_LH_P2_1_1_9)))
                      | _ -> 
                ...
                | _ -> 
                  (failwith "error")))) in
            (let rec sphmap_6 = (fun xss_6 -> 
              (let rec _lh_matchIdent_5_3 = xss_6 in
                (match _lh_matchIdent_5_3 with
                  | `LH_N -> 
                    (`LH_N)
                  | `LH_C(_lh_trace_LH_C_0_6, _lh_trace_LH_C_1_6) -> 
                    (let rec _lh_matchIdent_5_4 = (((sphereintersect_lh__d1 pos_0) _lh_tracepixel_LH_P2_0_0) _lh_trace_LH_C_0_6) in
                      (((_lh_matchIdent_5_4 _lh_trace_LH_C_0_6) _lh_trace_LH_C_1_6) sphmap_6))
                  | _ -> 
                    (failwith "error")))) in
              (let rec dists_6 = (sphmap_6 _lh_tracepixel_arg1_0) in
                (if (null_lh__d1 dists_6) then
                  (`LH_P3(false, infinity_lh__d1, (head_lh__d2 _lh_tracepixel_arg1_0)))
                else
                  (let rec _lh_matchIdent_5_5 = (((foldr_lh__d2 f_2_0) (head_lh__d1 dists_6)) (tail_lh__d1 dists_6)) in
                    (match _lh_matchIdent_5_5 with
                      | `LH_P2(_lh_trace_LH_P2_0_2_0, _lh_trace_LH_P2_1_2_0) -> 
                        (`LH_P3(true, _lh_trace_LH_P2_0_2_0, _lh_trace_LH_P2_1_2_0))
                      | _ -> 
                        (failwith "error"))))))) in
...
let rec vecscale_lh__d1 _lh_vecscale_arg1_1_2 _lh_vecscale_arg2_1_3 =
  (match _lh_vecscale_arg1_1_2 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_2, _lh_vecscale_LH_P3_1_1_2, _lh_vecscale_LH_P3_2_1_2) -> 
      (let rec _lh_vecadd_LH_P3_2_3_5 = (_lh_vecscale_arg2_1_3 *. _lh_vecscale_LH_P3_2_1_2) in
        (let rec _lh_vecadd_LH_P3_1_3_5 = (_lh_vecscale_arg2_1_3 *. _lh_vecscale_LH_P3_1_1_2) in
          (let rec _lh_vecadd_LH_P3_0_3_5 = (_lh_vecscale_arg2_1_3 *. _lh_vecscale_LH_P3_0_1_2) in
            (fun _lh_vecadd_arg2_1_3 -> 
              (((_lh_vecadd_arg2_1_3 _lh_vecadd_LH_P3_0_3_5) _lh_vecadd_LH_P3_1_3_5) _lh_vecadd_LH_P3_2_3_5)))))
    | _ -> 
      (failwith "error"));;
                                  ...
                                  (let rec magx_0 = (((2.0 *. _lh_camparams_LH_P2_1_1) *. (tan (dtor_lh__d2 (xfov_0 /. 2.0)))) /. xwinsize_0) in
                                    (let rec magy_0 = (((2.0 *. _lh_camparams_LH_P2_1_1) *. (tan (dtor_lh__d1 (yfov_0 /. 2.0)))) /. ywinsize_0) in
                                      (let rec scrnx_0 = ((vecscale_lh__d2 _lh_camparams_LH_P2_0_1) magx_0) in
                                        (let rec scrny_0 = (_lh_camparams_LH_P2_0_0 magy_0) in
                                          (let rec firstray_0 = (match initfirstray_0 with
                                            | `LH_P3(_lh_vecsub_LH_P3_0_0, _lh_vecsub_LH_P3_1_0, _lh_vecsub_LH_P3_2_0) -> 
                                              ((((((vecscale_lh__d1 scrnx_0) (0.5 *. xwinsize_0)) ((vecscale_lh__d3 scrny_0) (0.5 *. ywinsize_0))) _lh_vecsub_LH_P3_0_0) _lh_vecsub_LH_P3_1_0) _lh_vecsub_LH_P3_2_0)
                                            | _ -> 
                                              (failwith "error")) in
                    ...
                    (let rec _lh_camparams_LH_P2_1_2 = len_1 in
                      (let rec _lh_camparams_LH_P2_0_2 = (`LH_P3((_lh_vecnorm_LH_P3_0_1 /. len_1), (_lh_vecnorm_LH_P3_1_1 /. len_1), (_lh_vecnorm_LH_P3_2_1 /. len_1))) in
                        (fun _lh_camparams_LH_P2_0_3 _lh_camparams_LH_P2_1_3 _lh_camparams_arg4_1 _lh_camparams_arg5_1 initfirstray_1 -> 
                          (let rec _lh_matchIdent_3_1 = (((veccross_lh__d2 _lh_camparams_LH_P2_0_2) _lh_camparams_LH_P2_0_3) 99) in
                            (((((_lh_matchIdent_3_1 _lh_camparams_LH_P2_0_2) _lh_camparams_LH_P2_1_3) _lh_camparams_arg4_1) _lh_camparams_arg5_1) initfirstray_1))))))))))))));;
      ...
      (let rec len_2 = (sqrt (((_lh_vecnorm_LH_P3_0_2 *. _lh_vecnorm_LH_P3_0_2) +. (_lh_vecnorm_LH_P3_1_2 *. _lh_vecnorm_LH_P3_1_2)) +. (_lh_vecnorm_LH_P3_2_2 *. _lh_vecnorm_LH_P3_2_2))) in
        (let rec _lh_camparams_LH_P2_1_4 = len_2 in
          (let rec _lh_camparams_LH_P2_0_4 = (`LH_P3((_lh_vecnorm_LH_P3_0_2 /. len_2), (_lh_vecnorm_LH_P3_1_2 /. len_2), (_lh_vecnorm_LH_P3_2_2 /. len_2))) in
            (fun _lh_camparams_arg3_1 _lh_camparams_arg4_3 _lh_camparams_arg5_3 initfirstray_4 -> 
              (let rec _lh_matchIdent_4_6 = ((match _lh_camparams_LH_P2_0_4 with
                | `LH_P3(_lh_veccross_LH_P3_0_4, _lh_veccross_LH_P3_1_4, _lh_veccross_LH_P3_2_4) -> 
                  (((_lh_camparams_arg3_1 _lh_veccross_LH_P3_0_4) _lh_veccross_LH_P3_1_4) _lh_veccross_LH_P3_2_4)
                | _ -> 
                  (failwith "error")) 99) in
                (((((_lh_matchIdent_4_6 _lh_camparams_LH_P2_0_4) _lh_camparams_LH_P2_1_4) _lh_camparams_arg4_3) _lh_camparams_arg5_3) initfirstray_4))))))
    | _ -> 
      (failwith "error"));;
...
let rec testlights_lh__d1 =
  (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (fun f_2_2 f_2_3 i_6 -> 
    i_6) in
    (let rec h_1_9 = (`Point((`LH_P3((0.0 -. 3.0), 1.0, 5.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_2_4 -> 
        (let rec t_2_4 = (t_2_3 f_2_4) in
          (let rec h_2_0 = (f_2_4 h_1_9) in
            (fun f_2_5 i_7 -> 
              ((f_2_5 h_2_0) ((t_2_4 f_2_5) i_7)))))))) in
    (let rec h_2_1 = (`Point((`LH_P3(1.0, (0.0 -. 4.0), 4.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_2_6 -> 
        (let rec t_2_5 = (t_2_2 f_2_6) in
          (let rec h_2_2 = (f_2_6 h_2_1) in
            (fun f_2_7 i_8 -> 
              ((f_2_7 h_2_2) ((t_2_5 f_2_7) i_8)))))))) in
    (let rec h_2_3 = (`Point((`LH_P3(4.0, 3.0, 2.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_2_8 -> 
        (let rec t_2_6 = (t_2_1 f_2_8) in
          (let rec h_2_4 = (f_2_8 h_2_3) in
            (fun f_2_9 i_9 -> 
              ((f_2_9 h_2_4) ((t_2_6 f_2_9) i_9))))))));;
let rec fov_lh__d1 =
  45.0;;
let rec hash_lh__d1 _lh_hash_arg1_0 =
  (let rec u8_0 = (fun x_0 -> 
    ...
    ((_lh_hash_arg1_0 (fun rgb_0 acc_0 -> 
      (let rec _lh_matchIdent_6_1 = rgb_0 in
...
let rec run_lh__d1 _lh_run_arg1_0 =
  (hash_lh__d1 ((let rec lights_1 = testlights_lh__d1 in
    (let rec _lh_matchIdent_3_2 = (let rec initfirstray_2 = ((vecsub_lh__d2 lookat_lh__d1) lookfrom_lh__d1) in
      (let rec _lh_matchIdent_3_3 = (vecnorm_lh__d2 initfirstray_2) in
        ((((_lh_matchIdent_3_3 vup_lh__d1) fov_lh__d1) (float_of_int _lh_run_arg1_0)) initfirstray_2))) in
      ((_lh_matchIdent_3_2 _lh_run_arg1_0) lights_1))) snd_lh__d1));;

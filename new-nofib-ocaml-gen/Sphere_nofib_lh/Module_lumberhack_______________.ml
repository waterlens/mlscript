...
let rec enumFromTo_lh__d2 a_0 b_0 =
  (if (a_0 <= b_0) then
    ...
    (fun _lh_listcomp_fun_ls_h_6 _lh_listcomp_fun_7 f_4 _lh_listcomp_fun_ls_t_6 _lh_listcomp_fun_8 -> 
  ...
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_9 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_9 = a_1 in
        (fun _lh_listcomp_fun_1_1 _lh_ray_arg1_2 f_1_0 -> 
          (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_7 -> 
            (((((_lh_listcomp_fun_para_7 _lh_listcomp_fun_ls_h_9) _lh_listcomp_fun_1_2) f_1_0) _lh_listcomp_fun_ls_t_9) _lh_listcomp_fun_1_1)) in
            (_lh_listcomp_fun_1_2 ((enumFromTo_lh__d2 0) (_lh_ray_arg1_2 - 1)))))))
  else
    (fun _lh_listcomp_fun_1_3 _lh_ray_arg1_3 f_1_1 f_1_2 f_1_3 i_5 -> 
      i_5));;

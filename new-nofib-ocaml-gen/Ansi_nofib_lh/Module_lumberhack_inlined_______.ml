...
let rec goto_lh__d2 _lh_goto_arg1_4 _lh_goto_arg2_4 =
  (let rec t_6_8 = (let rec t_6_9 = ((mappend_lh__d1_d5 (string_of_int _lh_goto_arg2_4)) ((mappend_lh__d1_d6 (`LH_C(';', (string_of_int _lh_goto_arg1_4)))) (let rec t_7_0 = (fun ys_6_8 -> 
    ...
    (let rec h_6_8 = 'H' in
      (fun ys_6_9 -> 
        (`LH_C(h_6_8, (t_7_0 ys_6_9)))))))) in
    (let rec h_6_9 = '[' in
      (fun ys_7_0 -> 
        (`LH_C(h_6_9, (t_6_9 ys_7_0)))))) in
    (let rec h_7_0 = 'E' in
      (fun ys_7_1 -> 
        (`LH_C(h_7_0, (t_6_8 ys_7_1))))));;
...
let rec goto_lh__d1 _lh_goto_arg1_1 _lh_goto_arg2_1 =
  (let rec t_5_7 = (let rec t_5_8 = ((mappend_lh__d1_d3 (string_of_int _lh_goto_arg2_1)) ((mappend_lh__d1_d4 (`LH_C(';', (string_of_int _lh_goto_arg1_1)))) (let rec t_5_9 = (fun ys_5_1 -> 
    ...
    (let rec h_5_7 = 'H' in
      (fun ys_5_2 -> 
        (`LH_C(h_5_7, (t_5_9 ys_5_2)))))))) in
    (let rec h_5_8 = '[' in
      (fun ys_5_3 -> 
        (`LH_C(h_5_8, (t_5_8 ys_5_3)))))) in
    (let rec h_5_9 = 'E' in
      (fun ys_5_4 -> 
        (`LH_C(h_5_9, (t_5_7 ys_5_4))))));;
...
let rec goto_lh__d3 _lh_goto_arg1_6 _lh_goto_arg2_6 =
  (let rec t_9_3 = (let rec t_9_4 = ((mappend_lh__d1_d7 (string_of_int _lh_goto_arg2_6)) ((mappend_lh__d1_d8 (`LH_C(';', (string_of_int _lh_goto_arg1_6)))) (let rec t_9_5 = (fun ys_9_6 -> 
    ...
    (let rec h_9_3 = 'H' in
      (fun ys_9_7 -> 
        (`LH_C(h_9_3, (t_9_5 ys_9_7)))))))) in
    (let rec h_9_4 = '[' in
      (fun ys_9_8 -> 
        (`LH_C(h_9_4, (t_9_4 ys_9_8)))))) in
    (let rec h_9_5 = 'E' in
      (fun ys_9_9 -> 
        (`LH_C(h_9_5, (t_9_3 ys_9_9))))));;

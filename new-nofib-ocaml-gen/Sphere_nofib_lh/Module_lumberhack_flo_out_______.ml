  ...
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_8 = a_1 in
        (fun _lh_listcomp_fun_ls_h_9 _lh_listcomp_fun_1_1 f_9 _lh_listcomp_fun_ls_t_9 _lh_listcomp_fun_1_2 -> 
          (let rec t_1_2 = (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_8) in
            (let rec h_1_0 = (let rec _lh_snd_LH_P2_1_0 = ((f_9 _lh_listcomp_fun_ls_h_9) _lh_listcomp_fun_ls_h_8) in
              (let rec _lh_snd_LH_P2_0_0 = (`LH_P2(_lh_listcomp_fun_ls_h_9, _lh_listcomp_fun_ls_h_8)) in
                _lh_snd_LH_P2_1_0)) in
              (fun f_1_0 -> 
                (let rec t_1_3 = (t_1_2 f_1_0) in
                  (let rec h_1_1 = (f_1_0 h_1_0) in
                    (fun f_1_1 i_4 -> 
                      ((f_1_1 h_1_1) ((t_1_3 f_1_1) i_4)))))))))))
  else
    (fun _lh_listcomp_fun_ls_h_1_0 _lh_listcomp_fun_1_3 f_1_2 _lh_listcomp_fun_ls_t_1_0 _lh_listcomp_fun_1_4 -> 
  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_0 in
        (fun _lh_listcomp_fun_6 _lh_ray_arg1_1 f_1 -> 
          (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_6 -> 
            (((((_lh_listcomp_fun_para_6 _lh_listcomp_fun_ls_h_5) _lh_listcomp_fun_7) f_1) _lh_listcomp_fun_ls_t_5) _lh_listcomp_fun_6)) in
            (_lh_listcomp_fun_7 ((enumFromTo_lh__d1 0) (_lh_ray_arg1_1 - 1)))))))
  else
    (fun _lh_listcomp_fun_8 _lh_ray_arg1_2 f_2 f_3 f_4 i_1 -> 
      i_1));;
let rec pi_lh__d2 =
  3.141592653589793;;
...
let rec reflectsurf_lh__d1 _lh_reflectsurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
...
let rec vecscale_lh__d9 _lh_vecscale_arg1_8 _lh_vecscale_arg2_9 =
  (match _lh_vecscale_arg1_8 with
    | `LH_P3(_lh_vecscale_LH_P3_0_8, _lh_vecscale_LH_P3_1_8, _lh_vecscale_LH_P3_2_8) -> 
      (let rec _lh_vecadd_LH_P3_2_2_7 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_2_8) in
        (let rec _lh_vecadd_LH_P3_1_2_7 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_1_8) in
          (let rec _lh_vecadd_LH_P3_0_2_7 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_0_8) in
            (fun _lh_vecadd_LH_P3_0_2_8 _lh_vecadd_LH_P3_1_2_8 _lh_vecadd_LH_P3_2_2_8 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_2_8 +. _lh_vecadd_LH_P3_0_2_7), (_lh_vecadd_LH_P3_1_2_8 +. _lh_vecadd_LH_P3_1_2_7), (_lh_vecadd_LH_P3_2_2_8 +. _lh_vecadd_LH_P3_2_2_7)))))))
    | _ -> 
      (failwith "error"));;
    ...
    | `LH_P3(_lh_vecsub_LH_P3_0_1, _lh_vecsub_LH_P3_1_1, _lh_vecsub_LH_P3_2_1) -> 
      (match _lh_vecsub_arg2_1 with
        | `LH_P3(_lh_vecsub_LH_P3_0_2, _lh_vecsub_LH_P3_1_2, _lh_vecsub_LH_P3_2_2) -> 
          (`LH_P3((_lh_vecsub_LH_P3_0_1 -. _lh_vecsub_LH_P3_0_2), (_lh_vecsub_LH_P3_1_1 -. _lh_vecsub_LH_P3_1_2), (_lh_vecsub_LH_P3_2_1 -. _lh_vecsub_LH_P3_2_2)))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
...
let rec trace_lh__d2 _lh_trace_arg1_1 _lh_trace_arg2_1 _lh_trace_arg3_1 =
  (let rec f_1_4 = (fun d1s1_1 d2s2_1 -> 
    ...
    (let rec sphmap_1 = (fun xss_1 -> 
      (let rec _lh_matchIdent_3_2 = xss_1 in
        (match _lh_matchIdent_3_2 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_1, _lh_trace_LH_C_1_1) -> 
            (let rec _lh_matchIdent_3_3 = (((sphereintersect_lh__d1 _lh_trace_arg2_1) _lh_trace_arg3_1) _lh_trace_LH_C_0_1) in
      ...
      (let rec dists_1 = (sphmap_1 _lh_trace_arg1_1) in
        (if (null_lh__d1 dists_1) then
          ...
          (let rec _lh_matchIdent_3_4 = (((foldr_lh__d2 f_1_4) (head_lh__d3 dists_1)) (tail_lh__d1 dists_1)) in
  ...
  (match _lh_vecadd_arg1_1_0 with
    | `LH_P3(_lh_vecadd_LH_P3_0_3_3, _lh_vecadd_LH_P3_1_3_3, _lh_vecadd_LH_P3_2_3_3) -> 
      (match _lh_vecadd_arg2_1_6 with
        | `LH_P3(_lh_vecadd_LH_P3_0_3_4, _lh_vecadd_LH_P3_1_3_4, _lh_vecadd_LH_P3_2_3_4) -> 
          (`LH_P3((_lh_vecadd_LH_P3_0_3_3 +. _lh_vecadd_LH_P3_0_3_4), (_lh_vecadd_LH_P3_1_3_3 +. _lh_vecadd_LH_P3_1_3_4), (_lh_vecadd_LH_P3_2_3_3 +. _lh_vecadd_LH_P3_2_3_4)))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
...
let rec bodysurf_lh__d2 _lh_bodysurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
...
let rec specpowsurf_lh__d1 _lh_specpowsurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
...
let rec specularsurf_lh__d2 _lh_specularsurf_arg1_1 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_1_0 -> 
            ...
            (fun _lh_vecmult_arg2_9 -> 
              (match _lh_vecmult_arg2_9 with
                | `LH_P3(_lh_vecmult_LH_P3_0_1_1, _lh_vecmult_LH_P3_1_1_1, _lh_vecmult_LH_P3_2_1_1) -> 
                  (let rec _lh_vecadd_LH_P3_2_3_7 = (_lh_vecmult_LH_P3_2_1_0 *. _lh_vecmult_LH_P3_2_1_1) in
                    (let rec _lh_vecadd_LH_P3_1_3_7 = (_lh_vecmult_LH_P3_1_1_0 *. _lh_vecmult_LH_P3_1_1_1) in
                      (let rec _lh_vecadd_LH_P3_0_3_7 = (_lh_vecmult_LH_P3_0_1_0 *. _lh_vecmult_LH_P3_0_1_1) in
                        (fun _lh_vecadd_LH_P3_0_3_8 _lh_vecadd_LH_P3_1_3_8 _lh_vecadd_LH_P3_2_3_8 -> 
                          (`LH_P3((_lh_vecadd_LH_P3_0_3_8 +. _lh_vecadd_LH_P3_0_3_7), (_lh_vecadd_LH_P3_1_3_8 +. _lh_vecadd_LH_P3_1_3_7), (_lh_vecadd_LH_P3_2_3_8 +. _lh_vecadd_LH_P3_2_3_7)))))))
                | _ -> 
                  (failwith "error"))))))
    | _ -> 
      (failwith "error"));;
...
let rec diffusesurf_lh__d1 _lh_diffusesurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
...
let rec shadowed_lh__d1 _lh_shadowed_arg1_0 _lh_shadowed_arg2_0 _lh_shadowed_arg3_0 =
  (let rec _lh_matchIdent_2 = (((trace_lh__d2 testspheres_lh__d1) ((vecadd_lh__d1_d1 _lh_shadowed_arg1_0) ((vecscale_lh__d1_d4 _lh_shadowed_arg2_0) epsilon_lh__d1))) _lh_shadowed_arg2_0) in
                      ...
                      (if (cosangle_0 <= 0.0) then
                          ...
                          (let rec cosalpha_0 = (0.0 -. ((vecdot_lh__d6 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1)) in
                            (let rec diffcont_0 = ((vecmult_lh__d4 ((vecscale_lh__d1_d4 diff_0) (0.0 -. cosangle_0))) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_0 = (if (cosalpha_0 <= 0.0) then
                                ...
                                (((vecscale_lh__d1_d2 bodycol_0) (cosalpha_0 ** spow_0)) _lh_lightray_LH_P2_1_0)) in
                                (diffcont_0 speccont_0)))))
                      else
                        (let rec spec_0 = (specularsurf_lh__d2 _lh_lightray_arg5_0) in
                          (let rec cosalpha_1 = ((vecdot_lh__d4 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1) in
                            (let rec diffcont_1 = (((vecscale_lh__d1_d3 diff_0) cosangle_0) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_1 = (if (cosalpha_1 <= 0.0) then
                                ...
                                (((vecscale_lh__d1_d1 spec_0) (cosalpha_1 ** spow_0)) _lh_lightray_LH_P2_1_0)) in
                      ...
                      (if (cosangle_1 <= 0.0) then
                          ...
                          (let rec cosalpha_2 = (0.0 -. ((vecdot_lh__d6 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3)) in
                            (let rec diffcont_2 = ((vecmult_lh__d4 ((vecscale_lh__d1_d4 diff_1) (0.0 -. cosangle_1))) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_2 = (if (cosalpha_2 <= 0.0) then
                                ...
                                (((vecscale_lh__d1_d2 bodycol_1) (cosalpha_2 ** spow_1)) _lh_lightray_LH_P2_1_1)) in
                                (diffcont_2 speccont_2)))))
                      else
                        (let rec spec_1 = (specularsurf_lh__d2 _lh_lightray_arg5_1) in
                          (let rec cosalpha_3 = ((vecdot_lh__d4 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3) in
                            (let rec diffcont_3 = (((vecscale_lh__d1_d3 diff_1) cosangle_1) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_3 = (if (cosalpha_3 <= 0.0) then
                                ...
                                (((vecscale_lh__d1_d1 spec_1) (cosalpha_3 ** spow_1)) _lh_lightray_LH_P2_1_1)) in
                                (diffcont_3 speccont_3)))))))))))))
      | _ -> 
        (failwith "error")));;
let rec ambientsurf_lh__d1 _lh_ambientsurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_7 -> 
...
let rec bodysurf_lh__d1 _lh_bodysurf_arg1_1 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_8 -> 
...
let rec transmitsurf_lh__d1 _lh_transmitsurf_arg1_0 =
  (head_lh__d3 ((let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_1_1 -> 
...
let rec reflectray_lh__d1 _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
  (let rec newcontrib_4 = ((vecmult_lh__d6 _lh_reflectray_arg4_0) _lh_reflectray_arg5_0) in
    (let rec nearpos_4 = ((vecadd_lh__d1_d1 _lh_reflectray_arg1_0) ((vecscale_lh__d1_d4 _lh_reflectray_arg2_0) epsilon_lh__d1)) in
      (let rec _lh_matchIdent_1_4 = (((trace_lh__d2 testspheres_lh__d1) nearpos_4) _lh_reflectray_arg2_0) in
...
refractray_lh__d1 _lh_refractray_arg1_0 _lh_refractray_arg2_0 _lh_refractray_arg3_0 =
  (let rec dotp_0 = (0.0 -. ((vecdot_lh__d6 _lh_refractray_arg2_0) _lh_refractray_arg3_0)) in
    (let rec _lh_matchIdent_3 = (if (dotp_0 < 0.0) then
                      ...
                      (let rec _lh_transmitray_LH_P2_0_0 = true in
                        (fun _lh_transmitray_arg1_0 _lh_transmitray_arg2_0 _lh_transmitray_arg3_0 _lh_transmitray_arg6_0 newcontrib_0 -> 
                          (let rec nearpos_0 = ((vecadd_lh__d1_d1 _lh_transmitray_arg3_0) ((vecscale_lh__d1_d4 _lh_transmitray_LH_P2_1_0) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_4 = (((trace_lh__d2 testspheres_lh__d1) nearpos_0) _lh_transmitray_LH_P2_1_0) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_1 = false in
                        (fun _lh_transmitray_arg1_1 _lh_transmitray_arg2_1 _lh_transmitray_arg3_1 _lh_transmitray_arg6_1 newcontrib_1 -> 
                          (let rec nearpos_1 = ((vecadd_lh__d1_d1 _lh_transmitray_arg3_1) ((vecscale_lh__d1_d4 _lh_transmitray_LH_P2_1_1) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_5 = (((trace_lh__d2 testspheres_lh__d1) nearpos_1) _lh_transmitray_LH_P2_1_1) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_2 = true in
                        (fun _lh_transmitray_arg1_2 _lh_transmitray_arg2_2 _lh_transmitray_arg3_2 _lh_transmitray_arg6_2 newcontrib_2 -> 
                          (let rec nearpos_2 = ((vecadd_lh__d1_d1 _lh_transmitray_arg3_2) ((vecscale_lh__d1_d4 _lh_transmitray_LH_P2_1_2) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_6 = (((trace_lh__d2 testspheres_lh__d1) nearpos_2) _lh_transmitray_LH_P2_1_2) in
                      ...
                      (let rec _lh_transmitray_LH_P2_0_3 = false in
                        (fun _lh_transmitray_arg1_3 _lh_transmitray_arg2_3 _lh_transmitray_arg3_3 _lh_transmitray_arg6_3 newcontrib_3 -> 
                          (let rec nearpos_3 = ((vecadd_lh__d1_d1 _lh_transmitray_arg3_3) ((vecscale_lh__d1_d4 _lh_transmitray_LH_P2_1_3) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_7 = (((trace_lh__d2 testspheres_lh__d1) nearpos_3) _lh_transmitray_LH_P2_1_3) in
                              (match _lh_matchIdent_7 with
                                ...
                                | _ -> 
                                  (failwith "error"))))))))))))))) in
      (_lh_matchIdent_3 _lh_refractray_arg2_0)))
and
shade_lh__d1 _lh_shade_arg1_8 _lh_shade_arg2_0 _lh_shade_arg3_0 _lh_shade_arg4_0 _lh_shade_arg5_0 _lh_shade_arg6_8 =
  (let rec hitpos_8 = (match _lh_shade_arg3_0 with
    | `LH_P3(_lh_vecadd_LH_P3_0_2_3, _lh_vecadd_LH_P3_1_2_3, _lh_vecadd_LH_P3_2_2_3) -> 
      (((((vecscale_lh__d8 _lh_shade_arg4_0) _lh_shade_arg5_0) _lh_vecadd_LH_P3_0_2_3) _lh_vecadd_LH_P3_1_2_3) _lh_vecadd_LH_P3_2_2_3)
    | _ -> 
      (failwith "error")) in
          ...
          (fun _lh_vecmult_arg2_5 -> 
            (match _lh_vecmult_arg2_5 with
              | `LH_P3(_lh_vecmult_LH_P3_0_7, _lh_vecmult_LH_P3_1_7, _lh_vecmult_LH_P3_2_7) -> 
                (let rec _lh_vecadd_LH_P3_2_2_4 = (_lh_vecmult_LH_P3_2_6 *. _lh_vecmult_LH_P3_2_7) in
                  (let rec _lh_vecadd_LH_P3_1_2_4 = (_lh_vecmult_LH_P3_1_6 *. _lh_vecmult_LH_P3_1_7) in
                    (let rec _lh_vecadd_LH_P3_0_2_4 = (_lh_vecmult_LH_P3_0_6 *. _lh_vecmult_LH_P3_0_7) in
          ...
          (let rec norm_0 = ((spherenormal_lh__d1 hitpos_8) _lh_shade_arg2_0) in
            (let rec refl_8 = (match _lh_shade_arg4_0 with
              | `LH_P3(_lh_vecadd_LH_P3_0_2_6, _lh_vecadd_LH_P3_1_2_6, _lh_vecadd_LH_P3_2_2_6) -> 
                (((((vecscale_lh__d9 norm_0) ((0.0 -. 2.0) *. ((vecdot_lh__d1 _lh_shade_arg4_0) norm_0))) _lh_vecadd_LH_P3_0_2_6) _lh_vecadd_LH_P3_1_2_6) _lh_vecadd_LH_P3_2_2_6)
              | _ -> 
                (failwith "error")) in
                ...
                (let rec _lh_matchIdent_1_5 = ((lightdirection_lh__d1 l_0) hitpos_8) in
                  (match _lh_matchIdent_1_5 with
                    | `LH_P2(_lh_lightray_LH_P2_0_5, _lh_lightray_LH_P2_1_3) -> 
                      (let rec cosangle_3 = ((vecdot_lh__d5 _lh_lightray_LH_P2_0_5) norm_0) in
...
transmitray_lh__d1 _lh_transmitray_arg1_4 _lh_transmitray_arg2_4 _lh_transmitray_arg3_4 _lh_transmitray_arg4_0 _lh_transmitray_arg5_0 _lh_transmitray_arg6_4 _lh_transmitray_arg7_0 _lh_transmitray_arg8_0 =
  (let rec newcontrib_5 = ((vecmult_lh__d6 _lh_transmitray_arg6_4) _lh_transmitray_arg7_0) in
    (let rec _lh_matchIdent_2_9 = (((refractray_lh__d1 _lh_transmitray_arg5_0) _lh_transmitray_arg4_0) _lh_transmitray_arg8_0) in
      (((((_lh_matchIdent_2_9 _lh_transmitray_arg1_4) _lh_transmitray_arg2_4) _lh_transmitray_arg3_4) _lh_transmitray_arg6_4) newcontrib_5)));;
...
let rec trace_lh__d1 _lh_trace_arg1_0 _lh_trace_arg2_0 _lh_trace_arg3_0 =
  (let rec f_1_3 = (fun d1s1_0 d2s2_0 -> 
    (let rec _lh_matchIdent_2_3 = d1s1_0 in
      (match _lh_matchIdent_2_3 with
        | `LH_P2(_lh_trace_LH_P2_0_0, _lh_trace_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_2_4 = d2s2_0 in
    ...
    (let rec sphmap_0 = (fun xss_0 -> 
      (let rec _lh_matchIdent_2_5 = xss_0 in
        (match _lh_matchIdent_2_5 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_0, _lh_trace_LH_C_1_0) -> 
            (let rec _lh_matchIdent_2_6 = (((sphereintersect_lh__d1 _lh_trace_arg2_0) _lh_trace_arg3_0) _lh_trace_LH_C_0_0) in
          ...
          (let rec _lh_tracepixel_LH_P3_2_0 = (head_lh__d2 _lh_trace_arg1_0) in
            (let rec _lh_tracepixel_LH_P3_1_0 = infinity_lh__d1 in
              (let rec _lh_tracepixel_LH_P3_0_0 = false in
                (fun _lh_tracepixel_LH_P2_0_2 _lh_tracepixel_arg2_1 pos_2 -> 
                  (if _lh_tracepixel_LH_P3_0_0 then
                    ((((((shade_lh__d1 _lh_tracepixel_arg2_1) _lh_tracepixel_LH_P3_2_0) pos_2) _lh_tracepixel_LH_P2_0_2) _lh_tracepixel_LH_P3_1_0) (`LH_P3(1.0, 1.0, 1.0)))
                  else
                    background_lh__d1)))))
        else
          (let rec _lh_matchIdent_2_7 = (((foldr_lh__d2 f_1_3) (head_lh__d1 dists_0)) (tail_lh__d1 dists_0)) in
                ...
                (let rec _lh_tracepixel_LH_P3_2_1 = _lh_trace_LH_P2_1_3 in
                  (let rec _lh_tracepixel_LH_P3_1_1 = _lh_trace_LH_P2_0_3 in
                    (let rec _lh_tracepixel_LH_P3_0_1 = true in
                      (fun _lh_tracepixel_LH_P2_0_3 _lh_tracepixel_arg2_2 pos_3 -> 
                        (if _lh_tracepixel_LH_P3_0_1 then
                          ((((((shade_lh__d1 _lh_tracepixel_arg2_2) _lh_tracepixel_LH_P3_2_1) pos_3) _lh_tracepixel_LH_P2_0_3) _lh_tracepixel_LH_P3_1_1) (`LH_P3(1.0, 1.0, 1.0)))
                        else
                          background_lh__d1)))))
              | _ -> 
                (failwith "error")))))));;
...
let rec vecscale_lh__d1 _lh_vecscale_arg1_1_1 _lh_vecscale_arg2_1_2 =
  (match _lh_vecscale_arg1_1_1 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_1, _lh_vecscale_LH_P3_1_1_1, _lh_vecscale_LH_P3_2_1_1) -> 
      (let rec _lh_vecadd_LH_P3_2_3_0 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_2_1_1) in
        (let rec _lh_vecadd_LH_P3_1_3_0 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_1_1_1) in
          (let rec _lh_vecadd_LH_P3_0_3_0 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_0_1_1) in
            (fun _lh_vecadd_LH_P3_0_3_1 _lh_vecadd_LH_P3_1_3_1 _lh_vecadd_LH_P3_2_3_1 -> 
              (let rec _lh_vecsub_LH_P3_2_7 = (_lh_vecadd_LH_P3_2_3_1 +. _lh_vecadd_LH_P3_2_3_0) in
                (let rec _lh_vecsub_LH_P3_1_7 = (_lh_vecadd_LH_P3_1_3_1 +. _lh_vecadd_LH_P3_1_3_0) in
                  (let rec _lh_vecsub_LH_P3_0_7 = (_lh_vecadd_LH_P3_0_3_1 +. _lh_vecadd_LH_P3_0_3_0) in
                    (fun _lh_vecsub_LH_P3_0_8 _lh_vecsub_LH_P3_1_8 _lh_vecsub_LH_P3_2_8 -> 
                      (let rec _lh_vecadd_LH_P3_2_3_2 = (_lh_vecsub_LH_P3_2_8 -. _lh_vecsub_LH_P3_2_7) in
                        (let rec _lh_vecadd_LH_P3_1_3_2 = (_lh_vecsub_LH_P3_1_8 -. _lh_vecsub_LH_P3_1_7) in
                          (let rec _lh_vecadd_LH_P3_0_3_2 = (_lh_vecsub_LH_P3_0_8 -. _lh_vecsub_LH_P3_0_7) in
                            (fun _lh_vecadd_arg2_1_5 -> 
                              (((_lh_vecadd_arg2_1_5 _lh_vecadd_LH_P3_0_3_2) _lh_vecadd_LH_P3_1_3_2) _lh_vecadd_LH_P3_2_3_2)))))))))))))
    | _ -> 
      (failwith "error"));;
                                        ...
                                        (let rec scrny_0 = (_lh_camparams_LH_P2_0_0 magy_0) in
                                          (let rec firstray_0 = (match initfirstray_0 with
                                            | `LH_P3(_lh_vecsub_LH_P3_0_0, _lh_vecsub_LH_P3_1_0, _lh_vecsub_LH_P3_2_0) -> 
                                              ((((((vecscale_lh__d4 scrnx_0) (0.5 *. xwinsize_0)) ((vecscale_lh__d1 scrny_0) (0.5 *. ywinsize_0))) _lh_vecsub_LH_P3_0_0) _lh_vecsub_LH_P3_1_0) _lh_vecsub_LH_P3_2_0)
                                            | _ -> 
                                              (failwith "error")) in
                                                  ...
                                                  (fun _lh_ray_arg1_0 lights_0 -> 
                                                    (let rec f_0 = (fun i_0 j_0 -> 
                                                      (let rec pos_0 = lookfrom_lh__d2 in
                                                        (let rec _lh_matchIdent_0 = (vecnorm_lh__d4 ((_lh_ray_LH_P3_0_0 ((vecscale_lh__d5 _lh_ray_LH_P3_1_0) (float_of_int i_0))) ((vecscale_lh__d6 _lh_ray_LH_P3_2_0) (float_of_int j_0)))) in
                                                          (match _lh_matchIdent_0 with
                                                            | `LH_P2(_lh_tracepixel_LH_P2_0_0, _lh_tracepixel_LH_P2_1_0) -> 
                                                              (let rec _lh_matchIdent_1 = (((trace_lh__d1 testspheres_lh__d1) pos_0) _lh_tracepixel_LH_P2_0_0) in
                                                                (((_lh_matchIdent_1 _lh_tracepixel_LH_P2_0_0) lights_0) pos_0))
                                                            | _ -> 
                                                              (failwith "error"))))) in
                    ...
                    (let rec _lh_camparams_LH_P2_1_2 = len_1 in
                      (let rec _lh_camparams_LH_P2_0_2 = (`LH_P3((_lh_vecnorm_LH_P3_0_1 /. len_1), (_lh_vecnorm_LH_P3_1_1 /. len_1), (_lh_vecnorm_LH_P3_2_1 /. len_1))) in
                        (fun _lh_camparams_LH_P2_0_3 _lh_camparams_LH_P2_1_3 _lh_camparams_arg4_1 _lh_camparams_arg5_1 initfirstray_1 -> 
                          (let rec _lh_matchIdent_8 = (((veccross_lh__d2 _lh_camparams_LH_P2_0_2) _lh_camparams_LH_P2_0_3) 99) in
                            (((((_lh_matchIdent_8 _lh_camparams_LH_P2_0_2) _lh_camparams_LH_P2_1_3) _lh_camparams_arg4_1) _lh_camparams_arg5_1) initfirstray_1))))))))))))));;
        ...
        (let rec _lh_camparams_LH_P2_1_4 = len_2 in
          (let rec _lh_camparams_LH_P2_0_4 = (`LH_P3((_lh_vecnorm_LH_P3_0_2 /. len_2), (_lh_vecnorm_LH_P3_1_2 /. len_2), (_lh_vecnorm_LH_P3_2_2 /. len_2))) in
            (fun _lh_camparams_arg3_1 _lh_camparams_arg4_3 _lh_camparams_arg5_3 initfirstray_4 -> 
              (let rec _lh_matchIdent_1_8 = ((match _lh_camparams_LH_P2_0_4 with
                ...
                (((((_lh_matchIdent_1_8 _lh_camparams_LH_P2_0_4) _lh_camparams_LH_P2_1_4) _lh_camparams_arg4_3) _lh_camparams_arg5_3) initfirstray_4))))))
    | _ -> 
      (failwith "error"));;
...
let rec hash_lh__d1 _lh_hash_arg1_0 =
  (let rec u8_0 = (fun x_0 -> 
    ...
    ((_lh_hash_arg1_0 (fun rgb_0 acc_0 -> 
      (let rec _lh_matchIdent_2_8 = rgb_0 in
...
let rec run_lh__d1 _lh_run_arg1_0 =
  (hash_lh__d1 ((let rec lights_1 = (testlights_lh__d1 0) in
    (let rec _lh_matchIdent_9 = (let rec initfirstray_2 = (lookat_lh__d1 lookfrom_lh__d1) in
      (let rec _lh_matchIdent_1_0 = (vecnorm_lh__d2 initfirstray_2) in
        ((((_lh_matchIdent_1_0 vup_lh__d1) fov_lh__d1) (float_of_int _lh_run_arg1_0)) initfirstray_2))) in

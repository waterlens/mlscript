...
let rec abs__d0 _lh_abs_arg1_0 =
  (if (_lh_abs_arg1_0 < 0) then
    ...
    _lh_abs_arg1_0);;
let rec enumFromTo__d0 a_1 b_1 _lh_popOutId_0_1 _lh_popOutId_1_1 =
  (if (a_1 <= b_1) then
...
let rec max'__d0 _lh_max'_arg1_0 =
  (match _lh_max'_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec enumFromTo__d1 a_0 b_0 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 =
  (if (a_0 <= b_0) then
    (fun f_1 f_2 -> 
...
and quotRem__d0 _lh_quotRem_arg1_0 _lh_quotRem_arg2_0 _lh_g_LH_P3_0_0 _lh_g_LH_P3_0_1 _lh_g_LH_P3_1_0 _lh_g_LH_P3_1_1 _lh_g_LH_P3_2_0 =

...
let rec zipWith_lz_lz_lh__d1 f_1 xs_0 ys_0 =
  (lazy (match (Lazy.force xs_0) with
    ...
    | `LH_N -> 
      (`LH_N)));;
let rec enumFromThenTo_lh__d2 a_1 t_4 b_1 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1_0 = (((enumFromThenTo_lh__d2 t_4) ((2 * t_4) - a_1)) b_1) in
  ...
  (match _lh_nextSize_arg1_0 with
    | `Wheel(_lh_nextSize_Wheel_0_0, _lh_nextSize_Wheel_1_0) -> 
      (`Wheel((_lh_nextSize_Wheel_0_0 * _lh_nextSize_arg2_0), (let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_5 -> 
        ...
        (_lh_listcomp_fun_1_6 (((enumFromThenTo_lh__d2 0) _lh_nextSize_Wheel_0_0) ((_lh_nextSize_arg2_0 - 1) * _lh_nextSize_Wheel_0_0))))))
    | _ -> 
      (failwith "error"));;
...
let rec append_lz_lh__d1 _lh_append_lz_arg1_0 _lh_append_lz_arg2_0 =
  (let rec _lh_matchIdent_3 = _lh_append_lz_arg1_0 in
    (match _lh_matchIdent_3 with
      ...
      | _ -> 
        (failwith "error")));;
let rec enumFromThenTo_lh__d1 a_0 t_3 b_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_5 = (((enumFromThenTo_lh__d1 t_3) ((2 * t_3) - a_0)) b_0) in
                  ...
                  (_lh_listcomp_fun_1_0 (let rec _lh_listcomp_fun_ls_t_7 = (fun _lh_listcomp_fun_1_1 _lh_sieve_Wheel_0_5 _lh_sieve_arg2_5 _lh_sieve_arg3_5 _lh_listcomp_fun_ls_t_8 _lh_listcomp_fun_1_2 -> 
                    ...
                    (let rec _lh_listcomp_fun_ls_h_5 = (_lh_listcomp_fun_ls_h_4 + _lh_listcomp_fun_ls_h_3) in
                      (fun _lh_listcomp_fun_1_3 _lh_sieve_Wheel_0_6 _lh_sieve_arg2_6 _lh_sieve_arg3_6 _lh_listcomp_fun_ls_t_9 _lh_listcomp_fun_1_4 -> 
                        (if ((((noFactor_lh__d1 _lh_sieve_Wheel_0_6) _lh_sieve_arg2_6) _lh_sieve_arg3_6) _lh_listcomp_fun_ls_h_5) then
        ...
        (match _lh_sieve_LH_C_0_0 with
          | `Wheel(_lh_sieve_Wheel_0_0, _lh_sieve_Wheel_1_0) -> 
            ((append_lz_lh__d1 (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
              ...
              (_lh_listcomp_fun_0 (let rec _lh_listcomp_fun_ls_t_0 = (((enumFromThenTo_lh__d1 (_lh_sieve_Wheel_0_0 * 2)) (_lh_sieve_Wheel_0_0 * 3)) (((min_lh__d1 (_lh_sieve_arg4_0 * _lh_sieve_arg4_0)) ((head_lz_lh__d1 _lh_sieve_arg2_0) - 1)) * _lh_sieve_Wheel_0_0)) in
                (let rec _lh_listcomp_fun_ls_h_0 = _lh_sieve_Wheel_0_0 in
                  (fun _lh_listcomp_fun_1 _lh_sieve_Wheel_0_1 _lh_sieve_Wheel_1_1 _lh_sieve_arg2_1 _lh_sieve_arg3_1 -> 
                    (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_1 -> 
                            ...
                            (_lh_listcomp_fun_3 (let rec _lh_listcomp_fun_ls_t_2 = (fun _lh_listcomp_fun_4 _lh_sieve_Wheel_0_2 _lh_sieve_arg2_2 _lh_sieve_arg3_2 _lh_listcomp_fun_ls_t_3 _lh_listcomp_fun_5 -> 
                              ...
                              (let rec _lh_listcomp_fun_ls_h_2 = (_lh_listcomp_fun_ls_h_1 + _lh_listcomp_fun_ls_h_0) in
                                (fun _lh_listcomp_fun_6 _lh_sieve_Wheel_0_3 _lh_sieve_arg2_3 _lh_sieve_arg3_3 _lh_listcomp_fun_ls_t_4 _lh_listcomp_fun_7 -> 
                                  (if ((((noFactor_lh__d1 _lh_sieve_Wheel_0_3) _lh_sieve_arg2_3) _lh_sieve_arg3_3) _lh_listcomp_fun_ls_h_2) then
                      ...
                      (_lh_listcomp_fun_2 _lh_sieve_Wheel_1_1)))))))) ((((sieve_lh__d1 _lh_sieve_LH_C_1_0) (tail_lz_lh__d1 _lh_sieve_arg2_0)) (tail_lz_lh__d2 _lh_sieve_arg3_0)) _lh_sieve_arg4_0))
          | _ -> 
            (failwith "error"))
      | _ -> 
        (failwith "error")));;

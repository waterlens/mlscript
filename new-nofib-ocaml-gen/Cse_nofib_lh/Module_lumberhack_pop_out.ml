...
let rec take__d0 n_2_0 ls_6 =
  (if (n_2_0 > 0) then
    ...
    (fun f_1_4 -> 
      (`LH_N)));;
let rec update__d0 _lh_update_arg1_0 s_0 _lh_bind_arg2_0 =
...
and enumFromTo__d0 a_0 b_1 _lh_popOutId_0_2 =
  (if (a_0 <= b_1) then
    (let rec t_2_0 = ((enumFromTo__d0 (a_0 + 1)) b_1) in
      (let rec h_2_0 = a_0 in
        (`LH_C((_lh_popOutId_0_2 h_2_0), ((map__d3 _lh_popOutId_0_2) t_2_0)))))
  else
    (`LH_N))
...
and ltGraph__d0 _lh_ltGraph_arg1_0 =
  (match _lh_ltGraph_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and map__d1 f_0 ls_0 _lh_popOutId_0_0 =
  (match ls_0 with
    | `LH_C(h_0, t_0) -> 
    ...
    | `LH_N -> 
      (`LH_N))
and map__d2 f_1_5 ls_7 _lh_popOutId_0_1 =
  (match ls_7 with
    | `LH_C(h_1_7, t_1_7) -> 
...
and mmapl__d0 _lh_mmapl_arg1_0 _lh_mmapl_arg2_0 =
  (match _lh_mmapl_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and mult___d0 _lh_mult__arg1_1 _lh_mult__arg2_1 label_2_2 =
...
and mult___d1 _lh_mult__arg1_0 _lh_mult__arg2_0 label_1_9 =
...
and mult___d2 _lh_mult__arg1_2 _lh_mult__arg2_2 label_2_9 =
...
and plus___d0 _lh_plus__arg1_5 _lh_plus__arg2_5 label_2_7 =
...
and plus___d1 _lh_plus__arg1_0 _lh_plus__arg2_0 label_2 =
...
and plus___d2 _lh_plus__arg1_3 _lh_plus__arg2_3 label_1_4 =
...
and plus___d3 _lh_plus__arg1_6 _lh_plus__arg2_6 label_3_3 =
...
and plus___d4 _lh_plus__arg1_1 _lh_plus__arg2_1 label_8 =
...
and plus___d5 _lh_plus__arg1_4 _lh_plus__arg2_4 label_1_6 =
...
and plus___d6 _lh_plus__arg1_2 _lh_plus__arg2_2 label_1_2 =
...
and prod__d0 _lh_prod_arg1_0 label_2_3 =
...
and prod__d1 _lh_prod_arg1_1 label_3_1 =

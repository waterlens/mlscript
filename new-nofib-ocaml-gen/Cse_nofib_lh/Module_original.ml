...
and incr_lh _lh_incr_arg1_0 =
  (update_lh (fun x_0 -> 
    (1 + x_0)))
and labelTree_lh _lh_labelTree_arg1_0 =
...
and ltGraph_lh _lh_ltGraph_arg1_0 =
  (match _lh_ltGraph_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and mmapl_lh _lh_mmapl_arg1_0 _lh_mmapl_arg2_0 =
  (match _lh_mmapl_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and testCse_nofib_lh _lh_testCse_nofib_arg1_0 =
  ((map_lh (fun i_1 -> 

  ...
  (if (a_8 <= b_7) then
    (let rec t_7_9 = ((enumFromTo_lh__d1 (a_8 + 1)) b_7) in
      (let rec h_7_9 = a_8 in
        (fun f_3_1 i_1_3 -> 
          ((f_3_1 h_7_9) ((t_7_9 f_3_1) i_1_3)))))
  else
    (fun f_3_2 i_1_4 -> 
      i_1_4));;
let rec reverse_lh__d1 ls_2_6 =
  (ls_2_6 (fun f_3_9 f_4_0 -> 
    (`LH_N)));;
...
let rec mappend_lh__d2_d7 xs_3_5 ys_1_4_5 =
  (match xs_3_5 with
    | `LH_C(h_1_4_0, t_1_4_0) -> 
      (let rec t_1_4_1 = ((mappend_lh__d2_d7 t_1_4_0) ys_1_4_5) in
        (let rec h_1_4_1 = h_1_4_0 in
          (fun ys_1_4_6 -> 
            (`LH_C(h_1_4_1, (t_1_4_1 ys_1_4_6))))))
    | `LH_N -> 
      ys_1_4_5);;
...
let rec mappend_lh__d2_d2 xs_3_4 ys_1_4_4 =
  (match xs_3_4 with
    | `LH_C(h_1_3_9, t_1_3_9) -> 
      (`LH_C(h_1_3_9, ((mappend_lh__d2_d2 t_1_3_9) ys_1_4_4)))
    | `LH_N -> 
      ys_1_4_4);;
let rec tab_lh__d1 _lh_tab_arg1_1 =
  (if (_lh_tab_arg1_1 <= 0) then
    ...
    (let rec t_1_3_7 = (tab_lh__d1 (_lh_tab_arg1_1 - 1)) in
      (let rec h_1_3_7 = ' ' in
        (fun ys_1_4_2 -> 
          (let rec t_1_3_8 = (t_1_3_7 ys_1_4_2) in
            (let rec h_1_3_8 = h_1_3_7 in
              (fun ys_1_4_3 -> 
                (`LH_C(h_1_3_8, (t_1_3_8 ys_1_4_3))))))))));;
...
let rec foldr_lh__d6 f_2 i_2 ls_4 =
  (match ls_4 with
    ...
    | `LH_N -> 
      i_2);;
let rec foldr_lh__d7 f_3_8 i_1_5 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_9_5, t_9_5) -> 
      ((f_3_8 h_9_5) (((foldr_lh__d7 f_3_8) i_1_5) t_9_5))
    | `LH_N -> 
      i_1_5);;
...
let rec enumFromTo_lh__d4 a_2 b_2 =
  (if (a_2 <= b_2) then
    ...
    (fun f_4 ys_6 -> 
      (`LH_N)));;
let rec filter_lh__d2 f_4_1 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_1_2_7, t_1_2_7) -> 
      (if (f_4_1 h_1_2_7) then
        (let rec ty_1 = ((filter_lh__d2 f_4_1) t_1_2_7) in
          (let rec hy_1 = h_1_2_7 in
            (fun f_4_2 hx_5 tx_5 -> 
              (`LH_C(((f_4_2 hx_5) hy_1), ((tx_5 f_4_2) ty_1))))))
      else
        ((filter_lh__d2 f_4_1) t_1_2_7))
    | `LH_N -> 
      (fun f_4_3 hx_6 tx_6 -> 
        (`LH_N)));;
...
let rec reverse_lh__d2 ls_2_8 =
  (ls_2_8 (fun f_4_4 ys_1_3_9 _lh_dummy_1_1 f_4_5 i_1_6 -> 
    i_1_6));;
...
let rec break_lh__d1 _lh_break_arg1_1 _lh_break_arg2_1 =
  (match _lh_break_arg2_1 with
    | `LH_N -> 
      (`LH_P2((`LH_N), (fun _lh_dummy_7 f_3_4 -> 
        (`LH_N))))

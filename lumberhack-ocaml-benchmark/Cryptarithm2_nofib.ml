  ...
  (if (a_3 <= b_1) then
    (let rec t_4_4 = ((enumFromTo__d0 (a_3 + 1)) b_1) in
      (let rec h_4_3 = a_3 in
        (fun f_3_8 -> 
          (`LH_C((f_3_8 h_4_3), ((map__d0 f_3_8) t_4_4))))))
  else
    (fun f_3_9 -> 
      (`LH_N)))
...
and map__d4 f_1_9 ls_1_2 =
  (match ls_1_2 with
    ...
    | `LH_N -> 
      (fun _lh_dummy_8 f_2_0 _lh_dummy_9 -> 
        (`LH_N)))
and map__d8 f_2_9 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_3_3, t_3_3) -> 
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Cryptarithm2_nofib" (fun () -> ignore (let open Module_original in ((testCryptarithm2_nofib__d0 1))));
  Bench.Test.create ~name:"lumberhack_Cryptarithm2_nofib" (fun () -> ignore (let open Module_lumberhack in ((testCryptarithm2_nofib__d0 1))));
  Bench.Test.create ~name:"lumberhack_pop_out_Cryptarithm2_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testCryptarithm2_nofib__d0 1))));
])

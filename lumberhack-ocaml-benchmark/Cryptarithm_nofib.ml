...
(* lumberhack *)
let rec addj_d0_d0_d0 _lh_addj_arg1_4 _lh_addj_arg2_4 =
  (match _lh_addj_arg2_4 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_4, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_4, _lh_addj_LH_C_1_4) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_4, (`LH_C(_lh_addj_LH_C_0_4, _lh_addj_LH_C_1_4)))), (let rec _lh_listcomp_fun_4_3 = (fun _lh_listcomp_fun_para_1_9 -> 
        (match _lh_listcomp_fun_para_1_9 with
          | `LH_C(_lh_listcomp_fun_ls_h_2_8, _lh_listcomp_fun_ls_t_3_3) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_4, _lh_listcomp_fun_ls_h_2_8)), (_lh_listcomp_fun_4_3 _lh_listcomp_fun_ls_t_3_3)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_4_3 ((addj_d0_d0_d0 _lh_addj_arg1_4) _lh_addj_LH_C_1_4)))))
    | _ -> 
      (failwith "error"));;
let rec addj_d0_d1_d0 _lh_addj_arg1_2 _lh_addj_arg2_2 =
  (match _lh_addj_arg2_2 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_2, _lh_addj_LH_C_1_2) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2, (`LH_C(_lh_addj_LH_C_0_2, _lh_addj_LH_C_1_2)))), (let rec _lh_listcomp_fun_3_7 = (fun _lh_listcomp_fun_para_1_5 -> 
        (match _lh_listcomp_fun_para_1_5 with
          | `LH_C(_lh_listcomp_fun_ls_h_2_4, _lh_listcomp_fun_ls_t_2_9) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_2, _lh_listcomp_fun_ls_h_2_4)), (_lh_listcomp_fun_3_7 _lh_listcomp_fun_ls_t_2_9)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_3_7 ((addj_d0_d1_d0 _lh_addj_arg1_2) _lh_addj_LH_C_1_2)))))
    | _ -> 
      (failwith "error"));;
let rec addj_d0_d1_d2 _lh_addj_arg1_3 _lh_addj_arg2_3 =
  (match _lh_addj_arg2_3 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_3, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_3, _lh_addj_LH_C_1_3) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_3, (`LH_C(_lh_addj_LH_C_0_3, _lh_addj_LH_C_1_3)))), (let rec _lh_listcomp_fun_4_2 = (fun _lh_listcomp_fun_para_1_8 -> 
        (match _lh_listcomp_fun_para_1_8 with
          | `LH_C(_lh_listcomp_fun_ls_h_2_7, _lh_listcomp_fun_ls_t_3_2) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_3, _lh_listcomp_fun_ls_h_2_7)), (_lh_listcomp_fun_4_2 _lh_listcomp_fun_ls_t_3_2)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_4_2 ((addj_d0_d1_d2 _lh_addj_arg1_3) _lh_addj_LH_C_1_3)))))
    | _ -> 
      (failwith "error"));;
let rec addj_d0_d1_d3 _lh_addj_arg1_0 _lh_addj_arg2_0 =
  (match _lh_addj_arg2_0 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_0, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_0, _lh_addj_LH_C_1_0) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_0, (`LH_C(_lh_addj_LH_C_0_0, _lh_addj_LH_C_1_0)))), (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_4 -> 
        (match _lh_listcomp_fun_para_4 with
          | `LH_C(_lh_listcomp_fun_ls_h_5, _lh_listcomp_fun_ls_t_5) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_0, _lh_listcomp_fun_ls_h_5)), (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_5)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0 ((addj_d0_d1_d3 _lh_addj_arg1_0) _lh_addj_LH_C_1_0)))))
    | _ -> 
      (failwith "error"));;
let rec expand_d0_d0_d0 _lh_expand_arg1_1 _lh_expand_arg2_1 _lh_expand_arg3_1 _lh_expand_arg4_1 _lh_expand_arg5_1 _lh_expand_arg6_1 =
  (((((_lh_expand_arg6_1 + (_lh_expand_arg5_1 * 10)) + (_lh_expand_arg4_1 * 100)) + (_lh_expand_arg3_1 * 1000)) + (_lh_expand_arg2_1 * 10000)) + (_lh_expand_arg1_1 * 100000));;
let rec expand_d1_d0_d0 _lh_expand_arg1_2 _lh_expand_arg2_2 _lh_expand_arg3_2 _lh_expand_arg4_2 _lh_expand_arg5_2 _lh_expand_arg6_2 =
  (((((_lh_expand_arg6_2 + (_lh_expand_arg5_2 * 10)) + (_lh_expand_arg4_2 * 100)) + (_lh_expand_arg3_2 * 1000)) + (_lh_expand_arg2_2 * 10000)) + (_lh_expand_arg1_2 * 100000));;
let rec expand_d2_d0_d0 _lh_expand_arg1_0 _lh_expand_arg2_0 _lh_expand_arg3_0 _lh_expand_arg4_0 _lh_expand_arg5_0 _lh_expand_arg6_0 =
...
let rec filter_d0_d1_d0 f_4 ls_4 =
  (match ls_4 with
    | `LH_C(h_2, t_2) -> 
      (if (f_4 h_2) then
        (`LH_C(h_2, ((filter_d0_d1_d0 f_4) t_2)))
      else
        ((filter_d0_d1_d0 f_4) t_2))
    | `LH_N -> 
      (`LH_N));;
let rec map_d0_d0_d0 f_3 ls_3 =
  (ls_3 f_3);;
let rec map_d0_d0_d1 f_5 ls_5 =
  (ls_5 f_5);;
let rec take_d0_d0_d0 n_0 ls_0 =
  (if (n_0 > 0) then
    ...
    (`LH_N));;
let rec take_d0_d0_d1 n_1 ls_2 =
  (if (n_1 > 0) then
    (ls_2 n_1)
  else
    (`LH_N));;
                            ...
                            (fun _lh_listcomp_fun_2_0 _lh_permutations_LH_C_0_1_0 -> 
                              (let rec _lh_listcomp_fun_2_1 = (fun _lh_listcomp_fun_para_9 -> 
                                (match _lh_listcomp_fun_para_9 with
                                  | `LH_C(_lh_listcomp_fun_ls_h_1_2, _lh_listcomp_fun_ls_t_1_4) -> 
                                    (`LH_C(_lh_listcomp_fun_ls_h_1_2, (_lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_1_4)))
                                  | `LH_N -> 
                                    (_lh_listcomp_fun_2_0 _lh_listcomp_fun_ls_t_1_3))) in
                                (_lh_listcomp_fun_2_1 ((addj_d0_d0_d0 _lh_permutations_LH_C_0_1_0) _lh_listcomp_fun_ls_h_1_1))))))
                      | `LH_N -> 
                              ...
                              (let rec _lh_listcomp_fun_3_6 = (fun _lh_listcomp_fun_para_1_4 -> 
                                (match _lh_listcomp_fun_para_1_4 with
                                  | `LH_C(_lh_listcomp_fun_ls_h_2_3, _lh_listcomp_fun_ls_t_2_8) -> 
                                    (`LH_C(_lh_listcomp_fun_ls_h_2_3, (_lh_listcomp_fun_3_6 _lh_listcomp_fun_ls_t_2_8)))
                                  | `LH_N -> 
                                    (_lh_listcomp_fun_3_5 _lh_listcomp_fun_ls_t_2_7))) in
                                (_lh_listcomp_fun_3_6 ((addj_d0_d0_d0 _lh_permutations_LH_C_0_1_4) _lh_listcomp_fun_ls_h_2_2))))))
                      | `LH_N -> 
                        (_lh_listcomp_fun_3_3 _lh_listcomp_fun_ls_t_2_5))) in
                    (_lh_listcomp_fun_3_4 ((addj_d0_d1_d0 _lh_permutations_LH_C_0_1_3) _lh_listcomp_fun_ls_h_2_0)))))))))
    | _ -> 
      (failwith "error"))
and condition_d0_d0_d0 _lh_condition_arg1_0 =
                                      ...
                                      (match _lh_condition_LH_C_1_8 with
                                        | `LH_C(_lh_condition_LH_C_0_9, _lh_condition_LH_C_1_9) -> 
                                          (match _lh_condition_LH_C_1_9 with
                                            | `LH_N -> 
                                              ((((((((expand_d0_d0_d0 _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_1) _lh_condition_LH_C_0_2) _lh_condition_LH_C_0_3) _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_4) + (5 * ((((((expand_d1_d0_d0 _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_5) _lh_condition_LH_C_0_6) _lh_condition_LH_C_0_7) _lh_condition_LH_C_0_8) _lh_condition_LH_C_0_6))) = ((((((expand_d2_d0_d0 _lh_condition_LH_C_0_9) _lh_condition_LH_C_0_2) _lh_condition_LH_C_0_9) _lh_condition_LH_C_0_6) _lh_condition_LH_C_0_0) _lh_condition_LH_C_0_4))
                                            | _ -> 
                                              (failwith "error"))
                                        | _ -> 
                                          (failwith "error"))
...
and enumFromTo_d1_d0_d0 a_0 b_0 =
  (if (a_0 <= b_0) then
    ...
    (fun f_2 -> 
      (`LH_N)))
and filter_d0_d0_d0 f_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_0, t_0) -> 
      (if (f_0 h_0) then
        (`LH_C(h_0, ((filter_d0_d0_d0 f_0) t_0)))
      else
        ((filter_d0_d1_d0 f_0) t_0))
    | `LH_N -> 
      (`LH_N))
and permutations_d0_d0_d0 _lh_permutations_arg1_1 =
  (match _lh_permutations_arg1_1 with
    | `LH_N -> 
      (`LH_C((`LH_N), (`LH_N)))
    | `LH_C(_lh_permutations_LH_C_0_7, _lh_permutations_LH_C_1_1) -> 
      (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_5 -> 
        ((_lh_listcomp_fun_para_5 _lh_listcomp_fun_1_1) _lh_permutations_LH_C_0_7)) in
        (_lh_listcomp_fun_1_1 (permutations_d0_d1_d0 _lh_permutations_LH_C_1_1)))
    | _ -> 
      (failwith "error"))
            ...
            (let rec _lh_listcomp_fun_4_0 = (fun _lh_listcomp_fun_para_1_6 -> 
              (match _lh_listcomp_fun_para_1_6 with
                | `LH_C(_lh_listcomp_fun_ls_h_2_6, _lh_listcomp_fun_ls_t_3_1) -> 
                  (`LH_C(_lh_listcomp_fun_ls_h_2_6, (_lh_listcomp_fun_4_0 _lh_listcomp_fun_ls_t_3_1)))
                | `LH_N -> 
                  (_lh_listcomp_fun_3_9 _lh_listcomp_fun_ls_t_3_0))) in
              (_lh_listcomp_fun_4_0 ((addj_d0_d0_d0 _lh_permutations_LH_C_0_1_6) _lh_listcomp_fun_ls_h_2_5))))))
    | `LH_C(_lh_permutations_LH_C_0_1_7, _lh_permutations_LH_C_1_3) -> 
      (let rec _lh_listcomp_fun_4_1 = (fun _lh_listcomp_fun_para_1_7 -> 
        ((_lh_listcomp_fun_para_1_7 _lh_listcomp_fun_4_1) _lh_permutations_LH_C_0_1_7)) in
        (_lh_listcomp_fun_4_1 (permutations_d0_d1_d1 _lh_permutations_LH_C_1_3)))
    | _ -> 
      (failwith "error"))
                    ...
                    (let rec _lh_listcomp_fun_ls_h_2 = _lh_listcomp_fun_ls_h_1 in
                      (fun _lh_listcomp_fun_4 _lh_permutations_LH_C_0_3 -> 
                        (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_1 -> 
                          ...
                          (_lh_listcomp_fun_5 ((addj_d0_d0_d0 _lh_permutations_LH_C_0_3) _lh_listcomp_fun_ls_h_2))))))
                | `LH_N -> 
                  (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_0))) in
              (_lh_listcomp_fun_3 ((addj_d0_d1_d0 _lh_permutations_LH_C_0_2) _lh_listcomp_fun_ls_h_0))))))
    | `LH_C(_lh_permutations_LH_C_0_4, _lh_permutations_LH_C_1_0) -> 
      (let rec _lh_listcomp_fun_6 = (fun _lh_listcomp_fun_para_2 -> 
        (match _lh_listcomp_fun_para_2 with
          | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
            (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_3 -> 
              (((_lh_listcomp_fun_para_3 _lh_listcomp_fun_7) _lh_listcomp_fun_ls_t_4) _lh_listcomp_fun_6)) in
              (_lh_listcomp_fun_7 ((addj_d0_d1_d1 _lh_permutations_LH_C_0_4) _lh_listcomp_fun_ls_h_4)))
          | `LH_N -> 
            (fun _lh_listcomp_fun_8 _lh_permutations_LH_C_0_5 _lh_listcomp_fun_9 _lh_permutations_LH_C_0_6 -> 
              (`LH_N)))) in
        (_lh_listcomp_fun_6 (permutations_d0_d1_d2 _lh_permutations_LH_C_1_0)))
    | _ -> 
      (failwith "error"))
and permutations_d0_d1_d2 _lh_permutations_arg1_2 =
  (match _lh_permutations_arg1_2 with
    | `LH_N -> 
      (`LH_C((`LH_N), (`LH_N)))
    | `LH_C(_lh_permutations_LH_C_0_8, _lh_permutations_LH_C_1_2) -> 
            ...
            (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_7 -> 
              (match _lh_listcomp_fun_para_7 with
                | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
                  (`LH_C(_lh_listcomp_fun_ls_h_7, (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_7)))
                | `LH_N -> 
                  (_lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_6))) in
              (_lh_listcomp_fun_1_3 ((addj_d0_d1_d3 _lh_permutations_LH_C_0_8) _lh_listcomp_fun_ls_h_6)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_2 (permutations_d0_d1_d2 _lh_permutations_LH_C_1_2)))
    | _ -> 
      (failwith "error"))
and testCryptarithm_nofib_d0_d0_d0 _lh_testCryptarithm_nofib_arg1_0 =
  ((map_d0_d0_d1 (fun i_0 -> 
    (let rec p0_0 = ((take_d0_d0_d1 10) ((enumFromTo_d0_d0_d0 0) (9 + i_0))) in
      ((filter_d0_d0_d0 condition_d0_d0_d0) (permutations_d0_d0_d0 p0_0))))) ((enumFromTo_d1_d0_d0 1) _lh_testCryptarithm_nofib_arg1_0));;

(* lumberhack_pop_out *)
let rec addj_d0_d0_d0_d0 _lh_addj_arg1_1_0 _lh_addj_arg2_1_0 =
  (match _lh_addj_arg2_1_0 with
    | `LH_N -> 
...
let rec addj_d0_d0_d0_d1 _lh_addj_arg1_1_5 _lh_addj_arg2_1_5 =
  (match _lh_addj_arg2_1_5 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_1_5, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_5, _lh_addj_LH_C_1_1_5) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_1_5, (`LH_C(_lh_addj_LH_C_0_1_5, _lh_addj_LH_C_1_1_5)))), (let rec _lh_listcomp_fun_9_3 = (fun _lh_listcomp_fun_para_4_5 -> 
        (match _lh_listcomp_fun_para_4_5 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_3, _lh_listcomp_fun_ls_t_7_3) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_5, _lh_listcomp_fun_ls_h_6_3)), (_lh_listcomp_fun_9_3 _lh_listcomp_fun_ls_t_7_3)))
          | `LH_N -> 
            (`LH_N))) in
...
let rec addj_d0_d0_d0_d4 _lh_addj_arg1_1_6 _lh_addj_arg2_1_6 =
  (match _lh_addj_arg2_1_6 with
    ...
    | `LH_C(_lh_addj_LH_C_0_1_6, _lh_addj_LH_C_1_1_6) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_1_6, (`LH_C(_lh_addj_LH_C_0_1_6, _lh_addj_LH_C_1_1_6)))), (let rec _lh_listcomp_fun_9_4 = (fun _lh_listcomp_fun_para_4_6 -> 
        (match _lh_listcomp_fun_para_4_6 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_4, _lh_listcomp_fun_ls_t_7_4) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_6, _lh_listcomp_fun_ls_h_6_4)), (_lh_listcomp_fun_9_4 _lh_listcomp_fun_ls_t_7_4)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_9_4 ((addj_d0_d0_d0_d4 _lh_addj_arg1_1_6) _lh_addj_LH_C_1_1_6)))))
    | _ -> 
      (failwith "error"));;
let rec addj_d0_d1_d0_d0 _lh_addj_arg1_1_1 _lh_addj_arg2_1_1 =
  (match _lh_addj_arg2_1_1 with
    | `LH_N -> 
...
let rec addj_d0_d1_d0_d3 _lh_addj_arg1_9 _lh_addj_arg2_9 =
  (match _lh_addj_arg2_9 with
    ...
    | `LH_C(_lh_addj_LH_C_0_9, _lh_addj_LH_C_1_9) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_9, (`LH_C(_lh_addj_LH_C_0_9, _lh_addj_LH_C_1_9)))), (let rec _lh_listcomp_fun_7_0 = (fun _lh_listcomp_fun_para_3_0 -> 
        (match _lh_listcomp_fun_para_3_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_4_8, _lh_listcomp_fun_ls_t_5_8) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_9, _lh_listcomp_fun_ls_h_4_8)), (_lh_listcomp_fun_7_0 _lh_listcomp_fun_ls_t_5_8)))
          | `LH_N -> 
            (`LH_N))) in
...
let rec expand_d1_d0_d0_d0 _lh_expand_arg1_5 _lh_expand_arg2_5 _lh_expand_arg3_5 _lh_expand_arg4_5 _lh_expand_arg5_5 _lh_expand_arg6_5 =
...
let rec expand_d2_d0_d0_d0 _lh_expand_arg1_3 _lh_expand_arg2_3 _lh_expand_arg3_3 _lh_expand_arg4_3 _lh_expand_arg5_3 _lh_expand_arg6_3 =
  (((((_lh_expand_arg6_3 + (_lh_expand_arg5_3 * 10)) + (_lh_expand_arg4_3 * 100)) + (_lh_expand_arg3_3 * 1000)) + (_lh_expand_arg2_3 * 10000)) + (_lh_expand_arg1_3 * 100000));;
let rec filter_d0_d1_d0_d0 f_1_1 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_6, t_6) -> 
      (if (f_1_1 h_6) then
        (`LH_C(h_6, ((filter_d0_d1_d0_d0 f_1_1) t_6)))
      else
        ((filter_d0_d1_d0_d0 f_1_1) t_6))
    | `LH_N -> 
      (`LH_N));;
let rec map_d0_d0_d0_d0 f_9 ls_8 =
  (ls_8 f_9);;
let rec map_d0_d0_d1_d0 f_1_0 ls_9 =
  (ls_9 f_1_0);;
let rec take_d0_d0_d0_d0 n_4 ls_7 =
  (if (n_4 > 0) then
    (ls_7 n_4)
  else
    (`LH_N));;
let rec take_d0_d0_d1_d0 n_5 ls_1_1 =
  (if (n_5 > 0) then
    (ls_1_1 n_5)
  else
    (`LH_N));;
                            ...
                            (fun _lh_listcomp_fun_5_0 _lh_permutations_LH_C_0_1_9 -> 
                              (let rec _lh_listcomp_fun_5_1 = (fun _lh_listcomp_fun_para_2_1 -> 
                                (match _lh_listcomp_fun_para_2_1 with
                                  | `LH_C(_lh_listcomp_fun_ls_h_3_3, _lh_listcomp_fun_ls_t_4_0) -> 
                                    (`LH_C(_lh_listcomp_fun_ls_h_3_3, (_lh_listcomp_fun_5_1 _lh_listcomp_fun_ls_t_4_0)))
                                  | `LH_N -> 
                                    (_lh_listcomp_fun_5_0 _lh_listcomp_fun_ls_t_3_9))) in
                                (_lh_listcomp_fun_5_1 ((addj_d0_d0_d0_d2 _lh_permutations_LH_C_0_1_9) _lh_listcomp_fun_ls_h_3_2))))))
                      | `LH_N -> 
                            ...
                            (fun _lh_listcomp_fun_6_5 _lh_permutations_LH_C_0_2_3 -> 
                              (let rec _lh_listcomp_fun_6_6 = (fun _lh_listcomp_fun_para_2_6 -> 
                                (match _lh_listcomp_fun_para_2_6 with
                                  | `LH_C(_lh_listcomp_fun_ls_h_4_4, _lh_listcomp_fun_ls_t_5_4) -> 
                                    (`LH_C(_lh_listcomp_fun_ls_h_4_4, (_lh_listcomp_fun_6_6 _lh_listcomp_fun_ls_t_5_4)))
                                  | `LH_N -> 
                                    (_lh_listcomp_fun_6_5 _lh_listcomp_fun_ls_t_5_3))) in
                                (_lh_listcomp_fun_6_6 ((addj_d0_d0_d0_d4 _lh_permutations_LH_C_0_2_3) _lh_listcomp_fun_ls_h_4_3))))))
                      | `LH_N -> 
                        (_lh_listcomp_fun_6_3 _lh_listcomp_fun_ls_t_5_1))) in
                    (_lh_listcomp_fun_6_4 ((addj_d0_d1_d0_d3 _lh_permutations_LH_C_0_2_2) _lh_listcomp_fun_ls_h_4_1)))))))))
    | _ -> 
      (failwith "error"))
and condition_d0_d0_d0_d0 _lh_condition_arg1_1 =
  (match _lh_condition_arg1_1 with
    | `LH_C(_lh_condition_LH_C_0_1_0, _lh_condition_LH_C_1_1_0) -> 
      (match _lh_condition_LH_C_1_1_0 with
        | `LH_C(_lh_condition_LH_C_0_1_1, _lh_condition_LH_C_1_1_1) -> 
                                    ...
                                    | `LH_C(_lh_condition_LH_C_0_1_8, _lh_condition_LH_C_1_1_8) -> 
                                      (match _lh_condition_LH_C_1_1_8 with
                                        | `LH_C(_lh_condition_LH_C_0_1_9, _lh_condition_LH_C_1_1_9) -> 
                                          (match _lh_condition_LH_C_1_1_9 with
                                            | `LH_N -> 
                                              ((((((((expand_d0_d0_d0_d0 _lh_condition_LH_C_0_1_0) _lh_condition_LH_C_0_1_1) _lh_condition_LH_C_0_1_2) _lh_condition_LH_C_0_1_3) _lh_condition_LH_C_0_1_0) _lh_condition_LH_C_0_1_4) + (5 * ((((((expand_d1_d0_d0_d0 _lh_condition_LH_C_0_1_0) _lh_condition_LH_C_0_1_5) _lh_condition_LH_C_0_1_6) _lh_condition_LH_C_0_1_7) _lh_condition_LH_C_0_1_8) _lh_condition_LH_C_0_1_6))) = ((((((expand_d2_d0_d0_d0 _lh_condition_LH_C_0_1_9) _lh_condition_LH_C_0_1_2) _lh_condition_LH_C_0_1_9) _lh_condition_LH_C_0_1_6) _lh_condition_LH_C_0_1_0) _lh_condition_LH_C_0_1_4))
                                            | _ -> 
                                              (failwith "error"))
                                        | _ -> 
                                          (failwith "error"))
...
and enumFromTo_d1_d0_d0_d0 a_2 b_2 _lh_popOutId_0_0 =
  (if (a_2 <= b_2) then
    ...
    (`LH_N))
and filter_d0_d0_d0_d0 f_6 ls_6 =
  (match ls_6 with
    | `LH_C(h_4, t_4) -> 
      (if (f_6 h_4) then
        (`LH_C(h_4, ((filter_d0_d0_d0_d0 f_6) t_4)))
      else
...
and testCryptarithm_nofib_d0_d0_d0_d0 _lh_testCryptarithm_nofib_arg1_1 =
  ((map_d0_d0_d1_d0 (fun i_1 -> 
    (let rec p0_1 = ((take_d0_d0_d1_d0 10) ((enumFromTo_d0_d0_d0_d0 0) (9 + i_1))) in
      ((filter_d0_d0_d0_d0 condition_d0_d0_d0_d0) (permutations_d0_d0_d0_d0 p0_1))))) ((enumFromTo_d1_d0_d0_d0 1) _lh_testCryptarithm_nofib_arg1_1));;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Cryptarithm_nofib" (fun () -> ignore ((testCryptarithm_nofib_d0 1)));
  Bench.Test.create ~name:"lumberhack_Cryptarithm_nofib" (fun () -> ignore ((testCryptarithm_nofib_d0_d0_d0 1)));
  Bench.Test.create ~name:"lumberhack_pop_out_Cryptarithm_nofib" (fun () -> ignore ((testCryptarithm_nofib_d0_d0_d0_d0 1)));
])

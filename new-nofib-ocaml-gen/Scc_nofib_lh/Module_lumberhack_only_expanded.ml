...
let rec map__d0 f_1_3 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_2_2, t_2_3) -> 
      (`LH_C((f_1_3 h_2_2), ((map__d0 f_1_3) t_2_3)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend__d0 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_2_1, t_2_2) -> 
      (`LH_C(h_2_1, ((mappend__d0 t_2_2) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend__d1 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend__d1 t_2_4) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
      ...
      (let rec c_1 = 3 in
        (let rec d_1 = 4 in
          (let rec f_1_4 = 5 in
            (let rec g_1 = 6 in
              (let rec h_2_3 = 7 in
                (let rec vertices_1 = (`LH_C(a_6, (`LH_C(b_3, (`LH_C(c_1, (`LH_C(d_1, (`LH_C(f_1_4, (`LH_C(g_1, (`LH_C(h_2_3, (`LH_N))))))))))))))) in
                  (let rec edges_1 = (`LH_C((`LH_P2(b_3, a_6)), (`LH_C((`LH_P2(c_1, b_3)), (`LH_C((`LH_P2(c_1, d_1)), (`LH_C((`LH_P2(c_1, h_2_3)), (`LH_C((`LH_P2(d_1, c_1)), (`LH_C((`LH_P2(f_1_4, a_6)), (`LH_C((`LH_P2(f_1_4, g_1)), (`LH_C((`LH_P2(f_1_4, h_2_3)), (`LH_C((`LH_P2(g_1, f_1_4)), (`LH_C((`LH_P2(h_2_3, g_1)), (`LH_N))))))))))))))))))))) in

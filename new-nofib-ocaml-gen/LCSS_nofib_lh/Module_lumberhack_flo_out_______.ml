  ...
  (match ls_8 with
    | `LH_C(h_5, t_5) -> 
      ((reverse_helper_lh__d2 t_5) (let rec ty_0 = a_2 in
        (let rec hy_0 = h_5 in
          (fun hx_1 tx_1 -> 
            (let rec _lh_findk_LH_C_1_0 = (match tx_1 with
              | `LH_C(hx_2, tx_2) -> 
                ((ty_0 hx_2) tx_2)
              | `LH_N -> 
                ...
                (let rec _lh_findk_LH_P2_0_0 = hx_1 in
                  (fun _lh_findk_LH_C_1_1 _lh_findk_arg1_3 _lh_findk_arg2_3 _lh_findk_arg3_3 -> 
                    (if ((_lh_findk_LH_P2_0_0 + _lh_findk_LH_P2_1_0) >= _lh_findk_arg3_3) then
                      (((_lh_findk_LH_C_1_1 _lh_findk_arg1_3) (_lh_findk_arg1_3 + 1)) (_lh_findk_LH_P2_0_0 + _lh_findk_LH_P2_1_0))
                    else
                      (((_lh_findk_LH_C_1_1 _lh_findk_arg2_3) (_lh_findk_arg1_3 + 1)) _lh_findk_arg3_3))))) in
...
let rec reverse_lh__d2 ls_1_6 =
  ((reverse_helper_lh__d2 ls_1_6) (fun hx_6 tx_6 _lh_findk_arg2_1_0 _lh_findk_arg1_1_0 _lh_findk_arg3_1_0 -> 
    _lh_findk_arg2_1_0));;
      ...
      ((reverse_helper_lh__d5 t_0) (let rec _lh_algb1_LH_C_1_0 = a_0 in
        (let rec _lh_algb1_LH_C_0_0 = h_0 in
          (fun _lh_algb1_arg2_0 -> 
            (_lh_algb1_LH_C_1_0 ((((algb2_lh__d1 _lh_algb1_LH_C_0_0) 0) 0) _lh_algb1_arg2_0))))))
    | `LH_N -> 
      a_0);;
    ...
    | `LH_C(h_1_1, t_1_3) -> 
      ((reverse_helper_lh__d4 t_1_3) (let rec ty_1 = a_7 in
        (let rec hy_1 = h_1_1 in
          (fun hx_4 tx_4 -> 
            (let rec _lh_findk_LH_C_1_2 = (match tx_4 with
              | `LH_C(hx_5, tx_5) -> 
                ((ty_1 hx_5) tx_5)
              | `LH_N -> 
              ...
              (let rec _lh_findk_LH_C_0_1 = (let rec _lh_findk_LH_P2_1_1 = hy_1 in
                (let rec _lh_findk_LH_P2_0_1 = hx_4 in
                  (fun _lh_findk_LH_C_1_3 _lh_findk_arg1_8 _lh_findk_arg2_8 _lh_findk_arg3_8 -> 
                    (if ((_lh_findk_LH_P2_0_1 + _lh_findk_LH_P2_1_1) >= _lh_findk_arg3_8) then
                      (((_lh_findk_LH_C_1_3 _lh_findk_arg1_8) (_lh_findk_arg1_8 + 1)) (_lh_findk_LH_P2_0_1 + _lh_findk_LH_P2_1_1))
                    else
                      (((_lh_findk_LH_C_1_3 _lh_findk_arg2_8) (_lh_findk_arg1_8 + 1)) _lh_findk_arg3_8))))) in
                (fun _lh_findk_arg2_9 _lh_findk_arg1_9 _lh_findk_arg3_9 -> 
                  ((((_lh_findk_LH_C_0_1 _lh_findk_LH_C_1_2) _lh_findk_arg1_9) _lh_findk_arg2_9) _lh_findk_arg3_9))))))))
    | `LH_N -> 
      a_7);;
let rec reverse_lh__d4 ls_1_7 =
  ((reverse_helper_lh__d4 ls_1_7) (fun hx_9 tx_9 _lh_findk_arg2_1_3 _lh_findk_arg1_1_3 _lh_findk_arg3_1_3 -> 
    _lh_findk_arg2_1_3));;
...
let rec algb_lh__d2 _lh_algb_arg1_3 _lh_algb_arg2_3 =
  (`LH_C(0, ((algb1_lh__d2 _lh_algb_arg1_3) (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_5 -> 
    (match _lh_listcomp_fun_para_5 with
      | `LH_C(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_t_3) -> 
        (`LH_C((`LH_P2(_lh_listcomp_fun_ls_h_3, 0)), (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_3)))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_9 _lh_algb_arg2_3)))));;
                ...
                (let rec xs1_0 = ((take_lh__d3 m2_0) _lh_algc_arg3_0) in
                  (let rec xs2_0 = ((drop_lh__d1 m2_0) _lh_algc_arg3_0) in
                    (let rec l1_0 = ((algb_lh__d2 xs1_0) _lh_algc_arg4_0) in
                      (let rec l2_0 = (reverse_lh__d4 (`LH_C(0, ((algb1_lh__d3 (reverse_lh__d6 xs2_0)) (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_3 -> 
                        (_lh_listcomp_fun_para_3 _lh_listcomp_fun_7)) in
                        (_lh_listcomp_fun_7 (reverse_lh__d1 _lh_algc_arg4_0))))))) in
                        (let rec k_0 = ((((match l1_0 with
                          | `LH_C(hx_7, tx_7) -> 
                            ((l2_0 hx_7) tx_7)
                          | `LH_N -> 
                            (fun _lh_findk_arg2_1_1 _lh_findk_arg1_1_1 _lh_findk_arg3_1_1 -> 
                              _lh_findk_arg2_1_1)) 0) 0) (0 - 1)) in
                          (fun _lh_funcomp_x_0 -> 
            ...
            (let rec xs1_1 = ((take_lh__d2 m2_1) _lh_algc_arg3_0) in
              (let rec xs2_1 = ((drop_lh__d4 m2_1) _lh_algc_arg3_0) in
                (let rec l1_1 = ((algb_lh__d3 xs1_1) _lh_algc_arg4_0) in
                  (let rec l2_1 = (reverse_lh__d2 (`LH_C(0, ((reverse_lh__d5 xs2_1) (let rec _lh_listcomp_fun_8 = (fun _lh_listcomp_fun_para_4 -> 
                    (_lh_listcomp_fun_para_4 _lh_listcomp_fun_8)) in
                    (_lh_listcomp_fun_8 (reverse_lh__d3 _lh_algc_arg4_0))))))) in
                    (let rec k_1 = ((((match l1_1 with
                      | `LH_C(hx_8, tx_8) -> 
                        ((l2_1 hx_8) tx_8)
                      | `LH_N -> 
                        (fun _lh_findk_arg2_1_2 _lh_findk_arg1_1_2 _lh_findk_arg3_1_2 -> 
                          _lh_findk_arg2_1_2)) 0) 0) (0 - 1)) in
                      (fun _lh_funcomp_x_1 -> 

...
(* lumberhack_pop_out *)
let rec append_lz_d0_d0_d0 _lh_append_lz_arg1_4 _lh_append_lz_arg2_7 =
  (let rec _lh_matchIdent_9 = _lh_append_lz_arg1_4 in
    (_lh_matchIdent_9 _lh_append_lz_arg2_7));;
let rec append_lz_d0_d0_d1 _lh_append_lz_arg1_3 _lh_append_lz_arg2_6 =
  (let rec _lh_matchIdent_8 = _lh_append_lz_arg1_3 in
    (_lh_matchIdent_8 _lh_append_lz_arg2_6));;
let rec append_lz_d0_d0_d2 _lh_append_lz_arg1_2 _lh_append_lz_arg2_5 =
  (let rec _lh_matchIdent_7 = _lh_append_lz_arg1_2 in
    (_lh_matchIdent_7 _lh_append_lz_arg2_5));;
let rec append_lz_d1_d0_d0 _lh_append_lz_arg1_5 _lh_append_lz_arg2_8 =
  (let rec _lh_matchIdent_1_0 = _lh_append_lz_arg1_5 in
    (match _lh_matchIdent_1_0 with
      | `LH_C(_lh_append_lz_LH_C_0_3, _lh_append_lz_LH_C_1_3) -> 
        (lazy (`LH_C(_lh_append_lz_LH_C_0_3, ((append_lz_d1_d0_d0 _lh_append_lz_LH_C_1_3) _lh_append_lz_arg2_8))))
      | `LH_N -> 
        _lh_append_lz_arg2_8
      | _ -> 
        (failwith "error")));;
let rec carryPropagate_d0_d0_d0 _lh_carryPropagate_arg1_1 _lh_carryPropagate_arg2_1 =
  (lazy (let rec _lh_matchIdent_1_2 = (Lazy.force _lh_carryPropagate_arg2_1) in
...
let rec concat_lz_d0_d0_d1 _lh_concat_lz_arg1_2 =
  (lazy (let rec _lh_matchIdent_1_1 = (Lazy.force _lh_concat_lz_arg1_2) in
    _lh_matchIdent_1_1));;
let rec enumFromThen_d0_d0_d0 a_2 t_1_1 =
  (lazy (`LH_C(a_2, ((enumFromThen_d0_d0_d0 t_1_1) ((2 * t_1_1) - a_2)))));;
let rec head_lz_d0_d0_d0 ls_8 =
  (match (Lazy.force ls_8) with
    | `LH_C(h_7, t_8) -> 
      h_7
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_d0_d0_d0 f_8 ls_1_0 =
  (lazy ((Lazy.force ls_1_0) f_8));;
let rec map_lz_d0_d0_d1 f_4 ls_6 =
  (lazy ((Lazy.force ls_6) f_4));;
let rec map_lz_d1_d0_d0 f_5 ls_7 =
  (lazy (match (Lazy.force ls_7) with
    | `LH_C(h_6, t_7) -> 
      (`LH_C((f_5 h_6), ((map_lz_d1_d0_d0 f_5) t_7)))
    | `LH_N -> 
      (`LH_N)));;
...
let rec tail_lz_d1_d0_d0 ls_1_2 =
  (match (Lazy.force ls_1_2) with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec take_lz_d0_d0_d0 n_1 ls_1_1 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_1_1) with
      | `LH_C(h_1_0, t_1_2) -> 
        (`LH_C(h_1_0, ((take_lz_d0_d0_d0 (n_1 - 1)) t_1_2)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
  ...
  ((take_lz_d0_d0_d0 _lh_e_arg1_1) ((fun b_1 -> 
    ((append_lz_d0_d0_d0 (let rec _lh_append_lz_LH_C_0_4 = '2' in
      (let rec _lh_append_lz_LH_C_1_4 = (let rec _lh_append_lz_LH_C_0_5 = '.' in
        (let rec _lh_append_lz_LH_C_1_5 = (fun _lh_append_lz_arg2_9 -> 
          _lh_append_lz_arg2_9) in
          (fun _lh_append_lz_arg2_1_0 -> 
            (lazy (`LH_C(_lh_append_lz_LH_C_0_5, ((append_lz_d0_d0_d1 _lh_append_lz_LH_C_1_5) _lh_append_lz_arg2_1_0))))))) in
        (fun _lh_append_lz_arg2_1_1 -> 
          (lazy (`LH_C(_lh_append_lz_LH_C_0_4, ((append_lz_d0_d0_d2 _lh_append_lz_LH_C_1_4) _lh_append_lz_arg2_1_1)))))))) b_1)) ((fun _lh_funcomp_x_4 -> 
...
and iterate_d0_d0_d0 f_6 x_1 =
  (lazy (let rec h_9 = x_1 in
    (let rec t_1_0 = ((iterate_d0_d0_d0 f_6) (f_6 x_1)) in
      (fun f_7 -> 
        (let rec _lh_concat_lz_LH_C_0_1 = (f_7 h_9) in
          (let rec _lh_concat_lz_LH_C_1_1 = ((map_lz_d0_d0_d0 f_7) t_1_0) in

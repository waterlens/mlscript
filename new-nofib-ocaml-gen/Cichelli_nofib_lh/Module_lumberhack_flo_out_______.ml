...
let rec keys_lh__d1 _lh_keys_arg1_2 =
  (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (let rec t_3_5 = (fun n_2 f_2_9 -> 
    (`LH_N)) in
    (let rec h_2_8 = (`LH_C('a', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('c', (`LH_C('o', (`LH_C('t', (`LH_N))))))))))))))) in
      (fun n_3 -> 
        (let rec t_3_6 = (if ((n_3 - 1) > 0) then
          (t_3_5 (n_3 - 1))
        else
          (fun f_3_0 -> 
            (`LH_N))) in
          (let rec h_2_9 = h_2_8 in
            (fun f_3_1 -> 
              (`LH_C((f_3_1 h_2_9), (t_3_6 f_3_1))))))))) in
    (let rec h_3_0 = (`LH_C('p', (`LH_C('e', (`LH_C('a', (`LH_C('c', (`LH_C('h', (`LH_N))))))))))) in
      (fun n_4 -> 
        (let rec t_3_7 = (if ((n_4 - 1) > 0) then
          (t_3_4 (n_4 - 1))
        else
          (fun f_3_2 -> 
            (`LH_N))) in
      ...
      (fun n_5 -> 
        (let rec t_3_8 = (if ((n_5 - 1) > 0) then
          ...
          (let rec h_3_3 = h_3_2 in
            (fun f_3_5 -> 
              (`LH_C((f_3_5 h_3_3), (t_3_8 f_3_5))))))))) in
    (let rec h_3_4 = (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_N))))))))))) in
      (fun n_6 -> 
        (let rec t_3_9 = (if ((n_6 - 1) > 0) then
          (t_3_2 (n_6 - 1))
        else
          (fun f_3_6 -> 
            (`LH_N))) in
          (let rec h_3_5 = h_3_4 in
            (fun f_3_7 -> 
              (`LH_C((f_3_7 h_3_5), (t_3_9 f_3_7)))))))));;
let rec keys_lh__d4 _lh_keys_arg1_1 _lh_dummy_5 =
  (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (fun _lh_dummy_6 -> 
    0) in
    (fun _lh_dummy_7 -> 
      (1 + (t_2_2 99)))) in
    (fun _lh_dummy_8 -> 
    ...
    | `H(_lh_hinsert_H_0_0, _lh_hinsert_H_1_0, _lh_hinsert_H_2_0) -> 
      (let rec lo'_0 = ((minm_lh__d1 _lh_hinsert_H_0_0) _lh_hinsert_arg1_0) in
        (let rec hi'_0 = ((maxm_lh__d1 _lh_hinsert_H_1_0) _lh_hinsert_arg1_0) in
          (if (((member_lh__d3 _lh_hinsert_arg1_0) _lh_hinsert_H_2_0) || (((1 + hi'_0) - lo'_0) > ((keys_lh__d4 0) 99))) then
            (`Nothing)
          else
...
let rec assoc_lh__d1 _lh_assoc_arg1_1 _lh_assoc_arg2_1 =
  (match _lh_assoc_arg2_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d3 f_2_6 ls_1_3 _lh_popOutId_0_0 =
  (match ls_1_3 with
    | `LH_C(h_2_3, t_2_7) -> 
      (let rec _lh_first_LH_C_1_3 = ((map_lh__d3 f_2_6) t_2_7) in
        (let rec _lh_first_LH_C_0_3 = (f_2_6 h_2_3) in
          (let rec _lh_matchIdent_5 = _lh_first_LH_C_0_3 in
            (match _lh_matchIdent_5 with
              | `YesIts(_lh_first_YesIts_0_3, _lh_first_YesIts_1_3) -> 
                (`YesIts((_lh_popOutId_0_0 + _lh_first_YesIts_0_3), _lh_first_YesIts_1_3))
              | `NotEver(_lh_first_NotEver_0_3) -> 
                (_lh_first_LH_C_1_3 (_lh_popOutId_0_0 + _lh_first_NotEver_0_3))
              | _ -> 
                (failwith "error")))))
    | `LH_N -> 
      (`NotEver(_lh_popOutId_0_0)));;
let rec firstSuccess_lh__d1 _lh_firstSuccess_arg1_0 _lh_firstSuccess_arg2_0 =
  (((map_lh__d3 _lh_firstSuccess_arg1_0) _lh_firstSuccess_arg2_0) 0);;
let rec enumFromTo_lh__d4 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec t_4 = ((enumFromTo_lh__d4 (a_0 + 1)) b_0) in
      (let rec h_4 = a_0 in
        (fun f_1 -> 
          (let rec _lh_first_LH_C_1_0 = (t_4 f_1) in
                ...
                (let rec _lh_matchIdent_2 = _lh_first_LH_C_0_0 in
                  (match _lh_matchIdent_2 with
                    ...
                    | `NotEver(_lh_first_NotEver_0_0) -> 
                      (_lh_first_LH_C_1_0 (_lh_first_arg1_2 + _lh_first_NotEver_0_0))
                    | _ -> 
                      (failwith "error")))))))))
  else
...
let rec firstSuccess_lh__d3 _lh_firstSuccess_arg1_1 _lh_firstSuccess_arg2_1 =
  ((_lh_firstSuccess_arg2_1 _lh_firstSuccess_arg1_1) 0);;
  ...
  (if (a_4 <= b_4) then
    (let rec t_2_6 = ((enumFromTo_lh__d3 (a_4 + 1)) b_4) in
      (let rec h_2_2 = a_4 in
        (fun f_2_4 -> 
          (let rec _lh_first_LH_C_1_2 = (t_2_6 f_2_4) in
            (let rec _lh_first_LH_C_0_2 = (f_2_4 h_2_2) in
                ...
                (let rec _lh_matchIdent_3 = _lh_first_LH_C_0_1 in
                  (match _lh_matchIdent_3 with
                    ...
                    | `NotEver(_lh_first_NotEver_0_1) -> 
                      (_lh_first_LH_C_1_1 (_lh_first_arg1_6 + _lh_first_NotEver_0_1))
                    | _ -> 
                      (failwith "error")))))))))
  else
    (fun f_2_2 _lh_first_arg1_7 -> 
      ...
      (let rec _lh_ends_K_1_2 = (head_lh__d2 k_1) in
        (let rec t_2_8 = (let rec t_2_9 = (fun ys_7 -> 
          ...
          (let rec h_2_4 = _lh_ends_K_2_2 in
            (fun ys_8 -> 
              (let rec t_3_0 = (t_2_9 ys_8) in
                (let rec h_2_5 = h_2_4 in
                  (fun f_2_7 i_3 -> 
                    ((f_2_7 h_2_5) ((t_3_0 f_2_7) i_3)))))))) in
          (let rec h_2_6 = _lh_ends_K_1_2 in
            (fun ys_9 -> 
              (let rec t_3_1 = (t_2_8 ys_9) in
                (let rec h_2_7 = h_2_6 in
                  (fun f_2_8 i_4 -> 
                    ((f_2_8 h_2_7) ((t_3_1 f_2_8) i_4))))))))))));;
let rec freqtab_lh__d1 _lh_freqtab_arg1_0 =
  (histo_lh__d1 (((attribkeys_lh__d2 (keys_lh__d3 0)) ends_lh__d3) 99));;
      ...
      (if (_lh_select_arg1_0 _lh_select_arg2_0) then
        (`LH_P2((let rec t_2 = _lh_select_LH_P2_0_0 in
          (let rec h_2 = _lh_select_arg2_0 in
            (fun ys_1 -> 
              (let rec _lh_findhash'_LH_C_1_0 = (t_2 ys_1) in
                      ...
                      | `K(_lh_findhash'_K_0_0, _lh_findhash'_K_1_0, _lh_findhash'_K_2_0, _lh_findhash'_K_3_0) -> 
                        (let rec try_0 = (fun newAssocs_0 -> 
                          (let rec newCharAssocs_0 = ((mappend_lh__d3 newAssocs_0) _lh_findhash'_arg2_0) in
                            (let rec _lh_matchIdent_0 = ((hinsert_lh__d1 ((let rec _lh_hash_K_3_0 = _lh_findhash'_K_3_0 in
  ...
  (match _lh_blocked'_arg2_0 with
    ...
    | `LH_C(_lh_blocked'_LH_C_0_0, _lh_blocked'_LH_C_1_0) -> 
      (let rec ds'_0 = ((mappend_lh__d4 _lh_blocked'_arg1_0) (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_3 -> 
        ...
        (_lh_listcomp_fun_1_2 (ends_lh__d2 _lh_blocked'_LH_C_0_0)))) in
                            ...
                            | `K(_lh_findhash'_K_0_1, _lh_findhash'_K_1_4, _lh_findhash'_K_2_4, _lh_findhash'_K_3_1) -> 
                              (let rec try_4 = (fun newAssocs_1 -> 
                                (let rec newCharAssocs_1 = ((mappend_lh__d3 newAssocs_1) _lh_findhash'_arg2_3) in
                                  (let rec _lh_matchIdent_8 = ((hinsert_lh__d1 ((let rec _lh_hash_K_3_1 = _lh_findhash'_K_3_1 in

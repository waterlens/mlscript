  ...
  (if (_lh_copy_arg1_7 > 0) then
    (let rec t_3_6 = ((copy_lh__d3 (_lh_copy_arg1_7 - 1)) _lh_copy_arg2_7) in
      (let rec h_3_6 = _lh_copy_arg2_7 in
        (fun ys_3_7 -> 
          (`LH_C(h_3_6, ((mappend_lh__d5 t_3_6) ys_3_7))))))
  else
    (fun ys_3_8 -> 
      ys_3_8));;
  ...
  (if (_lh_copy_arg1_5 > 0) then
    (let rec t_3_3 = ((copy_lh__d2 (_lh_copy_arg1_5 - 1)) _lh_copy_arg2_5) in
      (let rec h_3_3 = _lh_copy_arg2_5 in
        (fun ys_3_3 -> 
          (`LH_C(h_3_3, ((mappend_lh__d1 t_3_3) ys_3_3))))))
  else
    (fun ys_3_4 -> 
      ys_3_4));;
    ...
    (let rec tx_0 = ((copy_lh__d1_d0 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
      (let rec hx_0 = _lh_copy_arg2_3 in
        (fun f_7 ys_2_1 -> 
          (match ys_2_1 with
            | `LH_C(hy_0, ty_0) -> 
              (let rec tx_1 = (((zipWith_lh__d2 f_7) tx_0) ty_0) in
  ...
  (if (_lh_copy_arg1_0 > 0) then
    (let rec t_0 = ((copy_lh__d9 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec h_0 = _lh_copy_arg2_0 in
        (fun ys_1 -> 
          (`LH_C(h_0, ((mappend_lh__d7 t_0) ys_1))))))
  else
    (fun ys_2 -> 
      ys_2));;
  ...
  (if (_lh_copy_arg1_6 > 0) then
    (let rec ty_1 = ((copy_lh__d6 (_lh_copy_arg1_6 - 1)) _lh_copy_arg2_6) in
      (let rec hy_1 = _lh_copy_arg2_6 in
        (fun f_2_9 hx_2 tx_2 -> 
          (let rec t_3_4 = (((zipWith_lh__d1 f_2_9) tx_2) ty_1) in
            (let rec h_3_4 = ((f_2_9 hx_2) hy_1) in
              (fun ys_3_5 -> 
                (`LH_C(h_3_4, ((mappend_lh__d8 t_3_4) ys_3_5)))))))))
  else
        ...
        (let rec _lh_zip3_LH_C_1_1_2 = ((take_lh__d2 (n_0 - 1)) t_1_0) in
          (let rec _lh_zip3_LH_C_0_1_2 = h_1_0 in
            (fun _lh_zip3_LH_C_0_1_3 _lh_zip3_LH_C_1_1_3 _lh_zip3_arg3_1_3 -> 
              (let rec _lh_matchIdent_1_2 = _lh_zip3_arg3_1_3 in
                ((((_lh_matchIdent_1_2 _lh_zip3_LH_C_0_1_2) _lh_zip3_LH_C_0_1_3) _lh_zip3_LH_C_1_1_2) _lh_zip3_LH_C_1_1_3)))))
      | `LH_N -> 

...
and apply_component_lh _lh_apply_component_arg1_0 _lh_apply_component_arg2_0 =
  (match _lh_apply_component_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and check_depth_lh _lh_check_depth_arg1_0 _lh_check_depth_arg2_0 =
...
and circuit_simulate_lh _lh_circuit_simulate_arg1_0 _lh_circuit_simulate_arg2_0 =
  ((map_lh collect_outputs_lh) ((simulate_lh _lh_circuit_simulate_arg1_0) _lh_circuit_simulate_arg2_0))
and collect_outputs_lh _lh_collect_outputs_arg1_0 =
...
and concat_lh lss_0 =
  (match lss_0 with
    ...
    | `LH_N -> 
      (`LH_N))
and critical_path_depth_lh _lh_critical_path_depth_arg1_0 =
  (match _lh_critical_path_depth_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and do_cycle_lh _lh_do_cycle_arg1_0 _lh_do_cycle_arg2_0 _lh_do_cycle_arg3_0 =
  (match _lh_do_cycle_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and do_send_lh _lh_do_send_arg1_0 _lh_do_send_arg2_0 =
...
and nearest_power_of_two_lh _lh_nearest_power_of_two_arg1_0 =
  (((until_lh (fun a_2 -> 
    (a_2 >= _lh_nearest_power_of_two_arg1_0))) (fun a_3 -> 
    (a_3 * 2))) 1)
and pad_circuit_lh _lh_pad_circuit_arg1_0 =
  (match _lh_pad_circuit_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and pad_packets_lh _lh_pad_packets_arg1_0 =
...
and restore_requests_lh _lh_restore_requests_arg1_0 _lh_restore_requests_arg2_0 =
...
and run_lh _lh_run_arg1_0 _lh_run_arg2_0 =
...
and scanlr_lh _lh_scanlr_arg1_0 _lh_scanlr_arg2_0 _lh_scanlr_arg3_0 _lh_scanlr_arg4_0 _lh_scanlr_arg5_0 =
  ...
  in (let rec xs'_0 = ((map_lh (fun x_0 -> 
    ...
    (let rec _lh_matchIdent_5 = ((((sweep_ud_lh ((up_0 _lh_scanlr_arg1_0) _lh_scanlr_arg2_0)) ((down_0 _lh_scanlr_arg1_0) _lh_scanlr_arg2_0)) (`LH_P2(_lh_scanlr_arg3_0, _lh_scanlr_arg4_0))) (put_lh xs'_0)) in
      (match _lh_matchIdent_5 with
        ...
        | _ -> 
          (failwith "error"))))
and send_lh _lh_send_arg1_0 =
  (((((scanlr_lh send_right_lh) send_left_lh) emptyPacket_lh) emptyPacket_lh) _lh_send_arg1_0)
and simulate_component_lh _lh_simulate_component_arg1_0 _lh_simulate_component_arg2_0 =
...
and simulate_components_lh _lh_simulate_components_arg1_0 _lh_simulate_components_arg2_0 =
  ((map_lh (simulate_component_lh _lh_simulate_components_arg1_0)) _lh_simulate_components_arg2_0)
and simulate_lh _lh_simulate_arg1_0 _lh_simulate_arg2_0 =
...
and store_inputs_lh _lh_store_inputs_arg1_0 _lh_store_inputs_arg2_0 =
  (match _lh_store_inputs_arg2_0 with
    ...
    | _ -> 
      _lh_store_inputs_arg2_0)
and sweep_ud_lh _lh_sweep_ud_arg1_0 _lh_sweep_ud_arg2_0 _lh_sweep_ud_arg3_0 _lh_sweep_ud_arg4_0 =
  (let rec _lh_matchIdent_4 = ((upsweep_lh _lh_sweep_ud_arg1_0) _lh_sweep_ud_arg4_0) in
    (match _lh_matchIdent_4 with
      ...
      | _ -> 
        (failwith "error")))
and testCircsim_nofib_lh _lh_testCircsim_nofib_arg1_0 =
...
and up_i_lh _lh_up_i_arg1_0 _lh_up_i_arg2_0 =
  (match _lh_up_i_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and updateInports_lh _lh_updateInports_arg1_0 _lh_updateInports_arg2_0 =
...
and updateOutports_lh _lh_updateOutports_arg1_0 _lh_updateOutports_arg2_0 =
...
and update_i_lh _lh_update_i_arg1_0 _lh_update_i_arg2_0 =
  (match _lh_update_i_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and update_io_lh _lh_update_io_arg1_0 _lh_update_io_arg2_0 _lh_update_io_arg3_0 =
...
and update_o_lh _lh_update_o_arg1_0 _lh_update_o_arg2_0 =
  (match _lh_update_o_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and update_outports_lh _lh_update_outports_arg1_0 _lh_update_outports_arg2_0 =
...
and update_requests_lh _lh_update_requests_arg1_0 _lh_update_requests_arg2_0 =

...
let rec return_lh__d7 _lh_return_arg1_5 =
  (`StateT((fun s_1_3 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_5, s_1_3)), (`LH_N))))));;
...
let rec lift_lh__d1 _lh_lift_arg1_0 =
  (`StateT((fun s_5 -> 
    (((map_lh__d7 (fun x_1 -> 
      (`LH_C((`LH_P2(x_1, s_5)), (`LH_N))))) _lh_lift_arg1_0) 99))));;
...
let rec return_lh__d4 _lh_return_arg1_6 =
  (`StateT((fun s_1_7 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_6, s_1_7)), (`LH_N))))));;
    ...
    (((map_lh__d7 (fun as_6 -> 
      (let rec _lh_matchIdent_1_5 = as_6 in
        (match _lh_matchIdent_1_5 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d9 _lh_bind_arg1_5) s_1_8)) 99)) in
      ...
      (let rec _lh_matchIdent_9 = as_4 in
        (match _lh_matchIdent_9 with
          | `LH_P2(_lh_bind_LH_P2_0_3, _lh_bind_LH_P2_1_3) -> 
            ((_lh_bind_arg2_4 _lh_bind_LH_P2_0_3) _lh_bind_LH_P2_1_3)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d7 _lh_bind_arg1_3) s_1_2)) 99))));;
let rec rest_lh__d1 _lh_rest_arg1_0 =
  (match _lh_rest_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d4 f_1_4 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_3_4, t_3_4) -> 
      (let rec t_3_5 = ((map_lh__d4 f_1_4) t_3_4) in
        (let rec h_3_5 = (f_1_4 h_3_4) in
          (fun _lh_dummy_1_7 -> 
            ((mappend_lh__d8 h_3_5) (t_3_5 99)))))
    | `LH_N -> 
      (fun _lh_dummy_1_8 -> 
        (`LH_N)));;
let rec bind_lh__d1 _lh_bind_arg1_6 _lh_bind_arg2_7 =
  (let rec _lh_runStateT_StateT_0_9 = (fun s_1_9 -> 
    (((map_lh__d4 (fun as_7 -> 
      (let rec _lh_matchIdent_1_6 = as_7 in
        (match _lh_matchIdent_1_6 with
          | `LH_P2(_lh_bind_LH_P2_0_6, _lh_bind_LH_P2_1_6) -> 
            ((_lh_bind_arg2_7 _lh_bind_LH_P2_0_6) _lh_bind_LH_P2_1_6)
          | _ -> 
            (failwith "error"))))) (_lh_bind_arg1_6 s_1_9)) 99)) in
      ...
      (let rec _lh_matchIdent_2 = as_0 in
        (match _lh_matchIdent_2 with
          | `LH_P2(_lh_bind_LH_P2_0_0, _lh_bind_LH_P2_1_0) -> 
            ((_lh_bind_arg2_0 _lh_bind_LH_P2_0_0) _lh_bind_LH_P2_1_0)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d9 _lh_bind_arg1_0) s_3)) 99))));;
...
let rec return_lh__d6 _lh_return_arg1_4 =
  (`StateT((fun s_8 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_4, s_8)), (`LH_N))))));;
    ...
    (((map_lh__d7 (fun as_3 -> 
      (let rec _lh_matchIdent_8 = as_3 in
        (match _lh_matchIdent_8 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d9 _lh_bind_arg1_2) s_1_1)) 99))));;
      ...
      ((bind_lh__d4 (let rec _lh_matchIdent_3 = _lh_solve_arg1_0 in
        ...
        ((bind_lh__d1 (select_lh__d1 _lh_solve_LH_C_0_0)) (fun botN_0 -> 
          (let rec _lh_runStateT_StateT_0_3 = (fun s_6 -> 
            ((((guard_lh__d1 ((topN_0 mod 10) = botN_0)) s_6) (fun as_1 -> 
              (let rec _lh_matchIdent_4 = as_1 in
                (_lh_matchIdent_4 (fun _s_0 -> 
...
let rec puzzle_lh__d1 _lh_puzzle_arg1_0 _lh_puzzle_arg2_0 =
  (let rec solution_0 = (((solve_lh__d1 (transpose_lh__d1 ((map_lh__d1 reverse_lh__d1) _lh_puzzle_arg1_0))) (reverse_lh__d2 _lh_puzzle_arg2_0)) 0) in
    (let rec answer_0 = (let rec _lh_matchIdent_1_0 = ((execStateT_lh__d1 solution_0) (`Digits(((enumFromTo_lh__d1 0) 9), (`LH_N)))) in
                          ...
                          (match _lh_listcomp_fun_ls_h_1 with
                            | `LH_P2(_lh_puzzle_LH_P2_0_0, _lh_puzzle_LH_P2_1_0) -> 
                              (let rec t_1_8 = (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1) in
                                (let rec h_1_8 = (((let rec t_1_9 = (fun ys_1_0 -> 
                                  ys_1_0) in
                                  (let rec h_1_9 = _lh_puzzle_LH_P2_0_0 in
                                    (fun ys_1_1 -> 
                                      (let rec t_2_0 = (t_1_9 ys_1_1) in
                                        (let rec h_2_0 = h_1_9 in
                                          (fun ys_1_2 -> 
                                            (`LH_C(h_2_0, (t_2_0 ys_1_2))))))))) (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (fun ys_1_3 -> 
                                  ys_1_3) in
                                  (let rec h_2_1 = ' ' in
                                    (fun ys_1_4 -> 
                                      (`LH_C(h_2_1, (t_2_4 ys_1_4)))))) in
                                  (let rec h_2_2 = '>' in
                                    (fun ys_1_5 -> 
                                      (`LH_C(h_2_2, (t_2_3 ys_1_5)))))) in
                                  (let rec h_2_3 = '=' in
                                    (fun ys_1_6 -> 
                                      (`LH_C(h_2_3, (t_2_2 ys_1_6)))))) in
                                  (let rec h_2_4 = ' ' in
                                    (fun ys_1_7 -> 
                                      (`LH_C(h_2_4, (t_2_1 ys_1_7))))))) (string_of_int _lh_puzzle_LH_P2_1_0)) in
                                  (fun f_9 -> 
                                    (let rec t_2_5 = (t_1_8 f_9) in
...
let rec testCryptarithm2_nofib_lh__d1 _lh_testCryptarithm2_nofib_arg1_0 =
  (let rec args_0 = (`LH_C((`LH_C('T', (`LH_C('H', (`LH_C('I', (`LH_C('R', (`LH_C('T', (`LH_C('Y', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C(((let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (let rec t_3_3 = (fun ys_1_8 -> 
    ys_1_8) in
    (let rec h_2_8 = 'E' in
      (fun ys_1_9 -> 
        (`LH_C(h_2_8, (t_3_3 ys_1_9)))))) in
    (let rec h_2_9 = 'V' in
      (fun ys_2_0 -> 
        (`LH_C(h_2_9, (t_3_2 ys_2_0)))))) in
    (let rec h_3_0 = 'L' in
      (fun ys_2_1 -> 
        (`LH_C(h_3_0, (t_3_1 ys_2_1)))))) in
    (let rec h_3_1 = 'E' in
      (fun ys_2_2 -> 
        (`LH_C(h_3_1, (t_3_0 ys_2_2)))))) in
    (let rec h_3_2 = 'W' in
      (fun ys_2_3 -> 
        (`LH_C(h_3_2, (t_2_9 ys_2_3)))))) in
    (let rec h_3_3 = 'T' in
      (fun ys_2_4 -> 
        (`LH_C(h_3_3, (t_2_8 ys_2_4)))))) (if (_lh_testCryptarithm2_nofib_arg1_0 > 999999) then
    (`LH_C('1', (`LH_N)))
  else
    (`LH_N))), (`LH_N))))))))))))) in

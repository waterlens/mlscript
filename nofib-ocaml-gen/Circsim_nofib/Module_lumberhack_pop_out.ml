...
let rec enumFromTo__d1 a_0 b_0 _lh_popOutId_0_4 _lh_popOutId_1_1 _lh_popOutId_2_0 =
  (if (a_0 <= b_0) then
      ...
      (let rec _lh_listcomp_fun_ls_h_3 = a_0 in
        (let rec ty_1 = (_lh_popOutId_0_4 _lh_listcomp_fun_ls_t_3) in
          (let rec hy_1 = ((7 * _lh_listcomp_fun_ls_h_3) + 1) in
            ((((Lazy.force _lh_popOutId_2_0) _lh_popOutId_1_1) hy_1) ty_1)))))
  else
    (`LH_N));;
let rec enumFromTo__d2 a_7 b_3 _lh_popOutId_0_1_4 _lh_popOutId_1_8 _lh_popOutId_2_3 =
  (if (a_7 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_1_4 = ((enumFromTo__d2 (a_7 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_1_3 = a_7 in
        (let rec ty_8 = (_lh_popOutId_0_1_4 _lh_listcomp_fun_ls_t_1_4) in
          (let rec hy_8 = ((7 * _lh_listcomp_fun_ls_h_1_3) + 7) in
            ((((Lazy.force _lh_popOutId_2_3) _lh_popOutId_1_8) hy_8) ty_8)))))
  else
    (`LH_N));;
...
and collect_outputs__d0 _lh_collect_outputs_arg1_0 =
  (match _lh_collect_outputs_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and combine__d0 _lh_combine_arg1_1 _lh_combine_arg2_1 _lh_combine_arg3_1 _lh_combine_arg4_1 f_3_7 =
...
and combine__d1 _lh_combine_arg1_2 _lh_combine_arg2_2 _lh_combine_arg3_2 _lh_combine_arg4_2 f_4_1 ys_1_3 =
  (let rec tx_3 = (transpose__d1 (`LH_C(_lh_combine_arg3_2, _lh_combine_arg4_2))) in
    (let rec hx_3 = (`LH_C(_lh_combine_arg1_2, _lh_combine_arg2_2)) in
      (match ys_1_3 with
        ...
        | `LH_N -> 
          (`LH_N))))
and combine__d2 _lh_combine_arg1_0 _lh_combine_arg2_0 _lh_combine_arg3_0 _lh_combine_arg4_0 f_2_2 =
...
and combine__d3 _lh_combine_arg1_3 _lh_combine_arg2_3 _lh_combine_arg3_3 _lh_combine_arg4_3 f_4_4 ys_1_4 =
  (let rec tx_4 = (transpose__d3 (`LH_C(_lh_combine_arg3_3, _lh_combine_arg4_3))) in
    (let rec hx_4 = (`LH_C(_lh_combine_arg1_3, _lh_combine_arg2_3)) in
      (match ys_1_4 with
        ...
        | `LH_N -> 
          (`LH_N))))
and copy__d0 _lh_copy_arg1_3 _lh_copy_arg2_3 _lh_popOutId_0_1_3 =
  (if (_lh_copy_arg1_3 > 0) then
    (let rec t_4_4 = ((copy__d0 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
      (let rec h_4_4 = _lh_copy_arg2_3 in
        (`LH_C(h_4_4, ((take__d0 (_lh_popOutId_0_1_3 - 1)) t_4_4)))))
  else
    (`LH_N))
and copy__d1 _lh_copy_arg1_4 _lh_copy_arg2_4 _lh_popOutId_0_1_8 =
  (if (_lh_copy_arg1_4 > 0) then
    (let rec t_8_1 = ((copy__d1 (_lh_copy_arg1_4 - 1)) _lh_copy_arg2_4) in
      (let rec h_8_1 = _lh_copy_arg2_4 in
        (`LH_C(h_8_1, ((take__d2 (_lh_popOutId_0_1_8 - 1)) t_8_1)))))
  else
    (`LH_N))
and copy__d2 _lh_copy_arg1_2 _lh_copy_arg2_2 _lh_popOutId_0_1_0 _lh_popOutId_1_6 _lh_popOutId_2_2 _lh_popOutId_3_0 _lh_popOutId_4_0 _lh_popOutId_5_0 _lh_popOutId_6_0 =
  (if (_lh_copy_arg1_2 > 0) then
    (let rec ty_6 = ((copy__d2 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec hy_6 = _lh_copy_arg2_2 in
        (let rec _lh_listcomp_fun_ls_t_7 = ((zip__d0 _lh_popOutId_1_6) ty_6) in
          (let rec _lh_listcomp_fun_ls_h_7 = (let rec _lh_store_inputs_LH_P2_1_0 = hy_6 in
            (let rec _lh_store_inputs_LH_P2_0_0 = _lh_popOutId_0_1_0 in
    ...
    (`LH_N))
and copy__d3 _lh_copy_arg1_1 _lh_copy_arg2_1 _lh_popOutId_0_7 _lh_popOutId_1_3 =
  (if (_lh_copy_arg1_1 > 0) then
    (let rec _lh_scanl_LH_C_1_0 = ((copy__d3 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
      (let rec _lh_scanl_LH_C_0_0 = _lh_copy_arg2_1 in
        (((scanl__d0 _lh_popOutId_0_7) ((_lh_popOutId_0_7 _lh_popOutId_1_3) _lh_scanl_LH_C_0_0)) _lh_scanl_LH_C_1_0)))
  else
    (`LH_N))
and copy__d4 _lh_copy_arg1_0 _lh_copy_arg2_0 _lh_popOutId_0_6 =
  (if (_lh_copy_arg1_0 > 0) then
    (let rec t_2_3 = ((copy__d4 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec h_2_3 = _lh_copy_arg2_0 in
        (`LH_C(h_2_3, ((take__d4 (_lh_popOutId_0_6 - 1)) t_2_3)))))
  else
    (`LH_N))
...
and enumFromTo__d0 a_3 b_1 _lh_popOutId_0_8 _lh_popOutId_1_4 =
  (if (a_3 <= b_1) then
    (let rec t_3_7 = ((enumFromTo__d0 (a_3 + 1)) b_1) in
      (let rec h_3_7 = a_3 in
        (((foldl__d0 _lh_popOutId_0_8) ((_lh_popOutId_0_8 _lh_popOutId_1_4) h_3_7)) t_3_7)))
  else
    _lh_popOutId_1_4)
and enumFromTo__d3 a_4 b_2 _lh_popOutId_0_9 _lh_popOutId_1_5 _lh_popOutId_2_1 =
  (if (a_4 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_6 = ((enumFromTo__d3 (a_4 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_6 = a_4 in
        (let rec t_3_8 = (_lh_popOutId_0_9 _lh_listcomp_fun_ls_t_6) in
          (let rec h_3_8 = ((7 * _lh_listcomp_fun_ls_h_6) + 1) in
            (let rec t_3_9 = ((map__d2_d8 _lh_popOutId_1_5) t_3_8) in
              (let rec h_3_9 = (_lh_popOutId_1_5 h_3_8) in
...
and map__d1_d3 f_8_0 ls_4_3 _lh_popOutId_0_1_6 =
  (match ls_4_3 with
    | `LH_C(h_7_7, t_7_7) -> 
      (let rec t_7_8 = ((map__d1_d3 f_8_0) t_7_7) in
        (let rec h_7_8 = (f_8_0 h_7_7) in
          (`LH_C((_lh_popOutId_0_1_6 h_7_8), ((map__d1_d2 _lh_popOutId_0_1_6) t_7_8)))))
    | `LH_N -> 
      (`LH_N))
and map__d1_d4 f_6_0 ls_3_5 _lh_popOutId_0_1_2 =
  (match ls_3_5 with
    | `LH_C(h_4_1, t_4_1) -> 
    ...
    | `LH_N -> 
      false)
and map__d1_d5 f_2_3 ls_1_3 _lh_popOutId_0_3 _lh_popOutId_1_0 =
  (match ls_1_3 with
    | `LH_C(h_1_7, t_1_7) -> 
      (let rec t_1_8 = ((map__d1_d5 f_2_3) t_1_7) in
        (let rec h_1_8 = (f_2_3 h_1_7) in
          (let rec _lh_or_LH_C_1_1 = ((map__d1_d6 _lh_popOutId_0_3) t_1_8) in
            (let rec _lh_or_LH_C_0_1 = (_lh_popOutId_0_3 h_1_8) in
    ...
    | `LH_N -> 
      false)
and map__d1_d7 f_1_5 ls_1_2 _lh_popOutId_0_2 =
  (match ls_1_2 with
    | `LH_C(h_1_2, t_1_2) -> 
      (let rec t_1_3 = ((map__d1_d7 f_1_5) t_1_2) in
        (let rec h_1_3 = (f_1_5 h_1_2) in
          (`LH_C((_lh_popOutId_0_2 h_1_3), ((map__d1_d9 _lh_popOutId_0_2) t_1_3)))))
    | `LH_N -> 
      (`LH_N))
and map__d2_d4 f_7_6 ls_4_0 _lh_popOutId_0_1_5 =
  (match ls_4_0 with
    | `LH_C(h_5_1, t_5_1) -> 
      (let rec t_5_2 = ((map__d2_d4 f_7_6) t_5_1) in
        (let rec h_5_2 = (f_7_6 h_5_1) in
          (`LH_C((_lh_popOutId_0_1_5 h_5_2), ((map__d2_d3 _lh_popOutId_0_1_5) t_5_2)))))
    | `LH_N -> 
      (`LH_N))
and map__d3 f_1_2 ls_9 _lh_popOutId_0_1 =
  (match ls_9 with
    | `LH_C(h_5, t_5) -> 
    ...
    | `LH_N -> 
      false)
and map__d4 f_3_0 ls_1_5 _lh_popOutId_0_5 _lh_popOutId_1_2 =
  (match ls_1_5 with
    | `LH_C(h_1_9, t_1_9) -> 
      (let rec t_2_0 = ((map__d4 f_3_0) t_1_9) in
        (let rec h_2_0 = (f_3_0 h_1_9) in
          (let rec _lh_or_LH_C_1_2 = ((map__d5 _lh_popOutId_0_5) t_2_0) in
            (let rec _lh_or_LH_C_0_2 = (_lh_popOutId_0_5 h_2_0) in
    ...
    | `LH_N -> 
      false)
and map__d6 f_8 ls_7 _lh_popOutId_0_0 =
  (match ls_7 with
    | `LH_C(h_3, t_3) -> 
      (let rec t_4 = ((map__d6 f_8) t_3) in
        (let rec h_4 = (f_8 h_3) in
          (`LH_C((_lh_popOutId_0_0 h_4), ((map__d8 _lh_popOutId_0_0) t_4)))))
    | `LH_N -> 
      (`LH_N))
    ...
    | _ -> 
      (let rec _lh_matchIdent_2_9 = ((splitAt__d1 ((length__d3 _lh_put_arg1_1) / 2)) _lh_put_arg1_1) in
        (match _lh_matchIdent_2_9 with
          ...
          | _ -> 
            (failwith "error"))))
and reg__d0 _lh_reg_arg1_0 _lh_reg_arg2_0 ys_3_7 ys_3_8 n_1_7 =
...
and regs__d0 _lh_regs_arg1_0 _lh_dummy_2 _lh_simulate_arg1_0 =
  let rec ilabel_0 = (fun _lh_ilabel_arg1_0 _lh_ilabel_arg2_0 -> 
    (`LH_P2(((mappend__d7 (let rec t_6 = (fun ys_5 -> 
      ys_5) in
      (let rec h_6 = 'x' in
        (fun ys_6 -> 
          (`LH_C(h_6, ((mappend__d7 t_6) ys_6))))))) (string_of_int _lh_ilabel_arg1_0)), _lh_ilabel_arg2_0)))
  and olabel_0 = (fun _lh_olabel_arg1_0 _lh_olabel_arg2_0 -> 
    (`LH_P2(((mappend__d6 (let rec t_7 = (fun ys_7 -> 
      ys_7) in
      (let rec h_7 = 'y' in
        (fun ys_8 -> 
          (`LH_C(h_7, ((mappend__d6 t_7) ys_8))))))) (string_of_int _lh_olabel_arg1_0)), _lh_olabel_arg2_0)))

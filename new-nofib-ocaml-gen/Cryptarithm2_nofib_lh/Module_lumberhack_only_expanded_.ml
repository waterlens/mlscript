...
let rec enumFromTo_lh__d1 a_4 b_1 =
  (if (a_4 <= b_1) then
    ...
    (`LH_N));;
let rec mappend_lh__d1 xs_1_0 ys_7 =
  (match xs_1_0 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d1 t_2_4) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec filter_lh__d1 f_4 ls_5 =
  (match ls_5 with
    | `LH_C(h_1_1, t_1_1) -> 
      (if (f_4 h_1_1) then
        (`LH_C(h_1_1, ((filter_lh__d1 f_4) t_1_1)))
      else
        ((filter_lh__d1 f_4) t_1_1))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d6 f_1 ls_1 =
  (match ls_1 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C((f_1 h_1), ((map_lh__d6 f_1) t_1)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d8 xs_2 ys_0 =
  (match xs_2 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d8 t_5) ys_0)))
    | `LH_N -> 
      ys_0);;
let rec concat_lh__d5 lss_0 =
  (match lss_0 with
    | `LH_C(h_2, t_2) -> 
      ((mappend_lh__d8 h_2) (concat_lh__d5 t_2))
    | `LH_N -> 
      (`LH_N));;
let rec runStateT_lh__d6 _lh_runStateT_arg1_0 =
      ...
      (let rec _lh_matchIdent_3 = as_2 in
        (match _lh_matchIdent_3 with
          | `LH_P2(_lh_bind_LH_P2_0_2, _lh_bind_LH_P2_1_2) -> 
            ((runStateT_lh__d6 (_lh_bind_arg2_2 _lh_bind_LH_P2_0_2)) _lh_bind_LH_P2_1_2)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_2) s_6))))));;
let rec lookup_lh__d3 _lh_lookup_arg1_0 _lh_lookup_arg2_0 =
  (match _lh_lookup_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec bind_lh__d8 _lh_bind_arg1_0 _lh_bind_arg2_0 =
  (`StateT((fun s_2 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_0 -> 
      (let rec _lh_matchIdent_0 = as_0 in
        (match _lh_matchIdent_0 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_0) s_2))))));;
let rec return_lh__d7 _lh_return_arg1_0 =
  (`StateT((fun s_3 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_0, s_3)), (`LH_N))))));;
...
let rec lift_lh__d1 _lh_lift_arg1_0 =
  (`StateT((fun s_0 -> 
    (concat_lh__d5 ((map_lh__d6 (fun x_0 -> 
      (`LH_C((`LH_P2(x_0, s_0)), (`LH_N))))) _lh_lift_arg1_0)))));;
let rec foldl_lh__d1 f_6 i_1 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_6, t_1_6) -> 
      (((foldl_lh__d1 f_6) ((f_6 i_1) h_1_6)) t_1_6)
    | `LH_N -> 
      i_1);;
...
let rec permute_lh__d2 _lh_permute_arg1_0 =
  ((bind_lh__d8 get_lh__d2) (fun st_0 -> 
    ((bind_lh__d8 (let rec xs_0 = (digits_lh__d1 st_0) in
      ...
      (let rec _lh_matchIdent_2 = iis_0 in
        (match _lh_matchIdent_2 with
          | `LH_P2(_lh_permute_LH_P2_0_0, _lh_permute_LH_P2_1_0) -> 
            ((bind_lh__d8 (put_lh__d1 (`Digits(_lh_permute_LH_P2_1_0, (`LH_C((`LH_P2(_lh_permute_arg1_0, _lh_permute_LH_P2_0_0)), (digitEnv_lh__d4 st_0))))))) (fun _p_0 -> 
              (return_lh__d7 _lh_permute_LH_P2_0_0)))
          | _ -> 
            (failwith "error")))))));;
let rec select_lh__d2 _lh_select_arg1_0 =
  ((bind_lh__d6 get_lh__d2) (fun st_2 -> 
    (let rec _lh_matchIdent_1_1 = ((lookup_lh__d3 _lh_select_arg1_0) (digitEnv_lh__d4 st_2)) in
...
let rec permute_lh__d1 _lh_permute_arg1_1 =
  ((bind_lh__d8 get_lh__d2) (fun st_1 -> 
    ((bind_lh__d8 (let rec xs_1 = (digits_lh__d1 st_1) in
      ...
      (let rec _lh_matchIdent_4 = iis_1 in
        (match _lh_matchIdent_4 with
          | `LH_P2(_lh_permute_LH_P2_0_1, _lh_permute_LH_P2_1_1) -> 
            ((bind_lh__d8 (put_lh__d1 (`Digits(_lh_permute_LH_P2_1_1, (`LH_C((`LH_P2(_lh_permute_arg1_1, _lh_permute_LH_P2_0_1)), (digitEnv_lh__d4 st_1))))))) (fun _p_1 -> 
...
let rec bind_lh__d5 _lh_bind_arg1_3 _lh_bind_arg2_3 =
  (`StateT((fun s_1_1 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_3 -> 
      (let rec _lh_matchIdent_5 = as_3 in
        (match _lh_matchIdent_5 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_3) s_1_1))))));;
...
let rec guard_lh__d1 _lh_guard_arg1_0 =
  (match _lh_guard_arg1_0 with
    | true -> 
      (`StateT((fun s_1_9 -> 
        (`LH_C((`LH_P2((`Unit), s_1_9)), (`LH_N))))))
    | false -> 
      (`StateT((fun s_2_0 -> 
        (`LH_N))))
    | _ -> 
      (failwith "error"));;
let rec bind_lh__d3 _lh_bind_arg1_5 _lh_bind_arg2_5 =
  (`StateT((fun s_1_3 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_5 -> 
      (let rec _lh_matchIdent_9 = as_5 in
        (match _lh_matchIdent_9 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_5) s_1_3))))));;
let rec rest_lh__d1 _lh_rest_arg1_0 =
  (match _lh_rest_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec runStateT_lh__d3 _lh_runStateT_arg1_3 =
...
let rec concat_lh__d4 lss_1 =
  (match lss_1 with
    | `LH_C(h_4, t_4) -> 
      ((mappend_lh__d8 h_4) (concat_lh__d4 t_4))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d5 f_2 ls_2 =
  (match ls_2 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C((f_2 h_3), ((map_lh__d5 f_2) t_3)))
    | `LH_N -> 
      (`LH_N));;
let rec runStateT_lh__d2 _lh_runStateT_arg1_4 =
  (match _lh_runStateT_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec bind_lh__d1 _lh_bind_arg1_7 _lh_bind_arg2_7 =
  (`StateT((fun s_1_7 -> 
    (concat_lh__d4 ((map_lh__d5 (fun as_7 -> 
      (let rec _lh_matchIdent_1_3 = as_7 in
        (match _lh_matchIdent_1_3 with
          | `LH_P2(_lh_bind_LH_P2_0_7, _lh_bind_LH_P2_1_7) -> 
            ((runStateT_lh__d2 (_lh_bind_arg2_7 _lh_bind_LH_P2_0_7)) _lh_bind_LH_P2_1_7)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d3 _lh_bind_arg1_7) s_1_7))))));;
let rec return_lh__d3 _lh_return_arg1_4 =
  (`StateT((fun s_1_5 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_4, s_1_5)), (`LH_N))))));;
let rec return_lh__d2 _lh_return_arg1_5 =
  (`StateT((fun s_1_6 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_5, s_1_6)), (`LH_N))))));;
let rec bind_lh__d4 _lh_bind_arg1_4 _lh_bind_arg2_4 =
  (`StateT((fun s_1_2 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_4 -> 
      (let rec _lh_matchIdent_8 = as_4 in
        (match _lh_matchIdent_8 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_4) s_1_2))))));;
...
let rec foldr_lh__d1 f_0 i_0 ls_0 =
  (match ls_0 with
    ...
    | `LH_N -> 
      i_0);;
let rec bind_lh__d7 _lh_bind_arg1_1 _lh_bind_arg2_1 =
  (`StateT((fun s_4 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_1 -> 
      (let rec _lh_matchIdent_1 = as_1 in
        (match _lh_matchIdent_1 with
          | `LH_P2(_lh_bind_LH_P2_0_1, _lh_bind_LH_P2_1_1) -> 
            ((runStateT_lh__d6 (_lh_bind_arg2_1 _lh_bind_LH_P2_0_1)) _lh_bind_LH_P2_1_1)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_1) s_4))))));;
let rec mapM_lh__d1 _lh_mapM_arg1_0 _lh_mapM_arg2_0 =
  (((foldr_lh__d1 (fun a_1 r_0 -> 
    ((bind_lh__d8 (_lh_mapM_arg1_0 a_1)) (fun x_1 -> 
      ((bind_lh__d7 r_0) (fun xs_4 -> 
        (return_lh__d7 (`LH_C(x_1, xs_4))))))))) (return_lh__d6 (`LH_N))) _lh_mapM_arg2_0);;
...
let rec runStateT_lh__d5 _lh_runStateT_arg1_1 =
  (match _lh_runStateT_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec runStateT_lh__d4 _lh_runStateT_arg1_2 =
  (match _lh_runStateT_arg1_2 with
    | `StateT(_lh_runStateT_StateT_0_2) -> 
      _lh_runStateT_StateT_0_2
    | _ -> 
      (failwith "error"));;
let rec bind_lh__d2 _lh_bind_arg1_6 _lh_bind_arg2_6 =
  (`StateT((fun s_1_4 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_6 -> 
      (let rec _lh_matchIdent_1_0 = as_6 in
        (match _lh_matchIdent_1_0 with
          | `LH_P2(_lh_bind_LH_P2_0_6, _lh_bind_LH_P2_1_6) -> 
            ((runStateT_lh__d4 (_lh_bind_arg2_6 _lh_bind_LH_P2_0_6)) _lh_bind_LH_P2_1_6)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d5 _lh_bind_arg1_6) s_1_4))))));;
let rec solve_lh__d1 _lh_solve_arg1_0 _lh_solve_arg2_0 _lh_solve_arg3_0 =
  (match _lh_solve_arg2_0 with
    | `LH_C(_lh_solve_LH_C_0_0, _lh_solve_LH_C_1_0) -> 
      ((bind_lh__d4 (let rec _lh_matchIdent_1_5 = _lh_solve_arg1_0 in
    ...
    | _ -> 
      (match _lh_solve_arg1_0 with
        ...
        | _ -> 
          (`StateT((fun _p_4 -> 
            (`LH_N))))));;
let rec enumFromTo_lh__d2 a_3 b_0 =
  (if (a_3 <= b_0) then
    (`LH_C(a_3, ((enumFromTo_lh__d2 (a_3 + 1)) b_0)))
  else
    (`LH_N));;
let rec mappend_lh__d2 xs_9 ys_6 =
  (match xs_9 with
    | `LH_C(h_2_2, t_2_2) -> 
      (`LH_C(h_2_2, ((mappend_lh__d2 t_2_2) ys_6)))
    | `LH_N -> 
      ys_6);;
...
let rec digitEnv_lh__d2 _lh_digitEnv_arg1_2 =
  (match _lh_digitEnv_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec runStateT_lh__d1 _lh_runStateT_arg1_5 =
...
let rec map_lh__d3 f_5 ls_7 =
  (match ls_7 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d7 xs_3 ys_1 =
  (match xs_3 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C(h_6, ((mappend_lh__d7 t_6) ys_1)))
    | `LH_N -> 
      ys_1);;
...
let rec execStateT_lh__d1 _lh_execStateT_arg1_0 _lh_execStateT_arg2_0 =
  (concat_lh__d2 ((map_lh__d3 (fun x_2 -> 
    (let rec _lh_matchIdent_1_6 = x_2 in
...
let rec fromJust_lh__d1 _lh_fromJust_arg1_0 =
  (match _lh_fromJust_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec reverse_helper_lh__d2 ls_3 a_0 =
  (match ls_3 with
    | `LH_C(h_7, t_7) -> 
      ((reverse_helper_lh__d2 t_7) (`LH_C(h_7, a_0)))
    | `LH_N -> 
      a_0);;
let rec reverse_lh__d2 ls_8 =
  ((reverse_helper_lh__d2 ls_8) (`LH_N));;
let rec map_lh__d4 f_3 ls_4 =
  (match ls_4 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C((f_3 h_1_0), ((map_lh__d4 f_3) t_1_0)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d6 xs_5 ys_2 =
  (match xs_5 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C(h_8, ((mappend_lh__d6 t_8) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec concat_lh__d3 lss_2 =
  (match lss_2 with
    | `LH_C(h_9, t_9) -> 
      ((mappend_lh__d8 h_9) (concat_lh__d3 t_9))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d3 xs_8 ys_5 =
  (match xs_8 with
    | `LH_C(h_1_9, t_1_9) -> 
      (`LH_C(h_1_9, ((mappend_lh__d3 t_1_9) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec mappend_lh__d4 xs_7 ys_4 =
  (match xs_7 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C(h_1_7, ((mappend_lh__d4 t_1_7) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec map_lh__d2 f_7 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_2_0, t_2_0) -> 
      (`LH_C((f_7 h_2_0), ((map_lh__d2 f_7) t_2_0)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d5 xs_6 ys_3 =
  (match xs_6 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C(h_1_2, ((mappend_lh__d5 t_1_2) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec concat_lh__d1 lss_4 =
  (match lss_4 with
    | `LH_C(h_1_8, t_1_8) -> 
      ((mappend_lh__d5 h_1_8) (concat_lh__d1 t_1_8))
    | `LH_N -> 
      (`LH_N));;
let rec reverse_helper_lh__d1 ls_6 a_2 =
  (match ls_6 with
    | `LH_C(h_1_3, t_1_3) -> 
      ((reverse_helper_lh__d1 t_1_3) (`LH_C(h_1_3, a_2)))
    | `LH_N -> 
      a_2);;
let rec reverse_lh__d1 ls_1_1 =
  ((reverse_helper_lh__d1 ls_1_1) (`LH_N));;
let rec puzzle_lh__d1 _lh_puzzle_arg1_0 _lh_puzzle_arg2_0 =
  (let rec solution_0 = (((solve_lh__d1 (transpose_lh__d1 ((map_lh__d2 reverse_lh__d1) _lh_puzzle_arg1_0))) (reverse_lh__d2 _lh_puzzle_arg2_0)) 0) in
    (let rec answer_0 = (let rec _lh_matchIdent_1_7 = ((execStateT_lh__d1 solution_0) (`Digits(((enumFromTo_lh__d2 0) 9), (`LH_N)))) in

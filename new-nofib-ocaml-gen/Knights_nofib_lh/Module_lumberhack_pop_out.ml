...
let rec createQueue__d0 =
  (`LH_N);;
let rec enumFromTo__d1 a_2 b_2 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 =
  (if (a_2 <= b_2) then
    (fun f_4 ys_1_1 -> 
      (let rec _lh_listcomp_fun_ls_t_1_0 = ((enumFromTo__d1 (a_2 + 1)) b_2) in
        (let rec _lh_listcomp_fun_ls_h_1_0 = a_2 in
          (let rec tx_0 = (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_1_0) in
            (let rec hx_0 = (`LH_P2(_lh_popOutId_0_0, _lh_listcomp_fun_ls_h_1_0)) in
...
and copy__d0 _lh_copy_arg1_2 _lh_copy_arg2_2 _lh_popOutId_0_4 _lh_popOutId_1_2 _lh_popOutId_2_1 _lh_popOutId_3_1 =
  (if (_lh_copy_arg1_2 <= 0) then
    ...
    (let rec ty_2 = ((copy__d0 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec hy_2 = _lh_copy_arg2_2 in
        (let rec ty_3 = (((zipWith__d0 _lh_popOutId_0_4) _lh_popOutId_2_1) ty_2) in
          (let rec hy_3 = ((_lh_popOutId_0_4 _lh_popOutId_1_2) hy_2) in
            (((Lazy.force _lh_popOutId_3_1) hy_3) ty_3))))))
and copy__d1 _lh_copy_arg1_3 _lh_copy_arg2_3 _lh_popOutId_0_5 =
  (if (_lh_copy_arg1_3 <= 0) then
    _lh_popOutId_0_5
  else
    (let rec t_1_1_3 = ((copy__d1 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
      (let rec h_8_8 = _lh_copy_arg2_3 in
        (`LH_C(h_8_8, ((mappend__d8 t_1_1_3) _lh_popOutId_0_5))))))
and copy__d2 _lh_copy_arg1_1 _lh_copy_arg2_1 _lh_popOutId_0_3 =
  (if (_lh_copy_arg1_1 <= 0) then
    _lh_popOutId_0_3
  else
    (let rec t_2_9 = ((copy__d2 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
      (let rec h_1_3 = _lh_copy_arg2_1 in
        (`LH_C(h_1_3, ((mappend__d1_d3 t_2_9) _lh_popOutId_0_3))))))
and copy__d3 _lh_copy_arg1_0 _lh_copy_arg2_0 _lh_popOutId_0_1 =
  (if (_lh_copy_arg1_0 <= 0) then
    _lh_popOutId_0_1
  else
    (let rec t_1_7 = ((copy__d3 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec h_9 = _lh_copy_arg2_0 in
        (`LH_C(h_9, ((mappend__d1_d5 t_1_7) _lh_popOutId_0_1))))))
      ...
      (let rec scrut_0 = (length__d4 singles_0) in
        (if (scrut_0 = 0) then
          ...
          (if (scrut_0 = 1) then
            ...
            (`LH_N))))))
and enumFromTo__d0 a_3 b_3 _lh_popOutId_0_2 _lh_popOutId_1_1 =
  (if (a_3 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_2_1 = ((enumFromTo__d0 (a_3 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_2_1 = a_3 in
        (let rec _lh_listcomp_fun_3_0 = (fun _lh_listcomp_fun_para_7 -> 
          ((((_lh_listcomp_fun_para_7 _lh_listcomp_fun_ls_h_2_1) _lh_listcomp_fun_3_0) _lh_listcomp_fun_ls_t_2_1) _lh_popOutId_0_2)) in
          (_lh_listcomp_fun_3_0 ((enumFromTo__d1 1) _lh_popOutId_1_1)))))
  else
    (fun f_6 ys_2_2 xs_1_3 ys_2_3 -> 
      ys_2_3))

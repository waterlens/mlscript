...
let rec ppBesideSP_lh__d1 _lh_ppBesideSP_arg1_0 _lh_ppBesideSP_arg2_0 _lh_ppBesideSP_arg3_0 _lh_ppBesideSP_arg4_0 =
  (let rec _lh_matchIdent_8 = ((_lh_ppBesideSP_arg1_0 _lh_ppBesideSP_arg3_0) false) in
    (match _lh_matchIdent_8 with
      | `MkPrettyRep(_lh_ppBesideSP_MkPrettyRep_0_0, _lh_ppBesideSP_MkPrettyRep_1_0, _lh_ppBesideSP_MkPrettyRep_2_0, _lh_ppBesideSP_MkPrettyRep_3_0) -> 
        (let rec li_0 = (if _lh_ppBesideSP_MkPrettyRep_2_0 then
          ...
          (let rec _lh_matchIdent_9 = ((_lh_ppBesideSP_arg2_0 (_lh_ppBesideSP_arg3_0 - li_0)) false) in
...
let rec ppBeside_lh__d1 _lh_ppBeside_arg1_0 _lh_ppBeside_arg2_0 _lh_ppBeside_arg3_0 _lh_ppBeside_arg4_0 =
  (let rec _lh_matchIdent_6 = ((_lh_ppBeside_arg1_0 _lh_ppBeside_arg3_0) false) in
    (match _lh_matchIdent_6 with
      | `MkPrettyRep(_lh_ppBeside_MkPrettyRep_0_0, _lh_ppBeside_MkPrettyRep_1_0, _lh_ppBeside_MkPrettyRep_2_0, _lh_ppBeside_MkPrettyRep_3_0) -> 
        (let rec _lh_matchIdent_7 = ((_lh_ppBeside_arg2_0 (_lh_ppBeside_arg3_0 - _lh_ppBeside_MkPrettyRep_1_0)) false) in
...
let rec flatten_lh__d1 _lh_flatten_arg1_0 _lh_flatten_arg2_0 _lh_flatten_arg3_0 _lh_flatten_arg4_0 =
  (match _lh_flatten_arg3_0 with
    | `CNil -> 
      (_lh_flatten_arg4_0 _lh_flatten_arg2_0)
    ...
    | `CNewline -> 
      (`LH_C('|', (_lh_flatten_arg4_0 true)))
    | _ -> 
      (match _lh_flatten_arg2_0 with
        | false -> 
          (match _lh_flatten_arg3_0 with
            | `CStr(_lh_flatten_CStr_0_0) -> 
              ((mappend_lh__d1 _lh_flatten_CStr_0_0) (_lh_flatten_arg4_0 false))
            | _ -> 
              (match _lh_flatten_arg2_0 with
                | false -> 
                  (match _lh_flatten_arg3_0 with
                    | `CCh(_lh_flatten_CCh_0_0) -> 
                      (`LH_C(_lh_flatten_CCh_0_0, (_lh_flatten_arg4_0 false)))
                    | _ -> 
                      (match _lh_flatten_arg2_0 with
                        | true -> 
                          (match _lh_flatten_arg3_0 with
                            | `CStr(_lh_flatten_CStr_0_1) -> 
                              ((mkIndent_lh__d1 _lh_flatten_arg1_0) ((mappend_lh__d1 _lh_flatten_CStr_0_1) (_lh_flatten_arg4_0 false)))
                            | _ -> 
                              (match _lh_flatten_arg2_0 with
                                | true -> 
                                  (match _lh_flatten_arg3_0 with
                                    | `CCh(_lh_flatten_CCh_0_1) -> 
                                      ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_1, (_lh_flatten_arg4_0 false))))
                                    | _ -> 
                                      (failwith "error"))
                                | _ -> 
                                  (failwith "error")))
                            ...
                            | true -> 
                              (match _lh_flatten_arg3_0 with
                                | `CCh(_lh_flatten_CCh_0_2) -> 
                                  ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_2, (_lh_flatten_arg4_0 false))))
                                | _ -> 
                                  (failwith "error"))
                            | _ -> 
                              (failwith "error"))))
                    ...
                    | true -> 
                      (match _lh_flatten_arg3_0 with
                        | `CStr(_lh_flatten_CStr_0_2) -> 
                          ((mkIndent_lh__d1 _lh_flatten_arg1_0) ((mappend_lh__d1 _lh_flatten_CStr_0_2) (_lh_flatten_arg4_0 false)))
                        | _ -> 
                          (match _lh_flatten_arg2_0 with
                            | true -> 
                              (match _lh_flatten_arg3_0 with
                                | `CCh(_lh_flatten_CCh_0_3) -> 
                                  ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_3, (_lh_flatten_arg4_0 false))))
                                | _ -> 
                                  (failwith "error"))
                            | _ -> 
                              (failwith "error")))
                        ...
                        | true -> 
                          (match _lh_flatten_arg3_0 with
                            | `CCh(_lh_flatten_CCh_0_4) -> 
                              ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_4, (_lh_flatten_arg4_0 false))))
                            | _ -> 
                              (failwith "error"))
                        | _ -> 
                          (failwith "error")))))
            ...
            | false -> 
              (match _lh_flatten_arg3_0 with
                | `CCh(_lh_flatten_CCh_0_5) -> 
                  (`LH_C(_lh_flatten_CCh_0_5, (_lh_flatten_arg4_0 false)))
                | _ -> 
                  (match _lh_flatten_arg2_0 with
                    | true -> 
                      (match _lh_flatten_arg3_0 with
                        | `CStr(_lh_flatten_CStr_0_3) -> 
                          ((mkIndent_lh__d1 _lh_flatten_arg1_0) ((mappend_lh__d1 _lh_flatten_CStr_0_3) (_lh_flatten_arg4_0 false)))
                        | _ -> 
                          (match _lh_flatten_arg2_0 with
                            | true -> 
                              (match _lh_flatten_arg3_0 with
                                | `CCh(_lh_flatten_CCh_0_6) -> 
                                  ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_6, (_lh_flatten_arg4_0 false))))
                                | _ -> 
                                  (failwith "error"))
                            | _ -> 
                              (failwith "error")))
                        ...
                        | true -> 
                          (match _lh_flatten_arg3_0 with
                            | `CCh(_lh_flatten_CCh_0_7) -> 
                              ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_7, (_lh_flatten_arg4_0 false))))
                            | _ -> 
                              (failwith "error"))
                        | _ -> 
                          (failwith "error"))))
                ...
                | true -> 
                  (match _lh_flatten_arg3_0 with
                    | `CStr(_lh_flatten_CStr_0_4) -> 
                      ((mkIndent_lh__d1 _lh_flatten_arg1_0) ((mappend_lh__d1 _lh_flatten_CStr_0_4) (_lh_flatten_arg4_0 false)))
                    | _ -> 
                      (match _lh_flatten_arg2_0 with
                        | true -> 
                          (match _lh_flatten_arg3_0 with
                            | `CCh(_lh_flatten_CCh_0_8) -> 
                              ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_8, (_lh_flatten_arg4_0 false))))
                            | _ -> 
                              (failwith "error"))
                        | _ -> 
                          (failwith "error")))
                    ...
                    | true -> 
                      (match _lh_flatten_arg3_0 with
                        | `CCh(_lh_flatten_CCh_0_9) -> 
                          ((mkIndent_lh__d1 _lh_flatten_arg1_0) (`LH_C(_lh_flatten_CCh_0_9, (_lh_flatten_arg4_0 false))))
                        | _ -> 
                          (failwith "error"))
                    | _ -> 
                      (failwith "error"))))));;
...
let rec ppShow_lh__d1 _lh_ppShow_arg1_0 _lh_ppShow_arg2_0 =
  (let rec _lh_matchIdent_1_0 = ((_lh_ppShow_arg2_0 _lh_ppShow_arg1_0) false) in
...
let rec testPretty_nofib_lh__d1 _lh_testPretty_nofib_arg1_0 =
  (let rec pretty_stuff_0 = (ppAboves_lh__d1 (`LH_C((ppBesides_lh__d1 (`LH_C((ppInt_lh__d1 (0 - 42)), (`LH_C((ppChar_lh__d1 '@'), (`LH_C((ppStr_lh__d2 (`LH_C('T', (`LH_C('h', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('s', (`LH_C('t', (`LH_C('r', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_N)))))))))))))))))))))))))))))))))), (`LH_N)))))))), (`LH_C(pp'SP_lh__d1, (`LH_C((fun _lh_ppHang_arg4_1 _lh_ppHang_arg5_1 -> 
    (let rec _lh_matchIdent_4 = (((ppStr_lh__d3 (`LH_C('T', (`LH_C('h', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C(' ', (`LH_C('l', (`LH_C('a', (`LH_C('b', (`LH_C('e', (`LH_C('l', (`LH_N)))))))))))))))))))))))))))))))))))) _lh_ppHang_arg4_1) false) in
      ((((_lh_matchIdent_4 8) (ppCat_lh__d1 ((copy_lh__d1 50) (ppStr_lh__d1 (`LH_C('x', (`LH_C('x', (`LH_C('x', (`LH_C('x', (`LH_C('x', (`LH_N))))))))))))))) _lh_ppHang_arg4_1) _lh_ppHang_arg5_1))), (`LH_N)))))))) in

  ...
  (if (_lh_copy_arg1_2 > 0) then
    (let rec ty_5 = ((copy_lh__d2 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec hy_5 = _lh_copy_arg2_2 in
        (fun hx_5 tx_5 -> 
          (let rec _lh_listcomp_fun_ls_t_7 = ((zip_lh__d1 tx_5) ty_5) in
            (let rec _lh_listcomp_fun_ls_h_7 = (let rec _lh_store_inputs_LH_P2_1_0 = hy_5 in
              ...
              (fun _lh_listcomp_fun_1_1 _lh_store_inputs_PS_0_2 _lh_store_inputs_PS_2_2 _lh_store_inputs_PS_3_2 _lh_store_inputs_PS_4_2 -> 
                ((((((_lh_listcomp_fun_ls_h_7 _lh_listcomp_fun_ls_t_7) _lh_listcomp_fun_1_1) _lh_store_inputs_PS_0_2) _lh_store_inputs_PS_2_2) _lh_store_inputs_PS_3_2) _lh_store_inputs_PS_4_2)))))))
  else
    (fun hx_6 tx_6 _lh_listcomp_fun_1_2 _lh_store_inputs_PS_0_3 _lh_store_inputs_PS_2_3 _lh_store_inputs_PS_3_3 _lh_store_inputs_PS_4_3 -> 
      (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo_lh__d2 (a_3 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_2 = a_3 in
        (fun _lh_listcomp_fun_3 -> 
          (let rec ty_0 = (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_2) in
            (let rec hy_0 = ((7 * _lh_listcomp_fun_ls_h_2) + 7) in
              (fun f_1_8 xs_3 -> 
                ((((Lazy.force xs_3) f_1_8) hy_0) ty_0)))))))
  else
    (fun _lh_listcomp_fun_4 f_1_9 xs_4 -> 
      (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_6 = ((enumFromTo_lh__d1 (a_5 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_6 = a_5 in
        (fun _lh_listcomp_fun_8 -> 
          (let rec t_3_3 = (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_6) in
            (let rec h_3_3 = ((7 * _lh_listcomp_fun_ls_h_6) + 1) in
              (fun f_2_8 -> 
                (let rec t_3_4 = ((map_lh__d1 f_2_8) t_3_3) in
                  (let rec h_3_4 = (f_2_8 h_3_3) in
                    (fun _lh_dummy_6 -> 
                      ((mappend_lh__d4 h_3_4) (concat_lh__d1 t_3_4)))))))))))
  else
    (fun _lh_listcomp_fun_9 f_2_9 _lh_dummy_7 ys_2_3 -> 
      ys_2_3));;
    ...
    (let rec _lh_listcomp_fun_ls_t_9 = ((enumFromTo_lh__d3 (a_7 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_8 = a_7 in
        (fun _lh_listcomp_fun_1_3 -> 
          (let rec ty_6 = (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_9) in
            (let rec hy_6 = ((7 * _lh_listcomp_fun_ls_h_8) + 1) in
              (fun f_3_6 xs_1_3 -> 
                ((((Lazy.force xs_1_3) f_3_6) hy_6) ty_6)))))))
  else
    (fun _lh_listcomp_fun_1_4 f_3_7 xs_1_4 -> 
      (`LH_N)));;
...
let rec enumFromTo_lh__d4 a_2 b_0 =
  (if (a_2 <= b_0) then
    (let rec t_7 = ((enumFromTo_lh__d4 (a_2 + 1)) b_0) in
      (let rec h_7 = a_2 in
        (fun f_9 i_1 -> 
          (((foldl_lh__d1 f_9) ((f_9 i_1) h_7)) t_7))))
  else
    (fun f_1_0 i_2 -> 
      i_2));;
    ...
    | `LH_C(h_9, t_9) -> 
      (let rec t_1_0 = ((map_lh__d1_d9 f_1_2) t_9) in
        (let rec h_1_0 = (f_1_2 h_9) in
          (fun f_1_3 -> 
            (let rec _lh_or_LH_C_1_1 = ((map_lh__d1_d7 f_1_3) t_1_0) in
              (let rec _lh_or_LH_C_0_1 = (f_1_3 h_1_0) in
                (fun _lh_dummy_2 -> 
    ...
    | `LH_C(h_2, t_2) -> 
      (let rec t_3 = ((map_lh__d1_d5 f_3) t_2) in
        (let rec h_3 = (f_3 h_2) in
          (fun f_4 -> 
            (`LH_C((f_4 h_3), ((map_lh__d1_d6 f_4) t_3))))))
    | `LH_N -> 
      (fun f_5 -> 
        (`LH_N)));;
    ...
    | `LH_C(h_0, t_0) -> 
      (let rec t_1 = ((map_lh__d9 f_0) t_0) in
        (let rec h_1 = (f_0 h_0) in
          (fun f_1 -> 
            (`LH_C((f_1 h_1), ((map_lh__d8 f_1) t_1))))))
    | `LH_N -> 
      (fun f_2 -> 
        (`LH_N)));;
    ...
    | `LH_C(h_1_1, t_1_1) -> 
      (let rec t_1_2 = ((map_lh__d1_d3 f_1_5) t_1_1) in
        (let rec h_1_2 = (f_1_5 h_1_1) in
          (fun f_1_6 -> 
            (let rec _lh_or_LH_C_1_2 = ((map_lh__d1_d2 f_1_6) t_1_2) in
              (let rec _lh_or_LH_C_0_2 = (f_1_6 h_1_2) in
                (fun _lh_dummy_4 -> 

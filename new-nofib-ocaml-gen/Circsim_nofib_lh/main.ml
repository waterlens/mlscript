...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_pop_out_Circsim_nofib_lh" (fun () -> ignore (let open Module_lumberhack_pop_out_______.Module_lumberhack_pop_out_______(struct end) in (run ())));
  Bench.Test.create ~name:"lumberhack_inlined_Circsim_nofib_lh" (fun () -> ignore (let open Module_lumberhack_inlined_______.Module_lumberhack_inlined_______(struct end) in (run ())));
  Bench.Test.create ~name:"lumberhack_flo_out_Circsim_nofib_lh" (fun () -> ignore (let open Module_lumberhack_flo_out_______.Module_lumberhack_flo_out_______(struct end) in (run ())));
])

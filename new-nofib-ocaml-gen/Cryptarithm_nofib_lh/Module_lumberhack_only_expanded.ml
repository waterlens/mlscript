...
let rec addj__d0 _lh_addj_arg1_1 _lh_addj_arg2_1 =
  (match _lh_addj_arg2_1 with
    ...
    | `LH_C(_lh_addj_LH_C_0_1, _lh_addj_LH_C_1_1) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_1, (`LH_C(_lh_addj_LH_C_0_1, _lh_addj_LH_C_1_1)))), (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
        (match _lh_listcomp_fun_para_3 with
          | `LH_C(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_t_3) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1, _lh_listcomp_fun_ls_h_3)), (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_3)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_3 ((addj__d0 _lh_addj_arg1_1) _lh_addj_LH_C_1_1)))))
    | _ -> 
      (failwith "error"));;
...
let rec expand__d1 _lh_expand_arg1_3 _lh_expand_arg2_3 _lh_expand_arg3_3 _lh_expand_arg4_3 _lh_expand_arg5_3 _lh_expand_arg6_3 =
...
let rec expand__d2 _lh_expand_arg1_2 _lh_expand_arg2_2 _lh_expand_arg3_2 _lh_expand_arg4_2 _lh_expand_arg5_2 _lh_expand_arg6_2 =
...
let rec filter__d0 f_1_3 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_1, t_2_3) -> 
      (if (f_1_3 h_2_1) then
        (`LH_C(h_2_1, ((filter__d0 f_1_3) t_2_3)))
      else
        ((filter__d0 f_1_3) t_2_3))
    | `LH_N -> 
      (`LH_N));;
        ...
        (match _lh_listcomp_fun_para_4 with
          | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
            (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
              ...
              (_lh_listcomp_fun_5 ((addj__d0 _lh_permutations_LH_C_0_1) _lh_listcomp_fun_ls_h_4)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_4 (permutations__d0 _lh_permutations_LH_C_1_1)))
    | _ -> 
      (failwith "error"))

...
let rec enumFromTo_lh__d1 a_0 b_1 _lh_popOutId_0_0 =
  (if (a_0 <= b_1) then
    ...
    (fun _lh_append_arg2_6 -> 
      _lh_append_arg2_6));;
let rec flatMap_lh__d2 _lh_flatMap_arg1_1 _lh_flatMap_arg2_1 =
  (match _lh_flatMap_arg2_1 with
    | `LH_N -> 
      (`LH_N)
    | `LH_C(_lh_flatMap_LH_C_0_1, _lh_flatMap_LH_C_1_1) -> 
      ((_lh_flatMap_arg1_1 _lh_flatMap_LH_C_0_1) ((flatMap_lh__d2 _lh_flatMap_arg1_1) _lh_flatMap_LH_C_1_1))
    | _ -> 
      (failwith "error"));;

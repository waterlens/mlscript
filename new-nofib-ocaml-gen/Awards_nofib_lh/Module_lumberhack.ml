    ...
    | `LH_C(h_1_4, t_1_4) -> 
      (let rec t_1_5 = ((map_lh__d2 f_1_8) t_1_4) in
        (let rec h_1_5 = (f_1_8 h_1_4) in
          (fun f_1_9 -> 
            (if (f_1_9 h_1_5) then
              (`LH_C(h_1_5, ((filter_lh__d0 f_1_9) t_1_5)))
            else
              ((filter_lh__d0 f_1_9) t_1_5)))))
    | `LH_N -> 
      (fun f_2_0 -> 
        (`LH_N)));;
...
let rec findawards_lh__d0 _lh_findawards_arg1_0 =
  (let rec _lh_matchIdent_3 = (awards_lh__d0 _lh_findawards_arg1_0) in
    (match _lh_matchIdent_3 with
      ...
      | _ -> 
        (failwith "error")));;
let rec competitors_lh__d0 _lh_competitors_arg1_0 =

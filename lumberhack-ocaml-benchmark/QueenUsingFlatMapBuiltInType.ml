...
and gen_d0_d0 _lh_gen_arg1_0 _lh_gen_arg2_0 =
  (match _lh_gen_arg1_0 with
    | 0 -> 
      (`LH_C((Obj.magic (fun _lh_safe_arg1_1 _lh_safe_arg2_1 -> 
        true)), (`LH_N)))
    | _ -> 
      ((flatMap_d0_d0 (fun b_1 -> 
        ((flatMap_d1_d0 (fun q_0 -> 
          (if (((safe_d0_d0 q_0) 1) b_1) then
            (let rec _lh_append_LH_C_0_0 = (Obj.magic (let rec _lh_safe_LH_C_0_0 = q_0 in
...
let rec append_d0_d0_d1 _lh_append_arg1_5 _lh_append_arg2_1_5 =
  (_lh_append_arg1_5 _lh_append_arg2_1_5);;
let rec append_d1_d0_d0 _lh_append_arg1_2 _lh_append_arg2_8 =
  (_lh_append_arg1_2 _lh_append_arg2_8);;
let rec append_d1_d0_d1 _lh_append_arg1_3 _lh_append_arg2_9 =
  (_lh_append_arg1_3 _lh_append_arg2_9);;
let rec flatMap_d1_d0_d0 _lh_flatMap_arg1_6 _lh_flatMap_arg2_2 =
...
let rec enumFromTo_d0_d0_d0 a_1 b_2 _lh_popOutId_0_0 =
  (if (a_1 <= b_2) then
    (let rec _lh_flatMap_LH_C_0_2 = a_1 in
      (let rec _lh_flatMap_LH_C_1_2 = ((enumFromTo_d0_d0_d0 (a_1 + 1)) b_2) in
...
and gen_d0_d0_d0 _lh_gen_arg1_1 _lh_gen_arg2_1 =
  (match _lh_gen_arg1_1 with
    | 0 -> 
      (`LH_C((Obj.magic (fun _lh_safe_arg1_4 _lh_safe_arg2_4 -> 
        true)), (`LH_N)))
    | _ -> 
      ((flatMap_d0_d0_d0 (fun b_3 -> 
        ((flatMap_d1_d0_d1 (fun q_1 -> 
          (if (((safe_d0_d0_d1 q_1) 1) b_3) then
            (let rec _lh_append_LH_C_0_2 = (Obj.magic (let rec _lh_safe_LH_C_0_1 = q_1 in
              (let rec _lh_safe_LH_C_1_1 = b_3 in

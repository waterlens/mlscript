(*
ocamlfind ocamlopt -rectypes -thread -O3 ./DigitsOfE2_nofib.ml -o "./DigitsOfE2_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./DigitsOfE2_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

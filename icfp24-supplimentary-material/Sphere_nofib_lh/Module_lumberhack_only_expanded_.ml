...
let rec foldr_lh__d1 f_4 i_2 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_2, t_1_3) -> 
      ((f_4 h_1_2) (((foldr_lh__d1 f_4) i_2) t_1_3))
    | `LH_N -> 
      i_2);;
let rec hash_lh__d1 _lh_hash_arg1_0 =
  (let rec u8_0 = (fun x_0 -> 
    ...
    (((foldr_lh__d1 (fun rgb_0 acc_0 -> 
      (let rec _lh_matchIdent_1_9 = rgb_0 in
...
let rec map_lh__d1 f_6 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_3, t_1_4) -> 
      (`LH_C((f_6 h_1_3), ((map_lh__d1 f_6) t_1_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec enumFromTo_lh__d1 a_1 b_1 =
  (if (a_1 <= b_1) then
    ...
    (`LH_N));;
let rec vecscale_lh__d5 _lh_vecscale_arg1_1_0 _lh_vecscale_arg2_1_0 =
  (match _lh_vecscale_arg1_1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d3 _lh_vecadd_arg1_7 _lh_vecadd_arg2_7 =
...
let rec mappend_lh__d3 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_1, t_2) -> 
      (`LH_C(h_1, ((mappend_lh__d3 t_2) ys_0)))
    | `LH_N -> 
      ys_0);;
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
        (match _lh_listcomp_fun_ls_h_4 with
          | `Specular(_lh_specularsurf_Specular_0_1) -> 
            (`LH_C(_lh_specularsurf_Specular_0_1, (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4)))
          | _ -> 
            (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_4 _lh_specularsurf_arg1_1))) (`LH_C((`LH_P3(0.0, 0.0, 0.0)), (`LH_N)))));;
let rec vecscale_lh__d7 _lh_vecscale_arg1_8 _lh_vecscale_arg2_8 =
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_6) -> 
        (match _lh_listcomp_fun_ls_h_6 with
          | `Reflect(_lh_reflectsurf_Reflect_0_0) -> 
            (`LH_C(_lh_reflectsurf_Reflect_0_0, (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6)))
          | _ -> 
            (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_6 _lh_reflectsurf_arg1_0))) (`LH_C(0.0, (`LH_N)))));;
...
let rec vecadd_lh__d9 _lh_vecadd_arg1_1 _lh_vecadd_arg2_1 =
  (match _lh_vecadd_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecdot_lh__d3 _lh_vecdot_arg1_1 _lh_vecdot_arg2_1 =
  (match _lh_vecdot_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecdot_lh__d2 _lh_vecdot_arg1_2 _lh_vecdot_arg2_2 =
  (match _lh_vecdot_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d4 _lh_vecscale_arg1_1 _lh_vecscale_arg2_1 =
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
        (match _lh_listcomp_fun_ls_h_0 with
          | `Specular(_lh_specularsurf_Specular_0_0) -> 
            (`LH_C(_lh_specularsurf_Specular_0_0, (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
          | _ -> 
            (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_0 _lh_specularsurf_arg1_0))) (`LH_C((`LH_P3(0.0, 0.0, 0.0)), (`LH_N)))));;
let rec vecadd_lh__d8 _lh_vecadd_arg1_2 _lh_vecadd_arg2_2 =
...
let rec lightcolour_lh__d1 _lh_lightcolour_arg1_0 =
  (match _lh_lightcolour_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d1 _lh_vecscale_arg1_4 _lh_vecscale_arg2_4 =
...
let rec epsilon_lh__d1 =
  0.000001;;
let rec vecscale_lh__d1_d5 _lh_vecscale_arg1_0 _lh_vecscale_arg2_0 =
...
let rec foldr_lh__d2 f_1 i_1 ls_6 =
  (match ls_6 with
    | `LH_C(h_9, t_1_0) -> 
      ((f_1 h_9) (((foldr_lh__d2 f_1) i_1) t_1_0))
    | `LH_N -> 
      i_1);;
let rec tail_lh__d1 ls_4 =
  (match ls_4 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec vecdot_lh__d4 _lh_vecdot_arg1_0 _lh_vecdot_arg2_0 =
...
let rec trace_lh__d1 _lh_trace_arg1_0 _lh_trace_arg2_0 _lh_trace_arg3_0 =
  (let rec f_3 = (fun d1s1_0 d2s2_0 -> 
    (let rec _lh_matchIdent_7 = d1s1_0 in
      (match _lh_matchIdent_7 with
        | `LH_P2(_lh_trace_LH_P2_0_0, _lh_trace_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_8 = d2s2_0 in
    ...
    (let rec sphmap_0 = (fun xss_0 -> 
      (let rec _lh_matchIdent_9 = xss_0 in
        (match _lh_matchIdent_9 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_0, _lh_trace_LH_C_1_0) -> 
            (let rec _lh_matchIdent_1_0 = (((sphereintersect_lh__d1 _lh_trace_arg2_0) _lh_trace_arg3_0) _lh_trace_LH_C_0_0) in
      ...
      (let rec dists_0 = (sphmap_0 _lh_trace_arg1_0) in
        (if (null_lh__d1 dists_0) then
          ...
          (let rec _lh_matchIdent_1_1 = (((foldr_lh__d2 f_3) (head_lh__d1 dists_0)) (tail_lh__d1 dists_0)) in
...
let rec shadowed_lh__d1 _lh_shadowed_arg1_0 _lh_shadowed_arg2_0 _lh_shadowed_arg3_0 =
  (let rec _lh_matchIdent_1 = (((trace_lh__d1 testspheres_lh__d1) ((vecadd_lh__d1_d0 _lh_shadowed_arg1_0) ((vecscale_lh__d1_d5 _lh_shadowed_arg2_0) epsilon_lh__d1))) _lh_shadowed_arg2_0) in
    (match _lh_matchIdent_1 with
      ...
      | _ -> 
        (failwith "error")));;
let rec vecscale_lh__d1_d3 _lh_vecscale_arg1_2 _lh_vecscale_arg2_2 =
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
        (match _lh_listcomp_fun_ls_h_2 with
          | `Diffuse(_lh_diffusesurf_Diffuse_0_0) -> 
            (`LH_C(_lh_diffusesurf_Diffuse_0_0, (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
          | _ -> 
            (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_2 _lh_diffusesurf_arg1_0))) (`LH_C((`LH_P3(0.0, 0.0, 0.0)), (`LH_N)))));;
let rec vecscale_lh__d1_d2 _lh_vecscale_arg1_3 _lh_vecscale_arg2_3 =
  ...
  (let rec _lh_matchIdent_5 = ((lightdirection_lh__d1 _lh_lightray_arg1_0) _lh_lightray_arg2_0) in
    (match _lh_matchIdent_5 with
      | `LH_P2(_lh_lightray_LH_P2_0_0, _lh_lightray_LH_P2_1_0) -> 
        (let rec cosangle_0 = ((vecdot_lh__d4 _lh_lightray_LH_P2_0_0) _lh_lightray_arg3_0) in
                      ...
                      (if (cosangle_0 <= 0.0) then
                        (let rec bodycol_0 = (bodysurf_lh__d2 _lh_lightray_arg5_0) in
                          (let rec cosalpha_0 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_0)) in
                            (let rec diffcont_0 = ((vecmult_lh__d5 ((vecscale_lh__d1_d1 diff_0) (0.0 -. cosangle_0))) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_0 = (if (cosalpha_0 <= 0.0) then
                                (`LH_P3(0.0, 0.0, 0.0))
                              else
                                ((vecmult_lh__d2 ((vecscale_lh__d1_d3 bodycol_0) (cosalpha_0 ** spow_0))) _lh_lightray_LH_P2_1_1)) in
                                ((vecadd_lh__d9 diffcont_0) speccont_0)))))
                      else
                        (let rec spec_0 = (specularsurf_lh__d2 _lh_lightray_arg5_0) in
                          (let rec cosalpha_1 = ((vecdot_lh__d2 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_0) in
                            (let rec diffcont_1 = ((vecmult_lh__d3 ((vecscale_lh__d1_d4 diff_0) cosangle_0)) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_1 = (if (cosalpha_1 <= 0.0) then
                                (`LH_P3(0.0, 0.0, 0.0))
                              else
                                ((vecmult_lh__d4 ((vecscale_lh__d1_d2 spec_0) (cosalpha_1 ** spow_0))) _lh_lightray_LH_P2_1_1)) in
                                ((vecadd_lh__d8 diffcont_1) speccont_1)))))))))
              | _ -> 
                (failwith "error"))))
      | _ -> 
        (failwith "error")));;
let rec vecadd_lh__d6 _lh_vecadd_arg1_4 _lh_vecadd_arg2_4 =
...
let rec is_zerovector_lh__d1 _lh_is_zerovector_arg1_0 =
  (match _lh_is_zerovector_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecdot_lh__d1 _lh_vecdot_arg1_3 _lh_vecdot_arg2_3 =
...
let rec refractray_lh__d1 _lh_refractray_arg1_0 _lh_refractray_arg2_0 _lh_refractray_arg3_0 =
  (let rec dotp_0 = (0.0 -. ((vecdot_lh__d4 _lh_refractray_arg2_0) _lh_refractray_arg3_0)) in
    (let rec _lh_matchIdent_0 = (if (dotp_0 < 0.0) then
      (`LH_P3(((vecscale_lh__d1_d5 _lh_refractray_arg3_0) (0.0 -. 1.0)), (0.0 -. dotp_0), (1.0 /. _lh_refractray_arg1_0)))
    else
          ...
          (let rec disc_0 = (((1.0 -. _lh_refractray_LH_P3_2_0) *. _lh_refractray_LH_P3_2_0) *. (1.0 -. (_lh_refractray_LH_P3_1_0 *. _lh_refractray_LH_P3_1_0))) in
            (let rec t_0 = ((_lh_refractray_LH_P3_2_0 *. _lh_refractray_LH_P3_1_0) -. (sqrt disc_0)) in
              (if (disc_0 < 0.0) then
                ...
                (`LH_P2(false, ((vecadd_lh__d1_d0 ((vecscale_lh__d1_d5 _lh_refractray_LH_P3_0_0) t_0)) ((vecscale_lh__d1_d5 _lh_refractray_arg2_0) _lh_refractray_LH_P3_2_0)))))))
        | _ -> 
          (failwith "error"))));;
let rec background_lh__d2 =
  (`LH_P3(0.078, 0.361, 0.753));;
let rec head_lh__d4 ls_2 =
  (match ls_2 with
    | `LH_C(h_4, t_5) -> 
      h_4
    | `LH_N -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_8, _lh_listcomp_fun_ls_t_8) -> 
        (match _lh_listcomp_fun_ls_h_8 with
          | `Ambient(_lh_ambientsurf_Ambient_0_0) -> 
            (`LH_C(_lh_ambientsurf_Ambient_0_0, (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_8)))
          | _ -> 
            (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_8))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_8 _lh_ambientsurf_arg1_0))) (`LH_C((`LH_P3(0.0, 0.0, 0.0)), (`LH_N)))));;
let rec vecadd_lh__d4 _lh_vecadd_arg1_6 _lh_vecadd_arg2_6 =
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_5, _lh_listcomp_fun_ls_t_5) -> 
        (match _lh_listcomp_fun_ls_h_5 with
          | `Body(_lh_bodysurf_Body_0_1) -> 
            (`LH_C(_lh_bodysurf_Body_0_1, (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_5)))
          | _ -> 
            (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_5))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_5 _lh_bodysurf_arg1_1))) (`LH_C((`LH_P3(1.0, 1.0, 1.0)), (`LH_N)))));;
...
let rec vecscale_lh__d8 _lh_vecscale_arg1_7 _lh_vecscale_arg2_7 =
  (match _lh_vecscale_arg1_7 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d9 _lh_vecscale_arg1_6 _lh_vecscale_arg2_6 =
...
let rec map_lh__d2 f_2 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_1, t_1_2) -> 
      (`LH_C((f_2 h_1_1), ((map_lh__d2 f_2) t_1_2)))
    | `LH_N -> 
      (`LH_N));;
let rec vecadd_lh__d7 _lh_vecadd_arg1_3 _lh_vecadd_arg2_3 =
...
let rec mappend_lh__d1 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_5, t_6) -> 
      (`LH_C(h_5, ((mappend_lh__d1 t_6) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec head_lh__d3 ls_3 =
  (match ls_3 with
    | `LH_C(h_6, t_7) -> 
      h_6
    | `LH_N -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_9, _lh_listcomp_fun_ls_t_9) -> 
        (match _lh_listcomp_fun_ls_h_9 with
          | `Refract(_lh_refractsurf_Refract_0_0) -> 
            (`LH_C(_lh_refractsurf_Refract_0_0, (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9)))
          | _ -> 
            (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_9 _lh_refractsurf_arg1_0))) (`LH_C(1.0, (`LH_N)))));;
let rec vecadd_lh__d5 _lh_vecadd_arg1_5 _lh_vecadd_arg2_5 =
  (match _lh_vecadd_arg1_5 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d0 _lh_vecscale_arg1_5 _lh_vecscale_arg2_5 =
...
let rec vecmult_lh__d1 _lh_vecmult_arg1_4 _lh_vecmult_arg2_4 =
  (match _lh_vecmult_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec foldr_lh__d3 f_0 i_0 ls_0 =
  (match ls_0 with
    | `LH_C(h_0, t_1) -> 
      ((f_0 h_0) (((foldr_lh__d3 f_0) i_0) t_1))
    | `LH_N -> 
      i_0);;
...
let rec reflectray_lh__d1 _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
  (let rec newcontrib_1 = ((vecmult_lh__d5 _lh_reflectray_arg4_0) _lh_reflectray_arg5_0) in
    (let rec nearpos_1 = ((vecadd_lh__d1_d0 _lh_reflectray_arg1_0) ((vecscale_lh__d1_d5 _lh_reflectray_arg2_0) epsilon_lh__d1)) in
      (let rec _lh_matchIdent_4 = (((trace_lh__d1 testspheres_lh__d1) nearpos_1) _lh_reflectray_arg2_0) in
        (match _lh_matchIdent_4 with
          | `LH_P3(_lh_reflectray_LH_P3_0_0, _lh_reflectray_LH_P3_1_0, _lh_reflectray_LH_P3_2_0) -> 
            (let rec newcol_1 = (if _lh_reflectray_LH_P3_0_0 then
              ((((((shade_lh__d1 _lh_reflectray_arg3_0) _lh_reflectray_LH_P3_2_0) nearpos_1) _lh_reflectray_arg2_0) _lh_reflectray_LH_P3_1_0) newcontrib_1)
            else
              background_lh__d2) in
              (if (is_zerovector_lh__d1 newcontrib_1) then
                _lh_reflectray_arg6_0
              else
                ((vecadd_lh__d1_d0 _lh_reflectray_arg6_0) ((vecmult_lh__d5 newcol_1) _lh_reflectray_arg4_0))))
          | _ -> 
            (failwith "error")))))
and
      ...
      (let rec surf_0 = (spheresurf_lh__d1 _lh_shade_arg2_0) in
        (let rec amb_0 = ((vecmult_lh__d1 ambientlight_0) (ambientsurf_lh__d1 surf_0)) in
          (let rec norm_0 = ((spherenormal_lh__d1 hitpos_0) _lh_shade_arg2_0) in
            (let rec refl_0 = ((vecadd_lh__d7 _lh_shade_arg4_0) ((vecscale_lh__d1_d0 norm_0) ((0.0 -. 2.0) *. ((vecdot_lh__d1 _lh_shade_arg4_0) norm_0)))) in
...
transmitray_lh__d1 _lh_transmitray_arg1_0 _lh_transmitray_arg2_0 _lh_transmitray_arg3_0 _lh_transmitray_arg4_0 _lh_transmitray_arg5_0 _lh_transmitray_arg6_0 _lh_transmitray_arg7_0 _lh_transmitray_arg8_0 =
  (let rec newcontrib_0 = ((vecmult_lh__d5 _lh_transmitray_arg6_0) _lh_transmitray_arg7_0) in
    (let rec _lh_matchIdent_2 = (((refractray_lh__d1 _lh_transmitray_arg5_0) _lh_transmitray_arg4_0) _lh_transmitray_arg8_0) in
                ...
                | `LH_P3(_lh_transmitray_LH_P3_0_0, _lh_transmitray_LH_P3_1_0, _lh_transmitray_LH_P3_2_0) -> 
                  (let rec newcol_0 = (if _lh_transmitray_LH_P3_0_0 then
                    ...
                    (if (is_zerovector_lh__d1 newcontrib_0) then
                      ...
                      (`LH_P2(false, ((vecadd_lh__d1_d0 ((vecmult_lh__d5 newcol_0) _lh_transmitray_arg6_0)) _lh_transmitray_arg2_0)))))
                | _ -> 
                  (failwith "error"))))
        | _ -> 
          (failwith "error"))));;
let rec lookfrom_lh__d2 =
  (`LH_P3(2.1, 1.3, 1.7));;
let rec vecadd_lh__d2 _lh_vecadd_arg1_8 _lh_vecadd_arg2_8 =
...
let rec background_lh__d1 =
  (`LH_P3(0.078, 0.361, 0.753));;
let rec vecscale_lh__d6 _lh_vecscale_arg1_9 _lh_vecscale_arg2_9 =
...
let rec tracepixel_lh__d1 _lh_tracepixel_arg1_0 _lh_tracepixel_arg2_0 _lh_tracepixel_arg3_0 _lh_tracepixel_arg4_0 _lh_tracepixel_arg5_0 _lh_tracepixel_arg6_0 _lh_tracepixel_arg7_0 =
  (let rec pos_0 = lookfrom_lh__d2 in
    (let rec _lh_matchIdent_1_3 = (vecnorm_lh__d4 ((vecadd_lh__d2 ((vecadd_lh__d3 _lh_tracepixel_arg5_0) ((vecscale_lh__d6 _lh_tracepixel_arg6_0) _lh_tracepixel_arg3_0))) ((vecscale_lh__d5 _lh_tracepixel_arg7_0) _lh_tracepixel_arg4_0))) in
      (match _lh_matchIdent_1_3 with
        | `LH_P2(_lh_tracepixel_LH_P2_0_0, _lh_tracepixel_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_1_4 = (((trace_lh__d1 _lh_tracepixel_arg1_0) pos_0) _lh_tracepixel_LH_P2_0_0) in
...
let rec vup_lh__d1 =
  (`LH_P3(0.0, 0.0, 1.0));;
let rec vecscale_lh__d2 _lh_vecscale_arg1_1_3 _lh_vecscale_arg2_1_3 =
...
let rec veccross_lh__d2 _lh_veccross_arg1_0 _lh_veccross_arg2_0 =
  (match _lh_veccross_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d3 _lh_vecscale_arg1_1_2 _lh_vecscale_arg2_1_2 =
  (match _lh_vecscale_arg1_1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d4 _lh_vecscale_arg1_1_1 _lh_vecscale_arg2_1_1 =
...
let rec vecscale_lh__d1 _lh_vecscale_arg1_1_4 _lh_vecscale_arg2_1_4 =
...
let rec vecnorm_lh__d2 _lh_vecnorm_arg1_2 =
  (match _lh_vecnorm_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d1 _lh_vecadd_arg1_9 _lh_vecadd_arg2_9 =
...
let rec camparams_lh__d1 _lh_camparams_arg1_0 _lh_camparams_arg2_0 _lh_camparams_arg3_0 _lh_camparams_arg4_0 _lh_camparams_arg5_0 =
  (let rec initfirstray_0 = ((vecsub_lh__d2 _lh_camparams_arg2_0) _lh_camparams_arg1_0) in
    (let rec _lh_matchIdent_1_5 = (vecnorm_lh__d2 initfirstray_0) in
      (match _lh_matchIdent_1_5 with
        | `LH_P2(_lh_camparams_LH_P2_0_0, _lh_camparams_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_1_6 = (vecnorm_lh__d3 ((veccross_lh__d1 _lh_camparams_LH_P2_0_0) _lh_camparams_arg3_0)) in
            (match _lh_matchIdent_1_6 with
              | `LH_P2(_lh_camparams_LH_P2_0_1, _lh_camparams_LH_P2_1_1) -> 
                (let rec _lh_matchIdent_1_7 = (vecnorm_lh__d1 ((veccross_lh__d2 _lh_camparams_LH_P2_0_1) _lh_camparams_LH_P2_0_0)) in
                        ...
                        (let rec yfov_0 = _lh_camparams_arg4_0 in
                          (let rec xwinsize_0 = _lh_camparams_arg5_0 in
                            (let rec ywinsize_0 = _lh_camparams_arg5_0 in
                              (let rec magx_0 = (((2.0 *. _lh_camparams_LH_P2_1_0) *. (tan (dtor_lh__d2 (xfov_0 /. 2.0)))) /. xwinsize_0) in
                                (let rec magy_0 = (((2.0 *. _lh_camparams_LH_P2_1_0) *. (tan (dtor_lh__d1 (yfov_0 /. 2.0)))) /. ywinsize_0) in
                                  (let rec scrnx_0 = ((vecscale_lh__d2 _lh_camparams_LH_P2_0_1) magx_0) in
                                    (let rec scrny_0 = ((vecscale_lh__d4 _lh_camparams_LH_P2_0_2) magy_0) in
...
let rec ray_lh__d1 _lh_ray_arg1_0 =
  (let rec lights_0 = testlights_lh__d1 in
    (let rec _lh_matchIdent_1_8 = (((((camparams_lh__d1 lookfrom_lh__d1) lookat_lh__d1) vup_lh__d1) fov_lh__d1) (float_of_int _lh_ray_arg1_0)) in
      (match _lh_matchIdent_1_8 with
        | `LH_P3(_lh_ray_LH_P3_0_0, _lh_ray_LH_P3_1_0, _lh_ray_LH_P3_2_0) -> 
          (let rec f_5 = (fun i_3 j_0 -> 
            (((((((tracepixel_lh__d1 testspheres_lh__d1) lights_0) (float_of_int i_3)) (float_of_int j_0)) _lh_ray_LH_P3_0_0) _lh_ray_LH_P3_1_0) _lh_ray_LH_P3_2_0)) in

...
let rec carryPropagate_lh__d1 _lh_carryPropagate_arg1_0 _lh_carryPropagate_arg2_0 =
  (lazy (let rec _lh_matchIdent_1 = (Lazy.force _lh_carryPropagate_arg2_0) in
    (_lh_matchIdent_1 _lh_carryPropagate_arg1_0)));;
let rec concat_lz_lh__d1 _lh_concat_lz_arg1_0 =
  (lazy (let rec _lh_matchIdent_5 = (Lazy.force _lh_concat_lz_arg1_0) in
    (_lh_matchIdent_5 99)));;
...
let rec iterate_lh__d1 f_1 x_0 =
  (lazy (let rec t_2 = ((iterate_lh__d1 f_1) (f_1 x_0)) in
    (let rec h_1 = x_0 in
      (fun f_2 -> 
        (let rec _lh_concat_lz_LH_C_1_0 = ((map_lz_lh__d1 f_2) t_2) in
          ...
          (fun _lh_carryPropagate_arg1_1 -> 
            (let rec carryguess_0 = (_lh_carryPropagate_LH_C_0_0 / _lh_carryPropagate_arg1_1) in
              (let rec remainder_0 = (_lh_carryPropagate_LH_C_0_0 mod _lh_carryPropagate_arg1_1) in
                (let rec recRes_0 = ((carryPropagate_lh__d1 (_lh_carryPropagate_arg1_1 + 1)) _lh_carryPropagate_LH_C_1_0) in
...
let rec e_lh__d1 _lh_e_arg1_0 =
  ((take_lz_lh__d1 _lh_e_arg1_0) ((fun b_0 -> 
    ((append_lz_lh__d1 (let rec _lh_append_lz_LH_C_1_0 = (let rec _lh_append_lz_LH_C_1_1 = (fun _lh_append_lz_arg2_1 -> 
      _lh_append_lz_arg2_1) in
      (let rec _lh_append_lz_LH_C_0_0 = '.' in
        (fun _lh_append_lz_arg2_2 -> 
          (lazy (`LH_C(_lh_append_lz_LH_C_0_0, ((append_lz_lh__d1 _lh_append_lz_LH_C_1_1) _lh_append_lz_arg2_2))))))) in
      (let rec _lh_append_lz_LH_C_0_1 = '2' in
        (fun _lh_append_lz_arg2_3 -> 
          (lazy (`LH_C(_lh_append_lz_LH_C_0_1, ((append_lz_lh__d1 _lh_append_lz_LH_C_1_0) _lh_append_lz_arg2_3)))))))) b_0)) ((fun _lh_funcomp_x_0 -> 

...
let rec enumFromTo__d0__d0 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo__d0__d0 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (fun _lh_listcomp_fun_0 -> 
          (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_0 -> 
            ...
            (_lh_listcomp_fun_1 ((enumFromTo__d1__d0 1) _lh_listcomp_fun_ls_h_0))))))
  else
    (fun _lh_listcomp_fun_2 _lh_dummy_0 -> 
      0))
and enumFromTo__d1__d0 a_1 b_1 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo__d1__d0 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_1 in
        (fun _lh_listcomp_fun_ls_h_2 _lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_2 _lh_listcomp_fun_4 -> 
          (let rec _lh_sum_LH_C_1_0 = (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_1) in
...
and testSumListComprehensionBuiltInType__d0__d0 _lh_testSumListComprehensionBuiltInType_arg1_0 =
  (sum__d0__d0 (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_1 -> 
    (_lh_listcomp_fun_para_1 _lh_listcomp_fun_7)) in
    (_lh_listcomp_fun_7 ((enumFromTo__d0__d0 1) _lh_testSumListComprehensionBuiltInType_arg1_0))));;

(* lumberhack_pop_out *)
let rec sum__d0__d0__d0 _lh_sum_arg1_1 =
  (_lh_sum_arg1_1 99);;
let rec sum__d0__d0__d1 _lh_sum_arg1_2 =
  (_lh_sum_arg1_2 99);;
let rec enumFromTo__d0__d0__d0 a_3 b_3 _lh_popOutId_0_1 =
  (if (a_3 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_7 = ((enumFromTo__d0__d0__d0 (a_3 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_7 = a_3 in
        (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_2 -> 
          ((((_lh_listcomp_fun_para_2 _lh_listcomp_fun_ls_h_7) _lh_listcomp_fun_1_3) _lh_listcomp_fun_ls_t_7) _lh_popOutId_0_1)) in
          (_lh_listcomp_fun_1_3 ((enumFromTo__d1__d0__d0 1) _lh_listcomp_fun_ls_h_7)))))
  else
    (fun _lh_dummy_3 -> 
      0))
and enumFromTo__d1__d0__d0 a_2 b_2 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 =
  (if (a_2 <= b_2) then
    (fun _lh_dummy_2 -> 
      (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo__d1__d0__d0 (a_2 + 1)) b_2) in
        (let rec _lh_listcomp_fun_ls_h_4 = a_2 in
          (let rec _lh_sum_LH_C_1_1 = (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_4) in
            (let rec _lh_sum_LH_C_0_1 = (_lh_popOutId_0_0 * _lh_listcomp_fun_ls_h_4) in
              (_lh_sum_LH_C_0_1 + (sum__d0__d0__d0 _lh_sum_LH_C_1_1)))))))
  else
    (_lh_popOutId_3_0 _lh_popOutId_2_0))
and testSumListComprehensionBuiltInType__d0__d0__d0 _lh_testSumListComprehensionBuiltInType_arg1_1 =
  (sum__d0__d0__d1 (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_3 -> 
    (_lh_listcomp_fun_para_3 _lh_listcomp_fun_1_5)) in
    (_lh_listcomp_fun_1_5 ((enumFromTo__d0__d0__d0 1) _lh_testSumListComprehensionBuiltInType_arg1_1))));;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_SumListComprehensionBuiltInType" (fun () -> ignore ((testSumListComprehensionBuiltInType__d0 1000)));
  Bench.Test.create ~name:"lumberhack_SumListComprehensionBuiltInType" (fun () -> ignore ((testSumListComprehensionBuiltInType__d0__d0 1000)));
  Bench.Test.create ~name:"lumberhack_pop_out_SumListComprehensionBuiltInType" (fun () -> ignore ((testSumListComprehensionBuiltInType__d0__d0__d0 1000)));
])

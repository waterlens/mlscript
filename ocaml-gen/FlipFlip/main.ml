...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_inlined_FlipFlip" (fun () -> ignore (let open Module_lumberhack_inlined_.Module_lumberhack_inlined_ in ((testFlipFlip ((genTree 17) 0)))));
  Bench.Test.create ~name:"lumberhack_flo_out_FlipFlip" (fun () -> ignore (let open Module_lumberhack_flo_out_.Module_lumberhack_flo_out_ in ((testFlipFlip ((genTree 17) 0)))));
])

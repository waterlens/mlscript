  ...
  (match _lh_addj_arg2_9 with
    | `LH_N -> 
      (let rec _lh_listcomp_fun_ls_h_1_1 = (`LH_C(_lh_addj_arg1_1_0, (`LH_N))) in
        (let rec _lh_listcomp_fun_ls_t_1_3 = (fun _lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_1_4 _lh_listcomp_fun_1_8 -> 
  ...
  (match _lh_permutations_arg1_0 with
    | `LH_N -> 
      (let rec _lh_listcomp_fun_ls_h_2 = (fun _lh_addj_arg1_2 -> 
        ...
        (let rec _lh_listcomp_fun_ls_t_5 = (fun _lh_listcomp_fun_6 _lh_permutations_LH_C_0_0 -> 
          (`LH_N)) in
  ...
  (match _lh_permutations_arg1_2 with
    | `LH_N -> 
      (let rec _lh_listcomp_fun_ls_h_3_3 = (fun _lh_addj_arg1_1_3 -> 
        ...
        (let rec _lh_listcomp_fun_ls_t_4_8 = (fun _lh_listcomp_fun_5_7 _lh_permutations_LH_C_0_1_2 _lh_listcomp_fun_5_8 _lh_permutations_LH_C_0_1_3 -> 
          (`LH_N)) in
...
(* lumberhack_pop_out *)
let rec addj_d0_d0_d0_d0_d0_d0_d0 _lh_addj_arg1_1_6 _lh_addj_arg2_1_3 =
  (_lh_addj_arg2_1_3 _lh_addj_arg1_1_6);;
let rec addj_d0_d0_d0_d1_d0_d0_d0 _lh_addj_arg1_1_7 _lh_addj_arg2_1_4 =
  (match _lh_addj_arg2_1_4 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_1_7, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_1, _lh_addj_LH_C_1_1_1) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_1_7, (`LH_C(_lh_addj_LH_C_0_1_1, _lh_addj_LH_C_1_1_1)))), (let rec _lh_listcomp_fun_6_9 = (fun _lh_listcomp_fun_para_3_0 -> 
        (match _lh_listcomp_fun_para_3_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_4_0, _lh_listcomp_fun_ls_t_5_2) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_1, _lh_listcomp_fun_ls_h_4_0)), (_lh_listcomp_fun_6_9 _lh_listcomp_fun_ls_t_5_2)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_6_9 ((addj_d0_d0_d0_d1_d0_d0_d0 _lh_addj_arg1_1_7) _lh_addj_LH_C_1_1_1)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d0_d0_d2_d0_d0_d0 _lh_addj_arg1_2_0 _lh_addj_arg2_1_6 =
  (match _lh_addj_arg2_1_6 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_0, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_4, _lh_addj_LH_C_1_1_4) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_0, (`LH_C(_lh_addj_LH_C_0_1_4, _lh_addj_LH_C_1_1_4)))), (let rec _lh_listcomp_fun_1_0_2 = (fun _lh_listcomp_fun_para_4_0 -> 
        (match _lh_listcomp_fun_para_4_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_1, _lh_listcomp_fun_ls_t_8_1) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_4, _lh_listcomp_fun_ls_h_6_1)), (_lh_listcomp_fun_1_0_2 _lh_listcomp_fun_ls_t_8_1)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_2 ((addj_d0_d0_d0_d2_d0_d0_d0 _lh_addj_arg1_2_0) _lh_addj_LH_C_1_1_4)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d0_d0_d3_d0_d0_d0 _lh_addj_arg1_2_3 _lh_addj_arg2_1_9 =
  (match _lh_addj_arg2_1_9 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_3, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_7, _lh_addj_LH_C_1_1_7) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_3, (`LH_C(_lh_addj_LH_C_0_1_7, _lh_addj_LH_C_1_1_7)))), (let rec _lh_listcomp_fun_1_0_5 = (fun _lh_listcomp_fun_para_4_3 -> 
        (match _lh_listcomp_fun_para_4_3 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_4, _lh_listcomp_fun_ls_t_8_4) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_7, _lh_listcomp_fun_ls_h_6_4)), (_lh_listcomp_fun_1_0_5 _lh_listcomp_fun_ls_t_8_4)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_5 ((addj_d0_d0_d0_d3_d0_d0_d0 _lh_addj_arg1_2_3) _lh_addj_LH_C_1_1_7)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d0_d0_d3_d0_d0_d1 _lh_addj_arg1_2_4 _lh_addj_arg2_2_0 =
  (match _lh_addj_arg2_2_0 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_4, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_8, _lh_addj_LH_C_1_1_8) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_4, (`LH_C(_lh_addj_LH_C_0_1_8, _lh_addj_LH_C_1_1_8)))), (let rec _lh_listcomp_fun_1_0_6 = (fun _lh_listcomp_fun_para_4_4 -> 
        (match _lh_listcomp_fun_para_4_4 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_5, _lh_listcomp_fun_ls_t_8_5) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_8, _lh_listcomp_fun_ls_h_6_5)), (_lh_listcomp_fun_1_0_6 _lh_listcomp_fun_ls_t_8_5)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_6 ((addj_d0_d0_d0_d3_d0_d0_d1 _lh_addj_arg1_2_4) _lh_addj_LH_C_1_1_8)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d0_d0_d4_d0_d0_d0 _lh_addj_arg1_2_8 _lh_addj_arg2_2_4 =
  (match _lh_addj_arg2_2_4 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_8, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_2_1, _lh_addj_LH_C_1_2_1) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_8, (`LH_C(_lh_addj_LH_C_0_2_1, _lh_addj_LH_C_1_2_1)))), (let rec _lh_listcomp_fun_1_0_9 = (fun _lh_listcomp_fun_para_4_7 -> 
        (match _lh_listcomp_fun_para_4_7 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_8, _lh_listcomp_fun_ls_t_8_8) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_2_1, _lh_listcomp_fun_ls_h_6_8)), (_lh_listcomp_fun_1_0_9 _lh_listcomp_fun_ls_t_8_8)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_9 ((addj_d0_d0_d0_d4_d0_d0_d0 _lh_addj_arg1_2_8) _lh_addj_LH_C_1_2_1)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d1_d0_d0_d0_d0_d0 _lh_addj_arg1_2_7 _lh_addj_arg2_2_3 =
  (_lh_addj_arg2_2_3 _lh_addj_arg1_2_7);;
let rec addj_d0_d1_d0_d1_d0_d0_d0 _lh_addj_arg1_2_5 _lh_addj_arg2_2_1 =
  (match _lh_addj_arg2_2_1 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_5, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_9, _lh_addj_LH_C_1_1_9) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_5, (`LH_C(_lh_addj_LH_C_0_1_9, _lh_addj_LH_C_1_1_9)))), (let rec _lh_listcomp_fun_1_0_7 = (fun _lh_listcomp_fun_para_4_5 -> 
        (match _lh_listcomp_fun_para_4_5 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_6, _lh_listcomp_fun_ls_t_8_6) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_9, _lh_listcomp_fun_ls_h_6_6)), (_lh_listcomp_fun_1_0_7 _lh_listcomp_fun_ls_t_8_6)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_7 ((addj_d0_d1_d0_d1_d0_d0_d0 _lh_addj_arg1_2_5) _lh_addj_LH_C_1_1_9)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d1_d0_d2_d0_d0_d0 _lh_addj_arg1_2_9 _lh_addj_arg2_2_5 =
  (_lh_addj_arg2_2_5 _lh_addj_arg1_2_9);;
let rec addj_d0_d1_d0_d2_d0_d1_d0 _lh_addj_arg1_3_2 _lh_addj_arg2_2_6 =
  (match _lh_addj_arg2_2_6 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_3_2, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_2_2, _lh_addj_LH_C_1_2_2) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_3_2, (`LH_C(_lh_addj_LH_C_0_2_2, _lh_addj_LH_C_1_2_2)))), (let rec _lh_listcomp_fun_1_3_2 = (fun _lh_listcomp_fun_para_5_4 -> 
        (match _lh_listcomp_fun_para_5_4 with
          | `LH_C(_lh_listcomp_fun_ls_h_7_6, _lh_listcomp_fun_ls_t_1_0_0) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_2_2, _lh_listcomp_fun_ls_h_7_6)), (_lh_listcomp_fun_1_3_2 _lh_listcomp_fun_ls_t_1_0_0)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_3_2 ((addj_d0_d1_d0_d2_d0_d1_d0 _lh_addj_arg1_3_2) _lh_addj_LH_C_1_2_2)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d1_d0_d3_d0_d0_d0 _lh_addj_arg1_2_6 _lh_addj_arg2_2_2 =
  (match _lh_addj_arg2_2_2 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_6, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_2_0, _lh_addj_LH_C_1_2_0) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_6, (`LH_C(_lh_addj_LH_C_0_2_0, _lh_addj_LH_C_1_2_0)))), (let rec _lh_listcomp_fun_1_0_8 = (fun _lh_listcomp_fun_para_4_6 -> 
        (match _lh_listcomp_fun_para_4_6 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_7, _lh_listcomp_fun_ls_t_8_7) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_2_0, _lh_listcomp_fun_ls_h_6_7)), (_lh_listcomp_fun_1_0_8 _lh_listcomp_fun_ls_t_8_7)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_8 ((addj_d0_d1_d0_d3_d0_d0_d0 _lh_addj_arg1_2_6) _lh_addj_LH_C_1_2_0)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d1_d2_d0_d0_d0_d0 _lh_addj_arg1_2_2 _lh_addj_arg2_1_8 =
  (match _lh_addj_arg2_1_8 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_2, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_6, _lh_addj_LH_C_1_1_6) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_2, (`LH_C(_lh_addj_LH_C_0_1_6, _lh_addj_LH_C_1_1_6)))), (let rec _lh_listcomp_fun_1_0_4 = (fun _lh_listcomp_fun_para_4_2 -> 
        (match _lh_listcomp_fun_para_4_2 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_3, _lh_listcomp_fun_ls_t_8_3) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_6, _lh_listcomp_fun_ls_h_6_3)), (_lh_listcomp_fun_1_0_4 _lh_listcomp_fun_ls_t_8_3)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_4 ((addj_d0_d1_d2_d0_d0_d0_d0 _lh_addj_arg1_2_2) _lh_addj_LH_C_1_1_6)))))
    | _ -> 
      (Obj.magic 99));;
let rec addj_d0_d1_d3_d0_d0_d0_d0 _lh_addj_arg1_2_1 _lh_addj_arg2_1_7 =
  (match _lh_addj_arg2_1_7 with
    | `LH_N -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_1, (`LH_N))), (`LH_N)))
    | `LH_C(_lh_addj_LH_C_0_1_5, _lh_addj_LH_C_1_1_5) -> 
      (`LH_C((`LH_C(_lh_addj_arg1_2_1, (`LH_C(_lh_addj_LH_C_0_1_5, _lh_addj_LH_C_1_1_5)))), (let rec _lh_listcomp_fun_1_0_3 = (fun _lh_listcomp_fun_para_4_1 -> 
        (match _lh_listcomp_fun_para_4_1 with
          | `LH_C(_lh_listcomp_fun_ls_h_6_2, _lh_listcomp_fun_ls_t_8_2) -> 
            (`LH_C((`LH_C(_lh_addj_LH_C_0_1_5, _lh_listcomp_fun_ls_h_6_2)), (_lh_listcomp_fun_1_0_3 _lh_listcomp_fun_ls_t_8_2)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_0_3 ((addj_d0_d1_d3_d0_d0_d0_d0 _lh_addj_arg1_2_1) _lh_addj_LH_C_1_1_5)))))
    | _ -> 
      (Obj.magic 99));;
...
let rec filter_d0_d1_d0_d0_d0_d1_d0 f_7 ls_7 =
  (match ls_7 with
    | `LH_C(h_5, t_5) -> 
      (if (f_7 h_5) then
    ...
    | `LH_N -> 
      (`LH_N));;
let rec map_d0_d0_d0_d0_d0_d0_d0 f_1_2 ls_1_2 =
  (ls_1_2 f_1_2);;
let rec map_d0_d0_d1_d0_d0_d0_d0 f_1_1 ls_9 =
  (ls_9 f_1_1);;
let rec take_d0_d0_d0_d0_d0_d0_d0 n_4 ls_1_0 =
  (if (n_4 > 0) then
    (ls_1_0 n_4)
  else
    (`LH_N));;
let rec take_d0_d0_d1_d0_d0_d0_d0 n_5 ls_1_1 =
  (if (n_5 > 0) then
    (ls_1_1 n_5)
  else
    (`LH_N));;
let rec addj_d0_d1_d1_d0_d0_d0_d0 _lh_addj_arg1_1_8 _lh_addj_arg2_1_5 =
  (match _lh_addj_arg2_1_5 with
    | `LH_N -> 
      (let rec _lh_listcomp_fun_ls_h_4_1 = (`LH_C(_lh_addj_arg1_1_8, (`LH_N))) in
        (let rec _lh_listcomp_fun_ls_t_5_3 = (fun _lh_listcomp_fun_7_0 _lh_listcomp_fun_ls_t_5_4 _lh_listcomp_fun_7_1 -> 
          (_lh_listcomp_fun_7_1 _lh_listcomp_fun_ls_t_5_4)) in
          (fun _lh_listcomp_fun_7_2 _lh_listcomp_fun_ls_t_5_5 _lh_listcomp_fun_7_3 -> 
            (let rec _lh_listcomp_fun_ls_h_4_2 = _lh_listcomp_fun_ls_h_4_1 in
              (let rec _lh_listcomp_fun_ls_t_5_6 = (_lh_listcomp_fun_7_2 _lh_listcomp_fun_ls_t_5_3) in
                (fun _lh_listcomp_fun_7_4 _lh_permutations_LH_C_0_2_1 -> 
                  (let rec _lh_listcomp_fun_7_5 = (fun _lh_listcomp_fun_para_3_1 -> 
                    (match _lh_listcomp_fun_para_3_1 with
                      | `LH_C(_lh_listcomp_fun_ls_h_4_3, _lh_listcomp_fun_ls_t_5_7) -> 
                        (let rec _lh_listcomp_fun_ls_h_4_4 = _lh_listcomp_fun_ls_h_4_3 in
                          (let rec _lh_listcomp_fun_ls_t_5_8 = (_lh_listcomp_fun_7_5 _lh_listcomp_fun_ls_t_5_7) in
                            (fun _lh_listcomp_fun_7_6 _lh_permutations_LH_C_0_2_2 -> 
                              (let rec _lh_listcomp_fun_7_7 = (fun _lh_listcomp_fun_para_3_2 -> 
                                (match _lh_listcomp_fun_para_3_2 with
                                  | `LH_C(_lh_listcomp_fun_ls_h_4_5, _lh_listcomp_fun_ls_t_5_9) -> 
                                    (`LH_C(_lh_listcomp_fun_ls_h_4_5, (_lh_listcomp_fun_7_7 _lh_listcomp_fun_ls_t_5_9)))
                                  | `LH_N -> 
                                    (_lh_listcomp_fun_7_6 _lh_listcomp_fun_ls_t_5_8))) in
                                (_lh_listcomp_fun_7_7 ((addj_d0_d0_d0_d2_d0_d0_d0 _lh_permutations_LH_C_0_2_2) _lh_listcomp_fun_ls_h_4_4))))))
                      | `LH_N -> 
                        (_lh_listcomp_fun_7_4 _lh_listcomp_fun_ls_t_5_6))) in
                    (_lh_listcomp_fun_7_5 ((addj_d0_d1_d0_d1_d0_d0_d0 _lh_permutations_LH_C_0_2_1) _lh_listcomp_fun_ls_h_4_2)))))))))
    | `LH_C(_lh_addj_LH_C_0_1_2, _lh_addj_LH_C_1_1_2) -> 
      (let rec _lh_listcomp_fun_ls_h_4_6 = (`LH_C(_lh_addj_arg1_1_8, (`LH_C(_lh_addj_LH_C_0_1_2, _lh_addj_LH_C_1_1_2)))) in
        (let rec _lh_listcomp_fun_ls_t_6_0 = (let rec _lh_listcomp_fun_7_8 = (fun _lh_listcomp_fun_para_3_3 -> 
          (match _lh_listcomp_fun_para_3_3 with
            | `LH_C(_lh_listcomp_fun_ls_h_4_7, _lh_listcomp_fun_ls_t_6_1) -> 
              (let rec _lh_listcomp_fun_ls_h_4_8 = (let rec _lh_addj_LH_C_0_1_3 = _lh_addj_LH_C_0_1_2 in
                (let rec _lh_addj_LH_C_1_1_3 = _lh_listcomp_fun_ls_h_4_7 in
                  (fun _lh_addj_arg1_1_9 -> 
                    (let rec _lh_listcomp_fun_ls_h_4_9 = (`LH_C(_lh_addj_arg1_1_9, (`LH_C(_lh_addj_LH_C_0_1_3, _lh_addj_LH_C_1_1_3)))) in
                      (let rec _lh_listcomp_fun_ls_t_6_2 = (let rec _lh_listcomp_fun_7_9 = (fun _lh_listcomp_fun_para_3_4 -> 
                        (match _lh_listcomp_fun_para_3_4 with
                          | `LH_C(_lh_listcomp_fun_ls_h_5_0, _lh_listcomp_fun_ls_t_6_3) -> 
                            (let rec _lh_listcomp_fun_ls_h_5_1 = (`LH_C(_lh_addj_LH_C_0_1_3, _lh_listcomp_fun_ls_h_5_0)) in
                              (let rec _lh_listcomp_fun_ls_t_6_4 = (_lh_listcomp_fun_7_9 _lh_listcomp_fun_ls_t_6_3) in
                                (fun _lh_listcomp_fun_8_0 _lh_listcomp_fun_ls_t_6_5 _lh_listcomp_fun_8_1 -> 
                                  (let rec _lh_listcomp_fun_ls_h_5_2 = _lh_listcomp_fun_ls_h_5_1 in
                                    (let rec _lh_listcomp_fun_ls_t_6_6 = (_lh_listcomp_fun_8_0 _lh_listcomp_fun_ls_t_6_4) in
                                      (fun _lh_listcomp_fun_8_2 _lh_permutations_LH_C_0_2_3 -> 
                                        (let rec _lh_listcomp_fun_8_3 = (fun _lh_listcomp_fun_para_3_5 -> 
                                          (match _lh_listcomp_fun_para_3_5 with
                                            | `LH_C(_lh_listcomp_fun_ls_h_5_3, _lh_listcomp_fun_ls_t_6_7) -> 
                                              (`LH_C(_lh_listcomp_fun_ls_h_5_3, (_lh_listcomp_fun_8_3 _lh_listcomp_fun_ls_t_6_7)))
                                            | `LH_N -> 
                                              (_lh_listcomp_fun_8_2 _lh_listcomp_fun_ls_t_6_6))) in
                                          (_lh_listcomp_fun_8_3 ((addj_d0_d0_d0_d3_d0_d0_d0 _lh_permutations_LH_C_0_2_3) _lh_listcomp_fun_ls_h_5_2)))))))))
                          | `LH_N -> 
                            (fun _lh_listcomp_fun_8_4 _lh_listcomp_fun_ls_t_6_8 _lh_listcomp_fun_8_5 -> 
                              (_lh_listcomp_fun_8_5 _lh_listcomp_fun_ls_t_6_8)))) in
                        (_lh_listcomp_fun_7_9 ((addj_d0_d1_d0_d2_d0_d1_d0 _lh_addj_arg1_1_9) _lh_addj_LH_C_1_1_3))) in
                        (fun _lh_listcomp_fun_8_6 _lh_listcomp_fun_ls_t_6_9 _lh_listcomp_fun_8_7 -> 
                          (let rec _lh_listcomp_fun_ls_h_5_4 = _lh_listcomp_fun_ls_h_4_9 in
                            (let rec _lh_listcomp_fun_ls_t_7_0 = (_lh_listcomp_fun_8_6 _lh_listcomp_fun_ls_t_6_2) in
                              (fun _lh_listcomp_fun_8_8 _lh_permutations_LH_C_0_2_4 -> 
                                (let rec _lh_listcomp_fun_8_9 = (fun _lh_listcomp_fun_para_3_6 -> 
                                  (match _lh_listcomp_fun_para_3_6 with
                                    | `LH_C(_lh_listcomp_fun_ls_h_5_5, _lh_listcomp_fun_ls_t_7_1) -> 
                                      (`LH_C(_lh_listcomp_fun_ls_h_5_5, (_lh_listcomp_fun_8_9 _lh_listcomp_fun_ls_t_7_1)))
                                    | `LH_N -> 
                                      (_lh_listcomp_fun_8_8 _lh_listcomp_fun_ls_t_7_0))) in
                                  (_lh_listcomp_fun_8_9 ((addj_d0_d0_d0_d3_d0_d0_d1 _lh_permutations_LH_C_0_2_4) _lh_listcomp_fun_ls_h_5_4)))))))))))) in
                (let rec _lh_listcomp_fun_ls_t_7_2 = (_lh_listcomp_fun_7_8 _lh_listcomp_fun_ls_t_6_1) in
                  (fun _lh_listcomp_fun_9_0 _lh_listcomp_fun_ls_t_7_3 _lh_listcomp_fun_9_1 -> 
                    (let rec _lh_listcomp_fun_ls_h_5_6 = _lh_listcomp_fun_ls_h_4_8 in
                      (let rec _lh_listcomp_fun_ls_t_7_4 = (_lh_listcomp_fun_9_0 _lh_listcomp_fun_ls_t_7_2) in
                        (fun _lh_listcomp_fun_9_2 _lh_permutations_LH_C_0_2_5 -> 
                          (let rec _lh_listcomp_fun_9_3 = (fun _lh_listcomp_fun_para_3_7 -> 
                            (((_lh_listcomp_fun_para_3_7 _lh_listcomp_fun_9_3) _lh_listcomp_fun_ls_t_7_4) _lh_listcomp_fun_9_2)) in
                            (_lh_listcomp_fun_9_3 ((addj_d0_d1_d0_d2_d0_d0_d0 _lh_permutations_LH_C_0_2_5) _lh_listcomp_fun_ls_h_5_6)))))))))
            | `LH_N -> 
              (fun _lh_listcomp_fun_9_4 _lh_listcomp_fun_ls_t_7_5 _lh_listcomp_fun_9_5 -> 
                (_lh_listcomp_fun_9_5 _lh_listcomp_fun_ls_t_7_5)))) in
          (_lh_listcomp_fun_7_8 ((addj_d0_d1_d2_d0_d0_d0_d0 _lh_addj_arg1_1_8) _lh_addj_LH_C_1_1_2))) in
          (fun _lh_listcomp_fun_9_6 _lh_listcomp_fun_ls_t_7_6 _lh_listcomp_fun_9_7 -> 
            (let rec _lh_listcomp_fun_ls_h_5_7 = _lh_listcomp_fun_ls_h_4_6 in
              (let rec _lh_listcomp_fun_ls_t_7_7 = (_lh_listcomp_fun_9_6 _lh_listcomp_fun_ls_t_6_0) in
                (fun _lh_listcomp_fun_9_8 _lh_permutations_LH_C_0_2_6 -> 
                  (let rec _lh_listcomp_fun_9_9 = (fun _lh_listcomp_fun_para_3_8 -> 
                    (match _lh_listcomp_fun_para_3_8 with
                      | `LH_C(_lh_listcomp_fun_ls_h_5_8, _lh_listcomp_fun_ls_t_7_8) -> 
                        (let rec _lh_listcomp_fun_ls_h_5_9 = _lh_listcomp_fun_ls_h_5_8 in
                          (let rec _lh_listcomp_fun_ls_t_7_9 = (_lh_listcomp_fun_9_9 _lh_listcomp_fun_ls_t_7_8) in
                            (fun _lh_listcomp_fun_1_0_0 _lh_permutations_LH_C_0_2_7 -> 
                              (let rec _lh_listcomp_fun_1_0_1 = (fun _lh_listcomp_fun_para_3_9 -> 
                                (match _lh_listcomp_fun_para_3_9 with
                                  | `LH_C(_lh_listcomp_fun_ls_h_6_0, _lh_listcomp_fun_ls_t_8_0) -> 
                                    (`LH_C(_lh_listcomp_fun_ls_h_6_0, (_lh_listcomp_fun_1_0_1 _lh_listcomp_fun_ls_t_8_0)))
                                  | `LH_N -> 
                                    (_lh_listcomp_fun_1_0_0 _lh_listcomp_fun_ls_t_7_9))) in
                                (_lh_listcomp_fun_1_0_1 ((addj_d0_d0_d0_d4_d0_d0_d0 _lh_permutations_LH_C_0_2_7) _lh_listcomp_fun_ls_h_5_9))))))
                      | `LH_N -> 
                        (_lh_listcomp_fun_9_8 _lh_listcomp_fun_ls_t_7_7))) in
                    (_lh_listcomp_fun_9_9 ((addj_d0_d1_d0_d3_d0_d0_d0 _lh_permutations_LH_C_0_2_6) _lh_listcomp_fun_ls_h_5_7)))))))))
    | _ -> 
      (Obj.magic 99))
and condition_d0_d0_d0_d0_d0_d0_d0 _lh_condition_arg1_1 =
  (match _lh_condition_arg1_1 with
    ...
    | _ -> 
      (Obj.magic 99))
and enumFromTo_d0_d0_d0_d0_d0_d0_d0 a_3 b_3 _lh_popOutId_0_1 =
  (if (a_3 <= b_3) then
    (let rec h_8 = a_3 in
      (let rec t_8 = ((enumFromTo_d0_d0_d0_d0_d0_d0_d0 (a_3 + 1)) b_3) in
        (`LH_C(h_8, ((take_d0_d0_d0_d0_d0_d0_d0 (_lh_popOutId_0_1 - 1)) t_8)))))
  else
    (`LH_N))
and enumFromTo_d1_d0_d0_d0_d0_d0_d0 a_2 b_2 _lh_popOutId_0_0 =
  (if (a_2 <= b_2) then
    (let rec h_7 = a_2 in
      (let rec t_7 = ((enumFromTo_d1_d0_d0_d0_d0_d0_d0 (a_2 + 1)) b_2) in
        (`LH_C((_lh_popOutId_0_0 h_7), ((map_d0_d0_d0_d0_d0_d0_d0 _lh_popOutId_0_0) t_7)))))
  else
    (`LH_N))
and filter_d0_d0_d0_d0_d0_d0_d0 f_8 ls_8 =
  (match ls_8 with
    | `LH_C(h_6, t_6) -> 
      (if (f_8 h_6) then
        (`LH_C(h_6, ((filter_d0_d0_d0_d0_d0_d0_d0 f_8) t_6)))
      else
        ((filter_d0_d1_d0_d0_d0_d0_d0 f_8) t_6))
    | `LH_N -> 
      (`LH_N))
and filter_d0_d1_d0_d0_d0_d0_d0 f_1_3 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_9, t_9) -> 
      (if (f_1_3 h_9) then
        (`LH_C(h_9, ((filter_d0_d1_d0_d0_d0_d0_d0 f_1_3) t_9)))
      else
        ((filter_d0_d1_d0_d0_d0_d1_d0 f_1_3) t_9))
    | `LH_N -> 
      (`LH_N))
and permutations_d0_d0_d0_d0_d0_d0_d0 _lh_permutations_arg1_4 =
  (match _lh_permutations_arg1_4 with
    | `LH_N -> 
      (`LH_C((`LH_N), (`LH_N)))
    | `LH_C(_lh_permutations_LH_C_0_1_9, _lh_permutations_LH_C_1_4) -> 
      (let rec _lh_listcomp_fun_6_6 = (fun _lh_listcomp_fun_para_2_7 -> 
        ((_lh_listcomp_fun_para_2_7 _lh_listcomp_fun_6_6) _lh_permutations_LH_C_0_1_9)) in
        (_lh_listcomp_fun_6_6 (permutations_d0_d1_d0_d0_d0_d0_d0 _lh_permutations_LH_C_1_4)))
    | _ -> 
      (Obj.magic 99))
and permutations_d0_d1_d0_d0_d0_d0_d0 _lh_permutations_arg1_7 =
  (match _lh_permutations_arg1_7 with
    | `LH_N -> 
      (let rec _lh_listcomp_fun_ls_h_7_4 = (fun _lh_addj_arg1_3_1 -> 
        (let rec _lh_listcomp_fun_ls_h_7_5 = (`LH_C(_lh_addj_arg1_3_1, (`LH_N))) in
          (let rec _lh_listcomp_fun_ls_t_9_6 = (fun _lh_listcomp_fun_1_2_4 _lh_listcomp_fun_ls_t_9_7 _lh_listcomp_fun_1_2_5 -> 
            (_lh_listcomp_fun_1_2_5 _lh_listcomp_fun_ls_t_9_7)) in
            (fun _lh_listcomp_fun_1_2_6 _lh_listcomp_fun_ls_t_9_8 _lh_listcomp_fun_1_2_7 -> 
              (`LH_C(_lh_listcomp_fun_ls_h_7_5, (_lh_listcomp_fun_1_2_6 _lh_listcomp_fun_ls_t_9_6))))))) in
        (let rec _lh_listcomp_fun_ls_t_9_9 = (fun _lh_listcomp_fun_1_2_8 _lh_permutations_LH_C_0_3_5 -> 
          (`LH_N)) in
          (fun _lh_listcomp_fun_1_2_9 _lh_permutations_LH_C_0_3_6 -> 
            (let rec _lh_listcomp_fun_1_3_0 = (fun _lh_listcomp_fun_para_5_2 -> 
              (((_lh_listcomp_fun_para_5_2 _lh_listcomp_fun_1_3_0) _lh_listcomp_fun_ls_t_9_9) _lh_listcomp_fun_1_2_9)) in
              (_lh_listcomp_fun_1_3_0 ((addj_d0_d0_d0_d0_d0_d0_d0 _lh_permutations_LH_C_0_3_6) _lh_listcomp_fun_ls_h_7_4))))))
    | `LH_C(_lh_permutations_LH_C_0_3_7, _lh_permutations_LH_C_1_7) -> 
      (let rec _lh_listcomp_fun_1_3_1 = (fun _lh_listcomp_fun_para_5_3 -> 
        ((_lh_listcomp_fun_para_5_3 _lh_listcomp_fun_1_3_1) _lh_permutations_LH_C_0_3_7)) in
        (_lh_listcomp_fun_1_3_1 (permutations_d0_d1_d1_d0_d0_d0_d0 _lh_permutations_LH_C_1_7)))
    | _ -> 
      (Obj.magic 99))
and permutations_d0_d1_d1_d0_d0_d0_d0 _lh_permutations_arg1_6 =
  (match _lh_permutations_arg1_6 with
    | `LH_N -> 
      (let rec _lh_listcomp_fun_ls_h_6_9 = (fun _lh_addj_arg1_3_0 -> 
        (let rec _lh_listcomp_fun_ls_h_7_0 = (`LH_C(_lh_addj_arg1_3_0, (`LH_N))) in
          (let rec _lh_listcomp_fun_ls_t_8_9 = (fun _lh_listcomp_fun_1_1_0 _lh_listcomp_fun_ls_t_9_0 _lh_listcomp_fun_1_1_1 -> 
            (_lh_listcomp_fun_1_1_1 _lh_listcomp_fun_ls_t_9_0)) in
            (fun _lh_listcomp_fun_1_1_2 _lh_listcomp_fun_ls_t_9_1 _lh_listcomp_fun_1_1_3 -> 
              (let rec _lh_listcomp_fun_ls_h_7_1 = _lh_listcomp_fun_ls_h_7_0 in
                (let rec _lh_listcomp_fun_ls_t_9_2 = (_lh_listcomp_fun_1_1_2 _lh_listcomp_fun_ls_t_8_9) in
                  (fun _lh_listcomp_fun_1_1_4 _lh_permutations_LH_C_0_2_8 -> 
                    (let rec _lh_listcomp_fun_1_1_5 = (fun _lh_listcomp_fun_para_4_8 -> 
                      (match _lh_listcomp_fun_para_4_8 with
                        | `LH_C(_lh_listcomp_fun_ls_h_7_2, _lh_listcomp_fun_ls_t_9_3) -> 
                          (`LH_C(_lh_listcomp_fun_ls_h_7_2, (_lh_listcomp_fun_1_1_5 _lh_listcomp_fun_ls_t_9_3)))
                        | `LH_N -> 
                          (_lh_listcomp_fun_1_1_4 _lh_listcomp_fun_ls_t_9_2))) in
                      (_lh_listcomp_fun_1_1_5 ((addj_d0_d0_d0_d1_d0_d0_d0 _lh_permutations_LH_C_0_2_8) _lh_listcomp_fun_ls_h_7_1)))))))))) in
        (let rec _lh_listcomp_fun_ls_t_9_4 = (fun _lh_listcomp_fun_1_1_6 _lh_permutations_LH_C_0_2_9 _lh_listcomp_fun_1_1_7 _lh_permutations_LH_C_0_3_0 -> 
          (`LH_N)) in
          (fun _lh_listcomp_fun_1_1_8 _lh_permutations_LH_C_0_3_1 -> 
            (let rec _lh_listcomp_fun_1_1_9 = (fun _lh_listcomp_fun_para_4_9 -> 
              (((_lh_listcomp_fun_para_4_9 _lh_listcomp_fun_1_1_9) _lh_listcomp_fun_ls_t_9_4) _lh_listcomp_fun_1_1_8)) in
              (_lh_listcomp_fun_1_1_9 ((addj_d0_d1_d0_d0_d0_d0_d0 _lh_permutations_LH_C_0_3_1) _lh_listcomp_fun_ls_h_6_9))))))
    | `LH_C(_lh_permutations_LH_C_0_3_2, _lh_permutations_LH_C_1_6) -> 
      (let rec _lh_listcomp_fun_1_2_0 = (fun _lh_listcomp_fun_para_5_0 -> 
        (match _lh_listcomp_fun_para_5_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_7_3, _lh_listcomp_fun_ls_t_9_5) -> 
            (let rec _lh_listcomp_fun_1_2_1 = (fun _lh_listcomp_fun_para_5_1 -> 
              (((_lh_listcomp_fun_para_5_1 _lh_listcomp_fun_1_2_1) _lh_listcomp_fun_ls_t_9_5) _lh_listcomp_fun_1_2_0)) in
              (_lh_listcomp_fun_1_2_1 ((addj_d0_d1_d1_d0_d0_d0_d0 _lh_permutations_LH_C_0_3_2) _lh_listcomp_fun_ls_h_7_3)))
          | `LH_N -> 
            (fun _lh_listcomp_fun_1_2_2 _lh_permutations_LH_C_0_3_3 _lh_listcomp_fun_1_2_3 _lh_permutations_LH_C_0_3_4 -> 
              (`LH_N)))) in
        (_lh_listcomp_fun_1_2_0 (permutations_d0_d1_d2_d0_d0_d0_d0 _lh_permutations_LH_C_1_6)))
    | _ -> 
      (Obj.magic 99))
and permutations_d0_d1_d2_d0_d0_d0_d0 _lh_permutations_arg1_5 =
  (match _lh_permutations_arg1_5 with
    | `LH_N -> 
      (`LH_C((`LH_N), (`LH_N)))
    | `LH_C(_lh_permutations_LH_C_0_2_0, _lh_permutations_LH_C_1_5) -> 
            ...
            (let rec _lh_listcomp_fun_6_8 = (fun _lh_listcomp_fun_para_2_9 -> 
              (match _lh_listcomp_fun_para_2_9 with
                | `LH_C(_lh_listcomp_fun_ls_h_3_9, _lh_listcomp_fun_ls_t_5_1) -> 
                  (`LH_C(_lh_listcomp_fun_ls_h_3_9, (_lh_listcomp_fun_6_8 _lh_listcomp_fun_ls_t_5_1)))
                | `LH_N -> 
                  (_lh_listcomp_fun_6_7 _lh_listcomp_fun_ls_t_5_0))) in
              (_lh_listcomp_fun_6_8 ((addj_d0_d1_d3_d0_d0_d0_d0 _lh_permutations_LH_C_0_2_0) _lh_listcomp_fun_ls_h_3_8)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_6_7 (permutations_d0_d1_d2_d0_d0_d0_d0 _lh_permutations_LH_C_1_5)))
    | _ -> 
      (Obj.magic 99))

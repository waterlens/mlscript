    ...
    (let rec _lh_listcomp_fun_ls_t_1_7 = ((enumFromTo_lh__d3 (a_2 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_1_8 = a_2 in
        (fun _lh_listcomp_fun_2_3 radicals_3 -> 
          (`LH_C((length_lh__d4 ((ccp_generator_lh__d2 radicals_3) _lh_listcomp_fun_ls_h_1_8)), (_lh_listcomp_fun_2_3 _lh_listcomp_fun_ls_t_1_7))))))
  else
    (fun _lh_listcomp_fun_2_4 radicals_4 -> 
      (`LH_N)));;
  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo_lh__d4 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_2 = a_0 in
        (fun _lh_listcomp_fun_2 radicals_0 -> 
          (`LH_C((length_lh__d5 ((bcp_generator_lh__d2 radicals_0) _lh_listcomp_fun_ls_h_2)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2))))))
  else
    (fun _lh_listcomp_fun_3 radicals_1 -> 
      (`LH_N)));;
  ...
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1_4 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1_5 = a_1 in
        (fun _lh_listcomp_fun_ls_h_1_6 _lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_1_5 _lh_listcomp_fun_2_0 -> 
          (`LH_C((length_lh__d1 ((atIndex_lz_lh__d1 _lh_listcomp_fun_ls_h_1_5) _lh_listcomp_fun_ls_h_1_6)), (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_1_4))))))
  else
    (fun _lh_listcomp_fun_ls_h_1_7 _lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_1_6 _lh_listcomp_fun_2_2 -> 
  ...
  (if (a_3 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_3_1 = ((enumFromTo_lh__d2 (a_3 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_2_9 = a_3 in
        (fun _lh_listcomp_fun_4_3 radicals_8 -> 
          (`LH_C(((length_lh__d2 ((bcp_generator_lh__d1 radicals_8) _lh_listcomp_fun_ls_h_2_9)) + (length_lh__d3 ((ccp_generator_lh__d1 radicals_8) _lh_listcomp_fun_ls_h_2_9))), (_lh_listcomp_fun_4_3 _lh_listcomp_fun_ls_t_3_1))))))
  else
    (fun _lh_listcomp_fun_4_4 radicals_9 -> 
      (`LH_N)));;

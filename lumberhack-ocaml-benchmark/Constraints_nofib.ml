  ...
  (if ((complete__d0 _lh_checkComplete_arg1_1) _lh_checkComplete_arg2_1) then
    (let rec _lh_f_Known_0_1 = (`LH_N) in
      (fun _lh_f_LH_P2_0_3 _lh_f_arg2_4 -> 
        (`Node((`LH_P2(_lh_f_LH_P2_0_3, (`Known(_lh_f_Known_0_1)))), _lh_f_arg2_4))))
  else
    (fun _lh_f_LH_P2_0_4 _lh_f_arg2_5 -> 
      (let rec cs'_0 = (`Known(((combine__d0 ((map__d1 label__d0) _lh_f_arg2_5)) (`LH_N)))) in
        (if (knownConflict__d0 cs'_0) then
          (`Node((`LH_P2(_lh_f_LH_P2_0_4, cs'_0)), (`LH_N)))
        else
          (`Node((`LH_P2(_lh_f_LH_P2_0_4, cs'_0)), _lh_f_arg2_5))))))
  ...
  (if ((complete__d1 _lh_checkComplete_arg1_2) _lh_checkComplete_arg2_2) then
    (let rec _lh_f_Known_0_2 = (`LH_N) in
      (fun _lh_f_LH_P2_0_5 _lh_f_arg2_6 -> 
        (`Node((`LH_P2(_lh_f_LH_P2_0_5, (`Known(_lh_f_Known_0_2)))), _lh_f_arg2_6))))
  else
    (fun _lh_f_LH_P2_0_6 _lh_f_arg2_7 -> 
      (`Node((`LH_P2(_lh_f_LH_P2_0_6, (`Known(((combine__d1 ((map__d4 label__d1) _lh_f_arg2_7)) (`LH_N)))))), _lh_f_arg2_7))))
    ...
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo__d0 (a_6 + 1)) b_4) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_6 in
        (fun _lh_fillTable_CSP_1_1 _lh_listcomp_fun_1_1 -> 
          (let rec ty_1 = (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_3) in
            (let rec hy_1 = (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_5 -> 
              ...
              (_lh_listcomp_fun_1_2 ((enumFromTo__d1 1) _lh_fillTable_CSP_1_1))) in
              (fun f_4_2 hx_3 tx_3 -> 
                (`LH_C(((f_4_2 hx_3) hy_1), (((zipWith__d0 f_4_2) tx_3) ty_1)))))))))
  else
    (fun _lh_fillTable_CSP_1_2 _lh_listcomp_fun_1_3 f_4_3 hx_4 tx_4 -> 
      (`LH_N)))
and enumFromTo__d1 a_2 b_2 =
  (if (a_2 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo__d1 (a_2 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_2 in
        (fun _lh_listcomp_fun_ls_h_1 _lh_listcomp_fun_6 -> 
          (let rec ty_0 = (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_1) in
              ...
              (let rec _lh_fillTable_LH_P2_0_0 = _lh_listcomp_fun_ls_h_1 in
                (fun _lh_fillTable_Assign_0_1 _lh_fillTable_Assign_1_1 _lh_fillTable_CSP_2_1 cs_2 -> 
                  (if ((cs_2 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_1 (`Assign(_lh_fillTable_Assign_0_1, _lh_fillTable_Assign_1_1))) (`Assign(_lh_fillTable_LH_P2_0_0, _lh_fillTable_LH_P2_1_0))))) then
                    ...
                    cs_2)))) in
              (fun f_2_5 hx_1 tx_1 -> 
                (`LH_C(((f_2_5 hx_1) hy_0), (((zipWith__d1 f_2_5) tx_1) ty_0)))))))))
  else
    (fun _lh_listcomp_fun_ls_h_2 _lh_listcomp_fun_7 f_2_6 hx_2 tx_2 -> 
      (`LH_N)))
and enumFromTo__d2 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo__d2 (a_0 + 1)) b_0) in
      (fun _lh_emptyTable_CSP_1_0 _lh_listcomp_fun_0 -> 
        (`LH_C((let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_0 -> 
          (_lh_listcomp_fun_para_0 _lh_listcomp_fun_1)) in
          (_lh_listcomp_fun_1 ((enumFromTo__d3 1) _lh_emptyTable_CSP_1_0))), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))))
  else
    (fun _lh_emptyTable_CSP_1_1 _lh_listcomp_fun_2 -> 
      (`LH_N)))
and enumFromTo__d4 a_1_5 b_1_1 =
  (if (a_1_5 <= b_1_1) then
    (let rec _lh_listcomp_fun_ls_t_1_0 = ((enumFromTo__d4 (a_1_5 + 1)) b_1_1) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_1_5 in
        (fun _lh_fillTable_CSP_1_4 _lh_listcomp_fun_2_6 -> 
          (let rec ty_3 = (_lh_listcomp_fun_2_6 _lh_listcomp_fun_ls_t_1_0) in
            (let rec hy_3 = (let rec _lh_listcomp_fun_2_7 = (fun _lh_listcomp_fun_para_1_0 -> 
              ...
              (_lh_listcomp_fun_2_7 ((enumFromTo__d5 1) _lh_fillTable_CSP_1_4))) in
              (fun f_7_5 hx_1_0 tx_1_0 -> 
                (`LH_C(((f_7_5 hx_1_0) hy_3), (((zipWith__d2 f_7_5) tx_1_0) ty_3)))))))))
  else
    (fun _lh_fillTable_CSP_1_5 _lh_listcomp_fun_2_8 f_7_6 hx_1_1 tx_1_1 -> 
      (`LH_N)))
and enumFromTo__d5 a_1_0 b_8 =
  (if (a_1_0 <= b_8) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo__d5 (a_1_0 + 1)) b_8) in
      (let rec _lh_listcomp_fun_ls_h_6 = a_1_0 in
        (fun _lh_listcomp_fun_ls_h_7 _lh_listcomp_fun_2_1 -> 
              ...
              (let rec _lh_fillTable_LH_P2_0_1 = _lh_listcomp_fun_ls_h_7 in
                (fun _lh_fillTable_Assign_0_2 _lh_fillTable_Assign_1_2 _lh_fillTable_CSP_2_2 cs_4 -> 
                  (if ((cs_4 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_2 (`Assign(_lh_fillTable_Assign_0_2, _lh_fillTable_Assign_1_2))) (`Assign(_lh_fillTable_LH_P2_0_1, _lh_fillTable_LH_P2_1_1))))) then
                    ...
                    cs_4)))) in
              (fun f_5_1 hx_5 tx_5 -> 
                (`LH_C(((f_5_1 hx_5) hy_2), (((zipWith__d3 f_5_1) tx_5) ty_2)))))))))
  else
    (fun _lh_listcomp_fun_ls_h_8 _lh_listcomp_fun_2_2 f_5_2 hx_6 tx_6 -> 
      (`LH_N)))
and enumFromTo__d6 a_9 b_7 =
  (if (a_9 <= b_7) then
    (let rec _lh_listcomp_fun_ls_t_7 = ((enumFromTo__d6 (a_9 + 1)) b_7) in
      (fun _lh_emptyTable_CSP_1_4 _lh_listcomp_fun_1_8 -> 
        (`LH_C((let rec _lh_listcomp_fun_1_9 = (fun _lh_listcomp_fun_para_8 -> 
          (_lh_listcomp_fun_para_8 _lh_listcomp_fun_1_9)) in
          (_lh_listcomp_fun_1_9 ((enumFromTo__d7 1) _lh_emptyTable_CSP_1_4))), (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_7)))))
  else
    (fun _lh_emptyTable_CSP_1_5 _lh_listcomp_fun_2_0 -> 
      (`LH_N)))
and enumFromTo__d8 a_1_4 b_1_0 =
  (if (a_1_4 <= b_1_0) then
    (let rec _lh_listcomp_fun_ls_t_9 = ((enumFromTo__d8 (a_1_4 + 1)) b_1_0) in
      (let rec _lh_listcomp_fun_ls_h_9 = a_1_4 in
        (fun _lh_listcomp_fun_2_4 ss_1 -> 
          (let rec t_4_2 = (_lh_listcomp_fun_2_4 _lh_listcomp_fun_ls_t_9) in
            (let rec h_4_1 = (`LH_C((`Assign(((maxLevel__d8 ss_1) + 1), _lh_listcomp_fun_ls_h_9)), ss_1)) in
              (fun f_7_3 -> 
                (`LH_C((f_7_3 h_4_1), ((map__d1_d6 f_7_3) t_4_2)))))))))
  else
    (fun _lh_listcomp_fun_2_5 ss_2 f_7_4 -> 
      (`LH_N)))
  ...
  (match ls_4_0 with
                ...
                (match _lh_combine_LH_P2_1_1 with
                  | `Known(_lh_combine_Known_0_1) -> 
                    (if ((notElem__d0 (maxLevel__d0 _lh_combine_LH_P2_0_1)) _lh_combine_Known_0_1) then
                      ...
                      ((combine__d0 _lh_combine_LH_C_1_1) ((union__d0 _lh_combine_Known_0_1) _lh_combine_arg2_4)))
                  | _ -> 
                    (failwith "error"))
              | _ -> 
                (failwith "error")))))
    | `LH_N -> 
      (fun _lh_combine_arg2_5 -> 
        _lh_combine_arg2_5))
and map__d1_d0 f_4_6 ls_3_1 =
  (match ls_3_1 with
    | `LH_C(h_2_7, t_2_8) -> 
      (let rec t_2_9 = ((map__d1_d0 f_4_6) t_2_8) in
        (let rec h_2_8 = (f_4_6 h_2_7) in
          (fun f_4_7 -> 
            (let rec t_3_0 = ((map__d1_d2 f_4_7) t_2_9) in
              (let rec h_2_9 = (f_4_7 h_2_8) in
                (fun f_4_8 -> 
                  (`LH_C((f_4_8 h_2_9), ((map__d1_d1 f_4_8) t_3_0)))))))))
    | `LH_N -> 
      (fun f_4_9 f_5_0 -> 
        (`LH_N)))
and map__d1_d4 f_5_4 ls_3_2 =
  (match ls_3_2 with
    | `LH_C(h_3_0, t_3_1) -> 
    ...
    | `LH_C(h_8, t_9) -> 
      (let rec t_1_0 = ((map__d1_d7 f_1_8) t_9) in
        (let rec h_9 = (f_1_8 h_8) in
          (fun f_1_9 -> 
            (if (f_1_9 h_9) then
              (`LH_C(h_9, ((filter__d7 f_1_9) t_1_0)))
            else
              ((filter__d7 f_1_9) t_1_0)))))
    | `LH_N -> 
      (fun f_2_0 -> 
        (`LH_N)))
and map__d2 f_3_3 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_1_7, t_1_8) -> 
      (let rec t_1_9 = ((map__d2 f_3_3) t_1_8) in
        (let rec h_1_8 = (f_3_3 h_1_7) in
          (fun f_3_4 -> 
            (`LH_C((f_3_4 h_1_8), ((map__d0 f_3_4) t_1_9))))))
    | `LH_N -> 
      (fun f_3_5 -> 
        (`LH_N)))
and map__d4 f_2_3 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_0, t_1_1) -> 
                ...
                (match _lh_combine_LH_P2_1_0 with
                  | `Known(_lh_combine_Known_0_0) -> 
                    (if ((notElem__d1 (maxLevel__d2 _lh_combine_LH_P2_0_0)) _lh_combine_Known_0_0) then
                      ...
                      ((combine__d1 _lh_combine_LH_C_1_0) ((union__d1 _lh_combine_Known_0_0) _lh_combine_arg2_0)))
                  | _ -> 
                    (failwith "error"))
              | _ -> 
                (failwith "error")))))
    | `LH_N -> 
      (fun _lh_combine_arg2_1 -> 
        _lh_combine_arg2_1))
and map__d5 f_7_7 ls_3_8 =
  (match ls_3_8 with
    | `LH_C(h_4_2, t_4_3) -> 
      (let rec t_4_4 = ((map__d5 f_7_7) t_4_3) in
        (let rec h_4_3 = (f_7_7 h_4_2) in
          (fun f_7_8 -> 
            (`LH_C((f_7_8 h_4_3), ((map__d3 f_7_8) t_4_4))))))
    | `LH_N -> 
      (fun f_7_9 -> 
        (`LH_N)))
and map__d6 f_9 ls_5 =
  (match ls_5 with
    | `LH_C(h_3, t_4) -> 
      (let rec t_5 = ((map__d6 f_9) t_4) in
        (let rec h_4 = (f_9 h_3) in
          (fun f_1_0 -> 
            (let rec t_6 = ((map__d7 f_1_0) t_5) in
              (let rec h_5 = (f_1_0 h_4) in
                (fun f_1_1 -> 
                  (`LH_C((f_1_1 h_5), ((map__d8 f_1_1) t_6)))))))))
    | `LH_N -> 
      (fun f_1_2 f_1_3 -> 
        (`LH_N)))
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Constraints_nofib" (fun () -> ignore (let open Module_original in ((testConstraints_nofib__d0 5))));
  Bench.Test.create ~name:"lumberhack_Constraints_nofib" (fun () -> ignore (let open Module_lumberhack in ((testConstraints_nofib__d0 5))));
  Bench.Test.create ~name:"lumberhack_pop_out_Constraints_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testConstraints_nofib__d0 5))));
])

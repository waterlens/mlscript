...
let rec map_lh__d1 f_9 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_2_7, t_2_7) -> 
      (`LH_C((f_9 h_2_7), ((map_lh__d1 f_9) t_2_7)))
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d1 a_4 b_3 =
  (if (a_4 <= b_3) then
    (`LH_C(a_4, ((enumFromTo_lh__d1 (a_4 + 1)) b_3)))
  else
    (`LH_N));;
let rec copy_lh__d2 _lh_copy_arg1_9 _lh_copy_arg2_9 =
  (if (_lh_copy_arg1_9 > 0) then
    (`LH_C(_lh_copy_arg2_9, ((copy_lh__d2 (_lh_copy_arg1_9 - 1)) _lh_copy_arg2_9)))
  else
    (`LH_N));;
let rec copy_lh__d1 _lh_copy_arg1_1_0 _lh_copy_arg2_1_0 =
  (if (_lh_copy_arg1_1_0 > 0) then
    (`LH_C(_lh_copy_arg2_1_0, ((copy_lh__d1 (_lh_copy_arg1_1_0 - 1)) _lh_copy_arg2_1_0)))
  else
    (`LH_N));;
let rec emptyPic_lh__d1 _lh_emptyPic_arg1_3 =
  (match _lh_emptyPic_arg1_3 with
    | `LH_P2(_lh_emptyPic_LH_P2_0_3, _lh_emptyPic_LH_P2_1_3) -> 
      ((copy_lh__d2 _lh_emptyPic_LH_P2_0_3) ((copy_lh__d1 _lh_emptyPic_LH_P2_1_3) ' '))
    | _ -> 
      (failwith "error"));;
let rec mappend_lh__d2 xs_1_6 ys_1_6 =
  (match xs_1_6 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d2 t_2_4) ys_1_6)))
    | `LH_N -> 
      ys_1_6);;
let rec mappend_lh__d5 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C(h_1_7, ((mappend_lh__d5 t_1_7) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend_lh__d4 xs_1_4 ys_1_4 =
  (match xs_1_4 with
    | `LH_C(h_1_9, t_1_9) -> 
      (`LH_C(h_1_9, ((mappend_lh__d4 t_1_9) ys_1_4)))
    | `LH_N -> 
      ys_1_4);;
let rec copy_lh__d4 _lh_copy_arg1_7 _lh_copy_arg2_7 =
  (if (_lh_copy_arg1_7 > 0) then
    (`LH_C(_lh_copy_arg2_7, ((copy_lh__d4 (_lh_copy_arg1_7 - 1)) _lh_copy_arg2_7)))
  else
    (`LH_N));;
let rec space_lh__d2 _lh_space_arg1_2 =
  ((copy_lh__d4 _lh_space_arg1_2) ' ');;
let rec copy_lh__d3 _lh_copy_arg1_8 _lh_copy_arg2_8 =
  (if (_lh_copy_arg1_8 > 0) then
    (`LH_C(_lh_copy_arg2_8, ((copy_lh__d3 (_lh_copy_arg1_8 - 1)) _lh_copy_arg2_8)))
  else
    (`LH_N));;
let rec space_lh__d1 _lh_space_arg1_3 =
  ((copy_lh__d3 _lh_space_arg1_3) ' ');;
let rec length_lh__d2 ls_7 =
  (match ls_7 with
    | `LH_C(h_1_8, t_1_8) -> 
      (1 + (length_lh__d2 t_1_8))
    | `LH_N -> 
      0);;
...
let rec banner_lh__d1 _lh_banner_arg1_0 =
  ((mappend_lh__d2 (`LH_C(((cjustify_lh__d1 75) (string_of_int _lh_banner_arg1_0)), (`LH_N)))) (emptyPic_lh__d1 (`LH_P2(1, 75))));;
let rec mappend_lh__d1 xs_1_7 ys_1_7 =
  (match xs_1_7 with
    | `LH_C(h_2_5, t_2_5) -> 
      (`LH_C(h_2_5, ((mappend_lh__d1 t_2_5) ys_1_7)))
    | `LH_N -> 
      ys_1_7);;
let rec mappend_lh__d6 xs_1_2 ys_1_2 =
  (match xs_1_2 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C(h_1_6, ((mappend_lh__d6 t_1_6) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
...
let rec map_lh__d2 f_8 ls_9 =
  (match ls_9 with
    | `LH_C(h_2_3, t_2_3) -> 
      (`LH_C((f_8 h_2_3), ((map_lh__d2 f_8) t_2_3)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d3 xs_1_5 ys_1_5 =
  (match xs_1_5 with
    | `LH_C(h_2_1, t_2_1) -> 
      (`LH_C(h_2_1, ((mappend_lh__d3 t_2_1) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
...
let rec mappend_lh__d1_d0 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d1_d0 t_1_1) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec copy_lh__d1_d1 _lh_copy_arg1_0 _lh_copy_arg2_0 =
  (if (_lh_copy_arg1_0 > 0) then
    (`LH_C(_lh_copy_arg2_0, ((copy_lh__d1_d1 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0)))
  else
    (`LH_N));;
...
let rec mappend_lh__d1_d4 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C(h_2, ((mappend_lh__d1_d4 t_2) ys_1)))
    | `LH_N -> 
      ys_1);;
let rec mappend_lh__d1_d5 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_0, t_0) -> 
      (`LH_C(h_0, ((mappend_lh__d1_d5 t_0) ys_0)))
    | `LH_N -> 
      ys_0);;
...
let rec space_lh__d3 _lh_space_arg1_1 =
  ((copy_lh__d1_d1 _lh_space_arg1_1) ' ');;
...
let rec take_lh__d1 n_1 ls_5 =
  (if (n_1 > 0) then
    (match ls_5 with
      | `LH_C(h_8, t_8) -> 
        (`LH_C(h_8, ((take_lh__d1 (n_1 - 1)) t_8)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec foldr_lh__d2 f_0 i_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_3, t_3) -> 
      ((f_0 h_3) (((foldr_lh__d2 f_0) i_0) t_3))
    | `LH_N -> 
      i_0);;
let rec foldr1_lh__d2 _lh_foldr1_arg1_0 _lh_foldr1_arg2_0 =
  (match _lh_foldr1_arg2_0 with
    | `LH_C(_lh_foldr1_LH_C_0_0, _lh_foldr1_LH_C_1_0) -> 
      (((foldr_lh__d2 _lh_foldr1_arg1_0) _lh_foldr1_LH_C_0_0) _lh_foldr1_LH_C_1_0)
    | _ -> 
      (failwith "error"));;
let rec zipWith_lh__d3 f_3 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(hx_0, tx_0) -> 
      (match ys_4 with
        | `LH_C(hy_0, ty_0) -> 
          (`LH_C(((f_3 hx_0) hy_0), (((zipWith_lh__d3 f_3) tx_0) ty_0)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d1_d2 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d1_d2 t_9) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec spread_lh__d1 _lh_spread_arg1_0 =
  ((foldr1_lh__d2 (fun a_2 b_1 -> 
    (((zipWith_lh__d3 mappend_lh__d1_d2) a_2) b_1))) _lh_spread_arg1_0);;
let rec mappend_lh__d1_d1 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d1_d1 t_1_0) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec foldr_lh__d1 f_1 i_1 ls_2 =
  (match ls_2 with
    | `LH_C(h_4, t_4) -> 
      ((f_1 h_4) (((foldr_lh__d1 f_1) i_1) t_4))
    | `LH_N -> 
      i_1);;
let rec foldr1_lh__d1 _lh_foldr1_arg1_1 _lh_foldr1_arg2_1 =
  (match _lh_foldr1_arg2_1 with
    | `LH_C(_lh_foldr1_LH_C_0_1, _lh_foldr1_LH_C_1_1) -> 
      (((foldr_lh__d1 _lh_foldr1_arg1_1) _lh_foldr1_LH_C_0_1) _lh_foldr1_LH_C_1_1)
    | _ -> 
      (failwith "error"));;
let rec stack_lh__d1 _lh_stack_arg1_0 =
  ((foldr1_lh__d1 (fun a_3 b_2 -> 
    ((mappend_lh__d1_d1 a_3) b_2))) _lh_stack_arg1_0);;
let rec map_lh__d5 f_2 ls_3 =
  (match ls_3 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C((f_2 h_6), ((map_lh__d5 f_2) t_6)))
    | `LH_N -> 
      (`LH_N));;
let rec block_lh__d2 _lh_block_arg1_0 _lh_funcomp_x_0 =
  ((fun _lh_funcomp_x_1 -> 
    (stack_lh__d1 ((map_lh__d5 spread_lh__d1) _lh_funcomp_x_1))) ((groop_lh__d1 _lh_block_arg1_0) _lh_funcomp_x_0));;
...
let rec mappend_lh__d1_d3 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d1_d3 t_5) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec pic_lh__d1 _lh_pic_arg1_0 =
  (match _lh_pic_arg1_0 with
    | `LH_P3(_lh_pic_LH_P3_0_0, _lh_pic_LH_P3_1_0, _lh_pic_LH_P3_2_0) -> 
      ((mappend_lh__d1_d0 (title_lh__d1 _lh_pic_LH_P3_0_0)) ((table_lh__d1 _lh_pic_LH_P3_1_0) _lh_pic_LH_P3_2_0))
    | _ -> 
      (failwith "error"));;
let rec map_lh__d4 f_6 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_5, t_1_5) -> 
      (`LH_C((f_6 h_1_5), ((map_lh__d4 f_6) t_1_5)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d8 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C(h_1_3, ((mappend_lh__d8 t_1_3) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend_lh__d7 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_1_4, t_1_4) -> 
      (`LH_C(h_1_4, ((mappend_lh__d7 t_1_4) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec zipWith_lh__d2 f_4 xs_8 ys_8 =
  (match xs_8 with
    | `LH_C(hx_1, tx_1) -> 
      (match ys_8 with
        | `LH_C(hy_1, ty_1) -> 
          (`LH_C(((f_4 hx_1) hy_1), (((zipWith_lh__d2 f_4) tx_1) ty_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec copy_lh__d8 _lh_copy_arg1_3 _lh_copy_arg2_3 =
  (if (_lh_copy_arg1_3 > 0) then
    (`LH_C(_lh_copy_arg2_3, ((copy_lh__d8 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3)))
  else
    (`LH_N));;
let rec copy_lh__d7 _lh_copy_arg1_4 _lh_copy_arg2_4 =
  (if (_lh_copy_arg1_4 > 0) then
    (`LH_C(_lh_copy_arg2_4, ((copy_lh__d7 (_lh_copy_arg1_4 - 1)) _lh_copy_arg2_4)))
  else
    (`LH_N));;
let rec emptyPic_lh__d3 _lh_emptyPic_arg1_1 =
  (match _lh_emptyPic_arg1_1 with
    | `LH_P2(_lh_emptyPic_LH_P2_0_1, _lh_emptyPic_LH_P2_1_1) -> 
      ((copy_lh__d8 _lh_emptyPic_LH_P2_0_1) ((copy_lh__d7 _lh_emptyPic_LH_P2_1_1) ' '))
    | _ -> 
      (failwith "error"));;
let rec end_lh__d1 _lh_end_arg1_0 =
  (emptyPic_lh__d3 (`LH_P2(1, 25)));;
let rec mappend_lh__d9 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C(h_1_2, ((mappend_lh__d9 t_1_2) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec copy_lh__d9 _lh_copy_arg1_2 _lh_copy_arg2_2 =
  (if (_lh_copy_arg1_2 > 0) then
    (`LH_C(_lh_copy_arg2_2, ((copy_lh__d9 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2)))
  else
    (`LH_N));;
let rec copy_lh__d1_d0 _lh_copy_arg1_1 _lh_copy_arg2_1 =
  (if (_lh_copy_arg1_1 > 0) then
    (`LH_C(_lh_copy_arg2_1, ((copy_lh__d1_d0 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1)))
  else
    (`LH_N));;
let rec emptyPic_lh__d4 _lh_emptyPic_arg1_0 =
  (match _lh_emptyPic_arg1_0 with
    | `LH_P2(_lh_emptyPic_LH_P2_0_0, _lh_emptyPic_LH_P2_1_0) -> 
      ((copy_lh__d1_d0 _lh_emptyPic_LH_P2_0_0) ((copy_lh__d9 _lh_emptyPic_LH_P2_1_0) ' '))
    | _ -> 
      (failwith "error"));;
let rec side_lh__d2 _lh_side_arg1_0 =
  (emptyPic_lh__d4 (`LH_P2(8, 2)));;
let rec copy_lh__d6 _lh_copy_arg1_5 _lh_copy_arg2_5 =
  (if (_lh_copy_arg1_5 > 0) then
    (`LH_C(_lh_copy_arg2_5, ((copy_lh__d6 (_lh_copy_arg1_5 - 1)) _lh_copy_arg2_5)))
  else
    (`LH_N));;
let rec copy_lh__d5 _lh_copy_arg1_6 _lh_copy_arg2_6 =
  (if (_lh_copy_arg1_6 > 0) then
    (`LH_C(_lh_copy_arg2_6, ((copy_lh__d5 (_lh_copy_arg1_6 - 1)) _lh_copy_arg2_6)))
  else
    (`LH_N));;
let rec emptyPic_lh__d2 _lh_emptyPic_arg1_2 =
  (match _lh_emptyPic_arg1_2 with
    | `LH_P2(_lh_emptyPic_LH_P2_0_2, _lh_emptyPic_LH_P2_1_2) -> 
      ((copy_lh__d6 _lh_emptyPic_LH_P2_0_2) ((copy_lh__d5 _lh_emptyPic_LH_P2_1_2) ' '))
    | _ -> 
      (failwith "error"));;
let rec side_lh__d1 _lh_side_arg1_1 =
  (emptyPic_lh__d2 (`LH_P2(8, 2)));;
let rec zipWith_lh__d1 f_5 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    | `LH_C(hx_2, tx_2) -> 
      (match ys_1_1 with
        | `LH_C(hy_2, ty_2) -> 
...
let rec map_lh__d3 f_7 ls_8 =
  (match ls_8 with
    | `LH_C(h_2_0, t_2_0) -> 
      (`LH_C((f_7 h_2_0), ((map_lh__d3 f_7) t_2_0)))
    | `LH_N -> 
      (`LH_N));;
...
let rec take_lh__d2 n_0 ls_4 =
  (if (n_0 > 0) then
    (match ls_4 with
      | `LH_C(h_7, t_7) -> 
        (`LH_C(h_7, ((take_lh__d2 (n_0 - 1)) t_7)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec firstDays_lh__d1 _lh_firstDays_arg1_0 =
  ((take_lh__d2 12) ((map_lh__d5 (fun a_0 -> 
    (a_0 mod 7))) (((scanl_lh__d1 (fun a_1 b_0 -> 
    (a_1 + b_0))) (jan1st_lh__d1 _lh_firstDays_arg1_0)) (monthLengths_lh__d2 _lh_firstDays_arg1_0))));;
...
let rec body_lh__d1 _lh_funcomp_x_4 =
  ((fun _lh_funcomp_x_5 -> 
    ((block_lh__d1 3) ((map_lh__d3 (fun _lh_funcomp_x_6 -> 
      (pad_lh__d1 (pic_lh__d1 _lh_funcomp_x_6)))) _lh_funcomp_x_5))) (months_lh__d1 _lh_funcomp_x_4));;

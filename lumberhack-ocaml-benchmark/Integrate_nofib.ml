...
let rec enumFromFloat_d2_d0 _lh_enumFromFloat_arg1_0 =
  (lazy (let rec hx_0 = _lh_enumFromFloat_arg1_0 in
    (let rec tx_0 = (Obj.magic 99) in
      (fun f_1 ys_0 -> 
        ((((Lazy.force ys_0) f_1) hx_0) (Obj.magic 99))))));;
...
let rec enumFromFloat_d0_d0_d0 _lh_enumFromFloat_arg1_9 =
  (lazy (let rec h_1_5 = _lh_enumFromFloat_arg1_9 in
    (let rec t_1_2 = (Obj.magic 99) in
      (fun f_3_5 -> 
        (let rec h_1_6 = (f_3_5 h_1_5) in
          (fun _lh_dummy_8_9 -> 
            h_1_6))))));;
let rec enumFromFloat_d2_d0_d0 _lh_enumFromFloat_arg1_1_1 =
  (lazy (let rec hx_1_3 = _lh_enumFromFloat_arg1_1_1 in
    (let rec tx_1_3 = (Obj.magic 99) in
      (fun f_4_5 ys_1_4 -> 
        ((((Lazy.force ys_1_4) f_4_5) hx_1_3) (Obj.magic 99))))));;
let rec enumFromFloat_d3_d0_d0 _lh_enumFromFloat_arg1_6 =
  (lazy (let rec h_1_1 = _lh_enumFromFloat_arg1_6 in
    (let rec t_9 = (enumFromFloat_d3_d0_d0 (_lh_enumFromFloat_arg1_6 +. 1.0)) in
      (fun f_2_4 -> 
        (let rec hy_5 = (f_2_4 h_1_1) in
          (let rec ty_5 = (Obj.magic 99) in
            (fun f_2_5 hx_7 tx_7 -> 
              (let rec h_1_2 = ((f_2_5 hx_7) hy_5) in
                (fun _lh_dummy_6_7 -> 
                  h_1_2)))))))));;
let rec enumFromFloat_d4_d0_d0 _lh_enumFromFloat_arg1_8 =
  (lazy (let rec hx_1_0 = _lh_enumFromFloat_arg1_8 in
    (let rec tx_1_0 = (enumFromFloat_d4_d0_d0 (_lh_enumFromFloat_arg1_8 +. 1.0)) in
      (fun f_3_2 ys_1_0 -> 
        ((((Lazy.force ys_1_0) f_3_2) hx_1_0) tx_1_0)))));;
let rec head_lz_d0_d0_d0 ls_2_1 =
  ((Lazy.force ls_2_1) 99);;
let rec head_lz_d1_d0_d0 ls_1_8 =
  ((Lazy.force ls_1_8) 99);;
let rec map_lz_d0_d0_d0 f_4_1 ls_2_0 =
  (lazy ((Lazy.force ls_2_0) f_4_1));;
let rec map_lz_d1_d0_d0 f_2_3 ls_1_3 =
  (lazy ((Lazy.force ls_1_3) f_2_3));;
let rec map_lz_d1_d0_d1 f_2_1 ls_1_1 =
  (lazy ((Lazy.force ls_1_1) f_2_1));;
let rec map_lz_d2_d0_d0 f_2_9 ls_1_7 =
  (lazy ((Lazy.force ls_1_7) f_2_9));;
let rec map_lz_d2_d0_d1 f_4_0 ls_1_9 =
  (lazy ((Lazy.force ls_1_9) f_4_0));;
let rec map_lz_d3_d0_d0 f_4_3 ls_2_2 =
  (lazy ((Lazy.force ls_2_2) f_4_3));;
let rec map_lz_d4_d0_d0 f_2_8 ls_1_6 =
  (lazy ((Lazy.force ls_1_6) f_2_8));;
let rec map_lz_d4_d0_d1 f_4_4 ls_2_3 =
  (lazy ((Lazy.force ls_2_3) f_4_4));;
let rec sumFloat_d0_d0_d0 _lh_sumFloat_arg1_3_1 =
  (_lh_sumFloat_arg1_3_1 99);;
let rec sumFloat_d0_d0_d1 _lh_sumFloat_arg1_4_6 =
...
let rec sumFloat_d0_d0_d4 _lh_sumFloat_arg1_2_7 =
  (_lh_sumFloat_arg1_2_7 99);;
let rec sumFloat_d0_d0_d5 _lh_sumFloat_arg1_2_1 =
  (_lh_sumFloat_arg1_2_1 99);;
let rec sumFloat_d0_d0_d6 _lh_sumFloat_arg1_1_2 =
  (_lh_sumFloat_arg1_1_2 99);;
let rec sumFloat_d0_d0_d7 _lh_sumFloat_arg1_4_5 =
  (_lh_sumFloat_arg1_4_5 99);;
let rec sumFloat_d0_d0_d8 _lh_sumFloat_arg1_1_7 =
  (_lh_sumFloat_arg1_1_7 99);;
let rec sumFloat_d0_d0_d9 _lh_sumFloat_arg1_6 =
  (_lh_sumFloat_arg1_6 99);;
let rec sumFloat_d1_d0_d0 _lh_sumFloat_arg1_2_0 =
  (_lh_sumFloat_arg1_2_0 99);;
let rec sumFloat_d1_d0_d1 _lh_sumFloat_arg1_1_8 =
  (_lh_sumFloat_arg1_1_8 99);;
let rec sumFloat_d1_d0_d2 _lh_sumFloat_arg1_4_3 =
...
let rec sumFloat_d1_d0_d5 _lh_sumFloat_arg1_1_3 =
  (_lh_sumFloat_arg1_1_3 99);;
let rec sumFloat_d1_d0_d6 _lh_sumFloat_arg1_4_1 =
  (_lh_sumFloat_arg1_4_1 99);;
let rec sumFloat_d1_d0_d7 _lh_sumFloat_arg1_1_4 =
  (_lh_sumFloat_arg1_1_4 99);;
let rec sumFloat_d1_d0_d8 _lh_sumFloat_arg1_2_2 =
  (_lh_sumFloat_arg1_2_2 99);;
let rec sumFloat_d1_d0_d9 _lh_sumFloat_arg1_1_1 =
  (_lh_sumFloat_arg1_1_1 99);;
let rec sumFloat_d2_d0_d0 _lh_sumFloat_arg1_2_8 =
  (_lh_sumFloat_arg1_2_8 99);;
let rec sumFloat_d2_d0_d1 _lh_sumFloat_arg1_1_0 =
  (_lh_sumFloat_arg1_1_0 99);;
let rec sumFloat_d2_d0_d2 _lh_sumFloat_arg1_3_6 =
  (_lh_sumFloat_arg1_3_6 99);;
let rec sumFloat_d2_d0_d3 _lh_sumFloat_arg1_2_4 =
  (_lh_sumFloat_arg1_2_4 99);;
let rec sumFloat_d2_d0_d4 _lh_sumFloat_arg1_3_8 =
  (_lh_sumFloat_arg1_3_8 99);;
let rec sumFloat_d2_d0_d5 _lh_sumFloat_arg1_3_4 =
  (_lh_sumFloat_arg1_3_4 99);;
let rec sumFloat_d2_d0_d6 _lh_sumFloat_arg1_3_7 =
  (_lh_sumFloat_arg1_3_7 99);;
let rec sumFloat_d2_d0_d7 _lh_sumFloat_arg1_1_9 =
  (_lh_sumFloat_arg1_1_9 99);;
let rec sumFloat_d2_d0_d8 _lh_sumFloat_arg1_3_9 =
  (_lh_sumFloat_arg1_3_9 99);;
let rec sumFloat_d2_d0_d9 _lh_sumFloat_arg1_5 =
  (_lh_sumFloat_arg1_5 99);;
let rec sumFloat_d3_d0_d0 _lh_sumFloat_arg1_3_2 =
  (_lh_sumFloat_arg1_3_2 99);;
let rec sumFloat_d3_d0_d1 _lh_sumFloat_arg1_7 =
  (_lh_sumFloat_arg1_7 99);;
let rec sumFloat_d3_d0_d2 _lh_sumFloat_arg1_3_0 =
  (_lh_sumFloat_arg1_3_0 99);;
let rec sumFloat_d3_d0_d3 _lh_sumFloat_arg1_2_3 =
  (_lh_sumFloat_arg1_2_3 99);;
let rec sumFloat_d3_d0_d4 _lh_sumFloat_arg1_4_0 =
  (_lh_sumFloat_arg1_4_0 99);;
let rec sumFloat_d3_d0_d5 _lh_sumFloat_arg1_2_9 =
  (_lh_sumFloat_arg1_2_9 99);;
let rec sumFloat_d3_d0_d6 _lh_sumFloat_arg1_4_4 =
  (_lh_sumFloat_arg1_4_4 99);;
let rec sumFloat_d3_d0_d7 _lh_sumFloat_arg1_9 =
  (_lh_sumFloat_arg1_9 99);;
let rec sumFloat_d3_d0_d8 _lh_sumFloat_arg1_4_2 =
  (_lh_sumFloat_arg1_4_2 99);;
let rec sumFloat_d3_d0_d9 _lh_sumFloat_arg1_2_5 =
  (_lh_sumFloat_arg1_2_5 99);;
let rec sumFloat_d4_d0_d0 _lh_sumFloat_arg1_1_6 =
...
let rec tail_lz_d1_d0_d0 ls_1_2 =
  (match (Lazy.force ls_1_2) with
    ...
    | `LH_N -> 
      (Obj.magic 99));;
let rec take_lz_d0_d0_d0 n_6 ls_1_0 =
  (if (n_6 > 0) then
    ((Lazy.force ls_1_0) n_6)
  else
    (fun _lh_dummy_5_6 -> 
      0.0));;
let rec take_lz_d0_d0_d1 n_7 ls_1_5 =
  (if (n_7 > 0) then
    ((Lazy.force ls_1_5) n_7)
  else
    (fun _lh_dummy_6_8 -> 
      0.0));;
let rec zipWith_lz_lz_d0_d0_d0 f_2_6 xs_6 ys_8 =
  (lazy (match (Lazy.force xs_6) with
    | `LH_C(hx_8, tx_8) -> 
      (match (Lazy.force ys_8) with
        | `LH_C(hy_6, ty_6) -> 
          (`LH_C(((f_2_6 hx_8) hy_6), (((zipWith_lz_lz_d0_d0_d0 f_2_6) tx_8) ty_6)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (Obj.magic 99)));;
let rec zipWith_lz_lz_d1_d0_d0 f_2_7 xs_7 ys_9 =
  (lazy (((Lazy.force xs_7) f_2_7) ys_9));;
let rec zipWith_lz_lz_d2_d0_d0 f_2_2 xs_5 ys_7 =
  (lazy (((Lazy.force xs_5) f_2_2) ys_7));;
let rec zipWith_lz_lz_d2_d0_d1 f_3_3 xs_8 ys_1_1 =
  (lazy (((Lazy.force xs_8) f_3_3) ys_1_1));;
let rec zipWith_lz_lz_d3_d0_d0 f_3_4 xs_9 ys_1_2 =
  (lazy (match (Lazy.force xs_9) with
    | `LH_C(hx_1_1, tx_1_1) -> 
      (match (Lazy.force ys_1_2) with
        | `LH_C(hy_8, ty_8) -> 
          (`LH_C(((f_3_4 hx_1_1) hy_8), (((zipWith_lz_lz_d3_d0_d0 f_3_4) tx_1_1) ty_8)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (Obj.magic 99)));;
let rec enumFromFloat_d1_d0_d0 _lh_enumFromFloat_arg1_1_0 =
  (lazy (let rec h_1_9 = _lh_enumFromFloat_arg1_1_0 in
    (let rec t_1_5 = (enumFromFloat_d1_d0_d0 (_lh_enumFromFloat_arg1_1_0 +. 1.0)) in
      (fun f_4_2 -> 
        (`LH_C((f_4_2 h_1_9), ((map_lz_d1_d0_d0 f_4_2) t_1_5)))))))
and enumFromFloat_d5_d0_d0 _lh_enumFromFloat_arg1_7 =
  (lazy (let rec h_1_4 = _lh_enumFromFloat_arg1_7 in
    (let rec t_1_1 = (enumFromFloat_d5_d0_d0 (_lh_enumFromFloat_arg1_7 +. 1.0)) in
      (fun f_3_0 -> 
        (let rec hy_7 = (f_3_0 h_1_4) in
          (let rec ty_7 = ((map_lz_d4_d0_d0 f_3_0) t_1_1) in
            (fun f_3_1 hx_9 tx_9 -> 
              (`LH_C(((f_3_1 hx_9) hy_7), (((zipWith_lz_lz_d2_d0_d0 f_3_1) tx_9) ty_7))))))))))
and etotal_d0_d0_d0 _lh_etotal_arg1_1 =
  (sumFloat_d4_d0_d0 ((take_lz_d0_d0_d0 _lh_etotal_arg1_1) ((map_lz_d2_d0_d0 (fun a_8 -> 
    (a_8 *. a_8))) (((zipWith_lz_lz_d4_d0_d0 (fun a_9 b_5 -> 
    (a_9 -. b_5))) (rtotals_d0_d0_d0 0)) (itotals_d0_d0_d0 0)))))
                ...
                (let rec _lh_sumFloat_LH_C_1_6_9 = (let rec _lh_sumFloat_LH_C_0_7_0 = (_lh_integrate1D_arg3_7 (_lh_integrate1D_arg2_7 -. (2.0 *. d_7))) in
                  (let rec _lh_sumFloat_LH_C_1_7_0 = (let rec _lh_sumFloat_LH_C_0_7_1 = (_lh_integrate1D_arg3_7 (_lh_integrate1D_arg2_7 -. d_7)) in
                    (let rec _lh_sumFloat_LH_C_1_7_1 = (let rec _lh_sumFloat_LH_C_0_7_2 = ((_lh_integrate1D_arg3_7 _lh_integrate1D_arg2_7) *. 0.5) in
                      (let rec _lh_sumFloat_LH_C_1_7_2 = (fun _lh_dummy_7_9 -> 
                        0.0) in
                        (fun _lh_dummy_8_0 -> 
                ...
                (let rec _lh_sumFloat_LH_C_1_5_1 = (let rec _lh_sumFloat_LH_C_0_5_2 = (_lh_integrate1D_arg3_5 (_lh_integrate1D_arg2_5 -. (2.0 *. d_5))) in
                  (let rec _lh_sumFloat_LH_C_1_5_2 = (let rec _lh_sumFloat_LH_C_0_5_3 = (_lh_integrate1D_arg3_5 (_lh_integrate1D_arg2_5 -. d_5)) in
                    (let rec _lh_sumFloat_LH_C_1_5_3 = (let rec _lh_sumFloat_LH_C_0_5_4 = ((_lh_integrate1D_arg3_5 _lh_integrate1D_arg2_5) *. 0.5) in
                      (let rec _lh_sumFloat_LH_C_1_5_4 = (fun _lh_dummy_5_7 -> 
                        0.0) in
                        (fun _lh_dummy_5_8 -> 
                ...
                (let rec _lh_sumFloat_LH_C_1_6_0 = (let rec _lh_sumFloat_LH_C_0_6_1 = (_lh_integrate1D_arg3_6 (_lh_integrate1D_arg2_6 -. (2.0 *. d_6))) in
                  (let rec _lh_sumFloat_LH_C_1_6_1 = (let rec _lh_sumFloat_LH_C_0_6_2 = (_lh_integrate1D_arg3_6 (_lh_integrate1D_arg2_6 -. d_6)) in
                    (let rec _lh_sumFloat_LH_C_1_6_2 = (let rec _lh_sumFloat_LH_C_0_6_3 = ((_lh_integrate1D_arg3_6 _lh_integrate1D_arg2_6) *. 0.5) in
                      (let rec _lh_sumFloat_LH_C_1_6_3 = (fun _lh_dummy_6_9 -> 
                        0.0) in
                        (fun _lh_dummy_7_0 -> 
...
and integrate2D_d1_d0_d0 _lh_integrate2D_arg1_3 _lh_integrate2D_arg2_3 _lh_integrate2D_arg3_3 _lh_integrate2D_arg4_3 _lh_integrate2D_arg5_3 =
  (((integrate1D_d2_d0_d0 _lh_integrate2D_arg3_3) _lh_integrate2D_arg4_3) (fun y_6 -> 
    (((integrate1D_d3_d0_d0 _lh_integrate2D_arg1_3) _lh_integrate2D_arg2_3) (fun x_6 -> 
...
and is_d1_d0_d0 _lh_is_arg1_2 =
  ((map_lz_d1_d0_d1 (fun a_1_0 -> 
    (((a_1_0 *. a_1_0) *. a_1_0) *. a_1_0))) (ints_d1_d0_d0 0))
and itotals_d0_d0_d0 _lh_itotals_arg1_1 =
  (lazy (`LH_C((head_lz_d0_d0_d0 (is_d0_d0_d0 0)), (((zipWith_lz_lz_d0_d0_d0 (fun a_7 b_4 -> 
    (a_7 +. b_4))) (tail_lz_d0_d0_d0 (is_d1_d0_d0 0))) (itotals_d0_d0_d0 0)))))
and rtotals_d0_d0_d0 _lh_rtotals_arg1_1 =
  (lazy (`LH_C((head_lz_d1_d0_d0 (zarks_d0_d0_d0 0)), (((zipWith_lz_lz_d3_d0_d0 (fun a_6 b_3 -> 
    (a_6 +. b_3))) (tail_lz_d1_d0_d0 (zarks_d1_d0_d0 0))) (rtotals_d0_d0_d0 0)))))
...
and zarks_d0_d0_d0 _lh_zarks_arg1_2 =
  (((zipWith_lz_lz_d1_d0_d0 zark_d0_d0_d0) (ints_d2_d0_d0 0)) ((map_lz_d3_d0_d0 (fun n_8 -> 
...
and zark_d1_d0_d0 _lh_zark_arg1_2 _lh_zark_arg2_2 =
  (((((integrate2D_d1_d0_d0 0.0) _lh_zark_arg1_2) 0.0) _lh_zark_arg2_2) (fun x_5 y_5 -> 
    (x_5 *. y_5)))
and zipWith_lz_lz_d4_d0_d0 f_3_6 xs_1_0 ys_1_3 =
  (lazy (match (Lazy.force xs_1_0) with
    | `LH_C(hx_1_2, tx_1_2) -> 
      (match (Lazy.force ys_1_3) with
        | `LH_C(hy_9, ty_9) -> 
          (let rec h_1_7 = ((f_3_6 hx_1_2) hy_9) in
            (let rec t_1_3 = (((zipWith_lz_lz_d4_d0_d0 f_3_6) tx_1_2) ty_9) in
              (fun f_3_7 -> 
                (let rec h_1_8 = (f_3_7 h_1_7) in
                  (let rec t_1_4 = ((map_lz_d2_d0_d1 f_3_7) t_1_3) in
                    (fun n_9 -> 
                      (let rec _lh_sumFloat_LH_C_0_7_3 = h_1_8 in
                        (let rec _lh_sumFloat_LH_C_1_7_3 = ((take_lz_d0_d0_d1 (n_9 - 1)) t_1_4) in
                          (fun _lh_dummy_9_0 -> 
                            (_lh_sumFloat_LH_C_0_7_3 +. (sumFloat_d4_d0_d1 _lh_sumFloat_LH_C_1_7_3)))))))))))
        | `LH_N -> 
          (fun f_3_8 n_1_0 _lh_dummy_9_1 -> 
            0.0))
    | `LH_N -> 
      (fun f_3_9 n_1_1 _lh_dummy_9_2 -> 
        0.0)));;

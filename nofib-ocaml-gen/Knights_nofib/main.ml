...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Knights_nofib" (fun () -> ignore (let open Module_lumberhack.Module_lumberhack in ((testKnights_nofib__d0 (`LH_C((`LH_C('8', (`LH_N))), (`LH_C((`LH_C('1', (`LH_N))), (`LH_N)))))))));
  Bench.Test.create ~name:"lumberhack_pop_out_Knights_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out.Module_lumberhack_pop_out in ((testKnights_nofib__d0 (`LH_C((`LH_C('8', (`LH_N))), (`LH_C((`LH_C('1', (`LH_N))), (`LH_N)))))))));
])

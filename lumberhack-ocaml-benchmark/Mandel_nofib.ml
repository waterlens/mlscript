...
let rec createPixmap_d0_d0_d0 _lh_createPixmap_arg1_1 _lh_createPixmap_arg2_1 _lh_createPixmap_arg3_1 _lh_createPixmap_arg4_1 =
  (`Pixmap(_lh_createPixmap_arg1_1, _lh_createPixmap_arg2_1, _lh_createPixmap_arg3_1, _lh_createPixmap_arg4_1));;
let rec map_lz_d0_d0_d0 f_8 ls_6 =
  (lazy (match (Lazy.force ls_6) with
    | `LH_C(h_4, t_6) -> 
      (`LH_C((f_8 h_4), ((map_lz_d0_d0_d0 f_8) t_6)))
    | `LH_N -> 
      (`LH_N)));;
let rec map_d0_d0_d0 f_1_5 ls_1_1 =
  (ls_1_1 f_1_5);;
let rec map_d0_d0_d1 f_7 ls_5 =
  (ls_5 f_7);;
let rec map_d1_d0_d0 f_1_2 ls_1_0 =
  (ls_1_0 f_1_2);;
    ...
    (fun f_9 f_1_0 -> 
      (let rec _lh_listcomp_fun_ls_h_4 = a_2 in
        (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo_d1_d0_d0 (a_2 + 1)) b_2) in
          (let rec h_5 = ((_lh_popOutId_2_1 _lh_listcomp_fun_ls_h_4) _lh_popOutId_0_3) in
            (let rec t_7 = (_lh_popOutId_1_3 _lh_listcomp_fun_ls_t_4) in
              (let rec h_6 = (f_9 h_5) in
                (let rec t_8 = ((map_d1_d0_d0 f_9) t_7) in
                  (`LH_C((f_1_0 h_6), ((map_d0_d0_d0 f_1_0) t_8))))))))))
  else
...
and mandelset_d0_d0_d0 _lh_mandelset_arg1_1 _lh_mandelset_arg2_1 _lh_mandelset_arg3_1 _lh_mandelset_arg4_1 _lh_mandelset_arg5_3 _lh_mandelset_arg6_1 _lh_mandelset_arg7_1 =
  (let rec prettyRGB_1 = (fun s_2 -> 
    (let rec t_9 = (_lh_mandelset_arg7_1 - s_2) in
      (`LH_P3(s_2, t_9, t_9)))) in
    (let rec windowToViewport_7 = (fun s_3 t_1_0 -> 
      (`Complex((_lh_mandelset_arg1_1 +. (((float_of_int s_3) *. (_lh_mandelset_arg3_1 -. _lh_mandelset_arg1_1)) /. (float_of_int _lh_mandelset_arg5_3))), (_lh_mandelset_arg2_1 +. (((float_of_int t_1_0) *. (_lh_mandelset_arg4_1 -. _lh_mandelset_arg2_1)) /. (float_of_int _lh_mandelset_arg6_1)))))) in
      (let rec result_1 = (((parallelMandel_d0_d0_d0 (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_2 -> 
        (((_lh_listcomp_fun_para_2 _lh_listcomp_fun_1_2) _lh_mandelset_arg5_3) windowToViewport_7)) in
        (_lh_listcomp_fun_1_2 ((enumFromTo_d0_d0_d0 1) _lh_mandelset_arg6_1)))) _lh_mandelset_arg7_1) (((myMax_d0_d0_d0 (_lh_mandelset_arg3_1 -. _lh_mandelset_arg1_1)) (_lh_mandelset_arg4_1 -. _lh_mandelset_arg2_1)) /. 2.0)) in
...
and take_lz_d0_d0_d0 n_1 ls_9 _lh_popOutId_0_1 _lh_popOutId_1_1 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_9) with
      | `LH_C(h_7, t_1_1) -> 
        (let rec _lh_whenDiverge_LH_C_0_1 = h_7 in
          (let rec _lh_whenDiverge_LH_C_1_1 = ((take_lz_d0_d0_d0 (n_1 - 1)) t_1_1) in

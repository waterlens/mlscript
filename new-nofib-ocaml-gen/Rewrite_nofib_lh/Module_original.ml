...
and eqExpr_lh _lh_eqExpr_arg1_0 _lh_eqExpr_arg2_0 =
  (match _lh_eqExpr_arg1_0 with
    ...
    | _ -> 
      false)
and eqListExpr_lh _lh_eqListExpr_arg1_0 _lh_eqListExpr_arg2_0 =
...
and map_dnet_lh _lh_map_dnet_arg1_0 _lh_map_dnet_arg2_0 =
  (match _lh_map_dnet_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and match'_lh _lh_match'_arg1_0 _lh_match'_arg2_0 =
  (match _lh_match'_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and match_lh _lh_match_arg1_0 _lh_match_arg2_0 =
  ((match'_lh (`LH_N)) (`LH_P2(_lh_match_arg1_0, _lh_match_arg2_0)))
and occurs_lh _lh_occurs_arg1_0 =
  ((expr_fold_lh (fun dum_2 -> 
    or_lh)) (fun x_1_4 -> 
    (x_1_4 = _lh_occurs_arg1_0)))
and orElseMap_lh _lh_orElseMap_arg1_0 _lh_orElseMap_arg2_0 _lh_orElseMap_arg3_0 =
  ((orElse_lh (_lh_orElseMap_arg1_0 _lh_orElseMap_arg3_0)) (_lh_orElseMap_arg2_0 _lh_orElseMap_arg3_0))
and prop_fold_lh _lh_prop_fold_arg1_0 _lh_prop_fold_arg2_0 _lh_prop_fold_arg3_0 =
  (match _lh_prop_fold_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and reduce1_lh _lh_reduce1_arg1_0 =
  (inside_lh (rewrite_lh _lh_reduce1_arg1_0))
and replace_lh _lh_replace_arg1_0 _lh_replace_arg2_0 _lh_replace_arg3_0 =
  (match _lh_replace_arg2_0 with
    ...
    | _ -> 
      (match _lh_replace_arg1_0 with
        ...
        | _ -> 
          (failwith "error")))
and result_lh _lh_result_arg1_0 =
  (match _lh_result_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and rewrite_lh _lh_rewrite_arg1_0 =
...
and simplify_lh _lh_simplify_arg1_0 =
  (let rec f_4 = (fun t_1_0 -> 
    ...
    f_4)
and stand_eqn_lh _lh_stand_eqn_arg1_0 _lh_stand_eqn_arg2_0 =
...
and subterms_lh _lh_subterms_arg1_0 =
  (match _lh_subterms_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and testRewrite_nofib_lh _lh_testRewrite_nofib_arg1_0 =
...
and try_all_lh _lh_try_all_arg1_0 =
  (((foldr_lh orElseMap_lh) (fun dum_0 -> 
    croak_lh)) _lh_try_all_arg1_0)
and unify'_lh _lh_unify'_arg1_0 _lh_unify'_arg2_0 =
  (match _lh_unify'_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and unify_lh _lh_unify_arg1_0 _lh_unify_arg2_0 =
  ((unify'_lh (`LH_N)) (`LH_P2(_lh_unify_arg1_0, _lh_unify_arg2_0)))
and univar_lh _lh_univar_arg1_0 _lh_univar_arg2_0 _lh_univar_arg3_0 =

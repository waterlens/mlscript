...
and ppStr__d1 _lh_ppStr_arg1_1 _lh_ppStr_arg2_1 _lh_ppStr_arg3_1 =
  (let rec ls_2 = (length__d1 _lh_ppStr_arg1_1) in
    (`MkPrettyRep((cStr__d1 _lh_ppStr_arg1_1), ls_2, false, (_lh_ppStr_arg2_1 >= ls_2))))
and ppStr__d2 _lh_ppStr_arg1_4 _lh_ppStr_arg2_4 _lh_ppStr_arg3_4 _lh_ppHang_arg2_1 _lh_ppHang_arg3_1 _lh_ppHang_arg4_1 _lh_ppHang_arg5_1 =
  (let rec ls_5 = (length__d2 _lh_ppStr_arg1_4) in
    (let rec _lh_ppHang_MkPrettyRep_3_0 = (_lh_ppStr_arg2_4 >= ls_5) in
      (let rec _lh_ppHang_MkPrettyRep_2_0 = false in
        (let rec _lh_ppHang_MkPrettyRep_1_0 = ls_5 in
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Pretty_nofib" (fun () -> ignore (let open Module_original in ((testPretty_nofib__d0 0))));
  Bench.Test.create ~name:"lumberhack_Pretty_nofib" (fun () -> ignore (let open Module_lumberhack in ((testPretty_nofib__d0 0))));
  Bench.Test.create ~name:"lumberhack_pop_out_Pretty_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testPretty_nofib__d0 0))));
])

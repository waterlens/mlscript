  ...
  (match _lh_break_arg2_1 with
    ...
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_1) then
        ...
        (let rec _lh_matchIdent_2_3 = ((break__d0 _lh_break_arg1_1) _lh_break_LH_C_1_1) in
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d0 _lh_compareList_arg1_1_4 _lh_compareList_arg2_1_4 =
  (match _lh_compareList_arg1_1_4 with
      ...
      (match _lh_compareList_arg2_1_4 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_4_4, _lh_compareList_LH_C_1_4_4) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_4_3) = (int_of_char _lh_compareList_LH_C_0_4_4)) then
            ((compareList__d0 _lh_compareList_LH_C_1_4_3) _lh_compareList_LH_C_1_4_4)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_4_3) < (int_of_char _lh_compareList_LH_C_0_4_4)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1 _lh_compareList_arg1_1_1 _lh_compareList_arg2_1_1 =
  (match _lh_compareList_arg1_1_1 with
      ...
      (match _lh_compareList_arg2_1_1 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_3_5, _lh_compareList_LH_C_1_3_5) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_3_4) = (int_of_char _lh_compareList_LH_C_0_3_5)) then
            ((compareList__d1 _lh_compareList_LH_C_1_3_4) _lh_compareList_LH_C_1_3_5)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_3_4) < (int_of_char _lh_compareList_LH_C_0_3_5)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1_d0 _lh_compareList_arg1_2 _lh_compareList_arg2_2 =
  (match _lh_compareList_arg1_2 with
      ...
      (match _lh_compareList_arg2_2 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_8, _lh_compareList_LH_C_1_8) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_7) = (int_of_char _lh_compareList_LH_C_0_8)) then
            ((compareList__d1_d0 _lh_compareList_LH_C_1_7) _lh_compareList_LH_C_1_8)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_7) < (int_of_char _lh_compareList_LH_C_0_8)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1_d1 _lh_compareList_arg1_1_3 _lh_compareList_arg2_1_3 =
  (match _lh_compareList_arg1_1_3 with
      ...
      (match _lh_compareList_arg2_1_3 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_4_1, _lh_compareList_LH_C_1_4_1) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_4_0) = (int_of_char _lh_compareList_LH_C_0_4_1)) then
            ((compareList__d1_d1 _lh_compareList_LH_C_1_4_0) _lh_compareList_LH_C_1_4_1)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_4_0) < (int_of_char _lh_compareList_LH_C_0_4_1)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1_d2 _lh_compareList_arg1_9 _lh_compareList_arg2_9 =
  (match _lh_compareList_arg1_9 with
      ...
      (match _lh_compareList_arg2_9 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_2_9, _lh_compareList_LH_C_1_2_9) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_2_8) = (int_of_char _lh_compareList_LH_C_0_2_9)) then
            ((compareList__d1_d2 _lh_compareList_LH_C_1_2_8) _lh_compareList_LH_C_1_2_9)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_2_8) < (int_of_char _lh_compareList_LH_C_0_2_9)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1_d3 _lh_compareList_arg1_1_2 _lh_compareList_arg2_1_2 =
  (match _lh_compareList_arg1_1_2 with
      ...
      (match _lh_compareList_arg2_1_2 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_3_8, _lh_compareList_LH_C_1_3_8) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_3_7) = (int_of_char _lh_compareList_LH_C_0_3_8)) then
            ((compareList__d1_d3 _lh_compareList_LH_C_1_3_7) _lh_compareList_LH_C_1_3_8)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_3_7) < (int_of_char _lh_compareList_LH_C_0_3_8)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1_d4 _lh_compareList_arg1_6 _lh_compareList_arg2_6 =
  (match _lh_compareList_arg1_6 with
      ...
      (match _lh_compareList_arg2_6 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_2_0, _lh_compareList_LH_C_1_2_0) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_9) = (int_of_char _lh_compareList_LH_C_0_2_0)) then
            ((compareList__d1_d4 _lh_compareList_LH_C_1_1_9) _lh_compareList_LH_C_1_2_0)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_9) < (int_of_char _lh_compareList_LH_C_0_2_0)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d1_d5 _lh_compareList_arg1_1_0 _lh_compareList_arg2_1_0 =
  (match _lh_compareList_arg1_1_0 with
      ...
      (match _lh_compareList_arg2_1_0 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_3_2, _lh_compareList_LH_C_1_3_2) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_3_1) = (int_of_char _lh_compareList_LH_C_0_3_2)) then
            ((compareList__d1_d5 _lh_compareList_LH_C_1_3_1) _lh_compareList_LH_C_1_3_2)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_3_1) < (int_of_char _lh_compareList_LH_C_0_3_2)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d2 _lh_compareList_arg1_7 _lh_compareList_arg2_7 =
  (match _lh_compareList_arg1_7 with
      ...
      (match _lh_compareList_arg2_7 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_2_3, _lh_compareList_LH_C_1_2_3) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_2_2) = (int_of_char _lh_compareList_LH_C_0_2_3)) then
            ((compareList__d2 _lh_compareList_LH_C_1_2_2) _lh_compareList_LH_C_1_2_3)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_2_2) < (int_of_char _lh_compareList_LH_C_0_2_3)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d3 _lh_compareList_arg1_8 _lh_compareList_arg2_8 =
  (match _lh_compareList_arg1_8 with
      ...
      (match _lh_compareList_arg2_8 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_2_6, _lh_compareList_LH_C_1_2_6) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_2_5) = (int_of_char _lh_compareList_LH_C_0_2_6)) then
            ((compareList__d3 _lh_compareList_LH_C_1_2_5) _lh_compareList_LH_C_1_2_6)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_2_5) < (int_of_char _lh_compareList_LH_C_0_2_6)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d4 _lh_compareList_arg1_1_6 _lh_compareList_arg2_1_6 =
  (match _lh_compareList_arg1_1_6 with
      ...
      (match _lh_compareList_arg2_1_6 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_5_0, _lh_compareList_LH_C_1_5_0) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_4_9) = (int_of_char _lh_compareList_LH_C_0_5_0)) then
            ((compareList__d4 _lh_compareList_LH_C_1_4_9) _lh_compareList_LH_C_1_5_0)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_4_9) < (int_of_char _lh_compareList_LH_C_0_5_0)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d5 _lh_compareList_arg1_1_5 _lh_compareList_arg2_1_5 =
  (match _lh_compareList_arg1_1_5 with
      ...
      (match _lh_compareList_arg2_1_5 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_4_7, _lh_compareList_LH_C_1_4_7) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_4_6) = (int_of_char _lh_compareList_LH_C_0_4_7)) then
            ((compareList__d5 _lh_compareList_LH_C_1_4_6) _lh_compareList_LH_C_1_4_7)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_4_6) < (int_of_char _lh_compareList_LH_C_0_4_7)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d6 _lh_compareList_arg1_4 _lh_compareList_arg2_4 =
      ...
      (match _lh_compareList_arg2_4 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_4, _lh_compareList_LH_C_1_1_4) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_3) = (int_of_char _lh_compareList_LH_C_0_1_4)) then
            ((compareList__d6 _lh_compareList_LH_C_1_1_3) _lh_compareList_LH_C_1_1_4)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_3) < (int_of_char _lh_compareList_LH_C_0_1_4)) then
              (`LT)
            else
...
let rec compareList__d7 _lh_compareList_arg1_1 _lh_compareList_arg2_1 =
  (match _lh_compareList_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d8 _lh_compareList_arg1_3 _lh_compareList_arg2_3 =
  (match _lh_compareList_arg1_3 with
      ...
      (match _lh_compareList_arg2_3 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_1, _lh_compareList_LH_C_1_1_1) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_0) = (int_of_char _lh_compareList_LH_C_0_1_1)) then
            ((compareList__d8 _lh_compareList_LH_C_1_1_0) _lh_compareList_LH_C_1_1_1)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_0) < (int_of_char _lh_compareList_LH_C_0_1_1)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec compareList__d9 _lh_compareList_arg1_5 _lh_compareList_arg2_5 =
  (match _lh_compareList_arg1_5 with
      ...
      (match _lh_compareList_arg2_5 with
        ...
        | `LH_C(_lh_compareList_LH_C_0_1_7, _lh_compareList_LH_C_1_1_7) -> 
          (if ((int_of_char _lh_compareList_LH_C_0_1_6) = (int_of_char _lh_compareList_LH_C_0_1_7)) then
            ((compareList__d9 _lh_compareList_LH_C_1_1_6) _lh_compareList_LH_C_1_1_7)
          else
            (if ((int_of_char _lh_compareList_LH_C_0_1_6) < (int_of_char _lh_compareList_LH_C_0_1_7)) then
              (`LT)
            else
    ...
    | _ -> 
      (failwith "error"));;
let rec foldl__d0 f_1_4 i_3 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_2_0, t_2_2) -> 
      (((foldl__d0 f_1_4) ((f_1_4 i_3) h_2_0)) t_2_2)
    | `LH_N -> 
      i_3);;
let rec foldr__d0 f_2_0 i_6 ls_3_0 =
  (match ls_3_0 with
    | `LH_C(h_3_7, t_3_9) -> 
      ((f_2_0 h_3_7) (((foldr__d0 f_2_0) i_6) t_3_9))
    | `LH_N -> 
      i_6);;
let rec foldr__d1 f_1_8 i_5 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_3_1, t_3_3) -> 
      ((f_1_8 h_3_1) (((foldr__d1 f_1_8) i_5) t_3_3))
    | `LH_N -> 
      i_5);;
let rec foldr__d2 f_1_6 i_4 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_2_7, t_2_9) -> 
      ((f_1_6 h_2_7) (((foldr__d2 f_1_6) i_4) t_2_9))
    | `LH_N -> 
      i_4);;
let rec foldr__d3 f_2_1 i_7 ls_3_1 =
  (match ls_3_1 with
    | `LH_C(h_3_8, t_4_0) -> 
      ((f_2_1 h_3_8) (((foldr__d3 f_2_1) i_7) t_4_0))
    | `LH_N -> 
      i_7);;
let rec map__d0 f_1_9 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_3_2, t_3_4) -> 
...
let rec mappend__d1 xs_1_6 ys_1_6 =
  (match xs_1_6 with
    | `LH_C(h_3_4, t_3_6) -> 
      (`LH_C(h_3_4, ((mappend__d1 t_3_6) ys_1_6)))
    | `LH_N -> 
      ys_1_6);;
let rec mappend__d2 xs_1_7 ys_1_7 =
  (match xs_1_7 with
    | `LH_C(h_3_5, t_3_7) -> 
      (`LH_C(h_3_5, ((mappend__d2 t_3_7) ys_1_7)))
    | `LH_N -> 
      ys_1_7);;
let rec mappend__d3 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_2_8, t_3_0) -> 
      (`LH_C(h_2_8, ((mappend__d3 t_3_0) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend__d4 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    ...
    | `LH_N -> 
      ys_1_1);;
let rec mappend__d5 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_2_2, t_2_4) -> 
      (`LH_C(h_2_2, ((mappend__d5 t_2_4) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend__d6 xs_1_8 ys_1_8 =
  (match xs_1_8 with
    | `LH_C(h_3_9, t_4_1) -> 
      (`LH_C(h_3_9, ((mappend__d6 t_4_1) ys_1_8)))
    | `LH_N -> 
      ys_1_8);;
let rec mappend__d7 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_2_3, t_2_5) -> 
      (`LH_C(h_2_3, ((mappend__d7 t_2_5) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec mappend__d8 xs_1_4 ys_1_4 =
  (match xs_1_4 with
    | `LH_C(h_3_0, t_3_2) -> 
      (`LH_C(h_3_0, ((mappend__d8 t_3_2) ys_1_4)))
    | `LH_N -> 
      ys_1_4);;
let rec mappend__d9 xs_1_5 ys_1_5 =
  (match xs_1_5 with
    | `LH_C(h_3_3, t_3_5) -> 
      (`LH_C(h_3_3, ((mappend__d9 t_3_5) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
...
let rec prependToAll__d0 _lh_prependToAll_arg1_1 _lh_prependToAll_arg2_1 =
  (match _lh_prependToAll_arg2_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec reverse_helper__d0 ls_2_8 a_7 =
  (match ls_2_8 with
    | `LH_C(h_3_6, t_3_8) -> 
      ((reverse_helper__d0 t_3_8) (`LH_C(h_3_6, a_7)))
    | `LH_N -> 
      a_7);;
let rec reverse_helper__d1 ls_2_1 a_6 =
  (match ls_2_1 with
    | `LH_C(h_2_6, t_2_8) -> 
      ((reverse_helper__d1 t_2_8) (`LH_C(h_2_6, a_6)))
    | `LH_N -> 
      a_6);;
let rec reverse_helper__d2 ls_2_0 a_5 =
  (match ls_2_0 with
    | `LH_C(h_2_1, t_2_3) -> 
      ((reverse_helper__d2 t_2_3) (`LH_C(h_2_1, a_5)))
    | `LH_N -> 
      a_5);;
let rec reverse_helper__d3 ls_3_2 a_8 =
  (match ls_3_2 with
    | `LH_C(h_4_0, t_4_2) -> 
      ((reverse_helper__d3 t_4_2) (`LH_C(h_4_0, a_8)))
    | `LH_N -> 
      a_8);;
...
let rec concat__d0 lss_1 =
  (match lss_1 with
    | `LH_C(h_2_9, t_3_1) -> 
      ((mappend__d8 h_2_9) (concat__d0 t_3_1))
    | `LH_N -> 
      (`LH_N))
...
and gtList__d0 _lh_gtList_arg1_6 _lh_gtList_arg2_6 =
  (let rec _lh_matchIdent_2_1 = ((compareList__d0 _lh_gtList_arg1_6) _lh_gtList_arg2_6) in
    (match _lh_matchIdent_2_1 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d1 _lh_gtList_arg1_7 _lh_gtList_arg2_7 =
  (let rec _lh_matchIdent_2_2 = ((compareList__d1 _lh_gtList_arg1_7) _lh_gtList_arg2_7) in
    (match _lh_matchIdent_2_2 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d1_d0 _lh_gtList_arg1_2 _lh_gtList_arg2_2 =
  (let rec _lh_matchIdent_1_2 = ((compareList__d1_d4 _lh_gtList_arg1_2) _lh_gtList_arg2_2) in
    (match _lh_matchIdent_1_2 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d1_d1 _lh_gtList_arg1_5 _lh_gtList_arg2_5 =
  (let rec _lh_matchIdent_1_6 = ((compareList__d1_d5 _lh_gtList_arg1_5) _lh_gtList_arg2_5) in
    (match _lh_matchIdent_1_6 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d2 _lh_gtList_arg1_1_1 _lh_gtList_arg2_1_1 =
  (let rec _lh_matchIdent_3_1 = ((compareList__d2 _lh_gtList_arg1_1_1) _lh_gtList_arg2_1_1) in
    (match _lh_matchIdent_3_1 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d3 _lh_gtList_arg1_3 _lh_gtList_arg2_3 =
  (let rec _lh_matchIdent_1_3 = ((compareList__d5 _lh_gtList_arg1_3) _lh_gtList_arg2_3) in
    (match _lh_matchIdent_1_3 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d4 _lh_gtList_arg1_8 _lh_gtList_arg2_8 =
  (let rec _lh_matchIdent_2_4 = ((compareList__d6 _lh_gtList_arg1_8) _lh_gtList_arg2_8) in
    (match _lh_matchIdent_2_4 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d5 _lh_gtList_arg1_1 _lh_gtList_arg2_1 =
  (let rec _lh_matchIdent_1_1 = ((compareList__d7 _lh_gtList_arg1_1) _lh_gtList_arg2_1) in
    (match _lh_matchIdent_1_1 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d6 _lh_gtList_arg1_9 _lh_gtList_arg2_9 =
  (let rec _lh_matchIdent_2_5 = ((compareList__d1_d0 _lh_gtList_arg1_9) _lh_gtList_arg2_9) in
    (match _lh_matchIdent_2_5 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d7 _lh_gtList_arg1_1_0 _lh_gtList_arg2_1_0 =
  (let rec _lh_matchIdent_2_8 = ((compareList__d1_d1 _lh_gtList_arg1_1_0) _lh_gtList_arg2_1_0) in
    (match _lh_matchIdent_2_8 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d8 _lh_gtList_arg1_4 _lh_gtList_arg2_4 =
  (let rec _lh_matchIdent_1_4 = ((compareList__d1_d2 _lh_gtList_arg1_4) _lh_gtList_arg2_4) in
    (match _lh_matchIdent_1_4 with
      | `GT -> 
        true
      | _ -> 
        false))
and gtList__d9 _lh_gtList_arg1_1_2 _lh_gtList_arg2_1_2 =
  (let rec _lh_matchIdent_3_2 = ((compareList__d1_d3 _lh_gtList_arg1_1_2) _lh_gtList_arg2_1_2) in
...
and intersperse__d0 _lh_intersperse_arg1_1 _lh_intersperse_arg2_1 =
  (match _lh_intersperse_arg2_1 with
    ...
    | _ -> 
      (failwith "error"))
and leList__d0 _lh_leList_arg1_4 _lh_leList_arg2_4 =
  (not ((gtList__d0 _lh_leList_arg1_4) _lh_leList_arg2_4))
...
and leList__d3 _lh_leList_arg1_8 _lh_leList_arg2_8 =
  (not ((gtList__d4 _lh_leList_arg1_8) _lh_leList_arg2_8))
and leList__d4 _lh_leList_arg1_7 _lh_leList_arg2_7 =
  (not ((gtList__d5 _lh_leList_arg1_7) _lh_leList_arg2_7))
and leList__d5 _lh_leList_arg1_2 _lh_leList_arg2_2 =
  (not ((gtList__d7 _lh_leList_arg1_2) _lh_leList_arg2_2))
and leList__d6 _lh_leList_arg1_3 _lh_leList_arg2_3 =
  (not ((gtList__d8 _lh_leList_arg1_3) _lh_leList_arg2_3))
and leList__d7 _lh_leList_arg1_9 _lh_leList_arg2_9 =
  (not ((gtList__d9 _lh_leList_arg1_9) _lh_leList_arg2_9))
and leList__d8 _lh_leList_arg1_5 _lh_leList_arg2_5 =
  (not ((gtList__d1_d0 _lh_leList_arg1_5) _lh_leList_arg2_5))
and leList__d9 _lh_leList_arg1_1_0 _lh_leList_arg2_1_0 =
  (not ((gtList__d1_d1 _lh_leList_arg1_1_0) _lh_leList_arg2_1_0))
and lines__d0 _lh_lines_arg1_1 =
  (match _lh_lines_arg1_1 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_2_9 = ((break__d0 (fun x_7 -> 
        (x_7 = '|'))) _lh_lines_arg1_1) in
        (match _lh_matchIdent_2_9 with
          | `LH_P2(_lh_lines_LH_P2_0_1, _lh_lines_LH_P2_1_1) -> 
            (`LH_C(_lh_lines_LH_P2_0_1, (let rec _lh_matchIdent_3_0 = _lh_lines_LH_P2_1_1 in
...
and ltList__d0 _lh_ltList_arg1_1 _lh_ltList_arg2_1 =
  (let rec _lh_matchIdent_1_0 = ((compareList__d3 _lh_ltList_arg1_1) _lh_ltList_arg2_1) in
...
and ltList__d1 _lh_ltList_arg1_3 _lh_ltList_arg2_3 =
  (let rec _lh_matchIdent_2_7 = ((compareList__d8 _lh_ltList_arg1_3) _lh_ltList_arg2_3) in
...
and ltList__d2 _lh_ltList_arg1_2 _lh_ltList_arg2_2 =
  (let rec _lh_matchIdent_2_6 = ((compareList__d9 _lh_ltList_arg1_2) _lh_ltList_arg2_2) in
...
and mangle__d0 _lh_mangle_arg1_1 =
  (let rec sort_1 = (fun _lh_sort_arg1_1 -> 
    ((((foldr__d0 (fun f_1_5 g_1 _lh_funcomp_x_7 -> 
      (f_1_5 (g_1 _lh_funcomp_x_7)))) (fun x_6 -> 
      x_6)) ((intersperse__d0 reverse__d3) (`LH_C(heapSort__d0, (`LH_C(insertSort__d0, (`LH_C(mergeSort__d0, (`LH_C(quickSort__d0, (`LH_C(quickSort2__d0, (`LH_C(quickerSort__d0, (`LH_C(treeSort__d0, (`LH_C(treeSort2__d0, (`LH_N))))))))))))))))))) _lh_sort_arg1_1)) in
    ((fun _lh_funcomp_x_8 -> 
      ((fun _lh_funcomp_x_9 -> 
                          ...
                          | `LH_C(_lh_runsplit_LH_C_0_1_1, _lh_runsplit_LH_C_1_1_1) -> 
                            (match _lh_runsplit_arg2_1 with
                              | `LH_C(_lh_runsplit_LH_C_0_1_2, _lh_runsplit_LH_C_1_1_2) -> 
                                (let rec _lh_matchIdent_1_7 = _lh_runsplit_LH_C_1_1_1 in
                                  (match _lh_matchIdent_1_7 with
                                    ...
                                    | _ -> 
                                      (if ((leList__d3 _lh_runsplit_LH_C_0_1_2) _lh_runsplit_LH_C_0_1_1) then
                                        ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_2, (`LH_C(_lh_runsplit_LH_C_0_1_1, _lh_matchIdent_1_7))))) _lh_runsplit_LH_C_1_1_2)
                                      else
                                        (`LH_C((`LH_C(_lh_runsplit_LH_C_0_1_1, _lh_matchIdent_1_7)), ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_2, (`LH_N)))) _lh_runsplit_LH_C_1_1_2))))))
                              | _ -> 
                                (failwith "error"))
                          | _ -> 
                            (failwith "error")))
                      ...
                      | `LH_C(_lh_runsplit_LH_C_0_1_3, _lh_runsplit_LH_C_1_1_3) -> 
                        (match _lh_runsplit_arg2_1 with
                          | `LH_C(_lh_runsplit_LH_C_0_1_4, _lh_runsplit_LH_C_1_1_4) -> 
                            (let rec _lh_matchIdent_1_8 = _lh_runsplit_LH_C_1_1_3 in
                              (match _lh_matchIdent_1_8 with
                                ...
                                | _ -> 
                                  (if ((leList__d3 _lh_runsplit_LH_C_0_1_4) _lh_runsplit_LH_C_0_1_3) then
                                    ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_4, (`LH_C(_lh_runsplit_LH_C_0_1_3, _lh_matchIdent_1_8))))) _lh_runsplit_LH_C_1_1_4)
                                  else
                                    (`LH_C((`LH_C(_lh_runsplit_LH_C_0_1_3, _lh_matchIdent_1_8)), ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_4, (`LH_N)))) _lh_runsplit_LH_C_1_1_4))))))
                          | _ -> 
                            (failwith "error"))
                      | _ -> 
                        (failwith "error")))))
                      ...
                      | `LH_C(_lh_runsplit_LH_C_0_1_6, _lh_runsplit_LH_C_1_1_6) -> 
                        (match _lh_runsplit_arg2_1 with
                          | `LH_C(_lh_runsplit_LH_C_0_1_7, _lh_runsplit_LH_C_1_1_7) -> 
                            (let rec _lh_matchIdent_1_9 = _lh_runsplit_LH_C_1_1_6 in
                              (match _lh_matchIdent_1_9 with
                                ...
                                | _ -> 
                                  (if ((leList__d3 _lh_runsplit_LH_C_0_1_7) _lh_runsplit_LH_C_0_1_6) then
                                    ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_7, (`LH_C(_lh_runsplit_LH_C_0_1_6, _lh_matchIdent_1_9))))) _lh_runsplit_LH_C_1_1_7)
                                  else
                                    (`LH_C((`LH_C(_lh_runsplit_LH_C_0_1_6, _lh_matchIdent_1_9)), ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_7, (`LH_N)))) _lh_runsplit_LH_C_1_1_7))))))
                          | _ -> 
                            (failwith "error"))
                      | _ -> 
                        (failwith "error")))
                  ...
                  | `LH_C(_lh_runsplit_LH_C_0_1_8, _lh_runsplit_LH_C_1_1_8) -> 
                    (match _lh_runsplit_arg2_1 with
                      | `LH_C(_lh_runsplit_LH_C_0_1_9, _lh_runsplit_LH_C_1_1_9) -> 
                        (let rec _lh_matchIdent_2_0 = _lh_runsplit_LH_C_1_1_8 in
                          (match _lh_matchIdent_2_0 with
                            ...
                            | _ -> 
                              (if ((leList__d3 _lh_runsplit_LH_C_0_1_9) _lh_runsplit_LH_C_0_1_8) then
                                ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_9, (`LH_C(_lh_runsplit_LH_C_0_1_8, _lh_matchIdent_2_0))))) _lh_runsplit_LH_C_1_1_9)
                              else
                                (`LH_C((`LH_C(_lh_runsplit_LH_C_0_1_8, _lh_matchIdent_2_0)), ((runsplit_1 (`LH_C(_lh_runsplit_LH_C_0_1_9, (`LH_N)))) _lh_runsplit_LH_C_1_1_9))))))
                      | _ -> 
                        (failwith "error"))
                  | _ -> 
                    (failwith "error"))))))
...
and quickSort2__d0 _lh_quickSort2_arg1_1 =
  (match _lh_quickSort2_arg1_1 with
    ...
    | `LH_C(_lh_quickSort2_LH_C_0_1, _lh_quickSort2_LH_C_1_1) -> 
      (let rec _lh_matchIdent_1_5 = ((partition__d0 ((fun x_5 y_1 -> 
        ((geList__d0 x_5) y_1)) _lh_quickSort2_LH_C_0_1)) _lh_quickSort2_LH_C_1_1) in
...
and reverse__d1 ls_2_9 =
  ((reverse_helper__d1 ls_2_9) (`LH_N))
and reverse__d2 ls_2_4 =
  ((reverse_helper__d2 ls_2_4) (`LH_N))
and reverse__d3 ls_2_2 =
  ((reverse_helper__d3 ls_2_2) (`LH_N))
  ...
  let rec mkTree_3 = (fun _lh_mkTree_arg1_3 -> 
    (let rec to_tree_3 = (fun _lh_to_tree_arg1_3 _lh_to_tree_arg2_3 -> 
      (match _lh_to_tree_arg2_3 with
        | `Tip2 -> 
          (`Twig2(_lh_to_tree_arg1_3))
        | `Twig2(_lh_to_tree_Twig2_0_1) -> 
          (if ((leList__d7 _lh_to_tree_arg1_3) _lh_to_tree_Twig2_0_1) then
            (`Branch2(_lh_to_tree_Twig2_0_1, (`Twig2(_lh_to_tree_arg1_3)), (`Tip2)))
          else
            (`Branch2(_lh_to_tree_Twig2_0_1, (`Tip2), (`Twig2(_lh_to_tree_arg1_3)))))
        | `Branch2(_lh_to_tree_Branch2_0_1, _lh_to_tree_Branch2_1_1, _lh_to_tree_Branch2_2_1) -> 
          (if ((leList__d8 _lh_to_tree_arg1_3) _lh_to_tree_Branch2_0_1) then
            (`Branch2(_lh_to_tree_Branch2_0_1, ((to_tree_3 _lh_to_tree_arg1_3) _lh_to_tree_Branch2_1_1), _lh_to_tree_Branch2_2_1))
          else
            (`Branch2(_lh_to_tree_Branch2_0_1, _lh_to_tree_Branch2_1_1, ((to_tree_3 _lh_to_tree_arg1_3) _lh_to_tree_Branch2_2_1))))
        | _ -> 
          (failwith "error"))) in
      (((foldr__d2 to_tree_3) (`Tip2)) _lh_mkTree_arg1_3)))
  and readTree_3 = (fun _lh_readTree_arg1_3 -> 
    (match _lh_readTree_arg1_3 with
      ...
      | `Branch2(_lh_readTree_Branch2_0_1, _lh_readTree_Branch2_1_1, _lh_readTree_Branch2_2_1) -> 
        ((mappend__d6 (readTree_3 _lh_readTree_Branch2_1_1)) (`LH_C(_lh_readTree_Branch2_0_1, (readTree_3 _lh_readTree_Branch2_2_1))))
      | _ -> 
        (failwith "error")))
  in ((fun _lh_funcomp_x_1_0 -> 
    (readTree_3 (mkTree_3 _lh_funcomp_x_1_0))) _lh_treeSort2_arg1_1)
  ...
  let rec mkTree_2 = (fun _lh_mkTree_arg1_2 -> 
    (let rec to_tree_2 = (fun _lh_to_tree_arg1_2 _lh_to_tree_arg2_2 -> 
      (match _lh_to_tree_arg2_2 with
        | `Tip -> 
          (`Branch(_lh_to_tree_arg1_2, (`Tip), (`Tip)))
        | `Branch(_lh_to_tree_Branch_0_1, _lh_to_tree_Branch_1_1, _lh_to_tree_Branch_2_1) -> 
          (if ((leList__d9 _lh_to_tree_arg1_2) _lh_to_tree_Branch_0_1) then
            (`Branch(_lh_to_tree_Branch_0_1, ((to_tree_2 _lh_to_tree_arg1_2) _lh_to_tree_Branch_1_1), _lh_to_tree_Branch_2_1))
          else
            (`Branch(_lh_to_tree_Branch_0_1, _lh_to_tree_Branch_1_1, ((to_tree_2 _lh_to_tree_arg1_2) _lh_to_tree_Branch_2_1))))
        | _ -> 
          (failwith "error"))) in
      (((foldr__d3 to_tree_2) (`Tip)) _lh_mkTree_arg1_2)))
  and readTree_2 = (fun _lh_readTree_arg1_2 -> 
    (match _lh_readTree_arg1_2 with
      ...
      | `Branch(_lh_readTree_Branch_0_1, _lh_readTree_Branch_1_1, _lh_readTree_Branch_2_1) -> 
        ((mappend__d7 (readTree_2 _lh_readTree_Branch_1_1)) (`LH_C(_lh_readTree_Branch_0_1, (readTree_2 _lh_readTree_Branch_2_1))))
      | _ -> 
        (failwith "error")))
  in ((fun _lh_funcomp_x_6 -> 
    (readTree_2 (mkTree_2 _lh_funcomp_x_6))) _lh_treeSort_arg1_1)

...
let rec concat_lh lss_0 =
  (match lss_0 with
    ...
    | `LH_N -> 
      (`LH_N))
and itemFromTo_lh _lh_itemFromTo_arg1_0 _lh_itemFromTo_arg2_0 =
...
and minSolutions_lh _lh_minSolutions_arg1_0 =
  (match _lh_minSolutions_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and notSeen_lh _lh_notSeen_arg1_0 =
  (all_lh (fun _s_0 -> 
    (let rec _lh_matchIdent_0 = _s_0 in
      (match _lh_matchIdent_0 with
        ...
        | _ -> 
          (failwith "error")))))
and position_lh _lh_position_arg1_0 =
...
and testPuzzle_nofib_lh _lh_testPuzzle_nofib_arg1_0 =
...
and transfer_lh _lh_transfer_arg1_0 _lh_transfer_arg2_0 _lh_transfer_arg3_0 _lh_transfer_arg4_0 _lh_transfer_arg5_0 =
...
and writeHistory_lh _lh_writeHistory_arg1_0 =
...
and writeItem_lh _lh_writeItem_arg1_0 _lh_writeItem_arg2_0 _lh_writeItem_arg3_0 =
  (match _lh_writeItem_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and writeSolutions_lh _lh_writeSolutions_arg1_0 _lh_writeSolutions_arg2_0 =
  (match _lh_writeSolutions_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and writeState_lh _lh_writeState_arg1_0 _lh_funcomp_x_0 =
  ((fun _lh_funcomp_x_1 -> 
    ((fun _lh_funcomp_x_2 -> 
      ((fun _lh_funcomp_x_3 -> 
        ((fun _lh_funcomp_x_4 -> 

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_PiDigits_nofib" (fun () -> ignore (let open Module_lumberhack.Module_lumberhack in ((testPiDigits_nofib__d0 5000))));
  Bench.Test.create ~name:"lumberhack_pop_out_PiDigits_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out.Module_lumberhack_pop_out in ((testPiDigits_nofib__d0 5000))));
])

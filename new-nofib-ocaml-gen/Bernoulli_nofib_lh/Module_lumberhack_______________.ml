...
let rec atIndex_lz_lh__d1 n_0 ls_0 =
  (if (n_0 < 0) then
    ...
    ((Lazy.force ls_0) n_0));;
let rec map_lz_lh__d1 f_4 ls_6 =
...
let rec pascal_lh__d1 =
  (lazy (`LH_C((`LH_C(1, (`LH_C(2, (`LH_C(1, (`LH_N))))))), ((map_lz_lh__d1 (fun line_0 -> 
    (((zipWith_lh__d1 (fun a_9 b_3 -> 
      (a_9 + b_3))) ((mappend_lh__d1 line_0) (let rec tx_3 = (fun f_7 ys_8 -> 
      (`LH_N)) in
      (let rec hx_3 = 0 in
        (fun f_8 ys_9 -> 
          (match ys_9 with
...
let rec zipWith_lz_nl_lh__d1 f_6 xs_4 ys_7 =
  (match ys_7 with
    ...
    | `LH_N -> 
      (fun a_8 -> 
        a_8));;
let rec sumAux_lh__d2 ls_5 a_7 =
  (ls_5 a_7);;
                ...
                (fun f_1_2 hy_6 ty_6 -> 
                  (let rec t_9 = (((zipWith_lz_nl_lh__d1 f_1_2) tx_5) ty_6) in
                    (let rec h_9 = ((f_1_2 hx_5) hy_6) in
                      (fun a_1_1 -> 
                        ((sumAux_lh__d2 t_9) (a_1_1 + h_9))))))))
          | `LH_N -> 
            (fun f_1_3 hy_7 ty_7 a_1_2 -> 
              a_1_2))))));;
...
let rec map_lz_lh__d3 f_1 ls_2 =
  (lazy (match (Lazy.force ls_2) with
    ...
    | `LH_N -> 
      (`LH_N)));;
let rec enumFrom_lh__d1 a_1_0 =
  (lazy (`LH_C(a_1_0, (enumFrom_lh__d1 (a_1_0 + 1)))));;
...
let rec sum_lh__d2 ls_1 =
  ((sumAux_lh__d2 ls_1) 0);;
let rec tail_lh__d2 ls_7 =
  (match ls_7 with
    | `LH_C(h_6, t_6) -> 
      t_6
    | `LH_N -> 
    ...
    | _ -> 
      (if ((_lh_bernoulli_arg1_0 mod 2) = 1) then
        ...
        (let rec powers_4 = ((atIndex_lz_lh__d1 (_lh_bernoulli_arg1_0 - 1)) (Lazy.force neg_powers_lh__d1)) in
          (((0 - 1) / 2) + (sum_lh__d1 (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_0 -> 

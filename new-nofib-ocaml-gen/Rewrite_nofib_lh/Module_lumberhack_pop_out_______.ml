    ...
    | `LH_C(h_3, t_7) -> 
      (let rec t_8 = ((map_lh__d1_d1 f_6) t_7) in
        (let rec h_4 = (f_6 h_3) in
          (`LH_C(h_4, ((mappend_lh__d1 t_8) _lh_popOutId_0_0)))))
    | `LH_N -> 
      _lh_popOutId_0_0);;
    ...
    (let rec _lh_all_LH_C_1_1 = ((copy_lh__d1 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec _lh_all_LH_C_0_1 = _lh_copy_arg2_0 in
        (if (_lh_popOutId_0_1 _lh_all_LH_C_0_1) then
          ((all_lh__d1 _lh_popOutId_0_1) _lh_all_LH_C_1_1)
        else
          false))));;
    ...
    | `LH_C(h_2_8, t_3_4) -> 
      (let rec t_3_5 = ((map_lh__d1_d2 f_3_3) t_3_4) in
        (let rec h_2_9 = (f_3_3 h_2_8) in
          (`LH_C((_lh_popOutId_0_2 h_2_9), ((map_lh__d6 _lh_popOutId_0_2) t_3_5)))))
    | `LH_N -> 
      (`LH_N));;
...
let rec fst_lh__d3 _lh_fst_arg1_3 =
  (match _lh_fst_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1 f_3_7 ls_1_4 _lh_popOutId_0_3 =
  (match ls_1_4 with
    | `LH_C(h_3_2, t_3_8) -> 
      (let rec _lh_inList_LH_C_1_1_2 = ((map_lh__d1 f_3_7) t_3_8) in
        (let rec _lh_inList_LH_C_0_1_2 = (f_3_7 h_3_2) in
          (if (_lh_popOutId_0_3 = _lh_inList_LH_C_0_1_2) then
            true
          else
            ((inList_lh__d2 _lh_popOutId_0_3) _lh_inList_LH_C_1_1_2))))
    | `LH_N -> 
      false);;
...
let rec lift_lh__d9 _lh_lift_arg1_8 _lh_lift_arg2_8 =
  (match _lh_lift_arg2_8 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d3 f_4_0 ls_1_6 _lh_popOutId_0_4 =
  (match ls_1_6 with
    | `LH_C(h_3_4, t_4_1) -> 
      (let rec t_4_2 = ((map_lh__d3 f_4_0) t_4_1) in
        (let rec h_3_5 = (f_4_0 h_3_4) in
          (`LH_C(h_3_5, ((mappend_lh__d3 t_4_2) _lh_popOutId_0_4)))))
    | `LH_N -> 
      _lh_popOutId_0_4);;
...
let rec map_lh__d4 f_4_2 ls_1_8 _lh_popOutId_0_5 =
  (match ls_1_8 with
    | `LH_C(h_3_7, t_4_4) -> 
      (let rec t_4_5 = ((map_lh__d4 f_4_2) t_4_4) in
        (let rec h_3_8 = (f_4_2 h_3_7) in
          (`LH_C(h_3_8, ((mappend_lh__d6 t_4_5) _lh_popOutId_0_5)))))
    | `LH_N -> 
      _lh_popOutId_0_5);;
      ...
      (fun _lh_dummy_0 -> 
        ...
        and p_eqn_0 = (fun _lh_p_eqn_arg1_0 -> 
          (((seQ_0 q_eqn_0) (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (fun f_1_7 i_1_0 -> 
            ...
            (let rec h_1_4 = p_expr_0 in
              (fun f_2_0 i_1_3 -> 
                ((f_2_0 h_1_4) (((foldr_lh__d1 f_2_0) i_1_3) t_1_7)))))) _lh_p_eqn_arg1_0))
        ...
        and seq2_0 = (fun _lh_seq2_arg1_0 _lh_seq2_arg2_0 _lh_seq2_arg3_0 -> 
          (let rec g_1 = (fun xs_4 -> 
            ...
            (fun _lh_funcomp_x_6 -> 
              ((fun _lh_funcomp_x_7 -> 
                (squash_lh__d1 ((lift_lh__d2 g_1) _lh_funcomp_x_7))) (_lh_seq2_arg2_0 _lh_funcomp_x_6)))))
        ...
        and p_expr_0 = (fun _lh_p_expr_arg1_0 -> 
          (((orElseMap_lh__d4 ((seQ_0 q_op_0) (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (fun f_2_1 i_1_4 -> 
            ...
            (let rec h_1_7 = p_term_0 in
              (fun f_2_4 i_1_7 -> 
                ((f_2_4 h_1_7) (((foldr_lh__d1 f_2_4) i_1_7) t_2_0))))))) p_term_0) _lh_p_expr_arg1_0))

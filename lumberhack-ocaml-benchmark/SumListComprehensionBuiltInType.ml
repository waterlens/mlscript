  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
      (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo_d1_d0 (a_0 + 1)) b_0) in
        (fun _lh_listcomp_fun_ls_h_1 _lh_listcomp_fun_1 _lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_1 -> 
...
and testSumListComprehensionBuiltInType_d0_d0 _lh_testSumListComprehensionBuiltInType_arg1_0 =
  (sum_d0_d0 (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
    (_lh_listcomp_fun_para_0 _lh_listcomp_fun_0)) in
    (_lh_listcomp_fun_0 ((enumFromTo_d0_d0 1) _lh_testSumListComprehensionBuiltInType_arg1_0))));;

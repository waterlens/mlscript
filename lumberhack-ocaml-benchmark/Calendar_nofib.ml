...
let rec monthNames__d0 =
  (let rec _lh_zip3_LH_C_1_2 = (let rec _lh_zip3_LH_C_1_3 = (let rec _lh_zip3_LH_C_1_4 = (let rec _lh_zip3_LH_C_1_5 = (let rec _lh_zip3_LH_C_1_6 = (let rec _lh_zip3_LH_C_1_7 = (let rec _lh_zip3_LH_C_1_8 = (let rec _lh_zip3_LH_C_1_9 = (let rec _lh_zip3_LH_C_1_1_0 = (let rec _lh_zip3_LH_C_1_1_1 = (let rec _lh_zip3_LH_C_1_1_2 = (let rec _lh_zip3_LH_C_1_1_3 = (fun _lh_zip3_arg2_1 _lh_zip3_arg3_2 f_1_3 -> 
    ...
    (let rec _lh_zip3_LH_C_0_1_3 = (`LH_C('J', (`LH_C('a', (`LH_C('n', (`LH_C('u', (`LH_C('a', (`LH_C('r', (`LH_C('y', (`LH_N))))))))))))))) in
      (fun _lh_zip3_arg2_1_3 _lh_zip3_arg3_1_4 -> 
...
and cjustify__d1 _lh_cjustify_arg1_1 _lh_cjustify_arg2_1 =
  (let rec m_1 = (_lh_cjustify_arg1_1 - (length__d2 _lh_cjustify_arg2_1)) in
    (let rec halfm_1 = (m_1 / 2) in
      ((mappend__d1_d3 ((mappend__d1_d4 (space__d3 halfm_1)) _lh_cjustify_arg2_1)) (space__d4 (m_1 - halfm_1)))))
and copy__d0 _lh_copy_arg1_8 _lh_copy_arg2_8 =
  (if (_lh_copy_arg1_8 > 0) then
    (let rec t_2_5 = ((copy__d0 (_lh_copy_arg1_8 - 1)) _lh_copy_arg2_8) in
      (let rec h_2_4 = _lh_copy_arg2_8 in
        (fun ys_2_5 -> 
          (`LH_C(h_2_4, ((mappend__d1 t_2_5) ys_2_5))))))
  else
    (fun ys_2_6 -> 
      ys_2_6))
and copy__d1_d0 _lh_copy_arg1_1_0 _lh_copy_arg2_1_0 =
  (if (_lh_copy_arg1_1_0 > 0) then
    (let rec t_4_1 = ((copy__d1_d0 (_lh_copy_arg1_1_0 - 1)) _lh_copy_arg2_1_0) in
      (let rec h_4_0 = _lh_copy_arg2_1_0 in
        (fun ys_3_6 -> 
          (`LH_C(h_4_0, ((mappend__d1_d1 t_4_1) ys_3_6))))))
  else
    (fun ys_3_7 -> 
      ys_3_7))
and copy__d1_d1 _lh_copy_arg1_2 _lh_copy_arg2_2 =
  (if (_lh_copy_arg1_2 > 0) then
    (let rec t_1_1 = ((copy__d1_d1 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec h_1_0 = _lh_copy_arg2_2 in
        (fun ys_8 -> 
          (`LH_C(h_1_0, ((mappend__d1_d4 t_1_1) ys_8))))))
  else
    (fun ys_9 -> 
      ys_9))
and copy__d2 _lh_copy_arg1_7 _lh_copy_arg2_7 =
  (if (_lh_copy_arg1_7 > 0) then
    (let rec t_2_3 = ((copy__d2 (_lh_copy_arg1_7 - 1)) _lh_copy_arg2_7) in
      (let rec h_2_2 = _lh_copy_arg2_7 in
        (fun ys_2_1 -> 
          (`LH_C(h_2_2, ((mappend__d1_d5 t_2_3) ys_2_1))))))
  else
    (fun ys_2_2 -> 
      ys_2_2))
and copy__d6 _lh_copy_arg1_1_1 _lh_copy_arg2_1_1 =
  (if (_lh_copy_arg1_1_1 > 0) then
    (let rec tx_4 = ((copy__d6 (_lh_copy_arg1_1_1 - 1)) _lh_copy_arg2_1_1) in
      (let rec hx_4 = _lh_copy_arg2_1_1 in
        (fun f_3_8 ys_4_0 -> 
          (match ys_4_0 with
            | `LH_C(hy_3, ty_3) -> 
              (let rec tx_5 = (((zipWith__d2 f_3_8) tx_4) ty_3) in
                (let rec hx_5 = ((f_3_8 hx_4) hy_3) in
                  (fun f_3_9 ys_4_1 -> 
                    (((ys_4_1 f_3_9) hx_5) tx_5))))
            | `LH_N -> 
              (fun f_4_0 ys_4_2 ys_4_3 -> 
                ys_4_3)))))
  else
    (fun f_4_1 ys_4_4 f_4_2 ys_4_5 ys_4_6 -> 
      ys_4_6))
and copy__d7 _lh_copy_arg1_9 _lh_copy_arg2_9 =
  (if (_lh_copy_arg1_9 > 0) then
    (let rec t_2_7 = ((copy__d7 (_lh_copy_arg1_9 - 1)) _lh_copy_arg2_9) in
      (let rec h_2_6 = _lh_copy_arg2_9 in
        (fun ys_3_0 -> 
          (`LH_C(h_2_6, ((mappend__d7 t_2_7) ys_3_0))))))
  else
    (fun ys_3_1 -> 
      ys_3_1))
and copy__d8 _lh_copy_arg1_6 _lh_copy_arg2_6 =
  (if (_lh_copy_arg1_6 > 0) then
    (let rec ty_0 = ((copy__d8 (_lh_copy_arg1_6 - 1)) _lh_copy_arg2_6) in
      (let rec hy_0 = _lh_copy_arg2_6 in
        (fun f_1_7 hx_0 tx_0 -> 
          (let rec t_2_1 = (((zipWith__d1 f_1_7) tx_0) ty_0) in
            (let rec h_2_0 = ((f_1_7 hx_0) hy_0) in
              (fun ys_1_8 -> 
                (`LH_C(h_2_0, ((mappend__d5 t_2_1) ys_1_8)))))))))
  else
    (fun f_1_8 hx_1 tx_1 ys_1_9 -> 
      ys_1_9))
  ...
  (if (a_5 <= b_4) then
    (let rec t_2_0 = ((enumFromTo__d0 (a_5 + 1)) b_4) in
      (let rec h_1_9 = a_5 in
        (fun f_1_5 -> 
          (`LH_C((f_1_5 h_1_9), ((map__d4 f_1_5) t_2_0))))))
  else
    (fun f_1_6 -> 
      (`LH_N)))
    ...
    | _ -> 
      (let rec t_1_5 = ((groop__d0 _lh_groop_arg1_1) ((drop__d0 _lh_groop_arg1_1) _lh_groop_arg2_1)) in
        (let rec h_1_4 = ((take__d0 _lh_groop_arg1_1) _lh_groop_arg2_1) in
          (fun f_1_0 -> 
            (`LH_C((f_1_0 h_1_4), ((map__d0 f_1_0) t_1_5)))))))
and groop__d1 _lh_groop_arg1_0 _lh_groop_arg2_0 =
...
and map__d5 f_4_3 ls_1_5 =
  (match ls_1_5 with
    ...
    | `LH_N -> 
      (fun _lh_dummy_1_9 _lh_dummy_2_0 -> 
        0))
and mappend__d1_d7 xs_6 ys_6 =
  (match xs_6 with
    ...
    | `LH_N -> 
      ys_6)
and monthLengths__d0 _lh_monthLengths_arg1_0 =
...
and scanl__d0 _lh_scanl_arg1_0 _lh_scanl_arg2_0 _lh_scanl_arg3_0 =
...
and title__d0 _lh_title_arg1_0 =
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Calendar_nofib" (fun () -> ignore (let open Module_original in ((testCalendar_nofib__d0 100))));
  Bench.Test.create ~name:"lumberhack_Calendar_nofib" (fun () -> ignore (let open Module_lumberhack in ((testCalendar_nofib__d0 100))));
  Bench.Test.create ~name:"lumberhack_pop_out_Calendar_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testCalendar_nofib__d0 100))));
])

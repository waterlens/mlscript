...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_ZipMapBothUnzip" (fun () -> ignore (let open Module_original in ((testZipMapBothUnzip 50000))));
  Bench.Test.create ~name:"lumberhack_ZipMapBothUnzip" (fun () -> ignore (let open Module_lumberhack in ((testZipMapBothUnzip__d0 50000))));
  Bench.Test.create ~name:"lumberhack_pop_out_ZipMapBothUnzip" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testZipMapBothUnzip__d0 50000))));
])

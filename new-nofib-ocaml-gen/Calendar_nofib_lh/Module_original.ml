...
and concat_lh lss_0 =
  (match lss_0 with
    ...
    | `LH_N -> 
      (`LH_N))
and date_lh _lh_date_arg1_0 _lh_date_arg2_0 =
...
and dates_lh _lh_dates_arg1_0 _lh_dates_arg2_0 =
  ((map_lh (fun d_0 -> 
    ((date_lh _lh_dates_arg2_0) d_0))) ((enumFromTo_lh (1 - _lh_dates_arg1_0)) (42 - _lh_dates_arg1_0)))
and emptyPic_lh _lh_emptyPic_arg1_0 =
  (match _lh_emptyPic_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and end_lh _lh_end_arg1_0 =
  (emptyPic_lh (`LH_P2(1, 25)))
and entries_lh _lh_entries_arg1_0 _lh_entries_arg2_0 =
  ((block_lh 7) ((dates_lh _lh_entries_arg1_0) _lh_entries_arg2_0))
and firstDays_lh _lh_firstDays_arg1_0 =
...
and foldr1_lh _lh_foldr1_arg1_0 _lh_foldr1_arg2_0 =
  (match _lh_foldr1_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and groop_lh _lh_groop_arg1_0 _lh_groop_arg2_0 =
...
and monthLengths_lh _lh_monthLengths_arg1_0 =

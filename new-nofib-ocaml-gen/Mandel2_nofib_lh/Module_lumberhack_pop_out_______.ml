...
let rec right_lh__d2 _lh_equalp_LH_P2_0_1 _lh_equalp_LH_P2_1_1 =
...
let rec down_lh__d1 _lh_equalp_LH_P2_0_3 _lh_equalp_LH_P2_1_3 =
...
let rec left_lh__d2 _lh_equalp_LH_P2_0_5 _lh_equalp_LH_P2_1_5 =
  (let rec _lh_equalp_LH_P2_1_4 = 0 in
    (let rec _lh_equalp_LH_P2_0_4 = (0 - 1) in
...
let rec equalp_lh__d2 _lh_equalp_arg1_0 _lh_equalp_arg2_0 =
  (match _lh_equalp_arg1_0 with
    | `LH_P2(_lh_equalp_LH_P2_0_6, _lh_equalp_LH_P2_1_6) -> 
      ((_lh_equalp_arg2_0 _lh_equalp_LH_P2_0_6) _lh_equalp_LH_P2_1_6)
    | _ -> 
      (failwith "error"));;
let rec equalp_lh__d1 _lh_equalp_arg1_1 _lh_equalp_arg2_1 =
  (match _lh_equalp_arg1_1 with
    | `LH_P2(_lh_equalp_LH_P2_0_7, _lh_equalp_LH_P2_1_7) -> 
      ((_lh_equalp_arg2_1 _lh_equalp_LH_P2_0_7) _lh_equalp_LH_P2_1_7)
    | _ -> 
      (failwith "error"));;
...
let rec equalp_lh__d3 _lh_equalp_arg1_2 _lh_equalp_arg2_2 =
  (match _lh_equalp_arg1_2 with
    | `LH_P2(_lh_equalp_LH_P2_0_8, _lh_equalp_LH_P2_1_8) -> 
      ((_lh_equalp_arg2_2 _lh_equalp_LH_P2_0_8) _lh_equalp_LH_P2_1_8)
    | _ -> 
      (failwith "error"));;
let rec equalp_lh__d4 _lh_equalp_arg1_3 _lh_equalp_arg2_3 =
  (_lh_equalp_arg1_3 _lh_equalp_arg2_3);;
    ...
    | `LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_0) -> 
      (match _lh_check_perim_arg2_0 with
        | `LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_1) -> 
          (let rec col1_0 = (point_colour_lh__d2 (let rec _lh_point_colour_LH_P2_1_1 = _lh_check_perim_LH_P2_1_0 in
            (let rec _lh_point_colour_LH_P2_0_1 = _lh_check_perim_LH_P2_0_0 in
              (fun _lh_dummy_0 -> 
                (((((check_radius_lh__d2 (np_lh__d2 _lh_point_colour_LH_P2_0_1)) (nq_lh__d2 _lh_point_colour_LH_P2_1_1)) 0) 0.0) 0.0))))) in
            (let rec col2_0 = (point_colour_lh__d5 (let rec _lh_point_colour_LH_P2_1_2 = _lh_check_perim_LH_P2_1_0 in
              (let rec _lh_point_colour_LH_P2_0_2 = _lh_check_perim_LH_P2_0_1 in
                (fun _lh_dummy_1 -> 
                  (((((check_radius_lh__d5 (np_lh__d5 _lh_point_colour_LH_P2_0_2)) (nq_lh__d5 _lh_point_colour_LH_P2_1_2)) 0) 0.0) 0.0))))) in
              (let rec col3_0 = (point_colour_lh__d3 (let rec _lh_point_colour_LH_P2_1_3 = _lh_check_perim_LH_P2_1_1 in
                (let rec _lh_point_colour_LH_P2_0_3 = _lh_check_perim_LH_P2_0_1 in
                  (fun _lh_dummy_2 -> 
                    (((((check_radius_lh__d3 (np_lh__d3 _lh_point_colour_LH_P2_0_3)) (nq_lh__d3 _lh_point_colour_LH_P2_1_3)) 0) 0.0) 0.0))))) in
                (let rec col4_0 = (point_colour_lh__d1 (let rec _lh_point_colour_LH_P2_1_4 = _lh_check_perim_LH_P2_1_1 in
                  (let rec _lh_point_colour_LH_P2_0_4 = _lh_check_perim_LH_P2_0_0 in
                    (fun _lh_dummy_3 -> 
                      (((((check_radius_lh__d1 (np_lh__d1 _lh_point_colour_LH_P2_0_4)) (nq_lh__d1 _lh_point_colour_LH_P2_1_4)) 0) 0.0) 0.0))))) in
                  (let rec corners_diff_0 = (if (col1_0 = col2_0) then
                    ...
                    (let rec check_line_0 = (fun xcyc_0 xdyd_0 -> 
                            ...
                            (let rec _lh_matchIdent_3 = xdyd_0 in
                              (match _lh_matchIdent_3 with
                                | `LH_P2(_lh_check_perim_LH_P2_0_3, _lh_check_perim_LH_P2_1_3) -> 
                                  (let rec finished_0 = (if ((equalp_lh__d1 (`LH_P2(_lh_check_perim_LH_P2_0_3, _lh_check_perim_LH_P2_1_3))) right_lh__d2) then
                                    (_lh_check_perim_LH_P2_0_2 >= _lh_check_perim_LH_P2_0_1)
                                  else
                                    (if ((equalp_lh__d2 (`LH_P2(_lh_check_perim_LH_P2_0_3, _lh_check_perim_LH_P2_1_3))) down_lh__d1) then
                                      (_lh_check_perim_LH_P2_1_2 <= _lh_check_perim_LH_P2_1_1)
                                    else
                                      (if ((equalp_lh__d3 (`LH_P2(_lh_check_perim_LH_P2_0_3, _lh_check_perim_LH_P2_1_3))) left_lh__d2) then
                      ...
                      (let rec check_sides_0 = (if ((check_line_0 (`LH_P2((_lh_check_perim_LH_P2_0_0 + 1), _lh_check_perim_LH_P2_1_0))) right_lh__d1) then
                        ...
                        (0 - 1)) in
                        (if ((equalp_lh__d4 (let rec _lh_equalp_LH_P2_1_9 = _lh_check_perim_LH_P2_1_0 in
                          (let rec _lh_equalp_LH_P2_0_9 = _lh_check_perim_LH_P2_0_0 in
                            (fun _lh_equalp_arg2_4 -> 
                              ((_lh_equalp_arg2_4 _lh_equalp_LH_P2_0_9) _lh_equalp_LH_P2_1_9))))) (let rec _lh_equalp_LH_P2_1_1_0 = _lh_check_perim_LH_P2_1_1 in
                          (let rec _lh_equalp_LH_P2_0_1_0 = _lh_check_perim_LH_P2_0_1 in
                            (fun _lh_equalp_LH_P2_0_1_1 _lh_equalp_LH_P2_1_1_1 -> 
                              ((_lh_equalp_LH_P2_0_1_1 = _lh_equalp_LH_P2_0_1_0) && (_lh_equalp_LH_P2_1_1_1 = _lh_equalp_LH_P2_1_1_0)))))) then
                          (point_colour_lh__d6 (let rec _lh_point_colour_LH_P2_1_5 = _lh_check_perim_LH_P2_1_0 in
                            (let rec _lh_point_colour_LH_P2_0_5 = _lh_check_perim_LH_P2_0_0 in
                              (fun _lh_dummy_4 -> 
                                (((((check_radius_lh__d6 (np_lh__d6 _lh_point_colour_LH_P2_0_5)) (nq_lh__d6 _lh_point_colour_LH_P2_1_5)) 0) 0.0) 0.0)))))
                        else

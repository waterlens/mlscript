...
let rec enumFromTo__d0 a_8 b_5 =
  (if (a_8 <= b_5) then
    ...
    (`LH_N));;
let rec enumFromTo__d1 a_7 b_4 =
  (if (a_7 <= b_4) then
    (`LH_C(a_7, ((enumFromTo__d1 (a_7 + 1)) b_4)))
  else
    (`LH_N));;
...
let rec firstPiece__d2 _lh_firstPiece_arg1_2 =
  (match _lh_firstPiece_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec foldr__d0 f_1_3 i_3 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_3_6, t_3_8) -> 
      ((f_1_3 h_3_6) (((foldr__d0 f_1_3) i_3) t_3_8))
    | `LH_N -> 
      i_3);;
let rec foldr__d1 f_1_4 i_4 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_4_0, t_4_2) -> 
      ((f_1_4 h_4_0) (((foldr__d1 f_1_4) i_4) t_4_2))
    | `LH_N -> 
      i_4);;
...
let rec inquireFront__d0 _lh_inquireFront_arg1_1 =
  (match _lh_inquireFront_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec inquireFront__d1 _lh_inquireFront_arg1_3 =
  (match _lh_inquireFront_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec inquireFront__d2 _lh_inquireFront_arg1_2 =
  (match _lh_inquireFront_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec intChessSetComp__d0 _lh_intChessSetComp_arg1_2 _lh_intChessSetComp_arg2_2 =
...
let rec intintComp__d0 _lh_intintComp_arg1_1 _lh_intintComp_arg2_1 =
  (match _lh_intintComp_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec intintComp__d1 _lh_intintComp_arg1_2 _lh_intintComp_arg2_2 =
  (match _lh_intintComp_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lastPiece__d0 _lh_lastPiece_arg1_5 =
  (match _lh_lastPiece_arg1_5 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lastPiece__d1 _lh_lastPiece_arg1_2 =
...
let rec lastPiece__d2 _lh_lastPiece_arg1_7 =
  (match _lh_lastPiece_arg1_7 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lastPiece__d3 _lh_lastPiece_arg1_1 =
  (match _lh_lastPiece_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lastPiece__d4 _lh_lastPiece_arg1_4 =
  (match _lh_lastPiece_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lastPiece__d5 _lh_lastPiece_arg1_3 =
...
let rec length__d4 ls_2_3 =
  (match ls_2_3 with
    ...
    | `LH_N -> 
      0);;
let rec length__d5 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_2_3, t_2_5) -> 
      (1 + (length__d5 t_2_5))
    | `LH_N -> 
      0);;
let rec map__d0 f_1_7 ls_2_9 =
  (match ls_2_9 with
    | `LH_C(h_4_6, t_4_8) -> 
      (`LH_C((f_1_7 h_4_6), ((map__d0 f_1_7) t_4_8)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d1 f_1_8 ls_3_1 =
  (match ls_3_1 with
    | `LH_C(h_5_0, t_5_2) -> 
      (`LH_C((f_1_8 h_5_0), ((map__d1 f_1_8) t_5_2)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d2 f_1_6 ls_2_8 =
  (match ls_2_8 with
    | `LH_C(h_4_3, t_4_5) -> 
      (`LH_C((f_1_6 h_4_3), ((map__d2 f_1_6) t_4_5)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d3 f_1_2 ls_2_1 =
  (match ls_2_1 with
    | `LH_C(h_2_6, t_2_8) -> 
      (`LH_C((f_1_2 h_2_6), ((map__d3 f_1_2) t_2_8)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend__d0 xs_1_6 ys_1_6 =
  (match xs_1_6 with
    | `LH_C(h_3_2, t_3_4) -> 
      (`LH_C(h_3_2, ((mappend__d0 t_3_4) ys_1_6)))
    | `LH_N -> 
      ys_1_6);;
let rec mappend__d1 xs_1_7 ys_1_7 =
  (match xs_1_7 with
    | `LH_C(h_3_3, t_3_5) -> 
      (`LH_C(h_3_3, ((mappend__d1 t_3_5) ys_1_7)))
    | `LH_N -> 
      ys_1_7);;
let rec mappend__d1_d0 xs_2_9 ys_2_9 =
  (match xs_2_9 with
    | `LH_C(h_4_8, t_5_0) -> 
      (`LH_C(h_4_8, ((mappend__d1_d0 t_5_0) ys_2_9)))
    | `LH_N -> 
      ys_2_9);;
let rec mappend__d1_d1 xs_2_2 ys_2_2 =
  (match xs_2_2 with
    | `LH_C(h_3_9, t_4_1) -> 
      (`LH_C(h_3_9, ((mappend__d1_d1 t_4_1) ys_2_2)))
    | `LH_N -> 
      ys_2_2);;
let rec mappend__d1_d2 xs_2_0 ys_2_0 =
  (match xs_2_0 with
    | `LH_C(h_3_8, t_4_0) -> 
      (`LH_C(h_3_8, ((mappend__d1_d2 t_4_0) ys_2_0)))
    | `LH_N -> 
      ys_2_0);;
let rec mappend__d1_d3 xs_2_3 ys_2_3 =
  (match xs_2_3 with
    | `LH_C(h_4_1, t_4_3) -> 
      (`LH_C(h_4_1, ((mappend__d1_d3 t_4_3) ys_2_3)))
    | `LH_N -> 
      ys_2_3);;
let rec mappend__d1_d4 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    | `LH_C(h_2_1, t_2_3) -> 
      (`LH_C(h_2_1, ((mappend__d1_d4 t_2_3) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec mappend__d1_d5 xs_1_4 ys_1_4 =
  (match xs_1_4 with
    | `LH_C(h_2_8, t_3_0) -> 
      (`LH_C(h_2_8, ((mappend__d1_d5 t_3_0) ys_1_4)))
    | `LH_N -> 
      ys_1_4);;
let rec mappend__d1_d6 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_2_0, t_2_2) -> 
      (`LH_C(h_2_0, ((mappend__d1_d6 t_2_2) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend__d1_d7 xs_3_0 ys_3_0 =
  (match xs_3_0 with
    | `LH_C(h_5_1, t_5_3) -> 
      (`LH_C(h_5_1, ((mappend__d1_d7 t_5_3) ys_3_0)))
    | `LH_N -> 
      ys_3_0);;
let rec mappend__d1_d8 xs_2_6 ys_2_6 =
  (match xs_2_6 with
    | `LH_C(h_4_4, t_4_6) -> 
      (`LH_C(h_4_4, ((mappend__d1_d8 t_4_6) ys_2_6)))
    | `LH_N -> 
      ys_2_6);;
let rec mappend__d1_d9 xs_1_9 ys_1_9 =
  (match xs_1_9 with
    | `LH_C(h_3_7, t_3_9) -> 
      (`LH_C(h_3_7, ((mappend__d1_d9 t_3_9) ys_1_9)))
    | `LH_N -> 
      ys_1_9);;
let rec mappend__d2 xs_3_1 ys_3_1 =
  (match xs_3_1 with
    | `LH_C(h_5_2, t_5_4) -> 
      (`LH_C(h_5_2, ((mappend__d2 t_5_4) ys_3_1)))
    | `LH_N -> 
      ys_3_1);;
let rec mappend__d3 xs_2_8 ys_2_8 =
  (match xs_2_8 with
    | `LH_C(h_4_7, t_4_9) -> 
      (`LH_C(h_4_7, ((mappend__d3 t_4_9) ys_2_8)))
    | `LH_N -> 
      ys_2_8);;
let rec mappend__d4 xs_1_2 ys_1_2 =
  (match xs_1_2 with
    | `LH_C(h_2_2, t_2_4) -> 
      (`LH_C(h_2_2, ((mappend__d4 t_2_4) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
let rec mappend__d5 xs_2_4 ys_2_4 =
  (match xs_2_4 with
    | `LH_C(h_4_2, t_4_4) -> 
      (`LH_C(h_4_2, ((mappend__d5 t_4_4) ys_2_4)))
    | `LH_N -> 
      ys_2_4);;
let rec mappend__d6 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_2_4, t_2_6) -> 
      (`LH_C(h_2_4, ((mappend__d6 t_2_6) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend__d7 xs_2_7 ys_2_7 =
  (match xs_2_7 with
    | `LH_C(h_4_5, t_4_7) -> 
      (`LH_C(h_4_5, ((mappend__d7 t_4_7) ys_2_7)))
    | `LH_N -> 
      ys_2_7);;
let rec mappend__d8 xs_1_5 ys_1_5 =
  (match xs_1_5 with
    | `LH_C(h_3_1, t_3_3) -> 
      (`LH_C(h_3_1, ((mappend__d8 t_3_3) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
let rec mappend__d9 xs_1_8 ys_1_8 =
  (match xs_1_8 with
    | `LH_C(h_3_5, t_3_7) -> 
      (`LH_C(h_3_5, ((mappend__d9 t_3_7) ys_1_8)))
    | `LH_N -> 
      ys_1_8);;
let rec move__d0 _lh_move_arg1_5 _lh_move_arg2_5 =
...
let rec move__d1 _lh_move_arg1_1 _lh_move_arg2_1 =
  (match _lh_move_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec move__d2 _lh_move_arg1_2 _lh_move_arg2_2 =
  (match _lh_move_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec move__d3 _lh_move_arg1_7 _lh_move_arg2_7 =
  (match _lh_move_arg1_7 with
    ...
    | _ -> 
      (failwith "error"));;
let rec move__d4 _lh_move_arg1_3 _lh_move_arg2_3 =
  (match _lh_move_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec move__d5 _lh_move_arg1_4 _lh_move_arg2_4 =
  (match _lh_move_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec move__d6 _lh_move_arg1_6 _lh_move_arg2_6 =
...
let rec myInit__d0 _lh_myInit_arg1_4 =
  (match _lh_myInit_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec myInit__d1 _lh_myInit_arg1_3 =
    ...
    | `LH_C(_lh_myInit_LH_C_0_3, _lh_myInit_LH_C_1_3) -> 
      (match _lh_myInit_LH_C_1_3 with
        | `LH_N -> 
          (`LH_N)
        | _ -> 
          (`LH_C(_lh_myInit_LH_C_0_3, (myInit__d1 _lh_myInit_LH_C_1_3))))
    | _ -> 
      (failwith "error"));;
let rec myInit__d2 _lh_myInit_arg1_2 =
    ...
    | `LH_C(_lh_myInit_LH_C_0_2, _lh_myInit_LH_C_1_2) -> 
      (match _lh_myInit_LH_C_1_2 with
        | `LH_N -> 
          (`LH_N)
        | _ -> 
          (`LH_C(_lh_myInit_LH_C_0_2, (myInit__d2 _lh_myInit_LH_C_1_2))))
    | _ -> 
      (failwith "error"));;
...
let rec myIsDigit__d0 _lh_myIsDigit_arg1_1 =
  (let rec n_5 = (int_of_char _lh_myIsDigit_arg1_1) in
    ((n_5 >= 48) && (n_5 <= 57)));;
let rec myLast__d0 _lh_myLast_arg1_4 =
...
let rec myLast__d2 _lh_myLast_arg1_2 =
  (match _lh_myLast_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec myLast__d3 _lh_myLast_arg1_1 =
...
let rec removeFront__d1 _lh_removeFront_arg1_1 =
  (match _lh_removeFront_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec repeat__d0 x_2 =
  (lazy (`LH_C(x_2, (repeat__d0 x_2))));;
let rec repeat__d1 x_3 =
  (lazy (`LH_C(x_3, (repeat__d1 x_3))));;
let rec sizeBoard__d0 _lh_sizeBoard_arg1_6 =
  (match _lh_sizeBoard_arg1_6 with
    ...
    | _ -> 
      (failwith "error"));;
let rec sizeBoard__d1 _lh_sizeBoard_arg1_1 =
  (match _lh_sizeBoard_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec sizeBoard__d2 _lh_sizeBoard_arg1_3 =
  (match _lh_sizeBoard_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec sizeBoard__d3 _lh_sizeBoard_arg1_4 =
  (match _lh_sizeBoard_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec sizeBoard__d4 _lh_sizeBoard_arg1_7 =
...
let rec sizeBoard__d5 _lh_sizeBoard_arg1_5 =
  (match _lh_sizeBoard_arg1_5 with
    ...
    | _ -> 
      (failwith "error"));;
let rec sizeBoard__d6 _lh_sizeBoard_arg1_8 =
  (match _lh_sizeBoard_arg1_8 with
    ...
    | _ -> 
      (failwith "error"));;
let rec sizeBoard__d7 _lh_sizeBoard_arg1_2 =
  (match _lh_sizeBoard_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec take_lz__d0 n_6 ls_2_4 =
  (if (n_6 > 0) then
    (match (Lazy.force ls_2_4) with
      | `LH_C(h_3_0, t_3_2) -> 
        (`LH_C(h_3_0, ((take_lz__d0 (n_6 - 1)) t_3_2)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
let rec zipWith__d0 f_1_5 xs_2_5 ys_2_5 =
  (match xs_2_5 with
    | `LH_C(hx_1_0, tx_1_0) -> 
      (match ys_2_5 with
        | `LH_C(hy_1_0, ty_1_0) -> 
          (`LH_C(((f_1_5 hx_1_0) hy_1_0), (((zipWith__d0 f_1_5) tx_1_0) ty_1_0)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec zip_lz_nl__d0 xs_2_1 ys_2_1 =
  (match ys_2_1 with
    | `LH_C(hy_9, ty_9) -> 
      (match (Lazy.force xs_2_1) with
        | `LH_C(hx_9, tx_9) -> 
          (`LH_C((`LH_P2(hx_9, hy_9)), ((zip_lz_nl__d0 tx_9) ty_9)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec zip_lz_nl__d1 xs_1_0 ys_1_0 =
  (match ys_1_0 with
    | `LH_C(hy_8, ty_8) -> 
      (match (Lazy.force xs_1_0) with
        | `LH_C(hx_8, tx_8) -> 
          (`LH_C((`LH_P2(hx_8, hy_8)), ((zip_lz_nl__d1 tx_8) ty_8)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec addAllFront__d0 _lh_addAllFront_arg1_1 _lh_addAllFront_arg2_1 =
  ((mappend__d0 _lh_addAllFront_arg1_1) _lh_addAllFront_arg2_1)
and addAllFront__d1 _lh_addAllFront_arg1_2 _lh_addAllFront_arg2_2 =
  ((mappend__d7 _lh_addAllFront_arg1_2) _lh_addAllFront_arg2_2)
...
and canMoveTo__d0 _lh_canMoveTo_arg1_5 _lh_canMoveTo_arg2_5 =
  (match _lh_canMoveTo_arg1_5 with
    | `LH_P2(_lh_canMoveTo_LH_P2_0_5, _lh_canMoveTo_LH_P2_1_5) -> 
      (let rec sze_6 = (sizeBoard__d0 _lh_canMoveTo_arg2_5) in
        (((((_lh_canMoveTo_LH_P2_0_5 >= 1) && (_lh_canMoveTo_LH_P2_0_5 <= sze_6)) && (_lh_canMoveTo_LH_P2_1_5 >= 1)) && (_lh_canMoveTo_LH_P2_1_5 <= sze_6)) && ((isSquareFree__d0 (`LH_P2(_lh_canMoveTo_LH_P2_0_5, _lh_canMoveTo_LH_P2_1_5))) _lh_canMoveTo_arg2_5)))
    | _ -> 
      (failwith "error"))
and canMoveTo__d1 _lh_canMoveTo_arg1_2 _lh_canMoveTo_arg2_2 =
  (match _lh_canMoveTo_arg1_2 with
    ...
    | _ -> 
      (failwith "error"))
and canMoveTo__d2 _lh_canMoveTo_arg1_4 _lh_canMoveTo_arg2_4 =
  (match _lh_canMoveTo_arg1_4 with
    | `LH_P2(_lh_canMoveTo_LH_P2_0_4, _lh_canMoveTo_LH_P2_1_4) -> 
      (let rec sze_5 = (sizeBoard__d2 _lh_canMoveTo_arg2_4) in
        (((((_lh_canMoveTo_LH_P2_0_4 >= 1) && (_lh_canMoveTo_LH_P2_0_4 <= sze_5)) && (_lh_canMoveTo_LH_P2_1_4 >= 1)) && (_lh_canMoveTo_LH_P2_1_4 <= sze_5)) && ((isSquareFree__d2 (`LH_P2(_lh_canMoveTo_LH_P2_0_4, _lh_canMoveTo_LH_P2_1_4))) _lh_canMoveTo_arg2_4)))
    | _ -> 
      (failwith "error"))
and canMoveTo__d3 _lh_canMoveTo_arg1_3 _lh_canMoveTo_arg2_3 =
  (match _lh_canMoveTo_arg1_3 with
    | `LH_P2(_lh_canMoveTo_LH_P2_0_3, _lh_canMoveTo_LH_P2_1_3) -> 
      (let rec sze_4 = (sizeBoard__d3 _lh_canMoveTo_arg2_3) in
        (((((_lh_canMoveTo_LH_P2_0_3 >= 1) && (_lh_canMoveTo_LH_P2_0_3 <= sze_4)) && (_lh_canMoveTo_LH_P2_1_3 >= 1)) && (_lh_canMoveTo_LH_P2_1_3 <= sze_4)) && ((isSquareFree__d3 (`LH_P2(_lh_canMoveTo_LH_P2_0_3, _lh_canMoveTo_LH_P2_1_3))) _lh_canMoveTo_arg2_3)))
    | _ -> 
      (failwith "error"))
and canMoveTo__d4 _lh_canMoveTo_arg1_1 _lh_canMoveTo_arg2_1 =
  (match _lh_canMoveTo_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and canMoveTo__d5 _lh_canMoveTo_arg1_6 _lh_canMoveTo_arg2_6 =
  (match _lh_canMoveTo_arg1_6 with
    | `LH_P2(_lh_canMoveTo_LH_P2_0_6, _lh_canMoveTo_LH_P2_1_6) -> 
      (let rec sze_7 = (sizeBoard__d5 _lh_canMoveTo_arg2_6) in
        (((((_lh_canMoveTo_LH_P2_0_6 >= 1) && (_lh_canMoveTo_LH_P2_0_6 <= sze_7)) && (_lh_canMoveTo_LH_P2_1_6 >= 1)) && (_lh_canMoveTo_LH_P2_1_6 <= sze_7)) && ((isSquareFree__d5 (`LH_P2(_lh_canMoveTo_LH_P2_0_6, _lh_canMoveTo_LH_P2_1_6))) _lh_canMoveTo_arg2_6)))
    | _ -> 
      (failwith "error"))
and canMoveTo__d6 _lh_canMoveTo_arg1_7 _lh_canMoveTo_arg2_7 =
  (match _lh_canMoveTo_arg1_7 with
    | `LH_P2(_lh_canMoveTo_LH_P2_0_7, _lh_canMoveTo_LH_P2_1_7) -> 
      (let rec sze_8 = (sizeBoard__d6 _lh_canMoveTo_arg2_7) in
        (((((_lh_canMoveTo_LH_P2_0_7 >= 1) && (_lh_canMoveTo_LH_P2_0_7 <= sze_8)) && (_lh_canMoveTo_LH_P2_1_7 >= 1)) && (_lh_canMoveTo_LH_P2_1_7 <= sze_8)) && ((isSquareFree__d6 (`LH_P2(_lh_canMoveTo_LH_P2_0_7, _lh_canMoveTo_LH_P2_1_7))) _lh_canMoveTo_arg2_7)))
    | _ -> 
      (failwith "error"))
...
and canMove__d1 _lh_canMove_arg1_3 _lh_canMove_arg2_3 =
  ((canMoveTo__d2 ((move__d2 _lh_canMove_arg2_3) (lastPiece__d2 _lh_canMove_arg1_3))) _lh_canMove_arg1_3)
...
and canMove__d3 _lh_canMove_arg1_4 _lh_canMove_arg2_4 =
  ((canMoveTo__d4 ((move__d5 _lh_canMove_arg2_4) (lastPiece__d5 _lh_canMove_arg1_4))) _lh_canMove_arg1_4)
and canMove__d4 _lh_canMove_arg1_5 _lh_canMove_arg2_5 =
  ((canMoveTo__d5 ((move__d6 _lh_canMove_arg2_5) (lastPiece__d6 _lh_canMove_arg1_5))) _lh_canMove_arg1_5)
...
and deleteFirst__d0 _lh_deleteFirst_arg1_2 =
  (match _lh_deleteFirst_arg1_2 with
    ...
    | _ -> 
      (failwith "error"))
and deleteFirst__d1 _lh_deleteFirst_arg1_1 =
  (match _lh_deleteFirst_arg1_1 with
    | `Board(_lh_deleteFirst_Board_0_1, _lh_deleteFirst_Board_1_1, _lh_deleteFirst_Board_2_1, _lh_deleteFirst_Board_3_1) -> 
      (let rec ts'_1 = (myInit__d1 _lh_deleteFirst_Board_3_1) in
        (`Board(_lh_deleteFirst_Board_0_1, (_lh_deleteFirst_Board_1_1 - 1), (myLast__d1 ts'_1), ts'_1)))
    | _ -> 
      (failwith "error"))
and deleteFirst__d2 _lh_deleteFirst_arg1_4 =
  (match _lh_deleteFirst_arg1_4 with
    | `Board(_lh_deleteFirst_Board_0_4, _lh_deleteFirst_Board_1_4, _lh_deleteFirst_Board_2_4, _lh_deleteFirst_Board_3_4) -> 
      (let rec ts'_4 = (myInit__d2 _lh_deleteFirst_Board_3_4) in
        (`Board(_lh_deleteFirst_Board_0_4, (_lh_deleteFirst_Board_1_4 - 1), (myLast__d2 ts'_4), ts'_4)))
    | _ -> 
      (failwith "error"))
and deleteFirst__d3 _lh_deleteFirst_arg1_3 =
  (match _lh_deleteFirst_arg1_3 with
    | `Board(_lh_deleteFirst_Board_0_3, _lh_deleteFirst_Board_1_3, _lh_deleteFirst_Board_2_3, _lh_deleteFirst_Board_3_3) -> 
      (let rec ts'_3 = (myInit__d3 _lh_deleteFirst_Board_3_3) in
        (`Board(_lh_deleteFirst_Board_0_3, (_lh_deleteFirst_Board_1_3 - 1), (myLast__d3 ts'_3), ts'_3)))
    | _ -> 
      (failwith "error"))
and depthSearch__d0 _lh_depthSearch_arg1_1 _lh_depthSearch_arg2_1 _lh_depthSearch_arg3_1 =
  (if (let rec _lh_matchIdent_2 = _lh_depthSearch_arg1_1 in
  ...
  (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_9 -> 
    (match _lh_listcomp_fun_para_9 with
      | `LH_C(_lh_listcomp_fun_ls_h_9, _lh_listcomp_fun_ls_t_9) -> 
        (`LH_C((`LH_P2((length__d3 (possibleMoves__d2 (deleteFirst__d1 _lh_listcomp_fun_ls_h_9))), _lh_listcomp_fun_ls_h_9)), (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9)))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_9 (allDescend__d0 _lh_descAndNo_arg1_1)))
...
and isSquareFree__d1 _lh_isSquareFree_arg1_6 _lh_isSquareFree_arg2_6 =
  (match _lh_isSquareFree_arg2_6 with
    ...
    | _ -> 
      (failwith "error"))
and isSquareFree__d2 _lh_isSquareFree_arg1_3 _lh_isSquareFree_arg2_3 =
  (match _lh_isSquareFree_arg2_3 with
    | `Board(_lh_isSquareFree_Board_0_3, _lh_isSquareFree_Board_1_3, _lh_isSquareFree_Board_2_3, _lh_isSquareFree_Board_3_3) -> 
      (not ((inList__d2 _lh_isSquareFree_arg1_3) _lh_isSquareFree_Board_3_3))
    | _ -> 
      (failwith "error"))
...
and isSquareFree__d6 _lh_isSquareFree_arg1_2 _lh_isSquareFree_arg2_2 =
  (match _lh_isSquareFree_arg2_2 with
    ...
    | _ -> 
      (failwith "error"))
and moveKnight__d0 _lh_moveKnight_arg1_1 _lh_moveKnight_arg2_1 =
  ((addPiece__d1 ((move__d1 _lh_moveKnight_arg2_1) (lastPiece__d1 _lh_moveKnight_arg1_1))) _lh_moveKnight_arg1_1)
and moveKnight__d1 _lh_moveKnight_arg1_2 _lh_moveKnight_arg2_2 =
  ((addPiece__d2 ((move__d4 _lh_moveKnight_arg2_2) (lastPiece__d4 _lh_moveKnight_arg1_2))) _lh_moveKnight_arg1_2)
and possibleMoves__d0 _lh_possibleMoves_arg1_1 =
  (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_1_0 -> 
    (match _lh_listcomp_fun_para_1_0 with
      | `LH_C(_lh_listcomp_fun_ls_h_1_0, _lh_listcomp_fun_ls_t_1_0) -> 
        (if ((canMove__d0 _lh_possibleMoves_arg1_1) _lh_listcomp_fun_ls_h_1_0) then
      ...
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_0 (`LH_C((`UL), (`LH_C((`UR), (`LH_C((`DL), (`LH_C((`DR), (`LH_C((`LU), (`LH_C((`LD), (`LH_C((`RU), (`LH_C((`RD), (`LH_N)))))))))))))))))))
and possibleMoves__d1 _lh_possibleMoves_arg1_3 =
  (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_1_2 -> 
    (match _lh_listcomp_fun_para_1_2 with
      | `LH_C(_lh_listcomp_fun_ls_h_1_2, _lh_listcomp_fun_ls_t_1_2) -> 
        (if ((canMove__d1 _lh_possibleMoves_arg1_3) _lh_listcomp_fun_ls_h_1_2) then
      ...
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_2 (`LH_C((`UL), (`LH_C((`UR), (`LH_C((`DL), (`LH_C((`DR), (`LH_C((`LU), (`LH_C((`LD), (`LH_C((`RU), (`LH_C((`RD), (`LH_N)))))))))))))))))))
and possibleMoves__d2 _lh_possibleMoves_arg1_4 =
  (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_1_3 -> 
    (match _lh_listcomp_fun_para_1_3 with
      | `LH_C(_lh_listcomp_fun_ls_h_1_3, _lh_listcomp_fun_ls_t_1_3) -> 
        (if ((canMove__d2 _lh_possibleMoves_arg1_4) _lh_listcomp_fun_ls_h_1_3) then
...
and possibleMoves__d3 _lh_possibleMoves_arg1_5 =
  (let rec _lh_listcomp_fun_2_1 = (fun _lh_listcomp_fun_para_2_1 -> 
    (match _lh_listcomp_fun_para_2_1 with
      | `LH_C(_lh_listcomp_fun_ls_h_2_1, _lh_listcomp_fun_ls_t_2_1) -> 
        (if ((canMove__d3 _lh_possibleMoves_arg1_5) _lh_listcomp_fun_ls_h_2_1) then
...
and possibleMoves__d4 _lh_possibleMoves_arg1_2 =
  (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_1_1 -> 
    (match _lh_listcomp_fun_para_1_1 with
      | `LH_C(_lh_listcomp_fun_ls_h_1_1, _lh_listcomp_fun_ls_t_1_1) -> 
        (if ((canMove__d4 _lh_possibleMoves_arg1_2) _lh_listcomp_fun_ls_h_1_1) then
...
and printTour__d0 _lh_printTour_arg1_1 =
  ...
  and pp_1 = (fun _lh_pp_arg1_1 -> 
    (match _lh_pp_arg1_1 with
      ...
      | _ -> 
        (failwith "error")))
  in (let rec _lh_matchIdent_3 = ((map__d3 (strToInt_1 0)) _lh_printTour_arg1_1) in
...
and quickSortIntChessSet__d0 _lh_quickSortIntChessSet_arg1_1 =
  (match _lh_quickSortIntChessSet_arg1_1 with
    ...
    | `LH_C(_lh_quickSortIntChessSet_LH_C_0_1, _lh_quickSortIntChessSet_LH_C_1_1) -> 
      ((mappend__d1 ((mappend__d2 (quickSortIntChessSet__d0 (let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_1_6 -> 
        (match _lh_listcomp_fun_para_1_6 with
          | `LH_C(_lh_listcomp_fun_ls_h_1_6, _lh_listcomp_fun_ls_t_1_6) -> 
            (if ((intChessSetComp__d0 _lh_listcomp_fun_ls_h_1_6) _lh_quickSortIntChessSet_LH_C_0_1) then
              (`LH_C(_lh_listcomp_fun_ls_h_1_6, (_lh_listcomp_fun_1_6 _lh_listcomp_fun_ls_t_1_6)))
            else
              (_lh_listcomp_fun_1_6 _lh_listcomp_fun_ls_t_1_6))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_6 _lh_quickSortIntChessSet_LH_C_1_1)))) (`LH_C(_lh_quickSortIntChessSet_LH_C_0_1, (`LH_N))))) (quickSortIntChessSet__d0 (let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_1_7 -> 
        (match _lh_listcomp_fun_para_1_7 with
          | `LH_C(_lh_listcomp_fun_ls_h_1_7, _lh_listcomp_fun_ls_t_1_7) -> 
            (if (not ((intChessSetComp__d1 _lh_listcomp_fun_ls_h_1_7) _lh_quickSortIntChessSet_LH_C_0_1)) then
          ...
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_7 _lh_quickSortIntChessSet_LH_C_1_1))))
    | _ -> 
      (failwith "error"))
and quickSortIntInt__d0 _lh_quickSortIntInt_arg1_1 =
  (match _lh_quickSortIntInt_arg1_1 with
    ...
    | `LH_C(_lh_quickSortIntInt_LH_C_0_1, _lh_quickSortIntInt_LH_C_1_1) -> 
      ((mappend__d1_d8 ((mappend__d1_d9 (quickSortIntInt__d0 (let rec _lh_listcomp_fun_1_9 = (fun _lh_listcomp_fun_para_1_9 -> 
        (match _lh_listcomp_fun_para_1_9 with
          | `LH_C(_lh_listcomp_fun_ls_h_1_9, _lh_listcomp_fun_ls_t_1_9) -> 
            (if ((intintComp__d1 _lh_listcomp_fun_ls_h_1_9) _lh_quickSortIntInt_LH_C_0_1) then
          ...
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_1_9 _lh_quickSortIntInt_LH_C_1_1)))) (`LH_C(_lh_quickSortIntInt_LH_C_0_1, (`LH_N))))) (quickSortIntInt__d0 (let rec _lh_listcomp_fun_2_0 = (fun _lh_listcomp_fun_para_2_0 -> 
        (match _lh_listcomp_fun_para_2_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_2_0, _lh_listcomp_fun_ls_t_2_0) -> 
            (if (not ((intintComp__d0 _lh_listcomp_fun_ls_h_2_0) _lh_quickSortIntInt_LH_C_0_1)) then
          ...
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_2_0 _lh_quickSortIntInt_LH_C_1_1))))
    | _ -> 
      (failwith "error"))
and root__d0 _lh_root_arg1_1 =
  ((addAllFront__d1 ((zip_lz_nl__d1 (repeat__d1 (1 - (_lh_root_arg1_1 * _lh_root_arg1_1)))) (((zipWith__d0 startTour__d0) (let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_1_4 -> 
        ...
        (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_1_5 -> 
          (match _lh_listcomp_fun_para_1_5 with
            | `LH_C(_lh_listcomp_fun_ls_h_1_5, _lh_listcomp_fun_ls_t_1_5) -> 
              (`LH_C((`LH_P2(_lh_listcomp_fun_ls_h_1_4, _lh_listcomp_fun_ls_h_1_5)), (_lh_listcomp_fun_1_5 _lh_listcomp_fun_ls_t_1_5)))
            | `LH_N -> 
              (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_4))) in
          (_lh_listcomp_fun_1_5 ((enumFromTo__d1 1) _lh_root_arg1_1)))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_4 ((enumFromTo__d0 1) _lh_root_arg1_1)))) ((copy__d0 (_lh_root_arg1_1 * _lh_root_arg1_1)) _lh_root_arg1_1)))) createQueue__d0)
...
and singleDescend__d0 _lh_singleDescend_arg1_1 =
  (let rec _lh_listcomp_fun_1_8 = (fun _lh_listcomp_fun_para_1_8 -> 
    (match _lh_listcomp_fun_para_1_8 with
        ...
        (match _lh_listcomp_fun_ls_h_1_8 with
          | `LH_P2(_lh_singleDescend_LH_P2_0_1, _lh_singleDescend_LH_P2_1_1) -> 
            (if (_lh_singleDescend_LH_P2_0_1 = 1) then
              (`LH_C(_lh_singleDescend_LH_P2_1_1, (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_1_8)))
            else
      ...
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_1_8 (descAndNo__d1 _lh_singleDescend_arg1_1)))
...
and spaces__d1 _lh_spaces_arg1_1 _lh_spaces_arg2_1 =
  (let rec logTen_1 = (fun _lh_logTen_arg1_1 -> 
    ...
    ((copy__d2 (((logTen_1 _lh_spaces_arg1_1) - (logTen_1 _lh_spaces_arg2_1)) + 1)) ' '))
and spaces__d2 _lh_spaces_arg1_3 _lh_spaces_arg2_3 =
  (let rec logTen_3 = (fun _lh_logTen_arg1_3 -> 
    ...
    ((copy__d3 (((logTen_3 _lh_spaces_arg1_3) - (logTen_3 _lh_spaces_arg2_3)) + 1)) ' '))
...
and tourFinished__d0 _lh_tourFinished_arg1_1 =
  (let rec sze_9 = (sizeBoard__d7 _lh_tourFinished_arg1_1) in
    (((noPieces__d0 _lh_tourFinished_arg1_1) = (sze_9 * sze_9)) && (canJumpFirst__d1 _lh_tourFinished_arg1_1)));;
end;;

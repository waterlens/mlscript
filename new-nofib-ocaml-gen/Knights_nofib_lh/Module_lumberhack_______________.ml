...
let rec foldr_lh__d1 f_2 i_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_7_2, t_1_1_9) -> 
      ((f_2 h_7_2) (((foldr_lh__d1 f_2) i_0) t_1_1_9))
    | `LH_N -> 
      i_0);;
let rec foldr_lh__d2 f_3 i_1 ls_2 =
  (match ls_2 with
    | `LH_C(h_7_3, t_1_2_0) -> 
      ((f_3 h_7_3) (((foldr_lh__d2 f_3) i_1) t_1_2_0))
    | `LH_N -> 
      i_1);;
  ...
  (match _lh_quickSortIntInt_arg1_0 with
    ...
    | `LH_C(_lh_quickSortIntInt_LH_C_0_0, _lh_quickSortIntInt_LH_C_1_0) -> 
      ((mappend_lh__d1_d7 ((mappend_lh__d1_d6 (quickSortIntInt_lh__d1 (let rec _lh_listcomp_fun_3_7 = (fun _lh_listcomp_fun_para_4 -> 
        ...
        ys_8_4) in
        (let rec h_7_4 = _lh_quickSortIntInt_LH_C_0_0 in
          (fun ys_8_5 -> 
            (`LH_C(h_7_4, ((mappend_lh__d1_d7 t_1_2_1) ys_8_5)))))))) (quickSortIntInt_lh__d1 (let rec _lh_listcomp_fun_3_8 = (fun _lh_listcomp_fun_para_5 -> 
  ...
  (if (_lh_copy_arg1_0 <= 0) then
    ...
    (let rec t_2_6 = ((copy_lh__d4 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec h_2 = _lh_copy_arg2_0 in
        (fun ys_5 -> 
          (let rec t_2_7 = ((mappend_lh__d6 t_2_6) ys_5) in
            (let rec h_3 = h_2 in
              (fun ys_6 -> 
...
let rec copy_lh__d3 _lh_copy_arg1_3 _lh_copy_arg2_3 =
  (if (_lh_copy_arg1_3 <= 0) then
    ...
    (let rec t_1_4_4 = ((copy_lh__d3 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
      (let rec h_9_5 = _lh_copy_arg2_3 in
        (fun ys_1_0_5 -> 
          (let rec t_1_4_5 = ((mappend_lh__d7 t_1_4_4) ys_1_0_5) in
...
let rec copy_lh__d2 _lh_copy_arg1_2 _lh_copy_arg2_2 =
  (if (_lh_copy_arg1_2 <= 0) then
    ...
    (let rec t_1_4_0 = ((copy_lh__d2 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec h_9_2 = _lh_copy_arg2_2 in
        (fun ys_1_0_2 -> 
          (let rec t_1_4_1 = ((mappend_lh__d1_d2 t_1_4_0) ys_1_0_2) in
  ...
  (if (let rec _lh_matchIdent_0 = _lh_depthSearch_arg1_0 in
    ...
    (if (_lh_depthSearch_arg3_0 (inquireFront_lh__d2 _lh_depthSearch_arg1_0)) then
      (lazy (let rec t_3_8 = (((depthSearch_lh__d1 (removeFront_lh__d2 _lh_depthSearch_arg1_0)) _lh_depthSearch_arg2_0) _lh_depthSearch_arg3_0) in
        (let rec h_1_1 = (inquireFront_lh__d1 _lh_depthSearch_arg1_0) in
          (fun n_2 -> 
            (let rec _lh_pp_LH_C_1_0 = ((take_lz_lh__d1 (n_2 - 1)) t_3_8) in
              (let rec _lh_pp_LH_C_0_0 = h_1_1 in
                (fun pp_1 -> 
                  (match _lh_pp_LH_C_0_0 with
                    | `LH_P2(_lh_pp_LH_P2_0_0, _lh_pp_LH_P2_1_0) -> 
                      ((mappend_lh__d4 ((mappend_lh__d2 ((mappend_lh__d1 ((mappend_lh__d3 (let rec t_3_9 = (let rec t_4_0 = (let rec t_4_1 = (let rec t_4_2 = (let rec t_4_3 = (let rec t_4_4 = (let rec t_4_5 = (let rec t_4_6 = (let rec t_4_7 = (let rec t_4_8 = (let rec t_4_9 = (let rec t_5_0 = (let rec t_5_1 = (let rec t_5_2 = (let rec t_5_3 = (let rec t_5_4 = (let rec t_5_5 = (let rec t_5_6 = (let rec t_5_7 = (fun ys_1_5 -> 
                        ...
                        (let rec h_1_2 = ' ' in
                          (fun ys_1_6 -> 
                            (`LH_C(h_1_2, ((mappend_lh__d3 t_5_7) ys_1_6)))))) in
                        (let rec h_1_3 = 'h' in
                          (fun ys_1_7 -> 
                            (`LH_C(h_1_3, ((mappend_lh__d3 t_5_6) ys_1_7)))))) in
                        (let rec h_1_4 = 't' in
                          (fun ys_1_8 -> 
                            (`LH_C(h_1_4, ((mappend_lh__d3 t_5_5) ys_1_8)))))) in
                        (let rec h_1_5 = 'i' in
                          (fun ys_1_9 -> 
                            (`LH_C(h_1_5, ((mappend_lh__d3 t_5_4) ys_1_9)))))) in
                        (let rec h_1_6 = 'w' in
                          (fun ys_2_0 -> 
                            (`LH_C(h_1_6, ((mappend_lh__d3 t_5_3) ys_2_0)))))) in
                        (let rec h_1_7 = ' ' in
                          (fun ys_2_1 -> 
                            (`LH_C(h_1_7, ((mappend_lh__d3 t_5_2) ys_2_1)))))) in
                        (let rec h_1_8 = 'r' in
                          (fun ys_2_2 -> 
                            (`LH_C(h_1_8, ((mappend_lh__d3 t_5_1) ys_2_2)))))) in
                        (let rec h_1_9 = 'u' in
                          (fun ys_2_3 -> 
                            (`LH_C(h_1_9, ((mappend_lh__d3 t_5_0) ys_2_3)))))) in
                        (let rec h_2_0 = 'o' in
                          (fun ys_2_4 -> 
                            (`LH_C(h_2_0, ((mappend_lh__d3 t_4_9) ys_2_4)))))) in
                        (let rec h_2_1 = 't' in
                          (fun ys_2_5 -> 
                            (`LH_C(h_2_1, ((mappend_lh__d3 t_4_8) ys_2_5)))))) in
                        (let rec h_2_2 = ' ' in
                          (fun ys_2_6 -> 
                            (`LH_C(h_2_2, ((mappend_lh__d3 t_4_7) ys_2_6)))))) in
                        (let rec h_2_3 = 's' in
                          (fun ys_2_7 -> 
                            (`LH_C(h_2_3, ((mappend_lh__d3 t_4_6) ys_2_7)))))) in
                        (let rec h_2_4 = 't' in
                          (fun ys_2_8 -> 
                            (`LH_C(h_2_4, ((mappend_lh__d3 t_4_5) ys_2_8)))))) in
                        (let rec h_2_5 = 'h' in
                          (fun ys_2_9 -> 
                            (`LH_C(h_2_5, ((mappend_lh__d3 t_4_4) ys_2_9)))))) in
                        (let rec h_2_6 = 'g' in
                          (fun ys_3_0 -> 
                            (`LH_C(h_2_6, ((mappend_lh__d3 t_4_3) ys_3_0)))))) in
                        (let rec h_2_7 = 'i' in
                          (fun ys_3_1 -> 
                            (`LH_C(h_2_7, ((mappend_lh__d3 t_4_2) ys_3_1)))))) in
                        (let rec h_2_8 = 'n' in
                          (fun ys_3_2 -> 
                            (`LH_C(h_2_8, ((mappend_lh__d3 t_4_1) ys_3_2)))))) in
                        (let rec h_2_9 = 'K' in
                          (fun ys_3_3 -> 
                            (`LH_C(h_2_9, ((mappend_lh__d3 t_4_0) ys_3_3)))))) in
                        (let rec h_3_0 = '|' in
                          (fun ys_3_4 -> 
                            (`LH_C(h_3_0, ((mappend_lh__d3 t_3_9) ys_3_4))))))) (string_of_int _lh_pp_LH_P2_0_0))) (let rec t_5_8 = (let rec t_5_9 = (let rec t_6_0 = (let rec t_6_1 = (let rec t_6_2 = (let rec t_6_3 = (let rec t_6_4 = (let rec t_6_5 = (let rec t_6_6 = (let rec t_6_7 = (let rec t_6_8 = (let rec t_6_9 = (let rec t_7_0 = (let rec t_7_1 = (let rec t_7_2 = (let rec t_7_3 = (let rec t_7_4 = (let rec t_7_5 = (let rec t_7_6 = (let rec t_7_7 = (fun ys_3_5 -> 
                        ys_3_5) in
                        (let rec h_3_1 = '|' in
                          (fun ys_3_6 -> 
...
let rec map_lh__d1 f_1_6 ls_4 =
  (match ls_4 with
    | `LH_C(h_8_9, t_1_3_7) -> 
      (`LH_C((f_1_6 h_8_9), ((map_lh__d1 f_1_6) t_1_3_7)))
    | `LH_N -> 
      (`LH_N));;
    ...
    (let rec hx_2 = x_1 in
      (fun hy_1 ty_1 -> 
        (let rec t_1_1_8 = ((zip_lz_nl_lh__d2 tx_2) ty_1) in
          (let rec h_7_1 = (`LH_P2(hx_2, hy_1)) in
            (fun ys_7_7 -> 
              (`LH_C(h_7_1, ((mappend_lh__d1_d8 t_1_1_8) ys_7_7))))))))));;
  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d1 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_8 = a_0 in
        (fun _lh_listcomp_fun_ls_h_9 _lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_9 _lh_listcomp_fun_1_1 -> 
          (let rec tx_0 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_8) in
            (let rec hx_0 = (`LH_P2(_lh_listcomp_fun_ls_h_9, _lh_listcomp_fun_ls_h_8)) in
              (fun f_0 ys_0 -> 
                (((ys_0 f_0) hx_0) tx_0)))))))
  else
    (fun _lh_listcomp_fun_ls_h_1_0 _lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_1_0 _lh_listcomp_fun_1_3 -> 
...
let rec enumFromTo_lh__d2 a_1 b_1 =
  (if (a_1 <= b_1) then
    ...
    (fun _lh_listcomp_fun_3_6 _lh_root_arg1_1 f_1 ys_7_8 xs_6 ys_7_9 -> 
      ys_7_9));;
...
let rec copy_lh__d1 _lh_copy_arg1_1 _lh_copy_arg2_1 =
  (if (_lh_copy_arg1_1 <= 0) then
    (fun f_4 hx_3 tx_3 xs_1_1 ys_8_6 -> 
      ys_8_6)
  else
        ...
        (fun _lh_listcomp_fun_4_1 _lh_possibleMoves_arg1_3_2 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_2) _lh_listcomp_fun_ls_h_3_0) then
            (let rec t_1_2_6 = (_lh_listcomp_fun_4_1 _lh_listcomp_fun_ls_t_3_7) in
              (let rec h_7_8 = _lh_listcomp_fun_ls_h_3_0 in
                (fun f_7 -> 
                  (`LH_C((f_7 h_7_8), ((map_lh__d3 f_7) t_1_2_6))))))
          else
        ...
        (fun _lh_listcomp_fun_4_2 _lh_possibleMoves_arg1_3_3 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_3) _lh_listcomp_fun_ls_h_3_1) then
            (let rec t_1_2_7 = (_lh_listcomp_fun_4_2 _lh_listcomp_fun_ls_t_3_6) in
              (let rec h_7_9 = _lh_listcomp_fun_ls_h_3_1 in
                (fun f_8 -> 
                  (`LH_C((f_8 h_7_9), ((map_lh__d3 f_8) t_1_2_7))))))
          else
        ...
        (fun _lh_listcomp_fun_4_3 _lh_possibleMoves_arg1_3_4 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_4) _lh_listcomp_fun_ls_h_3_2) then
            (let rec t_1_2_8 = (_lh_listcomp_fun_4_3 _lh_listcomp_fun_ls_t_3_5) in
              (let rec h_8_0 = _lh_listcomp_fun_ls_h_3_2 in
                (fun f_9 -> 
                  (`LH_C((f_9 h_8_0), ((map_lh__d3 f_9) t_1_2_8))))))
          else
        ...
        (fun _lh_listcomp_fun_4_4 _lh_possibleMoves_arg1_3_5 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_5) _lh_listcomp_fun_ls_h_3_3) then
            (let rec t_1_2_9 = (_lh_listcomp_fun_4_4 _lh_listcomp_fun_ls_t_3_4) in
              (let rec h_8_1 = _lh_listcomp_fun_ls_h_3_3 in
                (fun f_1_0 -> 
                  (`LH_C((f_1_0 h_8_1), ((map_lh__d3 f_1_0) t_1_2_9))))))
          else
        ...
        (fun _lh_listcomp_fun_4_5 _lh_possibleMoves_arg1_3_6 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_6) _lh_listcomp_fun_ls_h_3_4) then
            (let rec t_1_3_0 = (_lh_listcomp_fun_4_5 _lh_listcomp_fun_ls_t_3_3) in
              (let rec h_8_2 = _lh_listcomp_fun_ls_h_3_4 in
                (fun f_1_1 -> 
                  (`LH_C((f_1_1 h_8_2), ((map_lh__d3 f_1_1) t_1_3_0))))))
          else
        ...
        (fun _lh_listcomp_fun_4_6 _lh_possibleMoves_arg1_3_7 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_7) _lh_listcomp_fun_ls_h_3_5) then
            (let rec t_1_3_1 = (_lh_listcomp_fun_4_6 _lh_listcomp_fun_ls_t_3_2) in
              (let rec h_8_3 = _lh_listcomp_fun_ls_h_3_5 in
                (fun f_1_2 -> 
                  (`LH_C((f_1_2 h_8_3), ((map_lh__d3 f_1_2) t_1_3_1))))))
          else
        ...
        (fun _lh_listcomp_fun_4_7 _lh_possibleMoves_arg1_3_8 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_8) _lh_listcomp_fun_ls_h_3_6) then
            (let rec t_1_3_2 = (_lh_listcomp_fun_4_7 _lh_listcomp_fun_ls_t_3_1) in
              (let rec h_8_4 = _lh_listcomp_fun_ls_h_3_6 in
                (fun f_1_3 -> 
                  (`LH_C((f_1_3 h_8_4), ((map_lh__d3 f_1_3) t_1_3_2))))))
          else
        ...
        (fun _lh_listcomp_fun_4_8 _lh_possibleMoves_arg1_3_9 -> 
          (if ((canMove_lh__d2 _lh_possibleMoves_arg1_3_9) _lh_listcomp_fun_ls_h_3_7) then
            (let rec t_1_3_3 = (_lh_listcomp_fun_4_8 _lh_listcomp_fun_ls_t_3_0) in
              (let rec h_8_5 = _lh_listcomp_fun_ls_h_3_7 in
                (fun f_1_4 -> 
                  (`LH_C((f_1_4 h_8_5), ((map_lh__d3 f_1_4) t_1_3_3))))))
          else
...
let rec map_lh__d2 f_1_5 ls_3 =
  (match ls_3 with
    | `LH_C(h_8_6, t_1_3_4) -> 
      (`LH_C((f_1_5 h_8_6), ((map_lh__d2 f_1_5) t_1_3_4)))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `LH_C(h_8_7, t_1_3_5) -> 
      (let rec t_1_3_6 = ((mappend_lh__d2_d0 t_1_3_5) ys_9_2) in
        (let rec h_8_8 = h_8_7 in
          (fun ys_9_3 -> 
            (`LH_C(h_8_8, ((mappend_lh__d1_d9 t_1_3_6) ys_9_3))))))
    | `LH_N -> 
      ys_9_2);;
  ...
  (match _lh_quickSortIntChessSet_arg1_0 with
    ...
    | `LH_C(_lh_quickSortIntChessSet_LH_C_0_0, _lh_quickSortIntChessSet_LH_C_1_0) -> 
      ((mappend_lh__d1_d9 ((mappend_lh__d2_d0 (quickSortIntChessSet_lh__d1 (let rec _lh_listcomp_fun_5_0 = (fun _lh_listcomp_fun_para_8 -> 
        ...
        ys_9_8) in
        (let rec h_9_0 = _lh_quickSortIntChessSet_LH_C_0_0 in
          (fun ys_9_9 -> 
            (`LH_C(h_9_0, ((mappend_lh__d1_d9 t_1_3_8) ys_9_9)))))))) (quickSortIntChessSet_lh__d1 (let rec _lh_listcomp_fun_5_1 = (fun _lh_listcomp_fun_para_9 -> 
    ...
    (let rec hx_1 = x_0 in
      (fun hy_0 ty_0 -> 
        (let rec t_2_9 = ((zip_lz_nl_lh__d1 tx_1) ty_0) in
          (let rec h_4 = (`LH_P2(hx_1, hy_0)) in
            (fun ys_7 -> 
              (`LH_C(h_4, ((mappend_lh__d5 t_2_9) ys_7))))))))));;

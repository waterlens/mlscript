...
let rec map_lh__d1__d0 f_2_8 ls_8 =
  (ls_8 f_2_8);;
let rec enumFromTo_lh__d1__d0 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec t_3_1 = ((enumFromTo_lh__d1__d0 (a_0 + 1)) b_0) in
      (let rec h_3_0 = a_0 in
        (fun f_3_3 -> 
          (`LH_C((f_3_3 h_3_0), ((map_lh__d1__d0 f_3_3) t_3_1))))))
  else
    (fun f_3_4 -> 
      (`LH_N)));;
...
let rec concat_lh__d5__d3 lss_9 =
  (lss_9 99);;
let rec map_lh__d6__d1 f_5_6 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_6_1, t_6_2) -> 
    ...
    | `LH_N -> 
      (fun _lh_dummy_3_9 f_5_7 _lh_dummy_4_0 -> 
        (`LH_N)));;
...
let rec concat_lh__d5__d7 lss_5 =
  (lss_5 99);;
let rec map_lh__d6__d3 f_5_3 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_5_2, t_5_3) -> 
...
let rec concat_lh__d2__d1 lss_2_4 =
  (lss_2_4 99);;
let rec map_lh__d3__d0 f_4_2 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_3_5, t_3_6) -> 

...
let rec a_lh__d9 label_2 =
  (let rec _lh_label_Node_1_2 = (`LH_N) in
    (let rec _lh_label_Node_0_2 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2 -> 
...
let rec b_lh__d6 label_1_6 =
  (let rec _lh_label_Node_1_1_5 = (`LH_N) in
    (let rec _lh_label_Node_0_1_5 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_6 -> 
...
let rec prod_lh__d2 _lh_prod_arg1_1 label_2_3 =
  (let rec _lh_label_Node_1_2_2 = _lh_prod_arg1_1 in
    (let rec _lh_label_Node_0_2_2 = (`LH_C('X', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_3 -> 
    ...
    | 0 -> 
      (let rec _lh_label_Node_1_2_7 = (`LH_N) in
        (let rec _lh_label_Node_0_2_7 = (`LH_C('0', (`LH_N))) in
          (fun label_2_8 -> 
            ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_8 -> 
...
let rec d_lh__d2 label_2_6 =
  (let rec _lh_label_Node_1_2_5 = (`LH_N) in
    (let rec _lh_label_Node_0_2_5 = (`LH_C('d', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_6 -> 
...
let rec plus__lh__d7 _lh_plus__arg1_6 _lh_plus__arg2_6 label_3_3 =
  (let rec _lh_label_Node_1_3_2 = (`LH_C(_lh_plus__arg1_6, (`LH_C(_lh_plus__arg2_6, (`LH_N))))) in
    (let rec _lh_label_Node_0_3_2 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_4_0 -> 
...
let rec c_lh__d3 label_3_4 =
  (let rec _lh_label_Node_1_3_3 = (`LH_N) in
    (let rec _lh_label_Node_0_3_3 = (`LH_C('c', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_4_1 -> 
...
let rec example5_lh__d1 _lh_example5_arg1_0 =
  (prod_lh__d2 (((scanr_lh__d1 plus__lh__d7) (zerO_lh__d2 0)) (let rec _lh_scanr_LH_C_1_0 = (let rec _lh_scanr_LH_C_1_1 = (let rec _lh_scanr_LH_C_1_2 = (let rec _lh_scanr_LH_C_1_3 = (fun _lh_scanr_arg2_0 _lh_scanr_arg1_0 -> 
...
let rec a_lh__d1 label_1_3 =
  (let rec _lh_label_Node_1_1_2 = (`LH_N) in
    (let rec _lh_label_Node_0_1_2 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_2 -> 
...
let rec plus__lh__d1 _lh_plus__arg1_1 _lh_plus__arg2_1 label_1_5 =
  (let rec _lh_label_Node_1_1_4 = (`LH_C(_lh_plus__arg1_1, (`LH_C(_lh_plus__arg2_1, (`LH_N))))) in
    (let rec _lh_label_Node_0_1_4 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_5 -> 
...
let rec a_lh__d2 label_1_9 =
  (let rec _lh_label_Node_1_1_8 = (`LH_N) in
    (let rec _lh_label_Node_0_1_8 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_9 -> 
...
let rec c_lh__d1 label_1 =
  (let rec _lh_label_Node_1_1 = (`LH_N) in
    (let rec _lh_label_Node_0_1 = (`LH_C('c', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1 -> 
...
let rec a_lh__d5 label_6 =
  (let rec _lh_label_Node_1_6 = (`LH_N) in
    (let rec _lh_label_Node_0_6 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_6 -> 
...
let rec a_lh__d4 label_1_4 =
  (let rec _lh_label_Node_1_1_3 = (`LH_N) in
    (let rec _lh_label_Node_0_1_3 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_4 -> 
...
let rec b_lh__d2 label_2_1 =
  (let rec _lh_label_Node_1_2_0 = (`LH_N) in
    (let rec _lh_label_Node_0_2_0 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_1 -> 
...
let rec plus__lh__d3 _lh_plus__arg1_2 _lh_plus__arg2_2 label_2_2 =
  (let rec _lh_label_Node_1_2_1 = (`LH_C(_lh_plus__arg1_2, (`LH_C(_lh_plus__arg2_2, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_1 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_2 -> 
...
let rec plus__lh__d2 _lh_plus__arg1_4 _lh_plus__arg2_4 label_2_7 =
  (let rec _lh_label_Node_1_2_6 = (`LH_C(_lh_plus__arg1_4, (`LH_C(_lh_plus__arg2_4, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_6 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_7 -> 
...
let rec plus__lh__d4 _lh_plus__arg1_5 _lh_plus__arg2_5 label_2_9 =
  (let rec _lh_label_Node_1_2_8 = (`LH_C(_lh_plus__arg1_5, (`LH_C(_lh_plus__arg2_5, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_8 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_9 -> 
...
let rec b_lh__d1 label_7 =
  (let rec _lh_label_Node_1_7 = (`LH_N) in
    (let rec _lh_label_Node_0_7 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_7 -> 
...
let rec mult__lh__d1 _lh_mult__arg1_0 _lh_mult__arg2_0 label_9 =
  (let rec _lh_label_Node_1_9 = (`LH_C(_lh_mult__arg1_0, (`LH_C(_lh_mult__arg2_0, (`LH_N))))) in
    (let rec _lh_label_Node_0_9 = (`LH_C('*', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_9 -> 
...
let rec a_lh__d3 label_8 =
  (let rec _lh_label_Node_1_8 = (`LH_N) in
    (let rec _lh_label_Node_0_8 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_8 -> 
...
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec map_lh__d5 f_6 ls_5 _lh_popOutId_0_1 =
  (match ls_5 with
    | `LH_C(h_5, t_5) -> 
...
let rec null_lh__d1 _lh_null_arg1_0 =
  (match _lh_null_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d4 f_1_5 ls_7 _lh_popOutId_0_2 =
  (match ls_7 with
    | `LH_C(h_1_9, t_1_9) -> 
      (let rec t_2_0 = ((map_lh__d4 f_1_5) t_1_9) in
        (let rec h_2_0 = (f_1_5 h_1_9) in
          (`LH_C((_lh_popOutId_0_2 h_2_0), ((map_lh__d3 _lh_popOutId_0_2) t_2_0)))))
    | `LH_N -> 
      (`LH_N));;
                ...
                (let rec _lh_sim_LH_P3_0_0 = _lh_ltGraph_LH_P2_0_0 in
                  (fun _lh_sim_arg2_0 -> 
                    (match _lh_sim_arg2_0 with
                      ...
                      | _ -> 
                        (failwith "error")))))), (concat_lh__d1 ((map_lh__d5 ltGraph_lh__d1) _lh_ltGraph_Node_1_0)))))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
...
let rec c_lh__d2 label_3 =
  (let rec _lh_label_Node_1_3 = (`LH_N) in
    (let rec _lh_label_Node_0_3 = (`LH_C('c', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_3 -> 
...
let rec prod_lh__d1 _lh_prod_arg1_0 label_4 =
  (let rec _lh_label_Node_1_4 = _lh_prod_arg1_0 in
    (let rec _lh_label_Node_0_4 = (`LH_C('X', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_4 -> 
    ...
    | 0 -> 
      (let rec _lh_label_Node_1_1_6 = (`LH_N) in
        (let rec _lh_label_Node_0_1_6 = (`LH_C('0', (`LH_N))) in
          (fun label_1_7 -> 
            ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_7 -> 
...
let rec b_lh__d3 label_2_0 =
  (let rec _lh_label_Node_1_1_9 = (`LH_N) in
    (let rec _lh_label_Node_0_1_9 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_0 -> 
...
let rec plus__lh__d5 _lh_plus__arg1_3 _lh_plus__arg2_3 label_2_4 =
  (let rec _lh_label_Node_1_2_3 = (`LH_C(_lh_plus__arg1_3, (`LH_C(_lh_plus__arg2_3, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_3 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_4 -> 
...
let rec d_lh__d1 label_3_1 =
  (let rec _lh_label_Node_1_3_0 = (`LH_N) in
    (let rec _lh_label_Node_0_3_0 = (`LH_C('d', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_3_8 -> 
...
let rec a_lh__d6 label_3_2 =
  (let rec _lh_label_Node_1_3_1 = (`LH_N) in
    (let rec _lh_label_Node_0_3_1 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_3_9 -> 
...
let rec example4_lh__d1 _lh_example4_arg1_0 =
  (prod_lh__d1 (((scanl_lh__d1 plus__lh__d5) (zerO_lh__d1 0)) (let rec _lh_scanl_LH_C_1_0 = (let rec _lh_scanl_LH_C_1_1 = (let rec _lh_scanl_LH_C_1_2 = (let rec _lh_scanl_LH_C_1_3 = (fun _lh_scanl_arg1_0 _lh_scanl_arg2_0 -> 
    (`LH_N)) in
...
let rec a_lh__d8 label_5 =
  (let rec _lh_label_Node_1_5 = (`LH_N) in
    (let rec _lh_label_Node_0_5 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_5 -> 
...
let rec b_lh__d4 label_1_8 =
  (let rec _lh_label_Node_1_1_7 = (`LH_N) in
    (let rec _lh_label_Node_0_1_7 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_8 -> 
...
let rec a_lh__d7 label_2_5 =
  (let rec _lh_label_Node_1_2_4 = (`LH_N) in
    (let rec _lh_label_Node_0_2_4 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_2_5 -> 
...
let rec mult__lh__d2 _lh_mult__arg1_2 _lh_mult__arg2_2 label_3_0 =
  (let rec _lh_label_Node_1_2_9 = (`LH_C(_lh_mult__arg1_2, (`LH_C(_lh_mult__arg2_2, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_9 = (`LH_C('*', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_3_0 -> 
...
let rec b_lh__d5 label_1_0 =
  (let rec _lh_label_Node_1_1_0 = (`LH_N) in
    (let rec _lh_label_Node_0_1_0 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_0 -> 
...
let rec mult__lh__d3 _lh_mult__arg1_1 _lh_mult__arg2_1 label_1_1 =
  (let rec _lh_label_Node_1_1_1 = (`LH_C(_lh_mult__arg1_1, (`LH_C(_lh_mult__arg2_1, (`LH_N))))) in
    (let rec _lh_label_Node_0_1_1 = (`LH_C('*', (`LH_N))) in
      ((bind_lh__d2 (incr_lh__d1 0)) (fun n_1_1 -> 
...
let rec enumFromTo_lh__d1 a_0 b_1 _lh_popOutId_0_0 =
  (if (a_0 <= b_1) then
    (let rec t_4 = ((enumFromTo_lh__d1 (a_0 + 1)) b_1) in
      (let rec h_4 = a_0 in
        (`LH_C((_lh_popOutId_0_0 h_4), ((map_lh__d2 _lh_popOutId_0_0) t_4)))))
  else
    (`LH_N));;

      ...
      (let rec tx_5 = ((map_lh__d2 f_2) t_1_2) in
        (let rec hx_5 = (f_2 h_9) in
          (fun ys_3 -> 
            ((ys_3 hx_5) tx_5))))
    | `LH_N -> 
      (fun ys_4 _lh_findk_arg2_9 _lh_findk_arg1_9 _lh_findk_arg3_9 -> 
        _lh_findk_arg2_9));;
...
let rec map_lh__d1 f_3 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_1, t_1_4) -> 
      (let rec t_1_5 = ((map_lh__d1 f_3) t_1_4) in
        (let rec h_1_2 = (f_3 h_1_1) in
          (fun a_1_1 -> 
            ((reverse_helper_lh__d0 t_1_5) (let rec ty_3 = a_1_1 in
...
let rec reverse_lh__d0 ls_1_6 =
  ((reverse_helper_lh__d0 ls_1_6) (fun hx_8 tx_8 _lh_findk_arg2_1_6 _lh_findk_arg1_1_6 _lh_findk_arg3_1_6 -> 
    _lh_findk_arg2_1_6));;
let rec map_lh__d3 f_1 ls_3 =
  (match ls_3 with
    | `LH_C(h_2, t_2) -> 
      (let rec t_3 = ((map_lh__d3 f_1) t_2) in
        (let rec h_3 = (f_1 h_2) in
          (fun a_1 -> 
            ((reverse_helper_lh__d3 t_3) (let rec ty_0 = a_1 in
              (let rec hy_0 = h_3 in
                (fun hx_1 tx_1 -> 
...
let rec algb_lh__d0 _lh_algb_arg1_2 _lh_algb_arg2_2 =
...
let rec algb_lh__d2 _lh_algb_arg1_3 _lh_algb_arg2_3 =
  (let rec tx_9 = ((algb1_lh__d2 _lh_algb_arg1_3) (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_3 -> 
    ...
    (let rec hx_9 = 0 in
      (fun ys_7 -> 
        ((ys_7 hx_9) tx_9))));;
let rec algc_lh__d0 _lh_algc_arg1_0 _lh_algc_arg2_0 _lh_algc_arg3_0 _lh_algc_arg4_0 =
                    ...
                    (let rec l1_0 = ((algb_lh__d0 xs1_0) _lh_algc_arg4_0) in
                      (let rec l2_0 = (reverse_lh__d0 ((algb_lh__d1 (reverse_lh__d1 xs2_0)) (reverse_lh__d2 _lh_algc_arg4_0))) in
                        (let rec k_0 = ((((findk_lh__d0 0) 0) (0 - 1)) ((zip_lh__d0 l1_0) l2_0)) in
                          (fun _lh_funcomp_x_0 -> 
                            (((((algc_lh__d0 m2_0) k_0) xs1_0) ((take_lh__d1 k_0) _lh_algc_arg4_0)) (((((algc_lh__d0 (_lh_algc_arg1_0 - m2_0)) (_lh_algc_arg2_0 - k_0)) xs2_0) ((drop_lh__d1 k_0) _lh_algc_arg4_0)) _lh_funcomp_x_0))))))))))
        | _ -> 
                ...
                (let rec l1_1 = ((algb_lh__d2 xs1_1) _lh_algc_arg4_0) in
                  (let rec l2_1 = (reverse_lh__d3 ((algb_lh__d3 (reverse_lh__d4 xs2_1)) (reverse_lh__d5 _lh_algc_arg4_0))) in
                    (let rec k_1 = ((((findk_lh__d1 0) 0) (0 - 1)) ((zip_lh__d1 l1_1) l2_1)) in
                      (fun _lh_funcomp_x_1 -> 
                        (((((algc_lh__d0 m2_1) k_1) xs1_1) ((take_lh__d3 k_1) _lh_algc_arg4_0)) (((((algc_lh__d0 (_lh_algc_arg1_0 - m2_1)) (_lh_algc_arg2_0 - k_1)) xs2_1) ((drop_lh__d3 k_1) _lh_algc_arg4_0)) _lh_funcomp_x_1)))))))))));;

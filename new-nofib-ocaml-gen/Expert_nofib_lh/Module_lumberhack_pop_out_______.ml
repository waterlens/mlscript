  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_4_1 = ((enumFromTo_lh__d1 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_4_1 = a_0 in
        (`LH_C((`LH_C('X', (string_of_int _lh_listcomp_fun_ls_h_4_1))), (_lh_popOutId_0_0 _lh_listcomp_fun_ls_t_4_1)))))
  else
    (`LH_N));;
...
let rec process_lh__d1 _lh_process_arg1_0 _lh_process_arg2_0 =
  let rec info_0 = (fun _lh_info_arg1_0 _lh_info_arg2_0 -> 
    ((enterList_lh__d1 newTable_lh__d1) (let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_1_0 -> 
      (match _lh_listcomp_fun_para_1_0 with
            ...
            | `LH_P2(_lh_info_LH_P2_0_0, _lh_info_LH_P2_1_0) -> 
              (match _lh_info_LH_P2_0_0 with
                | `Question(_lh_info_Question_0_0) -> 
                  (`LH_C((`LH_P2(_lh_info_Question_0_0, _lh_info_LH_P2_1_0)), (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_0)))
                | _ -> 
        ...
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_1_4 ((zip_lh__d1 ((results_0 _lh_info_arg1_0) _lh_info_arg2_0)) (replies_0 _lh_info_arg2_0))))))
  ...
  and newsoln_0 = (`Soln(newTable_lh__d2, (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_1_1 -> 
    (_lh_listcomp_fun_para_1_1 _lh_listcomp_fun_1_5)) in
    (_lh_listcomp_fun_1_5 ((enumFromTo_lh__d1 0) 1)))))
  and replies_0 = (fun _lh_replies_arg1_0 -> 
    (let rec _lh_listcomp_fun_1_6 = (fun _lh_listcomp_fun_para_1_2 -> 
      (_lh_listcomp_fun_para_1_2 _lh_listcomp_fun_1_6)) in
      (_lh_listcomp_fun_1_6 (lines_lh__d3 _lh_replies_arg1_0))))

    ...
    (match ls_1_9 with
      | `LH_C(h_2_0, t_2_2) -> 
        (if (n_4 = 0) then
          ...
          ((atIndex_d0 (n_4 - 1)) t_2_2))
      | `LH_N -> 
        (failwith "error")));;
let rec enumFromThenTo_d0 a_6 t_2_8 b_3 =
  (if (a_6 <= b_3) then
    (`LH_C(a_6, (((enumFromThenTo_d0 t_2_8) ((2 * t_2_8) - a_6)) b_3)))
  else
    (`LH_N));;
let rec enumFromThenTo_d1 a_5 t_2_5 b_2 =
  (if (a_5 <= b_2) then
    (`LH_C(a_5, (((enumFromThenTo_d1 t_2_5) ((2 * t_2_5) - a_5)) b_2)))
  else
    (`LH_N));;
let rec head_d0 ls_2_3 =
  (match ls_2_3 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_d0 f_1_2 ls_2_1 =
  (lazy (match (Lazy.force ls_2_1) with
    | `LH_C(h_2_2, t_2_4) -> 
      (`LH_C((f_1_2 h_2_2), ((map_lz_d0 f_1_2) t_2_4)))
    | `LH_N -> 
      (`LH_N)));;
...
and prime_d0 _lh_prime_arg1_1 =
  ((atIndex_d0 _lh_prime_arg1_1) (primes_d0 _lh_prime_arg1_1))
and sieve_d0 _lh_sieve_arg1_1 _lh_sieve_arg2_1 _lh_sieve_arg3_1 _lh_sieve_arg4_1 =
  (lazy (let rec _lh_matchIdent_7 = (Lazy.force _lh_sieve_arg1_1) in
          ...
          | `Wheel(_lh_sieve_Wheel_0_1, _lh_sieve_Wheel_1_1) -> 
            ((append_lz_d0 (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_9 -> 
              (match _lh_listcomp_fun_para_9 with
                ...
                | `LH_N -> 
                  (`LH_N))) in
              (_lh_listcomp_fun_9 (`LH_C(_lh_sieve_Wheel_0_1, (((enumFromThenTo_d0 (_lh_sieve_Wheel_0_1 * 2)) (_lh_sieve_Wheel_0_1 * 3)) (((min_d0 (_lh_sieve_arg4_1 * _lh_sieve_arg4_1)) ((head_d0 _lh_sieve_arg2_1) - 1)) * _lh_sieve_Wheel_0_1))))))) (lazy ((((sieve_d0 _lh_sieve_LH_C_1_1) (tail_d0 _lh_sieve_arg2_1)) (tail_d1 _lh_sieve_arg3_1)) _lh_sieve_arg4_1)))
          | _ -> 
            (failwith "error"))
      | _ -> 
        (failwith "error"))))
...
let rec append_lz_d0_d0 _lh_append_lz_arg1_0 _lh_append_lz_arg2_0 =
  (let rec _lh_matchIdent_2 = _lh_append_lz_arg1_0 in
    (_lh_matchIdent_2 _lh_append_lz_arg2_0));;
let rec atIndex_d0_d0 n_0 ls_2 =
  (if (n_0 < 0) then
    (failwith "error")
  else
    (match ls_2 with
      | `LH_C(h_2, t_2) -> 
        (if (n_0 = 0) then
          ...
          ((atIndex_d0_d0 (n_0 - 1)) t_2))
      | `LH_N -> 
        (failwith "error")));;
let rec enumFromThenTo_d1_d0 a_1 t_5 b_1 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_h_3 = a_1 in
      (let rec _lh_listcomp_fun_ls_t_5 = (((enumFromThenTo_d1_d0 t_5) ((2 * t_5) - a_1)) b_1) in
...
let rec enumFromThenTo_d0_d0 a_0 t_3 b_0 =
  (if (a_0 <= b_0) then
    ...
    (fun _lh_sieve_Wheel_0_3 _lh_sieve_arg2_3 _lh_sieve_Wheel_1_1 _lh_sieve_arg3_3 _lh_listcomp_fun_7 _lh_append_lz_arg2_2 -> 
      (Lazy.force _lh_append_lz_arg2_2)))
...
and prime_d0_d0 _lh_prime_arg1_0 =
  ((atIndex_d0_d0 _lh_prime_arg1_0) (primes_d0_d0 _lh_prime_arg1_0))
and sieve_d0_d0 _lh_sieve_arg1_0 _lh_sieve_arg2_4 _lh_sieve_arg3_4 _lh_sieve_arg4_0 =
  (lazy (let rec _lh_matchIdent_3 = (Lazy.force _lh_sieve_arg1_0) in
          ...
          | `Wheel(_lh_sieve_Wheel_0_4, _lh_sieve_Wheel_1_2) -> 
            ((append_lz_d0_d0 (let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_5 -> 
              ...
              (_lh_listcomp_fun_1_7 (let rec _lh_listcomp_fun_ls_h_6 = _lh_sieve_Wheel_0_4 in
                (let rec _lh_listcomp_fun_ls_t_1_0 = (((enumFromThenTo_d0_d0 (_lh_sieve_Wheel_0_4 * 2)) (_lh_sieve_Wheel_0_4 * 3)) (((min_d0_d0 (_lh_sieve_arg4_0 * _lh_sieve_arg4_0)) ((head_d0_d0 _lh_sieve_arg2_4) - 1)) * _lh_sieve_Wheel_0_4)) in
                  (fun _lh_sieve_Wheel_0_5 _lh_sieve_arg2_5 _lh_sieve_Wheel_1_3 _lh_sieve_arg3_5 _lh_listcomp_fun_1_8 -> 
                    (let rec _lh_listcomp_fun_1_9 = (fun _lh_listcomp_fun_para_6 -> 
                      ...
                      (_lh_listcomp_fun_1_9 _lh_sieve_Wheel_1_3)))))))) (lazy ((((sieve_d0_d0 _lh_sieve_LH_C_1_0) (tail_d0_d0 _lh_sieve_arg2_4)) (tail_d1_d0 _lh_sieve_arg3_4)) _lh_sieve_arg4_0)))
          | _ -> 
            (failwith "error"))
      | _ -> 
        (failwith "error"))))
...
(* lumberhack_pop_out *)
let rec append_lz_d0_d0_d0 _lh_append_lz_arg1_1 _lh_append_lz_arg2_4 =
  (let rec _lh_matchIdent_4 = _lh_append_lz_arg1_1 in
    (_lh_matchIdent_4 _lh_append_lz_arg2_4));;
let rec append_lz_d0_d0_d1 _lh_append_lz_arg1_2 _lh_append_lz_arg2_5 =
  (let rec _lh_matchIdent_5 = _lh_append_lz_arg1_2 in
    (_lh_matchIdent_5 _lh_append_lz_arg2_5));;
let rec append_lz_d0_d0_d2 _lh_append_lz_arg1_3 _lh_append_lz_arg2_9 =
  (let rec _lh_matchIdent_9 = _lh_append_lz_arg1_3 in
    (_lh_matchIdent_9 _lh_append_lz_arg2_9));;
let rec atIndex_d0_d0_d0 n_1 ls_8 =
  (if (n_1 < 0) then
    (failwith "error")
  else
    (match ls_8 with
      | `LH_C(h_8, t_1_1) -> 
        (if (n_1 = 0) then
          ...
          ((atIndex_d0_d0_d0 (n_1 - 1)) t_1_1))
      | `LH_N -> 
        (failwith "error")));;
let rec enumFromThenTo_d1_d0_d0 a_2 t_8 b_2 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 =
  (if (a_2 <= b_2) then
    (let rec _lh_listcomp_fun_ls_h_9 = a_2 in
      (let rec _lh_listcomp_fun_ls_t_1_5 = (((enumFromThenTo_d1_d0_d0 t_8) ((2 * t_8) - a_2)) b_2) in
          ...
          (match _lh_listcomp_fun_para_8 with
            | `LH_C(_lh_listcomp_fun_ls_h_1_0, _lh_listcomp_fun_ls_t_1_6) -> 
              (let rec _lh_listcomp_fun_2_7 = (fun _lh_listcomp_fun_para_9 -> 
                ((((_lh_listcomp_fun_para_9 _lh_popOutId_0_0) _lh_listcomp_fun_2_7) _lh_listcomp_fun_2_6) _lh_listcomp_fun_ls_t_1_6)) in
                (_lh_listcomp_fun_2_7 (let rec _lh_listcomp_fun_ls_h_1_1 = (_lh_listcomp_fun_ls_h_1_0 + _lh_listcomp_fun_ls_h_9) in
                  (let rec _lh_listcomp_fun_ls_t_1_7 = (fun _lh_nextSize_arg2_6 _lh_listcomp_fun_2_8 _lh_listcomp_fun_2_9 _lh_listcomp_fun_ls_t_1_8 -> 
                    (_lh_listcomp_fun_2_9 _lh_listcomp_fun_ls_t_1_8)) in
                    (fun _lh_nextSize_arg2_7 _lh_listcomp_fun_3_0 _lh_listcomp_fun_3_1 _lh_listcomp_fun_ls_t_1_9 -> 
            ...
            | `LH_N -> 
              (_lh_popOutId_2_0 _lh_listcomp_fun_ls_t_1_5))) in
...
let rec head_d0_d0_d0 ls_7 =
  (match ls_7 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_d0_d0_d0 f_3 ls_9 =
  (lazy (match (Lazy.force ls_9) with
    | `LH_C(h_9, t_1_3) -> 
      (`LH_C((f_3 h_9), ((map_lz_d0_d0_d0 f_3) t_1_3)))
    | `LH_N -> 
      (`LH_N)));;
...
let rec notDivBy_d0_d0_d0 _lh_notDivBy_arg1_1 _lh_notDivBy_arg2_1 _lh_notDivBy_arg3_1 =
  (let rec _lh_matchIdent_7 = (Lazy.force _lh_notDivBy_arg2_1) in
    (match _lh_matchIdent_7 with
      | `LH_C(_lh_notDivBy_LH_C_0_2, _lh_notDivBy_LH_C_1_2) -> 
        (if (_lh_notDivBy_LH_C_0_2 > _lh_notDivBy_arg3_1) then
          true
        else
          (let rec _lh_matchIdent_8 = (Lazy.force _lh_notDivBy_arg1_1) in
...
let rec zipWith_lz_lz_d0_d0_d0 f_2 xs_1 ys_1 =
  (lazy (match (Lazy.force xs_1) with
    ...
    | `LH_N -> 
      (`LH_N)));;
let rec enumFromThenTo_d0_d0_d0 a_3 t_1_2 b_3 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 _lh_popOutId_3_0 _lh_popOutId_4_0 =
  (if (a_3 <= b_3) then
    (let rec _lh_listcomp_fun_ls_h_1_5 = a_3 in
      (let rec _lh_listcomp_fun_ls_t_2_5 = (((enumFromThenTo_d0_d0_d0 t_1_2) ((2 * t_1_2) - a_3)) b_3) in
          ...
          (match _lh_listcomp_fun_para_1_4 with
            | `LH_C(_lh_listcomp_fun_ls_h_1_6, _lh_listcomp_fun_ls_t_2_6) -> 
              (let rec _lh_listcomp_fun_4_4 = (fun _lh_listcomp_fun_para_1_5 -> 
                ((((((_lh_listcomp_fun_para_1_5 _lh_popOutId_0_1) _lh_popOutId_1_1) _lh_popOutId_3_0) _lh_listcomp_fun_4_4) _lh_listcomp_fun_4_3) _lh_listcomp_fun_ls_t_2_6)) in
                (_lh_listcomp_fun_4_4 (let rec _lh_listcomp_fun_ls_h_1_7 = (_lh_listcomp_fun_ls_h_1_6 + _lh_listcomp_fun_ls_h_1_5) in
                  (let rec _lh_listcomp_fun_ls_t_2_7 = (fun _lh_sieve_Wheel_0_1_3 _lh_sieve_arg2_1_3 _lh_sieve_arg3_1_3 _lh_listcomp_fun_4_5 _lh_listcomp_fun_4_6 _lh_listcomp_fun_ls_t_2_8 -> 
                    (_lh_listcomp_fun_4_6 _lh_listcomp_fun_ls_t_2_8)) in
                    (fun _lh_sieve_Wheel_0_1_4 _lh_sieve_arg2_1_4 _lh_sieve_arg3_1_4 _lh_listcomp_fun_4_7 _lh_listcomp_fun_4_8 _lh_listcomp_fun_ls_t_2_9 -> 
                      (if ((((noFactor_d0_d0_d0 _lh_sieve_Wheel_0_1_4) _lh_sieve_arg2_1_4) _lh_sieve_arg3_1_4) _lh_listcomp_fun_ls_h_1_7) then
                        (let rec _lh_append_lz_LH_C_0_3 = _lh_listcomp_fun_ls_h_1_7 in
                          (let rec _lh_append_lz_LH_C_1_3 = (_lh_listcomp_fun_4_7 _lh_listcomp_fun_ls_t_2_7) in
                            (fun _lh_append_lz_arg2_7 -> 
                              (lazy (`LH_C(_lh_append_lz_LH_C_0_3, ((append_lz_d0_d0_d2 _lh_append_lz_LH_C_1_3) _lh_append_lz_arg2_7)))))))
                      else
                        (_lh_listcomp_fun_4_7 _lh_listcomp_fun_ls_t_2_7)))))))
            | `LH_N -> 
              (_lh_popOutId_4_0 _lh_listcomp_fun_ls_t_2_5))) in
          (_lh_listcomp_fun_4_3 _lh_popOutId_2_1))))
  else
    (fun _lh_append_lz_arg2_8 -> 
      (Lazy.force _lh_append_lz_arg2_8)))
  ...
  (match _lh_nextSize_arg1_1 with
    | `Wheel(_lh_nextSize_Wheel_0_1, _lh_nextSize_Wheel_1_5) -> 
      (`Wheel((_lh_nextSize_Wheel_0_1 * _lh_nextSize_arg2_9), (let rec _lh_listcomp_fun_3_3 = (fun _lh_listcomp_fun_para_1_0 -> 
        (((_lh_listcomp_fun_para_1_0 _lh_nextSize_arg2_9) _lh_nextSize_Wheel_1_5) _lh_listcomp_fun_3_3)) in
...
and prime_d0_d0_d0 _lh_prime_arg1_1 =
  ((atIndex_d0_d0_d0 _lh_prime_arg1_1) (primes_d0_d0_d0 _lh_prime_arg1_1))
and sieve_d0_d0_d0 _lh_sieve_arg1_1 _lh_sieve_arg2_8 _lh_sieve_arg3_8 _lh_sieve_arg4_1 =
  (lazy (let rec _lh_matchIdent_6 = (Lazy.force _lh_sieve_arg1_1) in
    (match _lh_matchIdent_6 with
      | `LH_C(_lh_sieve_LH_C_0_1, _lh_sieve_LH_C_1_1) -> 
        (match _lh_sieve_LH_C_0_1 with
          | `Wheel(_lh_sieve_Wheel_0_8, _lh_sieve_Wheel_1_4) -> 
            ((append_lz_d0_d0_d0 (let rec _lh_listcomp_fun_3_4 = (fun _lh_listcomp_fun_para_1_1 -> 
              (((((_lh_listcomp_fun_para_1_1 _lh_sieve_Wheel_0_8) _lh_sieve_arg2_8) _lh_sieve_Wheel_1_4) _lh_sieve_arg3_8) _lh_listcomp_fun_3_4)) in
              (_lh_listcomp_fun_3_4 (let rec _lh_listcomp_fun_ls_h_1_2 = _lh_sieve_Wheel_0_8 in
                (let rec _lh_listcomp_fun_ls_t_2_0 = (((enumFromThenTo_d0_d0_d0 (_lh_sieve_Wheel_0_8 * 2)) (_lh_sieve_Wheel_0_8 * 3)) (((min_d0_d0_d0 (_lh_sieve_arg4_1 * _lh_sieve_arg4_1)) ((head_d0_d0_d0 _lh_sieve_arg2_8) - 1)) * _lh_sieve_Wheel_0_8)) in
                  (fun _lh_sieve_Wheel_0_9 _lh_sieve_arg2_9 _lh_sieve_Wheel_1_5 _lh_sieve_arg3_9 _lh_listcomp_fun_3_5 -> 
                    (let rec _lh_listcomp_fun_3_6 = (fun _lh_listcomp_fun_para_1_2 -> 
                      (match _lh_listcomp_fun_para_1_2 with
                        | `LH_C(_lh_listcomp_fun_ls_h_1_3, _lh_listcomp_fun_ls_t_2_1) -> 
                          (let rec _lh_listcomp_fun_3_7 = (fun _lh_listcomp_fun_para_1_3 -> 
                            ((((((_lh_listcomp_fun_para_1_3 _lh_sieve_Wheel_0_9) _lh_sieve_arg2_9) _lh_sieve_arg3_9) _lh_listcomp_fun_3_7) _lh_listcomp_fun_3_6) _lh_listcomp_fun_ls_t_2_1)) in
                            (_lh_listcomp_fun_3_7 (let rec _lh_listcomp_fun_ls_h_1_4 = (_lh_listcomp_fun_ls_h_1_3 + _lh_listcomp_fun_ls_h_1_2) in
                              (let rec _lh_listcomp_fun_ls_t_2_2 = (fun _lh_sieve_Wheel_0_1_0 _lh_sieve_arg2_1_0 _lh_sieve_arg3_1_0 _lh_listcomp_fun_3_8 _lh_listcomp_fun_3_9 _lh_listcomp_fun_ls_t_2_3 -> 
                                (_lh_listcomp_fun_3_9 _lh_listcomp_fun_ls_t_2_3)) in
                                (fun _lh_sieve_Wheel_0_1_1 _lh_sieve_arg2_1_1 _lh_sieve_arg3_1_1 _lh_listcomp_fun_4_0 _lh_listcomp_fun_4_1 _lh_listcomp_fun_ls_t_2_4 -> 
                                  (if ((((noFactor_d0_d0_d1 _lh_sieve_Wheel_0_1_1) _lh_sieve_arg2_1_1) _lh_sieve_arg3_1_1) _lh_listcomp_fun_ls_h_1_4) then
                                    (let rec _lh_append_lz_LH_C_0_2 = _lh_listcomp_fun_ls_h_1_4 in
                                      (let rec _lh_append_lz_LH_C_1_2 = (_lh_listcomp_fun_4_0 _lh_listcomp_fun_ls_t_2_2) in
                                        (fun _lh_append_lz_arg2_6 -> 
                                          (lazy (`LH_C(_lh_append_lz_LH_C_0_2, ((append_lz_d0_d0_d1 _lh_append_lz_LH_C_1_2) _lh_append_lz_arg2_6)))))))
                                  else
                                    (_lh_listcomp_fun_4_0 _lh_listcomp_fun_ls_t_2_2)))))))
                        | `LH_N -> 
                          (_lh_listcomp_fun_3_5 _lh_listcomp_fun_ls_t_2_0))) in
                      (_lh_listcomp_fun_3_6 _lh_sieve_Wheel_1_5)))))))) (lazy ((((sieve_d0_d0_d0 _lh_sieve_LH_C_1_1) (tail_d0_d0_d0 _lh_sieve_arg2_8)) (tail_d1_d0_d0 _lh_sieve_arg3_8)) _lh_sieve_arg4_1)))
          | _ -> 
            (failwith "error"))
      | _ -> 
        (failwith "error"))))

...
let rec eval_lh__d1 _lh_eval_arg1_0 =
  (if (_lh_eval_arg1_0 = 3) then
    (fun _lh_interpret_LH_C_1_0 _lh_interpret_arg1_1 -> 
      (`XWin))
  else
    (if (_lh_eval_arg1_0 = (0 - 3)) then
      (fun _lh_interpret_LH_C_1_1 _lh_interpret_arg1_2 -> 
        (`OWin))
    else
      (let rec _lh_interpret_Score_0_0 = _lh_eval_arg1_0 in
        (fun _lh_interpret_LH_C_1_2 _lh_interpret_arg1_3 -> 
          ((interpret_lh__d1 (_lh_interpret_arg1_3 + _lh_interpret_Score_0_0)) _lh_interpret_LH_C_1_2)))));;
let rec enumFromTo_lh__d2 a_1 b_2 =
  (if (a_1 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo_lh__d2 (a_1 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_1 in
        (fun _lh_listcomp_fun_ls_h_4 _lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_4 _lh_listcomp_fun_7 -> 
          (let rec t_1_1_4 = (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_3) in
            (let rec h_9_7 = (`LH_P2(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_h_3)) in
              (fun f_2_4 -> 
    ...
    (fun _lh_listcomp_fun_ls_h_5 _lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_5 _lh_listcomp_fun_9 -> 
...
let rec empty_lh__d1 _lh_empty_arg1_0 _lh_empty_arg2_0 =
  (match _lh_empty_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec enumFromTo_lh__d0 a_2 b_3 =
  (if (a_2 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_6 = ((enumFromTo_lh__d0 (a_2 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_6 = a_2 in
        (fun _lh_listcomp_fun_ls_h_7 _lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_7 _lh_listcomp_fun_1_1 -> 
          (let rec t_1_3_1 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_6) in
            (let rec h_1_1_2 = (`LH_P2(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_h_6)) in
              (fun f_2_6 -> 
    ...
    (fun _lh_listcomp_fun_ls_h_8 _lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_8 _lh_listcomp_fun_1_3 -> 
      (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_8)));;
      ...
      (match _lh_map2_arg3_5 with
        ...
        | _ -> 
          (match _lh_map2_arg2_5 with
            ...
            | _ -> 
              (failwith "error"))));;
let rec eval_lh__d0 _lh_eval_arg1_2 =
    ...
    (if (_lh_eval_arg1_2 = (0 - 3)) then
      ...
      (let rec _lh_interpret_Score_0_2 = _lh_eval_arg1_2 in
        (fun _lh_interpret_LH_C_1_1_6 _lh_interpret_arg1_1_8 -> 
          ((interpret_lh__d0 (_lh_interpret_arg1_1_8 + _lh_interpret_Score_0_2)) _lh_interpret_LH_C_1_1_6)))));;
let rec wins_lh__d0 =
...
let rec map_lh__d2 f_3_3 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_1_4_8, t_1_7_3) -> 
      (let rec t_1_7_4 = ((map_lh__d2 f_3_3) t_1_7_3) in
        (let rec h_1_4_9 = (f_3_3 h_1_4_8) in
          (fun f_3_4 i_1 -> 
            ((f_3_4 h_1_4_9) (((foldr_lh__d0 f_3_4) i_1) t_1_7_4)))))
    | `LH_N -> 
      (fun f_3_5 i_2 -> 
        i_2));;
let rec eval_lh__d2 _lh_eval_arg1_1 =
    ...
    (if (_lh_eval_arg1_1 = (0 - 3)) then
      ...
      (let rec _lh_interpret_Score_0_1 = _lh_eval_arg1_1 in
        (fun _lh_interpret_LH_C_1_1_3 _lh_interpret_arg1_1_5 -> 
          ((interpret_lh__d2 (_lh_interpret_arg1_1_5 + _lh_interpret_Score_0_1)) _lh_interpret_LH_C_1_1_3)))));;
    ...
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo_lh__d4 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (fun _lh_listcomp_fun_ls_h_1 _lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_1 _lh_listcomp_fun_1 -> 
          (let rec t_8_5 = (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0) in
            (let rec h_7_3 = (`LH_P2(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_h_0)) in
              (fun f_1_0 -> 
...
let rec enumFromTo_lh__d3 a_5 b_6 =
  (if (a_5 <= b_6) then
    ...
    (fun _lh_listcomp_fun_2_3 f_4_8 _lh_dummy_7_8 f_4_9 -> 
      (`LH_N)));;
  ...
  (if (not ((empty_lh__d1 _lh_placePiece_arg3_0) _lh_placePiece_arg2_0)) then
    ...
    (let rec _lh_matchIdent_0 = _lh_placePiece_arg2_0 in
      (match _lh_matchIdent_0 with
        ...
        | _ -> 
          (failwith "error"))));;
let rec enumFromTo_lh__d1 a_3 b_4 =
  (if (a_3 <= b_4) then
      ...
      (let rec _lh_listcomp_fun_ls_h_9 = a_3 in
        (fun _lh_listcomp_fun_1_4 -> 
          (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_2 -> 
            ((((_lh_listcomp_fun_para_2 _lh_listcomp_fun_ls_h_9) _lh_listcomp_fun_1_5) _lh_listcomp_fun_ls_t_9) _lh_listcomp_fun_1_4)) in
            (_lh_listcomp_fun_1_5 ((enumFromTo_lh__d0 1) 3))))))
  else
    (fun _lh_listcomp_fun_1_6 f_4_0 _lh_dummy_4_9 f_4_1 -> 
      (`LH_N)));;
...
let rec enumFromTo_lh__d5 a_4 b_5 =
  (if (a_4 <= b_5) then
    ...
    (fun _lh_listcomp_fun_2_0 f_4_2 _lh_dummy_7_4 -> 
      (`LH_N)));;

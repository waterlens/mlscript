...
let rec append_lz_d0_d0_d0 _lh_append_lz_arg1_2 _lh_append_lz_arg2_5 =
  (let rec _lh_matchIdent_6 = _lh_append_lz_arg1_2 in
    (_lh_matchIdent_6 _lh_append_lz_arg2_5));;
...
let rec append_lz_d1_d0_d0 _lh_append_lz_arg1_3 _lh_append_lz_arg2_6 =
  (let rec _lh_matchIdent_7 = _lh_append_lz_arg1_3 in
    (match _lh_matchIdent_7 with
      | `LH_C(_lh_append_lz_LH_C_0_3, _lh_append_lz_LH_C_1_3) -> 
        (lazy (`LH_C(_lh_append_lz_LH_C_0_3, ((append_lz_d1_d0_d0 _lh_append_lz_LH_C_1_3) _lh_append_lz_arg2_6))))
      | `LH_N -> 
...
let rec concat_lz_d0_d0_d1 _lh_concat_lz_arg1_1 =
  (lazy (let rec _lh_matchIdent_8 = (Lazy.force _lh_concat_lz_arg1_1) in
    (_lh_matchIdent_8 99)));;
let rec enumFromThen_d0_d0_d0 a_2 t_1_2 =
  (lazy (`LH_C(a_2, ((enumFromThen_d0_d0_d0 t_1_2) ((2 * t_1_2) - a_2)))));;
let rec head_lz_d0_d0_d0 ls_7 =
  (match (Lazy.force ls_7) with
    | `LH_C(h_6, t_7) -> 
      h_6
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_d0_d0_d0 f_8 ls_1_1 =
  (lazy ((Lazy.force ls_1_1) f_8));;
let rec map_lz_d0_d0_d1 f_4 ls_6 =
  (lazy ((Lazy.force ls_6) f_4));;
let rec map_lz_d1_d0_d0 f_5 ls_9 =
  (lazy (match (Lazy.force ls_9) with
    | `LH_C(h_8, t_9) -> 
      (`LH_C((f_5 h_8), ((map_lz_d1_d0_d0 f_5) t_9)))
    | `LH_N -> 
      (`LH_N)));;
...
let rec take_lz_d0_d0_d0 n_1 ls_1_0 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_1_0) with
      | `LH_C(h_9, t_1_0) -> 
        (`LH_C(h_9, ((take_lz_d0_d0_d0 (n_1 - 1)) t_1_0)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
and iterate_d0_d0_d0 f_6 x_1 =
  (lazy (let rec h_1_0 = x_1 in
    (let rec t_1_1 = ((iterate_d0_d0_d0 f_6) (f_6 x_1)) in
      (fun f_7 -> 
        (let rec _lh_concat_lz_LH_C_0_1 = (f_7 h_1_0) in
          (let rec _lh_concat_lz_LH_C_1_1 = ((map_lz_d0_d0_d0 f_7) t_1_1) in
            (fun _lh_dummy_1 -> 

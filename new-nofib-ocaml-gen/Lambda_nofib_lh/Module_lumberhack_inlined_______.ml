...
ppn_lh__d1 _lh_ppn_arg1_1 _lh_ppn_arg2_1 =
  (match _lh_ppn_arg2_1 with
    ...
    | `Lam(_lh_ppn_Lam_0_1, _lh_ppn_Lam_1_1) -> 
      (((bracket_lh__d3 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d6 ((mappend_lh__d2_d6 ((let rec t_3_2 = (fun ys_3_7 -> 
        ys_3_7) in
        (let rec h_3_1 = '@' in
          (fun ys_3_8 -> 
            (`LH_C(h_3_1, (t_3_2 ys_3_8)))))) _lh_ppn_Lam_0_1)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) ((ppn_lh__d1 (0 - 1)) _lh_ppn_Lam_1_1)))
    ...
    | `Thunk(_lh_ppn_Thunk_0_1, _lh_ppn_Thunk_1_1) -> 
      (((bracket_lh__d1 _lh_ppn_arg1_1) 0) (((mappend_lh__d2_d5 ((ppn_lh__d1 3) _lh_ppn_Thunk_0_1)) (let rec t_3_3 = (let rec t_3_4 = (fun ys_3_9 -> 
        ys_3_9) in
        (let rec h_3_2 = ':' in
          (fun ys_4_0 -> 
            (`LH_C(h_3_2, (t_3_4 ys_4_0)))))) in
        (let rec h_3_3 = ':' in
          (fun ys_4_1 -> 
            (`LH_C(h_3_3, (t_3_3 ys_4_1))))))) (ppenv_lh__d2 _lh_ppn_Thunk_1_1)))
    | _ -> 
      (failwith "error"));;
    ...
    | `LH_C(h_9, t_9) -> 
      (let rec t_1_0 = ((mappend_lh__d1_d9 t_9) ys_9) in
        (let rec h_1_0 = h_9 in
          (fun ys_1_0 -> 
            (`LH_C(h_1_0, (t_1_0 ys_1_0))))))
    | `LH_N -> 
      ys_9);;
let rec ppenv_lh__d1 _lh_ppenv_arg1_0 =
  ((mappend_lh__d2_d1 ((let rec t_2_2 = (fun ys_2_2 -> 
    ys_2_2) in
    (let rec h_2_1 = '[' in
      (fun ys_2_3 -> 
        (`LH_C(h_2_1, (t_2_2 ys_2_3)))))) ((flatMap_lh__d1 (fun vt_0 -> 
    (let rec _lh_matchIdent_3 = vt_0 in
      (match _lh_matchIdent_3 with
        | `LH_P2(_lh_ppenv_LH_P2_0_0, _lh_ppenv_LH_P2_1_0) -> 
          ((mappend_lh__d1_d8 (((mappend_lh__d1_d9 _lh_ppenv_LH_P2_0_0) (let rec t_2_3 = (fun ys_2_4 -> 
            ys_2_4) in
            (let rec h_2_2 = '=' in
              (fun ys_2_5 -> 
                (`LH_C(h_2_2, (t_2_3 ys_2_5))))))) (pp_lh__d8 _lh_ppenv_LH_P2_1_0))) (`LH_C(',', (`LH_C(' ', (`LH_N))))))
        | _ -> 
    ...
    (let rec _lh_matchIdent_5 = envt2_0 in
      (match _lh_matchIdent_5 with
        | `LH_P2(_lh_ev_LH_P2_0_0, _lh_ev_LH_P2_1_0) -> 
          (((mappend_lh__d5 (pp_lh__d3 _lh_ev_LH_P2_1_0)) (let rec t_2_8 = (let rec t_2_9 = (fun ys_3_2 -> 
            ys_3_2) in
            (let rec h_2_7 = ' ' in
              (fun ys_3_3 -> 
                (`LH_C(h_2_7, (t_2_9 ys_3_3)))))) in
            (let rec h_2_8 = ' ' in
              (fun ys_3_4 -> 
                (`LH_C(h_2_8, (t_2_8 ys_3_4))))))) (ppenv_lh__d1 _lh_ev_LH_P2_0_0))
        | _ -> 
          (failwith "error"))));;
...
let rec showTerm_lh__d1 _lh_showTerm_arg1_0 =
  (match _lh_showTerm_arg1_0 with
    | `Con(_lh_showTerm_Con_0_0) -> 
      ((let rec t_1_1 = (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (fun ys_1_1 -> 
        ys_1_1) in
        (let rec h_1_1 = ' ' in
          (fun ys_1_2 -> 
            (`LH_C(h_1_1, (t_1_4 ys_1_2)))))) in
        (let rec h_1_2 = 'n' in
          (fun ys_1_3 -> 
            (`LH_C(h_1_2, (t_1_3 ys_1_3)))))) in
        (let rec h_1_3 = 'o' in
          (fun ys_1_4 -> 
            (`LH_C(h_1_3, (t_1_2 ys_1_4)))))) in
        (let rec h_1_4 = 'C' in
          (fun ys_1_5 -> 
            (`LH_C(h_1_4, (t_1_1 ys_1_5)))))) (string_of_int _lh_showTerm_Con_0_0))
    | _ -> 
      ((failwith "error") (`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;

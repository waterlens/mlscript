(*
ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./MapQrev.ml -o "./MapQrev.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./MapQrev.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;
...
let rec qrev_d0 a_1 ys_0 =
  (match ys_0 with
    | `C(h_0, t_0) -> 
      ((qrev_d0 (let rec h_1 = (lazy h_0) in
        (let rec t_1 = (lazy a_1) in
          (fun f_1 -> 
            (`C((f_1 (Lazy.force h_1)), ((map_d0 f_1) (Lazy.force t_1)))))))) t_0)
    | `N -> 
      a_1)
...
let rec qrev_d0_d0 a_2 ys_1 =
  (match ys_1 with
    | `C(h_2, t_2) -> 
      ((qrev_d0_d0 (let rec h_3 = (lazy h_2) in
        (let rec t_3 = (lazy a_2) in
          (fun f_5 -> 
            (`C((f_5 (Lazy.force h_3)), ((map_d0_d1 f_5) (Lazy.force t_3)))))))) t_2)
    | `N -> 
      a_2)

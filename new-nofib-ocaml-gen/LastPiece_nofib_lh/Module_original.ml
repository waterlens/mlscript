...
and extend_lh _lh_extend_arg1_0 _lh_extend_arg2_0 _lh_extend_arg3_0 =
  (((insert_lh _lh_extend_arg2_0) _lh_extend_arg3_0) _lh_extend_arg1_0)
and extend_maybe_lh _lh_extend_maybe_arg1_0 _lh_extend_maybe_arg2_0 _lh_extend_maybe_arg3_0 =
  (match _lh_extend_maybe_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and fit_lh _lh_fit_arg1_0 _lh_fit_arg2_0 _lh_fit_arg3_0 _lh_fit_arg4_0 =
  (match _lh_fit_arg4_0 with
    ...
    | _ -> 
      (failwith "error"))
and initialPieces_lh _lh_initialPieces_arg1_0 =
...
and insert_lh _lh_insert_arg1_0 _lh_insert_arg2_0 _lh_insert_arg3_0 =
  (match _lh_insert_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and mapLookup_lh _lh_mapLookup_arg1_0 _lh_mapLookup_arg2_0 =
  (match _lh_mapLookup_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and search_lh _lh_search_arg1_0 _lh_search_arg2_0 _lh_search_arg3_0 _lh_search_arg4_0 =
  (match _lh_search_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and testLastPiece_nofib_lh _lh_testLastPiece_nofib_arg1_0 =

...
let rec fst_lh__d4 _lh_fst_arg1_0 =
  (match _lh_fst_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1_d3 f_1 ls_2 =
  (match ls_2 with
    | `LH_C(h_2, t_3) -> 
      (`LH_C((f_1 h_2), ((map_lh__d1_d3 f_1) t_3)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d7 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_9, t_1_4) -> 
      (`LH_C(h_9, ((mappend_lh__d7 t_1_4) ys_0)))
    | `LH_N -> 
      ys_0);;
...
let rec stand_eqn_lh__d3 _lh_stand_eqn_arg1_0 _lh_stand_eqn_arg2_0 =
  (match _lh_stand_eqn_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d3 f_1_9 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_2_4, t_3_1) -> 
      (`LH_C((f_1_9 h_2_4), ((map_lh__d3 f_1_9) t_3_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec simplify_lh__d5 _lh_simplify_arg1_0 =
  (let rec f_2 = (fun t_4 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_2) (_lh_simplify_arg1_0 t_4))) t_4)) in
    f_2);;
...
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_3, t_5) -> 
      ((mappend_lh__d7 h_3) (concat_lh__d1 t_5))
    | `LH_N -> 
      (`LH_N));;
...
let rec simplify_lh__d4 _lh_simplify_arg1_1 =
  (let rec f_5 = (fun t_8 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_5) (_lh_simplify_arg1_1 t_8))) t_8)) in
    f_5);;
...
let rec quant_lh__d5 _lh_quant_arg1_5 _lh_quant_arg2_5 _lh_quant_arg3_5 _lh_quant_arg4_5 =
  (let rec p_5 = (fun x_1_2 -> 
    ((_lh_quant_arg2_5 x_1_2) _lh_quant_arg3_5)) in
    ((_lh_quant_arg1_5 p_5) _lh_quant_arg4_5));;
let rec simplify_lh__d1 _lh_simplify_arg1_4 =
  (let rec f_1_6 = (fun t_2_6 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_1_6) (_lh_simplify_arg1_4 t_2_6))) t_2_6)) in
    f_1_6);;
let rec map_lh__d9 f_9 ls_7 =
  (match ls_7 with
    | `LH_C(h_8, t_1_2) -> 
      (`LH_C((f_9 h_8), ((map_lh__d9 f_9) t_1_2)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d3 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_2_2, t_2_9) -> 
      (`LH_C(h_2_2, ((mappend_lh__d3 t_2_9) ys_5)))
    | `LH_N -> 
      ys_5);;
...
let rec foldl_lh__d1 f_3 i_0 ls_3 =
  (match ls_3 with
    | `LH_C(h_4, t_6) -> 
      (((foldl_lh__d1 f_3) ((f_3 i_0) h_4)) t_6)
    | `LH_N -> 
      i_0);;
        ...
        | `Func(_lh_replace_Func_0_0, _lh_replace_Func_1_0) -> 
          (match _lh_replace_arg2_0 with
            | `LH_C(_lh_replace_LH_C_0_0, _lh_replace_LH_C_1_0) -> 
              (`Func(_lh_replace_Func_0_0, (((modify_lh__d1 _lh_replace_Func_1_0) _lh_replace_LH_C_0_0) (fun t_1_3 -> 
                (((replace_lh__d1 t_1_3) _lh_replace_LH_C_1_0) _lh_replace_arg3_0)))))
            | _ -> 
              (failwith "error"))
        | _ -> 
          (failwith "error")));;
...
let rec lift_lh__d1 _lh_lift_arg1_9 _lh_lift_arg2_9 =
  (match _lh_lift_arg2_9 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d7 f_1_4 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_1_6, t_2_2) -> 
      (`LH_C((f_1_4 h_1_6), ((map_lh__d7 f_1_4) t_2_2)))
    | `LH_N -> 
      (`LH_N));;
  ...
  (match _lh_cost_arg1_0 with
    | `LH_P2(_lh_cost_LH_P2_0_0, _lh_cost_LH_P2_1_0) -> 
      (let rec size_0 = (fun _lh_size_arg1_0 -> 
        (((expr_fold_lh__d1 (fun x_8 a_0 -> 
          ((sum_lh__d1 a_0) + 1))) (fun dum_2 -> 
...
let rec foldr_lh__d2 f_1_1 i_1 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_1, t_1_6) -> 
      ((f_1_1 h_1_1) (((foldr_lh__d2 f_1_1) i_1) t_1_6))
    | `LH_N -> 
      i_1);;
...
let rec sub_lh__d3 _lh_sub_arg1_0 _lh_sub_arg2_0 =
  (((expr_fold_lh__d1 (fun x_2 y_1 -> 
    (`Func(x_2, y_1)))) (apply_lh__d1 _lh_sub_arg2_0)) _lh_sub_arg1_0);;
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
        (match _lh_listcomp_fun_ls_h_0 with
          | `LH_P2(_lh_comp_sub_LH_P2_0_0, _lh_comp_sub_LH_P2_1_0) -> 
            (`LH_C((`LH_P2(_lh_comp_sub_LH_P2_0_0, ((sub_lh__d3 _lh_comp_sub_LH_P2_1_0) _lh_comp_sub_arg1_0))), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
          | _ -> 
...
let rec mappend_lh__d1 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_2_7, t_3_4) -> 
      (`LH_C(h_2_7, ((mappend_lh__d1 t_3_4) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec map_lh__d1_d1 f_7 ls_5 =
  (match ls_5 with
    | `LH_C(h_6, t_1_0) -> 
      (`LH_C((f_7 h_6), ((map_lh__d1_d1 f_7) t_1_0)))
    | `LH_N -> 
      (`LH_N));;
let rec simplify_lh__d3 _lh_simplify_arg1_2 =
  (let rec f_6 = (fun t_9 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_6) (_lh_simplify_arg1_2 t_9))) t_9)) in
    f_6);;
    ...
    | `Eqn(_lh_rewrite_Eqn_0_0, _lh_rewrite_Eqn_1_0) -> 
      (match _lh_rewrite_Eqn_1_0 with
        | `LH_P2(_lh_rewrite_LH_P2_0_0, _lh_rewrite_LH_P2_1_0) -> 
          (fun _lh_funcomp_x_2 -> 
            ((lift_lh__d1_d0 (sub_lh__d3 _lh_rewrite_LH_P2_1_0)) ((match_lh__d1 _lh_rewrite_LH_P2_0_0) _lh_funcomp_x_2)))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_t_3) -> 
        (match _lh_listcomp_fun_ls_h_3 with
          | `LH_P2(_lh_inside_LH_P2_0_0, _lh_inside_LH_P2_1_0) -> 
            (`LH_C(((lift_lh__d1_d0 ((replace_lh__d1 _lh_inside_arg2_0) _lh_inside_LH_P2_0_0)) (_lh_inside_arg1_0 _lh_inside_LH_P2_1_0)), (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_3)))
          | _ -> 
...
let rec squash_lh__d2 _lh_squash_arg1_0 =
  (match _lh_squash_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec foldr_lh__d1 f_1_3 i_2 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_5, t_2_1) -> 
      ((f_1_3 h_1_5) (((foldr_lh__d1 f_1_3) i_2) t_2_1))
    | `LH_N -> 
      i_2);;
...
let rec mappend_lh__d2 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_2_5, t_3_2) -> 
      (`LH_C(h_2_5, ((mappend_lh__d2 t_3_2) ys_6)))
    | `LH_N -> 
      ys_6);;
...
let rec quant_lh__d1_d0 _lh_quant_arg1_0 _lh_quant_arg2_0 _lh_quant_arg3_0 _lh_quant_arg4_0 =
  (let rec p_0 = (fun x_4 -> 
    ((_lh_quant_arg2_0 x_4) _lh_quant_arg3_0)) in
...
let rec mappend_lh__d5 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_1_8, t_2_4) -> 
      (`LH_C(h_1_8, ((mappend_lh__d5 t_2_4) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec quant_lh__d2 _lh_quant_arg1_8 _lh_quant_arg2_8 _lh_quant_arg3_8 _lh_quant_arg4_8 =
  (let rec p_8 = (fun x_1_5 -> 
    ((_lh_quant_arg2_8 x_1_5) _lh_quant_arg3_8)) in
...
let rec quant_lh__d9 _lh_quant_arg1_1 _lh_quant_arg2_1 _lh_quant_arg3_1 _lh_quant_arg4_1 =
  (let rec p_1 = (fun x_5 -> 
    ((_lh_quant_arg2_1 x_5) _lh_quant_arg3_1)) in
...
let rec mappend_lh__d6 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_1_3, t_1_8) -> 
      (`LH_C(h_1_3, ((mappend_lh__d6 t_1_8) ys_1)))
    | `LH_N -> 
      ys_1);;
let rec any_lh__d4 _lh_any_arg1_1 _lh_any_arg2_1 =
  (match _lh_any_arg2_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec atIndex_lh__d3 n_0 ls_1_1 =
  (if (n_0 < 0) then
    (failwith "error")
  else
    (match ls_1_1 with
      | `LH_C(h_1_2, t_1_7) -> 
        (if (n_0 = 0) then
          ...
          ((atIndex_lh__d3 (n_0 - 1)) t_1_7))
      | `LH_N -> 
        (failwith "error")));;
let rec map_lh__d6 f_1_5 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_1_7, t_2_3) -> 
      (`LH_C((f_1_5 h_1_7), ((map_lh__d6 f_1_5) t_2_3)))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d1_d2 f_4 ls_4 =
  (match ls_4 with
    | `LH_C(h_5, t_7) -> 
      (`LH_C((f_4 h_5), ((map_lh__d1_d2 f_4) t_7)))
    | `LH_N -> 
      (`LH_N));;
let rec sub_lh__d1 _lh_sub_arg1_2 _lh_sub_arg2_2 =
  (((expr_fold_lh__d1 (fun x_1_1 y_3 -> 
    (`Func(x_1_1, y_3)))) (apply_lh__d1 _lh_sub_arg2_2)) _lh_sub_arg1_2);;
let rec mappend_lh__d4 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_1_9, t_2_5) -> 
      (`LH_C(h_1_9, ((mappend_lh__d4 t_2_5) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec map_lh__d2 f_2_0 ls_2_1 =
  (match ls_2_1 with
    | `LH_C(h_2_8, t_3_5) -> 
      (`LH_C((f_2_0 h_2_8), ((map_lh__d2 f_2_0) t_3_5)))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d1 f_2_1 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_2_9, t_3_6) -> 
      (`LH_C((f_2_1 h_2_9), ((map_lh__d1 f_2_1) t_3_6)))
    | `LH_N -> 
      (`LH_N));;
...
let rec try_all_lh__d1 _lh_try_all_arg1_0 =
  (((foldr_lh__d2 orElseMap_lh__d4) (fun dum_1 -> 
...
let rec simplify_lh__d2 _lh_simplify_arg1_3 =
  (let rec f_1_2 = (fun t_2_0 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_1_2) (_lh_simplify_arg1_3 t_2_0))) t_2_0)) in
    f_1_2);;
...
let rec map_lh__d5 f_1_7 ls_1_6 =
  (match ls_1_6 with
    | `LH_C(h_2_0, t_2_7) -> 
      (`LH_C((f_1_7 h_2_0), ((map_lh__d5 f_1_7) t_2_7)))
    | `LH_N -> 
      (`LH_N));;
...
let rec quant_lh__d6 _lh_quant_arg1_4 _lh_quant_arg2_4 _lh_quant_arg3_4 _lh_quant_arg4_4 =
  (let rec p_4 = (fun x_1_0 -> 
    ((_lh_quant_arg2_4 x_1_0) _lh_quant_arg3_4)) in
...
let rec map_dnet_lh__d1 _lh_map_dnet_arg1_0 _lh_map_dnet_arg2_0 =
  (match _lh_map_dnet_arg2_0 with
    | `Switch(_lh_map_dnet_Switch_0_0, _lh_map_dnet_Switch_1_0) -> 
      (`Switch(((map_lh__d1_d3 ((cross_lh__d3 (fun x_1 -> 
...
let rec quant_lh__d8 _lh_quant_arg1_2 _lh_quant_arg2_2 _lh_quant_arg3_2 _lh_quant_arg4_2 =
  (let rec p_2 = (fun x_6 -> 
    ((_lh_quant_arg2_2 x_6) _lh_quant_arg3_2)) in
    ((_lh_quant_arg1_2 p_2) _lh_quant_arg4_2));;
let rec map_lh__d4 f_1_8 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_2_3, t_3_0) -> 
      (`LH_C((f_1_8 h_2_3), ((map_lh__d4 f_1_8) t_3_0)))
    | `LH_N -> 
      (`LH_N));;
...
let rec quant_lh__d3 _lh_quant_arg1_7 _lh_quant_arg2_7 _lh_quant_arg3_7 _lh_quant_arg4_7 =
  (let rec p_7 = (fun x_1_4 -> 
    ((_lh_quant_arg2_7 x_1_4) _lh_quant_arg3_7)) in
...
let rec update_alist_lh__d1 _lh_update_alist_arg1_0 _lh_update_alist_arg2_0 _lh_update_alist_arg3_0 =
  (let rec upd_0 = (fun ls_8 -> 
    (let rec _lh_matchIdent_0 = ls_8 in
...
let rec sift_lh__d1 _lh_sift_arg1_1 =
  ((fun _lh_funcomp_x_1 -> 
    (concat_lh__d1 ((map_lh__d1_d3 listify_lh__d1) _lh_funcomp_x_1))) _lh_sift_arg1_1);;
...
let rec map_lh__d1_d0 f_8 ls_6 =
  (match ls_6 with
    | `LH_C(h_7, t_1_1) -> 
      (`LH_C((f_8 h_7), ((map_lh__d1_d0 f_8) t_1_1)))
    | `LH_N -> 
      (`LH_N));;
let rec atIndex_lh__d2 n_1 ls_1_2 =
  (if (n_1 < 0) then
    (failwith "error")
  else
    (match ls_1_2 with
      | `LH_C(h_1_4, t_1_9) -> 
        (if (n_1 = 0) then
          ...
          ((atIndex_lh__d2 (n_1 - 1)) t_1_9))
      | `LH_N -> 
        (failwith "error")));;
let rec sub_lh__d2 _lh_sub_arg1_1 _lh_sub_arg2_1 =
  (((expr_fold_lh__d1 (fun x_9 y_2 -> 
    (`Func(x_9, y_2)))) (apply_lh__d1 _lh_sub_arg2_1)) _lh_sub_arg1_1);;
let rec cross_lh__d1 _lh_cross_arg1_2 _lh_cross_arg2_2 _lh_cross_arg3_2 =
  (match _lh_cross_arg3_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec atIndex_lh__d1 n_2 ls_2_0 =
  (if (n_2 < 0) then
    (failwith "error")
  else
    (match ls_2_0 with
      | `LH_C(h_2_6, t_3_3) -> 
        (if (n_2 = 0) then
          ...
          ((atIndex_lh__d1 (n_2 - 1)) t_3_3))
      | `LH_N -> 
        (failwith "error")));;
let rec quant_lh__d4 _lh_quant_arg1_6 _lh_quant_arg2_6 _lh_quant_arg3_6 _lh_quant_arg4_6 =
  (let rec p_6 = (fun x_1_3 -> 
    ((_lh_quant_arg2_6 x_1_3) _lh_quant_arg3_6)) in
    ((_lh_quant_arg1_6 p_6) _lh_quant_arg4_6));;
let rec map_lh__d8 f_1_0 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_0, t_1_5) -> 
      (`LH_C((f_1_0 h_1_0), ((map_lh__d8 f_1_0) t_1_5)))
    | `LH_N -> 
      (`LH_N));;
  ...
  (match _lh_result_arg1_0 with
    | `LH_P2(_lh_result_LH_P2_0_0, _lh_result_LH_P2_1_0) -> 
      ...
      and superpose_0 = (fun _lh_superpose_arg1_0 _lh_superpose_arg2_0 -> 
        (sift_lh__d2 (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
          (match _lh_listcomp_fun_para_4 with
            | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
              (match _lh_listcomp_fun_ls_h_4 with
                | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                  (`LH_C(((lift_lh__d8 (pair_lh__d1 _lh_superpose_LH_P2_0_0)) ((unify_lh__d1 _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4)))
                | _ -> 
      ...
      and addby_0 = (fun _lh_addby_arg1_0 _lh_addby_arg2_0 _lh_addby_arg3_0 -> 
        (let rec insert_0 = (fun x_1_9 ls_2_3 -> 
          (let rec _lh_matchIdent_5 = ls_2_3 in
      ...
      and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_6 -> 
        ((lift_lh__d7 ((cross_lh__d3 _lh_build_arg1_0) (fun x_2_1 -> 
      ...
      and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
        (((orElseMap_lh__d2 p_name_0) ((seQ_0 (fun x_2_2 -> 
          ((atIndex_lh__d1 1) x_2_2))) (`LH_C((look_for_0 '('), (`LH_C(p_expr_0, (`LH_C((look_for_0 ')'), (`LH_N))))))))) _lh_p_prim_arg1_0))
      ...
      and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
        (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh__d3 (((seq2Lzq_0 (fun x_2_6 y_4 -> 
      ...
      and crit_pairs_0 = (fun _lh_crit_pairs_arg1_0 _lh_crit_pairs_arg2_0 -> 
        ((mappend_lh__d6 ((map_lh__d4 ((mk_crit_0 _lh_crit_pairs_arg1_0) _lh_crit_pairs_arg2_0)) ((superpose_0 (lhs_lh__d7 _lh_crit_pairs_arg1_0)) (lhs_lh__d5 _lh_crit_pairs_arg2_0)))) ((map_lh__d9 ((mk_crit_0 _lh_crit_pairs_arg2_0) _lh_crit_pairs_arg1_0)) ((strict_super_0 (lhs_lh__d2 _lh_crit_pairs_arg2_0)) (lhs_lh__d3 _lh_crit_pairs_arg1_0)))))
        ...
        (let rec _lh_matchIdent_1_2 = ((split_0 (reducible_0 (reduce1_lh__d1 _lh_process2_arg6_0))) _lh_process2_arg3_0) in
          (match _lh_matchIdent_1_2 with
            | `LH_P2(_lh_process2_LH_P2_0_0, _lh_process2_LH_P2_1_0) -> 
              (let rec net'_0 = ((add_eqn_0 ((delete_eqns_lh__d1 ((map_lh__d1 eqno_lh__d1) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_0)) _lh_process2_arg6_0) in
                (let rec deletions_0 = ((map_lh__d3 eqpr_lh__d1) _lh_process2_LH_P2_0_0) in
                  (let rec critical_0 = ((all_crit_pairs_0 _lh_process2_arg6_0) _lh_process2_LH_P2_1_0) in
                    (let rec new_agenda_0 = (sift_lh__d1 ((map_lh__d1_d0 (resolve_0 (super_reduce_0 net'_0))) ((mappend_lh__d3 deletions_0) critical_0))) in
                      (let rec todo'_0 = (((add_agenda_0 (snd_lh__d2 _lh_process2_arg1_0)) new_agenda_0) _lh_process2_arg5_0) in
                        (((((process_0 _lh_process2_arg1_0) _lh_process2_arg2_0) ((mappend_lh__d2 _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_0, (`LH_N))))) net'_0) todo'_0))))))
            | _ -> 
              (failwith "error"))))
          ...
          (let rec _lh_matchIdent_1_3 = xs_1_0 in
            (match _lh_matchIdent_1_3 with
              | `LH_P2(_lh_seq2_LH_P2_0_0, _lh_seq2_LH_P2_1_0) -> 
                ((lift_lh__d4 ((cross_lh__d1 (_lh_seq2_arg1_0 _lh_seq2_LH_P2_0_0)) (fun x_2_8 -> 
                  x_2_8))) (_lh_seq2_arg3_0 _lh_seq2_LH_P2_1_0))
              | _ -> 
                (failwith "error")))) in
          (fun _lh_funcomp_x_8 -> 
            ((fun _lh_funcomp_x_9 -> 
              (squash_lh__d1 ((lift_lh__d2 g_1) _lh_funcomp_x_9))) (_lh_seq2_arg2_0 _lh_funcomp_x_8)))))
      ...
      and p_expr_0 = (fun _lh_p_expr_arg1_0 -> 
        (((orElseMap_lh__d4 ((seQ_0 q_op_0) (`LH_C(p_term_0, (`LH_C(p_op_0, (`LH_C(p_term_0, (`LH_N))))))))) p_term_0) _lh_p_expr_arg1_0))
        ...
        (let rec eqn'_0 = ((stand_eqn_lh__d1 (`LH_C('1', (`LH_N)))) _lh_all_crit_pairs_arg1_0) in
          (let rec eqn''_0 = ((stand_eqn_lh__d3 (`LH_C('2', (`LH_N)))) _lh_all_crit_pairs_arg1_0) in
            (let rec theory''_0 = ((map_lh__d1_d2 (stand_eqn_lh__d2 (`LH_C('2', (`LH_N))))) _lh_all_crit_pairs_arg2_0) in
              ((mappend_lh__d1 ((map_lh__d1_d1 ((mk_crit_0 eqn'_0) eqn''_0)) ((strict_super_0 (lhs_lh__d6 eqn'_0)) (lhs_lh__d4 eqn''_0)))) (concat_lh__d1 ((map_lh__d6 (crit_pairs_0 eqn'_0)) theory''_0)))))))
      ...
      and preorder_0 = (fun _lh_preorder_arg1_0 -> 
        (if ((eqListExpr_lh__d1 _lh_preorder_arg1_0) (`LH_N)) then
          ...
          ((mappend_lh__d5 (`LH_C((g_first_0 _lh_preorder_arg1_0), (`LH_N)))) (preorder_0 (g_rest_0 _lh_preorder_arg1_0)))))
      ...
      and process_0 = (fun _lh_process_arg1_0 _lh_process_arg2_0 _lh_process_arg3_0 _lh_process_arg4_0 _lh_process_arg5_0 -> 
        (match _lh_process_arg5_0 with
          ...
          | _ -> 
            (failwith "error")))
      in (let rec group_completion_0 = ((knuth_bendix_0 ((rpo_0 (rank_order_0 rank_0)) lex_ext_0)) ((map_lh__d2 parse_eqn_0) (`LH_C((`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('c', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('(', (`LH_C('b', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('c', (`LH_C(')', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C((`LH_C('E', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('x', (`LH_N))))))))))))))))))), (`LH_C((`LH_C('I', (`LH_C('(', (`LH_C('x', (`LH_C(')', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('E', (`LH_N))))))))))))))))))))))))), (`LH_N))))))))) in
        ((eqExpr_lh__d2 ((simplify_lh__d4 (super_reduce_0 group_completion_0)) (parse_0 _lh_result_LH_P2_0_0))) (parse_0 _lh_result_LH_P2_1_0)))
    | _ -> 
      (failwith "error"));;

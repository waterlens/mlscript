...
let rec take_lh__d2__d0__d0 n_8_7 ls_7_0 =
  (if (n_8_7 > 0) then
    ...
    (`LH_N));;
let rec copy_lh__d3__d0__d0 _lh_copy_arg1_0 _lh_copy_arg2_0 =
    ...
    | _ -> 
      (let rec t_3 = ((copy_lh__d3__d0__d0 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
        (let rec h_3 = _lh_copy_arg2_0 in
          (fun f_3 -> 
            (let rec t_4 = ((map_lh__d1__d0__d0 f_3) t_3) in
              (let rec h_4 = (f_3 h_3) in
                (fun n_3 -> 
                  (`LH_C(h_4, ((take_lh__d2__d0__d0 (n_3 - 1)) t_4))))))))));;
...
let rec mappend_lh__d2__d0__d0 xs_6_3 ys_1_4_8 =
  (xs_6_3 ys_1_4_8);;
let rec copy_lh__d2__d0__d0 _lh_copy_arg1_3 _lh_copy_arg2_3 =
    ...
    | _ -> 
      (let rec t_1_2_5 = ((copy_lh__d2__d0__d0 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
        (let rec h_1_2_5 = _lh_copy_arg2_3 in
          (fun ys_1_2_5 -> 
            (let rec t_1_2_6 = ((mappend_lh__d2__d0__d0 t_1_2_5) ys_1_2_5) in
...
let rec concat_lh__d1__d1__d0 lss_0 =
  (lss_0 99);;
let rec map_lh__d4__d0__d0 f_3_3 ls_2_8 =
  (match ls_2_8 with
...
let rec foldr_lh__d1__d1__d0 f_3_4 i_3 ls_2_9 =
  ((ls_2_9 f_3_4) i_3);;
let rec map_lh__d5__d0__d0 f_4 ls_4 =
  (match ls_4 with
    | `LH_C(h_6, t_6) -> 
      (let rec t_7 = ((map_lh__d5__d0__d0 f_4) t_6) in
        (let rec h_7 = (f_4 h_6) in
          (fun f_5 i_0 -> 
            ((f_5 h_7) (((foldr_lh__d1__d1__d0 f_5) i_0) t_7)))))
    | `LH_N -> 
      (fun f_6 i_1 -> 
        i_1));;
...
let rec take_lh__d1__d0__d0 n_7_5 ls_4_9 =
  (if (n_7_5 > 0) then
    ...
    (`LH_N));;
let rec copy_lh__d1__d0__d0 _lh_copy_arg1_1 _lh_copy_arg2_1 =
    ...
    | _ -> 
      (let rec t_1_1_4 = ((copy_lh__d1__d0__d0 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
        (let rec h_1_1_4 = _lh_copy_arg2_1 in
          (fun n_5_4 -> 
            (`LH_C(h_1_1_4, ((take_lh__d1__d0__d0 (n_5_4 - 1)) t_1_1_4)))))));;

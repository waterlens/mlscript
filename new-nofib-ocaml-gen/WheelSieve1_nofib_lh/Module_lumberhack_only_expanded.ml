...
let rec append_lz__d0 _lh_append_lz_arg1_1 _lh_append_lz_arg2_1 =
  (let rec _lh_matchIdent_4 = _lh_append_lz_arg1_1 in
    (match _lh_matchIdent_4 with
      ...
      | _ -> 
        (failwith "error")));;
let rec atIndex_lz__d0 n_4 ls_2_0 =
  (if (n_4 < 0) then
    (failwith "error")
  else
    (match (Lazy.force ls_2_0) with
      ...
      | `LH_N -> 
        (failwith "error")));;
let rec enumFromThenTo__d0 a_6 t_2_6 b_3 =
  (if (a_6 <= b_3) then
    (`LH_C(a_6, (((enumFromThenTo__d0 t_2_6) ((2 * t_2_6) - a_6)) b_3)))
  else
    (`LH_N));;
let rec enumFromThenTo__d1 a_5 t_2_2 b_2 =
  (if (a_5 <= b_2) then
    (`LH_C(a_5, (((enumFromThenTo__d1 t_2_2) ((2 * t_2_2) - a_5)) b_2)))
  else
    (`LH_N));;
...
let rec map_lz__d0 f_1_2 ls_1_9 =
  (lazy (match (Lazy.force ls_1_9) with
    | `LH_C(h_2_0, t_2_3) -> 
      (`LH_C((f_1_2 h_2_0), ((map_lz__d0 f_1_2) t_2_3)))
    | `LH_N -> 
      (`LH_N)));;

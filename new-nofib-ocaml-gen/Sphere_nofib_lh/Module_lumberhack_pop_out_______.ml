...
let rec hash_lh__d1 _lh_hash_arg1_0 =
  (let rec u8_0 = (fun x_0 -> 
    ...
    (((foldr_lh__d1 (fun rgb_0 acc_0 -> 
      (let rec _lh_matchIdent_2_0 = rgb_0 in
...
let rec vecscale_lh__d3 _lh_vecscale_arg1_3 _lh_vecscale_arg2_3 =
  (match _lh_vecscale_arg1_3 with
    | `LH_P3(_lh_vecscale_LH_P3_0_3, _lh_vecscale_LH_P3_1_3, _lh_vecscale_LH_P3_2_3) -> 
      (let rec _lh_vecadd_LH_P3_2_6 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_2_3) in
        (let rec _lh_vecadd_LH_P3_1_6 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_1_3) in
          (let rec _lh_vecadd_LH_P3_0_6 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_0_3) in
            (fun _lh_vecadd_LH_P3_0_7 _lh_vecadd_LH_P3_1_7 _lh_vecadd_LH_P3_2_7 -> 
              (let rec _lh_vecsub_LH_P3_2_0 = (_lh_vecadd_LH_P3_2_7 +. _lh_vecadd_LH_P3_2_6) in
                (let rec _lh_vecsub_LH_P3_1_0 = (_lh_vecadd_LH_P3_1_7 +. _lh_vecadd_LH_P3_1_6) in
                  (let rec _lh_vecsub_LH_P3_0_0 = (_lh_vecadd_LH_P3_0_7 +. _lh_vecadd_LH_P3_0_6) in
                    (fun _lh_vecsub_LH_P3_0_1 _lh_vecsub_LH_P3_1_1 _lh_vecsub_LH_P3_2_1 -> 
                      (let rec _lh_vecadd_LH_P3_2_8 = (_lh_vecsub_LH_P3_2_1 -. _lh_vecsub_LH_P3_2_0) in
                        (let rec _lh_vecadd_LH_P3_1_8 = (_lh_vecsub_LH_P3_1_1 -. _lh_vecsub_LH_P3_1_0) in
                          (let rec _lh_vecadd_LH_P3_0_8 = (_lh_vecsub_LH_P3_0_1 -. _lh_vecsub_LH_P3_0_0) in
                            (fun _lh_vecadd_arg2_3 -> 
                              (((_lh_vecadd_arg2_3 _lh_vecadd_LH_P3_0_8) _lh_vecadd_LH_P3_1_8) _lh_vecadd_LH_P3_2_8)))))))))))))
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d4 _lh_vecscale_arg1_4 _lh_vecscale_arg2_4 =
  (match _lh_vecscale_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d3 _lh_vecadd_arg1_4 _lh_vecadd_arg2_6 =
  (_lh_vecadd_arg1_4 _lh_vecadd_arg2_6);;
let rec pi_lh__d2 =
  3.141592653589793;;
...
let rec foldr_lh__d2 f_6 i_3 ls_3 =
  (match ls_3 with
    | `LH_C(h_1_0, t_1_2) -> 
      ((f_6 h_1_0) (((foldr_lh__d2 f_6) i_3) t_1_2))
    | `LH_N -> 
      i_3);;
let rec mappend_lh__d1 xs_1 ys_7 =
  (xs_1 ys_7);;
let rec head_lh__d3 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_6, t_1_8) -> 
      h_1_6
    | `LH_N -> 
          ...
          | `Reflect(_lh_reflectsurf_Reflect_0_0) -> 
            (let rec t_5 = (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_2) in
              (let rec h_3 = _lh_reflectsurf_Reflect_0_0 in
                (fun ys_5 -> 
                  (`LH_C(h_3, ((mappend_lh__d4 t_5) ys_5))))))
          | _ -> 
...
let rec vecnorm_lh__d4 _lh_vecnorm_arg1_1 =
  (match _lh_vecnorm_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecsub_lh__d4 _lh_vecsub_arg1_3 _lh_vecsub_arg2_4 =
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
        (match _lh_listcomp_fun_ls_h_1 with
          | `Specpow(_lh_specpowsurf_Specpow_0_0) -> 
            (let rec t_4 = (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1) in
              (let rec h_2 = _lh_specpowsurf_Specpow_0_0 in
                (fun ys_2 -> 
                  (`LH_C(h_2, ((mappend_lh__d4 t_4) ys_2))))))
          | _ -> 
...
let rec bodysurf_lh__d1 _lh_bodysurf_arg1_0 =
  (head_lh__d6 ((mappend_lh__d4 (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_6 -> 
        ...
        (match _lh_listcomp_fun_ls_h_8 with
          | `Body(_lh_bodysurf_Body_0_0) -> 
            (let rec t_1_1 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_8) in
              (let rec h_9 = _lh_bodysurf_Body_0_0 in
                (fun ys_1_2 -> 
                  (`LH_C(h_9, ((mappend_lh__d4 t_1_1) ys_1_2))))))
          | _ -> 
            (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_8))
      | `LH_N -> 
        (fun ys_1_3 -> 
          ys_1_3))) in
    (_lh_listcomp_fun_1_0 _lh_bodysurf_arg1_0))) (`LH_C((`LH_P3(1.0, 1.0, 1.0)), (`LH_N)))));;
let rec epsilon_lh__d5 =
  0.000001;;
let rec foldr_lh__d3 f_7 i_4 ls_4 =
  (match ls_4 with
    | `LH_C(h_1_1, t_1_3) -> 
      ((f_7 h_1_1) (((foldr_lh__d3 f_7) i_4) t_1_3))
    | `LH_N -> 
      i_4);;
...
let rec trace_lh__d2 _lh_trace_arg1_1 _lh_trace_arg2_1 _lh_trace_arg3_1 =
  (let rec f_1_5 = (fun d1s1_1 d2s2_1 -> 
    (let rec _lh_matchIdent_2_2 = d1s1_1 in
      (match _lh_matchIdent_2_2 with
        | `LH_P2(_lh_trace_LH_P2_0_4, _lh_trace_LH_P2_1_4) -> 
          (let rec _lh_matchIdent_2_3 = d2s2_1 in
    ...
    (let rec sphmap_1 = (fun xss_1 -> 
      (let rec _lh_matchIdent_2_4 = xss_1 in
        (match _lh_matchIdent_2_4 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_1, _lh_trace_LH_C_1_1) -> 
            (let rec _lh_matchIdent_2_5 = (((sphereintersect_lh__d1 _lh_trace_arg2_1) _lh_trace_arg3_1) _lh_trace_LH_C_0_1) in
      ...
      (let rec dists_1 = (sphmap_1 _lh_trace_arg1_1) in
        (if (null_lh__d1 dists_1) then
          (`LH_P3(false, infinity_lh__d1, (head_lh__d6 _lh_trace_arg1_1)))
        else
          (let rec _lh_matchIdent_2_6 = (((foldr_lh__d3 f_1_5) (head_lh__d6 dists_1)) (tail_lh__d1 dists_1)) in
            (match _lh_matchIdent_2_6 with
              ...
              | _ -> 
                (failwith "error")))))));;
let rec vecadd_lh__d1_d1 _lh_vecadd_arg1_1_0 _lh_vecadd_arg2_1_4 =
  (match _lh_vecadd_arg1_1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec s2_lh__d1_d0 _lh_s2_arg1_4 =
...
let rec testspheres_lh__d2 _lh_testspheres_arg1_1 =
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_t_3) -> 
        (match _lh_listcomp_fun_ls_h_3 with
          | `Diffuse(_lh_diffusesurf_Diffuse_0_0) -> 
            (let rec t_7 = (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3) in
              (let rec h_5 = _lh_diffusesurf_Diffuse_0_0 in
                (fun ys_8 -> 
                  (`LH_C(h_5, ((mappend_lh__d4 t_7) ys_8))))))
          | _ -> 
            (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3))
      | `LH_N -> 
        (fun ys_9 -> 
          ys_9))) in
    (_lh_listcomp_fun_4 _lh_diffusesurf_arg1_0))) (`LH_C((`LH_P3(0.0, 0.0, 0.0)), (`LH_N)))));;
let rec vecscale_lh__d1_d2 _lh_vecscale_arg1_5 _lh_vecscale_arg2_5 =
...
let rec shadowed_lh__d1 _lh_shadowed_arg1_0 _lh_shadowed_arg2_0 _lh_shadowed_arg3_0 =
  (let rec _lh_matchIdent_1 = (((trace_lh__d2 (testspheres_lh__d2 0)) ((vecadd_lh__d1_d1 _lh_shadowed_arg1_0) ((vecscale_lh__d1_d2 _lh_shadowed_arg2_0) epsilon_lh__d5))) _lh_shadowed_arg2_0) in
                      ...
                      (if (cosangle_0 <= 0.0) then
                        (let rec bodycol_0 = (bodysurf_lh__d1 _lh_lightray_arg5_0) in
                          (let rec cosalpha_0 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1)) in
                            (let rec diffcont_0 = ((vecmult_lh__d3 ((vecscale_lh__d1_d2 diff_0) (0.0 -. cosangle_0))) _lh_lightray_LH_P2_1_0) in
                        ...
                        (let rec spec_0 = (specularsurf_lh__d1 _lh_lightray_arg5_0) in
                          (let rec cosalpha_1 = ((vecdot_lh__d3 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1) in
                            (let rec diffcont_1 = ((vecmult_lh__d3 ((vecscale_lh__d1_d2 diff_0) cosangle_0)) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_1 = (if (cosalpha_1 <= 0.0) then
                                (`LH_P3(0.0, 0.0, 0.0))
                              else
                                ((vecmult_lh__d3 ((vecscale_lh__d1_d2 spec_0) (cosalpha_1 ** spow_0))) _lh_lightray_LH_P2_1_0)) in
                  ...
                  (let rec diff_1 = (diffusesurf_lh__d1 _lh_lightray_arg5_1) in
                    (let rec spow_1 = (specpowsurf_lh__d1 _lh_lightray_arg5_1) in
                      (if (cosangle_1 <= 0.0) then
                        (let rec bodycol_1 = (bodysurf_lh__d1 _lh_lightray_arg5_1) in
                          (let rec cosalpha_2 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3)) in
                            (let rec diffcont_2 = ((vecmult_lh__d3 ((vecscale_lh__d1_d2 diff_1) (0.0 -. cosangle_1))) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_2 = (if (cosalpha_2 <= 0.0) then
                                ...
                                ((vecadd_lh__d1_d1 diffcont_2) speccont_2)))))
                      else
                        (let rec spec_1 = (specularsurf_lh__d1 _lh_lightray_arg5_1) in
                          (let rec cosalpha_3 = ((vecdot_lh__d3 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3) in
                            (let rec diffcont_3 = ((vecmult_lh__d3 ((vecscale_lh__d1_d2 diff_1) cosangle_1)) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_3 = (if (cosalpha_3 <= 0.0) then
                                (`LH_P3(0.0, 0.0, 0.0))
                              else
                                ((vecmult_lh__d3 ((vecscale_lh__d1_d2 spec_1) (cosalpha_3 ** spow_1))) _lh_lightray_LH_P2_1_1)) in
                                ((vecadd_lh__d1_d1 diffcont_3) speccont_3)))))))))))))
      | _ -> 
        (failwith "error")));;
  ...
  (let rec _lh_matchIdent_8 = ((lightdirection_lh__d1 _lh_lightray_arg1_0) _lh_lightray_arg2_0) in
    (match _lh_matchIdent_8 with
      | `LH_P2(_lh_lightray_LH_P2_0_4, _lh_lightray_LH_P2_1_2) -> 
        (let rec cosangle_2 = ((vecdot_lh__d3 _lh_lightray_LH_P2_0_4) _lh_lightray_arg3_0) in
      ...
      | _ -> 
        (failwith "error")));;
let rec vecadd_lh__d6 _lh_vecadd_arg1_2 _lh_vecadd_arg2_4 =
  (match _lh_vecadd_arg1_2 with
    | `LH_P3(_lh_vecadd_LH_P3_0_9, _lh_vecadd_LH_P3_1_9, _lh_vecadd_LH_P3_2_9) -> 
      (((_lh_vecadd_arg2_4 _lh_vecadd_LH_P3_0_9) _lh_vecadd_LH_P3_1_9) _lh_vecadd_LH_P3_2_9)
    | _ -> 
      (failwith "error"));;
...
let rec is_zerovector_lh__d1 _lh_is_zerovector_arg1_0 =
  (match _lh_is_zerovector_arg1_0 with
    | `LH_P3(_lh_is_zerovector_LH_P3_0_0, _lh_is_zerovector_LH_P3_1_0, _lh_is_zerovector_LH_P3_2_0) -> 
      (((_lh_is_zerovector_LH_P3_0_0 < epsilon_lh__d4) && (_lh_is_zerovector_LH_P3_1_0 < epsilon_lh__d3)) && (_lh_is_zerovector_LH_P3_2_0 < epsilon_lh__d5))
    | _ -> 
      (failwith "error"));;
...
let rec epsilon_lh__d2 =
  0.000001;;
let rec is_zerovector_lh__d2 _lh_is_zerovector_arg1_1 =
  (match _lh_is_zerovector_arg1_1 with
    | `LH_P3(_lh_is_zerovector_LH_P3_0_1, _lh_is_zerovector_LH_P3_1_1, _lh_is_zerovector_LH_P3_2_1) -> 
      (((_lh_is_zerovector_LH_P3_0_1 < epsilon_lh__d5) && (_lh_is_zerovector_LH_P3_1_1 < epsilon_lh__d5)) && (_lh_is_zerovector_LH_P3_2_1 < epsilon_lh__d5))
    | _ -> 
      (failwith "error"));;
...
let rec vecadd_lh__d9 _lh_vecadd_arg1_1 _lh_vecadd_arg2_1 =
  (match _lh_vecadd_arg1_1 with
    | `LH_P3(_lh_vecadd_LH_P3_0_4, _lh_vecadd_LH_P3_1_4, _lh_vecadd_LH_P3_2_4) -> 
      (((_lh_vecadd_arg2_1 _lh_vecadd_LH_P3_0_4) _lh_vecadd_LH_P3_1_4) _lh_vecadd_LH_P3_2_4)
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d8 _lh_vecscale_arg1_6 _lh_vecscale_arg2_6 =
  (match _lh_vecscale_arg1_6 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d7 _lh_vecadd_arg1_5 _lh_vecadd_arg2_8 =
  (match _lh_vecadd_arg1_5 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d1 _lh_vecscale_arg1_1_1 _lh_vecscale_arg2_1_1 =
  (match _lh_vecscale_arg1_1_1 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_1, _lh_vecscale_LH_P3_1_1_1, _lh_vecscale_LH_P3_2_1_1) -> 
      (let rec _lh_vecadd_LH_P3_2_2_6 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_2_1_1) in
        (let rec _lh_vecadd_LH_P3_1_2_6 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_1_1_1) in
          (let rec _lh_vecadd_LH_P3_0_2_6 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_0_1_1) in
    ...
    | _ -> 
      (failwith "error"));;
let rec vecmult_lh__d2 _lh_vecmult_arg1_1 _lh_vecmult_arg2_2 =
...
let rec head_lh__d5 ls_5 =
  (match ls_5 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec mappend_lh__d3 xs_0 ys_4 =
  (xs_0 ys_4);;
let rec ambientsurf_lh__d1 _lh_ambientsurf_arg1_0 =
  (head_lh__d5 ((mappend_lh__d3 (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_5 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
        (match _lh_listcomp_fun_ls_h_7 with
          | `Ambient(_lh_ambientsurf_Ambient_0_0) -> 
            (let rec t_1_0 = (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_7) in
              (let rec h_8 = _lh_ambientsurf_Ambient_0_0 in
                (fun ys_1_0 -> 
                  (`LH_C(h_8, ((mappend_lh__d3 t_1_0) ys_1_0))))))
          | _ -> 
...
let rec vecadd_lh__d4 _lh_vecadd_arg1_3 _lh_vecadd_arg2_5 =
  (_lh_vecadd_arg1_3 _lh_vecadd_arg2_5);;
...
let rec spheresurf_lh__d1 _lh_spheresurf_arg1_0 =
  (match _lh_spheresurf_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d9 _lh_vecscale_arg1_7 _lh_vecscale_arg2_7 =
  (match _lh_vecscale_arg1_7 with
    | `LH_P3(_lh_vecscale_LH_P3_0_7, _lh_vecscale_LH_P3_1_7, _lh_vecscale_LH_P3_2_7) -> 
      (let rec _lh_vecadd_LH_P3_2_1_2 = (_lh_vecscale_arg2_7 *. _lh_vecscale_LH_P3_2_7) in
        (let rec _lh_vecadd_LH_P3_1_1_2 = (_lh_vecscale_arg2_7 *. _lh_vecscale_LH_P3_1_7) in
          (let rec _lh_vecadd_LH_P3_0_1_2 = (_lh_vecscale_arg2_7 *. _lh_vecscale_LH_P3_0_7) in
            (fun _lh_vecadd_LH_P3_0_1_3 _lh_vecadd_LH_P3_1_1_3 _lh_vecadd_LH_P3_2_1_3 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_1_3 +. _lh_vecadd_LH_P3_0_1_2), (_lh_vecadd_LH_P3_1_1_3 +. _lh_vecadd_LH_P3_1_1_2), (_lh_vecadd_LH_P3_2_1_3 +. _lh_vecadd_LH_P3_2_1_2)))))))
    | _ -> 
      (failwith "error"));;
let rec map_lh__d2 f_8 ls_6 =
  (ls_6 f_8);;
let rec mappend_lh__d2 xs_2 ys_1_4 =
  (xs_2 ys_1_4);;
...
let rec refractsurf_lh__d1 _lh_refractsurf_arg1_0 =
  (head_lh__d4 ((mappend_lh__d2 (let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_8 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_1_0, _lh_listcomp_fun_ls_t_1_0) -> 
        (match _lh_listcomp_fun_ls_h_1_0 with
          | `Refract(_lh_refractsurf_Refract_0_0) -> 
            (let rec t_1_7 = (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_0) in
              (let rec h_1_5 = _lh_refractsurf_Refract_0_0 in
                (fun ys_1_6 -> 
                  (`LH_C(h_1_5, ((mappend_lh__d2 t_1_7) ys_1_6))))))
          | _ -> 
            (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_0))
      | `LH_N -> 
        (fun ys_1_7 -> 
          ys_1_7))) in
    (_lh_listcomp_fun_1_4 _lh_refractsurf_arg1_0))) (`LH_C(1.0, (`LH_N)))));;
let rec vecadd_lh__d5 _lh_vecadd_arg1_7 _lh_vecadd_arg2_1_0 =
  (match _lh_vecadd_arg1_7 with
    | `LH_P3(_lh_vecadd_LH_P3_0_1_6, _lh_vecadd_LH_P3_1_1_6, _lh_vecadd_LH_P3_2_1_6) -> 
      (((_lh_vecadd_arg2_1_0 _lh_vecadd_LH_P3_0_1_6) _lh_vecadd_LH_P3_1_1_6) _lh_vecadd_LH_P3_2_1_6)
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d0 _lh_vecscale_arg1_8 _lh_vecscale_arg2_8 =
  (match _lh_vecscale_arg1_8 with
    | `LH_P3(_lh_vecscale_LH_P3_0_8, _lh_vecscale_LH_P3_1_8, _lh_vecscale_LH_P3_2_8) -> 
      (let rec _lh_vecadd_LH_P3_2_1_7 = (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_2_8) in
        (let rec _lh_vecadd_LH_P3_1_1_7 = (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_1_8) in
          (let rec _lh_vecadd_LH_P3_0_1_7 = (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_0_8) in
            (fun _lh_vecadd_LH_P3_0_1_8 _lh_vecadd_LH_P3_1_1_8 _lh_vecadd_LH_P3_2_1_8 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_1_8 +. _lh_vecadd_LH_P3_0_1_7), (_lh_vecadd_LH_P3_1_1_8 +. _lh_vecadd_LH_P3_1_1_7), (_lh_vecadd_LH_P3_2_1_8 +. _lh_vecadd_LH_P3_2_1_7)))))))
    | _ -> 
      (failwith "error"));;
let rec vecmult_lh__d1 _lh_vecmult_arg1_2 _lh_vecmult_arg2_3 =
...
let rec transmitsurf_lh__d1 _lh_transmitsurf_arg1_0 =
  (head_lh__d6 ((mappend_lh__d4 (let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_9 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_1_1, _lh_listcomp_fun_ls_t_1_1) -> 
        (match _lh_listcomp_fun_ls_h_1_1 with
          | `Transmit(_lh_transmitsurf_Transmit_0_0) -> 
            (let rec t_1_9 = (_lh_listcomp_fun_1_5 _lh_listcomp_fun_ls_t_1_1) in
              (let rec h_1_7 = _lh_transmitsurf_Transmit_0_0 in
                (fun ys_1_8 -> 
                  (`LH_C(h_1_7, ((mappend_lh__d4 t_1_9) ys_1_8))))))
          | _ -> 
            (_lh_listcomp_fun_1_5 _lh_listcomp_fun_ls_t_1_1))
      | `LH_N -> 
        (fun ys_1_9 -> 
          ys_1_9))) in
    (_lh_listcomp_fun_1_5 _lh_transmitsurf_arg1_0))) (`LH_C(0.0, (`LH_N)))));;
let rec reflectray_lh__d1 _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
  (let rec newcontrib_4 = ((vecmult_lh__d3 _lh_reflectray_arg4_0) _lh_reflectray_arg5_0) in
    (let rec nearpos_4 = ((vecadd_lh__d1_d1 _lh_reflectray_arg1_0) ((vecscale_lh__d1_d2 _lh_reflectray_arg2_0) epsilon_lh__d5)) in
      (let rec _lh_matchIdent_1_1 = (((trace_lh__d2 (testspheres_lh__d2 0)) nearpos_4) _lh_reflectray_arg2_0) in
        (match _lh_matchIdent_1_1 with
          | `LH_P3(_lh_reflectray_LH_P3_0_0, _lh_reflectray_LH_P3_1_0, _lh_reflectray_LH_P3_2_0) -> 
            (let rec newcol_4 = (if _lh_reflectray_LH_P3_0_0 then
              ...
              (if (is_zerovector_lh__d2 newcontrib_4) then
                _lh_reflectray_arg6_0
              else
                ((vecadd_lh__d1_d1 _lh_reflectray_arg6_0) ((vecmult_lh__d3 newcol_4) _lh_reflectray_arg4_0))))
          | _ -> 
            (failwith "error")))))
and
    ...
    (let rec _lh_matchIdent_2 = (if (dotp_0 < 0.0) then
      (let rec _lh_refractray_LH_P3_2_0 = (1.0 /. _lh_refractray_arg1_0) in
        (let rec _lh_refractray_LH_P3_1_0 = (0.0 -. dotp_0) in
          (let rec _lh_refractray_LH_P3_0_0 = ((vecscale_lh__d1_d2 _lh_refractray_arg3_0) (0.0 -. 1.0)) in
                    ...
                    (let rec _lh_transmitray_LH_P2_1_0 = (`LH_P3(0.0, 0.0, 0.0)) in
                      (let rec _lh_transmitray_LH_P2_0_0 = true in
                        (fun _lh_transmitray_arg1_0 _lh_transmitray_arg2_0 _lh_transmitray_arg3_0 _lh_transmitray_arg6_0 newcontrib_0 -> 
                          (let rec nearpos_0 = ((vecadd_lh__d9 _lh_transmitray_arg3_0) ((vecscale_lh__d1_d1 _lh_transmitray_LH_P2_1_0) epsilon_lh__d2)) in
                    ...
                    (let rec _lh_transmitray_LH_P2_1_1 = ((vecadd_lh__d1_d1 ((vecscale_lh__d1_d2 _lh_refractray_LH_P3_0_0) t_2)) ((vecscale_lh__d1_d2 _lh_refractray_arg2_1) _lh_refractray_LH_P3_2_0)) in
                      (let rec _lh_transmitray_LH_P2_0_1 = false in
                        (fun _lh_transmitray_arg1_1 _lh_transmitray_arg2_1 _lh_transmitray_arg3_1 _lh_transmitray_arg6_1 newcontrib_1 -> 
                          (let rec nearpos_1 = ((vecadd_lh__d9 _lh_transmitray_arg3_1) ((vecscale_lh__d1_d1 _lh_transmitray_LH_P2_1_1) epsilon_lh__d2)) in
                    ...
                    (let rec _lh_transmitray_LH_P2_1_2 = (`LH_P3(0.0, 0.0, 0.0)) in
                      (let rec _lh_transmitray_LH_P2_0_2 = true in
                        (fun _lh_transmitray_arg1_2 _lh_transmitray_arg2_2 _lh_transmitray_arg3_2 _lh_transmitray_arg6_2 newcontrib_2 -> 
                          (let rec nearpos_2 = ((vecadd_lh__d9 _lh_transmitray_arg3_2) ((vecscale_lh__d1_d1 _lh_transmitray_LH_P2_1_2) epsilon_lh__d2)) in
                    ...
                    (let rec _lh_transmitray_LH_P2_1_3 = ((vecadd_lh__d1_d1 ((vecscale_lh__d1_d2 _lh_refractray_LH_P3_0_1) t_3)) ((vecscale_lh__d1_d2 _lh_refractray_arg2_2) _lh_refractray_LH_P3_2_1)) in
                      (let rec _lh_transmitray_LH_P2_0_3 = false in
                        (fun _lh_transmitray_arg1_3 _lh_transmitray_arg2_3 _lh_transmitray_arg3_3 _lh_transmitray_arg6_3 newcontrib_3 -> 
                          (let rec nearpos_3 = ((vecadd_lh__d9 _lh_transmitray_arg3_3) ((vecscale_lh__d1_d1 _lh_transmitray_LH_P2_1_3) epsilon_lh__d2)) in
          ...
          (fun _lh_vecmult_arg2_1 -> 
            (match _lh_vecmult_arg2_1 with
              | `LH_P3(_lh_vecmult_LH_P3_0_3, _lh_vecmult_LH_P3_1_3, _lh_vecmult_LH_P3_2_3) -> 
                (let rec _lh_vecadd_LH_P3_2_1_0 = (_lh_vecmult_LH_P3_2_2 *. _lh_vecmult_LH_P3_2_3) in
                  (let rec _lh_vecadd_LH_P3_1_1_0 = (_lh_vecmult_LH_P3_1_2 *. _lh_vecmult_LH_P3_1_3) in
                    (let rec _lh_vecadd_LH_P3_0_1_0 = (_lh_vecmult_LH_P3_0_2 *. _lh_vecmult_LH_P3_0_3) in
      ...
      (let rec surf_8 = (spheresurf_lh__d1 _lh_shade_arg2_0) in
        (let rec amb_0 = ((vecmult_lh__d1 ambientlight_0) (ambientsurf_lh__d1 surf_8)) in
          (let rec norm_0 = ((spherenormal_lh__d1 hitpos_8) _lh_shade_arg2_0) in
            (let rec refl_8 = ((vecadd_lh__d6 _lh_shade_arg4_0) ((vecscale_lh__d1_d0 norm_0) ((0.0 -. 2.0) *. ((vecdot_lh__d1 _lh_shade_arg4_0) norm_0)))) in
              (let rec diff_2 = (vecsum_lh__d1 ((map_lh__d2 (fun l_0 -> 
                ...
                (let rec transmitted_0 = (transmitsurf_lh__d1 surf_8) in
                  (let rec simple_0 = ((vecadd_lh__d4 amb_0) diff_2) in
                    (let rec trintensity_8 = ((vecscale_lh__d7 (bodysurf_lh__d1 surf_8)) transmitted_0) in
                        ...
                        (let rec _lh_shade_LH_P2_1_8 = simple_0 in
                          (let rec _lh_shade_LH_P2_0_8 = false in
                            (fun _lh_shade_arg1_9 _lh_shade_arg6_9 hitpos_9 refl_9 surf_9 trintensity_9 -> 
                              (let rec reflsurf_8 = ((vecscale_lh__d8 (specularsurf_lh__d1 surf_9)) (reflectsurf_lh__d1 surf_9)) in
                                (let rec reflectiv_8 = (if _lh_shade_LH_P2_0_8 then
                                  ((vecadd_lh__d7 trintensity_9) reflsurf_8)
                                else
                                  reflsurf_8) in
...
transmitray_lh__d1 _lh_transmitray_arg1_4 _lh_transmitray_arg2_4 _lh_transmitray_arg3_4 _lh_transmitray_arg4_0 _lh_transmitray_arg5_0 _lh_transmitray_arg6_4 _lh_transmitray_arg7_0 _lh_transmitray_arg8_0 =
  (let rec newcontrib_5 = ((vecmult_lh__d2 _lh_transmitray_arg6_4) _lh_transmitray_arg7_0) in
    (let rec _lh_matchIdent_2_1 = (((refractray_lh__d1 _lh_transmitray_arg5_0) _lh_transmitray_arg4_0) _lh_transmitray_arg8_0) in
...
let rec trace_lh__d1 _lh_trace_arg1_0 _lh_trace_arg2_0 _lh_trace_arg3_0 =
  (let rec f_1_4 = (fun d1s1_0 d2s2_0 -> 
    (let rec _lh_matchIdent_1_5 = d1s1_0 in
      (match _lh_matchIdent_1_5 with
        | `LH_P2(_lh_trace_LH_P2_0_0, _lh_trace_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_1_6 = d2s2_0 in
    ...
    (let rec sphmap_0 = (fun xss_0 -> 
      (let rec _lh_matchIdent_1_7 = xss_0 in
        (match _lh_matchIdent_1_7 with
          | `LH_N -> 
            (`LH_N)
          | `LH_C(_lh_trace_LH_C_0_0, _lh_trace_LH_C_1_0) -> 
            (let rec _lh_matchIdent_1_8 = (((sphereintersect_lh__d1 _lh_trace_arg2_0) _lh_trace_arg3_0) _lh_trace_LH_C_0_0) in
              ...
              (let rec _lh_tracepixel_LH_P3_0_0 = false in
                (fun _lh_tracepixel_LH_P2_0_1 _lh_tracepixel_arg2_2 pos_2 -> 
                  (if _lh_tracepixel_LH_P3_0_0 then
                    ((((((shade_lh__d1 _lh_tracepixel_arg2_2) _lh_tracepixel_LH_P3_2_0) pos_2) _lh_tracepixel_LH_P2_0_1) _lh_tracepixel_LH_P3_1_0) (`LH_P3(1.0, 1.0, 1.0)))
                  else
                    background_lh__d1)))))
        else
          (let rec _lh_matchIdent_1_9 = (((foldr_lh__d2 f_1_4) (head_lh__d1 dists_0)) (tail_lh__d1 dists_0)) in
                    ...
                    (let rec _lh_tracepixel_LH_P3_0_1 = true in
                      (fun _lh_tracepixel_LH_P2_0_2 _lh_tracepixel_arg2_3 pos_3 -> 
                        (if _lh_tracepixel_LH_P3_0_1 then
                          ((((((shade_lh__d1 _lh_tracepixel_arg2_3) _lh_tracepixel_LH_P3_2_1) pos_3) _lh_tracepixel_LH_P2_0_2) _lh_tracepixel_LH_P3_1_1) (`LH_P3(1.0, 1.0, 1.0)))
                        else
                          background_lh__d1)))))
              | _ -> 
                (failwith "error")))))));;
let rec vecscale_lh__d2 _lh_vecscale_arg1_0 _lh_vecscale_arg2_0 =
  (match _lh_vecscale_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d1 _lh_vecadd_arg1_6 _lh_vecadd_arg2_9 =
  (_lh_vecadd_arg1_6 _lh_vecadd_arg2_9);;
let rec lookfrom_lh__d2 =
  (`LH_P3(2.1, 1.3, 1.7));;
let rec vecadd_lh__d2 _lh_vecadd_arg1_8 _lh_vecadd_arg2_1_1 =
  (_lh_vecadd_arg1_8 _lh_vecadd_arg2_1_1);;
let rec vecscale_lh__d1 _lh_vecscale_arg1_9 _lh_vecscale_arg2_9 =
  (match _lh_vecscale_arg1_9 with
    | `LH_P3(_lh_vecscale_LH_P3_0_9, _lh_vecscale_LH_P3_1_9, _lh_vecscale_LH_P3_2_9) -> 
      (let rec _lh_vecadd_LH_P3_2_2_1 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_2_9) in
        (let rec _lh_vecadd_LH_P3_1_2_1 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_1_9) in
          (let rec _lh_vecadd_LH_P3_0_2_1 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_0_9) in
            (fun _lh_vecadd_LH_P3_0_2_2 _lh_vecadd_LH_P3_1_2_2 _lh_vecadd_LH_P3_2_2_2 -> 
              (let rec _lh_vecadd_LH_P3_2_2_3 = (_lh_vecadd_LH_P3_2_2_2 +. _lh_vecadd_LH_P3_2_2_1) in
                (let rec _lh_vecadd_LH_P3_1_2_3 = (_lh_vecadd_LH_P3_1_2_2 +. _lh_vecadd_LH_P3_1_2_1) in
                  (let rec _lh_vecadd_LH_P3_0_2_3 = (_lh_vecadd_LH_P3_0_2_2 +. _lh_vecadd_LH_P3_0_2_1) in
                    (fun _lh_vecadd_arg2_1_3 -> 
                      (((_lh_vecadd_arg2_1_3 _lh_vecadd_LH_P3_0_2_3) _lh_vecadd_LH_P3_1_2_3) _lh_vecadd_LH_P3_2_2_3)))))))))
    | _ -> 
      (failwith "error"));;
...
let rec tracepixel_lh__d1 _lh_tracepixel_arg1_1 _lh_tracepixel_arg2_1 _lh_tracepixel_arg3_0 _lh_tracepixel_arg4_0 _lh_tracepixel_arg5_0 _lh_tracepixel_arg6_0 _lh_tracepixel_arg7_0 =
  (let rec pos_1 = lookfrom_lh__d2 in
    (let rec _lh_matchIdent_1_4 = (vecnorm_lh__d1 ((vecadd_lh__d1 ((vecadd_lh__d2 _lh_tracepixel_arg5_0) ((vecscale_lh__d1 _lh_tracepixel_arg6_0) _lh_tracepixel_arg3_0))) ((vecscale_lh__d2 _lh_tracepixel_arg7_0) _lh_tracepixel_arg4_0))) in
      (((_lh_matchIdent_1_4 _lh_tracepixel_arg1_1) _lh_tracepixel_arg2_1) pos_1)));;
let rec pi_lh__d1 =
  3.141592653589793;;
let rec dtor_lh__d1 _lh_dtor_arg1_1 =
  ((_lh_dtor_arg1_1 *. pi_lh__d1) /. 180.0);;
let rec vecscale_lh__d6 _lh_vecscale_arg1_1_0 _lh_vecscale_arg2_1_0 =
...
let rec vecscale_lh__d5 _lh_vecscale_arg1_2 _lh_vecscale_arg2_2 =
  (match _lh_vecscale_arg1_2 with
    | `LH_P3(_lh_vecscale_LH_P3_0_2, _lh_vecscale_LH_P3_1_2, _lh_vecscale_LH_P3_2_2) -> 
      (let rec _lh_vecadd_LH_P3_2_5 = (_lh_vecscale_arg2_2 *. _lh_vecscale_LH_P3_2_2) in
        (let rec _lh_vecadd_LH_P3_1_5 = (_lh_vecscale_arg2_2 *. _lh_vecscale_LH_P3_1_2) in
          (let rec _lh_vecadd_LH_P3_0_5 = (_lh_vecscale_arg2_2 *. _lh_vecscale_LH_P3_0_2) in
            (fun _lh_vecadd_arg2_2 -> 
              (((_lh_vecadd_arg2_2 _lh_vecadd_LH_P3_0_5) _lh_vecadd_LH_P3_1_5) _lh_vecadd_LH_P3_2_5)))))
    | _ -> 
      (failwith "error"));;
let rec s2_lh__d2 _lh_s2_arg1_0 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d8 _lh_s2_arg1_1 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d7 _lh_s2_arg1_2 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d5 _lh_s2_arg1_3 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d6 _lh_s2_arg1_9 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d4 _lh_s2_arg1_5 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d9 _lh_s2_arg1_6 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d3 _lh_s2_arg1_7 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec s2_lh__d1 _lh_s2_arg1_8 =
  (`LH_C((`Ambient((`LH_P3(0.035, 0.0325, 0.025)))), (`LH_C((`Diffuse((`LH_P3(0.5, 0.45, 0.35)))), (`LH_C((`Specular((`LH_P3(0.8, 0.8, 0.8)))), (`LH_C((`Specpow(3.0)), (`LH_C((`Reflect(0.5)), (`LH_N)))))))))));;
let rec testspheres_lh__d1 _lh_testspheres_arg1_0 =
...
let rec vecsub_lh__d1 _lh_vecsub_arg1_2 _lh_vecsub_arg2_2 =
  (match _lh_vecsub_arg1_2 with
    | `LH_P3(_lh_vecsub_LH_P3_0_4, _lh_vecsub_LH_P3_1_4, _lh_vecsub_LH_P3_2_4) -> 
      (((_lh_vecsub_arg2_2 _lh_vecsub_LH_P3_0_4) _lh_vecsub_LH_P3_1_4) _lh_vecsub_LH_P3_2_4)
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1 f_9 ls_9 =
  (ls_9 f_9);;
let rec enumFromTo_lh__d2 a_0 b_0 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_1 _lh_popOutId_3_1 _lh_popOutId_4_0 =
  (if (a_0 <= b_0) then
    (fun f_2 f_3 i_1 -> 
      (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
        (let rec _lh_listcomp_fun_ls_h_4 = a_0 in
          (let rec t_8 = (_lh_popOutId_1_1 _lh_listcomp_fun_ls_t_4) in
            (let rec h_6 = (let rec _lh_snd_LH_P2_1_0 = ((_lh_popOutId_2_1 _lh_popOutId_0_1) _lh_listcomp_fun_ls_h_4) in
              (let rec _lh_snd_LH_P2_0_0 = (`LH_P2(_lh_popOutId_0_1, _lh_listcomp_fun_ls_h_4)) in
                _lh_snd_LH_P2_1_0)) in
              (let rec t_9 = ((map_lh__d1 f_2) t_8) in
                (let rec h_7 = (f_2 h_6) in
                  ((f_3 h_7) (((foldr_lh__d1 f_3) i_1) t_9)))))))))
  else
    (_lh_popOutId_4_0 _lh_popOutId_3_1));;
let rec enumFromTo_lh__d1 a_1 b_1 _lh_popOutId_0_2 _lh_popOutId_1_2 _lh_popOutId_2_2 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_9 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_9 = a_1 in
        (let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_7 -> 
          (((((_lh_listcomp_fun_para_7 _lh_listcomp_fun_ls_h_9) _lh_listcomp_fun_1_2) _lh_popOutId_2_2) _lh_listcomp_fun_ls_t_9) _lh_popOutId_0_2)) in
          (_lh_listcomp_fun_1_2 ((enumFromTo_lh__d2 0) (_lh_popOutId_1_2 - 1))))))
  else
    (fun f_1_2 f_1_3 i_5 -> 
      i_5));;
let rec vup_lh__d1 _lh_vup_arg1_0 _lh_veccross_LH_P3_0_3 _lh_veccross_LH_P3_1_3 _lh_veccross_LH_P3_2_3 _lh_dummy_1 _lh_camparams_LH_P2_0_1 _lh_camparams_LH_P2_1_1 _lh_camparams_arg4_0 _lh_camparams_arg5_0 initfirstray_0 =
                                                ...
                                                (let rec _lh_ray_LH_P3_0_0 = firstray_0 in
                                                  (fun _lh_ray_arg1_0 lights_0 -> 
                                                    (let rec f_0 = (fun i_0 j_0 -> 
                                                      (((((((tracepixel_lh__d1 (testspheres_lh__d1 0)) lights_0) (float_of_int i_0)) (float_of_int j_0)) _lh_ray_LH_P3_0_0) _lh_ray_LH_P3_1_0) _lh_ray_LH_P3_2_0)) in
        ...
        (let rec _lh_camparams_LH_P2_1_3 = len_3 in
          (let rec _lh_camparams_LH_P2_0_3 = (`LH_P3((_lh_vecnorm_LH_P3_0_3 /. len_3), (_lh_vecnorm_LH_P3_1_3 /. len_3), (_lh_vecnorm_LH_P3_2_3 /. len_3))) in
            (fun _lh_camparams_arg3_1 _lh_camparams_arg4_2 _lh_camparams_arg5_2 initfirstray_2 -> 
              (let rec _lh_matchIdent_2_7 = (vecnorm_lh__d2 ((veccross_lh__d1 _lh_camparams_LH_P2_0_3) _lh_camparams_arg3_1)) in
                (((((_lh_matchIdent_2_7 _lh_camparams_LH_P2_0_3) _lh_camparams_LH_P2_1_3) _lh_camparams_arg4_2) _lh_camparams_arg5_2) initfirstray_2))))))
    | _ -> 
      (failwith "error"));;
...
let rec camparams_lh__d1 _lh_camparams_arg1_0 _lh_camparams_arg2_0 _lh_camparams_arg3_0 _lh_camparams_arg4_1 _lh_camparams_arg5_1 =
  (let rec initfirstray_1 = ((vecsub_lh__d2 _lh_camparams_arg2_0) _lh_camparams_arg1_0) in
    (let rec _lh_matchIdent_1_0 = (vecnorm_lh__d3 initfirstray_1) in
      ((((_lh_matchIdent_1_0 _lh_camparams_arg3_0) _lh_camparams_arg4_1) _lh_camparams_arg5_1) initfirstray_1)));;
let rec fov_lh__d1 =
  45.0;;
let rec lookat_lh__d1 _lh_lookat_arg1_0 _lh_vecsub_arg2_3 =
...
let rec testlights_lh__d1 _lh_testlights_arg1_0 f_1_9 =
  (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (fun f_1_6 -> 
    (`LH_N)) in
    (let rec h_1_9 = (`Point((`LH_P3((0.0 -. 3.0), 1.0, 5.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_1_7 -> 
        (`LH_C((f_1_7 h_1_9), ((map_lh__d2 f_1_7) t_2_3)))))) in
    (let rec h_2_0 = (`Point((`LH_P3(1.0, (0.0 -. 4.0), 4.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_1_8 -> 
        (`LH_C((f_1_8 h_2_0), ((map_lh__d2 f_1_8) t_2_2)))))) in
    (let rec h_2_1 = (`Point((`LH_P3(4.0, 3.0, 2.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (`LH_C((f_1_9 h_2_1), ((map_lh__d2 f_1_9) t_2_1)))));;
let rec ray_lh__d1 _lh_ray_arg1_1 =
  (let rec lights_1 = (testlights_lh__d1 0) in
    (let rec _lh_matchIdent_1_3 = (((((camparams_lh__d1 lookfrom_lh__d1) (lookat_lh__d1 0)) (vup_lh__d1 0)) fov_lh__d1) (float_of_int _lh_ray_arg1_1)) in

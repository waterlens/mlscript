(*
ocamlfind ocamlopt -rectypes -thread -O3 ./DigitsOfE1_nofib.ml -o "./DigitsOfE1_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./DigitsOfE1_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

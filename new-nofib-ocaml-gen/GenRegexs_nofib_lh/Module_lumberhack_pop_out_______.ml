...
let rec mappend_lh__d3 xs_1 ys_4 =
  (xs_1 ys_4);;
let rec enumFromTo_lh__d4 a_3 b_2 _lh_popOutId_0_2 _lh_popOutId_1_2 =
  (if (a_3 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_lh__d4 (a_3 + 1)) b_2) in
      (let rec t_7 = (_lh_popOutId_0_2 _lh_listcomp_fun_ls_t_5) in
        (let rec h_7 = '0' in
          (`LH_C(h_7, ((mappend_lh__d3 t_7) _lh_popOutId_1_2))))))
  else
    _lh_popOutId_1_2);;
...
constantRule_lh__d2 _lh_constantRule_arg1_1 =
  (match _lh_constantRule_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and
enumFromThenTo_lh__d1 a_4 t_8 b_3 _lh_popOutId_0_3 _lh_popOutId_1_3 _lh_popOutId_2_1 =
  (if (a_4 <= b_3) then
        ...
        (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_4 -> 
          (match _lh_listcomp_fun_para_4 with
            | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_7) -> 
              (`LH_C(((mappend_lh__d2 ((pad_lh__d1 (string_of_int _lh_listcomp_fun_ls_h_5)) _lh_popOutId_2_1)) _lh_listcomp_fun_ls_h_6), (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_7)))
            | `LH_N -> 
              (_lh_popOutId_0_3 _lh_listcomp_fun_ls_t_6))) in
          (_lh_listcomp_fun_1_1 (expand_lh__d1 _lh_popOutId_1_3)))))
  else
    (`LH_N))
and
enumFromTo_lh__d1 a_1 b_0 _lh_popOutId_0_0 _lh_popOutId_1_0 =
  (if (a_1 <= b_0) then
      ...
      (let rec _lh_listcomp_fun_ls_h_0 = a_1 in
        (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_0 -> 
          (match _lh_listcomp_fun_para_0 with
            ...
            | `LH_N -> 
              (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_0))) in
          (_lh_listcomp_fun_1 (expand_lh__d1 _lh_popOutId_0_0)))))
  else
    (`LH_N))
and
enumFromTo_lh__d2 a_5 b_4 _lh_popOutId_0_4 =
  (if (a_5 <= b_4) then
    (let rec t_9 = ((enumFromTo_lh__d2 (a_5 + 1)) b_4) in
      (let rec h_8 = a_5 in
        ((reverse_helper_lh__d1 t_9) (let rec _lh_listcomp_fun_ls_t_8 = _lh_popOutId_0_4 in
    ...
    _lh_popOutId_0_4)
and
enumFromTo_lh__d3 a_2 b_1 _lh_popOutId_0_1 _lh_popOutId_1_1 _lh_popOutId_2_0 =
  (if (a_2 <= b_1) then
        ...
        (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_1 -> 
          (match _lh_listcomp_fun_para_1 with
            | `LH_C(_lh_listcomp_fun_ls_h_3, _lh_listcomp_fun_ls_t_3) -> 
              (`LH_C(((mappend_lh__d2 ((pad_lh__d1 (string_of_int _lh_listcomp_fun_ls_h_2)) _lh_popOutId_2_0)) _lh_listcomp_fun_ls_h_3), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3)))
            | `LH_N -> 
              (_lh_popOutId_0_1 _lh_listcomp_fun_ls_t_2))) in
          (_lh_listcomp_fun_4 (expand_lh__d1 _lh_popOutId_1_1)))))
  else
    (`LH_N))
and

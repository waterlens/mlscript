...
let rec map_lh__d1 f_5 ls_6 =
  (match ls_6 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_5 h_9), ((map_lh__d1 f_5) t_9)))
    | `LH_N -> 
      (`LH_N));;
let rec a_lh__d4 =
  (`Node((`LH_C('a', (`LH_N))), (`LH_N)));;
...
let rec map_lh__d4 f_1 ls_1 =
  (match ls_1 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C((f_1 h_3), ((map_lh__d4 f_1) t_3)))
    | `LH_N -> 
      (`LH_N));;
        ...
        | `LH_P2(_lh_ltGraph_LH_P2_0_0, _lh_ltGraph_LH_P2_1_0) -> 
          (let rec labelOf_0 = (fun _lh_labelOf_arg1_0 -> 
            (match _lh_labelOf_arg1_0 with
              ...
              | _ -> 
                (failwith "error"))) in
            (`LH_C((`LH_P3(_lh_ltGraph_LH_P2_0_0, _lh_ltGraph_LH_P2_1_0, ((map_lh__d5 labelOf_0) _lh_ltGraph_Node_1_0))), (concat_lh__d1 ((map_lh__d4 ltGraph_lh__d1) _lh_ltGraph_Node_1_0)))))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
...
let rec mmapl_lh__d1 _lh_mmapl_arg1_0 _lh_mmapl_arg2_0 =
  (match _lh_mmapl_arg2_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec retURN_lh__d1 _lh_retURN_arg1_2 s_7 =
...
let rec startingWith_lh__d1 _lh_startingWith_arg1_0 _lh_startingWith_arg2_0 =
  (let rec _lh_matchIdent_4 = (_lh_startingWith_arg1_0 _lh_startingWith_arg2_0) in
    (match _lh_matchIdent_4 with
      ...
      | _ -> 
        (failwith "error")));;
let rec bind_lh__d1 _lh_bind_arg1_3 _lh_bind_arg2_3 s_6 =
  (let rec _lh_matchIdent_3 = (_lh_bind_arg1_3 s_6) in
...
let rec foldr_lh__d1 f_2 i_0 ls_3 =
  (match ls_3 with
    | `LH_C(h_6, t_6) -> 
      ((f_2 h_6) (((foldr_lh__d1 f_2) i_0) t_6))
    | `LH_N -> 
      i_0);;
...
let rec example4_lh__d1 =
  (prod_lh__d1 (((scanl_lh__d1 plus__lh__d4) zerO_lh__d1) (`LH_C(a_lh__d3, (`LH_C(b_lh__d3, (`LH_C(c_lh__d2, (`LH_C(d_lh__d1, (`LH_N)))))))))));;

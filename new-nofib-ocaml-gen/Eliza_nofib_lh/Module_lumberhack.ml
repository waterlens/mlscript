...
and dropWhile__d2 _lh_dropWhile_arg1_1 _lh_dropWhile_arg2_1 =
  (match _lh_dropWhile_arg2_1 with
    ...
    | _ -> 
      (failwith "error"))
and enumFromTo__d0 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec t_5_5 = ((enumFromTo__d0 (a_0 + 1)) b_0) in
      (let rec h_5_2 = a_0 in
        (fun f_3_2 -> 
          (`LH_C((f_3_2 h_5_2), ((map__d0 f_3_2) t_5_5))))))
  else
    (fun f_3_3 -> 
      (`LH_N)))
...
and makeResponse__d0 _lh_makeResponse_arg1_0 _lh_makeResponse_arg2_0 =
  (match _lh_makeResponse_arg1_0 with
    ...
    | _ -> 
      _lh_makeResponse_arg1_0)
and map__d4 f_2_1 ls_7 =
  (match ls_7 with
    | `LH_C(h_4_3, t_4_6) -> 
      (let rec t_4_7 = ((map__d4 f_2_1) t_4_6) in
        (let rec h_4_4 = (f_2_1 h_4_3) in
          (fun f_2_2 i_2 -> 
            ((f_2_2 h_4_4) (((foldr__d0 f_2_2) i_2) t_4_7)))))
    | `LH_N -> 
      (fun f_2_3 i_3 -> 
        i_3))
and map__d7 f_3_8 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_5_5, t_5_8) -> 
      (let rec _lh_prefix_LH_C_1_0 = ((map__d7 f_3_8) t_5_8) in
        (let rec _lh_prefix_LH_C_0_0 = (f_3_8 h_5_5) in
          (fun _lh_prefix_LH_C_0_1 _lh_prefix_LH_C_1_1 -> 
            ((_lh_prefix_LH_C_0_1 = _lh_prefix_LH_C_0_0) && ((prefix__d0 _lh_prefix_LH_C_1_1) _lh_prefix_LH_C_1_0)))))
    | `LH_N -> 
...
and tails__d0 _lh_tails_arg1_0 =
    ...
    | _ -> 
      (let rec t_5_6 = (tails__d0 (tail__d0 _lh_tails_arg1_0)) in
        (let rec h_5_3 = _lh_tails_arg1_0 in
          (fun f_3_6 -> 
            (if (f_3_6 h_5_3) then
              (let rec t_5_7 = ((filter__d1 f_3_6) t_5_6) in
                (let rec h_5_4 = h_5_3 in
                  (fun f_3_7 -> 
                    (`LH_C((f_3_7 h_5_4), ((map__d6 f_3_7) t_5_7))))))
            else
              ((filter__d1 f_3_6) t_5_6))))))
and take__d0 n_0 ls_1_0 =
  (if (n_0 > 0) then
    (match ls_1_0 with
      | `LH_C(h_4_7, t_5_0) -> 
        (let rec t_5_1 = ((take__d0 (n_0 - 1)) t_5_0) in
          (let rec h_4_8 = h_4_7 in
            (fun f_2_4 -> 
              (let rec t_5_2 = ((map__d1 f_2_4) t_5_1) in
                (let rec h_4_9 = (f_2_4 h_4_8) in
                  (fun f_2_5 -> 
                    (if (f_2_5 h_4_9) then
                      (let rec _lh_session_LH_C_1_1 = ((filter__d0 f_2_5) t_5_2) in
                      ...
                      ((filter__d0 f_2_5) t_5_2))))))))
      | `LH_N -> 
        (fun f_2_6 f_2_7 _lh_session_arg1_1 _lh_session_arg2_1 _lh_dummy_2_3 -> 
          0))
  else
    (fun f_2_8 f_2_9 _lh_session_arg1_2 _lh_session_arg2_2 _lh_dummy_2_4 -> 
      0))

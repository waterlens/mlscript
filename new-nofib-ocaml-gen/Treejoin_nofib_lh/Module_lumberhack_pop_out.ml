            ...
            | `Leaf(_lh_join_Leaf_0_0, _lh_join_Leaf_1_0) -> 
              (match _lh_join_Leaf_1_0 with
                | `LH_P3(_lh_join_LH_P3_0_4, _lh_join_LH_P3_1_4, _lh_join_LH_P3_2_4) -> 
                  (let rec _lh_matchIdent_5 = ((lookupT_lh _lh_join_LH_P3_2_4) _lh_join_arg2_0) in
                    ((((_lh_matchIdent_5 _lh_join_arg3_3) _lh_join_LH_P3_0_4) _lh_join_LH_P3_1_4) _lh_join_LH_P3_2_4))
                | _ -> 
                  (match _lh_join_arg1_0 with
                    | `Node(_lh_join_Node_0_0, _lh_join_Node_1_0, _lh_join_Node_2_0) -> 
                      (((join_lh _lh_join_Node_1_0) _lh_join_arg2_0) (((join_lh _lh_join_Node_2_0) _lh_join_arg2_0) _lh_join_arg3_3))
                    | _ -> 
                      (failwith "error")))
            | _ -> 
              (match _lh_join_arg1_0 with
                | `Node(_lh_join_Node_0_1, _lh_join_Node_1_1, _lh_join_Node_2_1) -> 
                  (((join_lh _lh_join_Node_1_1) _lh_join_arg2_0) (((join_lh _lh_join_Node_2_1) _lh_join_arg2_0) _lh_join_arg3_3))
                | _ -> 
                  (failwith "error")))));;
    ...
    (let rec c2_0 = lh_large_str_1 in
      (let rec a_0 = (((readTree_lh (fun x___0 -> 
        ...
        (let rec b_0 = (((readTree_lh (fun x___1 -> 
          (let rec _lh_matchIdent_4 = x___1 in

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Primetest_nofib" (fun () -> ignore (let open Module_lumberhack.Module_lumberhack in ((testPrimetest_nofib__d0 0))));
  Bench.Test.create ~name:"lumberhack_pop_out_Primetest_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out.Module_lumberhack_pop_out in ((testPrimetest_nofib__d0 0))));
])

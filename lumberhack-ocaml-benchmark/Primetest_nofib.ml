    ...
    (let rec _lh_f_LH_P2_0_0 = (_lh_divmod_arg1_0 / _lh_divmod_arg2_0) in
      (fun _lh_f_LH_P2_0_1 _lh_f_LH_P2_1_1 f_1_9 -> 
        (if (_lh_f_LH_P2_1_0 = 0) then
          (f_1_9 (let rec _lh_f_LH_P2_1_2 = _lh_f_LH_P2_0_0 in
...
and findKQ_d0_d0_d0 _lh_findKQ_arg1_0 =
  (let rec f_2_9 = (fun _lh_f_arg1_1 -> 
    ...
    (f_2_9 (let rec _lh_f_LH_P2_1_3 = (_lh_findKQ_arg1_0 - 1) in
...
and iterate_d0_d0_d0 f_2_7 x_5 =
  (lazy (let rec t_1_4 = ((iterate_d0_d0_d0 f_2_7) (f_2_7 x_5)) in
    (let rec h_1_1 = x_5 in
      (fun n_4 -> 
...
(* lumberhack_pop_out *)
let rec divmod_d1_d0_d0_d0 _lh_divmod_arg1_2 _lh_divmod_arg2_2 a_6 chop'_3 n_9 =
...
let rec doInput_d0_d0_d0_d0 _lh_doInput_arg1_7 _lh_doInput_arg2_3 =
  (_lh_doInput_arg2_3 _lh_doInput_arg1_7);;
let rec doInput_d0_d0_d1_d0 _lh_doInput_arg1_4 _lh_doInput_arg2_2 =
  (_lh_doInput_arg2_2 _lh_doInput_arg1_4);;
let rec drop_lz_d0_d0_d0_d0 _lh_drop_lz_arg1_1 _lh_drop_lz_arg2_1 =
  (let rec _lh_matchIdent_1_5 = (Lazy.force _lh_drop_lz_arg2_1) in
    (match _lh_matchIdent_1_5 with
      | `LH_N -> 
        (lazy (`LH_N))
      | `LH_C(_lh_drop_lz_LH_C_0_1, _lh_drop_lz_LH_C_1_1) -> 
...
let rec even_d1_d0_d0_d0 _lh_even_arg1_2 =
  ((_lh_even_arg1_2 mod 2) = 0);;
let rec foldl_d0_d0_d0_d0 f_4_9 i_3_1 ls_2_5 =
  ((ls_2_5 f_4_9) i_3_1);;
let rec foldl_d0_d0_d1_d0 f_5_3 i_3_4 ls_3_0 =
  ((ls_3_0 f_5_3) i_3_4);;
let rec foldl_d0_d0_d1_d0_d0 f_7_1 i_4_6 ls_3_5 =
  ((ls_3_5 f_7_1) i_4_6);;
let rec foldl_d0_d0_d2_d0 f_5_6 i_3_5 ls_3_2 =
  ((ls_3_2 f_5_6) i_3_5);;
let rec foldl_d0_d0_d3_d0 f_4_4 i_2_8 ls_2_2 =
  ((ls_2_2 f_4_4) i_2_8);;
let rec foldl_d0_d0_d4_d0 f_4_1 i_2_6 ls_2_0 =
  ((ls_2_0 f_4_1) i_2_6);;
let rec foldl_d0_d0_d5_d0 f_4_6 i_2_9 ls_2_3 =
  ((ls_2_3 f_4_6) i_2_9);;
let rec foldl_d0_d0_d6_d0 f_4_8 i_3_0 ls_2_4 =
  ((ls_2_4 f_4_8) i_3_0);;
let rec foldl_d0_d0_d7_d0 f_3_8 i_2_5 ls_1_9 =
  ((ls_1_9 f_3_8) i_2_5);;
let rec foldl_d0_d0_d8_d0 f_4_3 i_2_7 ls_2_1 =
  ((ls_2_1 f_4_3) i_2_7);;
let rec foldl_d0_d0_d9_d0 f_7_5 i_4_9 ls_3_7 =
  ((ls_3_7 f_7_5) i_4_9);;
...
let rec int_val_of_string_d0_d0_d0_d0 _lh_int_val_of_string_arg1_1 =
  (let rec f_4_7 = (fun _lh_f_arg1_3 _lh_f_arg2_4 -> 
    ((_lh_f_arg1_3 _lh_f_arg2_4) f_4_7)) in
    ((f_4_7 _lh_int_val_of_string_arg1_1) 0));;
let rec length_d0_d0_d0_d0 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_1_8, t_2_1) -> 
      (1 + (length_d0_d0_d0_d0 t_2_1))
    | `LH_N -> 
      0);;
...
let rec take_lz_d0_d0_d0_d0 n_1_0 ls_2_6 =
  (if (n_1_0 > 0) then
    (match (Lazy.force ls_2_6) with
      | `LH_C(h_1_7, t_2_0) -> 
        (`LH_C(h_1_7, ((take_lz_d0_d0_d0_d0 (n_1_0 - 1)) t_2_0)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
let rec take_lz_d1_d0_d0_d0 n_1_1 ls_2_8 =
  (if (n_1_1 > 0) then
    ((Lazy.force ls_2_8) n_1_1)
  else
    (`LH_N));;
let rec take_lz_d1_d0_d1_d0 n_1_3 ls_3_4 =
  (if (n_1_3 > 0) then
    ((Lazy.force ls_3_4) n_1_3)
  else
    (`LH_N));;
let rec break_d0_d0_d0_d0 _lh_break_arg1_1 _lh_break_arg2_1 =
  (match _lh_break_arg2_1 with
    | `LH_N -> 
      (`LH_P2((fun _lh_f_arg2_5 f_5_7 -> 
        _lh_f_arg2_5), (fun _lh_dummy_2 _lh_doInput_arg1_6 -> 
        (`LH_N))))
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_1) then
        (`LH_P2((fun _lh_f_arg2_6 f_5_8 -> 
          _lh_f_arg2_6), (let rec _lh_lines_LH_C_1_1 = _lh_break_LH_C_1_1 in
          (fun _lh_dummy_3 -> 
            (lines_d0_d0_d0_d0 _lh_lines_LH_C_1_1)))))
      else
        (let rec _lh_matchIdent_2_5 = ((break_d0_d0_d0_d0 _lh_break_arg1_1) _lh_break_LH_C_1_1) in
            ...
            | `LH_P2(_lh_break_LH_P2_0_1, _lh_break_LH_P2_1_1) -> 
              (`LH_P2((let rec _lh_f_LH_C_1_1 = _lh_break_LH_P2_0_1 in
                (let rec _lh_f_LH_C_0_1 = _lh_break_LH_C_0_1 in
                  (fun _lh_f_arg2_7 f_5_9 -> 
                    ((f_5_9 _lh_f_LH_C_1_1) ((10 * _lh_f_arg2_7) + (int_val_of_char_d0_d0_d0_d0 _lh_f_LH_C_0_1)))))), _lh_break_LH_P2_1_1))
            | _ -> 
              (failwith "error"))))
    | _ -> 
      (failwith "error"))
and chop_d0_d0_d0_d0 _lh_chop_arg1_1 =
  (let rec chop'_2 = (fun a_5 n_7 -> 
    ...
    (chop'_2 (`LH_N)))
and divmod_d0_d0_d0_d0 _lh_divmod_arg1_3 _lh_divmod_arg2_3 _lh_f_LH_P2_0_6 _lh_f_LH_P2_1_6 f_5_4 =
  (let rec _lh_f_LH_P2_1_5 = (_lh_divmod_arg1_3 mod _lh_divmod_arg2_3) in
    (let rec _lh_f_LH_P2_0_5 = (_lh_divmod_arg1_3 / _lh_divmod_arg2_3) in
      (if (_lh_f_LH_P2_1_5 = 0) then
        (f_5_4 (let rec _lh_f_LH_P2_1_7 = _lh_f_LH_P2_0_5 in
          (let rec _lh_f_LH_P2_0_7 = (_lh_f_LH_P2_0_6 + 1) in
            (fun f_5_5 -> 
              (let rec _lh_matchIdent_2_0 = ((divmod_d0_d0_d0_d0 _lh_f_LH_P2_1_7) 2) in
                (((_lh_matchIdent_2_0 _lh_f_LH_P2_0_7) _lh_f_LH_P2_1_7) f_5_5))))))
      else
          ...
          (let rec _lh_singleTestX_LH_P2_1_1 = _lh_f_LH_P2_1_6 in
            (let rec _lh_singleTestX_LH_P2_0_1 = _lh_f_LH_P2_0_6 in
              (let rec square_1 = (fun x_8 -> 
                ((x_8 * x_8) mod _lh_singleTestX_arg1_3)) in
                (let rec witness_1 = (fun ls_3_1 -> 
                  (let rec _lh_matchIdent_2_1 = ls_3_1 in
                    (match _lh_matchIdent_2_1 with
                      | `LH_N -> 
                        false
                      | `LH_C(_lh_singleTestX_LH_C_0_2, _lh_singleTestX_LH_C_1_2) -> 
                      ...
                      | _ -> 
                        (failwith "error")))) in
                  (let rec _lh_matchIdent_2_2 = ((take_lz_d1_d0_d1_d0 _lh_singleTestX_LH_P2_0_1) ((iterate_d0_d0_d0_d0 square_1) (((powerMod_d0_d0_d0_d0 _lh_singleTestX_arg3_3) _lh_singleTestX_LH_P2_1_1) _lh_singleTestX_arg1_3))) in
                    (match _lh_matchIdent_2_2 with
                      | `LH_C(_lh_singleTestX_LH_C_0_3, _lh_singleTestX_LH_C_1_3) -> 
                        (((_lh_singleTestX_LH_C_0_3 = 1) || (_lh_singleTestX_LH_C_0_3 = (_lh_singleTestX_arg1_3 - 1))) || (witness_1 _lh_singleTestX_LH_C_1_3))
                      | _ -> 
                        (failwith "error")))))))))))
and doLine_d0_d0_d0_d0 _lh_doLine_arg1_1 _lh_doLine_arg2_6 _lh_doLine_arg3_1 =
  (let rec n_1_2 = (int_val_of_string_d0_d0_d0_d0 _lh_doLine_arg1_1) in
    (let rec _lh_matchIdent_1_9 = (((multiTest_d0_d0_d0_d0 100) _lh_doLine_arg3_1) n_1_2) in
      (_lh_matchIdent_1_9 _lh_doLine_arg2_6)))
and findKQ_d0_d0_d0_d0 _lh_findKQ_arg1_1 =
  (let rec f_3_9 = (fun _lh_f_arg1_2 -> 
    (_lh_f_arg1_2 f_3_9)) in
    (f_3_9 (let rec _lh_f_LH_P2_1_4 = (_lh_findKQ_arg1_1 - 1) in
...
and iterate_d0_d0_d0_d0 f_4_2 x_7 =
  (lazy (let rec t_1_9 = ((iterate_d0_d0_d0_d0 f_4_2) (f_4_2 x_7)) in
    (let rec h_1_6 = x_7 in
      (fun n_8 -> 
        (`LH_C(h_1_6, ((take_lz_d1_d0_d0_d0 (n_8 - 1)) t_1_9)))))))
and lines_d0_d0_d0_d0 _lh_lines_arg1_1 =
  (let rec _lh_matchIdent_2_3 = ((break_d0_d0_d0_d0 (fun x_9 -> 
    (x_9 = '|'))) _lh_lines_arg1_1) in
    (match _lh_matchIdent_2_3 with
      | `LH_P2(_lh_lines_LH_P2_0_1, _lh_lines_LH_P2_1_1) -> 
        (let rec _lh_doInput_LH_C_1_1 = (let rec _lh_matchIdent_2_4 = _lh_lines_LH_P2_1_1 in
          (_lh_matchIdent_2_4 99)) in
          (let rec _lh_doInput_LH_C_0_1 = _lh_lines_LH_P2_0_1 in
            (fun _lh_doInput_arg1_5 -> 
              (((doLine_d0_d0_d0_d0 _lh_doInput_LH_C_0_1) (fun state_1 -> 
                ((doInput_d0_d0_d0_d0 state_1) _lh_doInput_LH_C_1_1))) _lh_doInput_arg1_5))))
      | _ -> 
        (failwith "error")))
and makeNumber_d0_d0_d0_d0 _lh_makeNumber_arg1_1 =
  ((foldl_d0_d0_d0_d0 (fun a_9 x_1_3 -> 
    ((a_9 * _lh_makeNumber_arg1_1) + x_1_3))) 0)
and map_d0_d0_d0_d0 f_5_0 ls_2_9 _lh_popOutId_0_3 _lh_popOutId_1_3 =
  (match ls_2_9 with
    | `LH_C(h_1_9, t_2_2) -> 
      (let rec t_2_3 = ((map_d0_d0_d0_d0 f_5_0) t_2_2) in
        (let rec h_2_0 = (f_5_0 h_1_9) in
          (((foldl_d0_d0_d8_d0 _lh_popOutId_0_3) ((_lh_popOutId_0_3 _lh_popOutId_1_3) h_2_0)) t_2_3)))
    | `LH_N -> 
      _lh_popOutId_1_3)
and map_d0_d1_d0_d0 f_7_2 ls_3_6 _lh_popOutId_0_5 _lh_popOutId_1_5 =
  (match ls_3_6 with
    | `LH_C(h_3_0, t_3_6) -> 
      (let rec t_3_7 = ((map_d0_d1_d0_d0 f_7_2) t_3_6) in
        (let rec h_3_1 = (f_7_2 h_3_0) in
          (((foldl_d0_d0_d9_d0 _lh_popOutId_0_5) ((_lh_popOutId_0_5 _lh_popOutId_1_5) h_3_1)) t_3_7)))
    | `LH_N -> 
      _lh_popOutId_1_5)
and map_d0_d2_d0_d0 f_6_0 ls_3_3 _lh_popOutId_0_4 _lh_popOutId_1_4 =
  (match ls_3_3 with
    | `LH_C(h_2_1, t_2_4) -> 
      (let rec t_2_5 = ((map_d0_d2_d0_d0 f_6_0) t_2_4) in
        (let rec h_2_2 = (f_6_0 h_2_1) in
          (((foldl_d0_d0_d1_d0_d0 _lh_popOutId_0_4) ((_lh_popOutId_0_4 _lh_popOutId_1_4) h_2_2)) t_2_5)))
    | `LH_N -> 
      _lh_popOutId_1_4)
...
and powerMod_d0_d0_d0_d0 _lh_powerMod_arg1_1 _lh_powerMod_arg2_1 _lh_powerMod_arg3_1 =
  (match _lh_powerMod_arg2_1 with
    ...
    | _ -> 
      (let rec a'_1 = (_lh_powerMod_arg1_1 mod _lh_powerMod_arg3_1) in
        (let rec f_4_5 = (fun a_7 b_2 c_1 -> 
          (let rec g_1 = (fun a_8 b_3 -> 
            (if (even_d1_d0_d0_d0 b_3) then
              ((g_1 ((a_8 * a_8) mod _lh_powerMod_arg3_1)) (b_3 / 2))
            else
              (((f_4_5 a_8) (b_3 - 1)) ((a_8 * c_1) mod _lh_powerMod_arg3_1)))) in
            (if (b_2 = 0) then
              c_1
            else
              ((g_1 a_7) b_2)))) in
          (((f_4_5 a'_1) (_lh_powerMod_arg2_1 - 1)) a'_1))))
...
and singleTest_d0_d0_d0_d0 _lh_singleTest_arg1_2 _lh_singleTest_arg2_2 _lh_singleTest_arg3_1 =
  (let rec _lh_matchIdent_1_6 = ((random_d0_d0_d0_d0 (_lh_singleTest_arg1_2 - 2)) _lh_singleTest_arg3_1) in
    ((_lh_matchIdent_1_6 _lh_singleTest_arg1_2) _lh_singleTest_arg2_2))
                  ...
                  (let rec _lh_doLine_LH_P2_1_5 = _lh_multiTest_LH_P2_1_1 in
                    (let rec _lh_doLine_LH_P2_0_5 = false in
                      (if _lh_doLine_LH_P2_0_5 then
                        (`LH_C((`LH_C('P', (`LH_C('r', (`LH_C('o', (`LH_C('b', (`LH_C('a', (`LH_C('b', (`LH_C('l', (`LH_C('y', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('m', (`LH_C('e', (`LH_N))))))))))))))))))))))))))))), (_lh_doLine_arg2_7 _lh_doLine_LH_P2_1_5)))
                      else
                        (`LH_C((`LH_C('C', (`LH_C('o', (`LH_C('m', (`LH_C('p', (`LH_C('o', (`LH_C('s', (`LH_C('i', (`LH_C('t', (`LH_C('e', (`LH_N))))))))))))))))))), (_lh_doLine_arg2_7 _lh_doLine_LH_P2_1_5))))))))))))))
        ...
        | `LH_N -> 
          (match _lh_uniform_arg2_1 with
            | `LH_C(_lh_uniform_LH_C_0_6, _lh_uniform_LH_C_1_6) -> 
              (match _lh_uniform_LH_C_1_6 with
                | `LH_N -> 
                  (let rec t_2_6 = (fun f_6_3 i_3_8 -> 
                    i_3_8) in
                    (let rec h_2_3 = (_lh_uniform_LH_C_0_6 mod _lh_uniform_LH_C_0_5) in
                      (fun f_6_4 i_3_9 -> 
                        (((foldl_d0_d0_d1_d0 f_6_4) ((f_6_4 i_3_9) h_2_3)) t_2_6))))
                | _ -> 
                  (match _lh_uniform_arg2_1 with
                    | `LH_C(_lh_uniform_LH_C_0_7, _lh_uniform_LH_C_1_7) -> 
                      (let rec t_2_7 = (_lh_uniform_LH_C_0_7 mod (_lh_uniform_LH_C_0_5 + 1)) in
                        (if (t_2_7 = _lh_uniform_LH_C_0_5) then
                          (let rec t_2_8 = ((uniform_d0_d0_d0_d0 _lh_uniform_LH_C_1_5) _lh_uniform_LH_C_1_7) in
                            (let rec h_2_4 = t_2_7 in
                              (fun f_6_5 i_4_0 -> 
                                (((foldl_d0_d0_d2_d0 f_6_5) ((f_6_5 i_4_0) h_2_4)) t_2_8))))
                        else
                          (let rec t_2_9 = ((map_d0_d0_d0_d0 (fun x_1_0 -> 
                            (x_1_0 mod 65536))) _lh_uniform_LH_C_1_7) in
                            (let rec h_2_5 = t_2_7 in
                              (fun f_6_6 i_4_1 -> 
                                (((foldl_d0_d0_d3_d0 f_6_6) ((f_6_6 i_4_1) h_2_5)) t_2_9))))))
                    | _ -> 
                      (failwith "error")))
            | _ -> 
              (match _lh_uniform_arg2_1 with
                | `LH_C(_lh_uniform_LH_C_0_8, _lh_uniform_LH_C_1_8) -> 
                  (let rec t_3_0 = (_lh_uniform_LH_C_0_8 mod (_lh_uniform_LH_C_0_5 + 1)) in
                    (if (t_3_0 = _lh_uniform_LH_C_0_5) then
                      (let rec t_3_1 = ((uniform_d0_d0_d0_d0 _lh_uniform_LH_C_1_5) _lh_uniform_LH_C_1_8) in
                        (let rec h_2_6 = t_3_0 in
                          (fun f_6_7 i_4_2 -> 
                            (((foldl_d0_d0_d4_d0 f_6_7) ((f_6_7 i_4_2) h_2_6)) t_3_1))))
                    else
                      (let rec t_3_2 = ((map_d0_d1_d0_d0 (fun x_1_1 -> 
                        (x_1_1 mod 65536))) _lh_uniform_LH_C_1_8) in
                        (let rec h_2_7 = t_3_0 in
                          (fun f_6_8 i_4_3 -> 
                            (((foldl_d0_d0_d5_d0 f_6_8) ((f_6_8 i_4_3) h_2_7)) t_3_2))))))
                | _ -> 
                  (failwith "error")))
        | _ -> 
          (match _lh_uniform_arg2_1 with
            | `LH_C(_lh_uniform_LH_C_0_9, _lh_uniform_LH_C_1_9) -> 
              (let rec t_3_3 = (_lh_uniform_LH_C_0_9 mod (_lh_uniform_LH_C_0_5 + 1)) in
                (if (t_3_3 = _lh_uniform_LH_C_0_5) then
                  (let rec t_3_4 = ((uniform_d0_d0_d0_d0 _lh_uniform_LH_C_1_5) _lh_uniform_LH_C_1_9) in
                    (let rec h_2_8 = t_3_3 in
                      (fun f_6_9 i_4_4 -> 
                        (((foldl_d0_d0_d6_d0 f_6_9) ((f_6_9 i_4_4) h_2_8)) t_3_4))))
                else
                  (let rec t_3_5 = ((map_d0_d2_d0_d0 (fun x_1_2 -> 
                    (x_1_2 mod 65536))) _lh_uniform_LH_C_1_9) in
                    (let rec h_2_9 = t_3_3 in
                      (fun f_7_0 i_4_5 -> 
                        (((foldl_d0_d0_d7_d0 f_7_0) ((f_7_0 i_4_5) h_2_9)) t_3_5))))))
            | _ -> 
              (failwith "error")))
    | _ -> 
      (failwith "error"));;

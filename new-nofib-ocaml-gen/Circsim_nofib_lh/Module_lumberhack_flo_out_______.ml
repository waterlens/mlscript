...
let rec outports_lh__d2 _lh_outports_arg1_1 =
  (match _lh_outports_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec zipWith_lh__d2 f_1_9 xs_7 ys_1_0 =
  (match xs_7 with
    | `LH_C(hx_2, tx_2) -> 
      (match ys_1_0 with
        | `LH_C(hy_1, ty_1) -> 
          (`LH_C(((f_1_9 hx_2) hy_1), (((zipWith_lh__d2 f_1_9) tx_2) ty_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec zipWith_lh__d1 f_3_0 xs_1_1 ys_2_9 =
  (match xs_1_1 with
    | `LH_C(hx_5, tx_5) -> 
      (match ys_2_9 with
        | `LH_C(hy_4, ty_4) -> 
          (`LH_C(((f_3_0 hx_5) hy_4), (((zipWith_lh__d1 f_3_0) tx_5) ty_4)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec enumFromTo_lh__d4 a_2 b_0 _lh_popOutId_0_1 _lh_popOutId_1_0 =
  (if (a_2 <= b_0) then
    (let rec t_1_0 = ((enumFromTo_lh__d4 (a_2 + 1)) b_0) in
      (let rec h_1_0 = a_2 in
        ((t_1_0 _lh_popOutId_0_1) ((_lh_popOutId_0_1 _lh_popOutId_1_0) h_1_0))))
  else
    _lh_popOutId_1_0);;
let rec foldr_lh__d1 f_1_8 i_1 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_6, t_1_6) -> 
      ((f_1_8 h_1_6) (((foldr_lh__d1 f_1_8) i_1) t_1_6))
    | `LH_N -> 
      i_1);;
...
let rec map_lh__d2_d0 f_9 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C((f_9 h_1_1), ((map_lh__d2_d0 f_9) t_1_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec update_i_lh__d1 _lh_update_i_arg1_0 _lh_update_i_arg2_0 =
  (match _lh_update_i_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec zipWith_lh__d5 f_4_4 xs_1_8 ys_3_3 =
  (match xs_1_8 with
    | `LH_C(hx_1_1, tx_1_1) -> 
      (match ys_3_3 with
        | `LH_C(hy_9, ty_9) -> 
          (`LH_C(((f_4_4 hx_1_1) hy_9), (((zipWith_lh__d5 f_4_4) tx_1_1) ty_9)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d1_d4 f_3_3 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_4_1, t_4_1) -> 
      (`LH_C((f_3_3 h_4_1), ((map_lh__d1_d4 f_3_3) t_4_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec zipWith_lh__d4 f_4_1 xs_1_6 ys_3_2 =
  (match xs_1_6 with
    | `LH_C(hx_1_0, tx_1_0) -> 
      (match ys_3_2 with
        | `LH_C(hy_8, ty_8) -> 
          (`LH_C(((f_4_1 hx_1_0) hy_8), (((zipWith_lh__d4 f_4_1) tx_1_0) ty_8)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d1_d9 f_1_0 ls_7 =
  (match ls_7 with
    | `LH_C(h_1_2, t_1_2) -> 
      (let rec t_1_3 = ((map_lh__d1_d9 f_1_0) t_1_2) in
        (let rec h_1_3 = (f_1_0 h_1_2) in
          (fun f_1_1 -> 
            (let rec _lh_or_LH_C_1_1 = (t_1_3 f_1_1) in
              (let rec _lh_or_LH_C_0_1 = (f_1_1 h_1_3) in
                (fun _lh_dummy_2 -> 
...
let rec outports_lh__d6 _lh_outports_arg1_5 =
  (match _lh_outports_arg1_5 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1_d8 f_2_8 ls_1_6 _lh_popOutId_0_2 =
  (match ls_1_6 with
    | `LH_C(h_3_8, t_3_8) -> 
      (let rec _lh_or_LH_C_1_3 = ((map_lh__d1_d8 f_2_8) t_3_8) in
        (let rec _lh_or_LH_C_0_3 = (f_2_8 h_3_8) in
...
let rec zipWith_lh__d3 f_3_8 xs_1_5 ys_3_1 =
  (match xs_1_5 with
    | `LH_C(hx_9, tx_9) -> 
      (match ys_3_1 with
        | `LH_C(hy_7, ty_7) -> 
          (`LH_C(((f_3_8 hx_9) hy_7), (((zipWith_lh__d3 f_3_8) tx_9) ty_7)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d1_d0 f_4_0 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_4_6, t_4_6) -> 
      (`LH_C((f_4_0 h_4_6), ((map_lh__d1_d0 f_4_0) t_4_6)))
    | `LH_N -> 
      (`LH_N));;
...
let rec outports_lh__d5 _lh_outports_arg1_2 =
  (match _lh_outports_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d1_d1 f_8 ls_5 _lh_popOutId_0_0 =
  (match ls_5 with
    | `LH_C(h_9, t_9) -> 
      (let rec _lh_or_LH_C_1_0 = ((map_lh__d1_d1 f_8) t_9) in
        (let rec _lh_or_LH_C_0_0 = (f_8 h_9) in
...
let rec map_lh__d1_d3 f_1_3 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_4, t_1_4) -> 
      (let rec t_1_5 = ((map_lh__d1_d3 f_1_3) t_1_4) in
        (let rec h_1_5 = (f_1_3 h_1_4) in
          (fun f_1_4 -> 
            (let rec _lh_or_LH_C_1_2 = (t_1_5 f_1_4) in
              (let rec _lh_or_LH_C_0_2 = (f_1_4 h_1_5) in
                (fun _lh_dummy_4 -> 
...
let rec map_lh__d5 f_3_2 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_4_0, t_4_0) -> 
      (`LH_C((f_3_2 h_4_0), ((map_lh__d5 f_3_2) t_4_0)))
    | `LH_N -> 
      (`LH_N));;
        ...
        (fun _lh_listcomp_fun_8 -> 
          (let rec ty_0 = (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_2) in
            (let rec hy_0 = ((7 * _lh_listcomp_fun_ls_h_2) + 7) in
              (fun f_1_6 xs_3 -> 
                ((((Lazy.force xs_3) f_1_6) hy_0) ty_0)))))))
  else
    (fun _lh_listcomp_fun_9 f_1_7 xs_4 -> 
      (`LH_N)));;
...
let rec enumFrom_lh__d2 a_4 =
  (lazy (let rec tx_3 = (enumFrom_lh__d2 (a_4 + 1)) in
    (let rec hx_3 = a_4 in
      (fun f_2_1 hy_2 ty_2 -> 
        (`LH_C(((f_2_1 hx_3) hy_2), ((ty_2 f_2_1) tx_3)))))));;
let rec map_lh__d6 f_2_2 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_3_2, t_3_2) -> 
      (`LH_C((f_2_2 h_3_2), ((map_lh__d6 f_2_2) t_3_2)))
    | `LH_N -> 
      (`LH_N));;
        ...
        (fun _lh_listcomp_fun_1_3 -> 
          (let rec t_3_6 = (_lh_listcomp_fun_1_3 _lh_listcomp_fun_ls_t_6) in
            (let rec h_3_6 = ((7 * _lh_listcomp_fun_ls_h_6) + 1) in
              (fun f_2_6 -> 
                (let rec t_3_7 = (t_3_6 f_2_6) in
                  (let rec h_3_7 = (f_2_6 h_3_6) in
                    (fun _lh_dummy_6 -> 
                      (h_3_7 (t_3_7 99)))))))))))
  else
    (fun _lh_listcomp_fun_1_4 f_2_7 _lh_dummy_7 ys_2_8 -> 
      ys_2_8));;
let rec copy_lh__d3 _lh_copy_arg1_3 _lh_copy_arg2_3 =
  (if (_lh_copy_arg1_3 > 0) then
    ...
    (`LH_N));;
let rec map_lh__d4 f_3_7 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_4_4, t_4_4) -> 
      (`LH_C((f_3_7 h_4_4), ((map_lh__d4 f_3_7) t_4_4)))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d2 f_2_4 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_3_4, t_3_4) -> 
      (`LH_C((f_2_4 h_3_4), ((map_lh__d2 f_2_4) t_3_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec pid_lh__d1 _lh_pid_arg1_3 =
  (match _lh_pid_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec map_lh__d3 f_3_6 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_4_2, t_4_2) -> 
      (`LH_C((f_3_6 h_4_2), ((map_lh__d3 f_3_6) t_4_2)))
    | `LH_N -> 
      (`LH_N));;
...
let rec enumFrom_lh__d1 a_6 =
  (lazy (let rec tx_4 = (enumFrom_lh__d1 (a_6 + 1)) in
    (let rec hx_4 = a_6 in
      (fun f_2_9 hy_3 ty_3 -> 
        (`LH_C(((f_2_9 hx_4) hy_3), ((ty_3 f_2_9) tx_4)))))));;
        ...
        (fun _lh_listcomp_fun_1_9 -> 
          (let rec ty_6 = (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_9) in
            (let rec hy_6 = ((7 * _lh_listcomp_fun_ls_h_8) + 1) in
              (fun f_3_4 xs_1_3 -> 
                ((((Lazy.force xs_1_3) f_3_4) hy_6) ty_6)))))))
  else
    (fun _lh_listcomp_fun_2_0 f_3_5 xs_1_4 -> 
      (`LH_N)));;

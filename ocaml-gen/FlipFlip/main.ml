...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_FlipFlip" (fun () -> ignore (let open Module_lumberhack_________.Module_lumberhack_________ in ((testFlipFlip__d0 ((genTree__d0 17) 0)))));
  Bench.Test.create ~name:"lumberhack_pop_out_FlipFlip" (fun () -> ignore (let open Module_lumberhack_pop_out_.Module_lumberhack_pop_out_ in ((testFlipFlip__d0 ((genTree__d0 17) 0)))));
])

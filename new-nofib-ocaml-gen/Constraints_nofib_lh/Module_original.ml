  ...
  (let rec f_5 = (fun _lh_f_arg1_0 _lh_f_arg2_0 -> 
    (match _lh_f_arg1_0 with
      ...
      | _ -> 
        (failwith "error"))) in
    (foldTree_lh f_5))
and bjbt'_lh _lh_bjbt'_arg1_0 _lh_funcomp_x_7 =
  ((bj'_lh _lh_bjbt'_arg1_0) ((bt_lh _lh_bjbt'_arg1_0) _lh_funcomp_x_7))
and bjbt_lh _lh_bjbt_arg1_0 _lh_funcomp_x_3 =
  ((bj_lh _lh_bjbt_arg1_0) ((bt_lh _lh_bjbt_arg1_0) _lh_funcomp_x_3))
and bm_lh _lh_bm_arg1_0 _lh_funcomp_x_0 =
  ((fun _lh_funcomp_x_1 -> 
    ...
    (`LH_P2(s_0, (let rec _lh_matchIdent_0 = ((earliestInconsistency_lh _lh_bt_arg1_0) s_0) in
      (match _lh_matchIdent_0 with
        ...
        | _ -> 
          (failwith "error")))))) in
    (mapTree_lh f_4))
and cacheChecks_lh _lh_cacheChecks_arg1_0 _lh_cacheChecks_arg2_0 _lh_cacheChecks_arg3_0 =
  (match _lh_cacheChecks_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and checkComplete_lh _lh_checkComplete_arg1_0 _lh_checkComplete_arg2_0 =
  (if ((complete_lh _lh_checkComplete_arg1_0) _lh_checkComplete_arg2_0) then
    (`Known((`LH_N)))
  else
    (`Unknown))
and collect_lh _lh_collect_arg1_0 =
  (match _lh_collect_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and combine_lh _lh_combine_arg1_0 _lh_combine_arg2_0 =
  (match _lh_combine_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and complete_lh _lh_complete_arg1_0 _lh_complete_arg2_0 =
...
and domainWipeOut_lh _lh_domainWipeOut_arg1_0 _lh_domainWipeOut_arg2_0 =
  (match _lh_domainWipeOut_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and earliestInconsistency_lh _lh_earliestInconsistency_arg1_0 _lh_earliestInconsistency_arg2_0 =
  (match _lh_earliestInconsistency_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and emptyTable_lh _lh_emptyTable_arg1_0 =
  (match _lh_emptyTable_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and fc_lh _lh_fc_arg1_0 _lh_funcomp_x_4 =
  ((fun _lh_funcomp_x_5 -> 
...
and fillTable_lh _lh_fillTable_arg1_0 _lh_fillTable_arg2_0 _lh_fillTable_arg3_0 =
...
and mkTree_lh _lh_mkTree_arg1_0 =
  (match _lh_mkTree_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and nubBy_lh _lh_nubBy_arg1_0 _lh_nubBy_arg2_0 =
...
and safe_lh _lh_safe_arg1_0 _lh_safe_arg2_0 =
  (match _lh_safe_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and search_lh _lh_search_arg1_0 _lh_search_arg2_0 =
  ((fun _lh_funcomp_x_9 -> 
...
and testConstraints_nofib_lh _lh_testConstraints_nofib_arg1_0 =
  ((map_lh (try_lh _lh_testConstraints_nofib_arg1_0)) (`LH_C(bt_lh, (`LH_C(bm_lh, (`LH_C(bjbt_lh, (`LH_C(bjbt'_lh, (`LH_C(fc_lh, (`LH_N))))))))))))
and try_lh _lh_try_arg1_0 _lh_try_arg2_0 =
  (length_lh ((search_lh _lh_try_arg2_0) (queens_lh _lh_try_arg1_0)))
and unionBy_lh _lh_unionBy_arg1_0 _lh_unionBy_arg2_0 _lh_unionBy_arg3_0 =

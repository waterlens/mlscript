...
let rec enumFromTo__d0__d0 a_1 b_1 =
  (if (a_1 <= b_1) then
    ...
    (`N));;
let rec map__d0__d0 f_4 ls_3 =
  (ls_3 f_4);;
let rec map__d0__d1 f_8 ls_5 =
  (ls_5 f_8);;
let rec map__d1__d0 f_5 ls_4 _lh_popOutId_0_0 =
  (match ls_4 with
    | `C(h_2, t_2) -> 
      (let rec r_2 = (f_5 h_2) in
        (let rec t_3 = ((map__d1__d0 f_5) t_2) in
          (let rec h_3 = r_2 in
            (let rec r_3 = (_lh_popOutId_0_0 h_3) in
              (`C(r_3, ((map__d0__d1 _lh_popOutId_0_0) t_3)))))))
    | `N -> 
      (`N))
and testMapmapLet__d0__d0 ls_6 =
  ((map__d0__d0 (fun x_2 -> 
    (x_2 + 1))) ((map__d1__d0 (fun x_3 -> 
    (x_3 * x_3))) ls_6));;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_MapmapLet" (fun () -> ignore ((testMapmapLet ((enumFromTo 1) 100000))));
  Bench.Test.create ~name:"lumberhack_MapmapLet" (fun () -> ignore ((testMapmapLet__d0 ((enumFromTo__d0 1) 100000))));
  Bench.Test.create ~name:"lumberhack_pop_out_MapmapLet" (fun () -> ignore ((testMapmapLet__d0__d0 ((enumFromTo__d0__d0 1) 100000))));
])

  ...
  ((fun _lh_funcomp_x_1 -> 
    ((fun _lh_funcomp_x_2 -> 
      ((fun _lh_funcomp_x_3 -> 
        ((fun _lh_funcomp_x_4 -> 
          ((fun s_0 -> 
            ((mappend_lh__d7 (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('-', (`LH_C('|', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) s_0)) (((fun _lh_writeItem_arg2_1 _lh_writeItem_arg3_1 -> 
            (match _lh_writeItem_arg2_1 with
              ...
              | _ -> 
                (failwith "error"))) (bonoPos_lh__d3 _lh_writeState_arg1_0)) _lh_funcomp_x_4))) (((fun _lh_writeItem_arg2_2 _lh_writeItem_arg3_2 -> 
          (match _lh_writeItem_arg2_2 with
            ...
            | _ -> 
              (failwith "error"))) (edgePos_lh__d4 _lh_writeState_arg1_0)) _lh_funcomp_x_3))) (((fun _lh_writeItem_arg2_3 _lh_writeItem_arg3_3 -> 
        (match _lh_writeItem_arg2_3 with
          ...
          | _ -> 
            (failwith "error"))) (larryPos_lh__d3 _lh_writeState_arg1_0)) _lh_funcomp_x_2))) (((fun _lh_writeItem_arg2_4 _lh_writeItem_arg3_4 -> 
              ...
              (fun _lh_funcomp_x_5 -> 
                ((fun _lh_funcomp_x_6 -> 
                  ((fun _lh_funcomp_x_7 -> 
                    ((fun _lh_funcomp_x_8 -> 
                      ((fun x_1 -> 
                        ((let rec t_6 = (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (fun ys_7 -> 
                          ys_7) in
                          (let rec h_6 = ' ' in
                            (fun ys_8 -> 
                              (`LH_C(h_6, (t_1_1 ys_8)))))) in
                          (let rec h_7 = ':' in
                            (fun ys_9 -> 
                              (`LH_C(h_7, (t_1_0 ys_9)))))) in
                          (let rec h_8 = 'e' in
                            (fun ys_1_0 -> 
                              (`LH_C(h_8, (t_9 ys_1_0)))))) in
                          (let rec h_9 = 'm' in
                            (fun ys_1_1 -> 
                              (`LH_C(h_9, (t_8 ys_1_1)))))) in
                          (let rec h_1_0 = 'i' in
                            (fun ys_1_2 -> 
                              (`LH_C(h_1_0, (t_7 ys_1_2)))))) in
                          (let rec h_1_1 = 'T' in
                            (fun ys_1_3 -> 
                              (`LH_C(h_1_1, (t_6 ys_1_3)))))) x_1)) ((fun x_2 -> 
...
let rec reverse_lh__d1 ls_4 =
  (ls_4 (fun _lh_writeSolutions_arg2_5 x_1_5 -> 
    x_1_5));;
      ...
      (let rec minAcc_0 = (fun minSoFar_0 mins_0 ls_3 -> 
                  ...
                  (if (minSoFar_0 = total_0) then
                    (((minAcc_0 minSoFar_0) (let rec t_1_3 = mins_0 in
                      (let rec h_1_3 = _lh_minSolutions_LH_C_0_1 in
                        (fun a_1 -> 
                          (t_1_3 (let rec _lh_writeSolutions_LH_C_1_0 = a_1 in
                                ...
                                ((fun _lh_funcomp_x_1_0 -> 
                                  ((fun _lh_funcomp_x_1_1 -> 
                                    ((fun _lh_funcomp_x_1_2 -> 
                                      ((fun x_6 -> 
                                        ((let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (fun ys_1_4 -> 
                                          ys_1_4) in
                                          (let rec h_1_4 = ' ' in
                                            (fun ys_1_5 -> 
                                              (`LH_C(h_1_4, (t_2_2 ys_1_5)))))) in
                                          (let rec h_1_5 = 'n' in
                                            (fun ys_1_6 -> 
                                              (`LH_C(h_1_5, (t_2_1 ys_1_6)))))) in
                                          (let rec h_1_6 = 'o' in
                                            (fun ys_1_7 -> 
                                              (`LH_C(h_1_6, (t_2_0 ys_1_7)))))) in
                                          (let rec h_1_7 = 'i' in
                                            (fun ys_1_8 -> 
                                              (`LH_C(h_1_7, (t_1_9 ys_1_8)))))) in
                                          (let rec h_1_8 = 't' in
                                            (fun ys_1_9 -> 
                                              (`LH_C(h_1_8, (t_1_8 ys_1_9)))))) in
                                          (let rec h_1_9 = 'u' in
                                            (fun ys_2_0 -> 
                                              (`LH_C(h_1_9, (t_1_7 ys_2_0)))))) in
                                          (let rec h_2_0 = 'l' in
                                            (fun ys_2_1 -> 
                                              (`LH_C(h_2_0, (t_1_6 ys_2_1)))))) in
                                          (let rec h_2_1 = 'o' in
                                            (fun ys_2_2 -> 
                                              (`LH_C(h_2_1, (t_1_5 ys_2_2)))))) in
                                          (let rec h_2_2 = 'S' in
                                            (fun ys_2_3 -> 
                                              (`LH_C(h_2_2, (t_1_4 ys_2_3)))))) x_6)) ((fun x_7 -> 
                                        ((mappend_lh__d2 (string_of_int _lh_writeSolutions_arg2_2)) x_7)) _lh_funcomp_x_1_2))) ((fun x_8 -> 
                                      (`LH_C('|', x_8))) _lh_funcomp_x_1_1))) ((writeHistory_lh__d1 _lh_writeSolutions_LH_C_0_0) _lh_funcomp_x_1_0))) ((_lh_writeSolutions_LH_C_1_0 (_lh_writeSolutions_arg2_2 + 1)) _lh_funcomp_x_9)))))))))) _lh_minSolutions_LH_C_1_1)
                  else
                    (((minAcc_0 total_0) (let rec t_2_3 = (fun a_2 -> 
                      a_2) in
                      (let rec h_2_3 = _lh_minSolutions_LH_C_0_1 in
                        (fun a_3 -> 
                          (t_2_3 (let rec _lh_writeSolutions_LH_C_1_1 = a_3 in
                                ...
                                ((fun _lh_funcomp_x_1_4 -> 
                                  ((fun _lh_funcomp_x_1_5 -> 
                                    ((fun _lh_funcomp_x_1_6 -> 
                                      ((fun x_9 -> 
                                        ((let rec t_2_4 = (let rec t_2_5 = (let rec t_2_6 = (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (fun ys_2_4 -> 
                                          ys_2_4) in
                                          (let rec h_2_4 = ' ' in
                                            (fun ys_2_5 -> 
                                              (`LH_C(h_2_4, (t_3_2 ys_2_5)))))) in
                                          (let rec h_2_5 = 'n' in
                                            (fun ys_2_6 -> 
                                              (`LH_C(h_2_5, (t_3_1 ys_2_6)))))) in
                                          (let rec h_2_6 = 'o' in
                                            (fun ys_2_7 -> 
                                              (`LH_C(h_2_6, (t_3_0 ys_2_7)))))) in
                                          (let rec h_2_7 = 'i' in
                                            (fun ys_2_8 -> 
                                              (`LH_C(h_2_7, (t_2_9 ys_2_8)))))) in
                                          (let rec h_2_8 = 't' in
                                            (fun ys_2_9 -> 
                                              (`LH_C(h_2_8, (t_2_8 ys_2_9)))))) in
                                          (let rec h_2_9 = 'u' in
                                            (fun ys_3_0 -> 
                                              (`LH_C(h_2_9, (t_2_7 ys_3_0)))))) in
                                          (let rec h_3_0 = 'l' in
                                            (fun ys_3_1 -> 
                                              (`LH_C(h_3_0, (t_2_6 ys_3_1)))))) in
                                          (let rec h_3_1 = 'o' in
                                            (fun ys_3_2 -> 
                                              (`LH_C(h_3_1, (t_2_5 ys_3_2)))))) in
                                          (let rec h_3_2 = 'S' in
                                            (fun ys_3_3 -> 
                                              (`LH_C(h_3_2, (t_2_4 ys_3_3)))))) x_9)) ((fun x_1_0 -> 
                                        ((mappend_lh__d2 (string_of_int _lh_writeSolutions_arg2_3)) x_1_0)) _lh_funcomp_x_1_6))) ((fun x_1_1 -> 
                                      (`LH_C('|', x_1_1))) _lh_funcomp_x_1_5))) ((writeHistory_lh__d1 _lh_writeSolutions_LH_C_0_1) _lh_funcomp_x_1_4))) ((_lh_writeSolutions_LH_C_1_1 (_lh_writeSolutions_arg2_3 + 1)) _lh_funcomp_x_1_3)))))))))) _lh_minSolutions_LH_C_1_1))))
            | _ -> 
              (failwith "error")))) in
        (reverse_lh__d1 (((minAcc_0 (totalTime_lh__d1 _lh_minSolutions_LH_C_0_0)) (let rec t_3_3 = (fun a_4 -> 
          ...
          (let rec h_3_3 = _lh_minSolutions_LH_C_0_0 in
            (fun a_5 -> 
              (t_3_3 (let rec _lh_writeSolutions_LH_C_1_2 = a_5 in
                    ...
                    ((fun _lh_funcomp_x_1_8 -> 
                      ((fun _lh_funcomp_x_1_9 -> 
                        ((fun _lh_funcomp_x_2_0 -> 
                          ((fun x_1_2 -> 
                            ((let rec t_3_4 = (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (let rec t_3_8 = (let rec t_3_9 = (let rec t_4_0 = (let rec t_4_1 = (let rec t_4_2 = (fun ys_3_4 -> 
                              ys_3_4) in
                              (let rec h_3_4 = ' ' in
                                (fun ys_3_5 -> 
                                  (`LH_C(h_3_4, (t_4_2 ys_3_5)))))) in
                              (let rec h_3_5 = 'n' in
                                (fun ys_3_6 -> 
                                  (`LH_C(h_3_5, (t_4_1 ys_3_6)))))) in
                              (let rec h_3_6 = 'o' in
                                (fun ys_3_7 -> 
                                  (`LH_C(h_3_6, (t_4_0 ys_3_7)))))) in
                              (let rec h_3_7 = 'i' in
                                (fun ys_3_8 -> 
                                  (`LH_C(h_3_7, (t_3_9 ys_3_8)))))) in
                              (let rec h_3_8 = 't' in
                                (fun ys_3_9 -> 
                                  (`LH_C(h_3_8, (t_3_8 ys_3_9)))))) in
                              (let rec h_3_9 = 'u' in
                                (fun ys_4_0 -> 
                                  (`LH_C(h_3_9, (t_3_7 ys_4_0)))))) in
                              (let rec h_4_0 = 'l' in
                                (fun ys_4_1 -> 
                                  (`LH_C(h_4_0, (t_3_6 ys_4_1)))))) in
                              (let rec h_4_1 = 'o' in
                                (fun ys_4_2 -> 
                                  (`LH_C(h_4_1, (t_3_5 ys_4_2)))))) in
                              (let rec h_4_2 = 'S' in
                                (fun ys_4_3 -> 
                                  (`LH_C(h_4_2, (t_3_4 ys_4_3)))))) x_1_2)) ((fun x_1_3 -> 
                            ((mappend_lh__d2 (string_of_int _lh_writeSolutions_arg2_4)) x_1_3)) _lh_funcomp_x_2_0))) ((fun x_1_4 -> 
                          (`LH_C('|', x_1_4))) _lh_funcomp_x_1_9))) ((writeHistory_lh__d1 _lh_writeSolutions_LH_C_0_2) _lh_funcomp_x_1_8))) ((_lh_writeSolutions_LH_C_1_2 (_lh_writeSolutions_arg2_4 + 1)) _lh_funcomp_x_1_7)))))))))) _lh_minSolutions_LH_C_1_0)))
    | _ -> 
      (failwith "error"));;
  ...
  (if (_lh_itemFromTo_arg1_1 = _lh_itemFromTo_arg2_1) then
              ...
              (if ((notSeen_lh__d1 newDest_0) _lh_transfer_arg5_5) then
                (let rec newTime_0 = (_lh_transfer_arg4_5 + (u2times_lh__d1 _lh_listcomp_fun_ls_h_2)) in
                  (let rec t_4_3 = (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_2) in
                    (let rec h_4_3 = (if (_lh_transfer_arg1_5 = newDest_0) then
                      (`LH_C((`LH_C((`LH_P2(newTime_0, newDest_0)), newHistory_5)), (`LH_N)))
                    else
                      (let rec newHistory_6 = (`LH_C((`LH_P2(newTime_0, newDest_0)), newHistory_5)) in
                        (let rec newLocation_6 = (opposite_lh__d1 newLocation_5) in
                          (let rec moveOne_1 = ((let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_4 -> 
                            ((((((((_lh_listcomp_fun_para_4 _lh_listcomp_fun_9) _lh_transfer_arg1_5) newDest_0) newLocation_5) newTime_0) newHistory_5) newHistory_6) newLocation_6)) in
                            (_lh_listcomp_fun_9 ((itemFromTo_lh__d1 (`Bono)) (`Adam)))) 99) in
                            (let rec moveTwo_1 = ((let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_5 -> 
                              ((((((((_lh_listcomp_fun_para_5 _lh_listcomp_fun_1_0) _lh_transfer_arg1_5) newDest_0) newLocation_5) newTime_0) newHistory_5) newHistory_6) newLocation_6)) in
                              (_lh_listcomp_fun_1_0 ((itemFromTo_lh__d3 (`Bono)) (`Larry)))) 99) in
                              ((mappend_lh__d3 moveOne_1) moveTwo_1)))))) in
                      (fun _lh_dummy_2 -> 
                        ((mappend_lh__d7 h_4_3) (t_4_3 99))))))
              else
    ...
    (let rec _lh_listcomp_fun_ls_t_3 = ((itemFromTo_lh__d1 (succItem_lh__d2 _lh_itemFromTo_arg1_1)) _lh_itemFromTo_arg2_1) in
      (let rec _lh_listcomp_fun_ls_h_3 = _lh_itemFromTo_arg1_1 in
        (fun _lh_listcomp_fun_1_1 _lh_transfer_arg1_6 _lh_transfer_arg2_6 _lh_transfer_arg3_6 _lh_transfer_arg4_6 _lh_transfer_arg5_6 newHistory_7 newLocation_7 -> 
          (if (((position_lh__d3 _lh_listcomp_fun_ls_h_3) _lh_transfer_arg2_6) = _lh_transfer_arg3_6) then
            (let rec newDest_1 = (((updateState_lh__d2 _lh_transfer_arg2_6) _lh_listcomp_fun_ls_h_3) newLocation_7) in
              (if ((notSeen_lh__d1 newDest_1) _lh_transfer_arg5_6) then
                (let rec newTime_1 = (_lh_transfer_arg4_6 + (u2times_lh__d1 _lh_listcomp_fun_ls_h_3)) in
                  (let rec t_4_4 = (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_3) in
                    (let rec h_4_4 = (if (_lh_transfer_arg1_6 = newDest_1) then
                      (`LH_C((`LH_C((`LH_P2(newTime_1, newDest_1)), newHistory_7)), (`LH_N)))
                    else
                      (let rec newHistory_8 = (`LH_C((`LH_P2(newTime_1, newDest_1)), newHistory_7)) in
                        (let rec newLocation_8 = (opposite_lh__d1 newLocation_7) in
                          (let rec moveOne_2 = ((let rec _lh_listcomp_fun_1_2 = (fun _lh_listcomp_fun_para_6 -> 
                            ((((((((_lh_listcomp_fun_para_6 _lh_listcomp_fun_1_2) _lh_transfer_arg1_6) newDest_1) newLocation_7) newTime_1) newHistory_7) newHistory_8) newLocation_8)) in
                            (_lh_listcomp_fun_1_2 ((itemFromTo_lh__d1 (`Bono)) (`Adam)))) 99) in
                            (let rec moveTwo_2 = ((let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_7 -> 
                              ((((((((_lh_listcomp_fun_para_7 _lh_listcomp_fun_1_3) _lh_transfer_arg1_6) newDest_1) newLocation_7) newTime_1) newHistory_7) newHistory_8) newLocation_8)) in
                              (_lh_listcomp_fun_1_3 ((itemFromTo_lh__d3 (`Bono)) (`Larry)))) 99) in
                              ((mappend_lh__d3 moveOne_2) moveTwo_2)))))) in
                      (fun _lh_dummy_3 -> 
                        ((mappend_lh__d7 h_4_4) (t_4_4 99))))))
              else
                (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_3)))
          else
            (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_3))))))
and
itemFromTo_lh__d2 _lh_itemFromTo_arg1_2 _lh_itemFromTo_arg2_2 =
  (if (_lh_itemFromTo_arg1_2 = _lh_itemFromTo_arg2_2) then
    (let rec _lh_listcomp_fun_ls_t_4 = (fun _lh_listcomp_fun_ls_h_4 _lh_listcomp_fun_1_6 _lh_transfer_arg1_7 _lh_transfer_arg2_7 _lh_transfer_arg3_7 _lh_transfer_arg4_7 _lh_transfer_arg5_7 newHistory_1_0 newLocation_1_0 _lh_listcomp_fun_ls_t_5 _lh_listcomp_fun_1_7 -> 
      (_lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_5)) in
      (let rec _lh_listcomp_fun_ls_h_5 = _lh_itemFromTo_arg1_2 in
        (fun _lh_listcomp_fun_ls_h_6 _lh_listcomp_fun_1_8 _lh_transfer_arg1_8 _lh_transfer_arg2_8 _lh_transfer_arg3_8 _lh_transfer_arg4_8 _lh_transfer_arg5_8 newHistory_1_1 newLocation_1_1 _lh_listcomp_fun_ls_t_6 _lh_listcomp_fun_1_9 -> 
          (if ((((position_lh__d2 _lh_listcomp_fun_ls_h_6) _lh_transfer_arg2_8) = _lh_transfer_arg3_8) && (((position_lh__d1 _lh_listcomp_fun_ls_h_5) _lh_transfer_arg2_8) = _lh_transfer_arg3_8)) then
            (let rec newDest_2 = (((((updateState_lh__d1 _lh_transfer_arg2_8) _lh_listcomp_fun_ls_h_6) newLocation_1_1) _lh_listcomp_fun_ls_h_5) newLocation_1_1) in
              (if ((notSeen_lh__d2 newDest_2) _lh_transfer_arg5_8) then
                (let rec newTime_2 = (_lh_transfer_arg4_8 + (u2times_lh__d2 _lh_listcomp_fun_ls_h_6)) in
                  (let rec t_4_5 = (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_4) in
                    (let rec h_4_5 = (if (_lh_transfer_arg1_8 = newDest_2) then
                      (`LH_C((`LH_C((`LH_P2(newTime_2, newDest_2)), newHistory_1_1)), (`LH_N)))
                    else
                      (let rec newHistory_1_2 = (`LH_C((`LH_P2(newTime_2, newDest_2)), newHistory_1_1)) in
                        (let rec newLocation_1_2 = (opposite_lh__d1 newLocation_1_1) in
                          (let rec moveOne_4 = ((let rec _lh_listcomp_fun_2_0 = (fun _lh_listcomp_fun_para_1_0 -> 
                            ((((((((_lh_listcomp_fun_para_1_0 _lh_listcomp_fun_2_0) _lh_transfer_arg1_8) newDest_2) newLocation_1_1) newTime_2) newHistory_1_1) newHistory_1_2) newLocation_1_2)) in
                            (_lh_listcomp_fun_2_0 ((itemFromTo_lh__d1 (`Bono)) (`Adam)))) 99) in
                            (let rec moveTwo_4 = ((let rec _lh_listcomp_fun_2_1 = (fun _lh_listcomp_fun_para_1_1 -> 
                              ((((((((_lh_listcomp_fun_para_1_1 _lh_listcomp_fun_2_1) _lh_transfer_arg1_8) newDest_2) newLocation_1_1) newTime_2) newHistory_1_1) newHistory_1_2) newLocation_1_2)) in
                              (_lh_listcomp_fun_2_1 ((itemFromTo_lh__d3 (`Bono)) (`Larry)))) 99) in
                              ((mappend_lh__d3 moveOne_4) moveTwo_4)))))) in
                      (fun _lh_dummy_4 -> 
                        ((mappend_lh__d6 h_4_5) (t_4_5 99))))))
              else
                (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_4)))
          else
            (_lh_listcomp_fun_1_8 _lh_listcomp_fun_ls_t_4)))))
  else
    (let rec _lh_listcomp_fun_ls_t_7 = ((itemFromTo_lh__d2 (succItem_lh__d3 _lh_itemFromTo_arg1_2)) _lh_itemFromTo_arg2_2) in
      (let rec _lh_listcomp_fun_ls_h_7 = _lh_itemFromTo_arg1_2 in
        (fun _lh_listcomp_fun_ls_h_8 _lh_listcomp_fun_2_2 _lh_transfer_arg1_9 _lh_transfer_arg2_9 _lh_transfer_arg3_9 _lh_transfer_arg4_9 _lh_transfer_arg5_9 newHistory_1_3 newLocation_1_3 _lh_listcomp_fun_ls_t_8 _lh_listcomp_fun_2_3 -> 
          (if ((((position_lh__d2 _lh_listcomp_fun_ls_h_8) _lh_transfer_arg2_9) = _lh_transfer_arg3_9) && (((position_lh__d1 _lh_listcomp_fun_ls_h_7) _lh_transfer_arg2_9) = _lh_transfer_arg3_9)) then
            (let rec newDest_3 = (((((updateState_lh__d1 _lh_transfer_arg2_9) _lh_listcomp_fun_ls_h_8) newLocation_1_3) _lh_listcomp_fun_ls_h_7) newLocation_1_3) in
              (if ((notSeen_lh__d2 newDest_3) _lh_transfer_arg5_9) then
                (let rec newTime_3 = (_lh_transfer_arg4_9 + (u2times_lh__d2 _lh_listcomp_fun_ls_h_8)) in
                  (let rec t_4_6 = (_lh_listcomp_fun_2_2 _lh_listcomp_fun_ls_t_7) in
                    (let rec h_4_6 = (if (_lh_transfer_arg1_9 = newDest_3) then
                      (`LH_C((`LH_C((`LH_P2(newTime_3, newDest_3)), newHistory_1_3)), (`LH_N)))
                    else
                      (let rec newHistory_1_4 = (`LH_C((`LH_P2(newTime_3, newDest_3)), newHistory_1_3)) in
                        (let rec newLocation_1_4 = (opposite_lh__d1 newLocation_1_3) in
                          (let rec moveOne_5 = ((let rec _lh_listcomp_fun_2_4 = (fun _lh_listcomp_fun_para_1_2 -> 
                            ((((((((_lh_listcomp_fun_para_1_2 _lh_listcomp_fun_2_4) _lh_transfer_arg1_9) newDest_3) newLocation_1_3) newTime_3) newHistory_1_3) newHistory_1_4) newLocation_1_4)) in
                            (_lh_listcomp_fun_2_4 ((itemFromTo_lh__d1 (`Bono)) (`Adam)))) 99) in
                            (let rec moveTwo_5 = ((let rec _lh_listcomp_fun_2_5 = (fun _lh_listcomp_fun_para_1_3 -> 
                              ((((((((_lh_listcomp_fun_para_1_3 _lh_listcomp_fun_2_5) _lh_transfer_arg1_9) newDest_3) newLocation_1_3) newTime_3) newHistory_1_3) newHistory_1_4) newLocation_1_4)) in
                              (_lh_listcomp_fun_2_5 ((itemFromTo_lh__d3 (`Bono)) (`Larry)))) 99) in
                              ((mappend_lh__d3 moveOne_5) moveTwo_5)))))) in
                      (fun _lh_dummy_5 -> 
                        ((mappend_lh__d6 h_4_6) (t_4_6 99))))))
              else
                (_lh_listcomp_fun_2_2 _lh_listcomp_fun_ls_t_7)))
          else
            (_lh_listcomp_fun_2_2 _lh_listcomp_fun_ls_t_7))))))
and
...
let rec testPuzzle_nofib_lh__d1 _lh_testPuzzle_nofib_arg1_0 =
  (let rec time_0 = (if ((length_lh__d1 _lh_testPuzzle_nofib_arg1_0) = 1) then
    ...
    (let rec solutions_0 = (if (initialState_lh__d1 = finalState_lh__d1) then
      (`LH_C((`LH_C((`LH_P2(time_0, finalState_lh__d1)), (`LH_N))), (`LH_N)))
    else
      (let rec newHistory_9 = (`LH_C((`LH_P2(time_0, finalState_lh__d1)), (`LH_N))) in
        (let rec newLocation_9 = (opposite_lh__d1 (`RightBank)) in
          (let rec moveOne_3 = ((let rec _lh_listcomp_fun_1_4 = (fun _lh_listcomp_fun_para_8 -> 
            ((((((((_lh_listcomp_fun_para_8 _lh_listcomp_fun_1_4) initialState_lh__d1) finalState_lh__d1) (`RightBank)) time_0) (`LH_N)) newHistory_9) newLocation_9)) in
            (_lh_listcomp_fun_1_4 ((itemFromTo_lh__d1 (`Bono)) (`Adam)))) 99) in
            (let rec moveTwo_3 = ((let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_9 -> 
              ((((((((_lh_listcomp_fun_para_9 _lh_listcomp_fun_1_5) initialState_lh__d1) finalState_lh__d1) (`RightBank)) time_0) (`LH_N)) newHistory_9) newLocation_9)) in
              (_lh_listcomp_fun_1_5 ((itemFromTo_lh__d3 (`Bono)) (`Larry)))) 99) in
              ((mappend_lh__d3 moveOne_3) moveTwo_3)))))) in

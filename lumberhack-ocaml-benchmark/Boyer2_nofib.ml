(*
touch ./Boyer2_nofib.mli && ocamlc ./Boyer2_nofib.mli && ocamlfind ocamlopt -rectypes -thread -O3 -w -A ./Boyer2_nofib.ml -o "./Boyer2_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./Boyer2_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o ./*.mli
*)
(* #use "topfind";;
...
let rec assoc__d0 _lh_assoc_arg1_2 =
  (match _lh_assoc_arg1_2 with
        ...
        | `Cons(_lh_assoc_Cons_0_4) -> 
          (match _lh_assoc_Cons_0_4 with
            | `LH_P2(_lh_assoc_LH_P2_0_7, _lh_assoc_LH_P2_1_7) -> 
              (let rec _lh_matchIdent_4_1 = _lh_assoc_LH_P2_0_7 in
    ...
    | _ -> 
      (failwith "error"));;
let rec assoc__d1 _lh_assoc_arg1_3 =
  (match _lh_assoc_arg1_3 with
        ...
        | `Cons(_lh_assoc_Cons_0_6) -> 
          (match _lh_assoc_Cons_0_6 with
            | `LH_P2(_lh_assoc_LH_P2_0_1_0, _lh_assoc_LH_P2_1_1_0) -> 
              (let rec _lh_matchIdent_4_7 = _lh_assoc_LH_P2_0_1_0 in
                        ...
                        (match _lh_assoc_LH_P2_0_1_1 with
                          | `Atom(_lh_assoc_Atom_0_3) -> 
                            (if (_lh_assoc_LH_P2_0_9 = (`Atom(_lh_assoc_Atom_0_3))) then
                              ...
                              (assoc__d1 (`LH_P2(_lh_assoc_LH_P2_0_9, _lh_assoc_LH_P2_1_1_0))))
                          | _ -> 
                            (`Nil))
                      | _ -> 
                        (`Nil))
    ...
    | _ -> 
      (failwith "error"));;
let rec assoc__d2 _lh_assoc_arg1_1 =
  (match _lh_assoc_arg1_1 with
        ...
        | `Cons(_lh_assoc_Cons_0_2) -> 
          (match _lh_assoc_Cons_0_2 with
            | `LH_P2(_lh_assoc_LH_P2_0_4, _lh_assoc_LH_P2_1_4) -> 
              (let rec _lh_matchIdent_2_6 = _lh_assoc_LH_P2_0_4 in
                        ...
                        (match _lh_assoc_LH_P2_0_5 with
                          | `Atom(_lh_assoc_Atom_0_1) -> 
                            (if (_lh_assoc_LH_P2_0_3 = (`Atom(_lh_assoc_Atom_0_1))) then
                              ...
                              (assoc__d2 (`LH_P2(_lh_assoc_LH_P2_0_3, _lh_assoc_LH_P2_1_4))))
                          | _ -> 
                            (`Nil))
                      | _ -> 
                        (`Nil))
    ...
    | _ -> 
      (failwith "error"));;
let rec atom__d0 _lh_atom_arg1_2 =
  (match _lh_atom_arg1_2 with
    | `Atom(_lh_atom_Atom_0_2) -> 
      true
    | _ -> 
      false);;
let rec atom__d1 _lh_atom_arg1_3 =
...
let rec atom__d2 _lh_atom_arg1_1 =
  (match _lh_atom_arg1_1 with
    ...
    | _ -> 
      false);;
let rec car__d0 _lh_car_arg1_1_3 =
...
let rec car__d1 _lh_car_arg1_8 =
  (match _lh_car_arg1_8 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d1_d0 _lh_car_arg1_9 =
...
let rec car__d1_d1 _lh_car_arg1_1_4 =
  (match _lh_car_arg1_1_4 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d1_d2 _lh_car_arg1_1 =
  (match _lh_car_arg1_1 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d1_d3 _lh_car_arg1_1_5 =
  (match _lh_car_arg1_1_5 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d1_d4 _lh_car_arg1_1_6 =
  (match _lh_car_arg1_1_6 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d1_d5 _lh_car_arg1_3 =
  (match _lh_car_arg1_3 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d2 _lh_car_arg1_6 =
  (match _lh_car_arg1_6 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d3 _lh_car_arg1_4 =
...
let rec car__d4 _lh_car_arg1_5 =
  (match _lh_car_arg1_5 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d5 _lh_car_arg1_1_2 =
  (match _lh_car_arg1_1_2 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d6 _lh_car_arg1_1_1 =
  (match _lh_car_arg1_1_1 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d7 _lh_car_arg1_2 =
  (match _lh_car_arg1_2 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d8 _lh_car_arg1_7 =
  (match _lh_car_arg1_7 with
    ...
    | _ -> 
      (`Nil));;
let rec car__d9 _lh_car_arg1_1_0 =
  (match _lh_car_arg1_1_0 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d0 _lh_cdr_arg1_8 =
  (match _lh_cdr_arg1_8 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d1 _lh_cdr_arg1_6 =
  (match _lh_cdr_arg1_6 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d1_d0 _lh_cdr_arg1_1_2 =
  (match _lh_cdr_arg1_1_2 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d1_d1 _lh_cdr_arg1_1 =
  (match _lh_cdr_arg1_1 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d1_d2 _lh_cdr_arg1_9 =
  (match _lh_cdr_arg1_9 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d2 _lh_cdr_arg1_1_0 =
  (match _lh_cdr_arg1_1_0 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d3 _lh_cdr_arg1_1_1 =
  (match _lh_cdr_arg1_1_1 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d4 _lh_cdr_arg1_7 =
  (match _lh_cdr_arg1_7 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d5 _lh_cdr_arg1_1_3 =
...
let rec cdr__d6 _lh_cdr_arg1_5 =
  (match _lh_cdr_arg1_5 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d7 _lh_cdr_arg1_4 =
  (match _lh_cdr_arg1_4 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d8 _lh_cdr_arg1_3 =
  (match _lh_cdr_arg1_3 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr__d9 _lh_cdr_arg1_2 =
...
let rec lispmember__d0 _lh_lispmember_arg1_3 =
  (match _lh_lispmember_arg1_3 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lispmember__d1 _lh_lispmember_arg1_2 =
          ...
          (match _lh_lispmember_Cons_0_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_5, _lh_lispmember_LH_P2_1_5) -> 
              (if (_lh_lispmember_LH_P2_0_4 = _lh_lispmember_LH_P2_0_5) then
                ...
                (lispmember__d1 (`LH_P2(_lh_lispmember_LH_P2_0_4, _lh_lispmember_LH_P2_1_5))))
            | _ -> 
              false)
        | _ -> 
          false)
...
let rec lispmember__d2 _lh_lispmember_arg1_4 =
  (match _lh_lispmember_arg1_4 with
    ...
    | _ -> 
      (failwith "error"));;
let rec lispmember__d3 _lh_lispmember_arg1_1 =
          ...
          (match _lh_lispmember_Cons_0_1 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3, _lh_lispmember_LH_P2_1_3) -> 
              (if (_lh_lispmember_LH_P2_0_2 = _lh_lispmember_LH_P2_0_3) then
                ...
                (lispmember__d3 (`LH_P2(_lh_lispmember_LH_P2_0_2, _lh_lispmember_LH_P2_1_3))))
            | _ -> 
              false)
        | _ -> 
          false)
...
let rec mappend__d1 xs_1_2 ys_1_2 =
  (match xs_1_2 with
    | `LH_C(h_2_3, t_2_5) -> 
      (`LH_C(h_2_3, ((mappend__d1 t_2_5) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
...
let rec mappend__d3 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    | `LH_C(h_2_2, t_2_4) -> 
      (`LH_C(h_2_2, ((mappend__d3 t_2_4) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec mappend__d4 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_2_4, t_2_6) -> 
      (`LH_C(h_2_4, ((mappend__d4 t_2_6) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec report__d0 _lh_report_arg1_1 =
  (match _lh_report_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec restOfToken__d0 _lh_restOfToken_arg1_2 =
  (match _lh_restOfToken_arg1_2 with
    ...
    | `LH_C(_lh_restOfToken_LH_C_0_2, _lh_restOfToken_LH_C_1_2) -> 
      (if (((_lh_restOfToken_LH_C_0_2 = '(') || (_lh_restOfToken_LH_C_0_2 = ')')) || (_lh_restOfToken_LH_C_0_2 = ' ')) then
        ...
        (let rec _lh_matchIdent_2_1 = (restOfToken__d0 _lh_restOfToken_LH_C_1_2) in
    ...
    | _ -> 
      (failwith "error"));;
let rec restOfToken__d1 _lh_restOfToken_arg1_3 =
  (match _lh_restOfToken_arg1_3 with
    ...
    | `LH_C(_lh_restOfToken_LH_C_0_3, _lh_restOfToken_LH_C_1_3) -> 
      (if (((_lh_restOfToken_LH_C_0_3 = '(') || (_lh_restOfToken_LH_C_0_3 = ')')) || (_lh_restOfToken_LH_C_0_3 = ' ')) then
        ...
        (let rec _lh_matchIdent_2_5 = (restOfToken__d1 _lh_restOfToken_LH_C_1_3) in
    ...
    | _ -> 
      (failwith "error"));;
let rec restOfToken__d2 _lh_restOfToken_arg1_1 =
  (match _lh_restOfToken_arg1_1 with
    ...
    | `LH_C(_lh_restOfToken_LH_C_0_1, _lh_restOfToken_LH_C_1_1) -> 
      (if (((_lh_restOfToken_LH_C_0_1 = '(') || (_lh_restOfToken_LH_C_0_1 = ')')) || (_lh_restOfToken_LH_C_0_1 = ' ')) then
        ...
        (let rec _lh_matchIdent_2_0 = (restOfToken__d2 _lh_restOfToken_LH_C_1_1) in
...
let rec sublist__d0 _lh_sublist_arg1_2 =
  (match _lh_sublist_arg1_2 with
          ...
          (match _lh_sublist_LH_C_0_5 with
            | '(' -> 
              (match _lh_sublist_LH_C_1_5 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_3_3 = (sublist__d0 _lh_sublist_LH_C_1_4) in
                    (match _lh_matchIdent_3_3 with
                      | `LH_P2(_lh_sublist_LH_P2_0_1_2, _lh_sublist_LH_P2_1_1_2) -> 
                        (let rec _lh_matchIdent_3_4 = (sublist__d0 _lh_sublist_LH_P2_0_1_2) in
                      ...
                      | _ -> 
                        (failwith "error")))
                | _ -> 
                  (let rec _lh_matchIdent_3_5 = (sublist__d0 _lh_sublist_LH_C_1_4) in
            ...
            | ')' -> 
              (match _lh_sublist_LH_C_1_5 with
                ...
                | _ -> 
                  (let rec _lh_matchIdent_3_6 = (sublist__d0 _lh_sublist_LH_C_1_4) in
                    (match _lh_matchIdent_3_6 with
                      ...
                      | _ -> 
                        (failwith "error"))))
            | _ -> 
              (let rec _lh_matchIdent_3_7 = (sublist__d0 _lh_sublist_LH_C_1_4) in
                (match _lh_matchIdent_3_7 with
                  ...
                  | _ -> 
                    (failwith "error"))))
        | _ -> 
          (let rec _lh_matchIdent_3_8 = (sublist__d0 _lh_sublist_LH_C_1_4) in
    ...
    | _ -> 
      (failwith "error"));;
let rec sublist__d1 _lh_sublist_arg1_1 =
          ...
          (match _lh_sublist_LH_C_0_3 with
            | '(' -> 
              (match _lh_sublist_LH_C_1_3 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_2_7 = (sublist__d1 _lh_sublist_LH_C_1_2) in
                    (match _lh_matchIdent_2_7 with
                      | `LH_P2(_lh_sublist_LH_P2_0_6, _lh_sublist_LH_P2_1_6) -> 
                        (let rec _lh_matchIdent_2_8 = (sublist__d1 _lh_sublist_LH_P2_0_6) in
                      ...
                      | _ -> 
                        (failwith "error")))
                | _ -> 
                  (let rec _lh_matchIdent_2_9 = (sublist__d1 _lh_sublist_LH_C_1_2) in
            ...
            | ')' -> 
              (match _lh_sublist_LH_C_1_3 with
                ...
                | _ -> 
                  (let rec _lh_matchIdent_3_0 = (sublist__d1 _lh_sublist_LH_C_1_2) in
                    (match _lh_matchIdent_3_0 with
                      ...
                      | _ -> 
                        (failwith "error"))))
            | _ -> 
              (let rec _lh_matchIdent_3_1 = (sublist__d1 _lh_sublist_LH_C_1_2) in
                (match _lh_matchIdent_3_1 with
                  ...
                  | _ -> 
                    (failwith "error"))))
        | _ -> 
          (let rec _lh_matchIdent_3_2 = (sublist__d1 _lh_sublist_LH_C_1_2) in
...
let rec sublist__d2 _lh_sublist_arg1_3 =
  (match _lh_sublist_arg1_3 with
          ...
          (match _lh_sublist_LH_C_0_7 with
            | '(' -> 
              (match _lh_sublist_LH_C_1_7 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_5_0 = (sublist__d2 _lh_sublist_LH_C_1_6) in
                    (match _lh_matchIdent_5_0 with
                      | `LH_P2(_lh_sublist_LH_P2_0_1_8, _lh_sublist_LH_P2_1_1_8) -> 
                        (let rec _lh_matchIdent_5_1 = (sublist__d2 _lh_sublist_LH_P2_0_1_8) in
                      ...
                      | _ -> 
                        (failwith "error")))
                | _ -> 
                  (let rec _lh_matchIdent_5_2 = (sublist__d2 _lh_sublist_LH_C_1_6) in
    ...
    | _ -> 
      (failwith "error"));;
let rec tv__d0 _lh_tv_arg1_1 =
  (match _lh_tv_arg1_1 with
    | `Atom(_lh_tv_Atom_0_1) -> 
      _lh_tv_Atom_0_1
    | _ -> 
      (failwith "error"));;
let rec tv__d1 _lh_tv_arg1_3 =
...
and applysubst__d0 _lh_applysubst_arg1_1 _lh_applysubst_arg2_1 =
  (match _lh_applysubst_arg2_1 with
    ...
    | `Atom(_lh_applysubst_Atom_0_1) -> 
      (let rec _lh_matchIdent_1_7 = (assoc__d0 (`LH_P2((`Atom(_lh_applysubst_Atom_0_1)), _lh_applysubst_arg1_1))) in
    ...
    | _ -> 
      (failwith "error"))
and applysubst__d1 _lh_applysubst_arg1_2 _lh_applysubst_arg2_2 =
  (match _lh_applysubst_arg2_2 with
    | `Nil -> 
      (`Nil)
    | `Atom(_lh_applysubst_Atom_0_2) -> 
      (let rec _lh_matchIdent_4_0 = (assoc__d2 (`LH_P2((`Atom(_lh_applysubst_Atom_0_2)), _lh_applysubst_arg1_2))) in
    ...
    | `Cons(_lh_applysubst_Cons_0_5) -> 
      (match _lh_applysubst_Cons_0_5 with
        | `LH_P2(_lh_applysubst_LH_P2_0_5, _lh_applysubst_LH_P2_1_5) -> 
          (`Cons((`LH_P2(_lh_applysubst_LH_P2_0_5, ((applysubstlst__d1 _lh_applysubst_arg1_2) _lh_applysubst_LH_P2_1_5)))))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"))
...
and applysubstlst__d1 _lh_applysubstlst_arg1_1 _lh_applysubstlst_arg2_1 =
  (match _lh_applysubstlst_arg2_1 with
    ...
    | _ -> 
      (failwith "error"))
and caddr__d0 _lh_caddr_arg1_1 =
  ((fun _lh_funcomp_x_6 -> 
    ((fun _lh_funcomp_x_7 -> 
      (car__d2 (cdr__d0 _lh_funcomp_x_7))) (cdr__d1 _lh_funcomp_x_6))) _lh_caddr_arg1_1)
and caddr__d1 _lh_caddr_arg1_3 =
  ((fun _lh_funcomp_x_1_3 -> 
    ((fun _lh_funcomp_x_1_4 -> 
      (car__d8 (cdr__d7 _lh_funcomp_x_1_4))) (cdr__d8 _lh_funcomp_x_1_3))) _lh_caddr_arg1_3)
and caddr__d2 _lh_caddr_arg1_2 =
  ((fun _lh_funcomp_x_1_1 -> 
    ((fun _lh_funcomp_x_1_2 -> 
      (car__d9 (cdr__d9 _lh_funcomp_x_1_2))) (cdr__d1_d0 _lh_funcomp_x_1_1))) _lh_caddr_arg1_2)
and cadr__d0 _lh_cadr_arg1_3 =
  ((fun _lh_funcomp_x_1_0 -> 
    (car__d3 (cdr__d2 _lh_funcomp_x_1_0))) _lh_cadr_arg1_3)
and cadr__d1 _lh_cadr_arg1_1 =
  ((fun _lh_funcomp_x_8 -> 
    (car__d1_d0 (cdr__d1_d1 _lh_funcomp_x_8))) _lh_cadr_arg1_1)
and cadr__d2 _lh_cadr_arg1_2 =
  ((fun _lh_funcomp_x_9 -> 
    (car__d1_d1 (cdr__d1_d2 _lh_funcomp_x_9))) _lh_cadr_arg1_2)
and falsep__d0 _lh_falsep_arg1_2 =
                            ...
                            | `LH_N -> 
                              (match _lh_falsep_LH_P2_1_5 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember__d0 (`LH_P2(_lh_falsep_LH_P2_0_4, _lh_falsep_LH_P2_1_4))))
                            | _ -> 
                              (lispmember__d0 (`LH_P2(_lh_falsep_LH_P2_0_4, _lh_falsep_LH_P2_1_4))))
                        | _ -> 
                          (lispmember__d0 (`LH_P2(_lh_falsep_LH_P2_0_4, _lh_falsep_LH_P2_1_4))))
    ...
    | `LH_C(_lh_getToken_LH_C_0_3, _lh_getToken_LH_C_1_3) -> 
      (if (_lh_getToken_LH_C_0_3 = ' ') then
        ...
        (if ((_lh_getToken_LH_C_0_3 = '(') || (_lh_getToken_LH_C_0_3 = ')')) then
          ...
          (let rec _lh_matchIdent_4_9 = (restOfToken__d0 _lh_getToken_LH_C_1_3) in
...
and makelemmas__d0 _lh_makelemmas_arg1_1 =
  (match _lh_makelemmas_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and mkLisplist__d0 _lh_mkLisplist_arg1_3 =
  (match _lh_mkLisplist_arg1_3 with
          ...
          (match _lh_mkLisplist_LH_C_0_7 with
            | '(' -> 
              (match _lh_mkLisplist_LH_C_1_7 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_5_7 = (sublist__d0 _lh_mkLisplist_LH_C_1_6) in
    ...
    | _ -> 
      (`Nil))
and mkLisplist__d1 _lh_mkLisplist_arg1_1 =
          ...
          (match _lh_mkLisplist_LH_C_0_3 with
            | '(' -> 
              (match _lh_mkLisplist_LH_C_1_3 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_1_8 = (sublist__d1 _lh_mkLisplist_LH_C_1_2) in
          ...
          (match _lh_mkLisplist_LH_C_0_5 with
            | '(' -> 
              (match _lh_mkLisplist_LH_C_1_5 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_2_3 = (sublist__d2 _lh_mkLisplist_LH_C_1_4) in
                    (match _lh_matchIdent_2_3 with
                      | `LH_P2(_lh_mkLisplist_LH_P2_0_2, _lh_mkLisplist_LH_P2_1_2) -> 
                        (let rec _lh_matchIdent_2_4 = _lh_mkLisplist_LH_P2_0_2 in
...
and onewayunify1__d0 _lh_onewayunify1_arg1_1 _lh_onewayunify1_arg2_1 _lh_onewayunify1_arg3_1 =
  (if (atom__d1 _lh_onewayunify1_arg2_1) then
    (let rec _lh_matchIdent_4_3 = (assoc__d1 (`LH_P2(_lh_onewayunify1_arg2_1, _lh_onewayunify1_arg3_1))) in
...
and onewayunify1lst__d0 _lh_onewayunify1lst_arg1_1 _lh_onewayunify1lst_arg2_1 _lh_onewayunify1lst_arg3_1 =
  (match _lh_onewayunify1lst_arg1_1 with
    ...
    | _ -> 
      (let rec _lh_matchIdent_4_4 = (((onewayunify1__d0 (car__d6 _lh_onewayunify1lst_arg1_1)) (car__d7 _lh_onewayunify1lst_arg2_1)) _lh_onewayunify1lst_arg3_1) in
...
and rewritewithlemmas__d0 _lh_rewritewithlemmas_arg1_1 _lh_rewritewithlemmas_arg2_1 _lh_rewritewithlemmas_arg3_1 =
  (match _lh_rewritewithlemmas_arg2_1 with
    ...
    | `LH_C(_lh_rewritewithlemmas_LH_C_0_1, _lh_rewritewithlemmas_LH_C_1_1) -> 
      (let rec _lh_matchIdent_4_8 = ((onewayunify__d0 _lh_rewritewithlemmas_arg1_1) (cadr__d0 _lh_rewritewithlemmas_LH_C_0_1)) in
...
and strToToken__d0 _lh_strToToken_arg1_2 =
  (match _lh_strToToken_arg1_2 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_4_5 = (getToken__d0 _lh_strToToken_arg1_2) in
        (match _lh_matchIdent_4_5 with
          | `LH_P2(_lh_strToToken_LH_P2_0_2, _lh_strToToken_LH_P2_1_2) -> 
            (`LH_C(_lh_strToToken_LH_P2_0_2, (strToToken__d0 _lh_strToToken_LH_P2_1_2)))
          | _ -> 
            (failwith "error"))))
and strToToken__d1 _lh_strToToken_arg1_1 =
  (match _lh_strToToken_arg1_1 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_3_9 = (getToken__d1 _lh_strToToken_arg1_1) in
        (match _lh_matchIdent_3_9 with
          ...
          | _ -> 
            (failwith "error"))))
and strToToken__d2 _lh_strToToken_arg1_3 =
  (match _lh_strToToken_arg1_3 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_4_6 = (getToken__d2 _lh_strToToken_arg1_3) in
        (match _lh_matchIdent_4_6 with
          | `LH_P2(_lh_strToToken_LH_P2_0_3, _lh_strToToken_LH_P2_1_3) -> 
            (`LH_C(_lh_strToToken_LH_P2_0_3, (strToToken__d2 _lh_strToToken_LH_P2_1_3)))
          | _ -> 
            (failwith "error"))))
            ...
            | `LH_P2(_lh_tautologyp_LH_P2_0_1, _lh_tautologyp_LH_P2_1_1) -> 
              (if (truep__d1 (`LH_P2((`Cons((`LH_P2(_lh_tautologyp_LH_P2_0_1, _lh_tautologyp_LH_P2_1_1)))), _lh_tautologyp_LH_P3_1_1))) then
                ...
                (if (falsep__d0 (`LH_P2((`Cons((`LH_P2(_lh_tautologyp_LH_P2_0_1, _lh_tautologyp_LH_P2_1_1)))), _lh_tautologyp_LH_P3_2_1))) then
                  ...
                  (let rec _lh_matchIdent_5_6 = _lh_tautologyp_LH_P2_0_1 in
...
and truep__d0 _lh_truep_arg1_1 =
  (match _lh_truep_arg1_1 with
                            ...
                            | `LH_N -> 
                              (match _lh_truep_LH_P2_1_3 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember__d2 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
                            | _ -> 
                              (lispmember__d2 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
                        | _ -> 
                          (lispmember__d2 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
    ...
    | _ -> 
      (failwith "error"))
and truep__d1 _lh_truep_arg1_2 =
  (match _lh_truep_arg1_2 with
                            ...
                            | `LH_N -> 
                              (match _lh_truep_LH_P2_1_5 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember__d3 (`LH_P2(_lh_truep_LH_P2_0_4, _lh_truep_LH_P2_1_4))))
                            | _ -> 
                              (lispmember__d3 (`LH_P2(_lh_truep_LH_P2_0_4, _lh_truep_LH_P2_1_4))))
                        | _ -> 
                          (lispmember__d3 (`LH_P2(_lh_truep_LH_P2_0_4, _lh_truep_LH_P2_1_4))))
    ...
    | _ -> 
      (failwith "error"))
and truep__d2 _lh_truep_arg1_3 =
                            ...
                            | `LH_N -> 
                              (match _lh_truep_LH_P2_1_7 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember__d4 (`LH_P2(_lh_truep_LH_P2_0_6, _lh_truep_LH_P2_1_6))))
                            | _ -> 
                              (lispmember__d4 (`LH_P2(_lh_truep_LH_P2_0_6, _lh_truep_LH_P2_1_6))))
                        | _ -> 
                          (lispmember__d4 (`LH_P2(_lh_truep_LH_P2_0_6, _lh_truep_LH_P2_1_6))))
...
and rewritewithlemmas__d0 _lh_rewritewithlemmas_arg1_0 _lh_rewritewithlemmas_arg2_0 _lh_rewritewithlemmas_arg3_0 =
  (match _lh_rewritewithlemmas_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and rules__d0 _lh_rules_arg1_0 _lh_dummy_1_1_5 _lh_addlemmalst_arg2_1_0_7 =
  (let rec _lh_makelemmas_LH_C_1_0 = (let rec _lh_makelemmas_LH_C_1_1 = (let rec _lh_makelemmas_LH_C_1_2 = (let rec _lh_makelemmas_LH_C_1_3 = (let rec _lh_makelemmas_LH_C_1_4 = (let rec _lh_makelemmas_LH_C_1_5 = (let rec _lh_makelemmas_LH_C_1_6 = (let rec _lh_makelemmas_LH_C_1_7 = (let rec _lh_makelemmas_LH_C_1_8 = (let rec _lh_makelemmas_LH_C_1_9 = (let rec _lh_makelemmas_LH_C_1_1_0 = (let rec _lh_makelemmas_LH_C_1_1_1 = (let rec _lh_makelemmas_LH_C_1_1_2 = (let rec _lh_makelemmas_LH_C_1_1_3 = (let rec _lh_makelemmas_LH_C_1_1_4 = (let rec _lh_makelemmas_LH_C_1_1_5 = (let rec _lh_makelemmas_LH_C_1_1_6 = (let rec _lh_makelemmas_LH_C_1_1_7 = (let rec _lh_makelemmas_LH_C_1_1_8 = (let rec _lh_makelemmas_LH_C_1_1_9 = (let rec _lh_makelemmas_LH_C_1_2_0 = (let rec _lh_makelemmas_LH_C_1_2_1 = (let rec _lh_makelemmas_LH_C_1_2_2 = (let rec _lh_makelemmas_LH_C_1_2_3 = (let rec _lh_makelemmas_LH_C_1_2_4 = (let rec _lh_makelemmas_LH_C_1_2_5 = (let rec _lh_makelemmas_LH_C_1_2_6 = (let rec _lh_makelemmas_LH_C_1_2_7 = (let rec _lh_makelemmas_LH_C_1_2_8 = (let rec _lh_makelemmas_LH_C_1_2_9 = (let rec _lh_makelemmas_LH_C_1_3_0 = (let rec _lh_makelemmas_LH_C_1_3_1 = (let rec _lh_makelemmas_LH_C_1_3_2 = (let rec _lh_makelemmas_LH_C_1_3_3 = (let rec _lh_makelemmas_LH_C_1_3_4 = (let rec _lh_makelemmas_LH_C_1_3_5 = (let rec _lh_makelemmas_LH_C_1_3_6 = (let rec _lh_makelemmas_LH_C_1_3_7 = (let rec _lh_makelemmas_LH_C_1_3_8 = (let rec _lh_makelemmas_LH_C_1_3_9 = (let rec _lh_makelemmas_LH_C_1_4_0 = (let rec _lh_makelemmas_LH_C_1_4_1 = (let rec _lh_makelemmas_LH_C_1_4_2 = (let rec _lh_makelemmas_LH_C_1_4_3 = (let rec _lh_makelemmas_LH_C_1_4_4 = (let rec _lh_makelemmas_LH_C_1_4_5 = (let rec _lh_makelemmas_LH_C_1_4_6 = (let rec _lh_makelemmas_LH_C_1_4_7 = (let rec _lh_makelemmas_LH_C_1_4_8 = (let rec _lh_makelemmas_LH_C_1_4_9 = (let rec _lh_makelemmas_LH_C_1_5_0 = (let rec _lh_makelemmas_LH_C_1_5_1 = (let rec _lh_makelemmas_LH_C_1_5_2 = (let rec _lh_makelemmas_LH_C_1_5_3 = (let rec _lh_makelemmas_LH_C_1_5_4 = (let rec _lh_makelemmas_LH_C_1_5_5 = (let rec _lh_makelemmas_LH_C_1_5_6 = (let rec _lh_makelemmas_LH_C_1_5_7 = (let rec _lh_makelemmas_LH_C_1_5_8 = (let rec _lh_makelemmas_LH_C_1_5_9 = (let rec _lh_makelemmas_LH_C_1_6_0 = (let rec _lh_makelemmas_LH_C_1_6_1 = (let rec _lh_makelemmas_LH_C_1_6_2 = (let rec _lh_makelemmas_LH_C_1_6_3 = (let rec _lh_makelemmas_LH_C_1_6_4 = (let rec _lh_makelemmas_LH_C_1_6_5 = (let rec _lh_makelemmas_LH_C_1_6_6 = (let rec _lh_makelemmas_LH_C_1_6_7 = (let rec _lh_makelemmas_LH_C_1_6_8 = (let rec _lh_makelemmas_LH_C_1_6_9 = (let rec _lh_makelemmas_LH_C_1_7_0 = (let rec _lh_makelemmas_LH_C_1_7_1 = (let rec _lh_makelemmas_LH_C_1_7_2 = (let rec _lh_makelemmas_LH_C_1_7_3 = (let rec _lh_makelemmas_LH_C_1_7_4 = (let rec _lh_makelemmas_LH_C_1_7_5 = (let rec _lh_makelemmas_LH_C_1_7_6 = (let rec _lh_makelemmas_LH_C_1_7_7 = (let rec _lh_makelemmas_LH_C_1_7_8 = (let rec _lh_makelemmas_LH_C_1_7_9 = (let rec _lh_makelemmas_LH_C_1_8_0 = (let rec _lh_makelemmas_LH_C_1_8_1 = (let rec _lh_makelemmas_LH_C_1_8_2 = (let rec _lh_makelemmas_LH_C_1_8_3 = (let rec _lh_makelemmas_LH_C_1_8_4 = (let rec _lh_makelemmas_LH_C_1_8_5 = (let rec _lh_makelemmas_LH_C_1_8_6 = (let rec _lh_makelemmas_LH_C_1_8_7 = (let rec _lh_makelemmas_LH_C_1_8_8 = (let rec _lh_makelemmas_LH_C_1_8_9 = (let rec _lh_makelemmas_LH_C_1_9_0 = (let rec _lh_makelemmas_LH_C_1_9_1 = (let rec _lh_makelemmas_LH_C_1_9_2 = (let rec _lh_makelemmas_LH_C_1_9_3 = (let rec _lh_makelemmas_LH_C_1_9_4 = (let rec _lh_makelemmas_LH_C_1_9_5 = (let rec _lh_makelemmas_LH_C_1_9_6 = (let rec _lh_makelemmas_LH_C_1_9_7 = (let rec _lh_makelemmas_LH_C_1_9_8 = (let rec _lh_makelemmas_LH_C_1_9_9 = (let rec _lh_makelemmas_LH_C_1_1_0_0 = (let rec _lh_makelemmas_LH_C_1_1_0_1 = (let rec _lh_makelemmas_LH_C_1_1_0_2 = (let rec _lh_makelemmas_LH_C_1_1_0_3 = (let rec _lh_makelemmas_LH_C_1_1_0_4 = (let rec _lh_makelemmas_LH_C_1_1_0_5 = (fun _lh_dummy_9 _lh_addlemmalst_arg2_1 -> 
    _lh_addlemmalst_arg2_1) in
    (let rec _lh_makelemmas_LH_C_0_0 = (`LH_C('(', (`LH_C('e', (`LH_C('q', (`LH_C('u', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('(', (`LH_C('g', (`LH_C('e', (`LH_C('t', (`LH_C(' ', (`LH_C('j', (`LH_C(' ', (`LH_C('(', (`LH_C('s', (`LH_C('e', (`LH_C('t', (`LH_C(' ', (`LH_C('i', (`LH_C(' ', (`LH_C('v', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C('m', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_C('(', (`LH_C('e', (`LH_C('q', (`LH_C('p', (`LH_C(' ', (`LH_C('j', (`LH_C(' ', (`LH_C('i', (`LH_C(')', (`LH_C('v', (`LH_C('a', (`LH_C('l', (`LH_C('(', (`LH_C('g', (`LH_C('e', (`LH_C('t', (`LH_C(' ', (`LH_C('j', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C('m', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (fun _lh_dummy_1_0 -> 
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Boyer2_nofib" (fun () -> ignore (let open Module_original in ((testBoyer2_nofib__d0 3))));
  Bench.Test.create ~name:"lumberhack_Boyer2_nofib" (fun () -> ignore (let open Module_lumberhack in ((testBoyer2_nofib__d0 3))));
  Bench.Test.create ~name:"lumberhack_pop_out_Boyer2_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testBoyer2_nofib__d0 3))));
])

...
and flatMap_d0_d0_d0 _lh_flatMap_arg1_7 _lh_flatMap_arg2_3 =
  (match _lh_flatMap_arg2_3 with
    ...
    | `LH_C(_lh_flatMap_LH_C_0_3, _lh_flatMap_LH_C_1_3) -> 
      ((append_d0_d0_d1 (_lh_flatMap_arg1_7 _lh_flatMap_LH_C_0_3)) ((flatMap_d0_d0_d0 _lh_flatMap_arg1_7) _lh_flatMap_LH_C_1_3))
    | _ -> 
      (failwith "error"))
        ...
        ((flatMap_d1_d0_d1 (fun q_1 -> 
          (if (((safe_d0_d0_d0 q_1) 1) b_2) then
            ...
            (fun _lh_append_arg2_1_0 -> 
              _lh_append_arg2_1_0)))) ((enumFromTo_d0_d0_d0 1) _lh_gen_arg2_1)))) ((gen_d0_d0_d0 (_lh_gen_arg1_1 - 1)) _lh_gen_arg2_1)))

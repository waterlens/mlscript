  ...
  (match _lh_head'_arg1_0 with
    | `LH_P2(_lh_head'_LH_P2_0_0, _lh_head'_LH_P2_1_0) -> 
      (if (not (null__d5 _lh_head'_LH_P2_0_0)) then
        (head__d6 _lh_head'_LH_P2_0_0)
      else
        (head__d7 _lh_head'_LH_P2_1_0))
    | _ -> 
      (failwith "error"))
...
and lines__d0 _lh_lines_arg1_0 =
  (let rec _lh_matchIdent_5 = ((break__d0 (fun x_3 -> 
    ...
    (match _lh_matchIdent_5 with
      ...
      | _ -> 
        (failwith "error")))
and map__d4 f_2 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_9, t_1_9) -> 
      (let rec t_2_0 = ((map__d4 f_2) t_1_9) in
        (let rec h_2_0 = (f_2 h_1_9) in
          (fun f_3 -> 
            (let rec t_2_1 = ((map__d5 f_3) t_2_0) in
              (let rec h_2_1 = (f_3 h_2_0) in
                (fun _lh_dummy_0 -> 
...
and splitAt__d3 _lh_splitAt_arg1_0 _lh_splitAt_arg2_0 =

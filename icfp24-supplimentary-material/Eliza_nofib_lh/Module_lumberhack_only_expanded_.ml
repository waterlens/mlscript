...
let rec foldr_lh__d1 f_8 i_1 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_2_6, t_2_6) -> 
      ((f_8 h_2_6) (((foldr_lh__d1 f_8) i_1) t_2_6))
    | `LH_N -> 
      i_1);;
...
let rec trim_lh__d1 _lh_trim_arg1_0 =
  (let rec cons_2 = (fun _lh_cons_arg1_1 _lh_cons_arg2_1 -> 
    (if (((inList_lh__d1 _lh_cons_arg1_1) (`LH_C(' ', (`LH_C('.', (`LH_C('!', (`LH_C('?', (`LH_C(',', (`LH_N)))))))))))) && (null_lh__d2 _lh_cons_arg2_1)) then
      (`LH_N)
    else
      (`LH_C(_lh_cons_arg1_1, _lh_cons_arg2_1)))) in
    ((fun _lh_funcomp_x_6 -> 
      (((foldr_lh__d1 cons_2) (`LH_N)) ((dropWhile_lh__d2 (fun x_1 -> 
        ((inList_lh__d2 x_1) (`LH_C(' ', (`LH_C('.', (`LH_C('!', (`LH_C('?', (`LH_C(',', (`LH_N)))))))))))))) _lh_funcomp_x_6))) _lh_trim_arg1_0));;
...
let rec words_lh__d1 _lh_words_arg1_1 =
  (let rec _lh_matchIdent_1_9 = ((dropWhile_lh__d1 isSpace_lh__d2) _lh_words_arg1_1) in
    (match _lh_matchIdent_1_9 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1) -> 
        (let rec _lh_matchIdent_2_0 = ((break_lh__d1 isSpace_lh__d1) (`LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1))) in
      ...
      | _ -> 
        (failwith "error")));;
let rec map_lh__d1 f_1_1 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_3_1, t_3_1) -> 
      (`LH_C((f_1_1 h_3_1), ((map_lh__d1 f_1_1) t_3_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec length_lh__d1 ls_1_7 =
  (match ls_1_7 with
    ...
    | `LH_N -> 
      0);;
let rec filter_lh__d1 f_9 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_2_8, t_2_8) -> 
      (if (f_9 h_2_8) then
        (`LH_C(h_2_8, ((filter_lh__d1 f_9) t_2_8)))
      else
        ((filter_lh__d1 f_9) t_2_8))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d1 xs_1_3 ys_1_2 =
  (match xs_1_3 with
    | `LH_C(h_2_5, t_2_5) -> 
      (`LH_C(h_2_5, ((mappend_lh__d1 t_2_5) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
...
let rec null_lz_lh__d1 _lh_null_lz_arg1_0 =
  (let rec _lh_matchIdent_7 = (Lazy.force _lh_null_lz_arg1_0) in
  ...
  (match _lh_makeResponse_arg1_0 with
    | `LH_C(_lh_makeResponse_LH_C_0_0, _lh_makeResponse_LH_C_1_0) -> 
      (match _lh_makeResponse_LH_C_0_0 with
        | '?' -> 
          ((mappend_lh__d5 ((mappend_lh__d4 ((mappend_lh__d6 _lh_makeResponse_LH_C_1_0) (`LH_C(' ', (`LH_N))))) _lh_makeResponse_arg2_0)) (`LH_C('?', (`LH_N))))
        | '.' -> 
          ((mappend_lh__d7 ((mappend_lh__d3 ((mappend_lh__d8 _lh_makeResponse_LH_C_1_0) (`LH_C(' ', (`LH_N))))) _lh_makeResponse_arg2_0)) (`LH_C('.', (`LH_N))))
        | _ -> 
...
let rec head_lz_lh__d1 ls_1_2 =
  (match (Lazy.force ls_1_2) with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec map_lz_lh__d1 f_6 ls_8 =
  (lazy (match (Lazy.force ls_8) with
    | `LH_C(h_2_0, t_2_0) -> 
      (`LH_C((f_6 h_2_0), ((map_lz_lh__d1 f_6) t_2_0)))
    | `LH_N -> 
      (`LH_N)));;
...
let rec length_lh__d2 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_2_2, t_2_2) -> 
      (1 + (length_lh__d2 t_2_2))
    | `LH_N -> 
      0);;
let rec filter_lz_lh__d1 f_7 ls_9 =
  (lazy (match (Lazy.force ls_9) with
    | `LH_C(h_2_1, t_2_1) -> 
      (if (f_7 h_2_1) then
        (`LH_C(h_2_1, ((filter_lz_lh__d1 f_7) t_2_1)))
      else
        (Lazy.force ((filter_lz_lh__d1 f_7) t_2_1)))
    | `LH_N -> 
      (`LH_N)));;
let rec mappend_lh__d1_d1 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C(h_3, ((mappend_lh__d1_d1 t_3) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_6, t_6) -> 
      ((mappend_lh__d1_d3 h_6) (concat_lh__d1 t_6))
    | `LH_N -> 
      (`LH_N));;
  ...
  (let rec prepare_0 = (fun _lh_prepare_arg1_0 -> 
    ...
    (let rec oneways_0 = (`LH_C((`LH_P2((`LH_C('m', (`LH_C('e', (`LH_N))))), (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_N))))))))), (`LH_N))) in
      (let rec bothways_0 = (`LH_C((`LH_P2((`LH_C('a', (`LH_C('r', (`LH_C('e', (`LH_N))))))), (`LH_C('a', (`LH_C('m', (`LH_N))))))), (`LH_C((`LH_P2((`LH_C('w', (`LH_C('e', (`LH_C('_', (`LH_C('r', (`LH_C('e', (`LH_N))))))))))), (`LH_C('w', (`LH_C('a', (`LH_C('s', (`LH_N))))))))), (`LH_C((`LH_P2((`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_N))))))), (`LH_C('I', (`LH_N))))), (`LH_C((`LH_P2((`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_N))))))))), (`LH_C('m', (`LH_C('y', (`LH_N))))))), (`LH_C((`LH_P2((`LH_C('I', (`LH_C('_', (`LH_C('v', (`LH_C('e', (`LH_N))))))))), (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('_', (`LH_C('v', (`LH_C('e', (`LH_N))))))))))))))), (`LH_C((`LH_P2((`LH_C('I', (`LH_C('_', (`LH_C('m', (`LH_N))))))), (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('_', (`LH_C('r', (`LH_C('e', (`LH_N))))))))))))))), (`LH_N))))))))))))) in
        (prepare_0 ((mappend_lh__d1_d0 oneways_0) (concat_lh__d1 (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
...
let rec foldr_lh__d2 f_5 i_0 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_2, t_1_2) -> 
      ((f_5 h_1_2) (((foldr_lh__d2 f_5) i_0) t_1_2))
    | `LH_N -> 
      i_0);;
...
let rec map_lh__d3 f_4 ls_5 =
  (match ls_5 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C((f_4 h_1_1), ((map_lh__d3 f_4) t_1_1)))
    | `LH_N -> 
      (`LH_N));;
let rec head_lh__d1 ls_4 =
  (match ls_4 with
    | `LH_C(h_9, t_9) -> 
      h_9
    | `LH_N -> 
...
let rec conjug_lh__d1 _lh_conjug_arg1_0 _lh_conjug_arg2_0 =
  ...
  and trailingI_0 = (fun _lh_trailingI_arg1_0 -> 
    (let rec cons_0 = (fun x_0 xs_1_1 -> 
      (if ((x_0 = (`LH_C('I', (`LH_N)))) && (null_lh__d3 xs_1_1)) then
  ...
  and ans_0 = (fun _lh_ans_arg1_0 _lh_ans_arg2_0 -> 
    (match _lh_ans_arg1_0 with
      | `LH_C(_lh_ans_LH_C_0_0, _lh_ans_LH_C_1_0) -> 
        (let rec _lh_matchIdent_1_1 = _lh_ans_LH_C_0_0 in
          (match _lh_matchIdent_1_1 with
            | `LH_P2(_lh_ans_LH_P2_0_0, _lh_ans_LH_P2_1_0) -> 
              (let rec _lh_matchIdent_1_2 = (Lazy.force _lh_ans_LH_P2_1_0) in
      ...
      | _ -> 
        (failwith "error")))
  in (let rec _lh_matchIdent_1_3 = ((ans_0 (keyTabOf_lh__d1 _lh_answer_arg1_0)) _lh_answer_arg2_0) in
...
let rec mappend_lh__d2 xs_1_2 ys_1_1 =
  (match xs_1_2 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d2 t_2_4) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_1_0 = ((break_lh__d2 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
...
let rec words_lh__d2 _lh_words_arg1_0 =
  (let rec _lh_matchIdent_1_5 = ((dropWhile_lh__d3 isSpace_lh__d4) _lh_words_arg1_0) in
    (match _lh_matchIdent_1_5 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0) -> 
        (let rec _lh_matchIdent_1_6 = ((break_lh__d2 isSpace_lh__d3) (`LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0))) in
...
let rec take_lh__d1 n_0 ls_1_4 =
  (if (n_0 > 0) then
    ...
    (`LH_N));;
let rec map_lh__d2 f_1_0 ls_1_6 =
  (match ls_1_6 with
    | `LH_C(h_2_9, t_2_9) -> 
      (`LH_C((f_1_0 h_2_9), ((map_lh__d2 f_1_0) t_2_9)))
    | `LH_N -> 
      (`LH_N));;

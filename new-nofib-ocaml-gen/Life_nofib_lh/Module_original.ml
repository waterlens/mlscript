...
and disp_lh _lh_disp_arg1_0 =
  (match _lh_disp_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and gen_lh _lh_gen_arg1_0 _lh_gen_arg2_0 =
  ((map_lh row_lh) ((shift_lh ((copy_lh _lh_gen_arg1_0) 0)) _lh_gen_arg2_0))
and generations_lh _lh_generations_arg1_0 =
  ((fun _lh_funcomp_x_0 -> 
    ((fun _lh_funcomp_x_1 -> 
      ((fun _lh_funcomp_x_2 -> 
...
and glue_lh _lh_glue_arg1_0 _lh_glue_arg2_0 _lh_glue_arg3_0 =
  ((mappend_lh ((mappend_lh _lh_glue_arg2_0) _lh_glue_arg1_0)) _lh_glue_arg3_0)
and row_lh _lh_row_arg1_0 =

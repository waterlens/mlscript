(*
ocamlfind ocamlopt -rectypes -thread -O3 ./SumFlatmap.ml -o "./SumFlatmap.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./SumFlatmap.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

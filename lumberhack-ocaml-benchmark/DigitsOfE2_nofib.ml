...
let rec append_lz_d0_d0_d0 _lh_append_lz_arg1_4 _lh_append_lz_arg2_7 =
  (let rec _lh_matchIdent_1_0 = _lh_append_lz_arg1_4 in
    (_lh_matchIdent_1_0 _lh_append_lz_arg2_7));;
let rec append_lz_d0_d0_d1 _lh_append_lz_arg1_5 _lh_append_lz_arg2_8 =
  (let rec _lh_matchIdent_1_1 = _lh_append_lz_arg1_5 in
    (_lh_matchIdent_1_1 _lh_append_lz_arg2_8));;
...
let rec concat_lz_d0_d0_d1 _lh_concat_lz_arg1_1 =
  (lazy (let rec _lh_matchIdent_8 = (Lazy.force _lh_concat_lz_arg1_1) in
    (_lh_matchIdent_8 99)));;
let rec enumFromThen_d0_d0_d0 a_2 t_9 =
  (lazy (`LH_C(a_2, ((enumFromThen_d0_d0_d0 t_9) ((2 * t_9) - a_2)))));;
let rec head_lz_d0_d0_d0 ls_1_1 =
  (match (Lazy.force ls_1_1) with
    ...
    | `LH_N -> 
      (Obj.magic 99));;
let rec map_lz_d0_d0_d0 f_6 ls_9 =
  (lazy ((Lazy.force ls_9) f_6));;
let rec map_lz_d0_d0_d1 f_5 ls_8 =
  (lazy ((Lazy.force ls_8) f_5));;
let rec map_lz_d1_d0_d0 f_4 ls_7 =
  (lazy (match (Lazy.force ls_7) with
    | `LH_C(h_7, t_8) -> 
      (`LH_C((f_4 h_7), ((map_lz_d1_d0_d0 f_4) t_8)))
    | `LH_N -> 
      (Obj.magic 99)));;
let rec tail_lz_d0_d0_d0 ls_1_0 =
...
let rec tail_lz_d1_d0_d0 ls_6 =
  (match (Lazy.force ls_6) with
    ...
    | `LH_N -> 
      (Obj.magic 99));;
let rec take_lz_d0_d0_d0 n_1 ls_1_2 =
  (if (n_1 > 0) then
    (match (Lazy.force ls_1_2) with
      | `LH_C(h_1_1, t_1_3) -> 
        (`LH_C(h_1_1, ((take_lz_d0_d0_d0 (n_1 - 1)) t_1_3)))
      | `LH_N -> 
        (Obj.magic 99))
  else
    (`LH_N));;
...
and iterate_d0_d0_d0 f_7 x_1 =
  (lazy (let rec h_8 = x_1 in
    (let rec t_1_0 = ((iterate_d0_d0_d0 f_7) (f_7 x_1)) in
      (fun f_8 -> 
        (let rec _lh_concat_lz_LH_C_0_1 = (f_8 h_8) in
          (let rec _lh_concat_lz_LH_C_1_1 = ((map_lz_d0_d0_d0 f_8) t_1_0) in
            (fun _lh_dummy_1 -> 

(*
ocamlfind ocamlopt -rectypes -thread -O3 ./BinaryTrees_nofib.ml -o "./BinaryTrees_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./BinaryTrees_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

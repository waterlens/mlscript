...
let rec foldl_lh__d1 f_9 i_0 ls_4 =
  (match ls_4 with
    | `LH_C(h_6, t_6) -> 
      (((foldl_lh__d1 f_9) ((f_9 i_0) h_6)) t_6)
    | `LH_N -> 
      i_0);;
    ...
    | `LH_N -> 
      (((rqsort_lh__d1 _lh_qpart_arg1_0) _lh_qpart_arg4_0) (let rec t_1_8 = (((rqsort_lh__d2 _lh_qpart_arg1_0) _lh_qpart_arg5_0) _lh_qpart_arg6_0) in
        (let rec h_1_8 = _lh_qpart_arg2_0 in
          (fun f_2_1 -> 
            (`LH_C((f_2_1 h_1_8), ((map_lh__d3 f_2_1) t_1_8)))))))
  ...
  (match _lh_qsort_arg2_0 with
    ...
    | `LH_C(_lh_qsort_LH_C_0_0, _lh_qsort_LH_C_1_0) -> 
      (match _lh_qsort_LH_C_1_0 with
        | `LH_N -> 
          (let rec t_5 = _lh_qsort_arg3_0 in
            (let rec h_5 = _lh_qsort_LH_C_0_0 in
              (fun f_8 -> 
                (`LH_C((f_8 h_5), ((map_lh__d3 f_8) t_5))))))
        | _ -> 
    ...
    | `LH_N -> 
      (((qsort_lh__d1 _lh_rqpart_arg1_1) _lh_rqpart_arg4_1) (let rec t_1_9 = (((qsort_lh__d1 _lh_rqpart_arg1_1) _lh_rqpart_arg5_1) _lh_rqpart_arg6_1) in
        (let rec h_1_9 = _lh_rqpart_arg2_1 in
          (fun f_2_3 -> 
            (`LH_C((f_2_3 h_1_9), ((map_lh__d3 f_2_3) t_1_9)))))))
...
rqpart_lh__d2 _lh_rqpart_arg1_0 _lh_rqpart_arg2_0 _lh_rqpart_arg3_0 _lh_rqpart_arg4_0 _lh_rqpart_arg5_0 _lh_rqpart_arg6_0 =
  (match _lh_rqpart_arg3_0 with
    | `LH_N -> 
      (((qsort_lh__d1 _lh_rqpart_arg1_0) _lh_rqpart_arg4_0) (let rec t_8 = (((qsort_lh__d1 _lh_rqpart_arg1_0) _lh_rqpart_arg5_0) _lh_rqpart_arg6_0) in
        (let rec h_8 = _lh_rqpart_arg2_0 in
          (fun f_1_0 -> 
            (`LH_C((f_1_0 h_8), ((map_lh__d3 f_1_0) t_8)))))))
        ...
        | `LH_N -> 
          (let rec t_1_1 = _lh_rqsort_arg3_0 in
            (let rec h_1_1 = _lh_rqsort_LH_C_0_0 in
              (fun f_1_3 -> 
                (`LH_C((f_1_3 h_1_1), ((map_lh__d3 f_1_3) t_1_1))))))
        | _ -> 
        ...
        | `LH_N -> 
          (let rec t_1_2 = _lh_rqsort_arg3_1 in
            (let rec h_1_2 = _lh_rqsort_LH_C_0_1 in
              (fun f_1_4 -> 
                (`LH_C((f_1_4 h_1_2), ((map_lh__d3 f_1_4) t_1_2))))))
        | _ -> 
...
let rec mappend_lh__d3 xs_1 ys_1 =
  (xs_1 ys_1);;
let rec map_lh__d6 f_1_1 ls_6 _lh_popOutId_0_2 =
  (match ls_6 with
    | `LH_C(h_9, t_9) -> 
      (let rec t_1_0 = ((map_lh__d6 f_1_1) t_9) in
        (let rec h_1_0 = (f_1_1 h_9) in
          (`LH_C(h_1_0, ((mappend_lh__d3 t_1_0) _lh_popOutId_0_2)))))
    | `LH_N -> 
      _lh_popOutId_0_2);;
let rec map_lh__d5 f_2_0 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C((f_2_0 h_1_7), ((map_lh__d5 f_2_0) t_1_7)))
    | `LH_N -> 
      (`LH_N));;
...
let rec sumAux_lh__d1 ls_1 a_2 =
  (match ls_1 with
    | `LH_N -> 
      a_2
    | `LH_C(h_2, t_2) -> 
      ((sumAux_lh__d1 t_2) (a_2 + h_2)));;
let rec sum_lh__d1 ls_5 =
  ((sumAux_lh__d1 ls_5) 0);;
let rec filter_lh__d1 f_2_2 ls_9 =
  (ls_9 f_2_2);;
let rec map_lh__d4 f_5 ls_3 _lh_popOutId_0_1 =
  (match ls_3 with
    | `LH_C(h_3, t_3) -> 
      (let rec t_4 = ((map_lh__d4 f_5) t_3) in
        (let rec h_4 = (f_5 h_3) in
          (if (_lh_popOutId_0_1 h_4) then
            (`LH_C(h_4, ((filter_lh__d1 _lh_popOutId_0_1) t_4)))
          else
            ((filter_lh__d1 _lh_popOutId_0_1) t_4))))
    | `LH_N -> 
      (`LH_N));;
...
let rec findawards_lh__d1 _lh_findawards_arg1_0 =
  (let rec _lh_matchIdent_1 = (awards_lh__d1 _lh_findawards_arg1_0) in
    (match _lh_matchIdent_1 with
      ...
      | _ -> 
        (failwith "error")));;
let rec competitors_lh__d1 _lh_competitors_arg1_0 f_1_9 =
  (let rec t_1_3 = (let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (fun f_1_5 -> 
    (`LH_N)) in
    (let rec h_1_3 = (let rec _lh_findallawards_LH_P2_1_0 = (`LH_C(9, (`LH_C(23, (`LH_C(17, (`LH_C(54, (`LH_C(_lh_competitors_arg1_0, (`LH_C(41, (`LH_C(9, (`LH_C(18, (`LH_C(14, (`LH_N))))))))))))))))))) in
      ...
      (fun f_1_6 -> 
        (`LH_C((f_1_6 h_1_3), ((map_lh__d2 f_1_6) t_1_6)))))) in
    (let rec h_1_4 = (let rec _lh_findallawards_LH_P2_1_1 = (`LH_C(1, (`LH_C(18, (`LH_C(_lh_competitors_arg1_0, (`LH_C(20, (`LH_C(21, (`LH_C(19, (`LH_C(34, (`LH_C(8, (`LH_C(16, (`LH_C(21, (`LH_N))))))))))))))))))))) in
      ...
      (fun f_1_7 -> 
        (`LH_C((f_1_7 h_1_4), ((map_lh__d2 f_1_7) t_1_5)))))) in
    (let rec h_1_5 = (let rec _lh_findallawards_LH_P2_1_2 = (`LH_C(23, (`LH_C(19, (`LH_C(45, (`LH_C(_lh_competitors_arg1_0, (`LH_C(17, (`LH_C(10, (`LH_C(5, (`LH_C(8, (`LH_C(14, (`LH_N))))))))))))))))))) in
      ...
      (fun f_1_8 -> 
        (`LH_C((f_1_8 h_1_5), ((map_lh__d2 f_1_8) t_1_4)))))) in
    (let rec h_1_6 = (let rec _lh_findallawards_LH_P2_1_3 = (`LH_C(35, (`LH_C(27, (`LH_C(40, (`LH_C(_lh_competitors_arg1_0, (`LH_C(34, (`LH_C(21, (`LH_N))))))))))))) in
      ...
      (`LH_C((f_1_9 h_1_6), ((map_lh__d2 f_1_9) t_1_3)))));;

  ...
  (match _lh_break_arg2_2 with
    ...
    | `LH_C(_lh_break_LH_C_0_2, _lh_break_LH_C_1_2) -> 
      (if (_lh_break_arg1_2 _lh_break_LH_C_0_2) then
        ...
        (let rec _lh_matchIdent_2_0 = ((break__d0 _lh_break_arg1_2) _lh_break_LH_C_1_2) in
  ...
  (match _lh_break_arg2_1 with
    ...
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_1) then
        ...
        (let rec _lh_matchIdent_1_6 = ((break__d1 _lh_break_arg1_1) _lh_break_LH_C_1_1) in
...
let rec enumFromTo__d0 a_5 b_2 =
  (if (a_5 <= b_2) then
    ...
    (`LH_N));;
let rec filter__d0 f_1_5 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_3_1, t_3_3) -> 
      (if (f_1_5 h_3_1) then
        (`LH_C(h_3_1, ((filter__d0 f_1_5) t_3_3)))
      else
        ((filter__d0 f_1_5) t_3_3))
    | `LH_N -> 
      (`LH_N));;
let rec filter__d1 f_1_2 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_2, t_2_4) -> 
      (if (f_1_2 h_2_2) then
        (`LH_C(h_2_2, ((filter__d1 f_1_2) t_2_4)))
      else
        ((filter__d1 f_1_2) t_2_4))
    | `LH_N -> 
      (`LH_N));;
let rec foldr__d0 f_1_6 i_4 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_3_2, t_3_4) -> 
      ((f_1_6 h_3_2) (((foldr__d0 f_1_6) i_4) t_3_4))
    | `LH_N -> 
      i_4);;
let rec foldr__d1 f_2_3 i_6 ls_3_6 =
  (match ls_3_6 with
    | `LH_C(h_5_1, t_5_3) -> 
      ((f_2_3 h_5_1) (((foldr__d1 f_2_3) i_6) t_5_3))
    | `LH_N -> 
      i_6);;
let rec head__d0 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_2_9, t_3_1) -> 
      h_2_9
    | `LH_N -> 
      (failwith "error"));;
let rec head__d1 ls_3_2 =
  (match ls_3_2 with
    | `LH_C(h_4_5, t_4_7) -> 
      h_4_5
    | `LH_N -> 
...
let rec isSpace__d1 _lh_isSpace_arg1_2 =
  (_lh_isSpace_arg1_2 = ' ');;
let rec isSpace__d2 _lh_isSpace_arg1_3 =
  (_lh_isSpace_arg1_3 = ' ');;
let rec isSpace__d3 _lh_isSpace_arg1_4 =
  (_lh_isSpace_arg1_4 = ' ');;
...
let rec length__d1 ls_2_7 =
  (match ls_2_7 with
    ...
    | `LH_N -> 
      0);;
let rec map__d0 f_2_2 ls_3_5 =
  (match ls_3_5 with
    | `LH_C(h_4_9, t_5_1) -> 
      (`LH_C((f_2_2 h_4_9), ((map__d0 f_2_2) t_5_1)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d1 f_1_7 ls_2_8 =
  (match ls_2_8 with
    | `LH_C(h_3_9, t_4_1) -> 
      (`LH_C((f_1_7 h_3_9), ((map__d1 f_1_7) t_4_1)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d2 f_1_4 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_2_7, t_2_9) -> 
      (`LH_C((f_1_4 h_2_7), ((map__d2 f_1_4) t_2_9)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d3 f_1_9 ls_3_0 =
  (match ls_3_0 with
    | `LH_C(h_4_2, t_4_4) -> 
      (`LH_C((f_1_9 h_4_2), ((map__d3 f_1_9) t_4_4)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d4 f_1_3 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_2_6, t_2_8) -> 
      (`LH_C((f_1_3 h_2_6), ((map__d4 f_1_3) t_2_8)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d5 f_1_8 ls_2_9 =
  (match ls_2_9 with
    | `LH_C(h_4_0, t_4_2) -> 
      (`LH_C((f_1_8 h_4_0), ((map__d5 f_1_8) t_4_2)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d6 f_2_4 ls_3_7 =
  (match ls_3_7 with
    | `LH_C(h_5_2, t_5_4) -> 
      (`LH_C((f_2_4 h_5_2), ((map__d6 f_2_4) t_5_4)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d7 f_2_1 ls_3_4 =
  (match ls_3_4 with
    | `LH_C(h_4_8, t_5_0) -> 
      (`LH_C((f_2_1 h_4_8), ((map__d7 f_2_1) t_5_0)))
    | `LH_N -> 
      (`LH_N));;
let rec map__d8 f_2_0 ls_3_1 =
  (match ls_3_1 with
    | `LH_C(h_4_4, t_4_6) -> 
      (`LH_C((f_2_0 h_4_4), ((map__d8 f_2_0) t_4_6)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend__d0 xs_1_5 ys_1_4 =
  (match xs_1_5 with
    | `LH_C(h_3_5, t_3_7) -> 
      (`LH_C(h_3_5, ((mappend__d0 t_3_7) ys_1_4)))
    | `LH_N -> 
      ys_1_4);;
let rec mappend__d1 xs_1_6 ys_1_5 =
  (match xs_1_6 with
    | `LH_C(h_3_6, t_3_8) -> 
      (`LH_C(h_3_6, ((mappend__d1 t_3_8) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
let rec mappend__d1_d0 xs_2_3 ys_2_1 =
  (match xs_2_3 with
    | `LH_C(h_5_0, t_5_2) -> 
      (`LH_C(h_5_0, ((mappend__d1_d0 t_5_2) ys_2_1)))
    | `LH_N -> 
      ys_2_1);;
let rec mappend__d1_d1 xs_1_2 ys_1_1 =
  (match xs_1_2 with
    | `LH_C(h_2_4, t_2_6) -> 
      (`LH_C(h_2_4, ((mappend__d1_d1 t_2_6) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec mappend__d1_d2 xs_1_9 ys_1_8 =
  (match xs_1_9 with
    | `LH_C(h_4_1, t_4_3) -> 
      (`LH_C(h_4_1, ((mappend__d1_d2 t_4_3) ys_1_8)))
    | `LH_N -> 
      ys_1_8);;
let rec mappend__d2 xs_1_4 ys_1_3 =
  (match xs_1_4 with
    | `LH_C(h_3_3, t_3_5) -> 
      (`LH_C(h_3_3, ((mappend__d2 t_3_5) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend__d3 xs_1_7 ys_1_6 =
  (match xs_1_7 with
    | `LH_C(h_3_7, t_3_9) -> 
      (`LH_C(h_3_7, ((mappend__d3 t_3_9) ys_1_6)))
    | `LH_N -> 
      ys_1_6);;
let rec mappend__d4 xs_1_8 ys_1_7 =
  (match xs_1_8 with
    | `LH_C(h_3_8, t_4_0) -> 
      (`LH_C(h_3_8, ((mappend__d4 t_4_0) ys_1_7)))
    | `LH_N -> 
      ys_1_7);;
let rec mappend__d5 xs_2_0 ys_1_9 =
  (match xs_2_0 with
    | `LH_C(h_4_3, t_4_5) -> 
      (`LH_C(h_4_3, ((mappend__d5 t_4_5) ys_1_9)))
    | `LH_N -> 
      ys_1_9);;
let rec mappend__d6 xs_2_1 ys_2_0 =
  (match xs_2_1 with
    | `LH_C(h_4_6, t_4_8) -> 
      (`LH_C(h_4_6, ((mappend__d6 t_4_8) ys_2_0)))
    | `LH_N -> 
      ys_2_0);;
let rec mappend__d7 xs_1_3 ys_1_2 =
  (match xs_1_3 with
    | `LH_C(h_2_8, t_3_0) -> 
      (`LH_C(h_2_8, ((mappend__d7 t_3_0) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
let rec mappend__d8 xs_1_0 ys_9 =
  (match xs_1_0 with
    | `LH_C(h_2_0, t_2_2) -> 
      (`LH_C(h_2_0, ((mappend__d8 t_2_2) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend__d9 xs_1_1 ys_1_0 =
  (match xs_1_1 with
    | `LH_C(h_2_3, t_2_5) -> 
...
let rec null__d3 _lh_null_arg1_1 =
  (match _lh_null_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec null__d4 _lh_null_arg1_5 =
...
let rec toUpper__d1 _lh_toUpper_arg1_2 =
  (let rec _lh_matchIdent_1_0 = _lh_toUpper_arg1_2 in
    (match _lh_matchIdent_1_0 with
      ...
      | _ -> 
        _lh_matchIdent_1_0));;
let rec toUpper__d2 _lh_toUpper_arg1_3 =
  ...
  and ans_1 = (fun _lh_ans_arg1_1 _lh_ans_arg2_1 -> 
    (match _lh_ans_arg1_1 with
      | `LH_C(_lh_ans_LH_C_0_2, _lh_ans_LH_C_1_2) -> 
        (let rec _lh_matchIdent_1_2 = _lh_ans_LH_C_0_2 in
      ...
      | _ -> 
        (failwith "error")))
  in (let rec _lh_matchIdent_1_3 = ((ans_1 (keyTabOf__d0 _lh_answer_arg1_1)) _lh_answer_arg2_1) in
...
and concat__d0 lss_1 =
  (match lss_1 with
    | `LH_C(h_3_0, t_3_2) -> 
      ((mappend__d6 h_3_0) (concat__d0 t_3_2))
    | `LH_N -> 
      (`LH_N))
and conjug__d0 _lh_conjug_arg1_1 _lh_conjug_arg2_1 =
  let rec conj_1 = (fun _lh_conj_arg1_1 -> 
    (head__d1 ((mappend__d8 (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
      (match _lh_listcomp_fun_para_5 with
          ...
          (match _lh_listcomp_fun_ls_h_5 with
            | `LH_P2(_lh_conj_LH_P2_0_1, _lh_conj_LH_P2_1_1) -> 
              (if ((ucase__d1 _lh_conj_arg1_1) = _lh_conj_LH_P2_0_1) then
                (`LH_C(_lh_conj_LH_P2_1_1, (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_5)))
              else
        ...
        | `LH_N -> 
          (`LH_N))) in
      (_lh_listcomp_fun_5 (conjugates__d0 0)))) (`LH_C(_lh_conj_arg1_1, (`LH_N))))))
  and trailingI_1 = (fun _lh_trailingI_arg1_1 -> 
    (let rec cons_5 = (fun x_5 xs_2_2 -> 
      (if ((x_5 = (`LH_C('I', (`LH_N)))) && (null__d3 xs_2_2)) then
        (`LH_C((`LH_C('m', (`LH_C('e', (`LH_N))))), (`LH_N)))
      else
        (`LH_C(x_5, xs_2_2)))) in
      (((foldr__d0 cons_5) (`LH_N)) _lh_trailingI_arg1_1)))
  ...
  in ((fun _lh_funcomp_x_2_5 -> 
    ((fun _lh_funcomp_x_2_6 -> 
      ((fun _lh_funcomp_x_2_7 -> 
        (unwords__d0 (trailingI_1 _lh_funcomp_x_2_7))) ((map__d4 conj_1) _lh_funcomp_x_2_6))) ((maybe_3 _lh_conjug_arg1_1) _lh_funcomp_x_2_5))) _lh_conjug_arg2_1)
and conjugates__d0 _lh_conjugates_arg1_1 =
  (let rec prepare_1 = (fun _lh_prepare_arg1_1 -> 
    ((map__d2 (fun wr_1 -> 
      (let rec _lh_matchIdent_8 = wr_1 in
    ...
    (let rec oneways_1 = (`LH_C((`LH_P2((`LH_C('m', (`LH_C('e', (`LH_N))))), (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_N))))))))), (`LH_N))) in
      (let rec bothways_1 = (`LH_C((`LH_P2((`LH_C('a', (`LH_C('r', (`LH_C('e', (`LH_N))))))), (`LH_C('a', (`LH_C('m', (`LH_N))))))), (`LH_C((`LH_P2((`LH_C('w', (`LH_C('e', (`LH_C('_', (`LH_C('r', (`LH_C('e', (`LH_N))))))))))), (`LH_C('w', (`LH_C('a', (`LH_C('s', (`LH_N))))))))), (`LH_C((`LH_P2((`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_N))))))), (`LH_C('I', (`LH_N))))), (`LH_C((`LH_P2((`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_N))))))))), (`LH_C('m', (`LH_C('y', (`LH_N))))))), (`LH_C((`LH_P2((`LH_C('I', (`LH_C('_', (`LH_C('v', (`LH_C('e', (`LH_N))))))))), (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('_', (`LH_C('v', (`LH_C('e', (`LH_N))))))))))))))), (`LH_C((`LH_P2((`LH_C('I', (`LH_C('_', (`LH_C('m', (`LH_N))))))), (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('_', (`LH_C('r', (`LH_C('e', (`LH_N))))))))))))))), (`LH_N))))))))))))) in
        (prepare_1 ((mappend__d7 oneways_1) (concat__d0 (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
...
and replies__d0 _lh_replies_arg1_1 _lh_replies_arg2_1 =
  ((fun _lh_funcomp_x_1_4 -> 
    ((fun _lh_funcomp_x_1_5 -> 
      ((map__d6 (fun _lh_funcomp_x_1_6 -> 
        ((conjug__d0 _lh_replies_arg2_1) ((drop__d0 (length__d1 _lh_replies_arg1_1)) _lh_funcomp_x_1_6)))) ((filter__d1 (fun _lh_funcomp_x_1_7 -> 
        ((prefix__d0 _lh_replies_arg1_1) ((map__d7 ucase__d2) _lh_funcomp_x_1_7)))) _lh_funcomp_x_1_5))) (tails__d0 _lh_funcomp_x_1_4))) _lh_replies_arg2_1)
and session__d0 _lh_session_arg1_1 _lh_session_arg2_1 _lh_session_arg3_1 =
  (match _lh_session_arg3_1 with
    ...
    | `LH_C(_lh_session_LH_C_0_1, _lh_session_LH_C_1_1) -> 
      (let rec _lh_matchIdent_1_1 = (if (_lh_session_arg2_1 = _lh_session_LH_C_0_1) then
        ...
        ((fun _lh_funcomp_x_1_9 -> 
          ((fun _lh_funcomp_x_2_0 -> 
            ((fun _lh_funcomp_x_2_1 -> 
              (length__d0 (((session__d0 (initial__d0 0)) (`LH_N)) _lh_funcomp_x_2_1))) ((filter__d0 (fun _lh_funcomp_x_2_2 -> 
              (not (null__d0 _lh_funcomp_x_2_2)))) _lh_funcomp_x_2_0))) ((map__d1 (fun _lh_funcomp_x_2_3 -> 
            (words__d1 (trim__d0 _lh_funcomp_x_2_3)))) _lh_funcomp_x_1_9))) ((take__d0 (i_5 mod 20)) _lh_funcomp_x_1_8))) input_1))) ((enumFromTo__d0 1) _lh_testEliza_nofib_arg1_1)))
and trim__d0 _lh_trim_arg1_1 =
  (let rec cons_3 = (fun _lh_cons_arg1_2 _lh_cons_arg2_2 -> 
    (if (((inList__d0 _lh_cons_arg1_2) (`LH_C(' ', (`LH_C('.', (`LH_C('!', (`LH_C('?', (`LH_C(',', (`LH_N)))))))))))) && (null__d4 _lh_cons_arg2_2)) then
      (`LH_N)
    else
      (`LH_C(_lh_cons_arg1_2, _lh_cons_arg2_2)))) in
    ((fun _lh_funcomp_x_2_4 -> 
      (((foldr__d1 cons_3) (`LH_N)) ((dropWhile__d1 (fun x_4 -> 
        ((inList__d1 x_4) (`LH_C(' ', (`LH_C('.', (`LH_C('!', (`LH_C('?', (`LH_C(',', (`LH_N)))))))))))))) _lh_funcomp_x_2_4))) _lh_trim_arg1_1))
and ucase__d0 _lh_ucase_arg1_3 =
  ((map__d3 toUpper__d0) _lh_ucase_arg1_3)
and ucase__d1 _lh_ucase_arg1_1 =
  ((map__d5 toUpper__d1) _lh_ucase_arg1_1)
...
and unwords__d0 _lh_unwords_arg1_1 =
  (match _lh_unwords_arg1_1 with
    ...
    | _ -> 
      (failwith "error"))
and words__d0 _lh_words_arg1_2 =
  (let rec _lh_matchIdent_1_8 = ((dropWhile__d0 isSpace__d0) _lh_words_arg1_2) in
    (match _lh_matchIdent_1_8 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_2, _lh_words_LH_C_1_2) -> 
        (let rec _lh_matchIdent_1_9 = ((break__d0 isSpace__d1) (`LH_C(_lh_words_LH_C_0_2, _lh_words_LH_C_1_2))) in
...
and words__d1 _lh_words_arg1_1 =
  (let rec _lh_matchIdent_1_4 = ((dropWhile__d2 isSpace__d2) _lh_words_arg1_1) in
    (match _lh_matchIdent_1_4 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1) -> 
        (let rec _lh_matchIdent_1_5 = ((break__d1 isSpace__d3) (`LH_C(_lh_words_LH_C_0_1, _lh_words_LH_C_1_1))) in
          (match _lh_matchIdent_1_5 with
            | `LH_P2(_lh_words_LH_P2_0_1, _lh_words_LH_P2_1_1) -> 
              (`LH_C(_lh_words_LH_P2_0_1, (words__d1 _lh_words_LH_P2_1_1)))
            | _ -> 
              (failwith "error")))
      | _ -> 
        (failwith "error")));;

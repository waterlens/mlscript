...
and testQueenBuiltInType__d0__d0 _lh_testQueenBuiltInType_arg1_0 =
  (nsoln__d0__d0 _lh_testQueenBuiltInType_arg1_0);;
...
let rec enumFromTo__d0__d0__d0 a_1 b_1 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 =
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo__d0__d0__d0 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_1 in
        (if (((safe__d0__d0__d0 _lh_listcomp_fun_ls_h_5) 1) _lh_popOutId_0_0) then
        ...
        (match _lh_listcomp_fun_para_2 with
          | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
            (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_3 -> 
              ...
              (_lh_listcomp_fun_7 ((enumFromTo__d0__d0__d0 1) _lh_gen_arg2_1)))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_6 ((gen__d0__d0__d0 (_lh_gen_arg1_1 - 1)) _lh_gen_arg2_1))))
and nsoln__d0__d0__d0 _lh_nsoln_arg1_1 =
  (length__d0__d0__d0 ((gen__d0__d0__d0 _lh_nsoln_arg1_1) _lh_nsoln_arg1_1))
and testQueenBuiltInType__d0__d0__d0 _lh_testQueenBuiltInType_arg1_1 =
  (nsoln__d0__d0__d0 _lh_testQueenBuiltInType_arg1_1);;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_QueenBuiltInType" (fun () -> ignore ((testQueenBuiltInType__d0 11)));
  Bench.Test.create ~name:"lumberhack_QueenBuiltInType" (fun () -> ignore ((testQueenBuiltInType__d0__d0 11)));
  Bench.Test.create ~name:"lumberhack_pop_out_QueenBuiltInType" (fun () -> ignore ((testQueenBuiltInType__d0__d0__d0 11)));
])

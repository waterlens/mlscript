(*
ocamlfind ocamlopt -rectypes -thread -O3 ./SumMapEnumSumAcc.ml -o "./SumMapEnumSumAcc.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./SumMapEnumSumAcc.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;
      ...
      (let rec t_0 = ((enumFromTo_d0 (a_0 + 1)) b_0) in
        (fun f_0 -> 
          (let rec h_1 = (f_0 h_0) in
            (let rec t_1 = ((map_d0 f_0) t_0) in
              (fun acc_0 -> 
                ((summ_d0 (acc_0 + h_1)) t_1)))))))
  else
    (fun f_1 acc_1 -> 
      acc_1))
and sum_d0 ls_0 =
...
(* lumberhack_pop_out *)
let rec map_d0_d0 f_6 ls_6 =
  (ls_6 f_6);;
let rec map_d0_d1 f_5 ls_4 =
  (ls_4 f_5);;
let rec summ_d0_d0 acc_6 ls_7 =
  (ls_7 acc_6);;

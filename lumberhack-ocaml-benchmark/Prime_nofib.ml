(*
ocamlfind ocamlopt -rectypes -thread -O3 ./Prime_nofib.ml -o "./Prime_nofib.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./Prime_nofib.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

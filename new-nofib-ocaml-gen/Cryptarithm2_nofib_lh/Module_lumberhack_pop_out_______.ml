...
let rec length_lh__d1 ls_1_0 =
  (ls_1_0 99);;
let rec filter_lh__d1 f_1_4 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_2_5, t_2_6) -> 
      (if (f_1_4 h_2_5) then
        (`LH_C(h_2_5, ((filter_lh__d1 f_1_4) t_2_6)))
      else
        ((filter_lh__d1 f_1_4) t_2_6))
    | `LH_N -> 
      (`LH_N));;
...
let rec get_lh__d2 =
  (`StateT((fun s_1_2 -> 
    (`LH_C((`LH_P2(s_1_2, s_1_2)), (`LH_N))))));;
let rec mappend_lh__d8 xs_3 ys_2 =
  (match xs_3 with
    | `LH_C(h_5, t_6) -> 
      (`LH_C(h_5, ((mappend_lh__d8 t_6) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec concat_lh__d5 lss_0 =
  (lss_0 99);;
let rec map_lh__d6 f_8 ls_5 _lh_popOutId_0_2 =
  (match ls_5 with
    | `LH_C(h_1_3, t_1_4) -> 
      (let rec t_1_5 = ((map_lh__d6 f_8) t_1_4) in
        (let rec h_1_4 = (f_8 h_1_3) in
          ((mappend_lh__d8 h_1_4) (concat_lh__d5 t_1_5))))
    | `LH_N -> 
      (`LH_N));;
...
let rec bind_lh__d8 _lh_bind_arg1_4 _lh_bind_arg2_5 =
  (`StateT((fun s_1_5 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_4 -> 
      (let rec _lh_matchIdent_9 = as_4 in
        (match _lh_matchIdent_9 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_4) s_1_5))))));;
...
let rec lift_lh__d1 _lh_lift_arg1_0 =
  (`StateT((fun s_7 -> 
    (concat_lh__d5 ((map_lh__d6 (fun x_1 -> 
      (`LH_C((`LH_P2(x_1, s_7)), (`LH_N))))) _lh_lift_arg1_0)))));;
let rec foldl_lh__d1 f_3 i_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_3, t_4) -> 
      (((foldl_lh__d1 f_3) ((f_3 i_0) h_3)) t_4)
    | `LH_N -> 
      i_0);;
...
let rec permute_lh__d2 _lh_permute_arg1_0 =
  ((bind_lh__d8 get_lh__d2) (fun st_2 -> 
    ((bind_lh__d8 (let rec xs_9 = (digits_lh__d1 st_2) in
      ...
      (let rec _lh_matchIdent_1_1 = iis_0 in
        (match _lh_matchIdent_1_1 with
          | `LH_P2(_lh_permute_LH_P2_0_0, _lh_permute_LH_P2_1_0) -> 
            ((bind_lh__d8 (put_lh__d1 (`Digits(_lh_permute_LH_P2_1_0, (`LH_C((`LH_P2(_lh_permute_arg1_0, _lh_permute_LH_P2_0_0)), (digitEnv_lh__d4 st_2))))))) (fun _p_3 -> 
...
let rec bind_lh__d6 _lh_bind_arg1_2 _lh_bind_arg2_3 =
  (let rec _lh_runStateT_StateT_0_4 = (fun s_1_3 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_2 -> 
      (let rec _lh_matchIdent_7 = as_2 in
        (match _lh_matchIdent_7 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_2) s_1_3)))) in
...
let rec permute_lh__d1 _lh_permute_arg1_1 =
  ((bind_lh__d8 get_lh__d2) (fun st_3 -> 
    ((bind_lh__d8 (let rec xs_1_0 = (digits_lh__d1 st_3) in
      ...
      (let rec _lh_matchIdent_1_5 = iis_1 in
        (match _lh_matchIdent_1_5 with
          | `LH_P2(_lh_permute_LH_P2_0_1, _lh_permute_LH_P2_1_1) -> 
            ((bind_lh__d8 (put_lh__d1 (`Digits(_lh_permute_LH_P2_1_1, (`LH_C((`LH_P2(_lh_permute_arg1_1, _lh_permute_LH_P2_0_1)), (digitEnv_lh__d4 st_3))))))) (fun _p_4 -> 
    ...
    (concat_lh__d5 ((map_lh__d6 (fun as_6 -> 
      (let rec _lh_matchIdent_1_6 = as_6 in
        (match _lh_matchIdent_1_6 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_6) s_1_9))))));;
let rec get_lh__d1 =
  (`StateT((fun s_1_8 -> 
    (`LH_C((`LH_P2(s_1_8, s_1_8)), (`LH_N))))));;
...
let rec guard_lh__d1 _lh_guard_arg1_0 =
  (match _lh_guard_arg1_0 with
    | true -> 
      (let rec _lh_runStateT_StateT_0_2 = (fun s_1_0 -> 
        (let rec t_9 = (fun f_5 _lh_dummy_6 -> 
          (`LH_N)) in
          (let rec h_8 = (let rec _lh_bind_LH_P2_1_2 = s_1_0 in
            (let rec _lh_bind_LH_P2_0_2 = (`Unit) in
              (fun _lh_bind_arg2_2 -> 
                ((runStateT_lh__d2 (_lh_bind_arg2_2 _lh_bind_LH_P2_0_2)) _lh_bind_LH_P2_1_2)))) in
            (fun f_6 -> 
              (let rec t_1_0 = ((map_lh__d5 f_6) t_9) in
                (let rec h_9 = (f_6 h_8) in
                  (fun _lh_dummy_7 -> 
                    ((mappend_lh__d8 h_9) (concat_lh__d4 t_1_0))))))))) in
        _lh_runStateT_StateT_0_2)
    | false -> 
      (let rec _lh_runStateT_StateT_0_3 = (fun s_1_1 f_7 _lh_dummy_8 -> 
        (`LH_N)) in
...
let rec bind_lh__d3 _lh_bind_arg1_3 _lh_bind_arg2_4 =
  (`StateT((fun s_1_4 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_3 -> 
      (let rec _lh_matchIdent_8 = as_3 in
        (match _lh_matchIdent_8 with
          ...
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_3) s_1_4))))));;
let rec rest_lh__d1 _lh_rest_arg1_0 =
  (match _lh_rest_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec runStateT_lh__d3 _lh_runStateT_arg1_4 =
  _lh_runStateT_arg1_4;;
let rec bind_lh__d1 _lh_bind_arg1_7 _lh_bind_arg2_8 =
  (let rec _lh_runStateT_StateT_0_6 = (fun s_2_0 -> 
    (concat_lh__d4 ((map_lh__d5 (fun as_7 -> 
      (let rec _lh_matchIdent_1_7 = as_7 in
        (_lh_matchIdent_1_7 _lh_bind_arg2_8)))) ((runStateT_lh__d3 _lh_bind_arg1_7) s_2_0)))) in
...
let rec bind_lh__d4 _lh_bind_arg1_0 _lh_bind_arg2_0 =
  (`StateT((fun s_5 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_0 -> 
...
let rec bind_lh__d7 _lh_bind_arg1_5 _lh_bind_arg2_6 =
  (`StateT((fun s_1_6 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_5 -> 
      (let rec _lh_matchIdent_1_3 = as_5 in
        (match _lh_matchIdent_1_3 with
          | `LH_P2(_lh_bind_LH_P2_0_6, _lh_bind_LH_P2_1_6) -> 
            ((runStateT_lh__d6 (_lh_bind_arg2_6 _lh_bind_LH_P2_0_6)) _lh_bind_LH_P2_1_6)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d6 _lh_bind_arg1_5) s_1_6))))));;
...
let rec bind_lh__d2 _lh_bind_arg1_1 _lh_bind_arg2_1 =
  (`StateT((fun s_8 -> 
    (concat_lh__d5 ((map_lh__d6 (fun as_1 -> 
      (let rec _lh_matchIdent_4 = as_1 in
        (match _lh_matchIdent_4 with
          | `LH_P2(_lh_bind_LH_P2_0_1, _lh_bind_LH_P2_1_1) -> 
            ((runStateT_lh__d4 (_lh_bind_arg2_1 _lh_bind_LH_P2_0_1)) _lh_bind_LH_P2_1_1)
          | _ -> 
            (failwith "error"))))) ((runStateT_lh__d5 _lh_bind_arg1_1) s_8))))));;
  ...
  (match _lh_solve_arg2_0 with
    | `LH_C(_lh_solve_LH_C_0_0, _lh_solve_LH_C_1_0) -> 
      ((bind_lh__d4 (let rec _lh_matchIdent_3 = _lh_solve_arg1_0 in
        ...
        ((bind_lh__d2 (select_lh__d2 _lh_solve_LH_C_0_0)) (fun botN_0 -> 
...
let rec concat_lh__d2 lss_3 =
  (lss_3 99);;
let rec mappend_lh__d7 xs_4 ys_3 =
  (xs_4 ys_3);;
let rec map_lh__d3 f_2 ls_0 _lh_popOutId_0_1 =
  (match ls_0 with
    | `LH_C(h_1, t_2) -> 
      (let rec t_3 = ((map_lh__d3 f_2) t_2) in
        (let rec h_2 = (f_2 h_1) in
          ((mappend_lh__d7 h_2) (concat_lh__d2 t_3))))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `LH_C(_lh_transpose_LH_C_0_0, _lh_transpose_LH_C_1_0) -> 
      (match _lh_transpose_LH_C_0_0 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_1, _lh_transpose_LH_C_1_1) -> 
          (let rec _lh_matchIdent_1_4 = (unzip_lh__d1 (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
...
let rec reverse_helper_lh__d2 ls_2 a_2 =
  (match ls_2 with
    | `LH_C(h_4, t_5) -> 
      ((reverse_helper_lh__d2 t_5) (`LH_C(h_4, a_2)))
    | `LH_N -> 
      a_2);;
let rec reverse_lh__d2 ls_1_4 =
  ((reverse_helper_lh__d2 ls_1_4) (`LH_N));;
let rec map_lh__d4 f_1_5 ls_1_2 =
  (ls_1_2 f_1_5);;
let rec mappend_lh__d6 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_1_2, t_1_3) -> 
      (`LH_C(h_1_2, ((mappend_lh__d6 t_1_3) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d3 ((map_lh__d4 (fun l_0 -> 
...
let rec mappend_lh__d4 xs_8 ys_8 =
  (xs_8 ys_8);;
let rec map_lh__d2 f_9 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_5, t_1_6) -> 
      (`LH_C((f_9 h_1_5), ((map_lh__d2 f_9) t_1_6)))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `LH_C(h_1_0, t_1_1) -> 
      (let rec t_1_2 = ((mappend_lh__d5 t_1_1) ys_5) in
        (let rec h_1_1 = h_1_0 in
          (fun ys_6 -> 
            (`LH_C(h_1_1, ((mappend_lh__d4 t_1_2) ys_6))))))
    | `LH_N -> 
      ys_5);;
let rec concat_lh__d1 lss_4 =
  (match lss_4 with
    | `LH_C(h_3_2, t_3_3) -> 
      ((mappend_lh__d5 h_3_2) (concat_lh__d1 t_3_3))
    | `LH_N -> 
      (fun ys_2_6 -> 
        ys_2_6));;
let rec reverse_helper_lh__d1 ls_3 a_3 =
  (match ls_3 with
    | `LH_C(h_6, t_7) -> 
      ((reverse_helper_lh__d1 t_7) (`LH_C(h_6, a_3)))
    | `LH_N -> 
      a_3);;
...
let rec puzzle_lh__d1 _lh_puzzle_arg1_0 _lh_puzzle_arg2_0 =
  (let rec solution_0 = (((solve_lh__d1 (transpose_lh__d1 ((map_lh__d2 reverse_lh__d1) _lh_puzzle_arg1_0))) (reverse_lh__d2 _lh_puzzle_arg2_0)) 0) in
    (let rec answer_0 = (let rec _lh_matchIdent_1_0 = ((execStateT_lh__d1 solution_0) (`Digits(((enumFromTo_lh__d2 0) 9), (`LH_N)))) in
                          ...
                          (match _lh_listcomp_fun_ls_h_1 with
                            | `LH_P2(_lh_puzzle_LH_P2_0_0, _lh_puzzle_LH_P2_1_0) -> 
                              (let rec t_1_7 = (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1) in
                                (let rec h_1_6 = ((mappend_lh__d3 ((mappend_lh__d2 (let rec t_1_8 = (fun ys_9 -> 
                                  ys_9) in
                                  (let rec h_1_7 = _lh_puzzle_LH_P2_0_0 in
                                    (fun ys_1_0 -> 
                                      (let rec t_1_9 = ((mappend_lh__d2 t_1_8) ys_1_0) in
                                        (let rec h_1_8 = h_1_7 in
                                          (fun ys_1_1 -> 
                                            (`LH_C(h_1_8, ((mappend_lh__d3 t_1_9) ys_1_1)))))))))) (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (fun ys_1_2 -> 
                                  ys_1_2) in
                                  (let rec h_1_9 = ' ' in
                                    (fun ys_1_3 -> 
                                      (`LH_C(h_1_9, ((mappend_lh__d3 t_2_3) ys_1_3)))))) in
                                  (let rec h_2_0 = '>' in
                                    (fun ys_1_4 -> 
                                      (`LH_C(h_2_0, ((mappend_lh__d3 t_2_2) ys_1_4)))))) in
                                  (let rec h_2_1 = '=' in
                                    (fun ys_1_5 -> 
                                      (`LH_C(h_2_1, ((mappend_lh__d3 t_2_1) ys_1_5)))))) in
                                  (let rec h_2_2 = ' ' in
                                    (fun ys_1_6 -> 
                                      (`LH_C(h_2_2, ((mappend_lh__d3 t_2_0) ys_1_6)))))))) (string_of_int _lh_puzzle_LH_P2_1_0)) in
                                  (fun f_1_0 -> 
                                    (let rec t_2_4 = ((map_lh__d4 f_1_0) t_1_7) in
                                      (let rec h_2_3 = (f_1_0 h_1_6) in
                                        (fun _lh_dummy_1_3 -> 
                                          ((mappend_lh__d8 h_2_3) (concat_lh__d3 t_2_4))))))))
                            | _ -> 
                              (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1))
                        | `LH_N -> 
                          (fun f_1_1 _lh_dummy_1_4 -> 
                            (`LH_N)))) in
                      (_lh_listcomp_fun_1 (digitEnv_lh__d2 answer_0)))))))))))));;
let rec map_lh__d1 f_1_2 ls_8 =
  (ls_8 f_1_2);;
let rec enumFromTo_lh__d1 a_0 b_0 _lh_popOutId_0_0 =
  (if (a_0 <= b_0) then
    (let rec t_1 = ((enumFromTo_lh__d1 (a_0 + 1)) b_0) in
      (let rec h_0 = a_0 in
        (`LH_C((_lh_popOutId_0_0 h_0), ((map_lh__d1 _lh_popOutId_0_0) t_1)))))
  else
    (`LH_N));;
let rec testCryptarithm2_nofib_lh__d1 _lh_testCryptarithm2_nofib_arg1_0 =
  ((map_lh__d1 (fun i_2 -> 
    (let rec args_0 = (`LH_C((`LH_C('T', (`LH_C('H', (`LH_C('I', (`LH_C('R', (`LH_C('T', (`LH_C('Y', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C((`LH_C('T', (`LH_C('W', (`LH_C('E', (`LH_C('L', (`LH_C('V', (`LH_C('E', (`LH_N))))))))))))), (`LH_C(((mappend_lh__d1 (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (fun ys_1_9 -> 
      ys_1_9) in
      (let rec h_2_6 = 'E' in
        (fun ys_2_0 -> 
          (`LH_C(h_2_6, ((mappend_lh__d1 t_3_2) ys_2_0)))))) in
      (let rec h_2_7 = 'V' in
        (fun ys_2_1 -> 
          (`LH_C(h_2_7, ((mappend_lh__d1 t_3_1) ys_2_1)))))) in
      (let rec h_2_8 = 'L' in
        (fun ys_2_2 -> 
          (`LH_C(h_2_8, ((mappend_lh__d1 t_3_0) ys_2_2)))))) in
      (let rec h_2_9 = 'E' in
        (fun ys_2_3 -> 
          (`LH_C(h_2_9, ((mappend_lh__d1 t_2_9) ys_2_3)))))) in
      (let rec h_3_0 = 'W' in
        (fun ys_2_4 -> 
          (`LH_C(h_3_0, ((mappend_lh__d1 t_2_8) ys_2_4)))))) in
      (let rec h_3_1 = 'T' in
        (fun ys_2_5 -> 
          (`LH_C(h_3_1, ((mappend_lh__d1 t_2_7) ys_2_5))))))) (if (i_2 > 999999) then
      (`LH_C('1', (`LH_N)))
    else
      (`LH_N))), (`LH_N))))))))))))) in
      ((puzzle_lh__d1 args_0) (`LH_C('N', (`LH_C('I', (`LH_C('N', (`LH_C('E', (`LH_C('T', (`LH_C('Y', (`LH_N))))))))))))))))) ((enumFromTo_lh__d1 1) _lh_testCryptarithm2_nofib_arg1_0));;
end;;

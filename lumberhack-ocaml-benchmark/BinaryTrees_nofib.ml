...
(* lumberhack *)
let rec check'__d0__d0 _lh_check'_arg1_4 _lh_check'_arg2_4 _lh_check'_arg3_0 =
  ((_lh_check'_arg3_0 _lh_check'_arg2_4) _lh_check'_arg1_4);;
let rec check__d0__d0 _lh_check_arg1_0 =
  (((check'__d0__d0 true) 0) _lh_check_arg1_0)
and make__d0__d0 _lh_make_arg1_0 _lh_make_arg2_0 =
  (match _lh_make_arg2_0 with
    | 0 -> 
      (let rec _lh_check'_Node_2_0 = (fun _lh_check'_arg2_0 _lh_check'_arg1_0 -> 
        ...
        (let rec _lh_check'_Node_1_0 = (fun _lh_check'_arg2_1 _lh_check'_arg1_1 -> 
          ...
          (let rec _lh_check'_Node_0_0 = _lh_make_arg1_0 in
            (fun _lh_check'_arg2_2 _lh_check'_arg1_2 -> 
              (((check'__d0__d0 (not _lh_check'_arg1_2)) (((check'__d0__d0 _lh_check'_arg1_2) (if _lh_check'_arg1_2 then
    ...
    | _ -> 
      (let rec i2_0 = (2 * _lh_make_arg1_0) in
        (let rec d2_0 = (_lh_make_arg2_0 - 1) in
          (let rec _lh_check'_Node_2_1 = ((make__d0__d0 i2_0) d2_0) in
            (let rec _lh_check'_Node_1_1 = ((make__d0__d0 (i2_0 - 1)) d2_0) in
              (let rec _lh_check'_Node_0_1 = _lh_make_arg1_0 in
                (fun _lh_check'_arg2_3 _lh_check'_arg1_3 -> 
                  (((check'__d0__d0 (not _lh_check'_arg1_3)) (((check'__d0__d0 _lh_check'_arg1_3) (if _lh_check'_arg1_3 then
                    (_lh_check'_arg2_3 + _lh_check'_Node_0_1)
                  else
                    (_lh_check'_arg2_3 - _lh_check'_Node_0_1))) _lh_check'_Node_1_1)) _lh_check'_Node_2_1))))))))
and testBinaryTrees_nofib__d0__d0 _lh_testBinaryTrees_nofib_arg1_0 =
  (check__d0__d0 ((make__d0__d0 0) _lh_testBinaryTrees_nofib_arg1_0));;

(* lumberhack_pop_out *)
let rec check'__d0__d0__d0 _lh_check'_arg1_5 _lh_check'_arg2_5 _lh_check'_arg3_1 =
  ((_lh_check'_arg3_1 _lh_check'_arg2_5) _lh_check'_arg1_5);;
let rec check'__d0__d0__d1 _lh_check'_arg1_7 _lh_check'_arg2_7 _lh_check'_arg3_3 =
  ((_lh_check'_arg3_3 _lh_check'_arg2_7) _lh_check'_arg1_7);;
let rec check'__d0__d0__d2 _lh_check'_arg1_1_3 _lh_check'_arg2_1_3 _lh_check'_arg3_5 =
  ((_lh_check'_arg3_5 _lh_check'_arg2_1_3) _lh_check'_arg1_1_3);;
let rec check'__d0__d0__d3 _lh_check'_arg1_6 _lh_check'_arg2_6 _lh_check'_arg3_2 =
  ((_lh_check'_arg3_2 _lh_check'_arg2_6) _lh_check'_arg1_6);;
let rec check'__d0__d0__d4 _lh_check'_arg1_1_2 _lh_check'_arg2_1_2 _lh_check'_arg3_4 =
  ((_lh_check'_arg3_4 _lh_check'_arg2_1_2) _lh_check'_arg1_1_2);;
let rec check__d0__d0__d0 _lh_check_arg1_1 =
  (((check'__d0__d0__d0 true) 0) _lh_check_arg1_1)
and make__d0__d0__d0 _lh_make_arg1_1 _lh_make_arg2_1 _lh_popOutId_0_0 _lh_popOutId_1_0 =
  (match _lh_make_arg2_1 with
    | 0 -> 
      (let rec _lh_check'_Node_2_2 = (fun _lh_check'_arg2_8 _lh_check'_arg1_8 -> 
        _lh_check'_arg2_8) in
        (let rec _lh_check'_Node_1_2 = (fun _lh_check'_arg2_9 _lh_check'_arg1_9 -> 
          _lh_check'_arg2_9) in
          (let rec _lh_check'_Node_0_2 = _lh_make_arg1_1 in
            (((check'__d0__d0__d1 (not _lh_popOutId_1_0)) (((check'__d0__d0__d2 _lh_popOutId_1_0) (if _lh_popOutId_1_0 then
    ...
    | _ -> 
      (let rec i2_1 = (2 * _lh_make_arg1_1) in
        (let rec d2_1 = (_lh_make_arg2_1 - 1) in
          (let rec _lh_check'_Node_2_3 = ((make__d0__d0__d0 i2_1) d2_1) in
            (let rec _lh_check'_Node_1_3 = ((make__d0__d0__d0 (i2_1 - 1)) d2_1) in
              (let rec _lh_check'_Node_0_3 = _lh_make_arg1_1 in
                (((check'__d0__d0__d3 (not _lh_popOutId_1_0)) (((check'__d0__d0__d4 _lh_popOutId_1_0) (if _lh_popOutId_1_0 then
                  (_lh_popOutId_0_0 + _lh_check'_Node_0_3)
                else
                  (_lh_popOutId_0_0 - _lh_check'_Node_0_3))) _lh_check'_Node_1_3)) _lh_check'_Node_2_3)))))))
and testBinaryTrees_nofib__d0__d0__d0 _lh_testBinaryTrees_nofib_arg1_1 =
  (check__d0__d0__d0 ((make__d0__d0__d0 0) _lh_testBinaryTrees_nofib_arg1_1));;

Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_BinaryTrees_nofib" (fun () -> ignore ((testBinaryTrees_nofib__d0 17)));
  Bench.Test.create ~name:"lumberhack_BinaryTrees_nofib" (fun () -> ignore ((testBinaryTrees_nofib__d0__d0 17)));
  Bench.Test.create ~name:"lumberhack_pop_out_BinaryTrees_nofib" (fun () -> ignore ((testBinaryTrees_nofib__d0__d0__d0 17)));
])

...
let rec ends__d2__d1 _lh_ends_arg1_0 =
  _lh_ends_arg1_0;;
let rec enumFromTo__d4__d0 a_9 b_9 _lh_popOutId_0_1_2 _lh_popOutId_1_1_1 _lh_popOutId_2_1 _lh_popOutId_3_1 =
  (if (a_9 <= b_9) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo__d4__d0 (a_9 + 1)) b_9) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_9 in
        (`LH_C((`LH_P2(_lh_popOutId_0_1_2, _lh_listcomp_fun_ls_h_5)), (_lh_popOutId_1_1_1 _lh_listcomp_fun_ls_t_5)))))
  else
    (_lh_popOutId_3_1 _lh_popOutId_2_1));;
let rec enumFromTo__d4__d1 a_0 b_0 _lh_popOutId_0_0 _lh_popOutId_1_0 _lh_popOutId_2_0 _lh_popOutId_3_0 =
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo__d4__d1 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (`LH_C((`LH_P2(_lh_popOutId_0_0, _lh_listcomp_fun_ls_h_0)), (_lh_popOutId_1_0 _lh_listcomp_fun_ls_t_0)))))
  else
...
and ends__d1__d0 _lh_ends_arg1_2 =
  (match _lh_ends_arg1_2 with
    ...
    | _ -> 
      (failwith "error"))
and enumFromTo__d0__d0 a_6 b_6 _lh_popOutId_0_9 _lh_popOutId_1_8 =
  (if (a_6 <= b_6) then
    (let rec t_6_1 = ((enumFromTo__d0__d0 (a_6 + 1)) b_6) in
      (let rec h_5_3 = a_6 in
        (let rec _lh_first_LH_C_1_6 = ((map__d1__d0 _lh_popOutId_0_9) t_6_1) in
          (let rec _lh_first_LH_C_0_6 = (_lh_popOutId_0_9 h_5_3) in
            (let rec _lh_matchIdent_1_0 = _lh_first_LH_C_0_6 in
              (match _lh_matchIdent_1_0 with
                | `YesIts(_lh_first_YesIts_0_6, _lh_first_YesIts_1_6) -> 
                  (`YesIts((_lh_popOutId_1_8 + _lh_first_YesIts_0_6), _lh_first_YesIts_1_6))
                | `NotEver(_lh_first_NotEver_0_6) -> 
                  ((first__d0__d0 (_lh_popOutId_1_8 + _lh_first_NotEver_0_6)) _lh_first_LH_C_1_6)
                | _ -> 
                  (failwith "error")))))))
  else
    (`NotEver(_lh_popOutId_1_8)))
and enumFromTo__d0__d1 a_1 b_1 _lh_popOutId_0_1 _lh_popOutId_1_1 =
  (if (a_1 <= b_1) then
    (let rec t_2_9 = ((enumFromTo__d0__d1 (a_1 + 1)) b_1) in
      (let rec h_2_1 = a_1 in
        (let rec _lh_first_LH_C_1_0 = ((map__d1__d2 _lh_popOutId_0_1) t_2_9) in
          (let rec _lh_first_LH_C_0_0 = (_lh_popOutId_0_1 h_2_1) in
            (let rec _lh_matchIdent_2 = _lh_first_LH_C_0_0 in
              (match _lh_matchIdent_2 with
                | `YesIts(_lh_first_YesIts_0_0, _lh_first_YesIts_1_0) -> 
                  (`YesIts((_lh_popOutId_1_1 + _lh_first_YesIts_0_0), _lh_first_YesIts_1_0))
                | `NotEver(_lh_first_NotEver_0_0) -> 
                  ((first__d0__d2 (_lh_popOutId_1_1 + _lh_first_NotEver_0_0)) _lh_first_LH_C_1_0)
                | _ -> 
                  (failwith "error")))))))
  else
    (`NotEver(_lh_popOutId_1_1)))
and enumFromTo__d1__d0 a_5 b_5 _lh_popOutId_0_6 _lh_popOutId_1_6 =
  (if (a_5 <= b_5) then
    (let rec t_5_5 = ((enumFromTo__d1__d0 (a_5 + 1)) b_5) in
      (let rec h_4_7 = a_5 in
        (let rec _lh_first_LH_C_1_4 = ((map__d2__d0 _lh_popOutId_0_6) t_5_5) in
          (let rec _lh_first_LH_C_0_4 = (_lh_popOutId_0_6 h_4_7) in
            (let rec _lh_matchIdent_8 = _lh_first_LH_C_0_4 in
              (match _lh_matchIdent_8 with
                | `YesIts(_lh_first_YesIts_0_4, _lh_first_YesIts_1_4) -> 
                  (`YesIts((_lh_popOutId_1_6 + _lh_first_YesIts_0_4), _lh_first_YesIts_1_4))
                | `NotEver(_lh_first_NotEver_0_4) -> 
                  ((first__d1__d0 (_lh_popOutId_1_6 + _lh_first_NotEver_0_4)) _lh_first_LH_C_1_4)
                | _ -> 
                  (failwith "error")))))))
  else
    (`NotEver(_lh_popOutId_1_6)))
and enumFromTo__d1__d1 a_3 b_3 _lh_popOutId_0_3 _lh_popOutId_1_3 =
  (if (a_3 <= b_3) then
    (let rec t_4_8 = ((enumFromTo__d1__d1 (a_3 + 1)) b_3) in
      (let rec h_4_0 = a_3 in
        (let rec _lh_first_LH_C_1_2 = ((map__d2__d2 _lh_popOutId_0_3) t_4_8) in
          (let rec _lh_first_LH_C_0_2 = (_lh_popOutId_0_3 h_4_0) in
            (let rec _lh_matchIdent_5 = _lh_first_LH_C_0_2 in
              (match _lh_matchIdent_5 with
                | `YesIts(_lh_first_YesIts_0_2, _lh_first_YesIts_1_2) -> 
                  (`YesIts((_lh_popOutId_1_3 + _lh_first_YesIts_0_2), _lh_first_YesIts_1_2))
                | `NotEver(_lh_first_NotEver_0_2) -> 
                  ((first__d1__d2 (_lh_popOutId_1_3 + _lh_first_NotEver_0_2)) _lh_first_LH_C_1_2)
                | _ -> 
                  (failwith "error")))))))
  else
    (`NotEver(_lh_popOutId_1_3)))
and enumFromTo__d2__d0 a_4 b_4 _lh_popOutId_0_5 _lh_popOutId_1_5 =
  (if (a_4 <= b_4) then
    (let rec t_5_4 = ((enumFromTo__d2__d0 (a_4 + 1)) b_4) in
      (let rec h_4_6 = a_4 in
        (let rec _lh_first_LH_C_1_3 = ((map__d3__d0 _lh_popOutId_0_5) t_5_4) in
          (let rec _lh_first_LH_C_0_3 = (_lh_popOutId_0_5 h_4_6) in
            (let rec _lh_matchIdent_7 = _lh_first_LH_C_0_3 in
              (match _lh_matchIdent_7 with
                | `YesIts(_lh_first_YesIts_0_3, _lh_first_YesIts_1_3) -> 
                  (`YesIts((_lh_popOutId_1_5 + _lh_first_YesIts_0_3), _lh_first_YesIts_1_3))
                | `NotEver(_lh_first_NotEver_0_3) -> 
                  ((first__d2__d0 (_lh_popOutId_1_5 + _lh_first_NotEver_0_3)) _lh_first_LH_C_1_3)
                | _ -> 
                  (failwith "error")))))))
  else
    (`NotEver(_lh_popOutId_1_5)))
and enumFromTo__d2__d1 a_2 b_2 _lh_popOutId_0_2 _lh_popOutId_1_2 =
  (if (a_2 <= b_2) then
    (let rec t_3_0 = ((enumFromTo__d2__d1 (a_2 + 1)) b_2) in
      (let rec h_2_2 = a_2 in
        (let rec _lh_first_LH_C_1_1 = ((map__d3__d2 _lh_popOutId_0_2) t_3_0) in
          (let rec _lh_first_LH_C_0_1 = (_lh_popOutId_0_2 h_2_2) in
            (let rec _lh_matchIdent_3 = _lh_first_LH_C_0_1 in
              (match _lh_matchIdent_3 with
                | `YesIts(_lh_first_YesIts_0_1, _lh_first_YesIts_1_1) -> 
                  (`YesIts((_lh_popOutId_1_2 + _lh_first_YesIts_0_1), _lh_first_YesIts_1_1))
                | `NotEver(_lh_first_NotEver_0_1) -> 
                  ((first__d2__d2 (_lh_popOutId_1_2 + _lh_first_NotEver_0_1)) _lh_first_LH_C_1_1)
                | _ -> 
                  (failwith "error")))))))
  else
    (`NotEver(_lh_popOutId_1_2)))
and enumFromTo__d3__d0 a_7 b_7 _lh_popOutId_0_1_0 _lh_popOutId_1_9 =
  (if (a_7 <= b_7) then
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo__d3__d0 (a_7 + 1)) b_7) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_7 in
        (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_2 -> 
          ((((_lh_listcomp_fun_para_2 _lh_listcomp_fun_ls_h_3) _lh_listcomp_fun_7) _lh_listcomp_fun_ls_t_3) _lh_popOutId_0_1_0)) in
          (_lh_listcomp_fun_7 ((enumFromTo__d4__d0 0) _lh_popOutId_1_9)))))
  else
    (`LH_N))
and enumFromTo__d3__d1 a_8 b_8 _lh_popOutId_0_1_1 _lh_popOutId_1_1_0 =
  (if (a_8 <= b_8) then
    (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo__d3__d1 (a_8 + 1)) b_8) in
      (let rec _lh_listcomp_fun_ls_h_4 = a_8 in
        (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_3 -> 
          ((((_lh_listcomp_fun_para_3 _lh_listcomp_fun_ls_h_4) _lh_listcomp_fun_1_0) _lh_listcomp_fun_ls_t_4) _lh_popOutId_0_1_1)) in
          (_lh_listcomp_fun_1_0 ((enumFromTo__d4__d1 0) _lh_popOutId_1_1_0)))))
  else
    (`LH_N))
and findhash__d0__d0 _lh_findhash_arg1_0 =
  (((findhash'__d0__d2 (`H((`Nothing), (`Nothing), (`LH_N)))) (`LH_N)) _lh_findhash_arg1_0)
...
and histo__d0__d1 _lh_histo_arg1_0 =
  (((foldr__d1__d5 histins__d0__d1) (`LH_N)) _lh_histo_arg1_0)
and keys__d0__d0 _lh_keys_arg1_5 f_8_9 f_9_0 _lh_dummy_1_9 =
  (let rec t_6_3 = (let rec t_6_4 = (let rec t_6_5 = (let rec t_6_6 = (fun f_8_0 f_8_1 _lh_dummy_1_5 f_8_2 i_9 -> 
    i_9) in
    (let rec h_5_5 = (`LH_C('a', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('c', (`LH_C('o', (`LH_C('t', (`LH_N))))))))))))))) in
      (fun f_8_3 -> 
      ...
      (let rec t_7_3 = ((map__d5__d4 f_8_9) t_6_3) in
        (let rec h_6_5 = (f_8_9 h_6_4) in
          (let rec t_7_4 = ((map__d6__d3 f_9_0) t_7_3) in
            (let rec h_6_6 = (f_9_0 h_6_5) in
              ((mappend__d2__d5 h_6_6) (concat__d0__d4 t_7_4))))))))
and keys__d0__d1 _lh_keys_arg1_4 f_4_5 f_4_6 _lh_dummy_1_4 =
  (let rec t_3_6 = (let rec t_3_7 = (let rec t_3_8 = (let rec t_3_9 = (fun f_3_6 f_3_7 _lh_dummy_1_0 f_3_8 i_2 -> 
    i_2) in
    (let rec h_2_8 = (`LH_C('a', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('c', (`LH_C('o', (`LH_C('t', (`LH_N))))))))))))))) in
      (fun f_3_9 -> 
      ...
      (let rec t_4_6 = ((map__d5__d9 f_4_5) t_3_6) in
        (let rec h_3_8 = (f_4_5 h_3_7) in
          (let rec t_4_7 = ((map__d6__d8 f_4_6) t_4_6) in
            (let rec h_3_9 = (f_4_6 h_3_8) in
              ((mappend__d2__d1_d1 h_3_9) (concat__d0__d9 t_4_7))))))))
and keys__d1__d0 _lh_keys_arg1_0 _lh_dummy_4 =
  (let rec t_3 = (let rec t_4 = (let rec t_5 = (let rec t_6 = (fun _lh_dummy_0 -> 
    0) in
    (fun _lh_dummy_1 -> 
      (1 + (length__d2__d0 t_6)))) in
    ...
    (fun _lh_dummy_3 -> 
      (1 + (length__d2__d2 t_4)))) in
    (1 + (length__d2__d3 t_3)))
and keys__d1__d1 _lh_keys_arg1_2 _lh_dummy_9 =
  (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (fun _lh_dummy_5 -> 
    0) in
    (fun _lh_dummy_6 -> 
      (1 + (length__d2__d5 t_1_9)))) in
    ...
    (fun _lh_dummy_8 -> 
      (1 + (length__d2__d7 t_1_7)))) in
    (1 + (length__d2__d8 t_1_6)))
and keys__d2__d0 _lh_keys_arg1_1 ys_1_0 f_1_3 =
  (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (fun ys_6 -> 
    ys_6) in
    (let rec h_3 = (`LH_C('a', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('c', (`LH_C('o', (`LH_C('t', (`LH_N))))))))))))))) in
      (fun ys_7 -> 
    ...
    (let rec h_9 = (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_N))))))))))) in
      (let rec t_1_4 = ((mappend__d4__d3 t_7) ys_1_0) in
        (let rec h_1_0 = h_9 in
          (`LH_C((f_1_3 h_1_0), ((map__d0__d4 f_1_3) t_1_4)))))))
and keys__d3__d0 _lh_keys_arg1_3 n_5 f_2_5 =
  (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (fun n_1 f_2_1 -> 
    (`LH_N)) in
    (let rec h_1_3 = (`LH_C('a', (`LH_C('p', (`LH_C('r', (`LH_C('i', (`LH_C('c', (`LH_C('o', (`LH_C('t', (`LH_N))))))))))))))) in
      (fun n_2 -> 
    ...
    (let rec h_1_9 = (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_N))))))))))) in
      (let rec t_2_8 = ((take__d0__d1 (n_5 - 1)) t_2_1) in
        (let rec h_2_0 = h_1_9 in
          (`LH_C((f_2_5 h_2_0), ((map__d0__d6 f_2_5) t_2_8)))))))
and map__d4__d0 f_9_9 ls_6_4 _lh_popOutId_0_1_3 =
  (match ls_6_4 with
    | `LH_C(h_7_3, t_8_1) -> 
      (let rec _lh_first_LH_C_1_7 = ((map__d4__d0 f_9_9) t_8_1) in
        (let rec _lh_first_LH_C_0_7 = (f_9_9 h_7_3) in
          (let rec _lh_matchIdent_1_4 = _lh_first_LH_C_0_7 in
            (match _lh_matchIdent_1_4 with
              | `YesIts(_lh_first_YesIts_0_7, _lh_first_YesIts_1_7) -> 
                (`YesIts((_lh_popOutId_0_1_3 + _lh_first_YesIts_0_7), _lh_first_YesIts_1_7))
              | `NotEver(_lh_first_NotEver_0_7) -> 
                ((first__d3__d1 (_lh_popOutId_0_1_3 + _lh_first_NotEver_0_7)) _lh_first_LH_C_1_7)
              | _ -> 
                (failwith "error")))))
    | `LH_N -> 
      (`NotEver(_lh_popOutId_0_1_3)))
and map__d4__d1 f_6_4 ls_4_2 _lh_popOutId_0_7 =
  (match ls_4_2 with
    | `LH_C(h_4_8, t_5_6) -> 
      (let rec _lh_first_LH_C_1_5 = ((map__d4__d1 f_6_4) t_5_6) in
        (let rec _lh_first_LH_C_0_5 = (f_6_4 h_4_8) in
          (let rec _lh_matchIdent_9 = _lh_first_LH_C_0_5 in
            (match _lh_matchIdent_9 with
              | `YesIts(_lh_first_YesIts_0_5, _lh_first_YesIts_1_5) -> 
                (`YesIts((_lh_popOutId_0_7 + _lh_first_YesIts_0_5), _lh_first_YesIts_1_5))
              | `NotEver(_lh_first_NotEver_0_5) -> 
                ((first__d3__d3 (_lh_popOutId_0_7 + _lh_first_NotEver_0_5)) _lh_first_LH_C_1_5)
              | _ -> 
                (failwith "error")))))
    | `LH_N -> 
      (`NotEver(_lh_popOutId_0_7)))
and maxm__d0__d0 _lh_maxm_arg1_1 _lh_maxm_arg2_1 =
  (match _lh_maxm_arg1_1 with
    | `Nothing -> 
      _lh_maxm_arg2_1
...
Command_unix.run (Bench.make_command [
  Bench.Test.create ~name:"original_Cichelli_nofib" (fun () -> ignore (let open Module_original in ((testCichelli_nofib__d0 6))));
  Bench.Test.create ~name:"lumberhack_Cichelli_nofib" (fun () -> ignore (let open Module_lumberhack in ((testCichelli_nofib__d0__d0 6))));
  Bench.Test.create ~name:"lumberhack_pop_out_Cichelli_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out in ((testCichelli_nofib__d0__d0 6))));
])

...
let rec subterm_lh__d1 _lh_subterm_arg1_0 =
  (let rec c_0 = ((let rec t_3 = (fun ys_4 -> 
    ys_4) in
    (let rec h_3 = 'c' in
      (fun ys_5 -> 
        (`LH_C(h_3, (t_3 ys_5)))))) (string_of_int _lh_subterm_arg1_0)) in
    (let rec str_0 = ((mappend_lh__d3 (((mappend_lh__d1 ((let rec t_4 = (let rec t_5 = (let rec t_6 = (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (let rec t_2_5 = (let rec t_2_6 = (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (fun ys_6 -> 
      ys_6) in
      (let rec h_4 = ' ' in
        (fun ys_7 -> 
          (`LH_C(h_4, (t_3_7 ys_7)))))) in
      (let rec h_5 = 's' in
        (fun ys_8 -> 
          (`LH_C(h_5, (t_3_6 ys_8)))))) in
      (let rec h_6 = 'u' in
        (fun ys_9 -> 
          (`LH_C(h_6, (t_3_5 ys_9)))))) in
      (let rec h_7 = 'l' in
        (fun ys_1_0 -> 
          (`LH_C(h_7, (t_3_4 ys_1_0)))))) in
      (let rec h_8 = 'p' in
        (fun ys_1_1 -> 
          (`LH_C(h_8, (t_3_3 ys_1_1)))))) in
      (let rec h_9 = ' ' in
        (fun ys_1_2 -> 
          (`LH_C(h_9, (t_3_2 ys_1_2)))))) in
      (let rec h_1_0 = '(' in
        (fun ys_1_3 -> 
          (`LH_C(h_1_0, (t_3_1 ys_1_3)))))) in
      (let rec h_1_1 = ')' in
        (fun ys_1_4 -> 
          (`LH_C(h_1_1, (t_3_0 ys_1_4)))))) in
      (let rec h_1_2 = ' ' in
        (fun ys_1_5 -> 
          (`LH_C(h_1_2, (t_2_9 ys_1_5)))))) in
      (let rec h_1_3 = 'b' in
        (fun ys_1_6 -> 
          (`LH_C(h_1_3, (t_2_8 ys_1_6)))))) in
      (let rec h_1_4 = ' ' in
        (fun ys_1_7 -> 
          (`LH_C(h_1_4, (t_2_7 ys_1_7)))))) in
      (let rec h_1_5 = 'a' in
        (fun ys_1_8 -> 
          (`LH_C(h_1_5, (t_2_6 ys_1_8)))))) in
      (let rec h_1_6 = ' ' in
        (fun ys_1_9 -> 
          (`LH_C(h_1_6, (t_2_5 ys_1_9)))))) in
      (let rec h_1_7 = 's' in
        (fun ys_2_0 -> 
          (`LH_C(h_1_7, (t_2_4 ys_2_0)))))) in
      (let rec h_1_8 = 'u' in
        (fun ys_2_1 -> 
          (`LH_C(h_1_8, (t_2_3 ys_2_1)))))) in
      (let rec h_1_9 = 'l' in
        (fun ys_2_2 -> 
          (`LH_C(h_1_9, (t_2_2 ys_2_2)))))) in
      (let rec h_2_0 = 'p' in
        (fun ys_2_3 -> 
          (`LH_C(h_2_0, (t_2_1 ys_2_3)))))) in
      (let rec h_2_1 = ' ' in
        (fun ys_2_4 -> 
          (`LH_C(h_2_1, (t_2_0 ys_2_4)))))) in
      (let rec h_2_2 = '(' in
        (fun ys_2_5 -> 
          (`LH_C(h_2_2, (t_1_9 ys_2_5)))))) in
      (let rec h_2_3 = ' ' in
        (fun ys_2_6 -> 
          (`LH_C(h_2_3, (t_1_8 ys_2_6)))))) in
      (let rec h_2_4 = 's' in
        (fun ys_2_7 -> 
          (`LH_C(h_2_4, (t_1_7 ys_2_7)))))) in
      (let rec h_2_5 = 'u' in
        (fun ys_2_8 -> 
          (`LH_C(h_2_5, (t_1_6 ys_2_8)))))) in
      (let rec h_2_6 = 'l' in
        (fun ys_2_9 -> 
          (`LH_C(h_2_6, (t_1_5 ys_2_9)))))) in
      (let rec h_2_7 = 'p' in
        (fun ys_3_0 -> 
          (`LH_C(h_2_7, (t_1_4 ys_3_0)))))) in
      (let rec h_2_8 = ' ' in
        (fun ys_3_1 -> 
          (`LH_C(h_2_8, (t_1_3 ys_3_1)))))) in
      (let rec h_2_9 = '(' in
        (fun ys_3_2 -> 
          (`LH_C(h_2_9, (t_1_2 ys_3_2)))))) in
      (let rec h_3_0 = ' ' in
        (fun ys_3_3 -> 
          (`LH_C(h_3_0, (t_1_1 ys_3_3)))))) in
      (let rec h_3_1 = 'f' in
        (fun ys_3_4 -> 
          (`LH_C(h_3_1, (t_1_0 ys_3_4)))))) in
      (let rec h_3_2 = ' ' in
        (fun ys_3_5 -> 
          (`LH_C(h_3_2, (t_9 ys_3_5)))))) in
      (let rec h_3_3 = 'x' in
        (fun ys_3_6 -> 
          (`LH_C(h_3_3, (t_8 ys_3_6)))))) in
      (let rec h_3_4 = ' ' in
        (fun ys_3_7 -> 
          (`LH_C(h_3_4, (t_7 ys_3_7)))))) in
      (let rec h_3_5 = '(' in
        (fun ys_3_8 -> 
          (`LH_C(h_3_5, (t_6 ys_3_8)))))) in
      (let rec h_3_6 = ' ' in
        (fun ys_3_9 -> 
          (`LH_C(h_3_6, (t_5 ys_3_9)))))) in
      (let rec h_3_7 = '(' in
        (fun ys_4_0 -> 
          (`LH_C(h_3_7, (t_4 ys_4_0)))))) c_0)) (let rec t_3_8 = (let rec t_3_9 = (let rec t_4_0 = (let rec t_4_1 = (let rec t_4_2 = (let rec t_4_3 = (let rec t_4_4 = (let rec t_4_5 = (let rec t_4_6 = (let rec t_4_7 = (let rec t_4_8 = (let rec t_4_9 = (let rec t_5_0 = (let rec t_5_1 = (let rec t_5_2 = (let rec t_5_3 = (let rec t_5_4 = (let rec t_5_5 = (let rec t_5_6 = (let rec t_5_7 = (let rec t_5_8 = (let rec t_5_9 = (let rec t_6_0 = (let rec t_6_1 = (let rec t_6_2 = (let rec t_6_3 = (let rec t_6_4 = (let rec t_6_5 = (let rec t_6_6 = (let rec t_6_7 = (let rec t_6_8 = (let rec t_6_9 = (let rec t_7_0 = (let rec t_7_1 = (let rec t_7_2 = (let rec t_7_3 = (let rec t_7_4 = (let rec t_7_5 = (let rec t_7_6 = (let rec t_7_7 = (let rec t_7_8 = (let rec t_7_9 = (let rec t_8_0 = (let rec t_8_1 = (let rec t_8_2 = (let rec t_8_3 = (let rec t_8_4 = (let rec t_8_5 = (let rec t_8_6 = (fun ys_4_1 -> 
      ys_4_1) in
      (let rec h_3_8 = ' ' in
        (fun ys_4_2 -> 
          (`LH_C(h_3_8, (t_8_6 ys_4_2)))))) in
      (let rec h_3_9 = 's' in
        (fun ys_4_3 -> 
          (`LH_C(h_3_9, (t_8_5 ys_4_3)))))) in
      (let rec h_4_0 = 'u' in
        (fun ys_4_4 -> 
          (`LH_C(h_4_0, (t_8_4 ys_4_4)))))) in
      (let rec h_4_1 = 'l' in
        (fun ys_4_5 -> 
          (`LH_C(h_4_1, (t_8_3 ys_4_5)))))) in
      (let rec h_4_2 = 'p' in
        (fun ys_4_6 -> 
          (`LH_C(h_4_2, (t_8_2 ys_4_6)))))) in
      (let rec h_4_3 = ' ' in
        (fun ys_4_7 -> 
          (`LH_C(h_4_3, (t_8_1 ys_4_7)))))) in
      (let rec h_4_4 = '(' in
        (fun ys_4_8 -> 
          (`LH_C(h_4_4, (t_8_0 ys_4_8)))))) in
      (let rec h_4_5 = ')' in
        (fun ys_4_9 -> 
          (`LH_C(h_4_5, (t_7_9 ys_4_9)))))) in
      (let rec h_4_6 = ' ' in
        (fun ys_5_0 -> 
          (`LH_C(h_4_6, (t_7_8 ys_5_0)))))) in
      (let rec h_4_7 = 'b' in
        (fun ys_5_1 -> 
          (`LH_C(h_4_7, (t_7_7 ys_5_1)))))) in
      (let rec h_4_8 = ' ' in
        (fun ys_5_2 -> 
          (`LH_C(h_4_8, (t_7_6 ys_5_2)))))) in
      (let rec h_4_9 = 'a' in
        (fun ys_5_3 -> 
          (`LH_C(h_4_9, (t_7_5 ys_5_3)))))) in
      (let rec h_5_0 = ' ' in
        (fun ys_5_4 -> 
          (`LH_C(h_5_0, (t_7_4 ys_5_4)))))) in
      (let rec h_5_1 = 's' in
        (fun ys_5_5 -> 
          (`LH_C(h_5_1, (t_7_3 ys_5_5)))))) in
      (let rec h_5_2 = 'e' in
        (fun ys_5_6 -> 
          (`LH_C(h_5_2, (t_7_2 ys_5_6)))))) in
      (let rec h_5_3 = 'm' in
        (fun ys_5_7 -> 
          (`LH_C(h_5_3, (t_7_1 ys_5_7)))))) in
      (let rec h_5_4 = 'i' in
        (fun ys_5_8 -> 
          (`LH_C(h_5_4, (t_7_0 ys_5_8)))))) in
      (let rec h_5_5 = 't' in
        (fun ys_5_9 -> 
          (`LH_C(h_5_5, (t_6_9 ys_5_9)))))) in
      (let rec h_5_6 = ' ' in
        (fun ys_6_0 -> 
          (`LH_C(h_5_6, (t_6_8 ys_6_0)))))) in
      (let rec h_5_7 = '(' in
        (fun ys_6_1 -> 
          (`LH_C(h_5_7, (t_6_7 ys_6_1)))))) in
      (let rec h_5_8 = ' ' in
        (fun ys_6_2 -> 
          (`LH_C(h_5_8, (t_6_6 ys_6_2)))))) in
      (let rec h_5_9 = 's' in
        (fun ys_6_3 -> 
          (`LH_C(h_5_9, (t_6_5 ys_6_3)))))) in
      (let rec h_6_0 = 'e' in
        (fun ys_6_4 -> 
          (`LH_C(h_6_0, (t_6_4 ys_6_4)))))) in
      (let rec h_6_1 = 'm' in
        (fun ys_6_5 -> 
          (`LH_C(h_6_1, (t_6_3 ys_6_5)))))) in
      (let rec h_6_2 = 'i' in
        (fun ys_6_6 -> 
          (`LH_C(h_6_2, (t_6_2 ys_6_6)))))) in
      (let rec h_6_3 = 't' in
        (fun ys_6_7 -> 
          (`LH_C(h_6_3, (t_6_1 ys_6_7)))))) in
      (let rec h_6_4 = ' ' in
        (fun ys_6_8 -> 
          (`LH_C(h_6_4, (t_6_0 ys_6_8)))))) in
      (let rec h_6_5 = '(' in
        (fun ys_6_9 -> 
          (`LH_C(h_6_5, (t_5_9 ys_6_9)))))) in
      (let rec h_6_6 = ' ' in
        (fun ys_7_0 -> 
          (`LH_C(h_6_6, (t_5_8 ys_7_0)))))) in
      (let rec h_6_7 = 'f' in
        (fun ys_7_1 -> 
          (`LH_C(h_6_7, (t_5_7 ys_7_1)))))) in
      (let rec h_6_8 = ' ' in
        (fun ys_7_2 -> 
          (`LH_C(h_6_8, (t_5_6 ys_7_2)))))) in
      (let rec h_6_9 = 'y' in
        (fun ys_7_3 -> 
          (`LH_C(h_6_9, (t_5_5 ys_7_3)))))) in
      (let rec h_7_0 = ' ' in
        (fun ys_7_4 -> 
          (`LH_C(h_7_0, (t_5_4 ys_7_4)))))) in
      (let rec h_7_1 = '(' in
        (fun ys_7_5 -> 
          (`LH_C(h_7_1, (t_5_3 ys_7_5)))))) in
      (let rec h_7_2 = ')' in
        (fun ys_7_6 -> 
          (`LH_C(h_7_2, (t_5_2 ys_7_6)))))) in
      (let rec h_7_3 = ' ' in
        (fun ys_7_7 -> 
          (`LH_C(h_7_3, (t_5_1 ys_7_7)))))) in
      (let rec h_7_4 = ')' in
        (fun ys_7_8 -> 
          (`LH_C(h_7_4, (t_5_0 ys_7_8)))))) in
      (let rec h_7_5 = ' ' in
        (fun ys_7_9 -> 
          (`LH_C(h_7_5, (t_4_9 ys_7_9)))))) in
      (let rec h_7_6 = ')' in
        (fun ys_8_0 -> 
          (`LH_C(h_7_6, (t_4_8 ys_8_0)))))) in
      (let rec h_7_7 = ' ' in
        (fun ys_8_1 -> 
          (`LH_C(h_7_7, (t_4_7 ys_8_1)))))) in
      (let rec h_7_8 = ')' in
        (fun ys_8_2 -> 
          (`LH_C(h_7_8, (t_4_6 ys_8_2)))))) in
      (let rec h_7_9 = ' ' in
        (fun ys_8_3 -> 
          (`LH_C(h_7_9, (t_4_5 ys_8_3)))))) in
      (let rec h_8_0 = 'o' in
        (fun ys_8_4 -> 
          (`LH_C(h_8_0, (t_4_4 ys_8_4)))))) in
      (let rec h_8_1 = 'r' in
        (fun ys_8_5 -> 
          (`LH_C(h_8_1, (t_4_3 ys_8_5)))))) in
      (let rec h_8_2 = 'e' in
        (fun ys_8_6 -> 
          (`LH_C(h_8_2, (t_4_2 ys_8_6)))))) in
      (let rec h_8_3 = 'z' in
        (fun ys_8_7 -> 
          (`LH_C(h_8_3, (t_4_1 ys_8_7)))))) in
      (let rec h_8_4 = ' ' in
        (fun ys_8_8 -> 
          (`LH_C(h_8_4, (t_4_0 ys_8_8)))))) in
      (let rec h_8_5 = '(' in
        (fun ys_8_9 -> 
          (`LH_C(h_8_5, (t_3_9 ys_8_9)))))) in
      (let rec h_8_6 = ' ' in
        (fun ys_9_0 -> 
          (`LH_C(h_8_6, (t_3_8 ys_9_0))))))) c_0)) (`LH_C(' ', (`LH_C('d', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('z', (`LH_C(' ', (`LH_C('f', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('v', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('e', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('e', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('[', (`LH_C(']', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('u', (`LH_C(' ', (`LH_C('e', (`LH_C('q', (`LH_C('u', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('d', (`LH_C('i', (`LH_C('f', (`LH_C('f', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_C('n', (`LH_C('c', (`LH_C('e', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('y', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('w', (`LH_C(' ', (`LH_C('l', (`LH_C('e', (`LH_C('s', (`LH_C('s', (`LH_C('p', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('m', (`LH_C('a', (`LH_C('i', (`LH_C('n', (`LH_C('d', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C('m', (`LH_C('b', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('l', (`LH_C('e', (`LH_C('n', (`LH_C('g', (`LH_C('t', (`LH_C('h', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
...
let rec addlemma_lh__d1 _lh_addlemma_arg1_0 _lh_addlemma_arg2_0 =
  (match _lh_addlemma_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec rules_lh__d1 _lh_dummy_0 _lh_addlemmalst_arg2_0 =

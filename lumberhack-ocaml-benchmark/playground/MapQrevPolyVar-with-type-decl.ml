(*
ocamlfind ocamlopt -rectypes -thread -O3 ./MapQrevPolyVar-with-type-decl.ml -o "./MapQrevPolyVar-with-type-decl.out" -linkpkg -package "core_unix.command_unix" -linkpkg -package "core_bench" && ./MapQrevPolyVar-with-type-decl.out && rm ./*.cmx ./*.out ./*.cmi ./*.o
*)
(* #use "topfind";;

...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_Para_nofib" (fun () -> ignore (let open Module_lumberhack.Module_lumberhack in ((testPara_nofib__d0__d0__d0 0))));
  Bench.Test.create ~name:"lumberhack_pop_out_Para_nofib" (fun () -> ignore (let open Module_lumberhack_pop_out.Module_lumberhack_pop_out in ((testPara_nofib__d0__d0__d0 0))));
])

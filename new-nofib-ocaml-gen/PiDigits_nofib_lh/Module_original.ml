...
let rec concat_lh lss_0 =
  (match lss_0 with
    ...
    | `LH_N -> 
      (`LH_N))
and hashOp_lh _lh_hashOp_arg1_0 _lh_hashOp_arg2_0 =
  (lazy (let rec k_1 = (_lh_hashOp_arg1_0 + 1) in
    (let rec _lh_matchIdent_2 = ((ampOp_lh k_1) _lh_hashOp_arg2_0) in
      (match _lh_matchIdent_2 with
        ...
        | _ -> 
          (failwith "error")))))
and percOp_lh _lh_percOp_arg1_0 _lh_percOp_arg2_0 _lh_percOp_arg3_0 =
      ...
      (let rec j_0 = ((min_lh _lh_percOp_arg3_0) k_0) in
        (let rec _lh_matchIdent_1 = (if (k_0 > _lh_percOp_arg3_0) then
          ...
          (match _lh_matchIdent_1 with
            ...
            | _ -> 
              (failwith "error"))))))
and pidgits_lh _lh_pidgits_arg1_0 =
...
and testPiDigits_nofib_lh _lh_testPiDigits_nofib_arg1_0 =

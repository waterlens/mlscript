...
let rec build_tree_lh _lh_build_tree_arg1_0 _lh_build_tree_arg2_0 =
  (match _lh_build_tree_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and check_perim_lh _lh_check_perim_arg1_0 _lh_check_perim_arg2_0 =
  (match _lh_check_perim_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and check_radius_lh _lh_check_radius_arg1_0 _lh_check_radius_arg2_0 _lh_check_radius_arg3_0 _lh_check_radius_arg4_0 _lh_check_radius_arg5_0 =
...
and np_lh _lh_np_arg1_0 =
  (pmn_lh +. ((float_of_int _lh_np_arg1_0) *. delta_p_lh))
and nq_lh _lh_nq_arg1_0 =
  (qmn_lh +. ((float_of_int _lh_nq_arg1_0) *. delta_q_lh))
and point_colour_lh _lh_point_colour_arg1_0 =
  (match _lh_point_colour_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and testMandel2_nofib_lh _lh_testMandel2_nofib_arg1_0 =

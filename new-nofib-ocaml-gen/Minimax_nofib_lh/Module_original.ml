              ...
              (let rec boardd_eval_0 = (((best_lh _lh_alternate_arg2_0) possibles_0) scores_0) in
                (let rec _lh_matchIdent_5 = boardd_eval_0 in
                  (match _lh_matchIdent_5 with
                    ...
                    | _ -> 
                      (failwith "error"))))))))))
and bestMove_lh _lh_bestMove_arg1_0 _lh_bestMove_arg2_0 _lh_bestMove_arg3_0 _lh_funcomp_x_0 =
  ((fun _lh_funcomp_x_1 -> 
...
and cropTree_lh _lh_cropTree_arg1_0 =
  (match _lh_cropTree_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and empty_lh _lh_empty_arg1_0 _lh_empty_arg2_0 =
  (match _lh_empty_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and fullBoard_lh _lh_fullBoard_arg1_0 =
...
and mapTree_lh _lh_mapTree_arg1_0 _lh_mapTree_arg2_0 =
  (match _lh_mapTree_arg2_0 with
    ...
    | _ -> 
      (failwith "error"))
and mise_lh _lh_mise_arg1_0 _lh_mise_arg2_0 _lh_mise_arg3_0 =
  (match _lh_mise_arg3_0 with
    ...
    | _ -> 
      (failwith "error"))
and newPositions_lh _lh_newPositions_arg1_0 _lh_newPositions_arg2_0 =
...
and placePiece_lh _lh_placePiece_arg1_0 _lh_placePiece_arg2_0 _lh_placePiece_arg3_0 =
...
and prune_lh _lh_prune_arg1_0 _lh_prune_arg2_0 =
...
and showBoard_lh _lh_showBoard_arg1_0 =
  (match _lh_showBoard_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showEvaluation_lh _lh_showEvaluation_arg1_0 =
  (match _lh_showEvaluation_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showMove_lh _lh_showMove_arg1_0 =
  (match _lh_showMove_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and showRow_lh _lh_showRow_arg1_0 =
  (match _lh_showRow_arg1_0 with
    ...
    | _ -> 
      (failwith "error"))
and static_lh _lh_static_arg1_0 =
  ((interpret_lh 0) ((map_lh (score_lh _lh_static_arg1_0)) wins_lh))
and testMinimax_nofib_lh _lh_testMinimax_nofib_arg1_0 =

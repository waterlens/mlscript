...
Command_unix.run (Bench.make_command [
  ...
  Bench.Test.create ~name:"lumberhack_inlined_Para_nofib_lh" (fun () -> ignore (let open Module_lumberhack_inlined_______.Module_lumberhack_inlined_______ in ((testPara_nofib_lh__d1 0))));
  Bench.Test.create ~name:"lumberhack_flo_out_Para_nofib_lh" (fun () -> ignore (let open Module_lumberhack_flo_out_______.Module_lumberhack_flo_out_______ in ((testPara_nofib_lh__d1 0))));
])
